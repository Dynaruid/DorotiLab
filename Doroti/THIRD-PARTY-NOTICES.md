...
- Package: `SkiaSharp` 3.119.4; platform-native assets are selected transitively by the official Avalonia desktop host
- Use: internal BGRA8888 software surface implementation behind `Doroti.Backends.Skia`
