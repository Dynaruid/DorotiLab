...
public static class DorotiApplication
{
    public static IDorotiViewEntrypoint CreateEntrypoint() => new DorotiWidgetEntrypoint(CreateRootWidget);
...
public sealed class CounterPageState : State<CounterPage>
{
    ...
    public override Widget build(BuildContext context) => new Material.Scaffold(
        appBar: new Material.AppBar(
            title: new Text("Doroti C# + Skia WebAssembly"),
