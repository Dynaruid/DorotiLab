...
public static class Dart_developerLibrary
{
    ...
    {
        public static global::Doroti.Flutter.Runtime.Flow step(long id) =>
    ...
    public static class Timeline
    {
        ...
        public static T timeSync<T>(string name, Func<T> callback, global::Doroti.Flutter.Runtime.Flow? flow = null)
        {
        ...
        public static void timeSync(string name, Action callback, global::Doroti.Flutter.Runtime.Flow? flow = null)
        {
            ArgumentNullException.ThrowIfNull(callback);
