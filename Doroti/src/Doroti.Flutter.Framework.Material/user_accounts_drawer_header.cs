...
internal class _AccountDetailsLayout__user_accounts_drawer_header : global::Doroti.Generated.Framework.Rendering.MultiChildLayoutDelegate
{
    ...
    {
        global::Doroti.Flutter.Ui.Size? iconSize__6462 = default!;
        ...
        {
            var constraintSize__6904 = ((iconSize__6462 is null) ? size : new global::Doroti.Flutter.Ui.Size((size.width - DartRuntimePrimitives.RequireValue(iconSize__6462).width), size.height));
            iconSize__6462 ??= new global::Doroti.Flutter.Ui.Size(User_accounts_drawer_headerLibrary._kAccountDetailsHeight, User_accounts_drawer_headerLibrary._kAccountDetailsHeight);
            global::Doroti.Flutter.Ui.Size bottomLineSize__7176 = ((global::Doroti.Flutter.Ui.Size)(object?)layoutChild(bottomLine__6746, global::Doroti.Generated.Framework.Rendering.BoxConstraints.CreateLoose(constraintSize__6904)));
            global::Doroti.Flutter.Ui.Offset bottomLineOffset__7275 = ((global::Doroti.Flutter.Ui.Offset)(object?)_offsetForBottomLine(size, DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(iconSize__6462)), bottomLineSize__7176));
            positionChild(bottomLine__6746, bottomLineOffset__7275);
            if (((bottomLine__6746 == accountEmail) && hasChild(accountName)))
            {
                global::Doroti.Flutter.Ui.Size nameSize__7532 = ((global::Doroti.Flutter.Ui.Size)(object?)layoutChild(accountName, global::Doroti.Generated.Framework.Rendering.BoxConstraints.CreateLoose(constraintSize__6904)));
    ...
    internal virtual global::Doroti.Flutter.Ui.Offset _offsetForIcon(Size size, Size iconSize)
    {
        return (this.textDirection switch { TextDirection.ltr => new global::Doroti.Flutter.Ui.Offset((size.width - iconSize.width), (size.height - iconSize.height)), TextDirection.rtl => new global::Doroti.Flutter.Ui.Offset(0.0, (size.height - iconSize.height)), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Flutter.Ui.Offset _offsetForBottomLine(Size size, Size iconSize, Size bottomLineSize)
    {
        double y__8156 = ((size.height - (0.5 * iconSize.height)) - (0.5 * bottomLineSize.height));
        return (this.textDirection switch { TextDirection.ltr => new global::Doroti.Flutter.Ui.Offset(0.0, y__8156), TextDirection.rtl => new global::Doroti.Flutter.Ui.Offset((size.width - bottomLineSize.width), y__8156), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Flutter.Ui.Offset _offsetForName(Size size, Size nameSize, Offset bottomLineOffset)
    {
        double y__8485 = (bottomLineOffset.dy - nameSize.height);
        return (this.textDirection switch { TextDirection.ltr => new global::Doroti.Flutter.Ui.Offset(0.0, y__8485), TextDirection.rtl => new global::Doroti.Flutter.Ui.Offset((size.width - nameSize.width), y__8485), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
