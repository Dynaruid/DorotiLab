...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/predictive_back_page_transitions_builder.dart
using System;
...
internal class _PredictiveBackSharedElementPageTransitionState__predictive_back_page_transitions_builder : global::Doroti.Generated.Framework.Widgets.State<_PredictiveBackSharedElementPageTransition__predictive_back_page_transitions_builder>, global::Doroti.Generated.Framework.Widgets.SingleTickerProviderStateMixin<_PredictiveBackSharedElementPageTransition__predictive_back_page_transitions_builder>
{
    ...
    internal virtual void _updateAnimations(Size screenSize)
    {
        ...
        _positionAnimation = this._animation.drive((((_PredictiveBackSharedElementPageTransition__predictive_back_page_transitions_builder)this.widget).phase switch { _PredictiveBackPhase__predictive_back_page_transitions_builder.commit => new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Offset>(begin: this._lastDrag, end: new global::Doroti.Flutter.Ui.Offset((screenSize.height * _kYPositionFactor), 0.0)), _ => new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Offset>(begin: (((_PredictiveBackSharedElementPageTransition__predictive_back_page_transitions_builder)this.widget).currentBackEvent?.swipeEdge switch { global::Doroti.Generated.Framework.Services.SwipeEdge.left => new global::Doroti.Flutter.Ui.Offset(xShift__16820, _getYShiftPosition(screenSize.height)), global::Doroti.Generated.Framework.Services.SwipeEdge.right => new global::Doroti.Flutter.Ui.Offset(-xShift__16820, _getYShiftPosition(screenSize.height)), null => new global::Doroti.Flutter.Ui.Offset(xShift__16820, _getYShiftPosition(screenSize.height)), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") }), end: Offset.zero) }));
    }
...
return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)global::Doroti.Generated.Framework.Widgets.Transform.CreateScale(scale: this._scaleTween.evaluate(this._bounceAnimation), child: global::Doroti.Generated.Framework.Widgets.Transform.CreateTranslate(offset: (((_PredictiveBackSharedElementPageTransition__predictive_back_page_transitions_builder)this.widget).phase switch { _PredictiveBackPhase__predictive_back_page_transitions_builder.commit => ((global::Doroti.Generated.Framework.Animation.Animation<Offset>)this._positionAnimation).value, _ => _lastDrag = new global::Doroti.Flutter.Ui.Offset(((global::Doroti.Generated.Framework.Animation.Animation<Offset>)this._positionAnimation).value.dx, _getYShiftPosition(MediaQuery.heightOf(context))) }), child: new global::Doroti.Generated.Framework.Widgets.Opacity(opacity: this._opacityTween.evaluate(this._commitAnimation), child: new global::Doroti.Generated.Framework.Widgets.ClipRRect(borderRadius: (MediaQuery.displayCornerRadiiOf(context) ?? global::Doroti.Generated.Framework.Painting.BorderRadius.CreateCircular(this._borderRadiusTween.evaluate(this._bounceAnimation))), child: child)))));
throw new InvalidOperationException("Dart closure completed without a value.");
...
internal class _PredictiveBackFullscreenPageTransitionState__predictive_back_page_transitions_builder : global::Doroti.Generated.Framework.Widgets.State<_PredictiveBackFullscreenPageTransition__predictive_back_page_transitions_builder>
{
    ...
    public override void didChangeDependencies()
    {
        ...
        _primaryPositionTween = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Animation.Animatable<Offset>>(new global::Doroti.Generated.Framework.Animation.TweenSequence<global::Doroti.Flutter.Ui.Offset>(new List<global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Flutter.Ui.Offset>> { new global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Flutter.Ui.Offset>(tween: new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Offset>(begin: Offset.zero, end: Offset.zero), weight: _kWeightPreCommit), new global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Flutter.Ui.Offset>(tween: new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Offset>(begin: new global::Doroti.Flutter.Ui.Offset(xShift__23697, 0.0), end: Offset.zero), weight: _kWeightPostCommit) }.Cast<global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Flutter.Ui.Offset>>().ToList()));
        _secondaryCurrentPositionTween = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Animation.Animatable<Offset>>(new global::Doroti.Generated.Framework.Animation.ConstantTween<global::Doroti.Flutter.Ui.Offset>(Offset.zero));
        _secondaryPositionTween = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Animation.Animatable<Offset>>(new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Offset>(begin: new global::Doroti.Flutter.Ui.Offset(xShift__23697, 0.0), end: Offset.zero));
    }
