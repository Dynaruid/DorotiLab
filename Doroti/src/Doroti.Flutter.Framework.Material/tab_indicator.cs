...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/tab_indicator.dart
using System;
...
public class UnderlineTabIndicator : global::Doroti.Generated.Framework.Painting.Decoration
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Rect _indicatorRectFor(Rect rect, TextDirection textDirection)
    {
        global::Doroti.Flutter.Ui.Rect indicator__2510 = ((global::Doroti.Flutter.Ui.Rect)(object?)this.insets.resolve(textDirection).deflateRect(rect));
        return global::Doroti.Flutter.Ui.Rect.fromLTWH(indicator__2510.left, (indicator__2510.bottom - ((global::Doroti.Generated.Framework.Painting.BorderSide)this.borderSide).width), indicator__2510.width, ((global::Doroti.Generated.Framework.Painting.BorderSide)this.borderSide).width);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _UnderlinePainter__tab_indicator : global::Doroti.Generated.Framework.Painting.BoxPainter
{
    ...
    public override void paint(Canvas canvas, Offset offset, global::Doroti.Generated.Framework.Painting.ImageConfiguration configuration)
    {
        ...
        global::Doroti.Flutter.Ui.Rect rect__3346 = ((global::Doroti.Flutter.Ui.Rect)(object?)(offset & DartRuntimePrimitives.RequireValue(((global::Doroti.Generated.Framework.Painting.ImageConfiguration)configuration).size)));
        global::Doroti.Flutter.Ui.TextDirection textDirection__3407 = DartRuntimePrimitives.RequireValue(((global::Doroti.Generated.Framework.Painting.ImageConfiguration)configuration).textDirection);
        global::Doroti.Flutter.Ui.Paint paint__3469 = default!;
        if ((this.borderRadius is not null))
        {
...
{            var __cascade = new global::Doroti.Flutter.Ui.Paint();
            ...
            return __cascade;        }))();
            global::Doroti.Flutter.Ui.Rect indicator__3585 = ((global::Doroti.Flutter.Ui.Rect)(object?)this.decoration._indicatorRectFor(rect__3346, textDirection__3407));
            var rrect__3660 = global::Doroti.Flutter.Ui.RRect.fromRectAndCorners(indicator__3585, topLeft: this.borderRadius!.topLeft, topRight: this.borderRadius!.topRight, bottomRight: this.borderRadius!.bottomRight, bottomLeft: this.borderRadius!.bottomLeft);
...
{            var __cascade = ((UnderlineTabIndicator)this.decoration).borderSide.toPaint();
            ...
            return __cascade;        }))();
            global::Doroti.Flutter.Ui.Rect indicator__4043 = ((global::Doroti.Flutter.Ui.Rect)(object?)this.decoration._indicatorRectFor(rect__3346, textDirection__3407).deflate((((UnderlineTabIndicator)this.decoration).borderSide.width / 2.0)));
