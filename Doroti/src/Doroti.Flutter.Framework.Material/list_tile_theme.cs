...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/list_tile_theme.dart
using System;
...
public class ListTileTheme : global::Doroti.Generated.Framework.Widgets.InheritedTheme
{
    ...
    public virtual global::Doroti.Flutter.Ui.Color? selectedColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((ListTileThemeData)this._data).selectedColor : this._selectedColor));
    public virtual global::Doroti.Flutter.Ui.Color? iconColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((ListTileThemeData)this._data).iconColor : this._iconColor));
    public virtual global::Doroti.Flutter.Ui.Color? textColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((ListTileThemeData)this._data).textColor : this._textColor));
    ...
    public virtual global::Doroti.Flutter.Ui.Color? tileColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((ListTileThemeData)this._data).tileColor : this._tileColor));
    public virtual global::Doroti.Flutter.Ui.Color? selectedTileColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((ListTileThemeData)this._data).selectedTileColor : this._selectedTileColor));
