...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/ink_splash.dart
using System;
...
public static partial class Ink_splashLibrary
{
    internal static double _getTargetRadius(global::Doroti.Generated.Framework.Rendering.RenderBox referenceBox, bool containedInkWell, global::System.Func<Rect>? rectCallback, Offset position)
    {
        if (containedInkWell)
        {
            global::Doroti.Flutter.Ui.Size size__1215 = ((global::Doroti.Flutter.Ui.Size)(object?)((rectCallback is not null) ? rectCallback().size : ((global::Doroti.Generated.Framework.Rendering.RenderBox)referenceBox).size));
...
{            var __cascade = new global::Doroti.Generated.Framework.Animation.AnimationController(duration: Ink_splashLibrary._kUnconfirmedSplashDuration, vsync: ((MaterialInkController)controller).vsync);
            __cascade.addListener(() => ((MaterialInkController)controller).markNeedsPaint());
            __cascade.forward();
            return __cascade;        }))();
        _radius = this._radiusController.drive(new global::Doroti.Generated.Framework.Animation.Tween<double>(begin: Ink_splashLibrary._kSplashInitialSize, end: this._targetRadius));
        _alphaController = ((Func<global::Doroti.Generated.Framework.Animation.AnimationController>)(() =>
{            var __cascade = new global::Doroti.Generated.Framework.Animation.AnimationController(duration: Ink_splashLibrary._kSplashFadeDuration, vsync: ((MaterialInkController)controller).vsync);
            __cascade.addListener(() => ((MaterialInkController)controller).markNeedsPaint());
            __cascade.addStatusListener((AnimationStatusListener)this._handleAlphaStatusChanged);
            return __cascade;        }))();
        _alpha = this._alphaController!.drive(new global::Doroti.Generated.Framework.Animation.IntTween(begin: color.alpha, end: 0L));
...
{            var __cascade = new global::Doroti.Flutter.Ui.Paint();
            ...
            return __cascade;        }))();
        global::Doroti.Flutter.Ui.Offset? center__7171 = ((global::Doroti.Flutter.Ui.Offset?)(object?)this._position);
        if (this._repositionToReferenceBox)
        {
            center__7171 = Dart_uiLibrary.Offset.lerp(center__7171, ((global::Doroti.Generated.Framework.Rendering.RenderBox)this.referenceBox).size.center(Offset.zero), ((global::Doroti.Generated.Framework.Animation.AnimationController)this._radiusController).value);
        }
        paintInkCircle(canvas: canvas, transform: transform, paint: paint__7103, center: DartRuntimePrimitives.RequireValue(center__7171), textDirection: this._textDirection, radius: ((global::Doroti.Generated.Framework.Animation.Animation<double>)this._radius).value, customBorder: this.customBorder, borderRadius: this._borderRadius, clipCallback: (global::System.Func<Rect>?)this._clipCallback);
    }
