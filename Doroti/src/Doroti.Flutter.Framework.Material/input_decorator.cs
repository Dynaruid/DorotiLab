...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/input_decorator.dart
using System;
...
public static partial class Input_decoratorLibrary
{
    internal static global::Doroti.Generated.Framework.Animation.Curve _kTransitionCurve = ((global::Doroti.Generated.Framework.Animation.Curve)(object?)global::Doroti.Generated.Framework.Animation.Curves.fastOutSlowIn);
}
...
internal delegate double _ChildBaselineGetter__input_decorator(global::Doroti.Generated.Framework.Rendering.RenderBox child, global::Doroti.Generated.Framework.Rendering.BoxConstraints constraints);
...
public class _InputBorderGap__input_decorator : global::Doroti.Generated.Framework.Foundation.ChangeNotifier
{
...
public class _InputBorderTween__input_decorator : global::Doroti.Generated.Framework.Animation.Tween<InputBorder>
{
...
internal class _InputBorderPainter__input_decorator : global::Doroti.Generated.Framework.Rendering.CustomPainter
{
    public virtual global::Doroti.Generated.Framework.Animation.Animation<double> borderAnimation { get; private set; } = default!;
    public virtual _InputBorderTween__input_decorator border { get; private set; } = default!;
    public virtual global::Doroti.Generated.Framework.Animation.Animation<double> gapAnimation { get; private set; } = default!;
    ...
    public virtual global::Doroti.Generated.Framework.Animation.ColorTween hoverColorTween { get; private set; } = default!;
    public virtual global::Doroti.Generated.Framework.Animation.Animation<double> hoverAnimation { get; private set; } = default!;

    internal _InputBorderPainter__input_decorator(global::Doroti.Generated.Framework.Foundation.Listenable repaint, global::Doroti.Generated.Framework.Animation.Animation<double> borderAnimation, _InputBorderTween__input_decorator border, global::Doroti.Generated.Framework.Animation.Animation<double> gapAnimation, _InputBorderGap__input_decorator gap, TextDirection textDirection, Color fillColor, global::Doroti.Generated.Framework.Animation.Animation<double> hoverAnimation, global::Doroti.Generated.Framework.Animation.ColorTween hoverColorTween) : base(repaint: repaint)
    {
    ...
    public virtual global::Doroti.Flutter.Ui.Color blendedColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(Dart_uiLibrary.Color.alphaBlend(this.hoverColorTween.evaluate(this.hoverAnimation)!, this.fillColor));
    public override void paint(Canvas canvas, Size size)
    {
        InputBorder borderValue__4594 = ((InputBorder)(object?)this.border.evaluate(this.borderAnimation));
        global::Doroti.Flutter.Ui.Rect canvasRect__4657 = ((global::Doroti.Flutter.Ui.Rect)(object?)(Offset.zero & size));
        global::Doroti.Flutter.Ui.Color blendedFillColor__4706 = ((global::Doroti.Flutter.Ui.Color)(object?)this.blendedColor);
...
{            var __cascade = new global::Doroti.Flutter.Ui.Paint();
        ...
        borderValue__4594.paint(canvas, canvasRect__4657, gapStart: (((_InputBorderGap__input_decorator)this.gap).start ?? 0.0), gapExtent: ((_InputBorderGap__input_decorator)this.gap).extent, gapPercentage: ((global::Doroti.Generated.Framework.Animation.Animation<double>)this.gapAnimation).value, textDirection: this.textDirection);
    }
...
public class _BorderContainer__input_decorator : global::Doroti.Generated.Framework.Widgets.StatefulWidget
{
    ...
    internal _BorderContainer__input_decorator(InputBorder border, _InputBorderGap__input_decorator gap, global::Doroti.Generated.Framework.Animation.Animation<double> gapAnimation, Color fillColor, Color hoverColor, bool isHovering)
    {
        this.border = border;
        this.gap = gap;
        this.gapAnimation = gapAnimation;
...
public class _BorderContainerState__input_decorator : global::Doroti.Generated.Framework.Widgets.State<_BorderContainer__input_decorator>, global::Doroti.Generated.Framework.Widgets.TickerProviderStateMixin<_BorderContainer__input_decorator>
{
    ...
    internal virtual global::Doroti.Generated.Framework.Animation.AnimationController _hoverColorController { get; set; } = default!;
    internal virtual global::Doroti.Generated.Framework.Animation.CurvedAnimation _borderAnimation { get; set; } = default!;
    internal virtual _InputBorderTween__input_decorator _border { get; set; } = default!;
    internal virtual global::Doroti.Generated.Framework.Animation.CurvedAnimation _hoverAnimation { get; set; } = default!;
    internal virtual global::Doroti.Generated.Framework.Animation.ColorTween _hoverColorTween { get; set; } = default!;
    ...
    {
        base.initState();
        _hoverColorController = new global::Doroti.Generated.Framework.Animation.AnimationController(duration: _kHoverDuration, value: (((_BorderContainer__input_decorator)this.widget).isHovering ? 1.0 : 0.0), vsync: this);
        _controller = new global::Doroti.Generated.Framework.Animation.AnimationController(duration: Input_decoratorLibrary._kTransitionDuration, vsync: this);
        _borderAnimation = new global::Doroti.Generated.Framework.Animation.CurvedAnimation(parent: this._controller, curve: Input_decoratorLibrary._kTransitionCurve, reverseCurve: ((global::Doroti.Generated.Framework.Animation.Curve)Input_decoratorLibrary._kTransitionCurve).flipped);
        ...
        _hoverAnimation = new global::Doroti.Generated.Framework.Animation.CurvedAnimation(parent: this._hoverColorController, curve: global::Doroti.Generated.Framework.Animation.Curves.linear);
        _hoverColorTween = new global::Doroti.Generated.Framework.Animation.ColorTween(begin: ((_BorderContainer__input_decorator)this.widget).hoverColor.withAlpha(0L), end: ((_BorderContainer__input_decorator)this.widget).hoverColor);
    }
...
{            var __cascade = this._controller;
    ...
    {
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.CustomPaint(foregroundPainter: new _InputBorderPainter__input_decorator(repaint: global::Doroti.Generated.Framework.Foundation.Listenable.CreateMerge(new List<global::Doroti.Generated.Framework.Foundation.Listenable> { this._borderAnimation, ((_BorderContainer__input_decorator)this.widget).gap, this._hoverColorController }.Cast<global::Doroti.Generated.Framework.Foundation.Listenable?>()), borderAnimation: this._borderAnimation, border: this._border, gapAnimation: ((_BorderContainer__input_decorator)this.widget).gapAnimation, gap: ((_BorderContainer__input_decorator)this.widget).gap, textDirection: Directionality.of(context), fillColor: ((_BorderContainer__input_decorator)this.widget).fillColor, hoverColorTween: this._hoverColorTween, hoverAnimation: this._hoverAnimation)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class _HelperError__input_decorator : global::Doroti.Generated.Framework.Widgets.StatefulWidget
{
    ...
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle { get; private set; }
    ...
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle { get; private set; }
    public virtual long? errorMaxLines { get; private set; }

    internal _HelperError__input_decorator(TextAlign? textAlign = null, global::Doroti.Generated.Framework.Widgets.Widget? helper = null, string? helperText = null, global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle = null, long? helperMaxLines = null, global::Doroti.Generated.Framework.Widgets.Widget? error = null, string? errorText = null, global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle = null, long? errorMaxLines = null)
    {
...
public class _HelperErrorState__input_decorator : global::Doroti.Generated.Framework.Widgets.State<_HelperError__input_decorator>, global::Doroti.Generated.Framework.Widgets.SingleTickerProviderStateMixin<_HelperError__input_decorator>
{
    public static global::Doroti.Generated.Framework.Widgets.Widget empty = ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)global::Doroti.Generated.Framework.Widgets.SizedBox.CreateShrink());
    internal virtual global::Doroti.Generated.Framework.Animation.AnimationController _controller { get; set; } = default!;
    internal virtual global::Doroti.Generated.Framework.Widgets.Widget? _helper { get; set; } = default;
    internal virtual global::Doroti.Generated.Framework.Widgets.Widget? _error { get; set; } = default;
    ...
    public override void didUpdateWidget(_HelperError__input_decorator old)
    {
        ...
        global::Doroti.Generated.Framework.Widgets.Widget? newError__11141 = ((_HelperError__input_decorator)this.widget).error;
        string? newErrorText__11184 = ((_HelperError__input_decorator)this.widget).errorText;
        global::Doroti.Generated.Framework.Widgets.Widget? newHelper__11235 = ((_HelperError__input_decorator)this.widget).helper;
        string? newHelperText__11280 = ((_HelperError__input_decorator)this.widget).helperText;
        global::Doroti.Generated.Framework.Widgets.Widget? oldError__11333 = ((_HelperError__input_decorator)old).error;
        string? oldErrorText__11373 = ((_HelperError__input_decorator)old).errorText;
        global::Doroti.Generated.Framework.Widgets.Widget? oldHelper__11421 = ((_HelperError__input_decorator)old).helper;
    ...
    internal virtual global::Doroti.Generated.Framework.Widgets.Widget _buildHelper()
    {
        ...
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.Semantics(container: true, child: new global::Doroti.Generated.Framework.Widgets.FadeTransition(opacity: new global::Doroti.Generated.Framework.Animation.Tween<double>(begin: 1.0, end: 0.0).animate(this._controller), child: (((_HelperError__input_decorator)this.widget).helper ?? new global::Doroti.Generated.Framework.Widgets.Text(((_HelperError__input_decorator)this.widget).helperText!, style: ((_HelperError__input_decorator)this.widget).helperStyle, textAlign: ((_HelperError__input_decorator)this.widget).textAlign, overflow: global::Doroti.Generated.Framework.Painting.TextOverflow.ellipsis, maxLines: ((_HelperError__input_decorator)this.widget).helperMaxLines)))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Generated.Framework.Widgets.Widget _buildError()
    {
        ...
        global::Doroti.Generated.Framework.Widgets.Widget? capturedError__12992 = ((_HelperError__input_decorator)this.widget).error;
        if (((capturedError__12992 is not null) && (((_HelperError__input_decorator)this.widget).errorStyle is not null)))
        {
            capturedError__12992 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(new global::Doroti.Generated.Framework.Widgets.DefaultTextStyle(style: ((_HelperError__input_decorator)this.widget).errorStyle!, child: capturedError__12992));
        }
...
return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.Semantics(container: true, liveRegion: !MediaQuery.supportsAnnounceOf(context), child: new global::Doroti.Generated.Framework.Widgets.FadeTransition(opacity: this._controller, child: new global::Doroti.Generated.Framework.Widgets.FractionalTranslation(translation: new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Offset>(begin: new global::Doroti.Flutter.Ui.Offset(0.0, -0.25), end: Offset.zero).evaluate(((global::Doroti.Generated.Framework.Animation.AnimationController)this._controller).view), child: (capturedError__12992 ?? new global::Doroti.Generated.Framework.Widgets.Text(capturedErrorText__12942!, style: ((_HelperError__input_decorator)this.widget).errorStyle, textAlign: ((_HelperError__input_decorator)this.widget).textAlign, overflow: global::Doroti.Generated.Framework.Painting.TextOverflow.ellipsis, maxLines: ((_HelperError__input_decorator)this.widget).errorMaxLines))))));
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public override global::Doroti.Generated.Framework.Widgets.Widget build(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
        ...
        {
            return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)_buildError());
        }
        if (((this._error is null) && this._hasHelper))
        {
            return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)_buildHelper());
        }
        if (this._hasError)
        {
            return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.Stack(children: new List<global::Doroti.Generated.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(new global::Doroti.Generated.Framework.Widgets.FadeTransition(opacity: new global::Doroti.Generated.Framework.Animation.Tween<double>(begin: 1.0, end: 0.0).animate(this._controller), child: this._helper)), DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(_buildError()) }));
        }
        if (this._hasHelper)
        {
            return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.Stack(children: new List<global::Doroti.Generated.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(_buildHelper()), DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(new global::Doroti.Generated.Framework.Widgets.FadeTransition(opacity: this._controller, child: this._error)) }));
        }
        return empty;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
{
    public virtual global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional contentPadding { get; private set; } = default!;
    ...
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? input { get; private set; }
    ...
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? suffix { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? prefixIcon { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? suffixIcon { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? helperError { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? counter { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? container { get; private set; }

    internal _Decoration__input_decorator(global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional contentPadding, bool isCollapsed, double floatingLabelHeight, double floatingLabelProgress, FloatingLabelAlignment floatingLabelAlignment, InputBorder border, _InputBorderGap__input_decorator borderGap, bool alignLabelWithHint, bool? isDense, bool isEmpty, VisualDensity visualDensity, double inputGap, bool maintainHintSize, bool maintainLabelSize, global::Doroti.Generated.Framework.Widgets.Widget? icon = null, global::Doroti.Generated.Framework.Widgets.Widget? input = null, global::Doroti.Generated.Framework.Widgets.Widget? label = null, global::Doroti.Generated.Framework.Widgets.Widget? hint = null, global::Doroti.Generated.Framework.Widgets.Widget? prefix = null, global::Doroti.Generated.Framework.Widgets.Widget? suffix = null, global::Doroti.Generated.Framework.Widgets.Widget? prefixIcon = null, global::Doroti.Generated.Framework.Widgets.Widget? suffixIcon = null, global::Doroti.Generated.Framework.Widgets.Widget? helperError = null, global::Doroti.Generated.Framework.Widgets.Widget? counter = null, global::Doroti.Generated.Framework.Widgets.Widget? container = null)
    {
...
{
    public virtual global::Doroti.Generated.Framework.Rendering.BoxConstraints inputConstraints { get; private set; } = default!;
    ...
    internal _RenderDecorationLayout__input_decorator(global::Doroti.Generated.Framework.Rendering.BoxConstraints inputConstraints, double baseline, double containerHeight, (double ascent, double bottomHeight, double subtextHeight)? subtextSize, Size size)
    {
...
public class _RenderDecoration__input_decorator : global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Widgets.SlottedContainerRenderObjectMixin<_DecorationSlot__input_decorator, global::Doroti.Generated.Framework.Rendering.RenderBox>
{
    ...
    internal virtual global::Doroti.Generated.Framework.Painting.TextAlignVertical? _textAlignVertical { get; set; } = default;
    ...
    public virtual DartMap<_DecorationSlot__input_decorator, global::Doroti.Generated.Framework.Rendering.RenderBox> _slotToChild { get; set; } = new DartMap<_DecorationSlot__input_decorator, global::Doroti.Generated.Framework.Rendering.RenderBox>();

    internal _RenderDecoration__input_decorator(_Decoration__input_decorator decoration, TextDirection textDirection, TextBaseline textBaseline, bool isFocused, bool expands, bool material3, global::Doroti.Generated.Framework.Painting.TextAlignVertical? textAlignVertical = null)
    {
    ...
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? icon => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.icon));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? input => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.input));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? label => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.label));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? hint => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.hint));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? prefix => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.prefix));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? suffix => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.suffix));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? prefixIcon => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.prefixIcon));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? suffixIcon => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.suffixIcon));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox helperError => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Rendering.RenderBox>(childForSlot(_DecorationSlot__input_decorator.helperError)!);
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? counter => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.counter));
    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? container => childForSlot(DartRuntimePrimitives.RequireValue(_DecorationSlot__input_decorator.container));
    public virtual IEnumerable<global::Doroti.Generated.Framework.Rendering.RenderBox> children
    {
        get
        {
            global::Doroti.Generated.Framework.Rendering.RenderBox? helperError__23189 = ((global::Doroti.Generated.Framework.Rendering.RenderBox?)(object?)childForSlot(_DecorationSlot__input_decorator.helperError));
            return ((IEnumerable<global::Doroti.Generated.Framework.Rendering.RenderBox>)(object?)((Func<List<global::Doroti.Generated.Framework.Rendering.RenderBox>>)(() => { var __collection23257 = new List<global::Doroti.Generated.Framework.Rendering.RenderBox>(); var __collectionElement23276 = this.icon; if (__collectionElement23276 is { } __nonNullCollectionElement23276) { __collection23257.Add(__nonNullCollectionElement23276); } var __collectionElement23289 = this.input; if (__collectionElement23289 is { } __nonNullCollectionElement23289) { __collection23257.Add(__nonNullCollectionElement23289); } var __collectionElement23303 = this.prefixIcon; if (__collectionElement23303 is { } __nonNullCollectionElement23303) { __collection23257.Add(__nonNullCollectionElement23303); } var __collectionElement23322 = this.suffixIcon; if (__collectionElement23322 is { } __nonNullCollectionElement23322) { __collection23257.Add(__nonNullCollectionElement23322); } var __collectionElement23341 = this.prefix; if (__collectionElement23341 is { } __nonNullCollectionElement23341) { __collection23257.Add(__nonNullCollectionElement23341); } var __collectionElement23356 = this.suffix; if (__collectionElement23356 is { } __nonNullCollectionElement23356) { __collection23257.Add(__nonNullCollectionElement23356); } var __collectionElement23371 = this.label; if (__collectionElement23371 is { } __nonNullCollectionElement23371) { __collection23257.Add(__nonNullCollectionElement23371); } var __collectionElement23385 = this.hint; if (__collectionElement23385 is { } __nonNullCollectionElement23385) { __collection23257.Add(__nonNullCollectionElement23385); } var __collectionElement23398 = helperError__23189; if (__collectionElement23398 is { } __nonNullCollectionElement23398) { __collection23257.Add(__nonNullCollectionElement23398); } var __collectionElement23418 = this.counter; if (__collectionElement23418 is { } __nonNullCollectionElement23418) { __collection23257.Add(__nonNullCollectionElement23418); } var __collectionElement23434 = this.container; if (__collectionElement23434 is { } __nonNullCollectionElement23434) { __collection23257.Add(__nonNullCollectionElement23434); } return __collection23257; }))());
            return default!;
        }
    }
    ...
    public virtual global::Doroti.Flutter.Ui.TextBaseline textBaseline
    {
    ...
    internal virtual global::Doroti.Generated.Framework.Painting.TextAlignVertical _defaultTextAlignVertical => (this._isOutlineAligned ? global::Doroti.Generated.Framework.Painting.TextAlignVertical.center : global::Doroti.Generated.Framework.Painting.TextAlignVertical.top);
    public virtual global::Doroti.Generated.Framework.Painting.TextAlignVertical textAlignVertical
    {
        get => ((this._textAlignVertical ?? (global::Doroti.Generated.Framework.Painting.TextAlignVertical)this._defaultTextAlignVertical));
        set
        {
            global::Doroti.Generated.Framework.Painting.TextAlignVertical? __value = value;
            if ((object.Equals(this._textAlignVertical, __value)))
            {
                return;
            }
            if ((((global::Doroti.Generated.Framework.Painting.TextAlignVertical)this.textAlignVertical).y == ((__value?.y ?? ((global::Doroti.Generated.Framework.Painting.TextAlignVertical)this._defaultTextAlignVertical).y))))
            {
    ...
    internal virtual global::Doroti.Flutter.Ui.Offset _densityOffset => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Offset>(((_Decoration__input_decorator)this.decoration).visualDensity.baseSizeAdjustment);
    ...
    internal static double _minWidth(global::Doroti.Generated.Framework.Rendering.RenderBox? box, double height) => DartRuntimePrimitives.ConvertValue<double>((box?.getMinIntrinsicWidth(height) ?? 0.0));
    internal static double _maxWidth(global::Doroti.Generated.Framework.Rendering.RenderBox? box, double height) => DartRuntimePrimitives.ConvertValue<double>((box?.getMaxIntrinsicWidth(height) ?? 0.0));
    internal static double _minHeight(global::Doroti.Generated.Framework.Rendering.RenderBox? box, double width) => DartRuntimePrimitives.ConvertValue<double>((box?.getMinIntrinsicHeight(width) ?? 0.0));
    internal static global::Doroti.Flutter.Ui.Size _boxSize(global::Doroti.Generated.Framework.Rendering.RenderBox? box) => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Size>((box?.size ?? Size.zero));
    internal static double _getBaseline(global::Doroti.Generated.Framework.Rendering.RenderBox box, global::Doroti.Generated.Framework.Rendering.BoxConstraints boxConstraints)
    {
        return (ChildLayoutHelper.getBaseline(box, boxConstraints, TextBaseline.alphabetic) ?? ((global::Doroti.Generated.Framework.Rendering.RenderBox)box).size.height);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal static double _getDryBaseline(global::Doroti.Generated.Framework.Rendering.RenderBox box, global::Doroti.Generated.Framework.Rendering.BoxConstraints boxConstraints)
    {
    ...
    internal static global::Doroti.Generated.Framework.Rendering.BoxParentData _boxParentData(global::Doroti.Generated.Framework.Rendering.RenderBox box) => ((global::Doroti.Generated.Framework.Rendering.BoxParentData?)(object?)box.parentData!)!;
    public virtual global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional contentPadding => ((_Decoration__input_decorator)this.decoration).contentPadding;
    internal virtual (double ascent, double bottomHeight, double subtextHeight)? _computeSubtextSizes(global::Doroti.Generated.Framework.Rendering.BoxConstraints constraints, global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, Size> layoutChild, global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, double> getBaseline)
    {
        var (counterSize__27587, counterAscent__27607) = (this.counter switch { global::Doroti.Generated.Framework.Rendering.RenderBox box__27665 => (((Size, double))((layoutChild(box__27665, constraints), getBaseline(box__27665, constraints)))), null => (((Size, double))((Size.zero, 0.0))) });
        double counterPadding__27862 = ((this.counter is not null) ? Input_decoratorLibrary._kSubtextCounterPadding : 0.0);
        global::Doroti.Generated.Framework.Rendering.BoxConstraints helperErrorConstraints__27953 = ((global::Doroti.Generated.Framework.Rendering.BoxConstraints)(object?)constraints.deflate(global::Doroti.Generated.Framework.Painting.EdgeInsets.CreateOnly(left: (counterSize__27587.width + counterPadding__27862))));
    ...
    internal virtual _RenderDecorationLayout__input_decorator _layout(global::Doroti.Generated.Framework.Rendering.BoxConstraints constraints, global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, Size> layoutChild, global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, double> getBaseline)
    {
        DartRuntimePrimitives.Assert(() => (((global::Doroti.Generated.Framework.Rendering.BoxConstraints)constraints).maxWidth < double.PositiveInfinity), () => (object?)"An InputDecorator, which is typically created by a TextField, cannot " + "have an unbounded width.\n" + "This happens when the parent widget does not provide a finite width " + "constraint. For example, if the InputDecorator is contained by a Row, " + "then its width must be constrained. An Expanded widget or a SizedBox " + "can be used to constrain the width of the InputDecorator or the " + "TextField that contains it.");
        global::Doroti.Generated.Framework.Rendering.BoxConstraints boxConstraints__29828 = ((global::Doroti.Generated.Framework.Rendering.BoxConstraints)(object?)constraints.loosen());
        global::Doroti.Generated.Framework.Rendering.RenderBox? icon__29942 = this.icon;
        double iconWidth__29977 = ((icon__29942 is null) ? 0.0 : layoutChild(icon__29942, boxConstraints__29828).width);
        global::Doroti.Generated.Framework.Rendering.BoxConstraints containerConstraints__30076 = ((global::Doroti.Generated.Framework.Rendering.BoxConstraints)(object?)boxConstraints__29828.deflate(global::Doroti.Generated.Framework.Painting.EdgeInsets.CreateOnly(left: iconWidth__29977)));
        global::Doroti.Generated.Framework.Rendering.BoxConstraints contentConstraints__30195 = ((global::Doroti.Generated.Framework.Rendering.BoxConstraints)(object?)containerConstraints__30076.deflate(global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional.CreateOnly(start: (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start + ((_Decoration__input_decorator)this.decoration).inputGap), end: (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end + ((_Decoration__input_decorator)this.decoration).inputGap))));
        (double ascent, double bottomHeight, double subtextHeight)? subtextSize__30549 = _computeSubtextSizes(constraints: contentConstraints__30195, layoutChild: (global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, Size>)layoutChild, getBaseline: (global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, double>)getBaseline);
        global::Doroti.Generated.Framework.Rendering.RenderBox? prefixIcon__30717 = this.prefixIcon;
        global::Doroti.Generated.Framework.Rendering.RenderBox? suffixIcon__30768 = this.suffixIcon;
        global::Doroti.Flutter.Ui.Size prefixIconSize__30813 = ((global::Doroti.Flutter.Ui.Size)(object?)((prefixIcon__30717 is null) ? Size.zero : layoutChild(prefixIcon__30717, containerConstraints__30076)));
        global::Doroti.Flutter.Ui.Size suffixIconSize__30941 = ((global::Doroti.Flutter.Ui.Size)(object?)((suffixIcon__30768 is null) ? Size.zero : layoutChild(suffixIcon__30768, containerConstraints__30076)));
        global::Doroti.Generated.Framework.Rendering.RenderBox? prefix__31075 = this.prefix;
        global::Doroti.Generated.Framework.Rendering.RenderBox? suffix__31118 = this.suffix;
        global::Doroti.Flutter.Ui.Size prefixSize__31155 = ((global::Doroti.Flutter.Ui.Size)(object?)((prefix__31075 is null) ? Size.zero : layoutChild(prefix__31075, contentConstraints__30195)));
        global::Doroti.Flutter.Ui.Size suffixSize__31253 = ((global::Doroti.Flutter.Ui.Size)(object?)((suffix__31118 is null) ? Size.zero : layoutChild(suffix__31118, contentConstraints__30195)));
        var accessoryHorizontalInsets__31347 = global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional.CreateOnly(start: ((iconWidth__29977 + prefixSize__31155.width) + (((prefixIcon__30717 is null) ? (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start + ((_Decoration__input_decorator)this.decoration).inputGap) : (prefixIconSize__30813.width + this.prefixToInputGap)))), end: (suffixSize__31253.width + (((suffixIcon__30768 is null) ? (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end + ((_Decoration__input_decorator)this.decoration).inputGap) : (suffixIconSize__30941.width + this.inputToSuffixGap)))));
        double inputWidth__31824 = Math.Max(0.0, (((global::Doroti.Generated.Framework.Rendering.BoxConstraints)constraints).maxWidth - accessoryHorizontalInsets__31347.horizontal));
        global::Doroti.Generated.Framework.Rendering.RenderBox? label__31953 = this.label;
        double topHeight__31990 = default!;
        if ((label__31953 is not null))
        {
            double suffixIconSpace__32045 = (((_Decoration__input_decorator)this.decoration).border.isOutline ? DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(suffixIconSize__30941.width, ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end, ((_Decoration__input_decorator)this.decoration).floatingLabelProgress)) : suffixIconSize__30941.width);
            double labelWidth__32244 = Math.Max(0.0, (((global::Doroti.Generated.Framework.Rendering.BoxConstraints)constraints).maxWidth - (((((((_Decoration__input_decorator)this.decoration).inputGap * 2L) + iconWidth__29977) + (((prefixIcon__30717 is null) ? ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start : prefixIconSize__30813.width))) + (((suffixIcon__30768 is null) ? ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end : suffixIconSpace__32045))))));
            ...
            global::Doroti.Generated.Framework.Rendering.BoxConstraints labelConstraints__32803 = ((global::Doroti.Generated.Framework.Rendering.BoxConstraints)(object?)boxConstraints__29828.copyWith(maxWidth: (labelWidth__32244 * invertedLabelScale__32646)));
        ...
        global::Doroti.Generated.Framework.Rendering.BoxConstraints inputConstraints__33423 = ((global::Doroti.Generated.Framework.Rendering.BoxConstraints)(object?)boxConstraints__29828.deflate(global::Doroti.Generated.Framework.Painting.EdgeInsets.CreateOnly(top: (((this.contentPadding.vertical + topHeight__31990) + bottomHeight__33349) + this._densityOffset.dy))).tighten(width: inputWidth__31824));
        global::Doroti.Generated.Framework.Rendering.RenderBox? input__33673 = this.input;
        global::Doroti.Generated.Framework.Rendering.RenderBox? hint__33714 = this.hint;
        global::Doroti.Flutter.Ui.Size inputSize__33747 = ((global::Doroti.Flutter.Ui.Size)(object?)((input__33673 is null) ? Size.zero : layoutChild(input__33673, inputConstraints__33423)));
        global::Doroti.Flutter.Ui.Size hintSize__33840 = ((global::Doroti.Flutter.Ui.Size)(object?)((hint__33714 is null) ? Size.zero : layoutChild(hint__33714, boxConstraints__29828.tighten(width: inputWidth__31824))));
        ...
        double contentHeight__35520 = Math.Max(fixIconHeight__35431, ((((((topHeight__31990 + ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).top) + fixAboveInput__34863) + inputHeight__34265) + fixBelowInput__35250) + ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).bottom) + this._densityOffset.dy));
        ...
        double maxContainerHeight__35932 = Math.Max(0.0, (((global::Doroti.Generated.Framework.Rendering.BoxConstraints)boxConstraints__29828).maxHeight - bottomHeight__33349));
        ...
        double textAlignVerticalFactor__36895 = (((((global::Doroti.Generated.Framework.Painting.TextAlignVertical)this.textAlignVertical).y + 1.0)) / 2.0);
        double baselineAdjustment__37176 = (fixAboveInput__34863 - (overflow__36684 * ((1L - textAlignVerticalFactor__36895))));
        double topInputBaseline__37351 = (((((((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).top + topHeight__31990) + inputInternalBaseline__34418) + baselineAdjustment__37176) + interactiveAdjustment__36306) + (this._densityOffset.dy / 2.0));
        ...
        return new _RenderDecorationLayout__input_decorator(inputConstraints: inputConstraints__33423, containerHeight: containerHeight__36026, baseline: baseline__37835, subtextSize: subtextSize__30549, size: new global::Doroti.Flutter.Ui.Size(((global::Doroti.Generated.Framework.Rendering.BoxConstraints)constraints).maxWidth, (containerHeight__36026 + ((subtextSize__30549?.subtextHeight ?? 0.0)))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal static double _interpolateThree(double begin, double middle, double end, global::Doroti.Generated.Framework.Painting.TextAlignVertical textAlignVertical)
    {
        double basis__40131 = ((((global::Doroti.Generated.Framework.Painting.TextAlignVertical)textAlignVertical).y <= 0L) ? Math.Max((middle - begin), 0) : Math.Max((end - middle), 0));
        return (middle + (basis__40131 * ((global::Doroti.Generated.Framework.Painting.TextAlignVertical)textAlignVertical).y));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override double computeMinIntrinsicWidth(double height)
    {
        ...
        return (((((((_RenderDecoration__input_decorator._minWidth(this.icon, height) + (((this.prefixIcon is not null) ? this.prefixToInputGap : (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start + ((_Decoration__input_decorator)this.decoration).inputGap)))) + _RenderDecoration__input_decorator._minWidth(this.prefixIcon, height)) + _RenderDecoration__input_decorator._minWidth(this.prefix, height)) + contentWidth__40559) + _RenderDecoration__input_decorator._minWidth(this.suffix, height)) + _RenderDecoration__input_decorator._minWidth(this.suffixIcon, height)) + (((this.suffixIcon is not null) ? this.inputToSuffixGap : (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end + ((_Decoration__input_decorator)this.decoration).inputGap))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override double computeMaxIntrinsicWidth(double height)
    {
        ...
        return (((((((_RenderDecoration__input_decorator._maxWidth(this.icon, height) + (((this.prefixIcon is not null) ? this.prefixToInputGap : (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start + ((_Decoration__input_decorator)this.decoration).inputGap)))) + _RenderDecoration__input_decorator._maxWidth(this.prefixIcon, height)) + _RenderDecoration__input_decorator._maxWidth(this.prefix, height)) + contentWidth__41352) + _RenderDecoration__input_decorator._maxWidth(this.suffix, height)) + _RenderDecoration__input_decorator._maxWidth(this.suffixIcon, height)) + (((this.suffixIcon is not null) ? this.inputToSuffixGap : (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end + ((_Decoration__input_decorator)this.decoration).inputGap))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual double _lineHeight(double width, List<global::Doroti.Generated.Framework.Rendering.RenderBox?> boxes)
    {
    ...
    public override double computeMinIntrinsicHeight(double width)
    {
        ...
        double inputHeight__44083 = _lineHeight(availableInputWidth__43939, ((Func<List<global::Doroti.Generated.Framework.Rendering.RenderBox?>>)(() => { var __collection44130 = new List<global::Doroti.Generated.Framework.Rendering.RenderBox?>(); __collection44130.Add(this.input); if (((_Decoration__input_decorator)this.decoration).isEmpty) { __collection44130.Add(this.hint); } return __collection44130; }))());
        double inputMaxHeight__44218 = new List<double> { inputHeight__44083, prefixHeight__43691, suffixHeight__43815 }.reduce(global::Doroti.Flutter.Runtime.Dart_mathLibrary.max);
        double contentHeight__44346 = ((((((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).top + (((this.label is null) ? 0.0 : ((_Decoration__input_decorator)this.decoration).floatingLabelHeight))) + inputMaxHeight__44218) + ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).bottom) + this._densityOffset.dy);
        double containerHeight__44557 = new List<double> { iconHeight__42396, contentHeight__44346, prefixIconHeight__42557, suffixIconHeight__42701 }.reduce(global::Doroti.Flutter.Runtime.Dart_mathLibrary.max);
    ...
    {
        global::Doroti.Generated.Framework.Rendering.RenderBox? input__45103 = this.input;
        if ((input__45103 is null))
        {
            return 0.0;
        }
        return (_RenderDecoration__input_decorator._boxParentData(input__45103).offset.dy + ((input__45103.getDistanceToActualBaseline(baseline) ?? ((global::Doroti.Generated.Framework.Rendering.RenderBox)input__45103).size.height)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    {
        global::Doroti.Generated.Framework.Rendering.RenderBox? input__45494 = this.input;
        if ((input__45494 is null))
        {
            return 0.0;
        }
        _RenderDecorationLayout__input_decorator layout__45597 = ((_RenderDecorationLayout__input_decorator)(object?)_layout(constraints, layoutChild: (global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, Size>)global::Doroti.Generated.Framework.Rendering.ChildLayoutHelper.dryLayoutChild, getBaseline: (global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, double>)_getDryBaseline));
    ...
    {
        _RenderDecorationLayout__input_decorator layout__46309 = ((_RenderDecorationLayout__input_decorator)(object?)_layout(constraints, layoutChild: (global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, Size>)global::Doroti.Generated.Framework.Rendering.ChildLayoutHelper.dryLayoutChild, getBaseline: (global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, double>)_getDryBaseline));
    ...
    {
        global::Doroti.Generated.Framework.Rendering.BoxConstraints constraints__46556 = this.constraints;
        _labelTransform = null;
        _RenderDecorationLayout__input_decorator layout__46650 = ((_RenderDecorationLayout__input_decorator)(object?)_layout(constraints__46556, layoutChild: (global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, Size>)global::Doroti.Generated.Framework.Rendering.ChildLayoutHelper.layoutChild, getBaseline: (global::System.Func<global::Doroti.Generated.Framework.Rendering.RenderBox, global::Doroti.Generated.Framework.Rendering.BoxConstraints, double>)_getBaseline));
        ...
        global::Doroti.Generated.Framework.Rendering.RenderBox? container__47047 = this.container;
        if ((container__47047 is not null))
        {
            var containerConstraints__47116 = global::Doroti.Generated.Framework.Rendering.BoxConstraints.CreateTightFor(height: ((_RenderDecorationLayout__input_decorator)layout__46650).containerHeight, width: (overallWidth__46991 - _RenderDecoration__input_decorator._boxSize(this.icon).width));
            ...
            _RenderDecoration__input_decorator._boxParentData(container__47047).offset = new global::Doroti.Flutter.Ui.Offset(x__47352, 0.0);
        }
        double height__47556 = ((_RenderDecorationLayout__input_decorator)layout__46650).containerHeight;
        double centerLayout(global::Doroti.Generated.Framework.Rendering.RenderBox box, double x)
        {
            _RenderDecoration__input_decorator._boxParentData(box).offset = new global::Doroti.Flutter.Ui.Offset(x, (((height__47556 - ((global::Doroti.Generated.Framework.Rendering.RenderBox)box).size.height)) / 2.0));
            return ((global::Doroti.Generated.Framework.Rendering.RenderBox)box).size.width;
            throw new InvalidOperationException("Dart control flow completed without a value.");
        }
        if ((this.icon is not null))
        {
        ...
        global::Doroti.Generated.Framework.Rendering.RenderBox? counter__48088 = this.counter;
        ...
        switch (this.textDirection)
        {
            case TextDirection.ltr:
                {
                    start__48324 = (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start + _RenderDecoration__input_decorator._boxSize(this.icon).width);
                    end__48331 = (overallWidth__46991 - ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end);
                    _RenderDecoration__input_decorator._boxParentData(this.helperError).offset = new global::Doroti.Flutter.Ui.Offset((start__48324 + ((_Decoration__input_decorator)this.decoration).inputGap), (subtextBaseline__47987 - helperErrorBaseline__48129));
                    if ((counter__48088 is not null))
                    {
                        _RenderDecoration__input_decorator._boxParentData(counter__48088).offset = new global::Doroti.Flutter.Ui.Offset(((end__48331 - ((global::Doroti.Generated.Framework.Rendering.RenderBox)counter__48088).size.width) - ((_Decoration__input_decorator)this.decoration).inputGap), (subtextBaseline__47987 - counterBaseline__48229));
                    }
                    break;
                }
            case TextDirection.rtl:
                {
                    start__48324 = ((overallWidth__46991 - ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start) - _RenderDecoration__input_decorator._boxSize(this.icon).width);
                    end__48331 = ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end;
                    _RenderDecoration__input_decorator._boxParentData(this.helperError).offset = new global::Doroti.Flutter.Ui.Offset(((start__48324 - ((global::Doroti.Generated.Framework.Rendering.RenderBox)this.helperError).size.width) - ((_Decoration__input_decorator)this.decoration).inputGap), (subtextBaseline__47987 - helperErrorBaseline__48129));
                    if ((counter__48088 is not null))
                    {
                        _RenderDecoration__input_decorator._boxParentData(counter__48088).offset = new global::Doroti.Flutter.Ui.Offset((end__48331 + ((_Decoration__input_decorator)this.decoration).inputGap), (subtextBaseline__47987 - counterBaseline__48229));
                    }
                    break;
                }
        }
        double baseline__49401 = ((_RenderDecorationLayout__input_decorator)layout__46650).baseline;
        double baselineLayout(global::Doroti.Generated.Framework.Rendering.RenderBox box, double x)
        {
            _RenderDecoration__input_decorator._boxParentData(box).offset = new global::Doroti.Flutter.Ui.Offset(x, (baseline__49401 - DartRuntimePrimitives.RequireValue(box.getDistanceToBaseline(TextBaseline.alphabetic))));
            return ((global::Doroti.Generated.Framework.Rendering.RenderBox)box).size.width;
            throw new InvalidOperationException("Dart control flow completed without a value.");
        }
        switch (this.textDirection)
            ...
            case TextDirection.rtl:
                {
                    if ((this.prefixIcon is not null))
                    {
                        start__48324 += ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start;
                ...
                case TextDirection.rtl:
                    {
                        ...
                        {
                            offsetToPrefixIcon__52609 = (this.material3 ? (_RenderDecoration__input_decorator._boxSize(this.prefixIcon).width - ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end) : 0);
                        }
                ...
                case TextDirection.ltr:
                    {
                        ...
                        if (((this.prefixIcon is not null) && !((_Decoration__input_decorator)this.decoration).alignLabelWithHint))
                        {
                            offsetToPrefixIcon__53325 = (this.material3 ? ((-_RenderDecoration__input_decorator._boxSize(this.prefixIcon).width + ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start)) : 0);
                        }
    ...
    internal virtual void _paintLabel(global::Doroti.Generated.Framework.Rendering.PaintingContext context, Offset offset)
    {
    ...
    public override void paint(global::Doroti.Generated.Framework.Rendering.PaintingContext context, Offset offset)
    {
        ...
        if ((this.label is not null))
        {
            global::Doroti.Flutter.Ui.Offset labelOffset__54368 = ((global::Doroti.Flutter.Ui.Offset)(object?)_RenderDecoration__input_decorator._boxParentData(this.label!).offset);
            ...
            global::Doroti.Generated.Framework.Painting.BorderSide borderSide__54752 = ((_Decoration__input_decorator)this.decoration).border.borderSide;
            ...
            double outlinedFloatingY__55189 = ((((-labelHeight__54432 * Input_decoratorLibrary._kFinalLabelScale)) / 2.0) - (((global::Doroti.Generated.Framework.Painting.BorderSide)borderSide__54752).strokeOffset / 2.0));
            double floatingY__55312 = (isOutlineBorder__54984 ? outlinedFloatingY__55189 : (((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).top + (this._densityOffset.dy / 2L)));
                ...
                case TextDirection.rtl:
                    {
                        ...
                        {
                            floatStartX__55670 += (this.material3 ? (_RenderDecoration__input_decorator._boxSize(this.prefixIcon).width - ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).end) : 0.0);
                        }
                        break;
                    }
                case TextDirection.ltr:
                    {
                        ...
                        if ((((this.prefixIcon is not null) && !((_Decoration__input_decorator)this.decoration).alignLabelWithHint) && isOutlineBorder__54984))
                        {
                            floatStartX__55670 += (this.material3 ? (-_RenderDecoration__input_decorator._boxSize(this.prefixIcon).width + ((global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional)this.contentPadding).start) : 0.0);
                        }
                        break;
                    }
            }
...
{            var __cascade = Matrix4.identity();
            ...
            return __cascade;        }))();
            layer = context.pushTransform(this.needsCompositing, offset, this._labelTransform!, (global::System.Action<global::Doroti.Generated.Framework.Rendering.PaintingContext, Offset>)this._paintLabel, oldLayer: ((global::Doroti.Generated.Framework.Rendering.TransformLayer?)(object?)this.layer)!);
        }
        else
        {
            layer = null;
    ...
    public override void applyPaintTransform(global::Doroti.Generated.Framework.Rendering.RenderObject child, Matrix4 transform)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Offset labelOffset__57370 = ((global::Doroti.Flutter.Ui.Offset)(object?)_RenderDecoration__input_decorator._boxParentData(this.label!).offset);
...
{            var __cascade = transform;
    ...
    {
        foreach (global::Doroti.Generated.Framework.Rendering.RenderBox child__57770 in this.children)
        {
            global::Doroti.Flutter.Ui.Offset offset__57883 = ((global::Doroti.Flutter.Ui.Offset)(object?)_RenderDecoration__input_decorator._boxParentData(child__57770).offset);
            bool isHit__57939 = result.addWithPaintOffset(offset: offset__57883, position: position, hitTest: ((global::System.Func<global::Doroti.Generated.Framework.Rendering.BoxHitTestResult, Offset, bool>)((result, transformed) => {
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    internal virtual global::Doroti.Generated.Framework.Semantics.ChildSemanticsConfigurationsResult _childSemanticsConfigurationDelegate(List<global::Doroti.Generated.Framework.Semantics.SemanticsConfiguration> childConfigs)
    {
        var builder__58441 = new global::Doroti.Generated.Framework.Semantics.ChildSemanticsConfigurationsResultBuilder();
        var mergeGroups__58507 = new DartMap<global::Doroti.Generated.Framework.Semantics.SemanticsTag, List<global::Doroti.Generated.Framework.Semantics.SemanticsConfiguration>>();
        var tags__58579 = new HashSet<global::Doroti.Generated.Framework.Semantics.SemanticsTag> { _InputDecoratorState__input_decorator._kPrefixSemanticsTag, _InputDecoratorState__input_decorator._kPrefixIconSemanticsTag, _InputDecoratorState__input_decorator._kSuffixSemanticsTag, _InputDecoratorState__input_decorator._kSuffixIconSemanticsTag };
        foreach (var childConfig__58829 in childConfigs)
        {
            global::Doroti.Generated.Framework.Semantics.SemanticsTag? tag__58886 = tags__58579.firstWhereOrNull(((tag) => childConfig__58829.tagsChildrenWith(tag)));
            if ((tag__58886 is not null))
            {
                mergeGroups__58507.putIfAbsent(tag__58886, (() => new List<global::Doroti.Generated.Framework.Semantics.SemanticsConfiguration>())).Add(childConfig__58829);
            }
            else
            {
        ...
        mergeGroups__58507.Values.forEach((__arg0) => ((global::System.Action<List<global::Doroti.Generated.Framework.Semantics.SemanticsConfiguration>>)((global::Doroti.Generated.Framework.Semantics.ChildSemanticsConfigurationsResultBuilder)builder__58441).markAsSiblingMergeGroup)(__arg0));
        return ((global::Doroti.Generated.Framework.Semantics.ChildSemanticsConfigurationsResult)(object?)builder__58441.build());
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    {
        config.childConfigurationsDelegate = (global::System.Func<List<global::Doroti.Generated.Framework.Semantics.SemanticsConfiguration>, global::Doroti.Generated.Framework.Semantics.ChildSemanticsConfigurationsResult>)this._childSemanticsConfigurationDelegate;
    }

    public virtual global::Doroti.Generated.Framework.Rendering.RenderBox? childForSlot(_DecorationSlot__input_decorator slot) => this._slotToChild.GetValueOrDefault(slot);
    ...
    public override List<global::Doroti.Generated.Framework.Foundation.DiagnosticsNode> debugDescribeChildren()
    {
        ...
        var childToSlot__7440 = new DartMap<global::Doroti.Generated.Framework.Rendering.RenderBox, _DecorationSlot__input_decorator>(this._slotToChild.Values, this._slotToChild.Keys);
    ...
    public virtual void _setChild(global::Doroti.Generated.Framework.Rendering.RenderBox? child, _DecorationSlot__input_decorator slot)
    {
    ...
    public virtual void _moveChild(global::Doroti.Generated.Framework.Rendering.RenderBox child, _DecorationSlot__input_decorator slot, _DecorationSlot__input_decorator oldSlot)
    {
...
internal class _Decorator__input_decorator : global::Doroti.Generated.Framework.Widgets.SlottedMultiChildRenderObjectWidget<_DecorationSlot__input_decorator, global::Doroti.Generated.Framework.Rendering.RenderBox>
{
    ...
    internal _Decorator__input_decorator(global::Doroti.Generated.Framework.Painting.TextAlignVertical? textAlignVertical, _Decoration__input_decorator decoration, TextDirection textDirection, TextBaseline textBaseline, bool isFocused, bool expands)
    {
    ...
    public override global::Doroti.Generated.Framework.Widgets.Widget? childForSlot(_DecorationSlot__input_decorator slot)
    {
    ...
    {
        return ((global::Doroti.Generated.Framework.Rendering.RenderObject)(object?)new _RenderDecoration__input_decorator(decoration: this.decoration, textDirection: this.textDirection, textBaseline: this.textBaseline, textAlignVertical: this.textAlignVertical, isFocused: this.isFocused, expands: this.expands, material3: Theme.of(context).useMaterial3));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual void updateRenderObject(global::Doroti.Generated.Framework.Widgets.BuildContext context, global::Doroti.Generated.Framework.Widgets.SlottedContainerRenderObjectMixin<_DecorationSlot__input_decorator, global::Doroti.Generated.Framework.Rendering.RenderBox> renderObject)
    {
...
internal class _AffixText__input_decorator : global::Doroti.Generated.Framework.Widgets.StatelessWidget
{
    ...
    public virtual global::Doroti.Generated.Framework.Semantics.SemanticsSortKey? semanticsSortKey { get; private set; }
    public virtual global::Doroti.Generated.Framework.Semantics.SemanticsTag semanticsTag { get; private set; } = default!;

    internal _AffixText__input_decorator(bool labelIsFloating, string? text = null, global::Doroti.Generated.Framework.Painting.TextStyle? style = null, global::Doroti.Generated.Framework.Widgets.Widget? child = null, global::Doroti.Generated.Framework.Semantics.SemanticsSortKey? semanticsSortKey = null, global::Doroti.Generated.Framework.Semantics.SemanticsTag semanticsTag = default!)
    {
    ...
    public override global::Doroti.Generated.Framework.Widgets.Widget build(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)DefaultTextStyle.merge(style: this.style, child: new global::Doroti.Generated.Framework.Widgets.IgnorePointer(ignoring: !this.labelIsFloating, child: new global::Doroti.Generated.Framework.Widgets.AnimatedOpacity(duration: Input_decoratorLibrary._kTransitionDuration, curve: Input_decoratorLibrary._kTransitionCurve, opacity: (this.labelIsFloating ? 1.0 : 0.0), child: new global::Doroti.Generated.Framework.Widgets.Semantics(sortKey: this.semanticsSortKey, tagForChildren: this.semanticsTag, child: (this.child ?? (((this.text is null) ? null : new global::Doroti.Generated.Framework.Widgets.Text(this.text!, style: this.style)))))))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

}

public class InputDecorator : global::Doroti.Generated.Framework.Widgets.StatefulWidget
{
    public virtual InputDecoration decoration { get; private set; } = default!;
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? baseStyle { get; private set; }
    public virtual TextAlign? textAlign { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.TextAlignVertical? textAlignVertical { get; private set; }
    public virtual bool isFocused { get; private set; } = default!;
    public virtual bool isHovering { get; private set; } = default!;
    ...
    public InputDecorator(global::Doroti.Generated.Framework.Foundation.Key? key = null, InputDecoration decoration = default!, global::Doroti.Generated.Framework.Painting.TextStyle? baseStyle = null, TextAlign? textAlign = null, global::Doroti.Generated.Framework.Painting.TextAlignVertical? textAlignVertical = null, bool isFocused = false, bool isHovering = false, bool expands = false, bool isEmpty = false, global::Doroti.Generated.Framework.Widgets.Widget? child = null) : base(key: key)
    {
        this.decoration = decoration;
    ...
    public static global::Doroti.Generated.Framework.Rendering.RenderBox? containerOf(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<InputDecoration>("decoration", this.decoration));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("baseStyle", this.baseStyle, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<bool>("isFocused", this.isFocused));
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<bool>("isEmpty", this.isEmpty));
    }

}

internal class _InputDecoratorState__input_decorator : global::Doroti.Generated.Framework.Widgets.State<InputDecorator>, global::Doroti.Generated.Framework.Widgets.TickerProviderStateMixin<InputDecorator>
{
    internal virtual global::Doroti.Generated.Framework.Animation.AnimationController _floatingLabelController { get; private set; } = default!;
    internal virtual global::Doroti.Generated.Framework.Animation.CurvedAnimation _floatingLabelAnimation { get; private set; } = default!;
    internal virtual global::Doroti.Generated.Framework.Animation.AnimationController _shakingLabelController { get; private set; } = default!;
    ...
    private global::Doroti.Generated.Framework.Semantics.OrdinalSortKey __late__prefixSemanticsSortOrder = default!;
    internal virtual global::Doroti.Generated.Framework.Semantics.OrdinalSortKey _prefixSemanticsSortOrder
    {
        get
        {
            if (!__late__prefixSemanticsSortOrder_initialized)
            {
                __late__prefixSemanticsSortOrder = new global::Doroti.Generated.Framework.Semantics.OrdinalSortKey(0, name: GetHashCode().ToString());
    ...
    private global::Doroti.Generated.Framework.Semantics.OrdinalSortKey __late__inputSemanticsSortOrder = default!;
    internal virtual global::Doroti.Generated.Framework.Semantics.OrdinalSortKey _inputSemanticsSortOrder
    {
        get
        {
            if (!__late__inputSemanticsSortOrder_initialized)
            {
                __late__inputSemanticsSortOrder = new global::Doroti.Generated.Framework.Semantics.OrdinalSortKey(1, name: GetHashCode().ToString());
    ...
    private global::Doroti.Generated.Framework.Semantics.OrdinalSortKey __late__suffixSemanticsSortOrder = default!;
    internal virtual global::Doroti.Generated.Framework.Semantics.OrdinalSortKey _suffixSemanticsSortOrder
    {
        get
        {
            if (!__late__suffixSemanticsSortOrder_initialized)
            {
                __late__suffixSemanticsSortOrder = new global::Doroti.Generated.Framework.Semantics.OrdinalSortKey(2, name: GetHashCode().ToString());
                __late__suffixSemanticsSortOrder_initialized = true;
            }
            return __late__suffixSemanticsSortOrder;
        }
    }
    internal static global::Doroti.Generated.Framework.Semantics.SemanticsTag _kPrefixSemanticsTag = new global::Doroti.Generated.Framework.Semantics.SemanticsTag("_InputDecoratorState.prefix");
    internal static global::Doroti.Generated.Framework.Semantics.SemanticsTag _kPrefixIconSemanticsTag = new global::Doroti.Generated.Framework.Semantics.SemanticsTag("_InputDecoratorState.prefixIcon");
    internal static global::Doroti.Generated.Framework.Semantics.SemanticsTag _kSuffixSemanticsTag = new global::Doroti.Generated.Framework.Semantics.SemanticsTag("_InputDecoratorState.suffix");
    internal static global::Doroti.Generated.Framework.Semantics.SemanticsTag _kSuffixIconSemanticsTag = new global::Doroti.Generated.Framework.Semantics.SemanticsTag("_InputDecoratorState.suffixIcon");
    ...
    {
        base.initState();
        _floatingLabelController = new global::Doroti.Generated.Framework.Animation.AnimationController(duration: Input_decoratorLibrary._kTransitionDuration, vsync: this);
        this._floatingLabelController.addListener(() => this._handleChange());
        _floatingLabelAnimation = new global::Doroti.Generated.Framework.Animation.CurvedAnimation(parent: this._floatingLabelController, curve: Input_decoratorLibrary._kTransitionCurve, reverseCurve: ((global::Doroti.Generated.Framework.Animation.Curve)Input_decoratorLibrary._kTransitionCurve).flipped);
        _shakingLabelController = new global::Doroti.Generated.Framework.Animation.AnimationController(duration: Input_decoratorLibrary._kTransitionDuration, vsync: this);
    }
    ...
    public virtual global::Doroti.Flutter.Ui.TextAlign? textAlign => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.TextAlign>(((InputDecorator)this.widget).textAlign);
...
{            var __cascade = this._shakingLabelController;
    ...
    internal virtual global::Doroti.Flutter.Ui.Color _getDefaultM2BorderColor(ThemeData themeData)
    {
        if ((!((InputDecoration)this.decoration).enabled && !this.isFocused))
        {
            return ((global::Doroti.Flutter.Ui.Color)(object?)(((((((InputDecoration)this.decoration).filled ?? false)) && !((((InputDecoration)this.decoration).border?.isOutline ?? false)))) ? Colors.transparent : themeData.disabledColor));
        }
        if (this._hasError)
        {
            return ((global::Doroti.Flutter.Ui.Color)(object?)themeData.colorScheme.error);
        }
        if (this.isFocused)
        {
            return ((global::Doroti.Flutter.Ui.Color)(object?)themeData.colorScheme.primary);
        }
        if (DartRuntimePrimitives.RequireValue(((InputDecoration)this.decoration).filled))
        {
            return ((global::Doroti.Flutter.Ui.Color)(object?)themeData.hintColor);
        }
        global::Doroti.Flutter.Ui.Color enabledColor__72859 = ((global::Doroti.Flutter.Ui.Color)(object?)themeData.colorScheme.onSurface.withOpacity(0.38));
        if (this.isHovering)
        {
            global::Doroti.Flutter.Ui.Color hoverColor__72965 = ((global::Doroti.Flutter.Ui.Color)(object?)(((InputDecoration)this.decoration).hoverColor ?? themeData.hoverColor));
            return ((global::Doroti.Flutter.Ui.Color)(object?)Dart_uiLibrary.Color.alphaBlend(hoverColor__72965.withOpacity(0.12), enabledColor__72859));
        }
        return ((global::Doroti.Flutter.Ui.Color)(object?)enabledColor__72859);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Flutter.Ui.Color _getFillColor(ThemeData themeData, InputDecorationThemeData defaults)
    {
        ...
        {
            return ((global::Doroti.Flutter.Ui.Color)(object?)WidgetStateProperty.resolveAs(((InputDecoration)this.decoration).fillColor!, this.widgetState));
        }
        return ((global::Doroti.Flutter.Ui.Color)(object?)WidgetStateProperty.resolveAs(((InputDecorationThemeData)defaults).fillColor!, this.widgetState));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Flutter.Ui.Color _getHoverColor(ThemeData themeData)
    {
        ...
        return ((global::Doroti.Flutter.Ui.Color)(object?)(((InputDecoration)this.decoration).hoverColor ?? themeData.hoverColor));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Flutter.Ui.Color _getIconColor(ThemeData themeData, InputDecorationThemeData defaults)
    {
        return ((global::Doroti.Flutter.Ui.Color)(object?)((WidgetStateProperty.resolveAs(((InputDecoration)this.decoration).iconColor, this.widgetState) ?? (Color)WidgetStateProperty.resolveAs(((InputDecorationThemeData)defaults).iconColor!, this.widgetState))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Flutter.Ui.Color _getPrefixIconColor(IconButtonThemeData iconButtonTheme, InputDecorationThemeData defaults)
    {
        return ((global::Doroti.Flutter.Ui.Color)(object?)((((WidgetStateProperty.resolveAs(((InputDecoration)this.decoration).prefixIconColor, this.widgetState) ?? (Color)iconButtonTheme.style?.foregroundColor?.resolve(this.widgetState))) ?? (Color)WidgetStateProperty.resolveAs(((InputDecorationThemeData)defaults).prefixIconColor!, this.widgetState))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Flutter.Ui.Color _getSuffixIconColor(IconButtonThemeData iconButtonTheme, InputDecorationThemeData defaults)
    {
    ...
    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle _getInlineLabelStyle(ThemeData themeData, InputDecorationThemeData defaults)
    {
        global::Doroti.Generated.Framework.Painting.TextStyle defaultStyle__75471 = ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)WidgetStateProperty.resolveAs(((InputDecorationThemeData)defaults).labelStyle!, this.widgetState));
        global::Doroti.Generated.Framework.Painting.TextStyle? style__75574 = ((global::Doroti.Generated.Framework.Painting.TextStyle?)(object?)WidgetStateProperty.resolveAs(((InputDecoration)this.decoration).labelStyle, this.widgetState));
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)themeData.textTheme.titleMedium!.merge(((InputDecorator)this.widget).baseStyle).merge(defaultStyle__75471).merge(style__75574).copyWith(height: 1));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle _getInlineHintStyle(ThemeData themeData, InputDecorationThemeData defaults)
    {
        global::Doroti.Generated.Framework.Painting.TextStyle defaultStyle__76057 = ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)WidgetStateProperty.resolveAs(((InputDecorationThemeData)defaults).hintStyle!, this.widgetState));
        global::Doroti.Generated.Framework.Painting.TextStyle? style__76159 = ((global::Doroti.Generated.Framework.Painting.TextStyle?)(object?)WidgetStateProperty.resolveAs(((InputDecoration)this.decoration).hintStyle, this.widgetState));
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)((themeData.useMaterial3 ? themeData.textTheme.bodyLarge! : themeData.textTheme.titleMedium!)).merge(((InputDecorator)this.widget).baseStyle).merge(defaultStyle__76057).merge(style__76159));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle _getFloatingLabelStyle(ThemeData themeData, InputDecorationThemeData defaults)
    {
        global::Doroti.Generated.Framework.Painting.TextStyle defaultTextStyle__76559 = ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)WidgetStateProperty.resolveAs(((InputDecorationThemeData)defaults).floatingLabelStyle!, this.widgetState));
        ...
        global::Doroti.Generated.Framework.Painting.TextStyle? style__76965 = ((global::Doroti.Generated.Framework.Painting.TextStyle?)(object?)WidgetStateProperty.resolveAs(((InputDecoration)this.decoration).floatingLabelStyle, this.widgetState));
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)themeData.textTheme.titleMedium!.merge(((InputDecorator)this.widget).baseStyle).merge(defaultTextStyle__76559).merge(style__76965).copyWith(height: 1));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle _getHelperStyle(ThemeData themeData, InputDecorationThemeData defaults)
    {
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)WidgetStateProperty.resolveAs(((InputDecorationThemeData)defaults).helperStyle!, this.widgetState).merge(WidgetStateProperty.resolveAs(((InputDecoration)this.decoration).helperStyle, this.widgetState)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle _getErrorStyle(ThemeData themeData, InputDecorationThemeData defaults)
    {
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)WidgetStateProperty.resolveAs(((InputDecorationThemeData)defaults).errorStyle!, this.widgetState).merge(((InputDecoration)this.decoration).errorStyle));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState> widgetState => ((Func<HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState>>)(() => { var __collection77750 = new HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState>(); if (!((InputDecoration)this.decoration).enabled) { __collection77750.Add(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled); } if (this.isFocused) { __collection77750.Add(global::Doroti.Generated.Framework.Widgets.WidgetState.focused); } if (this.isHovering) { __collection77750.Add(global::Doroti.Generated.Framework.Widgets.WidgetState.hovered); } if (this._hasError) { __collection77750.Add(global::Doroti.Generated.Framework.Widgets.WidgetState.error); } return __collection77750; }))();
    internal virtual InputBorder _getDefaultBorder(ThemeData themeData, InputDecorationThemeData defaults)
    {
        ...
        if ((((InputDecoration)this.decoration).border is global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<InputBorder>))
        {
            return border__78053;
        }
        if ((object.Equals(border__78053.borderSide, global::Doroti.Generated.Framework.Painting.BorderSide.none)))
        {
            return border__78053;
        }
        ...
        {
            return border__78053.copyWith(borderSide: new global::Doroti.Generated.Framework.Painting.BorderSide(color: _getDefaultM2BorderColor(themeData), width: (((((DartRuntimePrimitives.RequireValue(((InputDecoration)this.decoration).isCollapsed)) || (object.Equals(((InputDecoration)this.decoration).border, InputBorder.none))) || !((InputDecoration)this.decoration).enabled)) ? 0.0 : (this.isFocused ? 2.0 : 1.0))));
        }
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Generated.Framework.Widgets.FadeTransition _buildTransition(global::Doroti.Generated.Framework.Widgets.Widget child, global::Doroti.Generated.Framework.Animation.Animation<double> animation)
    {
        if ((!object.Equals(this._curvedAnimation?.parent, animation)))
        {
            this._curvedAnimation?.dispose();
            _curvedAnimation = new global::Doroti.Generated.Framework.Animation.CurvedAnimation(parent: animation, curve: Input_decoratorLibrary._kTransitionCurve);
        }
        return new global::Doroti.Generated.Framework.Widgets.FadeTransition(opacity: this._curvedAnimation!, child: child);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal static global::Doroti.Generated.Framework.Widgets.Widget _topStartLayout(global::Doroti.Generated.Framework.Widgets.Widget? currentChild, List<global::Doroti.Generated.Framework.Widgets.Widget> previousChildren)
    {
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.Stack(children: ((Func<List<global::Doroti.Generated.Framework.Widgets.Widget>>)(() => { var __collection79764 = new List<global::Doroti.Generated.Framework.Widgets.Widget>(); __collection79764.AddRange(previousChildren); var __collectionElement79794 = currentChild; if (__collectionElement79794 is { } __nonNullCollectionElement79794) { __collection79764.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(__nonNullCollectionElement79794)); } return __collection79764; }))()));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override global::Doroti.Generated.Framework.Widgets.Widget build(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Generated.Framework.Painting.TextStyle labelStyle__80321 = ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)_getInlineLabelStyle(themeData__79887, defaults__80108));
        global::Doroti.Flutter.Ui.TextBaseline textBaseline__80400 = DartRuntimePrimitives.RequireValue(((global::Doroti.Generated.Framework.Painting.TextStyle)labelStyle__80321).textBaseline);
        global::Doroti.Generated.Framework.Painting.TextStyle hintStyle__80462 = ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)_getInlineHintStyle(themeData__79887, defaults__80108));
        ...
        global::Doroti.Generated.Framework.Widgets.Widget? hint__80641 = default!;
        if (((((InputDecoration)this.decoration).hint is not null) || (hintText__80534 is not null)))
        {
            global::Doroti.Generated.Framework.Widgets.Widget hintWidget__80721 = (((InputDecoration)this.decoration).hint ?? new global::Doroti.Generated.Framework.Widgets.Text(hintText__80534!, style: hintStyle__80462, textDirection: ((InputDecoration)this.decoration).hintTextDirection, overflow: (((global::Doroti.Generated.Framework.Painting.TextStyle)hintStyle__80462).overflow ?? (((((InputDecoration)this.decoration).hintMaxLines is null) ? null : global::Doroti.Generated.Framework.Painting.TextOverflow.ellipsis))), textAlign: this.textAlign, maxLines: ((InputDecoration)this.decoration).hintMaxLines));
            bool showHint__81142 = (this.isEmpty && !this._hasInlineLabel);
            hint__80641 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>((maintainHintSize__80581 ? new global::Doroti.Generated.Framework.Widgets.AnimatedOpacity(opacity: (showHint__81142 ? 1.0 : 0.0), duration: (((InputDecoration)this.decoration).hintFadeDuration ?? Input_decoratorLibrary._kHintFadeTransitionDuration), curve: Input_decoratorLibrary._kTransitionCurve, child: hintWidget__80721) : new global::Doroti.Generated.Framework.Widgets.AnimatedSwitcher(duration: (((InputDecoration)this.decoration).hintFadeDuration ?? Input_decoratorLibrary._kHintFadeTransitionDuration), transitionBuilder: (global::System.Func<global::Doroti.Generated.Framework.Widgets.Widget, global::Doroti.Generated.Framework.Animation.Animation<double>, global::Doroti.Generated.Framework.Widgets.FadeTransition>)this._buildTransition, layoutBuilder: (global::System.Func<global::Doroti.Generated.Framework.Widgets.Widget?, List<global::Doroti.Generated.Framework.Widgets.Widget>, global::Doroti.Generated.Framework.Widgets.Widget>)_topStartLayout, child: (showHint__81142 ? hintWidget__80721 : global::Doroti.Generated.Framework.Widgets.SizedBox.CreateShrink()))));
        }
        ...
        global::Doroti.Generated.Framework.Widgets.Widget container__82180 = ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new _BorderContainer__input_decorator(border: border__81779, gap: this._borderGap, gapAnimation: this._floatingLabelAnimation, fillColor: _getFillColor(themeData__79887, defaults__80108), hoverColor: _getHoverColor(themeData__79887), isHovering: this.isHovering));
        global::Doroti.Generated.Framework.Widgets.Widget? label__82448 = default!;
        if ((((((object?)((InputDecoration)this.decoration).labelText ?? (object?)((InputDecoration)this.decoration).label))) is not null))
        {
            label__82448 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(new global::Doroti.Generated.Framework.Widgets.MatrixTransition(animation: this._shakingLabelController, onTransform: ((global::System.Func<double, Matrix4>)((value) => {
...
throw new InvalidOperationException("Dart closure completed without a value.");
})), child: new global::Doroti.Generated.Framework.Widgets.AnimatedOpacity(duration: Input_decoratorLibrary._kTransitionDuration, curve: Input_decoratorLibrary._kTransitionCurve, opacity: (this._shouldShowLabel ? 1.0 : 0.0), child: new global::Doroti.Generated.Framework.Widgets.AnimatedDefaultTextStyle(duration: Input_decoratorLibrary._kTransitionDuration, curve: Input_decoratorLibrary._kTransitionCurve, style: (this.labelShouldWithdraw ? _getFloatingLabelStyle(themeData__79887, defaults__80108) : labelStyle__80321), child: (((InputDecoration)this.decoration).label ?? new global::Doroti.Generated.Framework.Widgets.Text(((InputDecoration)this.decoration).labelText!, overflow: global::Doroti.Generated.Framework.Painting.TextOverflow.ellipsis, textAlign: this.textAlign))))));
        }
        ...
        global::Doroti.Generated.Framework.Widgets.Widget? input__83759 = ((InputDecorator)this.widget).child;
        ...
        global::Doroti.Generated.Framework.Widgets.Widget? icon__85204 = ((global::Doroti.Generated.Framework.Widgets.Widget?)(object?)((((InputDecoration)this.decoration).icon is null) ? null : new global::Doroti.Generated.Framework.Widgets.MouseRegion(cursor: global::Doroti.Generated.Framework.Services.SystemMouseCursors.basic, child: new global::Doroti.Generated.Framework.Widgets.Padding(padding: global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional.CreateOnly(end: 16.0), child: IconTheme.merge(data: new global::Doroti.Generated.Framework.Widgets.IconThemeData(color: _getIconColor(themeData__79887, defaults__80108), size: iconSize__85141), child: ((InputDecoration)this.decoration).icon!)))));
        global::Doroti.Generated.Framework.Widgets.Widget? prefixIcon__85654 = ((global::Doroti.Generated.Framework.Widgets.Widget?)(object?)((((InputDecoration)this.decoration).prefixIcon is null) ? null : new global::Doroti.Generated.Framework.Widgets.Center(widthFactor: 1.0, heightFactor: 1.0, child: new global::Doroti.Generated.Framework.Widgets.MouseRegion(cursor: global::Doroti.Generated.Framework.Services.SystemMouseCursors.basic, child: new global::Doroti.Generated.Framework.Widgets.ConstrainedBox(constraints: (((InputDecoration)this.decoration).prefixIconConstraints ?? visualDensity__79942.effectiveConstraints(new global::Doroti.Generated.Framework.Rendering.BoxConstraints(minWidth: ConstantsLibrary.kMinInteractiveDimension, minHeight: ConstantsLibrary.kMinInteractiveDimension))), child: IconTheme.merge(data: new global::Doroti.Generated.Framework.Widgets.IconThemeData(color: _getPrefixIconColor(iconButtonTheme__80253, defaults__80108), size: iconSize__85141), child: new IconButtonTheme(data: new IconButtonThemeData(style: new ButtonStyle(foregroundColor: new global::Doroti.Generated.Framework.Widgets.WidgetStatePropertyAll<global::Doroti.Flutter.Ui.Color>(_getPrefixIconColor(iconButtonTheme__80253, defaults__80108)), iconSize: new global::Doroti.Generated.Framework.Widgets.WidgetStatePropertyAll<double?>(iconSize__85141)).merge(iconButtonTheme__80253.style)), child: new global::Doroti.Generated.Framework.Widgets.Semantics(tagForChildren: _kPrefixIconSemanticsTag, child: ((InputDecoration)this.decoration).prefixIcon))))))));
        global::Doroti.Generated.Framework.Widgets.Widget? suffixIcon__87211 = ((global::Doroti.Generated.Framework.Widgets.Widget?)(object?)((((InputDecoration)this.decoration).suffixIcon is null) ? null : new global::Doroti.Generated.Framework.Widgets.Center(widthFactor: 1.0, heightFactor: 1.0, child: new global::Doroti.Generated.Framework.Widgets.MouseRegion(cursor: global::Doroti.Generated.Framework.Services.SystemMouseCursors.basic, child: new global::Doroti.Generated.Framework.Widgets.ConstrainedBox(constraints: (((InputDecoration)this.decoration).suffixIconConstraints ?? visualDensity__79942.effectiveConstraints(new global::Doroti.Generated.Framework.Rendering.BoxConstraints(minWidth: ConstantsLibrary.kMinInteractiveDimension, minHeight: ConstantsLibrary.kMinInteractiveDimension))), child: IconTheme.merge(data: new global::Doroti.Generated.Framework.Widgets.IconThemeData(color: _getSuffixIconColor(iconButtonTheme__80253, defaults__80108), size: iconSize__85141), child: new IconButtonTheme(data: new IconButtonThemeData(style: new ButtonStyle(foregroundColor: new global::Doroti.Generated.Framework.Widgets.WidgetStatePropertyAll<global::Doroti.Flutter.Ui.Color>(_getSuffixIconColor(iconButtonTheme__80253, defaults__80108)), iconSize: new global::Doroti.Generated.Framework.Widgets.WidgetStatePropertyAll<double?>(iconSize__85141)).merge(iconButtonTheme__80253.style)), child: new global::Doroti.Generated.Framework.Widgets.Semantics(tagForChildren: _kSuffixIconSemanticsTag, child: ((InputDecoration)this.decoration).suffixIcon))))))));
        global::Doroti.Generated.Framework.Widgets.Widget helperError__88767 = ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new _HelperError__input_decorator(textAlign: this.textAlign, helper: ((InputDecoration)this.decoration).helper, helperText: ((InputDecoration)this.decoration).helperText, helperStyle: _getHelperStyle(themeData__79887, defaults__80108), helperMaxLines: ((InputDecoration)this.decoration).helperMaxLines, error: ((InputDecoration)this.decoration).error, errorText: ((InputDecoration)this.decoration).errorText, errorStyle: _getErrorStyle(themeData__79887, defaults__80108), errorMaxLines: ((InputDecoration)this.decoration).errorMaxLines));
        global::Doroti.Generated.Framework.Widgets.Widget? counter__89195 = default!;
        ...
        else
        {
            ...
            {
                counter__89195 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(new global::Doroti.Generated.Framework.Widgets.Semantics(container: true, liveRegion: this.isFocused, child: new global::Doroti.Generated.Framework.Widgets.Text(((InputDecoration)this.decoration).counterText!, style: _getHelperStyle(themeData__79887, defaults__80108).merge(WidgetStateProperty.resolveAs(((InputDecoration)this.decoration).counterStyle, this.widgetState)), overflow: global::Doroti.Generated.Framework.Painting.TextOverflow.ellipsis, semanticsLabel: ((InputDecoration)this.decoration).semanticCounterText)));
            }
        }
        global::Doroti.Flutter.Ui.TextDirection textDirection__89936 = Directionality.of(context);
        ...
        global::Doroti.Generated.Framework.Painting.EdgeInsets? resolvedPadding__90133 = ((global::Doroti.Generated.Framework.Painting.EdgeInsets?)(object?)((InputDecoration)this.decoration).contentPadding?.resolve(textDirection__89936));
        global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional? decorationContentPadding__90235 = ((resolvedPadding__90133 is null) ? null : new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional((flipHorizontal__89995 ? ((global::Doroti.Generated.Framework.Painting.EdgeInsets)resolvedPadding__90133).right : ((global::Doroti.Generated.Framework.Painting.EdgeInsets)resolvedPadding__90133).left), ((global::Doroti.Generated.Framework.Painting.EdgeInsets)resolvedPadding__90133).top, (flipHorizontal__89995 ? ((global::Doroti.Generated.Framework.Painting.EdgeInsets)resolvedPadding__90133).left : ((global::Doroti.Generated.Framework.Painting.EdgeInsets)resolvedPadding__90133).right), ((global::Doroti.Generated.Framework.Painting.EdgeInsets)resolvedPadding__90133).bottom));
        global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional contentPadding__90608 = default!;
        ...
        if (DartRuntimePrimitives.RequireValue(((InputDecoration)this.decoration).isCollapsed))
        {
            ...
            contentPadding__90608 = (decorationContentPadding__90235 ?? global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional.zero);
        }
        else
        {
            if (!border__81779.isOutline)
            {
                floatingLabelHeight__90641 = MediaQuery.textScalerOf(context).scale((4.0 + (0.75 * DartRuntimePrimitives.RequireValue(((global::Doroti.Generated.Framework.Painting.TextStyle)labelStyle__80321).fontSize))));
                if ((((InputDecoration)this.decoration).filled ?? false))
                {
                    contentPadding__90608 = (decorationContentPadding__90235 ?? ((useMaterial3__80026 ? (decorationIsDense__85082 ? new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(12.0, 4.0, 12.0, 4.0) : new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(12.0, 8.0, 12.0, 8.0)) : (decorationIsDense__85082 ? new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(12.0, 8.0, 12.0, 8.0) : new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(12.0, 12.0, 12.0, 12.0)))));
                }
                else
                {
                    contentPadding__90608 = (decorationContentPadding__90235 ?? ((useMaterial3__80026 ? (decorationIsDense__85082 ? new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(0.0, 4.0, 0.0, 4.0) : new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(0.0, 8.0, 0.0, 8.0)) : (decorationIsDense__85082 ? new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(0.0, 8.0, 0.0, 8.0) : new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(0.0, 12.0, 0.0, 12.0)))));
                }
            }
            else
            {
                floatingLabelHeight__90641 = 0.0;
                contentPadding__90608 = (decorationContentPadding__90235 ?? ((useMaterial3__80026 ? (decorationIsDense__85082 ? new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(12.0, 16.0, 12.0, 8.0) : new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(12.0, 20.0, 12.0, 12.0)) : (decorationIsDense__85082 ? new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(12.0, 20.0, 12.0, 12.0) : new global::Doroti.Generated.Framework.Painting.EdgeInsetsDirectional(12.0, 24.0, 12.0, 16.0)))));
            }
        }
        ...
        var decorator__93091 = new _Decorator__input_decorator(decoration: new _Decoration__input_decorator(contentPadding: contentPadding__90608, isCollapsed: DartRuntimePrimitives.RequireValue(((InputDecoration)this.decoration).isCollapsed), inputGap: inputGap__92834, floatingLabelHeight: floatingLabelHeight__90641, floatingLabelAlignment: ((InputDecoration)this.decoration).floatingLabelAlignment!, floatingLabelProgress: ((global::Doroti.Generated.Framework.Animation.CurvedAnimation)this._floatingLabelAnimation).value, border: border__81779, borderGap: this._borderGap, alignLabelWithHint: (((InputDecoration)this.decoration).alignLabelWithHint ?? false), isDense: ((InputDecoration)this.decoration).isDense, isEmpty: this.isEmpty, visualDensity: visualDensity__79942, maintainHintSize: maintainHintSize__80581, maintainLabelSize: ((InputDecoration)this.decoration).maintainLabelSize, icon: icon__85204, input: input__83759, label: label__82448, hint: hint__80641, prefix: prefix__84042, suffix: suffix__84497, prefixIcon: prefixIcon__85654, suffixIcon: suffixIcon__87211, helperError: helperError__88767, counter: counter__89195, container: container__82180), textDirection: textDirection__89936, textBaseline: textBaseline__80400, textAlignVertical: ((InputDecorator)this.widget).textAlignVertical, isFocused: this.isFocused, expands: ((InputDecorator)this.widget).expands);
        string? semanticsHint__94938 = ((InputDecoration)this.decoration).errorText;
        global::Doroti.Generated.Framework.Widgets.Widget result__94994 = ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.Semantics(hint: semanticsHint__94938, child: decorator__93091));
        global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints__95080 = ((InputDecoration)this.decoration).constraints;
        if ((constraints__95080 is not null))
        {
            return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.ConstrainedBox(constraints: constraints__95080, child: result__94994));
        }
...
public class InputDecoration
{
    ...
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? helper { get; private set; }
    public virtual string? helperText { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle { get; private set; }
    public virtual long? helperMaxLines { get; private set; }
    ...
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? hint { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle { get; private set; }
    ...
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? prefixIcon { get; private set; }
    public virtual global::Doroti.Generated.Framework.Rendering.BoxConstraints? prefixIconConstraints { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? prefix { get; private set; }
    public virtual string? prefixText { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? prefixStyle { get; private set; }
    public virtual Color? prefixIconColor { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? suffixIcon { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? suffix { get; private set; }
    public virtual string? suffixText { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? suffixStyle { get; private set; }
    public virtual Color? suffixIconColor { get; private set; }
    public virtual global::Doroti.Generated.Framework.Rendering.BoxConstraints? suffixIconConstraints { get; private set; }
    public virtual string? counterText { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.Widget? counter { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? counterStyle { get; private set; }
    ...
    public InputDecoration(global::Doroti.Generated.Framework.Widgets.Widget? icon = null, Color? iconColor = null, global::Doroti.Generated.Framework.Widgets.Widget? label = null, string? labelText = null, global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle = null, global::Doroti.Generated.Framework.Widgets.Widget? helper = null, string? helperText = null, global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle = null, long? helperMaxLines = null, string? hintText = null, global::Doroti.Generated.Framework.Widgets.Widget? hint = null, global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle = null, TextDirection? hintTextDirection = null, long? hintMaxLines = null, Duration? hintFadeDuration = null, bool maintainHintHeight = true, bool maintainHintSize = true, bool maintainLabelSize = false, global::Doroti.Generated.Framework.Widgets.Widget? error = null, string? errorText = null, global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle = null, long? errorMaxLines = null, FloatingLabelBehavior? floatingLabelBehavior = null, FloatingLabelAlignment? floatingLabelAlignment = null, bool? isCollapsed = null, bool? isDense = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? contentPadding = null, global::Doroti.Generated.Framework.Widgets.Widget? prefixIcon = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? prefixIconConstraints = null, global::Doroti.Generated.Framework.Widgets.Widget? prefix = null, string? prefixText = null, global::Doroti.Generated.Framework.Painting.TextStyle? prefixStyle = null, Color? prefixIconColor = null, global::Doroti.Generated.Framework.Widgets.Widget? suffixIcon = null, global::Doroti.Generated.Framework.Widgets.Widget? suffix = null, string? suffixText = null, global::Doroti.Generated.Framework.Painting.TextStyle? suffixStyle = null, Color? suffixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? suffixIconConstraints = null, global::Doroti.Generated.Framework.Widgets.Widget? counter = null, string? counterText = null, global::Doroti.Generated.Framework.Painting.TextStyle? counterStyle = null, bool? filled = null, Color? fillColor = null, Color? focusColor = null, Color? hoverColor = null, InputBorder? errorBorder = null, InputBorder? focusedBorder = null, InputBorder? focusedErrorBorder = null, InputBorder? disabledBorder = null, InputBorder? enabledBorder = null, InputBorder? border = null, bool enabled = true, string? semanticCounterText = null, bool? alignLabelWithHint = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null, VisualDensity? visualDensity = null)
    {
        this.icon = icon;
    ...
    public static InputDecoration CreateCollapsed(string? hintText, FloatingLabelBehavior? floatingLabelBehavior = null, FloatingLabelAlignment? floatingLabelAlignment = null, global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle = null, global::Doroti.Generated.Framework.Widgets.Widget? hint = null, TextDirection? hintTextDirection = null, long? hintMaxLines = null, Duration? hintFadeDuration = null, bool maintainHintHeight = true, bool maintainHintSize = true, bool maintainLabelSize = false, bool? filled = false, Color? fillColor = null, Color? focusColor = null, Color? hoverColor = null, InputBorder? border = default!, bool enabled = true, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null)
    {
        ...
        __instance.contentPadding = global::Doroti.Generated.Framework.Painting.EdgeInsets.zero;
    ...
    public virtual InputDecoration copyWith(global::Doroti.Generated.Framework.Widgets.Widget? icon = null, Color? iconColor = null, global::Doroti.Generated.Framework.Widgets.Widget? label = null, string? labelText = null, global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle = null, global::Doroti.Generated.Framework.Widgets.Widget? helper = null, string? helperText = null, global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle = null, long? helperMaxLines = null, string? hintText = null, global::Doroti.Generated.Framework.Widgets.Widget? hint = null, global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle = null, TextDirection? hintTextDirection = null, Duration? hintFadeDuration = null, long? hintMaxLines = null, bool? maintainHintHeight = null, bool? maintainHintSize = null, bool? maintainLabelSize = null, global::Doroti.Generated.Framework.Widgets.Widget? error = null, string? errorText = null, global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle = null, long? errorMaxLines = null, FloatingLabelBehavior? floatingLabelBehavior = null, FloatingLabelAlignment? floatingLabelAlignment = null, bool? isCollapsed = null, bool? isDense = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? contentPadding = null, global::Doroti.Generated.Framework.Widgets.Widget? prefixIcon = null, global::Doroti.Generated.Framework.Widgets.Widget? prefix = null, string? prefixText = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? prefixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? prefixStyle = null, Color? prefixIconColor = null, global::Doroti.Generated.Framework.Widgets.Widget? suffixIcon = null, global::Doroti.Generated.Framework.Widgets.Widget? suffix = null, string? suffixText = null, global::Doroti.Generated.Framework.Painting.TextStyle? suffixStyle = null, Color? suffixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? suffixIconConstraints = null, global::Doroti.Generated.Framework.Widgets.Widget? counter = null, string? counterText = null, global::Doroti.Generated.Framework.Painting.TextStyle? counterStyle = null, bool? filled = null, Color? fillColor = null, Color? focusColor = null, Color? hoverColor = null, InputBorder? errorBorder = null, InputBorder? focusedBorder = null, InputBorder? focusedErrorBorder = null, InputBorder? disabledBorder = null, InputBorder? enabledBorder = null, InputBorder? border = null, bool? enabled = null, string? semanticCounterText = null, bool? alignLabelWithHint = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null, VisualDensity? visualDensity = null, global::Doroti.Generated.Framework.Semantics.SemanticsService? semanticsService = null)
    {
...
public class InputDecorationTheme : global::Doroti.Generated.Framework.Widgets.InheritedTheme, global::Doroti.Generated.Framework.Foundation.Diagnosticable
{
    ...
    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle? _floatingLabelStyle { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle? _helperStyle { get; private set; }
    internal virtual long? _helperMaxLines { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle? _hintStyle { get; private set; }
    internal virtual Duration? _hintFadeDuration { get; private set; }
    internal virtual long? _hintMaxLines { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle? _errorStyle { get; private set; }
    ...
    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle? _prefixStyle { get; private set; }
    internal virtual Color? _prefixIconColor { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Rendering.BoxConstraints? _prefixIconConstraints { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle? _suffixStyle { get; private set; }
    internal virtual Color? _suffixIconColor { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Rendering.BoxConstraints? _suffixIconConstraints { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Painting.TextStyle? _counterStyle { get; private set; }
    internal virtual bool _filled { get; private set; } = default!;
    internal virtual Color? _fillColor { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Painting.BorderSide? _activeIndicatorBorder { get; private set; }
    internal virtual global::Doroti.Generated.Framework.Painting.BorderSide? _outlineBorder { get; private set; }
    ...
    public InputDecorationTheme(global::Doroti.Generated.Framework.Foundation.Key? key = null, global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle = null, long? helperMaxLines = null, global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle = null, Duration? hintFadeDuration = null, long? hintMaxLines = null, global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle = null, long? errorMaxLines = null, FloatingLabelBehavior? floatingLabelBehavior = null, FloatingLabelAlignment? floatingLabelAlignment = null, bool? isDense = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? contentPadding = null, bool? isCollapsed = null, Color? iconColor = null, global::Doroti.Generated.Framework.Painting.TextStyle? prefixStyle = null, Color? prefixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? prefixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? suffixStyle = null, Color? suffixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? suffixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? counterStyle = null, bool? filled = null, Color? fillColor = null, global::Doroti.Generated.Framework.Painting.BorderSide? activeIndicatorBorder = null, global::Doroti.Generated.Framework.Painting.BorderSide? outlineBorder = null, Color? focusColor = null, Color? hoverColor = null, InputBorder? errorBorder = null, InputBorder? focusedBorder = null, InputBorder? focusedErrorBorder = null, InputBorder? disabledBorder = null, InputBorder? enabledBorder = null, InputBorder? border = null, bool? alignLabelWithHint = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null, VisualDensity? visualDensity = null, InputDecorationThemeData? data = null, global::Doroti.Generated.Framework.Widgets.Widget? child = null) : base(key: key, child: (child ?? global::Doroti.Generated.Framework.Widgets.SizedBox.CreateShrink()))
    {
    ...
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle => ((this._data is not null) ? ((InputDecorationThemeData)this._data).labelStyle : this._labelStyle);
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle => ((this._data is not null) ? ((InputDecorationThemeData)this._data).floatingLabelStyle : this._floatingLabelStyle);
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle => ((this._data is not null) ? ((InputDecorationThemeData)this._data).helperStyle : this._helperStyle);
    ...
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle => ((this._data is not null) ? ((InputDecorationThemeData)this._data).hintStyle : this._hintStyle);
    ...
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle => ((this._data is not null) ? ((InputDecorationThemeData)this._data).errorStyle : this._errorStyle);
    ...
    public virtual global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? contentPadding => ((this._data is not null) ? ((InputDecorationThemeData)this._data).contentPadding : this._contentPadding);
    public virtual bool isCollapsed => ((this._data is not null) ? ((InputDecorationThemeData)this._data).isCollapsed : this._isCollapsed);
    public virtual global::Doroti.Flutter.Ui.Color? iconColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((InputDecorationThemeData)this._data).iconColor : this._iconColor));
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? prefixStyle => ((this._data is not null) ? ((InputDecorationThemeData)this._data).prefixStyle : this._prefixStyle);
    public virtual global::Doroti.Flutter.Ui.Color? prefixIconColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((InputDecorationThemeData)this._data).prefixIconColor : this._prefixIconColor));
    public virtual global::Doroti.Generated.Framework.Rendering.BoxConstraints? prefixIconConstraints => ((this._data is not null) ? ((InputDecorationThemeData)this._data).prefixIconConstraints : this._prefixIconConstraints);
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? suffixStyle => ((this._data is not null) ? ((InputDecorationThemeData)this._data).suffixStyle : this._suffixStyle);
    public virtual global::Doroti.Flutter.Ui.Color? suffixIconColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((InputDecorationThemeData)this._data).suffixIconColor : this._suffixIconColor));
    public virtual global::Doroti.Generated.Framework.Rendering.BoxConstraints? suffixIconConstraints => ((this._data is not null) ? ((InputDecorationThemeData)this._data).suffixIconConstraints : this._suffixIconConstraints);
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? counterStyle => ((this._data is not null) ? ((InputDecorationThemeData)this._data).counterStyle : this._counterStyle);
    public virtual bool filled => ((this._data is not null) ? ((InputDecorationThemeData)this._data).filled : this._filled);
    public virtual global::Doroti.Flutter.Ui.Color? fillColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((InputDecorationThemeData)this._data).fillColor : this._fillColor));
    public virtual global::Doroti.Generated.Framework.Painting.BorderSide? activeIndicatorBorder => ((this._data is not null) ? ((InputDecorationThemeData)this._data).activeIndicatorBorder : this._activeIndicatorBorder);
    public virtual global::Doroti.Generated.Framework.Painting.BorderSide? outlineBorder => ((this._data is not null) ? ((InputDecorationThemeData)this._data).outlineBorder : this._outlineBorder);
    public virtual global::Doroti.Flutter.Ui.Color? focusColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((InputDecorationThemeData)this._data).focusColor : this._focusColor));
    public virtual global::Doroti.Flutter.Ui.Color? hoverColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((InputDecorationThemeData)this._data).hoverColor : this._hoverColor));
    ...
    public virtual global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints => ((this._data is not null) ? ((InputDecorationThemeData)this._data).constraints : this._constraints);
    ...
    public static InputDecorationThemeData of(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
    ...
    public virtual InputDecorationTheme copyWith(global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle = null, long? helperMaxLines = null, global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle = null, Duration? hintFadeDuration = null, long? hintMaxLines = null, global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle = null, long? errorMaxLines = null, FloatingLabelBehavior? floatingLabelBehavior = null, FloatingLabelAlignment? floatingLabelAlignment = null, bool? isDense = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? contentPadding = null, bool? isCollapsed = null, Color? iconColor = null, global::Doroti.Generated.Framework.Painting.TextStyle? prefixStyle = null, Color? prefixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? prefixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? suffixStyle = null, Color? suffixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? suffixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? counterStyle = null, bool? filled = null, Color? fillColor = null, global::Doroti.Generated.Framework.Painting.BorderSide? activeIndicatorBorder = null, global::Doroti.Generated.Framework.Painting.BorderSide? outlineBorder = null, Color? focusColor = null, Color? hoverColor = null, InputBorder? errorBorder = null, InputBorder? focusedBorder = null, InputBorder? focusedErrorBorder = null, InputBorder? disabledBorder = null, InputBorder? enabledBorder = null, InputBorder? border = null, bool? alignLabelWithHint = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null, VisualDensity? visualDensity = null)
    {
    ...
    public virtual InputDecorationTheme merge(InputDecorationTheme? other)
    {
        ...
        return ((InputDecorationTheme)(object?)copyWith(labelStyle: ((this.labelStyle ?? (global::Doroti.Generated.Framework.Painting.TextStyle)((InputDecorationTheme)other).labelStyle)), floatingLabelStyle: ((this.floatingLabelStyle ?? (global::Doroti.Generated.Framework.Painting.TextStyle)((InputDecorationTheme)other).floatingLabelStyle)), helperStyle: ((this.helperStyle ?? (global::Doroti.Generated.Framework.Painting.TextStyle)((InputDecorationTheme)other).helperStyle)), helperMaxLines: ((this.helperMaxLines ?? (long)((InputDecorationTheme)other).helperMaxLines)), hintStyle: ((this.hintStyle ?? (global::Doroti.Generated.Framework.Painting.TextStyle)((InputDecorationTheme)other).hintStyle)), hintFadeDuration: ((this.hintFadeDuration ?? (Duration)((InputDecorationTheme)other).hintFadeDuration)), hintMaxLines: ((this.hintMaxLines ?? (long)((InputDecorationTheme)other).hintMaxLines)), errorStyle: ((this.errorStyle ?? (global::Doroti.Generated.Framework.Painting.TextStyle)((InputDecorationTheme)other).errorStyle)), errorMaxLines: ((this.errorMaxLines ?? (long)((InputDecorationTheme)other).errorMaxLines)), contentPadding: ((this.contentPadding ?? (global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry)((InputDecorationTheme)other).contentPadding)), iconColor: ((this.iconColor ?? (Color)((InputDecorationTheme)other).iconColor)), prefixStyle: ((this.prefixStyle ?? (global::Doroti.Generated.Framework.Painting.TextStyle)((InputDecorationTheme)other).prefixStyle)), prefixIconColor: ((this.prefixIconColor ?? (Color)((InputDecorationTheme)other).prefixIconColor)), prefixIconConstraints: ((this.prefixIconConstraints ?? (global::Doroti.Generated.Framework.Rendering.BoxConstraints)((InputDecorationTheme)other).prefixIconConstraints)), suffixStyle: ((this.suffixStyle ?? (global::Doroti.Generated.Framework.Painting.TextStyle)((InputDecorationTheme)other).suffixStyle)), suffixIconColor: ((this.suffixIconColor ?? (Color)((InputDecorationTheme)other).suffixIconColor)), suffixIconConstraints: ((this.suffixIconConstraints ?? (global::Doroti.Generated.Framework.Rendering.BoxConstraints)((InputDecorationTheme)other).suffixIconConstraints)), counterStyle: ((this.counterStyle ?? (global::Doroti.Generated.Framework.Painting.TextStyle)((InputDecorationTheme)other).counterStyle)), fillColor: ((this.fillColor ?? (Color)((InputDecorationTheme)other).fillColor)), activeIndicatorBorder: ((this.activeIndicatorBorder ?? (global::Doroti.Generated.Framework.Painting.BorderSide)((InputDecorationTheme)other).activeIndicatorBorder)), outlineBorder: ((this.outlineBorder ?? (global::Doroti.Generated.Framework.Painting.BorderSide)((InputDecorationTheme)other).outlineBorder)), focusColor: ((this.focusColor ?? (Color)((InputDecorationTheme)other).focusColor)), hoverColor: ((this.hoverColor ?? (Color)((InputDecorationTheme)other).hoverColor)), errorBorder: ((this.errorBorder ?? (InputBorder)((InputDecorationTheme)other).errorBorder)), focusedBorder: ((this.focusedBorder ?? (InputBorder)((InputDecorationTheme)other).focusedBorder)), focusedErrorBorder: ((this.focusedErrorBorder ?? (InputBorder)((InputDecorationTheme)other).focusedErrorBorder)), disabledBorder: ((this.disabledBorder ?? (InputBorder)((InputDecorationTheme)other).disabledBorder)), enabledBorder: ((this.enabledBorder ?? (InputBorder)((InputDecorationTheme)other).enabledBorder)), border: ((this.border ?? (InputBorder)((InputDecorationTheme)other).border)), constraints: ((this.constraints ?? (global::Doroti.Generated.Framework.Rendering.BoxConstraints)((InputDecorationTheme)other).constraints)), visualDensity: ((this.visualDensity ?? (VisualDensity)((InputDecorationTheme)other).visualDensity))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override bool updateShouldNotify(global::Doroti.Generated.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>((!object.Equals(this.data, ((InputDecorationTheme)oldWidget).data)));
    ...
    {
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new InputDecorationTheme(data: this.data, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class InputDecorationThemeData : global::Doroti.Generated.Framework.Foundation.Diagnosticable
{
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle { get; private set; }
    ...
    public virtual Color? fillColor { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.BorderSide? outlineBorder { get; private set; }
    public virtual global::Doroti.Generated.Framework.Painting.BorderSide? activeIndicatorBorder { get; private set; }
    public virtual Color? focusColor { get; private set; }
    public virtual Color? hoverColor { get; private set; }
    public virtual InputBorder? errorBorder { get; private set; }
    public virtual InputBorder? focusedBorder { get; private set; }
    ...
    public InputDecorationThemeData(global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle = null, long? helperMaxLines = null, global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle = null, Duration? hintFadeDuration = null, long? hintMaxLines = null, global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle = null, long? errorMaxLines = null, FloatingLabelBehavior floatingLabelBehavior = FloatingLabelBehavior.auto, FloatingLabelAlignment floatingLabelAlignment = default!, bool isDense = false, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? contentPadding = null, bool isCollapsed = false, Color? iconColor = null, global::Doroti.Generated.Framework.Painting.TextStyle? prefixStyle = null, Color? prefixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? prefixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? suffixStyle = null, Color? suffixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? suffixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? counterStyle = null, bool filled = false, Color? fillColor = null, global::Doroti.Generated.Framework.Painting.BorderSide? activeIndicatorBorder = null, global::Doroti.Generated.Framework.Painting.BorderSide? outlineBorder = null, Color? focusColor = null, Color? hoverColor = null, InputBorder? errorBorder = null, InputBorder? focusedBorder = null, InputBorder? focusedErrorBorder = null, InputBorder? disabledBorder = null, InputBorder? enabledBorder = null, InputBorder? border = null, bool alignLabelWithHint = false, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null, VisualDensity? visualDensity = null)
    {
    ...
    public virtual InputDecorationThemeData copyWith(global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle = null, global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle = null, long? helperMaxLines = null, global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle = null, Duration? hintFadeDuration = null, long? hintMaxLines = null, global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle = null, long? errorMaxLines = null, FloatingLabelBehavior? floatingLabelBehavior = null, FloatingLabelAlignment? floatingLabelAlignment = null, bool? isDense = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? contentPadding = null, bool? isCollapsed = null, Color? iconColor = null, global::Doroti.Generated.Framework.Painting.TextStyle? prefixStyle = null, Color? prefixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? prefixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? suffixStyle = null, Color? suffixIconColor = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? suffixIconConstraints = null, global::Doroti.Generated.Framework.Painting.TextStyle? counterStyle = null, bool? filled = null, Color? fillColor = null, global::Doroti.Generated.Framework.Painting.BorderSide? activeIndicatorBorder = null, global::Doroti.Generated.Framework.Painting.BorderSide? outlineBorder = null, Color? focusColor = null, Color? hoverColor = null, InputBorder? errorBorder = null, InputBorder? focusedBorder = null, InputBorder? focusedErrorBorder = null, InputBorder? disabledBorder = null, InputBorder? enabledBorder = null, InputBorder? border = null, bool? alignLabelWithHint = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null, VisualDensity? visualDensity = null)
    {
    ...
    public virtual void debugFillProperties(global::Doroti.Generated.Framework.Foundation.DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("labelStyle", this.labelStyle, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).labelStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("floatingLabelStyle", this.floatingLabelStyle, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).floatingLabelStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("helperStyle", this.helperStyle, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).helperStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.IntProperty("helperMaxLines", this.helperMaxLines, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).helperMaxLines));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("hintStyle", this.hintStyle, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).hintStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<Duration>("hintFadeDuration", this.hintFadeDuration, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).hintFadeDuration));
        properties.add(new global::Doroti.Generated.Framework.Foundation.IntProperty("hintMaxLines", this.hintMaxLines, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).hintMaxLines));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("errorStyle", this.errorStyle, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).errorStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.IntProperty("errorMaxLines", this.errorMaxLines, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).errorMaxLines));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<FloatingLabelBehavior>("floatingLabelBehavior", this.floatingLabelBehavior, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).floatingLabelBehavior));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<FloatingLabelAlignment>("floatingLabelAlignment", this.floatingLabelAlignment, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).floatingLabelAlignment));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<bool>("isDense", this.isDense, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).isDense));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry>("contentPadding", this.contentPadding, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).contentPadding));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<bool>("isCollapsed", this.isCollapsed, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).isCollapsed));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Flutter.Ui.Color>("iconColor", this.iconColor, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).iconColor));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Flutter.Ui.Color>("prefixIconColor", this.prefixIconColor, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).prefixIconColor));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Rendering.BoxConstraints>("prefixIconConstraints", this.prefixIconConstraints, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).prefixIconConstraints));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("prefixStyle", this.prefixStyle, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).prefixStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Flutter.Ui.Color>("suffixIconColor", this.suffixIconColor, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).suffixIconColor));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Rendering.BoxConstraints>("suffixIconConstraints", this.suffixIconConstraints, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).suffixIconConstraints));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("suffixStyle", this.suffixStyle, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).suffixStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("counterStyle", this.counterStyle, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).counterStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<bool>("filled", this.filled, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).filled));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("fillColor", this.fillColor, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).fillColor));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.BorderSide>("activeIndicatorBorder", this.activeIndicatorBorder, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).activeIndicatorBorder));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.BorderSide>("outlineBorder", this.outlineBorder, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).outlineBorder));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("focusColor", this.focusColor, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).focusColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("hoverColor", this.hoverColor, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).hoverColor));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<InputBorder>("errorBorder", this.errorBorder, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).errorBorder));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<InputBorder>("focusedBorder", this.focusedBorder, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).focusedErrorBorder));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<InputBorder>("focusedErrorBorder", this.focusedErrorBorder, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).focusedErrorBorder));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<InputBorder>("disabledBorder", this.disabledBorder, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).disabledBorder));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<InputBorder>("enabledBorder", this.enabledBorder, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).enabledBorder));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<InputBorder>("border", this.border, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).border));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<bool>("alignLabelWithHint", this.alignLabelWithHint, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).alignLabelWithHint));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Rendering.BoxConstraints>("constraints", this.constraints, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).constraints));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<VisualDensity>("visualDensity", this.visualDensity, defaultValue: ((InputDecorationThemeData)defaultTheme__218670).visualDensity));
    }
...
internal class _InputDecoratorDefaultsM2__input_decorator : InputDecorationThemeData
{
    ...
    internal _InputDecoratorDefaultsM2__input_decorator(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
        this.context = context;
    }

    public override global::Doroti.Generated.Framework.Painting.TextStyle? hintStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return new global::Doroti.Generated.Framework.Painting.TextStyle(color: Theme.of(this.context).disabledColor);
}
return new global::Doroti.Generated.Framework.Painting.TextStyle(color: Theme.of(this.context).hintColor);
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return new global::Doroti.Generated.Framework.Painting.TextStyle(color: Theme.of(this.context).disabledColor);
}
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public override global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return new global::Doroti.Generated.Framework.Painting.TextStyle(color: Theme.of(this.context).disabledColor);
}
...
{
    return new global::Doroti.Generated.Framework.Painting.TextStyle(color: Theme.of(this.context).colorScheme.error);
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused))
{
    return new global::Doroti.Generated.Framework.Painting.TextStyle(color: Theme.of(this.context).colorScheme.primary);
}
return new global::Doroti.Generated.Framework.Painting.TextStyle(color: Theme.of(this.context).hintColor);
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
ThemeData themeData__225989 = Theme.of(this.context);
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)themeData__225989.textTheme.bodySmall!.copyWith(color: Colors.transparent));
}
return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)themeData__225989.textTheme.bodySmall!.copyWith(color: themeData__225989.hintColor));
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
ThemeData themeData__226368 = Theme.of(this.context);
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)themeData__226368.textTheme.bodySmall!.copyWith(color: Colors.transparent));
}
return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)themeData__226368.textTheme.bodySmall!.copyWith(color: themeData__226368.colorScheme.error));
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override Color? fillColor => DartRuntimePrimitives.ConvertValue<Color>(global::Doroti.Generated.Framework.Widgets.WidgetStateColor.CreateResolveWith(((states) => {
return ((Theme.brightnessOf(this.context), states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled)) switch { (Brightness.dark, true) => new global::Doroti.Flutter.Ui.Color(234881023L), (Brightness.dark, false) => new global::Doroti.Flutter.Ui.Color(452984831L), (Brightness.light, true) => new global::Doroti.Flutter.Ui.Color(83886080L), (Brightness.light, false) => new global::Doroti.Flutter.Ui.Color(167772160L) });
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override Color? iconColor => DartRuntimePrimitives.ConvertValue<Color>(global::Doroti.Generated.Framework.Widgets.WidgetStateColor.CreateResolveWith(((states) => {
if ((states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled) && !states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused)))
{
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public override Color? prefixIconColor => DartRuntimePrimitives.ConvertValue<Color>(global::Doroti.Generated.Framework.Widgets.WidgetStateColor.CreateResolveWith(((states) => {
if ((states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled) && !states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused)))
{
    return Theme.of(this.context).disabledColor;
}
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public override Color? suffixIconColor => DartRuntimePrimitives.ConvertValue<Color>(global::Doroti.Generated.Framework.Widgets.WidgetStateColor.CreateResolveWith(((states) => {
if ((states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled) && !states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused)))
{
    return Theme.of(this.context).disabledColor;
}
...
internal class _InputDecoratorDefaultsM3__input_decorator : InputDecorationThemeData
{
    ...
    internal _InputDecoratorDefaultsM3__input_decorator(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
        this.context = context;
    }
...
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return new global::Doroti.Generated.Framework.Painting.TextStyle(color: this._colors.onSurface.withOpacity(0.38));
}
return new global::Doroti.Generated.Framework.Painting.TextStyle(color: this._colors.onSurfaceVariant);
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override Color? fillColor => DartRuntimePrimitives.ConvertValue<Color>(global::Doroti.Generated.Framework.Widgets.WidgetStateColor.CreateResolveWith(((states) => {
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public override global::Doroti.Generated.Framework.Painting.BorderSide? activeIndicatorBorder => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.BorderSide>(global::Doroti.Generated.Framework.Widgets.WidgetStateBorderSide.CreateResolveWith(((states) => {
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.onSurface.withOpacity(0.38));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.error))
{
    if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused))
    {
        return new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.error, width: 2.0);
    }
    if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.hovered))
    {
        return new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.onErrorContainer);
    }
    return new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.error);
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused))
{
    return new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.primary, width: 2.0);
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.hovered))
{
    return new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.onSurface);
}
return new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.onSurfaceVariant);
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override global::Doroti.Generated.Framework.Painting.BorderSide? outlineBorder => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.BorderSide>(global::Doroti.Generated.Framework.Widgets.WidgetStateBorderSide.CreateResolveWith(((states) => {
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public override global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
global::Doroti.Generated.Framework.Painting.TextStyle textStyle__233081 = (this._textTheme.bodyLarge ?? new global::Doroti.Generated.Framework.Painting.TextStyle());
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__233081.copyWith(color: this._colors.onSurface.withOpacity(0.38)));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.error))
{
    if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused))
    {
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__233081.copyWith(color: this._colors.error));
    }
    if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.hovered))
    {
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__233081.copyWith(color: this._colors.onErrorContainer));
    }
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__233081.copyWith(color: this._colors.error));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__233081.copyWith(color: this._colors.primary));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.hovered))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__233081.copyWith(color: this._colors.onSurfaceVariant));
}
return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__233081.copyWith(color: this._colors.onSurfaceVariant));
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override global::Doroti.Generated.Framework.Painting.TextStyle? floatingLabelStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
global::Doroti.Generated.Framework.Painting.TextStyle textStyle__234050 = (this._textTheme.bodyLarge ?? new global::Doroti.Generated.Framework.Painting.TextStyle());
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__234050.copyWith(color: this._colors.onSurface.withOpacity(0.38)));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.error))
{
    if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused))
    {
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__234050.copyWith(color: this._colors.error));
    }
    if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.hovered))
    {
        return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__234050.copyWith(color: this._colors.onErrorContainer));
    }
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__234050.copyWith(color: this._colors.error));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.focused))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__234050.copyWith(color: this._colors.primary));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.hovered))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__234050.copyWith(color: this._colors.onSurfaceVariant));
}
return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__234050.copyWith(color: this._colors.onSurfaceVariant));
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override global::Doroti.Generated.Framework.Painting.TextStyle? helperStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
global::Doroti.Generated.Framework.Painting.TextStyle textStyle__235012 = (this._textTheme.bodySmall ?? new global::Doroti.Generated.Framework.Painting.TextStyle());
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__235012.copyWith(color: this._colors.onSurface.withOpacity(0.38)));
}
return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__235012.copyWith(color: this._colors.onSurfaceVariant));
throw new InvalidOperationException("Dart closure completed without a value.");
})));
    public override global::Doroti.Generated.Framework.Painting.TextStyle? errorStyle => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Painting.TextStyle>(global::Doroti.Generated.Framework.Widgets.WidgetStateTextStyle.CreateResolveWith(((states) => {
global::Doroti.Generated.Framework.Painting.TextStyle textStyle__235394 = (this._textTheme.bodySmall ?? new global::Doroti.Generated.Framework.Painting.TextStyle());
return ((global::Doroti.Generated.Framework.Painting.TextStyle)(object?)textStyle__235394.copyWith(color: this._colors.error));
throw new InvalidOperationException("Dart closure completed without a value.");
})));
}
