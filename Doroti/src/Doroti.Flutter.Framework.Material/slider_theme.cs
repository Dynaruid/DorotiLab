...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/slider_theme.dart
using System;
...
public class SliderTheme : global::Doroti.Generated.Framework.Widgets.InheritedTheme
{
    public virtual SliderThemeData data { get; private set; } = default!;

    public SliderTheme(global::Doroti.Generated.Framework.Foundation.Key? key = null, SliderThemeData data = default!, global::Doroti.Generated.Framework.Widgets.Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }

    public static SliderThemeData of(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
    ...
    {
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new SliderTheme(data: this.data, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override bool updateShouldNotify(global::Doroti.Generated.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>((!object.Equals(this.data, ((SliderTheme)oldWidget).data)));
}
...
public class SliderThemeData : global::Doroti.Generated.Framework.Foundation.Diagnosticable
{
    ...
    public virtual global::Doroti.Generated.Framework.Painting.TextStyle? valueIndicatorTextStyle { get; private set; }
    ...
    public static SliderThemeData CreateFromPrimaryColors(Color primaryColor, Color primaryColorDark, Color primaryColorLight, global::Doroti.Generated.Framework.Painting.TextStyle valueIndicatorTextStyle)
    {
    ...
    public virtual void debugFillProperties(global::Doroti.Generated.Framework.Foundation.DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.DoubleProperty("trackHeight", this.trackHeight, defaultValue: ((SliderThemeData)defaultData__37487).trackHeight));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("activeTrackColor", this.activeTrackColor, defaultValue: ((SliderThemeData)defaultData__37487).activeTrackColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("inactiveTrackColor", this.inactiveTrackColor, defaultValue: ((SliderThemeData)defaultData__37487).inactiveTrackColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("secondaryActiveTrackColor", this.secondaryActiveTrackColor, defaultValue: ((SliderThemeData)defaultData__37487).secondaryActiveTrackColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("disabledActiveTrackColor", this.disabledActiveTrackColor, defaultValue: ((SliderThemeData)defaultData__37487).disabledActiveTrackColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("disabledInactiveTrackColor", this.disabledInactiveTrackColor, defaultValue: ((SliderThemeData)defaultData__37487).disabledInactiveTrackColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("disabledSecondaryActiveTrackColor", this.disabledSecondaryActiveTrackColor, defaultValue: ((SliderThemeData)defaultData__37487).disabledSecondaryActiveTrackColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("activeTickMarkColor", this.activeTickMarkColor, defaultValue: ((SliderThemeData)defaultData__37487).activeTickMarkColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("inactiveTickMarkColor", this.inactiveTickMarkColor, defaultValue: ((SliderThemeData)defaultData__37487).inactiveTickMarkColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("disabledActiveTickMarkColor", this.disabledActiveTickMarkColor, defaultValue: ((SliderThemeData)defaultData__37487).disabledActiveTickMarkColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("disabledInactiveTickMarkColor", this.disabledInactiveTickMarkColor, defaultValue: ((SliderThemeData)defaultData__37487).disabledInactiveTickMarkColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("thumbColor", this.thumbColor, defaultValue: ((SliderThemeData)defaultData__37487).thumbColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("overlappingShapeStrokeColor", this.overlappingShapeStrokeColor, defaultValue: ((SliderThemeData)defaultData__37487).overlappingShapeStrokeColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("disabledThumbColor", this.disabledThumbColor, defaultValue: ((SliderThemeData)defaultData__37487).disabledThumbColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("overlayColor", this.overlayColor, defaultValue: ((SliderThemeData)defaultData__37487).overlayColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("valueIndicatorColor", this.valueIndicatorColor, defaultValue: ((SliderThemeData)defaultData__37487).valueIndicatorColor));
        properties.add(new global::Doroti.Generated.Framework.Painting.ColorProperty("valueIndicatorStrokeColor", this.valueIndicatorStrokeColor, defaultValue: ((SliderThemeData)defaultData__37487).valueIndicatorStrokeColor));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<SliderComponentShape>("overlayShape", this.overlayShape, defaultValue: ((SliderThemeData)defaultData__37487).overlayShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<SliderTickMarkShape>("tickMarkShape", this.tickMarkShape, defaultValue: ((SliderThemeData)defaultData__37487).tickMarkShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<SliderComponentShape>("thumbShape", this.thumbShape, defaultValue: ((SliderThemeData)defaultData__37487).thumbShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<SliderTrackShape>("trackShape", this.trackShape, defaultValue: ((SliderThemeData)defaultData__37487).trackShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<SliderComponentShape>("valueIndicatorShape", this.valueIndicatorShape, defaultValue: ((SliderThemeData)defaultData__37487).valueIndicatorShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<RangeSliderTickMarkShape>("rangeTickMarkShape", this.rangeTickMarkShape, defaultValue: ((SliderThemeData)defaultData__37487).rangeTickMarkShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<RangeSliderThumbShape>("rangeThumbShape", this.rangeThumbShape, defaultValue: ((SliderThemeData)defaultData__37487).rangeThumbShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<RangeSliderTrackShape>("rangeTrackShape", this.rangeTrackShape, defaultValue: ((SliderThemeData)defaultData__37487).rangeTrackShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<RangeSliderValueIndicatorShape>("rangeValueIndicatorShape", this.rangeValueIndicatorShape, defaultValue: ((SliderThemeData)defaultData__37487).rangeValueIndicatorShape));
        properties.add(new global::Doroti.Generated.Framework.Foundation.EnumProperty<ShowValueIndicator>("showValueIndicator", this.showValueIndicator, defaultValue: ((SliderThemeData)defaultData__37487).showValueIndicator));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.TextStyle>("valueIndicatorTextStyle", this.valueIndicatorTextStyle, defaultValue: ((SliderThemeData)defaultData__37487).valueIndicatorTextStyle));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DoubleProperty("minThumbSeparation", this.minThumbSeparation, defaultValue: ((SliderThemeData)defaultData__37487).minThumbSeparation));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<RangeThumbSelector>("thumbSelector", this.thumbSelector, defaultValue: ((SliderThemeData)defaultData__37487).thumbSelector));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Generated.Framework.Services.MouseCursor?>>("mouseCursor", this.mouseCursor, defaultValue: ((SliderThemeData)defaultData__37487).mouseCursor));
        properties.add(new global::Doroti.Generated.Framework.Foundation.EnumProperty<SliderInteraction>("allowedInteraction", this.allowedInteraction, defaultValue: ((SliderThemeData)defaultData__37487).allowedInteraction));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry>("padding", this.padding, defaultValue: ((SliderThemeData)defaultData__37487).padding));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Flutter.Ui.Size?>>("thumbSize", this.thumbSize, defaultValue: ((SliderThemeData)defaultData__37487).thumbSize));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DoubleProperty("trackGap", this.trackGap, defaultValue: ((SliderThemeData)defaultData__37487).trackGap));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<bool>("year2023", this.year2023, defaultValue: ((SliderThemeData)defaultData__37487).year2023));
    }
