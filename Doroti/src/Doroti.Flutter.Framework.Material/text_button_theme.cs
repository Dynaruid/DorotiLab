...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/text_button_theme.dart
using System;
...
public class TextButtonThemeData : global::Doroti.Generated.Framework.Foundation.Diagnosticable
{
...
public class TextButtonTheme : global::Doroti.Generated.Framework.Widgets.InheritedTheme
{
    public virtual TextButtonThemeData data { get; private set; } = default!;

    public TextButtonTheme(global::Doroti.Generated.Framework.Foundation.Key? key = null, TextButtonThemeData data = default!, global::Doroti.Generated.Framework.Widgets.Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }

    public static TextButtonThemeData of(global::Doroti.Generated.Framework.Widgets.BuildContext context)
    {
    ...
    {
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new TextButtonTheme(data: this.data, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override bool updateShouldNotify(global::Doroti.Generated.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>((!object.Equals(this.data, ((TextButtonTheme)oldWidget).data)));
}
