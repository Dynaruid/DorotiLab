...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/carousel_theme.dart
using System;
...
public class CarouselViewThemeData : global::Doroti.Generated.Framework.Foundation.Diagnosticable
{
    ...
    public static CarouselViewThemeData lerp(CarouselViewThemeData? a, CarouselViewThemeData? b, double t)
    {
        ...
        return new CarouselViewThemeData(backgroundColor: Dart_uiLibrary.Color.lerp(a?.backgroundColor, b?.backgroundColor, t), elevation: Dart_uiLibrary.lerpDouble(a?.elevation, b?.elevation, t), shape: ((global::Doroti.Generated.Framework.Painting.OutlinedBorder?)(object?)ShapeBorder.lerp(a?.shape, b?.shape, t))!, overlayColor: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Color?>(a?.overlayColor, b?.overlayColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), padding: EdgeInsets.lerp(a?.padding, b?.padding, t), itemClipBehavior: ((t < 0.5) ? a?.itemClipBehavior : b?.itemClipBehavior));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual void debugFillProperties(global::Doroti.Generated.Framework.Foundation.DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.EnumProperty<global::Doroti.Flutter.Ui.Clip>("itemClipBehavior", this.itemClipBehavior, defaultValue: null));
    }
