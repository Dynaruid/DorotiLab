...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/about.dart
using System;
...
internal class _PackageLicensePageState__about : global::Doroti.Generated.Framework.Widgets.State<_PackageLicensePage__about>
{
    ...
    internal async virtual Future _initLicenses()
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            {
                global::Doroti.Flutter.Runtime.Flow flow__34221 = global::Doroti.Flutter.Runtime.Flow.begin();
        ...
        foreach (global::Doroti.Generated.Framework.Foundation.LicenseEntry license__34391 in ((_PackageLicensePage__about)this.widget).licenseEntries)
        {
            ...
            DartRuntimePrimitives.Assert(() =>
                {
                    Timeline.timeSync("_initLicenses()", (() => {
}), flow: global::Doroti.Flutter.Runtime.Flow.step(debugFlowId__34170));
                    return true;
                });
...
foreach (var paragraph__35027 in paragraphs__34642)
{
    ...
    {
        this._licenses.Add(new global::Doroti.Generated.Framework.Widgets.Padding(padding: global::Doroti.Generated.Framework.Painting.EdgeInsets.CreateOnly(top: 16.0), child: new global::Doroti.Generated.Framework.Widgets.Text(((global::Doroti.Generated.Framework.Foundation.LicenseParagraph)paragraph__35027).text, style: new global::Doroti.Generated.Framework.Painting.TextStyle(fontWeight: FontWeight.bold), textAlign: global::Doroti.Flutter.Ui.TextAlign.center)));
    }
    else
    {
...
}), flow: global::Doroti.Flutter.Runtime.Flow.end(debugFlowId__34170));
                return true;
            });
    }
...
return global::Doroti.Generated.Framework.Widgets.Localizations.CreateOverride(locale: new global::Doroti.Flutter.Ui.Locale("en", "US"), context: context, child: listWidgets__36644[(int)(index)]);
throw new InvalidOperationException("Dart closure completed without a value.");
})))) }));
        }
...
return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.MouseRegion(child: new Card(color: Theme.of(context).cardColor, elevation: AboutLibrary._kCardElevation, clipBehavior: Clip.antiAlias, margin: new global::Doroti.Generated.Framework.Painting.EdgeInsets(AboutLibrary._kCardElevation, 0.0, AboutLibrary._kCardElevation, 0.0), shape: new global::Doroti.Generated.Framework.Painting.RoundedRectangleBorder(borderRadius: global::Doroti.Generated.Framework.Painting.BorderRadius.CreateVertical(top: global::Doroti.Flutter.Ui.Radius.circular(3.0))), child: this._builder(context, this._arguments, controller))));
throw new InvalidOperationException("Dart closure completed without a value.");
}))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
