...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/ink_highlight.dart
using System;
...
{            var __cascade = new global::Doroti.Flutter.Ui.Paint();
            ...
            return __cascade;        }))();
        global::Doroti.Flutter.Ui.Offset? originOffset__4474 = ((global::Doroti.Flutter.Ui.Offset?)(object?)MatrixUtils.getAsTranslation(transform));
        global::Doroti.Flutter.Ui.Rect rect__4545 = ((global::Doroti.Flutter.Ui.Rect)(object?)((this._rectCallback is not null) ? this._rectCallback() : (Offset.zero & ((global::Doroti.Generated.Framework.Rendering.RenderBox)this.referenceBox).size)));
