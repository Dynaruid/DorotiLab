...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/choice_chip.dart
using System;
...
internal enum _ChipVariant__choice_chip
{
    flat,
    elevated
}

public class ChoiceChip : global::Doroti.Generated.Framework.Widgets.StatelessWidget, ChipAttributes, SelectableChipAttributes, CheckmarkableChipAttributes, DisabledChipAttributes
{
    ...
    internal virtual _ChipVariant__choice_chip _chipVariant { get; private set; } = default!;

    public ChoiceChip(global::Doroti.Generated.Framework.Foundation.Key? key = null, global::Doroti.Generated.Framework.Widgets.Widget? avatar = null, global::Doroti.Generated.Framework.Widgets.Widget label = default!, global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? labelPadding = null, global::System.Action<bool>? onSelected = null, double? pressElevation = null, bool selected = default!, Color? selectedColor = null, Color? disabledColor = null, string? tooltip = null, global::Doroti.Generated.Framework.Painting.BorderSide? side = null, global::Doroti.Generated.Framework.Painting.OutlinedBorder? shape = null, Clip clipBehavior = Clip.none, global::Doroti.Generated.Framework.Widgets.FocusNode? focusNode = null, bool autofocus = false, global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<Color?>? color = null, Color? backgroundColor = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? padding = null, VisualDensity? visualDensity = null, MaterialTapTargetSize? materialTapTargetSize = null, double? elevation = null, Color? shadowColor = null, Color? surfaceTintColor = null, global::Doroti.Generated.Framework.Widgets.IconThemeData? iconTheme = null, Color? selectedShadowColor = null, bool? showCheckmark = null, Color? checkmarkColor = null, global::Doroti.Generated.Framework.Painting.ShapeBorder avatarBorder = default!, global::Doroti.Generated.Framework.Rendering.BoxConstraints? avatarBoxConstraints = null, ChipAnimationStyle? chipAnimationStyle = null, global::Doroti.Generated.Framework.Services.MouseCursor? mouseCursor = null) : base(key: key)
    {
    ...
    public static ChoiceChip CreateElevated(global::Doroti.Generated.Framework.Foundation.Key? key = null, global::Doroti.Generated.Framework.Widgets.Widget? avatar = null, global::Doroti.Generated.Framework.Widgets.Widget label = default!, global::Doroti.Generated.Framework.Painting.TextStyle? labelStyle = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? labelPadding = null, global::System.Action<bool>? onSelected = null, double? pressElevation = null, bool selected = default!, Color? selectedColor = null, Color? disabledColor = null, string? tooltip = null, global::Doroti.Generated.Framework.Painting.BorderSide? side = null, global::Doroti.Generated.Framework.Painting.OutlinedBorder? shape = null, Clip clipBehavior = Clip.none, global::Doroti.Generated.Framework.Widgets.FocusNode? focusNode = null, bool autofocus = false, global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<Color?>? color = null, Color? backgroundColor = null, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? padding = null, VisualDensity? visualDensity = null, MaterialTapTargetSize? materialTapTargetSize = null, double? elevation = null, Color? shadowColor = null, Color? surfaceTintColor = null, global::Doroti.Generated.Framework.Widgets.IconThemeData? iconTheme = null, Color? selectedShadowColor = null, bool? showCheckmark = null, Color? checkmarkColor = null, global::Doroti.Generated.Framework.Painting.ShapeBorder avatarBorder = default!, global::Doroti.Generated.Framework.Rendering.BoxConstraints? avatarBoxConstraints = null, ChipAnimationStyle? chipAnimationStyle = null, global::Doroti.Generated.Framework.Services.MouseCursor? mouseCursor = null)
    {
        var __instance = new ChoiceChip(key: key, avatar: avatar, label: label, labelStyle: labelStyle, labelPadding: labelPadding, onSelected: onSelected, pressElevation: pressElevation, selected: selected, selectedColor: selectedColor, disabledColor: disabledColor, tooltip: tooltip, side: side, shape: shape, clipBehavior: clipBehavior, focusNode: focusNode, autofocus: autofocus, color: color, backgroundColor: backgroundColor, padding: padding, visualDensity: visualDensity, materialTapTargetSize: materialTapTargetSize, elevation: elevation, shadowColor: shadowColor, surfaceTintColor: surfaceTintColor, iconTheme: iconTheme, selectedShadowColor: selectedShadowColor, showCheckmark: showCheckmark, checkmarkColor: checkmarkColor, avatarBorder: avatarBorder, avatarBoxConstraints: avatarBoxConstraints, chipAnimationStyle: chipAnimationStyle, mouseCursor: mouseCursor);
        global::Doroti.Generated.Framework.Painting.ShapeBorder __avatarBorder = avatarBorder ?? new global::Doroti.Generated.Framework.Painting.CircleBorder();
        ...
        __instance._chipVariant = _ChipVariant__choice_chip.elevated;
        return __instance;
    }
...
internal class _ChoiceChipDefaultsM3__choice_chip : ChipThemeData
{
    ...
    internal _ChoiceChipDefaultsM3__choice_chip(global::Doroti.Generated.Framework.Widgets.BuildContext context, bool isEnabled, bool isSelected, _ChipVariant__choice_chip _chipVariant) : base(shape: new global::Doroti.Generated.Framework.Painting.RoundedRectangleBorder(borderRadius: global::Doroti.Generated.Framework.Painting.BorderRadius.CreateAll(global::Doroti.Flutter.Ui.Radius.circular(8.0))), showCheckmark: true)
    {
    ...
    public override double? elevation => ((object.Equals(this._chipVariant, _ChipVariant__choice_chip.flat)) ? 0.0 : (this.isEnabled ? 1.0 : 0.0));
    ...
    public virtual global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Flutter.Ui.Color?>? color => DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Flutter.Ui.Color?>>(WidgetStateProperty.resolveWith((states) => {
...
{
    return (((object.Equals(this._chipVariant, _ChipVariant__choice_chip.flat)) ? this._colors.onSurface.withOpacity(0.12) : this._colors.onSurface.withOpacity(0.12)));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.disabled))
{
    return (((object.Equals(this._chipVariant, _ChipVariant__choice_chip.flat)) ? null : this._colors.onSurface.withOpacity(0.12)));
}
if (states.Contains(global::Doroti.Generated.Framework.Widgets.WidgetState.selected))
{
    return (((object.Equals(this._chipVariant, _ChipVariant__choice_chip.flat)) ? this._colors.secondaryContainer : this._colors.secondaryContainer));
}
return (((object.Equals(this._chipVariant, _ChipVariant__choice_chip.flat)) ? null : this._colors.surfaceContainerLow));
throw new InvalidOperationException("Dart closure completed without a value.");
}));
    public virtual global::Doroti.Flutter.Ui.Color? shadowColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((object.Equals(this._chipVariant, _ChipVariant__choice_chip.flat)) ? Colors.transparent : this._colors.shadow));
    ...
    public virtual global::Doroti.Flutter.Ui.Color? checkmarkColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>((this.isEnabled ? (this.isSelected ? this._colors.onSecondaryContainer : this._colors.primary) : this._colors.onSurface));
    public virtual global::Doroti.Flutter.Ui.Color? deleteIconColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>((this.isEnabled ? (this.isSelected ? this._colors.onSecondaryContainer : this._colors.onSurfaceVariant) : this._colors.onSurface));
    public override global::Doroti.Generated.Framework.Painting.BorderSide? side => (((object.Equals(this._chipVariant, _ChipVariant__choice_chip.flat)) && !this.isSelected) ? (this.isEnabled ? new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.outlineVariant) : new global::Doroti.Generated.Framework.Painting.BorderSide(color: this._colors.onSurface.withOpacity(0.12))) : new global::Doroti.Generated.Framework.Painting.BorderSide(color: Colors.transparent));
    ...
    public virtual global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry? labelPadding
    {
        get
        {
            ...
            return ((global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry?)(object?)EdgeInsets.lerp(global::Doroti.Generated.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: 8.0), global::Doroti.Generated.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: 4.0), Dart_uiLibrary.clampDouble((fontSizeRatio__11687 - 1.0), 0.0, 1.0))!);
            return default!;
        }
    }
}
