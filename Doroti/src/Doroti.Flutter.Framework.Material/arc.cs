...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/arc.dart
using System;
...
public class MaterialPointArcTween : global::Doroti.Generated.Framework.Animation.Tween<Offset>
{
    ...
    internal virtual void _initialize()
    {
        ...
        global::Doroti.Flutter.Ui.Offset begin__1824 = ((global::Doroti.Flutter.Ui.Offset)(object?)DartRuntimePrimitives.RequireValue(this.begin));
        global::Doroti.Flutter.Ui.Offset end__1862 = ((global::Doroti.Flutter.Ui.Offset)(object?)DartRuntimePrimitives.RequireValue(this.end));
        global::Doroti.Flutter.Ui.Offset delta__2031 = ((global::Doroti.Flutter.Ui.Offset)(object?)(DartRuntimePrimitives.RequireValue(end__1862) - DartRuntimePrimitives.RequireValue(begin__1824)));
        ...
        var c__2198 = new global::Doroti.Flutter.Ui.Offset(DartRuntimePrimitives.RequireValue(end__1862).dx, DartRuntimePrimitives.RequireValue(begin__1824).dy);
        double sweepAngle()
        {
            return (2.0 * global::Doroti.Flutter.Runtime.Dart_mathLibrary.asin((distanceFromAtoB__2153 / ((2.0 * DartRuntimePrimitives.RequireValue(this._radius))))));
        ...
        if (((deltaX__2069 > ArcLibrary._kOnAxisDelta) && (deltaY__2111 > ArcLibrary._kOnAxisDelta)))
        {
            if ((deltaX__2069 < deltaY__2111))
            {
                ...
                _center = new global::Doroti.Flutter.Ui.Offset((DartRuntimePrimitives.RequireValue(end__1862).dx + (DartRuntimePrimitives.RequireValue(this._radius) * Math.Sign(((DartRuntimePrimitives.RequireValue(begin__1824).dx - DartRuntimePrimitives.RequireValue(end__1862).dx))))), DartRuntimePrimitives.RequireValue(end__1862).dy);
            ...
            else
            {
                ...
                _center = new global::Doroti.Flutter.Ui.Offset(DartRuntimePrimitives.RequireValue(begin__1824).dx, (DartRuntimePrimitives.RequireValue(begin__1824).dy + (Math.Sign(((DartRuntimePrimitives.RequireValue(end__1862).dy - DartRuntimePrimitives.RequireValue(begin__1824).dy))) * DartRuntimePrimitives.RequireValue(this._radius))));
    ...
    public virtual global::Doroti.Flutter.Ui.Offset? center
    {
        get
        {
            if (false)
    ...
    public override Offset lerp(double t)
    {
        ...
        double x__5547 = (global::Doroti.Flutter.Runtime.Dart_mathLibrary.cos(angle__5482) * DartRuntimePrimitives.RequireValue(this._radius));
        double y__5596 = (global::Doroti.Flutter.Runtime.Dart_mathLibrary.sin(angle__5482) * DartRuntimePrimitives.RequireValue(this._radius));
        return (DartRuntimePrimitives.RequireValue(this._center) + new global::Doroti.Flutter.Ui.Offset(x__5547, y__5596));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class MaterialRectArcTween : global::Doroti.Generated.Framework.Animation.RectTween
{
    ...
    internal virtual void _initialize()
    {
        ...
        global::Doroti.Flutter.Ui.Offset centersVector__8156 = ((global::Doroti.Flutter.Ui.Offset)(object?)(((Offset)((dynamic)DartRuntimePrimitives.RequireValue(this.end)).center) - ((Offset)((dynamic)DartRuntimePrimitives.RequireValue(this.begin)).center)));
    ...
    {
        global::Doroti.Flutter.Ui.Offset delta__8732 = ((global::Doroti.Flutter.Ui.Offset)(object?)(_cornerFor(DartRuntimePrimitives.RequireValue(this.begin), ((_Diagonal__arc)diagonal).endId) - _cornerFor(DartRuntimePrimitives.RequireValue(this.begin), ((_Diagonal__arc)diagonal).beginId)));
    ...
    internal virtual global::Doroti.Flutter.Ui.Offset _cornerFor(Rect rect, _CornerId__arc id)
    {
    ...
    public override Rect? lerp(double t)
    {
        ...
        return global::Doroti.Flutter.Ui.Rect.fromPoints(this._beginArc.lerp(t), this._endArc.lerp(t));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class MaterialRectCenterArcTween : global::Doroti.Generated.Framework.Animation.RectTween
{
    ...
    public override Rect? lerp(double t)
    {
        ...
        global::Doroti.Flutter.Ui.Offset center__12629 = ((global::Doroti.Flutter.Ui.Offset)(object?)this._centerArc.lerp(t));
        ...
        return global::Doroti.Flutter.Ui.Rect.fromLTWH((center__12629.dx - (width__12675 / 2.0)), (center__12629.dy - (height__12742 / 2.0)), width__12675, height__12742);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
