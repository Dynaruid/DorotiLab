...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/button_style.dart
using System;
...
public delegate global::Doroti.Generated.Framework.Widgets.Widget ButtonLayerBuilder(global::Doroti.Generated.Framework.Widgets.BuildContext context, HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState> states, global::Doroti.Generated.Framework.Widgets.Widget? child);

public class ButtonStyle : global::Doroti.Generated.Framework.Foundation.Diagnosticable
{
    ...
    public virtual global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<Color?>? foregroundColor { get; private set; }
    ...
    public virtual global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<Color?>? iconColor { get; private set; }
    public virtual global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<double?>? iconSize { get; private set; }
    ...
    public virtual void debugFillProperties(global::Doroti.Generated.Framework.Foundation.DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Flutter.Ui.Color?>>("foregroundColor", this.foregroundColor, defaultValue: null));
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Flutter.Ui.Size?>>("minimumSize", this.minimumSize, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Flutter.Ui.Size?>>("fixedSize", this.fixedSize, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Flutter.Ui.Size?>>("maximumSize", this.maximumSize, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Flutter.Ui.Color?>>("iconColor", this.iconColor, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<double?>>("iconSize", this.iconSize, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.EnumProperty<IconAlignment>("iconAlignment", this.iconAlignment, defaultValue: null));
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.EnumProperty<MaterialTapTargetSize>("tapTargetSize", this.tapTargetSize, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<Duration>("animationDuration", this.animationDuration, defaultValue: null));
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::System.Func<global::Doroti.Generated.Framework.Widgets.BuildContext, HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState>, global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget>>("backgroundBuilder", this.backgroundBuilder, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::System.Func<global::Doroti.Generated.Framework.Widgets.BuildContext, HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState>, global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget>>("foregroundBuilder", this.foregroundBuilder, defaultValue: null));
    }
    ...
    public static ButtonStyle? lerp(ButtonStyle? a, ButtonStyle? b, double t)
    {
        ...
        return new ButtonStyle(textStyle: WidgetStateProperty.lerp<global::Doroti.Generated.Framework.Painting.TextStyle?>(a?.textStyle, b?.textStyle, t, (global::System.Func<global::Doroti.Generated.Framework.Painting.TextStyle?, global::Doroti.Generated.Framework.Painting.TextStyle?, double, global::Doroti.Generated.Framework.Painting.TextStyle?>)global::Doroti.Generated.Framework.Painting.TextStyle.lerp), backgroundColor: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Color?>(a?.backgroundColor, b?.backgroundColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), foregroundColor: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Color?>(a?.foregroundColor, b?.foregroundColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), overlayColor: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Color?>(a?.overlayColor, b?.overlayColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), shadowColor: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Color?>(a?.shadowColor, b?.shadowColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), surfaceTintColor: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Color?>(a?.surfaceTintColor, b?.surfaceTintColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), elevation: WidgetStateProperty.lerp<double?>(a?.elevation, b?.elevation, t, (global::System.Func<double?, double?, double, double?>)Dart_uiLibrary.lerpDouble), padding: WidgetStateProperty.lerp<global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry?>(a?.padding, b?.padding, t, (global::System.Func<global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry?, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry?, double, global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry?>)global::Doroti.Generated.Framework.Painting.EdgeInsetsGeometry.lerp), minimumSize: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Size?>(a?.minimumSize, b?.minimumSize, t, (global::System.Func<Size?, Size?, double, Size?>)Size.lerp), fixedSize: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Size?>(a?.fixedSize, b?.fixedSize, t, (global::System.Func<Size?, Size?, double, Size?>)Size.lerp), maximumSize: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Size?>(a?.maximumSize, b?.maximumSize, t, (global::System.Func<Size?, Size?, double, Size?>)Size.lerp), iconColor: WidgetStateProperty.lerp<global::Doroti.Flutter.Ui.Color?>(a?.iconColor, b?.iconColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), iconSize: WidgetStateProperty.lerp<double?>(a?.iconSize, b?.iconSize, t, (global::System.Func<double?, double?, double, double?>)Dart_uiLibrary.lerpDouble), iconAlignment: ((t < 0.5) ? a?.iconAlignment : b?.iconAlignment), side: WidgetStateBorderSide.lerp(a?.side, b?.side, t), shape: WidgetStateProperty.lerp<global::Doroti.Generated.Framework.Painting.OutlinedBorder?>(a?.shape, b?.shape, t, (global::System.Func<global::Doroti.Generated.Framework.Painting.OutlinedBorder?, global::Doroti.Generated.Framework.Painting.OutlinedBorder?, double, global::Doroti.Generated.Framework.Painting.OutlinedBorder?>)global::Doroti.Generated.Framework.Painting.OutlinedBorder.lerp), mouseCursor: ((t < 0.5) ? a?.mouseCursor : b?.mouseCursor), visualDensity: ((t < 0.5) ? a?.visualDensity : b?.visualDensity), tapTargetSize: ((t < 0.5) ? a?.tapTargetSize : b?.tapTargetSize), animationDuration: ((t < 0.5) ? a?.animationDuration : b?.animationDuration), enableFeedback: ((t < 0.5) ? a?.enableFeedback : b?.enableFeedback), alignment: AlignmentGeometry.lerp(a?.alignment, b?.alignment, t), splashFactory: ((t < 0.5) ? a?.splashFactory : b?.splashFactory), backgroundBuilder: ((global::System.Func<global::Doroti.Generated.Framework.Widgets.BuildContext, HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState>, global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget>)((t < 0.5) ? a?.backgroundBuilder : b?.backgroundBuilder)), foregroundBuilder: ((global::System.Func<global::Doroti.Generated.Framework.Widgets.BuildContext, HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState>, global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget>)((t < 0.5) ? a?.foregroundBuilder : b?.foregroundBuilder)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
