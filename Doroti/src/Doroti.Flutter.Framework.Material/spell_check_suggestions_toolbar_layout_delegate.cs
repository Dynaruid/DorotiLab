...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/spell_check_suggestions_toolbar_layout_delegate.dart
using System;
...
public class SpellCheckSuggestionsToolbarLayoutDelegate : global::Doroti.Generated.Framework.Rendering.SingleChildLayoutDelegate
{
    ...
    {
        return new global::Doroti.Flutter.Ui.Offset(TextSelectionToolbarLayoutDelegate.centerOn(this.anchor.dx, childSize.width, size.width), (((this.anchor.dy + childSize.height) > size.height) ? (size.height - childSize.height) : this.anchor.dy));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
