...
public class DialogTheme : global::Doroti.Generated.Framework.Widgets.InheritedTheme, global::Doroti.Generated.Framework.Foundation.Diagnosticable
{
    ...
    public virtual global::Doroti.Flutter.Ui.Color? backgroundColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((DialogThemeData)this._data).backgroundColor : this._backgroundColor));
    public virtual double? elevation => ((this._data is not null) ? ((DialogThemeData)this._data).elevation : this._elevation);
    public virtual global::Doroti.Flutter.Ui.Color? shadowColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((DialogThemeData)this._data).shadowColor : this._shadowColor));
    public virtual global::Doroti.Flutter.Ui.Color? surfaceTintColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((DialogThemeData)this._data).surfaceTintColor : this._surfaceTintColor));
    ...
    public virtual global::Doroti.Flutter.Ui.Color? iconColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((DialogThemeData)this._data).iconColor : this._iconColor));
    public virtual global::Doroti.Flutter.Ui.Color? barrierColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Color>(((this._data is not null) ? ((DialogThemeData)this._data).barrierColor : this._barrierColor));
    ...
    public virtual global::Doroti.Flutter.Ui.Clip? clipBehavior => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Clip>(((this._data is not null) ? ((DialogThemeData)this._data).clipBehavior : this._clipBehavior));
