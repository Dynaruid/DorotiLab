...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/material/checkbox_list_tile.dart
using System;
...
public class CheckboxListTile : global::Doroti.Generated.Framework.Widgets.StatelessWidget
{
    ...
    public virtual global::Doroti.Generated.Framework.Painting.OutlinedBorder? checkboxShape { get; private set; }
    ...
    {
        global::Doroti.Generated.Framework.Widgets.Widget control__19024 = default!;
        switch (this._checkboxType)
        {
            case _CheckboxType__checkbox_list_tile.material:
                {
                    control__19024 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(new global::Doroti.Generated.Framework.Widgets.ExcludeFocus(child: new Checkbox(value: this.value, onChanged: ((global::System.Action<bool?>)((this.enabled ?? true) ? this.onChanged : null)), mouseCursor: this.mouseCursor, activeColor: this.activeColor, fillColor: this.fillColor, checkColor: this.checkColor, hoverColor: this.hoverColor, overlayColor: this.overlayColor, splashRadius: this.splashRadius, materialTapTargetSize: (this.materialTapTargetSize ?? MaterialTapTargetSize.shrinkWrap), autofocus: this.autofocus, tristate: this.tristate, shape: this.checkboxShape, side: this.side, isError: this.isError, semanticLabel: this.checkboxSemanticLabel)));
                    break;
                }
            case _CheckboxType__checkbox_list_tile.adaptive:
                {
                    control__19024 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(new global::Doroti.Generated.Framework.Widgets.ExcludeFocus(child: Checkbox.CreateAdaptive(value: this.value, onChanged: ((global::System.Action<bool?>)((this.enabled ?? true) ? this.onChanged : null)), mouseCursor: this.mouseCursor, activeColor: this.activeColor, fillColor: this.fillColor, checkColor: this.checkColor, hoverColor: this.hoverColor, overlayColor: this.overlayColor, splashRadius: this.splashRadius, materialTapTargetSize: (this.materialTapTargetSize ?? MaterialTapTargetSize.shrinkWrap), autofocus: this.autofocus, tristate: this.tristate, shape: this.checkboxShape, side: this.side, isError: this.isError, semanticLabel: this.checkboxSemanticLabel)));
                    break;
                }
        }
        if ((this.checkboxScaleFactor != 1.0))
        {
            control__19024 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(global::Doroti.Generated.Framework.Widgets.Transform.CreateScale(scale: this.checkboxScaleFactor, child: control__19024));
        }
        ListTileThemeData listTileTheme__20754 = ListTileTheme.of(context);
        ListTileControlAffinity effectiveControlAffinity__20831 = ((this.controlAffinity ?? listTileTheme__20754.controlAffinity) ?? ListTileControlAffinity.platform);
        var (leading__20971, trailing__20988) = (effectiveControlAffinity__20831 switch { ListTileControlAffinity.leading => (((global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget?)>((control__19024, this.secondary)))), ListTileControlAffinity.trailing => (((global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget?)>((this.secondary, control__19024)))), ListTileControlAffinity.platform => (((global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Generated.Framework.Widgets.Widget?, global::Doroti.Generated.Framework.Widgets.Widget?)>((this.secondary, control__19024)))), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        ThemeData theme__21227 = Theme.of(context);
        CheckboxThemeData checkboxTheme__21282 = CheckboxTheme.of(context);
        var states__21335 = ((Func<HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState>>)(() => { var __collection21344 = new HashSet<global::Doroti.Generated.Framework.Widgets.WidgetState>(); if (this.selected) { __collection21344.Add(global::Doroti.Generated.Framework.Widgets.WidgetState.selected); } return __collection21344; }))();
        global::Doroti.Flutter.Ui.Color effectiveActiveColor__21411 = ((global::Doroti.Flutter.Ui.Color)(object?)(((this.activeColor ?? (Color)checkboxTheme__21282.fillColor?.resolve(states__21335))) ?? theme__21227.colorScheme.secondary));
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.MergeSemantics(child: new ListTile(selectedColor: effectiveActiveColor__21411, leading: leading__20971, title: this.title, subtitle: this.subtitle, trailing: trailing__20988, isThreeLine: this.isThreeLine, dense: this.dense, enabled: (this.enabled ?? (this.onChanged is not null)), onTap: ((global::System.Action)((this.onChanged is not null) ? this._handleValueChange : null)), selected: this.selected, autofocus: this.autofocus, contentPadding: this.contentPadding, shape: this.shape, selectedTileColor: this.selectedTileColor, tileColor: this.tileColor, visualDensity: this.visualDensity, focusNode: this.focusNode, statesController: this.statesController, onFocusChange: (global::System.Action<bool>?)this.onFocusChange, enableFeedback: this.enableFeedback, horizontalTitleGap: this.horizontalTitleGap, minVerticalPadding: this.minVerticalPadding, minLeadingWidth: this.minLeadingWidth, minTileHeight: this.minTileHeight, titleAlignment: this.titleAlignment, internalAddSemanticForOnTap: this.internalAddSemanticForOnTap)));
