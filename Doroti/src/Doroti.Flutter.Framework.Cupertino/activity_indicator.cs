...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/cupertino/activity_indicator.dart
using System;
...
public static partial class Activity_indicatorLibrary
{
    internal static Color _kActiveTickColor = ((Color)(object?)new CupertinoDynamicColor(color: new global::Doroti.Flutter.Ui.Color(4282137668L), darkColor: new global::Doroti.Flutter.Ui.Color(4293651445L)));
}
...
{            var __cascade = new global::Doroti.Flutter.Ui.Paint();
    ...
    public override void paint(Canvas canvas, Size size)
    {
        canvas.drawRRect(global::Doroti.Generated.Framework.Painting.BorderRadius.CreateAll(global::Doroti.Flutter.Ui.Radius.circular((size.height / 2L))).toRRect((Offset.zero & size)), this._backgroundPaint);
        if ((this.progress > 0L))
        {
            canvas.drawRRect(global::Doroti.Generated.Framework.Painting.BorderRadius.CreateAll(global::Doroti.Flutter.Ui.Radius.circular((size.height / 2L))).toRRect((Offset.zero & new global::Doroti.Flutter.Ui.Size((Dart_uiLibrary.clampDouble(this.progress, 0.0, 1.0) * size.width), size.height))), this._progressPaint);
        }
    }
