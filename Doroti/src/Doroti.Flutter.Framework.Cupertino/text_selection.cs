...
// Doroti typed semantic compiler 3.0.0; source: ../../../flutter-master/packages/flutter/lib/src/cupertino/text_selection.dart
using System;
...
internal class _CupertinoTextSelectionHandlePainter__text_selection : global::Doroti.Generated.Framework.Rendering.CustomPainter
{
...
{            var __cascade = new global::Doroti.Flutter.Ui.Paint();
            ...
            return __cascade;        }))();
        var circle__1207 = global::Doroti.Flutter.Ui.Rect.fromCircle(center: new global::Doroti.Flutter.Ui.Offset(Text_selectionLibrary._kSelectionHandleRadius, Text_selectionLibrary._kSelectionHandleRadius), radius: Text_selectionLibrary._kSelectionHandleRadius);
        var line__1367 = global::Doroti.Flutter.Ui.Rect.fromPoints(new global::Doroti.Flutter.Ui.Offset((Text_selectionLibrary._kSelectionHandleRadius - halfStrokeWidth__1132), ((2L * Text_selectionLibrary._kSelectionHandleRadius) - Text_selectionLibrary._kSelectionHandleOverlap)), new global::Doroti.Flutter.Ui.Offset((Text_selectionLibrary._kSelectionHandleRadius + halfStrokeWidth__1132), size.height));
...
{            var __cascade = new global::Doroti.Flutter.Ui.Path();
    ...
    public override bool shouldRepaint(global::Doroti.Generated.Framework.Rendering.CustomPainter oldDelegate) => (!object.Equals(this.color, ((_CupertinoTextSelectionHandlePainter__text_selection)oldDelegate).color));
}
...
public class CupertinoTextSelectionControls : global::Doroti.Generated.Framework.Widgets.TextSelectionControls
{
    public override Size getHandleSize(double textLineHeight)
    {
        return new global::Doroti.Flutter.Ui.Size((Text_selectionLibrary._kSelectionHandleRadius * 2L), ((textLineHeight + (Text_selectionLibrary._kSelectionHandleRadius * 2L)) - Text_selectionLibrary._kSelectionHandleOverlap));
    ...
    {
        global::Doroti.Flutter.Ui.Size desiredSize__4108 = default!;
        global::Doroti.Generated.Framework.Widgets.Widget handle__4138 = default!;
        global::Doroti.Generated.Framework.Widgets.Widget customPaint__4164 = ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.CustomPaint(painter: new _CupertinoTextSelectionHandlePainter__text_selection(CupertinoTheme.of(context).selectionHandleColor)));
        switch (type)
        {
            case global::Doroti.Generated.Framework.Rendering.TextSelectionHandleType.left:
                {
                    desiredSize__4108 = getHandleSize(textLineHeight);
                    handle__4138 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(global::Doroti.Generated.Framework.Widgets.SizedBox.CreateFromSize(size: desiredSize__4108, child: customPaint__4164));
                    return handle__4138;
                }
            case global::Doroti.Generated.Framework.Rendering.TextSelectionHandleType.right:
                {
                    desiredSize__4108 = getHandleSize(textLineHeight);
                    handle__4138 = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Widgets.Widget>(global::Doroti.Generated.Framework.Widgets.SizedBox.CreateFromSize(size: desiredSize__4108, child: customPaint__4164));
                    return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.Transform(transform: ((Func<Matrix4>)(() =>
{            var __cascade = Matrix4.identity();
            ...
            case global::Doroti.Generated.Framework.Rendering.TextSelectionHandleType.collapsed:
                {
                    return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)global::Doroti.Generated.Framework.Widgets.SizedBox.CreateFromSize(size: getHandleSize(textLineHeight)));
                }
            default:
    ...
    {
        global::Doroti.Flutter.Ui.Size handleSize__5681 = ((global::Doroti.Flutter.Ui.Size)(object?)getHandleSize(textLineHeight));
        switch (type)
        {
            case global::Doroti.Generated.Framework.Rendering.TextSelectionHandleType.left:
                {
                    return new global::Doroti.Flutter.Ui.Offset((handleSize__5681.width / 2L), handleSize__5681.height);
                }
            case global::Doroti.Generated.Framework.Rendering.TextSelectionHandleType.right:
                {
                    return new global::Doroti.Flutter.Ui.Offset((handleSize__5681.width / 2L), ((handleSize__5681.height - (2L * Text_selectionLibrary._kSelectionHandleRadius)) + Text_selectionLibrary._kSelectionHandleOverlap));
                }
            case global::Doroti.Generated.Framework.Rendering.TextSelectionHandleType.collapsed:
                {
                    return new global::Doroti.Flutter.Ui.Offset((handleSize__5681.width / 2L), (textLineHeight + (((handleSize__5681.height - textLineHeight)) / 2L)));
                }
            default:
                throw new InvalidOperationException("Non-exhaustive Dart switch value.");
        }
...
public static partial class Text_selectionLibrary
{
    public static global::Doroti.Generated.Framework.Widgets.TextSelectionControls cupertinoTextSelectionHandleControls = ((global::Doroti.Generated.Framework.Widgets.TextSelectionControls)(object?)new CupertinoTextSelectionHandleControls());
}

public static partial class Text_selectionLibrary
{
    public static global::Doroti.Generated.Framework.Widgets.TextSelectionControls cupertinoTextSelectionControls = ((global::Doroti.Generated.Framework.Widgets.TextSelectionControls)(object?)new CupertinoTextSelectionControls());
}

public class _CupertinoTextSelectionControlsToolbar__text_selection : global::Doroti.Generated.Framework.Widgets.StatefulWidget
{
...
public class _CupertinoTextSelectionControlsToolbarState__text_selection : global::Doroti.Generated.Framework.Widgets.State<_CupertinoTextSelectionControlsToolbar__text_selection>
{
    ...
    {
        if (((((_CupertinoTextSelectionControlsToolbar__text_selection)this.widget).handlePaste is not null) && (object.Equals(((_CupertinoTextSelectionControlsToolbar__text_selection)this.widget).clipboardStatus?.value, global::Doroti.Generated.Framework.Widgets.ClipboardStatus.unknown))))
        {
        ...
        global::Doroti.Generated.Framework.Painting.EdgeInsets mediaQueryPadding__9280 = ((global::Doroti.Generated.Framework.Painting.EdgeInsets)(object?)MediaQuery.paddingOf(context));
        double anchorX__9544 = Dart_uiLibrary.clampDouble((((_CupertinoTextSelectionControlsToolbar__text_selection)this.widget).selectionMidpoint.dx + ((_CupertinoTextSelectionControlsToolbar__text_selection)this.widget).globalEditableRegion.left), (Text_selectionLibrary._kArrowScreenPadding + ((global::Doroti.Generated.Framework.Painting.EdgeInsets)mediaQueryPadding__9280).left), ((MediaQuery.widthOf(context) - ((global::Doroti.Generated.Framework.Painting.EdgeInsets)mediaQueryPadding__9280).right) - Text_selectionLibrary._kArrowScreenPadding));
        ...
        var anchorAbove__10252 = new global::Doroti.Flutter.Ui.Offset(anchorX__9544, anchorTop__9909);
        var anchorBelow__10304 = new global::Doroti.Flutter.Ui.Offset(anchorX__9544, (((_CupertinoTextSelectionControlsToolbar__text_selection)this.widget).endpoints.Last().point.dy + ((_CupertinoTextSelectionControlsToolbar__text_selection)this.widget).globalEditableRegion.top));
        var items__10431 = new List<global::Doroti.Generated.Framework.Widgets.Widget>();
        CupertinoLocalizations localizations__10484 = CupertinoLocalizations.of(context);
        global::Doroti.Generated.Framework.Widgets.Widget onePhysicalPixelVerticalDivider__10553 = ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new global::Doroti.Generated.Framework.Widgets.SizedBox(width: (1.0 / MediaQuery.devicePixelRatioOf(context))));
        ...
        if (((((_CupertinoTextSelectionControlsToolbar__text_selection)this.widget).handlePaste is not null) && (object.Equals(((_CupertinoTextSelectionControlsToolbar__text_selection)this.widget).clipboardStatus?.value, global::Doroti.Generated.Framework.Widgets.ClipboardStatus.pasteable))))
        {
        ...
        return ((global::Doroti.Generated.Framework.Widgets.Widget)(object?)new CupertinoTextSelectionToolbar(anchorAbove: anchorAbove__10252, anchorBelow: anchorBelow__10304, children: items__10431));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
