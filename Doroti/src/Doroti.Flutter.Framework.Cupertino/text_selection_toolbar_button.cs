...
public static partial class Text_selection_toolbar_buttonLibrary
{
    internal static CupertinoDynamicColor _kToolbarPressedColor = new CupertinoDynamicColor(color: new global::Doroti.Flutter.Ui.Color(268435456L), darkColor: new global::Doroti.Flutter.Ui.Color(285212671L));
}
...
{            var __cascade = new global::Doroti.Flutter.Ui.Paint();
    ...
    public override void paint(Canvas canvas, Size size)
    {
        ...
        var origin__7210 = new global::Doroti.Flutter.Ui.Offset((-size.width / 2.0), (-size.height / 2.0));
...
{            var __cascade = new global::Doroti.Flutter.Ui.Path();
            ...
            __cascade.arcToPoint(new global::Doroti.Flutter.Ui.Offset((origin__7210.dx + 1.0), origin__7210.dy), radius: global::Doroti.Flutter.Ui.Radius.circular(1));
...
{            var __cascade = Matrix4.identity();
        ...
        canvas.drawLine(new global::Doroti.Flutter.Ui.Offset(-3.0, -3.0), new global::Doroti.Flutter.Ui.Offset(3.0, -3.0), this._painter);
        canvas.drawLine(new global::Doroti.Flutter.Ui.Offset(-3.0, 0.0), new global::Doroti.Flutter.Ui.Offset(3.0, 0.0), this._painter);
        canvas.drawLine(new global::Doroti.Flutter.Ui.Offset(-3.0, 3.0), new global::Doroti.Flutter.Ui.Offset(1.0, 3.0), this._painter);
        canvas.restore();
    }
