...
internal class _DatePickerLayoutDelegate__date_picker : global::Doroti.Generated.Framework.Rendering.MultiChildLayoutDelegate
{
    ...
    public override void performLayout(Size size)
    {
        ...
        for (var i__4578 = 0L; (i__4578 < checked((long)(this.columnWidths.Count))); i__4578++)
        {
            ...
            layoutChild(index__4633, global::Doroti.Generated.Framework.Rendering.BoxConstraints.CreateTight(new global::Doroti.Flutter.Ui.Size(Math.Max(0.0, childWidth__4715), size.height)));
            positionChild(index__4633, new global::Doroti.Flutter.Ui.Offset(currentHorizontalOffset__4377, 0.0));
...
public class CupertinoDatePicker : global::Doroti.Generated.Framework.Widgets.StatefulWidget
{
    ...
    {
        return texts.map<string, double>(((text) => TextPainter.computeMaxIntrinsicWidth(text: new global::Doroti.Generated.Framework.Painting.TextSpan(style: (textStyle ?? Date_pickerLibrary._themeTextStyle(context)), text: text), textDirection: Directionality.of(context)))).reduce(global::Doroti.Flutter.Runtime.Dart_mathLibrary.max);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
global::Doroti.Flutter.Ui.Color? color__109068 = ((global::Doroti.Flutter.Ui.Color?)(object?)CupertinoDynamicColor.maybeResolve(((CupertinoTimerPicker)this.widget).backgroundColor, context));
