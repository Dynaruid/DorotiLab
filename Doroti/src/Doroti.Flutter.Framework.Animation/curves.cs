...
public abstract class ParametricCurve<T>
{
    ...
    public override string ToString() => global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "ParametricCurve");
}
...
public class SawTooth : Curve
{
    ...
    {
        return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "SawTooth"))}({this.count})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class Interval : Curve
{
    ...
    public override string ToString()
    {
        ...
        {
            return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "Interval"))}({this.begin}⋯{this.end})➩{this.curve}";
        }
        return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "Interval"))}({this.begin}⋯{this.end})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class Split : Curve
{
    ...
    public override string ToString()
    {
        return $"{(global::Doroti.Generated.Framework.Foundation.DiagnosticsLibrary.describeIdentity(this))}({this.split}, {this.beginCurve}, {this.endCurve})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class Cubic : Curve
{
    ...
    public override string ToString()
    {
        return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "Cubic"))}({this.a.toStringAsFixed(2L)}, {this.b.toStringAsFixed(2L)}, {this.c.toStringAsFixed(2L)}, {this.d.toStringAsFixed(2L)})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class ThreePointCubic : Curve
{
    ...
    public override string ToString()
    {
        return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, $"ThreePointCubic({this.a1}, {this.b1}, {this.midpoint}, {this.a2}, {this.b2})"))} ";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public abstract class Curve2D : ParametricCurve<Offset>
{
    ...
    public virtual IEnumerable<Curve2DSample> generateSamples(double start = 0.0, double end = 1.0, double tolerance = 1e-10)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Offset pr__23382 = (p - r);
            global::Doroti.Flutter.Ui.Offset qr__23413 = (q - r);
...
public class CatmullRomSpline : Curve2D
{
    ...
    public CatmullRomSpline(List<Offset> controlPoints, double tension = 0.0, Offset? startHandle = null, Offset? endHandle = null)
    {
        ...
        this._cubicSegments = new List<List<global::Doroti.Flutter.Ui.Offset>>();
    ...
    internal static List<List<global::Doroti.Flutter.Ui.Offset>> _computeSegments(List<Offset> controlPoints, double tension, Offset? startHandle = null, Offset? endHandle = null)
    {
        ...
        var allPoints__32366 = new List<global::Doroti.Flutter.Ui.Offset> { DartRuntimePrimitives.RequireValue(startHandle), DartRuntimePrimitives.RequireValue(endHandle) };
        var alpha__32763 = 0.5;
        double reverseTension__32793 = (1.0 - tension);
        var result__32835 = new List<List<global::Doroti.Flutter.Ui.Offset>>();
        for (var i__32875 = 0L; (i__32875 < (checked((long)(allPoints__32366.Count)) - 3L)); ++i__32875)
        {
            var curve__32927 = new List<global::Doroti.Flutter.Ui.Offset> { allPoints__32366[(int)(i__32875)], allPoints__32366[(int)((i__32875 + 1L))], allPoints__32366[(int)((i__32875 + 2L))], allPoints__32366[(int)((i__32875 + 3L))] };
            global::Doroti.Flutter.Ui.Offset diffCurve10__33032 = (curve__32927[(int)(1L)] - curve__32927[(int)(0L)]);
            global::Doroti.Flutter.Ui.Offset diffCurve21__33086 = (curve__32927[(int)(2L)] - curve__32927[(int)(1L)]);
            global::Doroti.Flutter.Ui.Offset diffCurve32__33140 = (curve__32927[(int)(3L)] - curve__32927[(int)(2L)]);
            double t01__33194 = global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(diffCurve10__33032.distance, alpha__32763).toDouble();
            double t12__33269 = global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(diffCurve21__33086.distance, alpha__32763).toDouble();
            double t23__33344 = global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(diffCurve32__33140.distance, alpha__32763).toDouble();
            global::Doroti.Flutter.Ui.Offset m1__33420 = (((diffCurve21__33086 + ((((diffCurve10__33032 / t01__33194) - (((curve__32927[(int)(2L)] - curve__32927[(int)(0L)])) / ((t01__33194 + t12__33269))))) * t12__33269))) * reverseTension__32793);
            global::Doroti.Flutter.Ui.Offset m2__33562 = (((diffCurve21__33086 + ((((diffCurve32__33140 / t23__33344) - (((curve__32927[(int)(3L)] - curve__32927[(int)(1L)])) / ((t12__33269 + t23__33344))))) * t12__33269))) * reverseTension__32793);
            global::Doroti.Flutter.Ui.Offset sumM12__33704 = (m1__33420 + m2__33562);
            var segment__33735 = new List<global::Doroti.Flutter.Ui.Offset> { ((diffCurve21__33086 * -2.0) + sumM12__33704), (((diffCurve21__33086 * 3.0) - m1__33420) - sumM12__33704), m1__33420, curve__32927[(int)(1L)] };
    ...
    public override long samplingSeed
    {
        ...
        {
            _initializeIfNeeded();
            global::Doroti.Flutter.Ui.Offset seedPoint__34612 = this._cubicSegments[(int)(0L)][(int)(1L)];
            return ((((seedPoint__34612.dx + seedPoint__34612.dy)) * 10000L)).round();
            return default!;
        }
    }
    public override global::Doroti.Flutter.Ui.Offset transformInternal(double t)
    {
        _initializeIfNeeded();
        ...
        List<global::Doroti.Flutter.Ui.Offset> cubicControlPoints__35161 = this._cubicSegments[(int)(index__34915)];
...
public class CatmullRomCurve : Curve
{
    ...
    {
        return CatmullRomSpline.CreatePrecompute(new List<global::Doroti.Flutter.Ui.Offset> { Offset.zero, new global::Doroti.Flutter.Ui.Offset(1.0, 1.0) }, tension: tension).generateSamples(tolerance: 1e-12).ToList();
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public static bool validateControlPoints(List<Offset>? controlPoints, double tension = 0.0, List<string>? reasons = null)
    {
        ...
        controlPoints = new List<global::Doroti.Flutter.Ui.Offset> { Offset.zero, new global::Doroti.Flutter.Ui.Offset(1.0, 1.0) };
        global::Doroti.Flutter.Ui.Offset startHandle__42976 = ((controlPoints[(int)(0L)] * 2.0) - controlPoints[(int)(1L)]);
        global::Doroti.Flutter.Ui.Offset endHandle__43050 = ((controlPoints.Last() * 2.0) - controlPoints[(int)((checked((long)(controlPoints.Count)) - 2L))]);
        controlPoints = new List<global::Doroti.Flutter.Ui.Offset> { startHandle__42976, endHandle__43050 };
        ...
        {
            global::Doroti.Flutter.Ui.Offset point__45536 = ((Curve2DSample)sample__45491).value;
    ...
    public override double transformInternal(double t)
    {
        ...
        global::Doroti.Flutter.Ui.Offset value__47326 = default!;
        global::Doroti.Flutter.Ui.Offset startValue__47344 = this._precomputedSamples[(int)(start__47245)].value;
        global::Doroti.Flutter.Ui.Offset endValue__47402 = this._precomputedSamples[(int)(end__47264)].value;
...
public class FlippedCurve : Curve
{
    ...
    public override string ToString()
    {
        return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "FlippedCurve"))}({this.curve})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class ElasticInCurve : Curve
{
    ...
    public override double transformInternal(double t)
    {
        ...
        t = (t - 1.0);
        return (-global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(2.0, (10.0 * t)) * global::Doroti.Flutter.Runtime.Dart_mathLibrary.sin(((((t - s__51838)) * ((Dart_mathLibrary.pi * 2.0))) / this.period)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override string ToString()
    {
        return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "ElasticInCurve"))}({this.period})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class ElasticOutCurve : Curve
{
    ...
    public override double transformInternal(double t)
    {
        ...
        return ((global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(2.0, (-10L * t)) * global::Doroti.Flutter.Runtime.Dart_mathLibrary.sin(((((t - s__52711)) * ((Dart_mathLibrary.pi * 2.0))) / this.period))) + 1.0);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override string ToString()
    {
        return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "ElasticOutCurve"))}({this.period})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class ElasticInOutCurve : Curve
{
    ...
    public override double transformInternal(double t)
    {
        ...
        if ((t < 0.0))
        {
            return ((-0.5 * global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(2.0, (10.0 * t))) * global::Doroti.Flutter.Runtime.Dart_mathLibrary.sin(((((t - s__53605)) * ((Dart_mathLibrary.pi * 2.0))) / this.period)));
        }
        else
        {
            return (((global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(2.0, (-10.0 * t)) * global::Doroti.Flutter.Runtime.Dart_mathLibrary.sin(((((t - s__53605)) * ((Dart_mathLibrary.pi * 2.0))) / this.period))) * 0.5) + 1.0);
        }
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override string ToString()
    {
        return $"{(global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "ElasticInOutCurve"))}({this.period})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public abstract class Curves
{
    ...
    public static ThreePointCubic fastEaseInToSlowEaseOut = new ThreePointCubic(new global::Doroti.Flutter.Ui.Offset(0.056, 0.024), new global::Doroti.Flutter.Ui.Offset(0.108, 0.3085), new global::Doroti.Flutter.Ui.Offset(0.198, 0.541), new global::Doroti.Flutter.Ui.Offset(0.3655, 1.0), new global::Doroti.Flutter.Ui.Offset(0.5465, 0.989));
    ...
    public static ThreePointCubic easeInOutCubicEmphasized = new ThreePointCubic(new global::Doroti.Flutter.Ui.Offset(0.05, 0), new global::Doroti.Flutter.Ui.Offset(0.133333, 0.06), new global::Doroti.Flutter.Ui.Offset(0.166666, 0.4), new global::Doroti.Flutter.Ui.Offset(0.208333, 0.82), new global::Doroti.Flutter.Ui.Offset(0.25, 1));
