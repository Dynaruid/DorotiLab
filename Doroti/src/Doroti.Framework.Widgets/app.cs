...
public static partial class AppLibrary
{
    ...
    )
    {
        ...
        DartMap<string, Locale> allSupportedLocales = new DartMap<string, Locale>().cast<
            string,
            Locale
        >();
        DartMap<string, Locale> languageAndCountryLocales = new DartMap<string, Locale>().cast<
            string,
            Locale
        >();
        DartMap<string, Locale> languageAndScriptLocales = new DartMap<string, Locale>().cast<
            string,
            Locale
        >();
        DartMap<string, Locale> languageLocales = new DartMap<string, Locale>().cast<
            string,
            Locale
        >();
        DartMap<string?, Locale> countryLocales = new DartMap<string?, Locale>().cast<
            string?,
            Locale
        >();
        foreach (var locale in supportedLocales)
        {
            ...
            languageAndScriptLocales.putIfAbsent(
                $"{locale.languageCode}_{locale.scriptCode}",
                () => locale
            );
            languageAndCountryLocales.putIfAbsent(
        ...
        for (var localeIndex = 0L; localeIndex < checked(preferredLocales.Count); localeIndex += 1L)
        {
            ...
            if (
                allSupportedLocales.ContainsKey(
            ...
            {
                Locale? match = DartCollectionRuntime.NullableMapValue<Locale>(
            ...
            {
                Locale? matchLocal = DartCollectionRuntime.NullableMapValue<Locale>(
            ...
            if (matchAlternate is not null)
            {
                ...
                if (
                    (localeIndex == 0L)
                    && !(
                        ((localeIndex + 1L) < checked(preferredLocales.Count))
                        && (
                            preferredLocales[(int)(localeIndex + 1L)].languageCode
                            == userLocale.languageCode
                        )
                    )
                )
            ...
            {
                matchAlternate = DartCollectionRuntime.NullableMapValue<Locale>(
                    countryLocales,
...
public delegate Route<object> PageRouteFactory(
...
public class WidgetsApp : StatefulWidget
{
    ...
    internal static DartMap<ShortcutActivator, Intent> _defaultShortcuts = new DartMap<
        ShortcutActivator,
        Intent
    >
    {
        ...
        [new SingleActivator(LogicalKeyboardKey.arrowUp, control: true)] = new ScrollIntent(
            direction: AxisDirection.up
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowDown, control: true)] = new ScrollIntent(
            direction: AxisDirection.down
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowLeft, control: true)] = new ScrollIntent(
            direction: AxisDirection.left
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowRight, control: true)] = new ScrollIntent(
    ...
    internal static DartMap<ShortcutActivator, Intent> _defaultWebShortcuts = new DartMap<
        ShortcutActivator,
        Intent
    >
    {
        [new SingleActivator(LogicalKeyboardKey.space)] = new PrioritizedIntents(
            orderedIntents: new List<Intent>
            {
                new ActivateIntent(),
        ...
        [new SingleActivator(LogicalKeyboardKey.tab)] = new NextFocusIntent(),
        [new SingleActivator(LogicalKeyboardKey.tab, shift: true)] = new PreviousFocusIntent(),
        [new SingleActivator(LogicalKeyboardKey.arrowUp)] = new ScrollIntent(
            direction: AxisDirection.up
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowDown)] = new ScrollIntent(
            direction: AxisDirection.down
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowLeft)] = new ScrollIntent(
            direction: AxisDirection.left
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowRight)] = new ScrollIntent(
            direction: AxisDirection.right
        ),
        [new SingleActivator(LogicalKeyboardKey.pageUp)] = new ScrollIntent(
            direction: AxisDirection.up,
    ...
    internal static DartMap<ShortcutActivator, Intent> _defaultAppleOsShortcuts = new DartMap<
        ShortcutActivator,
        Intent
    >
    {
        ...
        [new SingleActivator(LogicalKeyboardKey.arrowUp, meta: true)] = new ScrollIntent(
            direction: AxisDirection.up
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowDown, meta: true)] = new ScrollIntent(
            direction: AxisDirection.down
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowLeft, meta: true)] = new ScrollIntent(
            direction: AxisDirection.left
        ),
        [new SingleActivator(LogicalKeyboardKey.arrowRight, meta: true)] = new ScrollIntent(
            direction: AxisDirection.right
        ),
        [new SingleActivator(LogicalKeyboardKey.pageUp)] = new ScrollIntent(
            direction: AxisDirection.up,
    ...
    internal static DartMap<Type, dynamic> defaultActionsForContext(BuildContext context)
    {
        ...
        actions[typeof(ScrollIntent)] = IntentAction<ScrollIntent>.CreateOverridable(
            context: context,
            defaultAction: new ScrollAction()
        );
        return actions;
    }
        ...
        : base(key: key)
    {
        ...
        System.Diagnostics.Debug.Assert(
            (home is null) || !__routes.ContainsKey(Navigator.defaultRouteName)
        );
        System.Diagnostics.Debug.Assert(
            (builder is not null)
                || (home is not null)
                || __routes.ContainsKey(Navigator.defaultRouteName)
                || (onGenerateRoute is not null)
                || (onUnknownRoute is not null)
        );
        System.Diagnostics.Debug.Assert(
            (home is not null)
                || Enumerable.Any(__routes)
                || (onGenerateRoute is not null)
                || (onUnknownRoute is not null)
                || (
                    (builder is not null)
                    && (navigatorKey is null)
                    && (initialRoute is null)
                    && !Enumerable.Any(__navigatorObservers)
                )
        );
        System.Diagnostics.Debug.Assert(
            (builder is not null) || (onGenerateRoute is not null) || (pageRouteBuilder is not null)
        );
        System.Diagnostics.Debug.Assert(Enumerable.Any(__supportedLocales));
    }

    public static WidgetsApp CreateRouter(
        Key? key = null,
    ...
    {
        get { return WidgetsBinding.instance.debugShowWidgetInspectorOverrideNotifier.value; }
        set
        {
            var __value = value;
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _WidgetsAppState__app());
}
...
internal class _WidgetsAppState__app : State<WidgetsApp>, WidgetsBindingObserver
{
    ...
    internal virtual PlatformRouteInformationProvider? _defaultRouteInformationProvider { get; set; } =
        default;
    ...
    internal virtual LocalizationsResolver _localizationsResolver
    {
        get
        {
            ...
            {
                __late__localizationsResolver = new LocalizationsResolver(
    ...
    internal virtual string _initialRouteName =>
    ...
    internal virtual void _updateRouting(WidgetsApp? oldWidget = null)
    {
        if (_usesRouterWithDelegates)
        {
            ...
            if (
                (widget.routeInformationProvider is null)
                && (widget.routeInformationParser is not null)
            )
            {
                _defaultRouteInformationProvider ??= new PlatformRouteInformationProvider(
                    initialRouteInformation: new RouteInformation(
                        uri: DartUri.parse(_initialRouteName)
                    )
                );
            }
            else
        ...
        else
        {
            ...
            {
                DartRuntimePrimitives.Assert(() =>
                    (widget.builder is not null) || _usesRouterWithConfig
                );
    ...
    internal virtual bool _usesRouterWithDelegates =>
        DartRuntimePrimitives.ConvertValue<bool>(widget.routerDelegate is not null);
    internal virtual bool _usesRouterWithConfig =>
        DartRuntimePrimitives.ConvertValue<bool>(widget.routerConfig is not null);
    internal virtual bool _usesNavigator =>
        DartRuntimePrimitives.ConvertValue<bool>(
            (((WidgetsApp)widget).home is not null)
                || (
                    (
                        ((WidgetsApp)widget).routes is { } __items66337
                            ? System.Linq.Enumerable.Any(__items66337)
                            : (bool?)null
                    ) ?? false
                )
                || (((WidgetsApp)widget).onGenerateRoute is not null)
                || (((WidgetsApp)widget).onUnknownRoute is not null)
        );
    internal virtual RouteInformationProvider? _effectiveRouteInformationProvider =>
        DartRuntimePrimitives.ConvertValue<RouteInformationProvider>(
            widget.routeInformationProvider ?? _defaultRouteInformationProvider
        );
    internal virtual BackButtonDispatcher _effectiveBackButtonDispatcher =>
        DartRuntimePrimitives.ConvertValue<BackButtonDispatcher>(
    ...
    internal virtual dynamic? _onGenerateRoute(RouteSettings settings)
    {
        ...
        Func<BuildContext, Widget>? pageContentBuilder =
            ((nameLocal == Navigator.defaultRouteName) && (widget.home is not null))
                ? ((context) => widget.home!)
                : widget.routes!.GetValueOrDefault(
                    DartRuntimePrimitives.RequireReference(nameLocal)
                );
        if (pageContentBuilder is not null)
        {
            DartRuntimePrimitives.Assert(
                () => widget.pageRouteBuilder is not null,
                () =>
                    (object?)"The default onGenerateRoute handler for WidgetsApp must have a "
    ...
    {
        return (!Equals(widget.locale, oldWidget.locale))
            || (
                !Equals(widget.localeListResolutionCallback, oldWidget.localeListResolutionCallback)
            )
    ...
    public override Widget build(BuildContext context)
    {
        ...
        if (_usesRouterWithDelegates)
        {
            routing = DartRuntimePrimitives.ConvertValue<Widget>(
                widget.routerDelegate!.createRouterWidget(
        ...
        else
        {
                ...
                routing = DartRuntimePrimitives.ConvertValue<Widget>(
                    new FocusScope(
                        ...
                        child: new Navigator(
                            ...
                            onGenerateInitialRoutes: (widget.onGenerateInitialRoutes is null)
                            ...
                            routeTraversalEdgeBehavior: Foundation.ConstantsLibrary.kIsWeb
                                ? TraversalEdgeBehavior.leaveDorotiView
            ...
            else
            {
                ...
                {
                    routing = DartRuntimePrimitives.ConvertValue<Widget>(
                        widget.routerConfig!.createRouterWidget(restorationScopeId: "router")
                    );
                }
            }
        }
        ...
        {
            result = DartRuntimePrimitives.ConvertValue<Widget>(
                new DefaultTextStyle(style: widget.textStyle!, child: result)
            );
        }
                ...
                new Stack(
                    children: new List<Widget>
                    {
                        ...
                        new Positioned(
                            ...
                            left: 0.0,
                            right: 0.0,
                            child: PerformanceOverlay.CreateAllEnabled()
                        ),
                    }
                )
            );
        ...
        {
            result = DartRuntimePrimitives.ConvertValue<Widget>(
                new SemanticsDebugger(child: result)
            );
        }
        DartRuntimePrimitives.Assert(() =>
        {
            if (!WidgetsBinding.instance.debugExcludeRootWidgetInspector)
            {
                result = DartRuntimePrimitives.ConvertValue<Widget>(
                    new ValueListenableBuilder<bool>(
                        valueListenable: WidgetsBinding
                            .instance
                            .debugShowWidgetInspectorOverrideNotifier,
                        builder: (context, debugShowWidgetInspectorOverride, child) =>
                        {
            ...
            {
                result = DartRuntimePrimitives.ConvertValue<Widget>(
                    new CheckedModeBanner(child: result)
                );
            }
            return true;
            throw new InvalidOperationException("Dart closure completed without a value.");
        ...
        result = DartRuntimePrimitives.ConvertValue<Widget>(
            new Focus(
                ...
                {
                    if (
                        ((@event is not KeyDownEvent) && (@event is not KeyRepeatEvent))
                        || (!Equals(@event.logicalKey, LogicalKeyboardKey.escape))
                    )
                    {
