...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/expansible.dart
#nullable enable
...
public delegate Widget ExpansibleComponentBuilder(BuildContext context, global::Doroti.Generated.Framework.Animation.Animation<double> animation);

public delegate Widget ExpansibleBuilder(BuildContext context, Widget header, Widget body, global::Doroti.Generated.Framework.Animation.Animation<double> animation);

public class ExpansibleController : global::Doroti.Generated.Framework.Foundation.ChangeNotifier
{
        ...
        DartRuntimePrimitives.Assert(() =>
            {
                ...
                {
                    throw DartRuntimePrimitives.AsException(new global::Doroti.Generated.Framework.Foundation.FlutterError(new List<global::Doroti.Generated.Framework.Foundation.DiagnosticsNode> { new global::Doroti.Generated.Framework.Foundation.ErrorSummary("ExpansibleController.of() called with a context that does not contain a Expansible."), new global::Doroti.Generated.Framework.Foundation.ErrorDescription("No Expansible ancestor could be found starting from the context that was passed to ExpansibleController.of(). " + "This usually happens when the context provided is from the same StatefulWidget as that " + "whose build function actually creates the Expansible widget being sought."), new global::Doroti.Generated.Framework.Foundation.ErrorHint("There are several ways to avoid this problem. The simplest is to use a Builder to get a " + "context that is \"under\" the Expansible. "), new global::Doroti.Generated.Framework.Foundation.ErrorHint("A more efficient solution is to split your build function into several widgets. This " + "introduces a new context from which you can obtain the Expansible. In this solution, " + "you would have an outer widget that creates the Expansible populated by instances of " + "your new inner widgets, and then in these inner widgets you would use ExpansibleController.of().\n" + "An other solution is assign a GlobalKey to the Expansible, " + "then use the key.currentState property to obtain the Expansible rather than " + "using the ExpansibleController.of() function."), context.describeElement("The context used was") }));
                }
                return true;
...
public class Expansible : StatefulWidget
{
    ...
    public virtual global::System.Func<BuildContext, global::Doroti.Generated.Framework.Animation.Animation<double>, Widget> headerBuilder { get; private set; } = default!;
    public virtual global::System.Func<BuildContext, global::Doroti.Generated.Framework.Animation.Animation<double>, Widget> bodyBuilder { get; private set; } = default!;
    ...
    public virtual global::System.Func<BuildContext, Widget, Widget, global::Doroti.Generated.Framework.Animation.Animation<double>, Widget> expansibleBuilder { get; private set; } = default!;

    public Expansible(global::Doroti.Generated.Framework.Foundation.Key? key = null, global::System.Func<BuildContext, global::Doroti.Generated.Framework.Animation.Animation<double>, Widget> headerBuilder = default!, global::System.Func<BuildContext, global::Doroti.Generated.Framework.Animation.Animation<double>, Widget> bodyBuilder = default!, ExpansibleController controller = default!, global::System.Func<BuildContext, Widget, Widget, global::Doroti.Generated.Framework.Animation.Animation<double>, Widget> expansibleBuilder = default!, global::Doroti.Generated.Framework.Animation.AnimationStyle? animationStyle = null, Duration? duration = null, global::Doroti.Generated.Framework.Animation.Curve curve = default!, global::Doroti.Generated.Framework.Animation.Curve? reverseCurve = null, bool maintainState = true) : base(key: key)
    {
        global::System.Func<BuildContext, Widget, Widget, global::Doroti.Generated.Framework.Animation.Animation<double>, Widget> __expansibleBuilder = expansibleBuilder ?? _defaultExpansibleBuilder;
        Duration __duration = duration ?? Duration.Create(milliseconds: 200);
        global::Doroti.Generated.Framework.Animation.Curve __curve = curve ?? global::Doroti.Generated.Framework.Animation.Curves.ease;
    ...
    internal static Widget _defaultExpansibleBuilder(BuildContext context, Widget header, Widget body, global::Doroti.Generated.Framework.Animation.Animation<double> animation)
    {
        return ((Widget)(object?)new Column(mainAxisSize: global::Doroti.Generated.Framework.Rendering.MainAxisSize.min, children: new List<Widget> { header, body }));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _ExpansibleState__expansible : State<Expansible>, SingleTickerProviderStateMixin<Expansible>
{
    ...
    internal virtual global::Doroti.Generated.Framework.Animation.CurvedAnimation _heightFactor { get; set; } = default!;
    ...
    internal virtual global::Doroti.Generated.Framework.Animation.Curve _curve
    {
        get
        {
    ...
    internal virtual global::Doroti.Generated.Framework.Animation.Curve? _reverseCurve
    {
        get
        {
    ...
    {
        base.initState();
        _animationController = new global::Doroti.Generated.Framework.Animation.AnimationController(duration: this._duration, vsync: this);
        ...
        var heightFactorTween__14621 = new global::Doroti.Generated.Framework.Animation.Tween<double>(begin: 0.0, end: 1.0);
        _heightFactor = new global::Doroti.Generated.Framework.Animation.CurvedAnimation(parent: this._animationController.drive(heightFactorTween__14621), curve: this._curve, reverseCurve: this._reverseCurve);
    ...
    public override void didUpdateWidget(Expansible oldWidget)
    {
        ...
        global::Doroti.Generated.Framework.Animation.Curve oldCurve__15111 = (((Expansible)oldWidget).animationStyle?.curve ?? ((Expansible)oldWidget).curve);
        global::Doroti.Generated.Framework.Animation.Curve? oldReverseCurve__15191 = (((Expansible)oldWidget).animationStyle?.reverseCurve ?? ((Expansible)oldWidget).reverseCurve);
...
PageStorage.maybeOf(this.context)?.writeState(this.context, ((Expansible)this.widget).controller.isExpanded);
    ...
    public override Widget build(BuildContext context)
    {
        ...
        return ((Widget)(object?)new AnimatedBuilder(animation: ((global::Doroti.Generated.Framework.Animation.AnimationController)this._animationController).view, builder: ((global::System.Func<BuildContext, Widget?, Widget>)((context, child) => {
Widget header__17139 = this.widget.headerBuilder(context, this._animationController);
Widget body__17222 = ((Widget)(object?)new ClipRect(child: new Align(heightFactor: ((global::Doroti.Generated.Framework.Animation.CurvedAnimation)this._heightFactor).value, child: child)));
