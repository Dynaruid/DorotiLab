...
public class MediaQueryData
{
    ...
    internal static global::Doroti.Generated.Framework.Painting.TextScaler _textScalerFromView(DorotiView view, MediaQueryData? platformData)
    {
        return (platformData?.textScaler ?? new SystemTextScaler(view.platformDispatcher));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal static global::Doroti.Generated.Framework.Painting.BorderRadius? _displayCornerRadiiFromView(DorotiView view)
    {
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public static Widget fromView(global::Doroti.Generated.Framework.Foundation.Key? key = null, DorotiView view = default!, Widget child = default!)
    {
...
public class _MediaQueryFromView__media_query : StatefulWidget
{
    ...
    internal _MediaQueryFromView__media_query(global::Doroti.Generated.Framework.Foundation.Key? key = null, DorotiView view = default!, bool ignoreParentData = false, Widget child = default!) : base(key: key)
    {
        this.view = view;
