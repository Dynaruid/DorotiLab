...
public class MediaQueryData
{
    ...
    public virtual TextScaler textScaler
    {
        get
        {
            if (!DartRuntimePrimitives.Identical(Media_queryLibrary._kUnspecifiedTextScaler, _textScaler))
            {
                return _textScaler;
            }
            return (_textScaleFactor == 1.0) ? TextScaler.noScaling : TextScaler.CreateLinear(_textScaleFactor);
        }
    }
    ...
    public virtual MediaQueryData removeViewInsets(bool removeLeft = false, bool removeTop = false, bool removeRight = false, bool removeBottom = false)
    {
        ...
        return copyWith(viewPadding: viewPadding.copyWith(left: removeLeft ? Math.Max(0.0, viewPadding.left - viewInsets.left) : null, top: removeTop ? Math.Max(0.0, viewPadding.top - viewInsets.top) : null, right: removeRight ? Math.Max(0.0, viewPadding.right - viewInsets.right) : null, bottom: removeBottom ? Math.Max(0.0, viewPadding.bottom - viewInsets.bottom) : null), viewInsets: viewInsets.copyWith(left: removeLeft ? 0.0 : null, top: removeTop ? 0.0 : null, right: removeRight ? 0.0 : null, bottom: removeBottom ? 0.0 : null));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual MediaQueryData removeViewPadding(bool removeLeft = false, bool removeTop = false, bool removeRight = false, bool removeBottom = false)
    {
        ...
        return copyWith(padding: padding.copyWith(left: removeLeft ? 0.0 : null, top: removeTop ? 0.0 : null, right: removeRight ? 0.0 : null, bottom: removeBottom ? 0.0 : null), viewPadding: viewPadding.copyWith(left: removeLeft ? 0.0 : null, top: removeTop ? 0.0 : null, right: removeRight ? 0.0 : null, bottom: removeBottom ? 0.0 : null));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual MediaQueryData removeDisplayFeatures(Rect subScreen)
    {
        DartRuntimePrimitives.Assert(() => (subScreen.left >= 0.0) && (subScreen.top >= 0.0) && (subScreen.right <= size.width) && (subScreen.bottom <= size.height), () => (object?)"'subScreen' argument cannot be outside the bounds of the screen");
        ...
        return copyWith(padding: EdgeInsets.CreateOnly(left: Math.Max(0.0, padding.left - subScreen.left), top: Math.Max(0.0, padding.top - subScreen.top), right: Math.Max(0.0, padding.right - rightInset), bottom: Math.Max(0.0, padding.bottom - bottomInset)), viewPadding: EdgeInsets.CreateOnly(left: Math.Max(0.0, viewPadding.left - subScreen.left), top: Math.Max(0.0, viewPadding.top - subScreen.top), right: Math.Max(0.0, viewPadding.right - rightInset), bottom: Math.Max(0.0, viewPadding.bottom - bottomInset)), viewInsets: EdgeInsets.CreateOnly(left: Math.Max(0.0, viewInsets.left - subScreen.left), top: Math.Max(0.0, viewInsets.top - subScreen.top), right: Math.Max(0.0, viewInsets.right - rightInset), bottom: Math.Max(0.0, viewInsets.bottom - bottomInset)), displayFeatures: displayFeatures.where((displayFeature) => subScreen.overlaps(displayFeature.bounds)).ToList());
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is MediaQueryData) && Equals(__other.size, size) && (__other.devicePixelRatio == devicePixelRatio) && (__other.textScaleFactor == textScaleFactor) && Equals(__other.platformBrightness, platformBrightness) && Equals(__other.padding, padding) && Equals(__other.viewPadding, viewPadding) && Equals(__other.viewInsets, viewInsets) && Equals(__other.systemGestureInsets, systemGestureInsets) && (__other.alwaysUse24HourFormat == alwaysUse24HourFormat) && (__other.highContrast == highContrast) && (__other.onOffSwitchLabels == onOffSwitchLabels) && (__other.disableAnimations == disableAnimations) && (__other.reduceMotion == reduceMotion) && (__other.invertColors == invertColors) && (__other.accessibleNavigation == accessibleNavigation) && (__other.boldText == boldText) && (__other.supportsAnnounce == supportsAnnounce) && Equals(__other.navigationMode, navigationMode) && Equals(__other.gestureSettings, gestureSettings) && CollectionsLibrary.listEquals(__other.displayFeatures, displayFeatures) && (__other.supportsShowingSystemContextMenu == supportsShowingSystemContextMenu) && (__other.lineHeightScaleFactorOverride == lineHeightScaleFactorOverride) && (__other.letterSpacingOverride == letterSpacingOverride) && (__other.wordSpacingOverride == wordSpacingOverride) && (__other.paragraphSpacingOverride == paragraphSpacingOverride) && Equals(__other.displayCornerRadii, displayCornerRadii);
    }

    public override int GetHashCode() => DartRuntimePrimitives.ConvertValue<int>(FoundationRuntimePorts.ObjectHash(size, devicePixelRatio, textScaleFactor, platformBrightness, padding, viewPadding, viewInsets, alwaysUse24HourFormat, highContrast, onOffSwitchLabels, disableAnimations, reduceMotion, invertColors, accessibleNavigation, boldText, navigationMode, gestureSettings, FoundationRuntimePorts.ObjectHashAll(displayFeatures), supportsShowingSystemContextMenu, FoundationRuntimePorts.ObjectHash(lineHeightScaleFactorOverride, letterSpacingOverride, wordSpacingOverride, paragraphSpacingOverride, displayCornerRadii)));
    public override string ToString()
    {
        var properties = new List<string> { $"size: {size}", $"devicePixelRatio: {devicePixelRatio.toStringAsFixed(1L)}", $"textScaler: {textScaler}", $"platformBrightness: {platformBrightness}", $"padding: {padding}", $"viewPadding: {viewPadding}", $"viewInsets: {viewInsets}", $"systemGestureInsets: {systemGestureInsets}", $"alwaysUse24HourFormat: {alwaysUse24HourFormat}", $"accessibleNavigation: {accessibleNavigation}", $"highContrast: {highContrast}", $"onOffSwitchLabels: {onOffSwitchLabels}", $"disableAnimations: {disableAnimations}", $"reduceMotion: {reduceMotion}", $"invertColors: {invertColors}", $"boldText: {boldText}", $"navigationMode: {navigationMode.ToString()}", $"gestureSettings: {gestureSettings}", $"displayFeatures: {displayFeatures}", $"supportsShowingSystemContextMenu: {supportsShowingSystemContextMenu}", $"lineHeightScaleFactorOverride: {lineHeightScaleFactorOverride}", $"letterSpacingOverride: {letterSpacingOverride}", $"wordSpacingOverride: {wordSpacingOverride}", $"paragraphSpacingOverride: {paragraphSpacingOverride}", $"displayCornerRadii: {displayCornerRadii}" };
...
public class MediaQuery : InheritedModel<_MediaQueryAspect__media_query>
{
    ...
    public static Widget applyTextStyleOverrides(Key? key = null, double? lineHeightScaleFactorOverride = default!, double? letterSpacingOverride = default!, double? wordSpacingOverride = default!, double? paragraphSpacingOverride = default!, Widget child = default!)
    {
        return new Builder(key: key, builder: (context) =>
        {
            ...
            return new MediaQuery(data: of(context).applyTextStyleOverrides(lineHeightScaleFactorOverride: lineHeightScaleFactorOverride, letterSpacingOverride: letterSpacingOverride, wordSpacingOverride: wordSpacingOverride, paragraphSpacingOverride: paragraphSpacingOverride), child: child);
    ...
    public static Widget withNoTextScaling(Key? key = null, Widget child = default!)
    {
        ...
        {
            DartRuntimePrimitives.Assert(() => DebugLibrary.debugCheckHasMediaQuery(context));
            return new MediaQuery(data: of(context).copyWith(textScaler: TextScaler.noScaling), child: child);
            throw new InvalidOperationException("Dart closure completed without a value.");
        });
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public static Widget withClampedTextScaling(Key? key = null, double minScaleFactor = 0.0, double maxScaleFactor = double.PositiveInfinity, Widget child = default!)
    {
        ...
        return new Builder(builder: (context) =>
        {
            ...
            return new MediaQuery(data: dataLocal.copyWith(textScaler: dataLocal.textScaler.clamp(minScaleFactor: minScaleFactor, maxScaleFactor: maxScaleFactor)), child: child);
            throw new InvalidOperationException("Dart closure completed without a value.");
        });
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _MediaQueryFromViewState__media_query : State<_MediaQueryFromView__media_query>, WidgetsBindingObserver
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        if (!Foundation.ConstantsLibrary.kReleaseMode && (_parentData is null) && (!Equals(effectiveData.platformBrightness, Foundation.DebugLibrary.debugBrightnessOverride)))
        {
...
public class SystemTextScaler : TextScaler
{
    ...
    public SystemTextScaler(PlatformConfiguration? configuration, PlatformDispatcher _platformDispatcher)
    {
        ...
        __field_textScaleFactor = configuration?.textScaleFactor ?? _platformDispatcher.textScaleFactor;
    ...
    public override bool Equals(object? other)
    {
        ...
        return other switch { SystemTextScaler { textScaleFactor: double textScaleFactorLocal } => textScaleFactor == textScaleFactorLocal, var noScaling when Equals(noScaling, TextScaler.noScaling) => textScaleFactor == 1.0, _ => false };
    }

    public override int GetHashCode() => DartRuntimePrimitives.ConvertValue<int>(textScaleFactor.GetHashCode());
    public override string ToString() => $"SystemTextScaler ({((textScaleFactor == 1.0) ? "no scaling" : $"{textScaleFactor}x")})";
}
