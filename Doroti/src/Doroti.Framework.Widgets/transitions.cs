...
public abstract class AnimatedWidget : StatefulWidget
{
    ...
    protected AnimatedWidget(Key? key = null, Listenable listenable = default!) : base(key: key)
    {
...
public delegate Widget? DelegatedTransitionBuilder(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation, bool allowSnapshotting, Widget? child);
...
public class SlideTransition : AnimatedWidget
{
    ...
    public SlideTransition(Key? key = null, Animation<Offset> position = default!, bool transformHitTests = true, TextDirection? textDirection = null, Widget? child = null) : base(key: key, listenable: position)
    {
    ...
    public virtual Animation<Offset> position => DartRuntimePrimitives.ConvertValue<Animation<Offset>>(((Animation<Offset>?)listenable)!);
...
public class MatrixTransition : AnimatedWidget
{
    ...
    public MatrixTransition(Key? key = null, Animation<double> animation = default!, Func<double, Matrix4> onTransform = default!, Alignment alignment = default!, FilterQuality? filterQuality = null, Widget? child = null) : base(key: key, listenable: animation)
    {
...
{
    public ScaleTransition(Key? key = null, Animation<double> scale = default!, Alignment alignment = default!, FilterQuality? filterQuality = null, Widget? child = null) : base(key: key, alignment: alignment ?? Alignment.center, filterQuality: filterQuality, child: child, animation: scale, onTransform: _handleScaleMatrix)
    {
    }
...
{
    public RotationTransition(Key? key = null, Animation<double> turns = default!, Alignment alignment = default!, FilterQuality? filterQuality = null, Widget? child = null) : base(key: key, alignment: alignment ?? Alignment.center, filterQuality: filterQuality, child: child, animation: turns, onTransform: _handleTurnsMatrix)
    {
    }
...
public class SizeTransition : AnimatedWidget
{
    ...
    public SizeTransition(Key? key = null, Axis axis = Axis.vertical, Animation<double> sizeFactor = default!, double? axisAlignment = null, AlignmentGeometry? alignment = null, double? fixedCrossAxisSizeFactor = null, Widget? child = null) : base(key: key, listenable: sizeFactor)
    {
        this.axis = axis;
...
public class FadeTransition : SingleChildRenderObjectWidget
{
    ...
    public FadeTransition(Key? key = null, Animation<double> opacity = default!, bool alwaysIncludeSemantics = false, Widget? child = null) : base(key: key, child: child)
    {
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(((Func<RenderAnimatedOpacity>)(() =>
{
...
public class SliverFadeTransition : SingleChildRenderObjectWidget
{
    ...
    public SliverFadeTransition(Key? key = null, Animation<double> opacity = default!, bool alwaysIncludeSemantics = false, Widget? sliver = null) : base(key: key, child: sliver)
    {
        this.opacity = opacity;
        this.alwaysIncludeSemantics = alwaysIncludeSemantics;
    }
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(((Func<RenderSliverAnimatedOpacity>)(() =>
{
    var __cascade = __renderObject;
    __cascade.opacity = opacity;
    __cascade.alwaysIncludeSemantics = alwaysIncludeSemantics;
...
public class RelativeRectTween : Tween<RelativeRect>
{
    ...
    public override RelativeRect lerp(double t) => DartRuntimePrimitives.ConvertValue<RelativeRect>(RelativeRect.lerp(begin, end, t)!);
}
...
public class PositionedTransition : AnimatedWidget
{
    ...
    public PositionedTransition(Key? key = null, Animation<RelativeRect> rect = default!, Widget child = default!) : base(key: key, listenable: rect)
    {
        this.child = child;
    }
...
public class RelativePositionedTransition : AnimatedWidget
{
    ...
    public RelativePositionedTransition(Key? key = null, Animation<Rect?> rect = default!, Size size = default!, Widget child = default!) : base(key: key, listenable: rect)
    {
        this.size = size;
        this.child = child;
    }

    public virtual Animation<Rect?> rect => DartRuntimePrimitives.ConvertValue<Animation<Rect?>>(((Animation<Rect?>?)listenable)!);
    public override Widget build(BuildContext context)
    {
...
public class DecoratedBoxTransition : AnimatedWidget
{
    ...
    public DecoratedBoxTransition(Key? key = null, Animation<Decoration> decoration = default!, DecorationPosition position = DecorationPosition.background, Widget child = default!) : base(key: key, listenable: decoration)
    {
...
public class AlignTransition : AnimatedWidget
{
    ...
    public AlignTransition(Key? key = null, Animation<AlignmentGeometry> alignment = default!, Widget child = default!, double? widthFactor = null, double? heightFactor = null) : base(key: key, listenable: alignment)
    {
        this.child = child;
    ...
    public virtual Animation<AlignmentGeometry> alignment => ((Animation<AlignmentGeometry>?)listenable)!;
    public override Widget build(BuildContext context)
    {
...
public class DefaultTextStyleTransition : AnimatedWidget
{
    ...
    public DefaultTextStyleTransition(Key? key = null, Animation<TextStyle> style = default!, Widget child = default!, TextAlign? textAlign = null, bool softWrap = true, TextOverflow overflow = TextOverflow.clip, long? maxLines = null) : base(key: key, listenable: style)
    {
        this.child = child;
...
public class ListenableBuilder : AnimatedWidget
{
    ...
    public ListenableBuilder(Key? key = null, Listenable listenable = default!, Func<BuildContext, Widget?, Widget> builder = default!, Widget? child = null) : base(key: key, listenable: listenable)
    {
...
{
    public AnimatedBuilder(Key? key = null, Listenable animation = default!, Func<BuildContext, Widget?, Widget> builder = default!, Widget? child = null) : base(key: key, builder: builder, child: child, listenable: animation)
    {
    }
