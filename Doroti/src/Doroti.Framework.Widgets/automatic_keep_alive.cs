...
{
    internal virtual DartMap<Listenable, Action>? _handles { get; set; } = default;
    ...
    {
        Listenable handleLocal = notification.handle;
        _handles ??= new DartMap<Listenable, Action>();
...
{
    public virtual Listenable handle { get; private set; } = default!;
