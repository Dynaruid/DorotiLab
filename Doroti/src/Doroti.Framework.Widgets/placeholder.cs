        ...
        var path = (
            (Func<Path>)(
                () =>
                {
                    ...
                    __cascade.addPolygon(
                        new List<Offset> { rect.topRight, rect.bottomLeft },
                        false
                    );
                    __cascade.addPolygon(
                        new List<Offset> { rect.topLeft, rect.bottomRight },
                        false
                    );
                    return __cascade;
                }
    ...
    public override Widget build(BuildContext context)
    {
        return new LimitedBox(
            ...
            child: new CustomPaint(
                size: Size.infinite,
                painter: new _PlaceholderPainter__placeholder(
                    color: color,
