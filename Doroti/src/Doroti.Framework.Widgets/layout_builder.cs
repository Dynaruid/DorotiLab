...
{
    protected AbstractLayoutBuilder(Key? key = null)
        : base(key: key) { }
    ...
    public override RenderObjectElement createElement() =>
        DartRuntimePrimitives.ConvertValue<RenderObjectElement>(
            new _LayoutBuilderElement__layout_builder<LayoutInfoType>(this)
        );

    public virtual bool updateShouldRebuild(AbstractLayoutBuilder<LayoutInfoType> oldWidget) =>
        true;

    public abstract override RenderObject createRenderObject(BuildContext context);
}

public abstract class ConstrainedLayoutBuilder<ConstraintType>
    : AbstractLayoutBuilder<ConstraintType>
    where ConstraintType : Constraints
{
    private Func<BuildContext, ConstraintType, Widget> __field_builder = default!;
    public override Func<BuildContext, ConstraintType, Widget> builder
    {
        get => __field_builder;
    }
    ...
    protected ConstrainedLayoutBuilder(
        Key? key = null,
        Func<BuildContext, ConstraintType, Widget> builder = default!
    )
        : base(key: key)
    {
...
internal class _LayoutBuilderElement__layout_builder<LayoutInfoType> : RenderObjectElement
{
    ...
    internal _LayoutBuilderElement__layout_builder(AbstractLayoutBuilder<LayoutInfoType> widget)
        : base(widget) { }
    ...
    internal virtual void _scheduleRebuild()
    {
        ...
        bool deferMarkNeedsLayout = Scheduler.SchedulerBinding.instance.schedulerPhase switch
        {
            Scheduler.SchedulerPhase.idle => true,
            Scheduler.SchedulerPhase.postFrameCallbacks => true,
    ...
    {
        LayoutInfoType layoutInfoLocal = DartRuntimePrimitives.ConvertValue<LayoutInfoType>(
            layoutBuilder.layoutInfo
        );
        void updateChildCallback()
        {
            ...
            try
            {
                DartRuntimePrimitives.Assert(() =>
                    EqualityComparer<LayoutInfoType>.Default.Equals(
                        layoutInfoLocal,
                        layoutBuilder.layoutInfo
                    )
                );
                built = ((AbstractLayoutBuilder<LayoutInfoType>?)widget)!.builder(
                    this,
                    layoutInfoLocal
                );
            ...
            catch (Exception e)
            {
                ...
                built = ErrorWidget.builder(
                    Layout_builderLibrary._reportException(
                        new ErrorDescription($"building {widget}"),
                        e,
                        stack,
...
public interface RenderAbstractLayoutBuilderMixin<LayoutInfoType, out ChildType>
...
public delegate void RenderConstrainedLayoutBuilder<LayoutInfoType, ChildType>()
    where ChildType : RenderObject;
...
public class LayoutBuilder : ConstrainedLayoutBuilder<BoxConstraints>
{
    public LayoutBuilder(
        Key? key = null,
        Func<BuildContext, BoxConstraints, Widget> builder = default!
    )
        : base(key: key, builder: builder) { }

    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(
            new _RenderLayoutBuilder__layout_builder()
        );
}
