        ...
        DartRuntimePrimitives.Assert(() =>
            {
                ...
                {
                    throw DartRuntimePrimitives.AsException(new global::Doroti.Framework.Foundation.FlutterError(new List<global::Doroti.Framework.Foundation.DiagnosticsNode> { new global::Doroti.Framework.Foundation.ErrorSummary("No WidgetsLocalizations found."), new global::Doroti.Framework.Foundation.ErrorDescription($"{DartRuntimePrimitives.RuntimeType(context.widget)} widgets require WidgetsLocalizations " + "to be provided by a Localizations widget ancestor."), new global::Doroti.Framework.Foundation.ErrorDescription("The widgets library uses Localizations to generate messages, " + "labels, and abbreviations."), new global::Doroti.Framework.Foundation.ErrorHint("To introduce a WidgetsLocalizations, either use a " + "WidgetsApp at the root of your application to include them " + "automatically, or add a Localization widget with a " + "WidgetsLocalizations delegate.") }));
                }
                return true;
                throw new InvalidOperationException("Dart closure completed without a value.");
            });
