...
public static partial class DebugLibrary
{
    public static bool debugItemsHaveDuplicateKeys(IEnumerable<Widget> items)
    {
        DartRuntimePrimitives.Assert(() =>
        {
            ...
            {
                throw DartRuntimePrimitives.AsException(
                    FlutterError.Create($"Duplicate key found: {nonUniqueKey}.")
                );
            }
            return true;
            throw new InvalidOperationException("Callback completed without returning a value.");
...
public static partial class DebugLibrary
{
    public static bool debugCheckHasTable(BuildContext context)
    {
        ...
        {
            if (
                (context.widget is not Table)
                && (context.findAncestorWidgetOfExactType<Table>() is null)
            )
            {
                throw DartRuntimePrimitives.AsException(
                    new FlutterError(
                        new List<DiagnosticsNode>
                        {
                            ...
                            new ErrorDescription(
                                $"{DartRuntimePrimitives.RuntimeType(context.widget)} widgets require a Table widget ancestor."
                            ),
...
public static partial class DebugLibrary
{
    public static bool debugCheckHasMediaQuery(BuildContext context)
    {
        ...
        {
            if (
                (context.widget is not MediaQuery)
                && (context.getElementForInheritedWidgetOfExactType<MediaQuery>() is null)
            )
            {
                throw DartRuntimePrimitives.AsException(
                    new FlutterError(
                        new List<DiagnosticsNode>
                        {
                            ...
                            new ErrorDescription(
                                $"{DartRuntimePrimitives.RuntimeType(context.widget)} widgets require a MediaQuery widget ancestor."
                            ),
                            context.describeWidget(
...
public static partial class DebugLibrary
{
    ...
    )
    {
        ...
        {
            if (
                (context.widget is not Directionality)
                && (context.getElementForInheritedWidgetOfExactType<Directionality>() is null)
            )
            {
                why = (why is null) ? "" : $" {why}";
                throw DartRuntimePrimitives.AsException(
                    new FlutterError(
                        new List<DiagnosticsNode>
                        {
                            ...
                            new ErrorDescription(
                                $"{DartRuntimePrimitives.RuntimeType(context.widget)} widgets require a Directionality widget ancestor{why}.\n"
                            ),
                            context.describeWidget(
...
public static partial class DebugLibrary
{
    public static bool debugCheckHasWidgetsLocalizations(BuildContext context)
    {
        ...
        {
            if (
                Localizations.of<WidgetsLocalizations>(context, typeof(WidgetsLocalizations))
                is null
            )
            {
                throw DartRuntimePrimitives.AsException(
                    new FlutterError(
                        new List<DiagnosticsNode>
                        {
                            new ErrorSummary("No WidgetsLocalizations found."),
                            new ErrorDescription(
                                $"{DartRuntimePrimitives.RuntimeType(context.widget)} widgets require WidgetsLocalizations "
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            if (LookupBoundary.findAncestorWidgetOfExactType<Overlay>(context) is null)
            {
                bool hiddenByBoundary =
                    LookupBoundary.debugIsHidingAncestorWidgetOfExactType<Overlay>(context);
                throw DartRuntimePrimitives.AsException(
                    new FlutterError(
                        new List<DiagnosticsNode>
                        {
                            ...
                            new ErrorDescription(
                                $"{DartRuntimePrimitives.RuntimeType(context.widget)} widgets require an Overlay "
