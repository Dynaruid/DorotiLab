...
public class NavigationToolbar : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        {
            children.Add(
                new LayoutId(id: _ToolbarSlot__navigation_toolbar.leading, child: leading)
            );
        }
        ...
        {
            children.Add(
                new LayoutId(id: _ToolbarSlot__navigation_toolbar.trailing, child: trailing)
            );
        }
...
internal class _ToolbarLayout__navigation_toolbar : MultiChildLayoutDelegate
{
    ...
    internal _ToolbarLayout__navigation_toolbar(
        bool centerMiddle,
    ...
    public override void performLayout(Size size)
    {
        ...
        if (hasChild(_ToolbarSlot__navigation_toolbar.leading))
        {
            ...
            double leadingX = textDirection switch
            {
        ...
        if (hasChild(_ToolbarSlot__navigation_toolbar.trailing))
        {
            ...
            Size trailingSize = layoutChild(
                _ToolbarSlot__navigation_toolbar.trailing,
                constraintsLocal
            );
            double trailingX = textDirection switch
            {
            ...
            positionChild(
                _ToolbarSlot__navigation_toolbar.trailing,
                new Offset(trailingX, trailingY)
            );
        }
        if (hasChild(_ToolbarSlot__navigation_toolbar.middle))
        {
            ...
            BoxConstraints constraintsAlternate = BoxConstraints
                .CreateLoose(size)
                .copyWith(maxWidth: maxWidthLocal);
            Size middleSize = layoutChild(
                _ToolbarSlot__navigation_toolbar.middle,
                constraintsAlternate
            );
            ...
            double middleX = textDirection switch
            {
