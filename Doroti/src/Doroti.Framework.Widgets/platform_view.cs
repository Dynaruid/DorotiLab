...
public class AndroidView : StatefulWidget
{
    ...
    public virtual HashSet<Factory<OneSequenceGestureRecognizer>>? gestureRecognizers
    {
        get;
        private set;
    }
    ...
    public AndroidView(
        ...
        Action<long>? onPlatformViewCreated = null,
        PlatformViewHitTestBehavior hitTestBehavior = PlatformViewHitTestBehavior.opaque,
        TextDirection? layoutDirection = null,
        HashSet<Factory<OneSequenceGestureRecognizer>>? gestureRecognizers = null,
        object? creationParams = default!,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _AndroidViewState__platform_view());
}
...
public abstract class _DarwinView__platform_view : StatefulWidget
{
    ...
    internal _DarwinView__platform_view(
        Key? key = null,
        string viewType = default!,
        Action<long>? onPlatformViewCreated = null,
        PlatformViewHitTestBehavior hitTestBehavior = PlatformViewHitTestBehavior.opaque,
...
{
    public virtual UiKitViewGestureBlockingPolicy gestureBlockingPolicy { get; private set; } =
        default!;
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _UiKitViewState__platform_view());
}
...
public class AppKitView : _DarwinView__platform_view
{
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _AppKitViewState__platform_view());
}
...
public class HtmlElementView : StatelessWidget
{
    ...
    public static HtmlElementView CreateFromTagName(
        Key? key = null,
        string tagName = default!,
        bool isVisible = true,
        Action<object>? onElementCreated = null,
        PlatformViewHitTestBehavior hitTestBehavior = PlatformViewHitTestBehavior.opaque
...
internal class _AndroidViewState__platform_view : State<AndroidView>
{
    ...
    internal static HashSet<Factory<OneSequenceGestureRecognizer>> _emptyRecognizersSet =
        new HashSet<Factory<OneSequenceGestureRecognizer>>();
    ...
    public override Widget build(BuildContext context)
    {
        return new Focus(
            ...
            child: new _AndroidPlatformView__platform_view(
    ...
    internal virtual TextDirection _findLayoutDirection()
    {
        DartRuntimePrimitives.Assert(() =>
            (widget.layoutDirection is not null)
    ...
    internal virtual void _onFocusChange(bool isFocused)
    {
                                ...
                                FlutterError.reportError(
                                    new FlutterErrorDetails(
                                        ...
                                        context: new ErrorDescription(
                                            "while clearing the platform view focus"
                                        )
                                    )
                                );
                            }
        ...
        DartRuntimePrimitives.Ignore(
            SystemChannels
                .textInput.invokeMethod<object?>(
                    "TextInput.setPlatformViewClient",
                    new DartMap<string, object?> { ["platformViewId"] = _id }
                )
                .catchError(
                    (e, stack) =>
                    {
                        ...
                        else
                        {
                            FlutterError.reportError(
                                new FlutterErrorDetails(
                                    ...
                                    library: "widgets library",
                                    context: new ErrorDescription(
                                        "while setting the platform view client"
                                    )
                                )
                            );
                        }
...
internal abstract class _DarwinViewState__platform_view<PlatformViewT, ControllerT, RenderT, ViewT>
    : State<PlatformViewT>
    where PlatformViewT : _DarwinView__platform_view
    where ControllerT : DarwinPlatformViewController
    where RenderT : RenderDarwinPlatformView<ControllerT>
    where ViewT : _DarwinPlatformView__platform_view<ControllerT, RenderT>
{
    ...
    internal virtual async Future _createNewUiKitView()
    {
        try
        {
    ...
    internal virtual void _onFocusChange(bool isFocused, ControllerT controller)
    {
        ...
        DartRuntimePrimitives.Ignore(
            SystemChannels
                .textInput.invokeMethod<object?>(
                    "TextInput.setPlatformViewClient",
                    new DartMap<string, object?> { ["platformViewId"] = controller.id }
                )
                .then(
                    (_) => { },
                    onError: (error, stack) =>
...
internal class _UiKitViewState__platform_view
    : _DarwinViewState__platform_view<
        UiKitView,
        UiKitViewController,
        RenderUiKitView,
        _UiKitPlatformView__platform_view
    >
{
    public override async Future<UiKitViewController> createNewViewController(long id)
    {
        return await PlatformViewsService.initUiKitView(
            id: id,
            viewType: widget.viewType,
    ...
    {
        return new _UiKitPlatformView__platform_view(
            controller: _controller!,
            hitTestBehavior: widget.hitTestBehavior,
            gestureRecognizers: widget.gestureRecognizers ?? _emptyRecognizersSet
        );
...
internal class _AppKitViewState__platform_view
    : _DarwinViewState__platform_view<
        AppKitView,
        AppKitViewController,
        RenderAppKitView,
        _AppKitPlatformView__platform_view
    >
{
    public override async Future<AppKitViewController> createNewViewController(long id)
    {
    ...
    {
        return new _AppKitPlatformView__platform_view(
            controller: _controller!,
            hitTestBehavior: widget.hitTestBehavior,
            gestureRecognizers: widget.gestureRecognizers ?? _emptyRecognizersSet
        );
...
internal abstract class _DarwinPlatformView__platform_view<TController, TRender>
    ...
    where TRender : RenderDarwinPlatformView<TController>
{
    ...
    internal _DarwinPlatformView__platform_view(
...
internal class _UiKitPlatformView__platform_view
    : _DarwinPlatformView__platform_view<UiKitViewController, RenderUiKitView>
{
...
internal class _AppKitPlatformView__platform_view
    : _DarwinPlatformView__platform_view<AppKitViewController, RenderAppKitView>
{
    internal _AppKitPlatformView__platform_view(
...
public class PlatformViewCreationParams
{
    ...
    public PlatformViewCreationParams(
        long id,
        string viewType,
        Action<long> onPlatformViewCreated,
...
public delegate Widget PlatformViewSurfaceFactory(
    BuildContext context,
    PlatformViewController controller
);

public delegate PlatformViewController CreatePlatformViewCallback(
    PlatformViewCreationParams @params
);

public class PlatformViewLink : StatefulWidget
{
    internal virtual Func<BuildContext, PlatformViewController, Widget> _surfaceFactory
    {
        get;
        private set;
    } = default!;
    internal virtual Func<PlatformViewCreationParams, PlatformViewController> _onCreatePlatformView
    {
        get;
        private set;
    } = default!;
    ...
    public PlatformViewLink(
        Key? key = null,
        Func<BuildContext, PlatformViewController, Widget> surfaceFactory = default!,
        Func<PlatformViewCreationParams, PlatformViewController> onCreatePlatformView = default!,
        string viewType = default!
    )
        : base(key: key)
    {
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _PlatformViewLinkState__platform_view());
}
...
internal class _PlatformViewLinkState__platform_view : State<PlatformViewLink>
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        {
            return new _PlatformViewPlaceHolder__platform_view(
                    ...
                    (error, stack) =>
                    {
                        FlutterError.reportError(
                            new FlutterErrorDetails(
                                ...
                                context: new ErrorDescription(
                                    "while handling framework focus changed on platform view"
                                )
                            )
                        );
                    }
...
public class PlatformViewSurface : LeafRenderObjectWidget
{
    ...
    public PlatformViewSurface(
        Key? key = null,
        PlatformViewController controller = default!,
        PlatformViewHitTestBehavior hitTestBehavior = default!,
        HashSet<Factory<OneSequenceGestureRecognizer>> gestureRecognizers = default!
    )
        : base(key: key)
    {
        this.controller = controller;
...
public class AndroidViewSurface : StatefulWidget
{
    ...
    public AndroidViewSurface(
        Key? key = null,
        AndroidViewController controller = default!,
        PlatformViewHitTestBehavior hitTestBehavior = default!,
        HashSet<Factory<OneSequenceGestureRecognizer>> gestureRecognizers = default!
    )
        : base(key: key)
...
internal class _AndroidViewSurfaceState__platform_view : State<AndroidViewSurface>
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        {
            return new _PlatformLayerBasedAndroidViewSurface__platform_view(
        ...
        {
            return new _TextureBasedAndroidViewSurface__platform_view(
                controller: widget.controller,
                hitTestBehavior: widget.hitTestBehavior,
                gestureRecognizers: widget.gestureRecognizers
            );
...
internal class _TextureBasedAndroidViewSurface__platform_view : PlatformViewSurface
{
    ...
    public override RenderObject createRenderObject(BuildContext context)
    {
        ...
        var renderBox = new RenderAndroidView(
            viewController: viewControllerLocal,
            gestureRecognizers: gestureRecognizers,
            hitTestBehavior: hitTestBehavior
        );
...
public class _PlatformViewPlaceholderBox__platform_view : RenderConstrainedBox
{
    ...
    internal _PlatformViewPlaceholderBox__platform_view(Action<Size, Offset> onLayout)
        : base(
...
internal static class PlatformViewDisposal
{
    ...
    {
        Scheduler.SchedulerBinding.instance.addPostFrameCallback(
            _ => DartRuntimePrimitives.Ignore(controller.dispose()),
