...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    {
        global::Doroti.Ui.Size? oldSize__36788 = ((global::Doroti.Ui.Size?)(object?)(this.hasSize ? this.size : null));
        base.performResize();
    ...
    public override void showOnScreen(global::Doroti.Generated.Framework.Rendering.RenderObject? descendant = null, Rect? rect = null, Duration duration = default, global::Doroti.Generated.Framework.Animation.Curve curve = default!)
    {
        ...
        global::Doroti.Ui.Rect? newRect__41255 = ((global::Doroti.Ui.Rect?)(object?)RenderTwoDimensionalViewport.showInViewport(descendant: descendant, viewport: this, axisDirection: axisDirection__40577, rect: rect, duration: duration, curve: curve));
...
this._childManager._buildChild(vicinity);
    ...
    public virtual global::Doroti.Ui.Size computeChildPaintExtent(Offset layoutOffset, Size childSize)
    {
        ...
        return new global::Doroti.Ui.Size(width__56926, height__58052);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
