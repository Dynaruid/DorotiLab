...
internal static class WidgetStateMapping
{
    ...
    internal static T ResolveRequired<T>(WidgetStateMapper<T> mapper, HashSet<WidgetState> states) where T : class =>
        mapper.resolve(states) ?? throw new DartArgumentError(states, nameof(states), "No widget-state map key matched the current states. Add WidgetState.any.");
}

internal sealed class _WidgetStateColorMapper__widget_state : WidgetStateColor, IWidgetStateMapping<Color>
{
    private readonly WidgetStateMapper<Color> mapper;
    DartMap<WidgetStatesConstraint, Color> IWidgetStateMapping<Color>.Mapping => ((IWidgetStateMapping<Color>)mapper).Mapping;
    internal _WidgetStateColorMapper__widget_state(DartMap<WidgetStatesConstraint, Color> map) : base(0) => mapper = new(map);
    public override Color resolve(HashSet<WidgetState> states) => WidgetStateMapping.ResolveRequired(mapper, states);
    ...
    public override ColorSpace colorSpace => throw WidgetStateMapping.Unresolved(nameof(colorSpace));
    public override Color resolveFrom<TContext>(TContext context) => throw WidgetStateMapping.Unresolved(nameof(resolveFrom));
    public override Color withValues(double? alpha = null, double? red = null, double? green = null, double? blue = null, ColorSpace? colorSpace = null) => throw WidgetStateMapping.Unresolved(nameof(withValues));
...
internal sealed class _WidgetBorderSideMapper__widget_state : WidgetStateBorderSide, IWidgetStateMapping<BorderSide?>
{
    ...
    DartMap<WidgetStatesConstraint, BorderSide?> IWidgetStateMapping<BorderSide?>.Mapping => ((IWidgetStateMapping<BorderSide?>)mapper).Mapping;
    internal _WidgetBorderSideMapper__widget_state(DartMap<WidgetStatesConstraint, BorderSide?> map) => mapper = new(map);
...
internal sealed class _WidgetOutlinedBorderMapper__widget_state : WidgetStateOutlinedBorder, IWidgetStateMapping<OutlinedBorder?>
{
    private readonly WidgetStateMapper<OutlinedBorder?> mapper;
    DartMap<WidgetStatesConstraint, OutlinedBorder?> IWidgetStateMapping<OutlinedBorder?>.Mapping => ((IWidgetStateMapping<OutlinedBorder?>)mapper).Mapping;
    internal _WidgetOutlinedBorderMapper__widget_state(DartMap<WidgetStatesConstraint, OutlinedBorder?> map) => mapper = new(map);
    ...
    public override void paint(Canvas canvas, Rect rect, TextDirection? textDirection = null, BoxShape shape = BoxShape.rectangle, BorderRadius? borderRadius = null) => throw WidgetStateMapping.Unresolved(nameof(paint));
    public override BorderSide side => throw WidgetStateMapping.Unresolved(nameof(side));
    public override OutlinedBorder copyWith(BorderSide? side = null, BorderRadiusGeometry? borderRadius = null, double? eccentricity = null, LinearBorderEdge? start = null, LinearBorderEdge? end = null, LinearBorderEdge? top = null, LinearBorderEdge? bottom = null, double? circularity = null, double? rectilinearity = null, double? points = null, double? innerRadiusRatio = null, double? pointRounding = null, double? valleyRounding = null, double? rotation = null, double? squash = null) => throw WidgetStateMapping.Unresolved(nameof(copyWith));
}

internal sealed class _WidgetTextStyleMapper__widget_state : WidgetStateTextStyle, IWidgetStateMapping<TextStyle>
{
    private readonly WidgetStateMapper<TextStyle> mapper;
    DartMap<WidgetStatesConstraint, TextStyle> IWidgetStateMapping<TextStyle>.Mapping => ((IWidgetStateMapping<TextStyle>)mapper).Mapping;
    internal _WidgetTextStyleMapper__widget_state(DartMap<WidgetStatesConstraint, TextStyle> map) => mapper = new(map);
    public override TextStyle resolve(HashSet<WidgetState> states) => WidgetStateMapping.ResolveRequired(mapper, states);
    public override bool Equals(object? other) => mapper.Equals(other);
    public override int GetHashCode() => mapper.GetHashCode();
    public override string ToString() => mapper.ToString();
    ...
    public override FontWeight? fontWeight => throw WidgetStateMapping.Unresolved(nameof(fontWeight));
    public override FontStyle? fontStyle => throw WidgetStateMapping.Unresolved(nameof(fontStyle));
    public override double? letterSpacing => throw WidgetStateMapping.Unresolved(nameof(letterSpacing));
    public override double? wordSpacing => throw WidgetStateMapping.Unresolved(nameof(wordSpacing));
    public override TextBaseline? textBaseline => throw WidgetStateMapping.Unresolved(nameof(textBaseline));
    public override double? height => throw WidgetStateMapping.Unresolved(nameof(height));
    public override TextLeadingDistribution? leadingDistribution => throw WidgetStateMapping.Unresolved(nameof(leadingDistribution));
    ...
    public override TextDecoration? decoration => throw WidgetStateMapping.Unresolved(nameof(decoration));
    public override Color? decorationColor => throw WidgetStateMapping.Unresolved(nameof(decorationColor));
    public override TextDecorationStyle? decorationStyle => throw WidgetStateMapping.Unresolved(nameof(decorationStyle));
    public override double? decorationThickness => throw WidgetStateMapping.Unresolved(nameof(decorationThickness));
    ...
    public override List<FontFeature>? fontFeatures => throw WidgetStateMapping.Unresolved(nameof(fontFeatures));
    public override List<FontVariation>? fontVariations => throw WidgetStateMapping.Unresolved(nameof(fontVariations));
    public override TextOverflow? overflow => throw WidgetStateMapping.Unresolved(nameof(overflow));
    public override List<string>? fontFamilyFallback => throw WidgetStateMapping.Unresolved(nameof(fontFamilyFallback));
...
internal sealed class _WidgetStateOutlinedBorder__widget_state : WidgetStateOutlinedBorder
{
    ...
    public override OutlinedBorder copyWith(BorderSide? side = null, BorderRadiusGeometry? borderRadius = null, double? eccentricity = null, LinearBorderEdge? start = null, LinearBorderEdge? end = null, LinearBorderEdge? top = null, LinearBorderEdge? bottom = null, double? circularity = null, double? rectilinearity = null, double? points = null, double? innerRadiusRatio = null, double? pointRounding = null, double? valleyRounding = null, double? rotation = null, double? squash = null) => shape.copyWith(side, borderRadius, eccentricity, start, end, top, bottom, circularity, rectilinearity, points, innerRadiusRatio, pointRounding, valleyRounding, rotation, squash);
}
