...
public class TextSelectionToolbarAnchors
{
    ...
    {
        global::Doroti.Ui.Rect selectionRect = ((global::Doroti.Ui.Rect)getSelectionRect(renderBox, startGlyphHeight, endGlyphHeight, selectionEndpoints));
        if ((Equals(selectionRect, Rect.zero)))
        {
            return new TextSelectionToolbarAnchors(primaryAnchor: Offset.zero);
        }
        global::Doroti.Ui.Rect editingRegion = ((global::Doroti.Ui.Rect)_getEditingRegion(renderBox));
    ...
    {
        return Rect.fromPoints(((Offset)(renderBox).localToGlobal(Offset.zero)), ((Offset)(renderBox).localToGlobal(((global::Doroti.Framework.Rendering.RenderBox)renderBox).size.bottomRight(Offset.zero))));
