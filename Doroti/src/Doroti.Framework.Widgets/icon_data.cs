...
public class IconData
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is IconData) && (__other.codePoint == codePoint) && (__other.fontFamily == fontFamily) && (__other.fontPackage == fontPackage) && (__other.matchTextDirection == matchTextDirection) && CollectionsLibrary.listEquals(__other.fontFamilyFallback, fontFamilyFallback);
    }

    public override int GetHashCode()
    {
        return FoundationRuntimePorts.ObjectHash(codePoint, fontFamily, fontPackage, matchTextDirection, FoundationRuntimePorts.ObjectHashAll(fontFamilyFallback ?? new List<string>()));
    }
...
public class IconDataProperty : global::Doroti.Framework.Foundation.DiagnosticsProperty<IconData>
{
    ...
    public override DartMap<string, object?> toJsonMap(global::Doroti.Framework.Foundation.DiagnosticsSerializationDelegate? @delegate = null)
    {
        ...
        {
            json["valueProperties"] = new DartMap<string, object?> { ["codePoint"] = value!.codePoint };
        }
        return json;
