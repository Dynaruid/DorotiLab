...
internal class _NullWidget__default_selection_style : StatelessWidget
{
    ...
    {
        throw DartRuntimePrimitives.AsException(FlutterError.Create("A DefaultSelectionStyle constructed with DefaultSelectionStyle.fallback cannot be incorporated into the widget tree, " + "it is meant only to provide a fallback value returned by DefaultSelectionStyle.of() " + "when no enclosing default selection style is present in a BuildContext."));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
