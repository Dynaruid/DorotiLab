...
{
    internal _UbiquitousInheritedElement__basic(InheritedWidget widget)
        : base(widget) { }
...
{
    internal _UbiquitousInheritedWidget__basic(Key? key = null, Widget child = default!)
        : base(key: key, child: child) { }

    public override InheritedElement createElement() =>
        DartRuntimePrimitives.ConvertValue<InheritedElement>(
            new _UbiquitousInheritedElement__basic(this)
        );
}
...
public class Directionality : _UbiquitousInheritedWidget__basic
{
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(
            !Equals(textDirection, ((Directionality)oldWidget).textDirection)
        );
...
public class BackdropGroup : InheritedWidget
{
    ...
    public BackdropGroup(Key? key = null, Widget child = default!, BackdropKey? backdropKey = null)
        : base(key: key, child: child)
    {
...
public class BackdropFilter : SingleChildRenderObjectWidget
{
    ...
    public static BackdropFilter CreateGrouped(
        Key? key = null,
        ImageFilter? filter = null,
        ImageFilterConfig? filterConfig = null,
        Widget? child = null,
    ...
    {
        var __instance = new BackdropFilter(
            key,
            filter,
            filterConfig,
            child,
    ...
    {
        get { return filterConfig ?? ImageFilterConfig.Create(filter!); }
    }
...
public class CustomPaint : SingleChildRenderObjectWidget
{
        ...
        : base(key: key, child: child)
    {
        ...
        System.Diagnostics.Debug.Assert(
            (painter is not null) || (foregroundPainter is not null) || (!isComplex && !willChange)
        );
    }

    public CustomPaint(Size size, ToggleablePainter painter)
        : this(size: size, painter: new ToggleableCustomPainterAdapter(painter)) { }
...
public class ClipRect : SingleChildRenderObjectWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(
            new DiagnosticsProperty<CustomClipper<Rect>>("clipper", clipper, defaultValue: null)
        );
    }
}
...
public class ClipRRect : SingleChildRenderObjectWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DiagnosticsProperty<CustomClipper<RRect>>("clipper", clipper, defaultValue: null)
        );
    }
}
...
public class ClipRSuperellipse : SingleChildRenderObjectWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DiagnosticsProperty<CustomClipper<RSuperellipse>>(
                "clipper",
                clipper,
                defaultValue: null
            )
...
public class ClipPath : SingleChildRenderObjectWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(
            new DiagnosticsProperty<CustomClipper<Path>>("clipper", clipper, defaultValue: null)
        );
    }
}
...
public class Transform : SingleChildRenderObjectWidget
{
    ...
    public static Transform CreateRotate(
        Key? key = null,
    ...
    public static Transform CreateTranslate(
        Key? key = null,
    ...
    public static Transform CreateScale(
        Key? key = null,
        double? scale = null,
        double? scaleX = null,
        double? scaleY = null,
    ...
    )
    {
        ...
        __instance.transformHitTests = transformHitTests;
        __instance.filterQuality = filterQuality;
        __instance.transform = Matrix4.diagonal3Values(
            (scale ?? scaleX) ?? 1.0,
            (scale ?? scaleY) ?? 1.0,
            1.0
        );
    ...
    public static Transform CreateFlip(
        Key? key = null,
        bool flipX = false,
        bool flipY = false,
        Offset? origin = null,
    ...
    internal static Matrix4 _computeRotation(double radians)
    {
        DartRuntimePrimitives.Assert(
            ...
            () => (object?)$"Cannot compute the rotation matrix for a non-finite angle: {radians}"
        );
        if (radians == 0.0)
        {
...
public class CompositedTransformFollower : SingleChildRenderObjectWidget
{
    ...
    public CompositedTransformFollower(
        ...
        Offset offset = default,
        Alignment targetAnchor = default!,
...
public class FractionalTranslation : SingleChildRenderObjectWidget
{
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<RenderFractionalTranslation>)(
                    () =>
                    {
                        var __cascade = __renderObject;
...
public class RotatedBox : SingleChildRenderObjectWidget
{
    ...
    public RotatedBox(Key? key = null, long quarterTurns = default!, Widget? child = null)
        : base(key: key, child: child)
    {
...
public class Padding : SingleChildRenderObjectWidget
{
    ...
    public Padding(Key? key = null, EdgeInsetsGeometry padding = default!, Widget? child = null)
        : base(key: key, child: child)
    {
...
public class LayoutId : ParentDataWidget<MultiChildLayoutParentData>
{
    ...
    public LayoutId(Key? key = null, object id = default!, Widget child = default!)
        : base(child: child, key: key ?? new ValueKey<object>(id))
    {
        this.id = id;
    }
...
public class CustomMultiChildLayout : MultiChildRenderObjectWidget
{
    ...
    public CustomMultiChildLayout(
        Key? key = null,
        MultiChildLayoutDelegate @delegate = default!,
...
public class SizedBox : SingleChildRenderObjectWidget
{
    ...
    public static SizedBox CreateSquare(
        Key? key = null,
        Widget? child = null,
    ...
    {
        get { return BoxConstraints.CreateTightFor(width: width, height: height); }
    }
    ...
    public override string toStringShort()
    {
        ...
        {
            (var __constant100107, var __constant100124)
                when Equals(__constant100107, double.PositiveInfinity)
                    && Equals(__constant100124, double.PositiveInfinity) =>
                $"{objectRuntimeTypeFunctions.objectRuntimeType(this, "SizedBox")}.expand",
            (0.0, 0.0) =>
                $"{objectRuntimeTypeFunctions.objectRuntimeType(this, "SizedBox")}.shrink",
...
public class ConstrainedBox : SingleChildRenderObjectWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(
            new DiagnosticsProperty<BoxConstraints>("constraints", constraints, showName: false)
        );
    }
}
...
public class ConstraintsTransformBox : SingleChildRenderObjectWidget
{
    internal static DartMap<Func<BoxConstraints, BoxConstraints>, string> _debugKnownTransforms =
        new DartMap<Func<BoxConstraints, BoxConstraints>, string>
        {
    ...
    public virtual AlignmentGeometry alignment { get; private set; } = default!;
    public virtual Func<BoxConstraints, BoxConstraints> constraintsTransform { get; private set; } =
        default!;
    public virtual Clip clipBehavior { get; private set; } = default!;
    ...
    public ConstraintsTransformBox(
        ...
        AlignmentGeometry alignment = default!,
        Func<BoxConstraints, BoxConstraints> constraintsTransform = default!,
        Clip clipBehavior = Clip.none,
    ...
    public static BoxConstraints maxHeightUnconstrained(BoxConstraints constraints) =>
        constraints.copyWith(maxHeight: double.PositiveInfinity);

    public static BoxConstraints maxWidthUnconstrained(BoxConstraints constraints) =>
        constraints.copyWith(maxWidth: double.PositiveInfinity);

    public static BoxConstraints maxUnconstrained(BoxConstraints constraints) =>
        constraints.copyWith(maxWidth: double.PositiveInfinity, maxHeight: double.PositiveInfinity);
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<RenderConstraintsTransformBox>)(
                    () =>
                    {
                        var __cascade = __renderObject;
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        string? debugTransformLabel =
            (_debugTransformLabel.Length != 0)
                ? _debugTransformLabel
                : _debugKnownTransforms.GetValueOrDefault(constraintsTransform);
        if (debugTransformLabel is not null)
        {
            properties.add(
                new DiagnosticsProperty<string>("constraints transform", debugTransformLabel)
            );
        }
    }
}
...
public class UnconstrainedBox : StatelessWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<AlignmentGeometry>("alignment", alignment));
        properties.add(
            new EnumProperty<Axis>("constrainedAxis", constrainedAxis, defaultValue: null)
        );
        properties.add(
            new EnumProperty<TextDirection>("textDirection", textDirection, defaultValue: null)
        );
...
public class FractionallySizedBox : SingleChildRenderObjectWidget
{
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<RenderFractionallySizedOverflowBox>)(
                    () =>
                    {
                        var __cascade = __renderObject;
                        __cascade.alignment = alignment;
...
public class OverflowBox : SingleChildRenderObjectWidget
{
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<RenderConstrainedOverflowBox>)(
                    () =>
                    {
                        var __cascade = __renderObject;
                        __cascade.alignment = alignment;
...
public class Offstage : SingleChildRenderObjectWidget
{
    ...
    public Offstage(Key? key = null, bool offstage = true, Widget? child = null)
        : base(key: key, child: child)
    {
    ...
    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(new RenderOffstage(offstage: offstage));
    ...
    public override SingleChildRenderObjectElement createElement() =>
        DartRuntimePrimitives.ConvertValue<SingleChildRenderObjectElement>(
            new _OffstageElement__basic(this)
        );
}

internal class _OffstageElement__basic : SingleChildRenderObjectElement
{
    internal _OffstageElement__basic(Offstage widget)
        : base(widget) { }
...
public class AspectRatio : SingleChildRenderObjectWidget
{
    ...
    public AspectRatio(Key? key = null, double aspectRatio = default!, Widget? child = null)
        : base(key: key, child: child)
    {
...
public class IntrinsicHeight : SingleChildRenderObjectWidget
{
    ...
    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(new RenderIntrinsicHeight());
}
...
{
    public IgnoreBaseline(Key? key = null, Widget? child = null)
        : base(key: key, child: child) { }
...
{
    public SliverToBoxAdapter(Key? key = null, Widget? child = null)
        : base(key: key, child: child) { }

    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(new RenderSliverToBoxAdapter());
}
...
public abstract class _SemanticsBase__basic : SingleChildRenderObjectWidget
{
    ...
    internal _SemanticsBase__basic(
        Key? key = null,
        Widget? child = null,
        bool container = default!,
        bool explicitChildNodes = default!,
        bool excludeSemantics = default!,
        bool blockUserActions = default!,
        bool? enabled = default!,
        bool? @checked = default!,
        bool? mixed = default!,
        bool? selected = default!,
        bool? toggled = default!,
        bool? button = default!,
        bool? slider = default!,
        bool? keyboardKey = default!,
        bool? link = default!,
        DartUri? linkUrl = default!,
        bool? header = default!,
        long? headingLevel = default!,
        bool? textField = default!,
        bool? readOnly = default!,
        bool? focusable = default!,
        bool? focused = default!,
        AccessibilityFocusBlockType? accessibilityFocusBlockType = default!,
        bool? inMutuallyExclusiveGroup = default!,
        bool? obscured = default!,
        bool? multiline = default!,
        bool? scopesRoute = default!,
        bool? namesRoute = default!,
        bool? hidden = default!,
        bool? image = default!,
        bool? liveRegion = default!,
        bool? expanded = default!,
        bool? isRequired = default!,
        long? maxValueLength = default!,
        long? currentValueLength = default!,
        string? identifier = default!,
        object? traversalParentIdentifier = default!,
        object? traversalChildIdentifier = default!,
        string? label = default!,
        AttributedString? attributedLabel = default!,
        string? value = default!,
        AttributedString? attributedValue = default!,
        string? increasedValue = default!,
        AttributedString? attributedIncreasedValue = default!,
        string? decreasedValue = default!,
        AttributedString? attributedDecreasedValue = default!,
        string? hint = default!,
        AttributedString? attributedHint = default!,
        string? tooltip = default!,
        string? onTapHint = default!,
        string? onLongPressHint = default!,
        TextDirection? textDirection = default!,
        SemanticsSortKey? sortKey = default!,
        SemanticsTag? tagForChildren = default!,
        Action? onTap = default!,
        Action? onLongPress = default!,
        Action? onScrollLeft = default!,
        Action? onScrollRight = default!,
        Action? onScrollUp = default!,
        Action? onScrollDown = default!,
        Action? onIncrease = default!,
        Action? onDecrease = default!,
        Action? onCopy = default!,
        Action? onCut = default!,
        Action? onPaste = default!,
        Action? onDismiss = default!,
        Action<bool>? onMoveCursorForwardByCharacter = default!,
        Action<bool>? onMoveCursorBackwardByCharacter = default!,
        Action<TextSelection>? onSetSelection = default!,
        Action<string>? onSetText = default!,
        Action? onDidGainAccessibilityFocus = default!,
        Action? onDidLoseAccessibilityFocus = default!,
        Action? onFocus = default!,
        Action? onExpand = default!,
        Action? onCollapse = default!,
        DartMap<CustomSemanticsAction, Action>? customSemanticsActions = default!,
        SemanticsRole? role = default!,
        HashSet<string>? controlsNodes = default!,
        SemanticsValidationResult validationResult = default!,
        SemanticsHitTestBehavior? hitTestBehavior = default!,
        SemanticsInputType? inputType = default!,
...
public class SliverSemantics : _SemanticsBase__basic
{
    ...
    public static SliverSemantics CreateFromProperties(
        Key? key = null,
        Widget? child = null,
        bool container = false,
        bool explicitChildNodes = false,
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<RenderSliverSemanticsAnnotations>)(
                    () =>
                    {
                        var __cascade = __renderObject;
    ...
    )
    {
        switch (axis)
        {
            case Axis.horizontal:
            {
                ...
                AxisDirection axisDirection = Basic_typesLibrary.textDirectionToAxisDirection(
                    textDirection
                );
                return reverse
                    ? Basic_typesLibrary.flipAxisDirection(axisDirection)
                    : axisDirection;
            }
            case Axis.vertical:
            {
...
public class Stack : MultiChildRenderObjectWidget
{
            ...
            DartRuntimePrimitives.Assert(() =>
                DebugLibrary.debugCheckHasDirectionality(
                    ...
                    hint: Equals(alignment, AlignmentDirectional.topStart)
                        ...
                        : null,
                    alternative: $"Instead of providing a Directionality widget, another solution would be passing a non-directional 'alignment__as178201', or an explicit 'textDirection', to the {GetType()}."
                )
            );
        }
        return true;
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new EnumProperty<Clip>("clipBehavior", clipBehavior, defaultValue: Clip.hardEdge)
        );
    }
}
...
public class Positioned : ParentDataWidget<StackParentData>
{
    ...
    public static Positioned CreateFromRect(
        Key? key = null,
        Rect rect = default!,
        Widget child = default!
    )
    {
        var __instance = new Positioned(
            key,
            default!,
            default!,
            default!,
    ...
    public static Positioned CreateFromRelativeRect(
        Key? key = null,
        RelativeRect rect = default!,
        Widget child = default!
    )
    {
        var __instance = new Positioned(
    ...
    public static Positioned CreateFill(
        Key? key = null,
        double? left = 0.0,
        double? top = 0.0,
        double? right = 0.0,
    ...
    public static Positioned CreateDirectional(
        Key? key = null,
        TextDirection textDirection = default!,
        double? start = null,
        double? top = null,
    ...
    {
        var (leftLocal, rightLocal) = textDirection switch
        {
...
public class Flex : MultiChildRenderObjectWidget
{
        ...
        : base(key: key, children: children ?? new List<Widget>())
    {
        ...
        System.Diagnostics.Debug.Assert(
            !DartRuntimePrimitives.Identical(crossAxisAlignment, CrossAxisAlignment.baseline)
    ...
    internal virtual bool _needTextDirection
    {
        get
        {
            switch (direction)
            {
                ...
                case Axis.vertical:
                {
                    return Equals(crossAxisAlignment, CrossAxisAlignment.start)
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new EnumProperty<CrossAxisAlignment>("crossAxisAlignment", crossAxisAlignment)
        );
        properties.add(
            new EnumProperty<TextDirection>("textDirection", textDirection, defaultValue: null)
        );
        ...
        properties.add(
            new EnumProperty<TextBaseline>("textBaseline", textBaseline, defaultValue: null)
        );
        properties.add(
...
{
    public Expanded(Key? key = null, long flex = 1, Widget child = default!)
        : base(key: key, flex: flex, child: child, fit: FlexFit.tight) { }
}
...
public class Wrap : MultiChildRenderObjectWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new EnumProperty<WrapCrossAlignment>("crossAxisAlignment", crossAxisAlignment)
        );
        properties.add(
            new EnumProperty<TextDirection>("textDirection", textDirection, defaultValue: null)
        );
...
public class Flow : MultiChildRenderObjectWidget
{
    ...
    public static Flow CreateUnwrapped(
        Key? key = null,
        FlowDelegate @delegate = default!,
        List<Widget> children = default!,
        Clip clipBehavior = Clip.hardEdge
    ...
    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(
            new RenderFlow(@delegate: @delegate, clipBehavior: clipBehavior)
        );
...
public class RichText : MultiChildRenderObjectWidget
{
    ...
    public RichText(
        ...
        SelectionRegistrar? selectionRegistrar = null,
    ...
    internal static TextScaler _effectiveTextScalerFrom(
    ...
    )
    {
        ...
        {
            (TextScaler scaler, 1.0) => scaler,
            (var __constant252140, double textScaleFactorLocal)
                when Equals(__constant252140, TextScaler.noScaling) => TextScaler.CreateLinear(
    ...
    internal virtual double _getDevicePixelRatio(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<double>(
            (MediaQuery.maybeDevicePixelRatioOf(context) ?? View.maybeOf(context)?.devicePixelRatio)
                ?? 1.0
        );
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new EnumProperty<TextOverflow>("overflow", overflow, defaultValue: TextOverflow.clip)
        );
        properties.add(
        ...
        properties.add(
            new DiagnosticsProperty<Painting.StrutStyle>(
                "strutStyle",
                strutStyle,
                defaultValue: null
            )
...
public class RawImage : LeafRenderObjectWidget
{
    ...
    public override RenderObject createRenderObject(BuildContext context)
    {
        ...
        DartRuntimePrimitives.Assert(
            () => image?.debugDisposed != true,
            () =>
                (object?)"Creator of a RawImage disposed of the image when the RawImage still "
                + "needed it."
        );
        return new RenderImage(
            ...
            textDirection: (matchTextDirection || (alignment is not Alignment))
            ...
            (
                (Func<RenderImage>)(
                    () =>
                    {
                        ...
                        __cascade.textDirection =
                            (matchTextDirection || (alignment is not Alignment))
                                ? Directionality.of(context)
                                : null;
...
public class DefaultAssetBundle : InheritedWidget
{
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(
            !Equals(bundle, ((DefaultAssetBundle)oldWidget).bundle)
        );
}
...
public class WidgetToRenderBoxAdapter : LeafRenderObjectWidget
{
    ...
    public WidgetToRenderBoxAdapter(
        ...
        : base(key: new GlobalObjectKey<IState>(renderBox))
    {
    ...
    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(renderBox);
...
public class Listener : SingleChildRenderObjectWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new IterableProperty<string>("listeners", listeners.Cast<string>(), ifEmpty: "<none>")
        );
...
{
    public RepaintBoundary(Key? key = null, Widget? child = null)
        : base(key: key, child: child) { }

    public static RepaintBoundary CreateWrap(Widget child, long childIndex)
    {
        return new RepaintBoundary(new ValueKey<object>(child.key ?? (object)childIndex), child);
    }

    public static List<RepaintBoundary> wrapAll(List<Widget> widgets) =>
        new List<RepaintBoundary>();

    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(new RenderRepaintBoundary());
}
...
public class Semantics : _SemanticsBase__basic
{
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<RenderSemanticsAnnotations>)(
                    () =>
                    {
                        var __cascade = __renderObject;
                        __cascade.container = container;
...
{
    public MergeSemantics(Key? key = null, Widget? child = null)
        : base(key: key, child: child) { }

    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(new RenderMergeSemantics());
}
...
public class BlockSemantics : SingleChildRenderObjectWidget
{
    ...
    public BlockSemantics(Key? key = null, bool blocking = true, Widget? child = null)
        : base(key: key, child: child)
    {
...
public class ExcludeSemantics : SingleChildRenderObjectWidget
{
    ...
    public ExcludeSemantics(Key? key = null, bool excluding = true, Widget? child = null)
        : base(key: key, child: child)
    {
...
public class IndexedSemantics : SingleChildRenderObjectWidget
{
    ...
    public IndexedSemantics(Key? key = null, long index = default!, Widget? child = null)
        : base(key: key, child: child)
    {
        this.index = index;
    }
    ...
    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(new RenderIndexedSemantics(index: index));
...
public class KeyedSubtree : StatelessWidget
{
    ...
    public KeyedSubtree(Key? key = null, Widget child = default!)
        : base(key: key)
    {
        this.child = child;
    }
...
public class Builder : StatelessWidget
{
    ...
    public Builder(Key? key = null, Func<BuildContext, Widget> builder = default!)
        : base(key: key)
    {
...
{
    public virtual Func<BuildContext, Action<Action>, Widget> builder { get; private set; } =
        default!;

    public StatefulBuilder(
        Key? key = null,
        Func<BuildContext, Action<Action>, Widget> builder = default!
    )
        : base(key: key)
    {
        this.builder = builder;
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _StatefulBuilderState__basic());
}
...
public class ColoredBox : SingleChildRenderObjectWidget
{
    ...
    public ColoredBox(Color color, bool isAntiAlias = true, Widget? child = null, Key? key = null)
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DiagnosticsProperty<bool>("isAntiAlias", isAntiAlias, defaultValue: true)
        );
    }
}
...
internal class _RenderColoredBox__basic : RenderProxyBoxWithHitTestBehavior
{
    ...
    internal _RenderColoredBox__basic(Color color, bool isAntiAlias)
