...
internal class _FadeUpwardsPageTransition__page_transitions_builder : StatelessWidget
{
    ...
    internal static global::Doroti.Framework.Animation.Animatable<double> _fastOutSlowInTween = new global::Doroti.Framework.Animation.CurveTween(curve: Curves.fastOutSlowIn);
...
public class _OpenUpwardsPageTransition__page_transitions_builder : StatefulWidget
{
    ...
    internal static global::Doroti.Framework.Animation.Curve _transitionCurve = new global::Doroti.Framework.Animation.Cubic(0.2, 0.0, 0.0, 1.0);
...
internal class _OpenUpwardsPageTransitionState__page_transitions_builder : State<_OpenUpwardsPageTransition__page_transitions_builder>
{
    ...
    {
        _primaryAnimation = new global::Doroti.Framework.Animation.CurvedAnimation(parent: widget.animation, curve: _OpenUpwardsPageTransition__page_transitions_builder._transitionCurve, reverseCurve: _OpenUpwardsPageTransition__page_transitions_builder._transitionCurve.flipped);
        _secondaryTranslationCurvedAnimation = new global::Doroti.Framework.Animation.CurvedAnimation(parent: widget.secondaryAnimation, curve: _OpenUpwardsPageTransition__page_transitions_builder._transitionCurve, reverseCurve: _OpenUpwardsPageTransition__page_transitions_builder._transitionCurve.flipped);
    }
    ...
    public override Widget build(BuildContext context)
    {
        ...
        {
            global::Doroti.Ui.Size size = constraints.biggest;
            global::Doroti.Framework.Animation.Animation<double> clipAnimation = new global::Doroti.Framework.Animation.Tween<double>(begin: 0.0, end: size.height).animate(_primaryAnimation);
            global::Doroti.Framework.Animation.Animation<double> opacityAnimation = _OpenUpwardsPageTransition__page_transitions_builder._scrimOpacityTween.animate(_primaryAnimation);
            global::Doroti.Framework.Animation.Animation<global::Doroti.Ui.Offset> primaryTranslationAnimation = _OpenUpwardsPageTransition__page_transitions_builder._primaryTranslationTween.animate(_primaryAnimation);
            global::Doroti.Framework.Animation.Animation<global::Doroti.Ui.Offset> secondaryTranslationAnimation = _OpenUpwardsPageTransition__page_transitions_builder._secondaryTranslationTween.animate(_secondaryTranslationCurvedAnimation);
            return new AnimatedBuilder(animation: Listenable.CreateMerge(new List<global::Doroti.Framework.Foundation.Listenable> { widget.animation, widget.secondaryAnimation }.Cast<global::Doroti.Framework.Foundation.Listenable?>()), builder: (context, child) =>
            {
