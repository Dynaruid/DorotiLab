...
internal class _FadeUpwardsPageTransition__page_transitions_builder : StatelessWidget
{
    ...
    internal static global::Doroti.Framework.Animation.Animatable<double> _fastOutSlowInTween = ((global::Doroti.Framework.Animation.Animatable<double>)new global::Doroti.Framework.Animation.CurveTween(curve: Curves.fastOutSlowIn));
    ...
    {
        return ((Widget)new SlideTransition(position: this._positionAnimation, child: new FadeTransition(opacity: this._opacityAnimation, child: this.child)));
...
public class FadeUpwardsPageTransitionsBuilder : PageTransitionsBuilder
{
    ...
    {
        return ((Widget)new _FadeUpwardsPageTransition__page_transitions_builder(routeAnimation: animation, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class _OpenUpwardsPageTransition__page_transitions_builder : StatefulWidget
{
    ...
    internal static global::Doroti.Framework.Animation.Curve _transitionCurve = ((global::Doroti.Framework.Animation.Curve)new global::Doroti.Framework.Animation.Cubic(0.2, 0.0, 0.0, 1.0));
...
internal class _OpenUpwardsPageTransitionState__page_transitions_builder : State<_OpenUpwardsPageTransition__page_transitions_builder>
{
    ...
    public override void didUpdateWidget(_OpenUpwardsPageTransition__page_transitions_builder oldWidget)
    {
        ...
        if (((!Equals(((_OpenUpwardsPageTransition__page_transitions_builder)oldWidget).animation, ((_OpenUpwardsPageTransition__page_transitions_builder)this.widget).animation)) || (!Equals(((_OpenUpwardsPageTransition__page_transitions_builder)oldWidget).secondaryAnimation, ((_OpenUpwardsPageTransition__page_transitions_builder)this.widget).secondaryAnimation))))
        {
            _disposeAnimations();
            _setAnimations();
        }
    ...
    public override Widget build(BuildContext context)
    {
        return ((Widget)new LayoutBuilder(builder: ((global::System.Func<BuildContext, global::Doroti.Framework.Rendering.BoxConstraints, Widget>)((context, constraints) =>
        {
            global::Doroti.Ui.Size size = ((global::Doroti.Ui.Size)((global::Doroti.Framework.Rendering.BoxConstraints)constraints).biggest);
            global::Doroti.Framework.Animation.Animation<double> clipAnimation = ((global::Doroti.Framework.Animation.Animation<double>)new global::Doroti.Framework.Animation.Tween<double>(begin: 0.0, end: size.height).animate(this._primaryAnimation));
            global::Doroti.Framework.Animation.Animation<double> opacityAnimation = ((global::Doroti.Framework.Animation.Animation<double>)_OpenUpwardsPageTransition__page_transitions_builder._scrimOpacityTween.animate(this._primaryAnimation));
            global::Doroti.Framework.Animation.Animation<global::Doroti.Ui.Offset> primaryTranslationAnimation = ((global::Doroti.Framework.Animation.Animation<global::Doroti.Ui.Offset>)_OpenUpwardsPageTransition__page_transitions_builder._primaryTranslationTween.animate(this._primaryAnimation));
            global::Doroti.Framework.Animation.Animation<global::Doroti.Ui.Offset> secondaryTranslationAnimation = ((global::Doroti.Framework.Animation.Animation<global::Doroti.Ui.Offset>)_OpenUpwardsPageTransition__page_transitions_builder._secondaryTranslationTween.animate(this._secondaryTranslationCurvedAnimation));
            return ((Widget)new AnimatedBuilder(animation: Listenable.CreateMerge(new List<global::Doroti.Framework.Foundation.Listenable> { ((_OpenUpwardsPageTransition__page_transitions_builder)this.widget).animation, ((_OpenUpwardsPageTransition__page_transitions_builder)this.widget).secondaryAnimation }.Cast<global::Doroti.Framework.Foundation.Listenable?>()), builder: ((global::System.Func<BuildContext, Widget?, Widget>)((context, child) =>
            {
                return ((Widget)new ColoredBox(color: _OpenUpwardsPageTransition__page_transitions_builder._scrimColor.withOpacity(((global::Doroti.Framework.Animation.Animation<double>)opacityAnimation).value), child: new Align(alignment: Alignment.bottomLeft, child: new ClipRect(child: new SizedBox(height: ((global::Doroti.Framework.Animation.Animation<double>)clipAnimation).value, child: new OverflowBox(alignment: Alignment.bottomLeft, maxHeight: size.height, child: new FractionalTranslation(translation: ((global::Doroti.Framework.Animation.Animation<Offset>)secondaryTranslationAnimation).value, child: new FractionalTranslation(translation: ((global::Doroti.Framework.Animation.Animation<Offset>)primaryTranslationAnimation).value, child: ((_OpenUpwardsPageTransition__page_transitions_builder)this.widget).child))))))));
...
public class OpenUpwardsPageTransitionsBuilder : PageTransitionsBuilder
{
    ...
    public override Widget buildTransitions<T>(PageRoute<T> route, BuildContext context, global::Doroti.Framework.Animation.Animation<double> animation, global::Doroti.Framework.Animation.Animation<double> secondaryAnimation, Widget child)
    {
        return ((Widget)new _OpenUpwardsPageTransition__page_transitions_builder(animation: animation, secondaryAnimation: secondaryAnimation, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
