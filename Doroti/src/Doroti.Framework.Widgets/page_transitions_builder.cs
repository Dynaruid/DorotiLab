...
public abstract class PageTransitionsBuilder
{
    ...
    public abstract Widget buildTransitions<T>(
        PageRoute<T> route,
...
{
    internal static Tween<Offset> _bottomUpTween = new Tween<Offset>(
        begin: new Offset(0.0, 0.25),
        end: Offset.zero
    );
    internal static Animatable<double> _fastOutSlowInTween = new CurveTween(
    ...
    internal _FadeUpwardsPageTransition__page_transitions_builder(
...
public class FadeUpwardsPageTransitionsBuilder : PageTransitionsBuilder
{
    ...
    {
        return new _FadeUpwardsPageTransition__page_transitions_builder(
...
{
    internal static Tween<Offset> _primaryTranslationTween = new Tween<Offset>(
        begin: new Offset(0.0, 0.05),
        end: Offset.zero
    );
    internal static Tween<Offset> _secondaryTranslationTween = new Tween<Offset>(
        begin: Offset.zero,
        end: new Offset(0.0, -0.025)
    );
    ...
    internal _OpenUpwardsPageTransition__page_transitions_builder(
        Animation<double> animation,
        Animation<double> secondaryAnimation,
        Widget child
    )
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _OpenUpwardsPageTransitionState__page_transitions_builder()
        );
}

internal class _OpenUpwardsPageTransitionState__page_transitions_builder
    : State<_OpenUpwardsPageTransition__page_transitions_builder>
{
    ...
    public override void didUpdateWidget(
        _OpenUpwardsPageTransition__page_transitions_builder oldWidget
    )
    {
        base.didUpdateWidget(oldWidget);
        if (
            (!Equals(oldWidget.animation, widget.animation))
            || (!Equals(oldWidget.secondaryAnimation, widget.secondaryAnimation))
        )
        {
            _disposeAnimations();
            _setAnimations();
    ...
    {
        _primaryAnimation = new CurvedAnimation(
            parent: widget.animation,
            curve: _OpenUpwardsPageTransition__page_transitions_builder._transitionCurve,
            reverseCurve: _OpenUpwardsPageTransition__page_transitions_builder
                ._transitionCurve
                .flipped
        );
        _secondaryTranslationCurvedAnimation = new CurvedAnimation(
    ...
    public override Widget build(BuildContext context)
    {
        return new LayoutBuilder(
            builder: (context, constraints) =>
            {
                ...
                Animation<double> clipAnimation = new Tween<double>(
                    begin: 0.0,
                    end: size.height
                ).animate(_primaryAnimation);
                Animation<double> opacityAnimation =
                    _OpenUpwardsPageTransition__page_transitions_builder._scrimOpacityTween.animate(
                        _primaryAnimation
                    );
                Animation<Offset> primaryTranslationAnimation =
                    _OpenUpwardsPageTransition__page_transitions_builder._primaryTranslationTween.animate(
                        _primaryAnimation
                    );
                Animation<Offset> secondaryTranslationAnimation =
                    _OpenUpwardsPageTransition__page_transitions_builder._secondaryTranslationTween.animate(
                ...
                return new AnimatedBuilder(
                    ...
                    builder: (context, child) =>
                    {
                        return new ColoredBox(
                            color: _OpenUpwardsPageTransition__page_transitions_builder._scrimColor.withOpacity(
...
public class OpenUpwardsPageTransitionsBuilder : PageTransitionsBuilder
{
    ...
    {
        return new _OpenUpwardsPageTransition__page_transitions_builder(
            animation: animation,
