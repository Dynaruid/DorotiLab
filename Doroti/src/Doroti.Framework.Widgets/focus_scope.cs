...
public class Focus : StatefulWidget
{
    ...
    public static Focus CreateWithExternalFocusNode(
        Key? key = null,
        Widget child = default!,
        ...
        Action<bool>? onFocusChange = null,
        bool includeSemantics = default!
    ) =>
        new _FocusWithExternalFocusNode__focus_scope(
            key,
            child,
            focusNode,
            parentNode,
    ...
    public virtual Func<FocusNode, KeyEvent, KeyEventResult>? onKeyEvent =>
        DartRuntimePrimitives.ConvertValue<Func<FocusNode, KeyEvent, KeyEventResult>>(
            _onKeyEvent ?? (focusNode?.onKeyEvent)
        );
    public virtual Func<FocusNode, RawKeyEvent, KeyEventResult>? onKey =>
        DartRuntimePrimitives.ConvertValue<Func<FocusNode, RawKeyEvent, KeyEventResult>>(
            _onKey ?? (focusNode?.onKey)
        );
    ...
    public virtual string? debugLabel =>
        DartRuntimePrimitives.ConvertValue<string>(_debugLabel ?? focusNode?.debugLabel);

    public static FocusNode of(
    ...
    {
        _FocusInheritedScope__focus_scope? scope = createDependency
            ? context.dependOnInheritedWidgetOfExactType<_FocusInheritedScope__focus_scope>()
            : context.getInheritedWidgetOfExactType<_FocusInheritedScope__focus_scope>();
        return scope?.notifier switch
        {
            null => DartRuntimePrimitives.ConvertValue<FocusNode>(null),
            FocusScopeNode __object19955 when !scopeOk =>
    ...
    public static bool isAt(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<bool>(maybeOf(context)?.hasFocus ?? false);
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _FocusState__focus_scope());
}

internal class _FocusWithExternalFocusNode__focus_scope : Focus
{
    internal _FocusWithExternalFocusNode__focus_scope(
        Key? key = null,
        Widget child = default!,
        FocusNode focusNode = default!,
        FocusNode? parentNode = null,
...
internal class _FocusState__focus_scope : State<Focus>
{
    ...
    public virtual FocusNode focusNode =>
        DartRuntimePrimitives.ConvertValue<FocusNode>(
            widget.focusNode ?? (_internalNode ??= _createNode())
        );
    ...
    public override void didUpdateWidget(Focus oldWidget)
    {
        ...
        {
            if (
                Equals(oldWidget.focusNode, widget.focusNode)
    ...
    public override Widget build(BuildContext context)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            ...
            {
                childLocal = DartRuntimePrimitives.ConvertValue<Widget>(
                    new _DebugFocusBorder__focus_scope(node: focusNode, child: childLocal)
                );
            }
            return true;
            throw new InvalidOperationException("Callback completed without returning a value.");
...
public class FocusScope : Focus
{
    ...
    public static FocusScope CreateWithExternalFocusNode(
        Key? key = null,
        Widget child = default!,
        FocusScopeNode focusScopeNode = default!,
        FocusNode? parentNode = null,
        bool autofocus = default!,
        bool includeSemantics = default!,
        Action<bool>? onFocusChange = null
    ) =>
        new _FocusScopeWithExternalFocusNode__focus_scope(
            key,
            child,
            focusScopeNode,
            parentNode,
    ...
    public override State<Focus> createState() =>
        DartRuntimePrimitives.ConvertValue<State<Focus>>(new _FocusScopeState__focus_scope());
}
    ...
    public override Widget build(BuildContext context)
    {
        ...
        if (widget.includeSemantics)
        {
            result = DartRuntimePrimitives.ConvertValue<Widget>(
                new Semantics(explicitChildNodes: true, child: result)
            );
        }
        return result;
        throw new InvalidOperationException("Control flow completed without returning a value.");
            ...
            builder: (context, _) =>
            {
                return new DecoratedBox(
                    decoration: new BoxDecoration(
                        border: Border.CreateAll(color: _borderColor, width: 3.0)
                    ),
...
{
    internal _FocusInheritedScope__focus_scope(FocusNode node, Widget child)
        : base(child: child, notifier: node) { }
}
...
public class ExcludeFocus : StatelessWidget
{
    ...
    public ExcludeFocus(Key? key = null, bool excluding = true, Widget child = default!)
        : base(key: key)
    {
