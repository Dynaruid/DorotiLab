...
public class Scrollable : StatefulWidget
{
    ...
    public virtual Func<BuildContext, ViewportOffset, Widget> viewportBuilder
    {
        get;
        private set;
    } = default!;
    ...
    public Scrollable(
        ...
        Func<ScrollIncrementDetails, double>? incrementCalculator = null,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new ScrollableState());
    ...
    public static ScrollableState? maybeOf(BuildContext context, Axis? axis = null)
    {
        ...
        {
            ScrollableState scrollableLocal = (
                (_ScrollableScope__scrollable?)element.widget
            )!.scrollable;
            if (
                (axis is null)
                || Equals(
    ...
    {
        _ScrollableScope__scrollable? widget =
            context.getInheritedWidgetOfExactType<_ScrollableScope__scrollable>();
        ...
        while (scrollable is not null)
        {
            ...
            DartRuntimePrimitives.Ignore(
                (newFutures, scrollable) = scrollable._performEnsureVisible(
                    ...
                    targetRenderObject: targetRenderObjectLocal
                )
            );
...
internal class _ScrollableScope__scrollable : InheritedWidget
{
    ...
    internal _ScrollableScope__scrollable(
...
public class ScrollableState
    : State<Scrollable>,
        TickerProviderStateMixin<Scrollable>,
        RestorationMixin<Scrollable>,
        ScrollContext
{
    ...
    internal virtual _RestorableScrollOffset__scrollable _persistedScrollOffset
    {
        get;
        private set;
    } = new _RestorableScrollOffset__scrollable();
    ...
    internal virtual GlobalKey<IState> _scrollSemanticsKey { get; private set; } =
    ...
    internal virtual GlobalKey<IState> _ignorePointerKey { get; private set; } =
        GlobalKey<IState>.Create();
    internal virtual DartMap<Type, dynamic> _gestureRecognizers { get; set; } =
    ...
    public virtual ScrollPosition position =>
        DartRuntimePrimitives.ConvertValue<ScrollPosition>(_position!);
    public virtual ScrollPhysics? resolvedPhysics => _physics;
    public virtual Offset deltaToScrollOrigin =>
        DartRuntimePrimitives.ConvertValue<Offset>(
            axisDirection switch
            {
                AxisDirection.up => new Offset(0, -position.pixels),
    ...
    public virtual Scheduler.TickerProvider vsync =>
        DartRuntimePrimitives.ConvertValue<Scheduler.TickerProvider>(this);
    ...
    {
        DartRuntimePrimitives.Assert(() =>
            RestorationLibrary.debugIsSerializableForRestoration(offset)
        );
    ...
    internal virtual bool _shouldUpdatePosition(Scrollable oldWidget)
    {
        ...
        if (
            (widget.scrollBehavior is not null)
        ...
        do
        {
            if (
                !Equals(
                    DartRuntimePrimitives.RuntimeType(newPhysics),
                    DartRuntimePrimitives.RuntimeType(oldPhysics)
                )
            )
            {
                return true;
                                        ...
                                        (
                                            (Func<VerticalDragGestureRecognizer>)(
                                                () =>
                                                {
                                                    ...
                                                    __cascade.minFlingDistance =
                                                        _physics?.minFlingDistance;
                                                    __cascade.minFlingVelocity =
                                                        _physics?.minFlingVelocity;
                                                    __cascade.maxFlingVelocity =
                                                        _physics?.maxFlingVelocity;
                                                    __cascade.velocityTrackerBuilder =
                                                        _configuration.velocityTrackerBuilder(
                                                            context
                                                        );
                                                    __cascade.dragStartBehavior =
                                                        widget.dragStartBehavior;
                                                    __cascade.multitouchDragStrategy =
                                                        _configuration.getMultitouchDragStrategy(
                                                            context
                                                        );
                                                    __cascade.gestureSettings =
                                                        _mediaQueryGestureSettings;
                                                    __cascade.supportedDevices =
                                                        _configuration.dragDevices;
                                                    return __cascade;
                                                }
                                            )
                                        )()
    ...
    internal virtual void _receivedPointerSignal(PointerSignalEvent @event)
    {
        ...
        else
        {
            ...
            {
                PointerScrollInertiaCancelEvent @event__as38382 =
    ...
    {
        DartRuntimePrimitives.Assert(() => _position is not null);
        Widget result = new _ScrollableScope__scrollable(
            scrollable: this,
            position: position,
            child: new Listener(
        ...
        if (!widget.excludeFromSemantics)
        {
            result = DartRuntimePrimitives.ConvertValue<Widget>(
                new NotificationListener<ScrollMetricsNotification>(
                    onNotification: _handleScrollMetricsNotification,
                    child: new _ScrollSemantics__scrollable(
        ...
        {
            result = DartRuntimePrimitives.ConvertValue<Widget>(
                new _ScrollableSelectionHandler__scrollable(
                    state: this,
                    position: position,
    ...
    {
        Future ensureVisibleFuture = position.ensureVisible(
            @object,
            alignment: alignment,
            duration: duration,
            curve: curve,
...
public class _ScrollableSelectionHandler__scrollable : StatefulWidget
{
    ...
    internal _ScrollableSelectionHandler__scrollable(
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _ScrollableSelectionHandlerState__scrollable()
        );
}

public class _ScrollableSelectionHandlerState__scrollable
    : State<_ScrollableSelectionHandler__scrollable>
{
    internal virtual _ScrollableSelectionContainerDelegate__scrollable _selectionDelegate { get; set; } =
        default!;

    public override void initState()
    {
        base.initState();
        _selectionDelegate = new _ScrollableSelectionContainerDelegate__scrollable(
            state: widget.state,
...
internal class _ScrollableSelectionContainerDelegate__scrollable
    : MultiSelectableSelectionContainerDelegate
{
    ...
    internal virtual ScrollPosition _position { get; set; } = default!;
    internal virtual DartMap<Selectable, double> _selectableStartEdgeUpdateRecords
    {
        get;
        private set;
    } = new DartMap<Selectable, double>();
    internal virtual DartMap<Selectable, double> _selectableEndEdgeUpdateRecords
    {
        get;
        private set;
    } = new DartMap<Selectable, double>();

    internal _ScrollableSelectionContainerDelegate__scrollable(
        ScrollableState state,
        ScrollPosition position
    )
    {
    ...
    )
    {
        ...
        if (
            ...
            && ((_currentDragStartRelatedToOrigin is null) || forceUpdateStart)
        )
        {
            ...
            Matrix4 childTransform = selectables[(int)currentSelectionStartIndex]
                .getTransformTo(box);
            Offset localDragStart = MatrixUtils.transformPoint(
                childTransform,
                start.localPosition + new Offset(0, -start.lineHeight / 2L)
            );
        ...
        if (
            ...
            && ((_currentDragEndRelatedToOrigin is null) || forceUpdateEnd)
        )
        {
            ...
            Matrix4 childTransformLocal = selectables[(int)currentSelectionEndIndex]
                .getTransformTo(box);
            Offset localDragEnd = MatrixUtils.transformPoint(
                childTransformLocal,
                end.localPosition + new Offset(0, -end.lineHeight / 2L)
            );
    ...
    internal virtual void _jumpToEdge(bool isExtent)
    {
        ...
        Offset edgeOffsetInScrollableCoordinates = MatrixUtils.transformPoint(
            transform,
            edge.localPosition
        );
        var scrollableRect = Rect.fromLTRB(
            0,
            0,
        ...
        switch (state.axisDirection)
        {
            ...
            case AxisDirection.left:
            {
                ...
                if (
                    (edgeAlternate >= scrollableRect.right)
                    && (edgeAlternate <= scrollableRect.left)
                )
                {
                    return;
                }
    ...
    public override void ensureChildUpdated(Selectable selectable)
    {
        ...
        double? previousStartRecord = DartCollectionRuntime.NullableMapValue<double>(
            _selectableStartEdgeUpdateRecords,
            selectable
        );
        if (
            (_currentDragStartRelatedToOrigin is not null)
            && (
        ...
        double? previousEndRecord = DartCollectionRuntime.NullableMapValue<double>(
            _selectableEndEdgeUpdateRecords,
            selectable
        );
        if (
            (_currentDragEndRelatedToOrigin is not null)
            && (
...
public static partial class ScrollableLibrary
{
    internal static Offset _getDeltaToScrollOrigin(ScrollableState scrollableState)
    {
        ...
        {
            AxisDirection.up => new Offset(0, -scrollableState.position.pixels),
...
internal class _ScrollSemantics__scrollable : SingleChildRenderObjectWidget
{
    ...
    internal _ScrollSemantics__scrollable(
        Key? key = null,
        ScrollPosition position = default!,
        bool allowImplicitScrolling = default!,
        Axis axis = default!,
        long? semanticChildCount = default!,
        Widget? child = null
    )
    ...
    {
        return new _RenderScrollSemantics__scrollable(
            position: position,
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<_RenderScrollSemantics__scrollable>)(
                    () =>
                    {
...
public class _RenderScrollSemantics__scrollable : RenderProxyBox
{
    ...
    internal _RenderScrollSemantics__scrollable(
        ScrollPosition position,
        bool allowImplicitScrolling,
        Axis axis,
        long? semanticChildCount,
...
public class TwoDimensionalScrollable : StatefulWidget
{
    ...
    public virtual Func<BuildContext, ViewportOffset, ViewportOffset, Widget> viewportBuilder
    {
        get;
        private set;
    } = default!;
    ...
    public TwoDimensionalScrollable(
        ...
        Func<BuildContext, ViewportOffset, ViewportOffset, Widget> viewportBuilder = default!,
        Func<ScrollIncrementDetails, double>? incrementCalculator = null,
        string? restorationId = null,
        bool excludeFromSemantics = false,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new TwoDimensionalScrollableState());
...
public class TwoDimensionalScrollableState : State<TwoDimensionalScrollable>
{
    ...
    internal virtual GlobalKey<ScrollableState> _verticalOuterScrollableKey { get; private set; } =
        GlobalKey<ScrollableState>.Create();
    internal virtual GlobalKey<ScrollableState> _horizontalInnerScrollableKey
    {
        get;
        private set;
    } = GlobalKey<ScrollableState>.Create();
    ...
    public virtual ScrollableState verticalScrollable
    {
        ...
        {
            DartRuntimePrimitives.Assert(() =>
                _verticalOuterScrollableKey.currentState is not null
            );
    ...
    public virtual ScrollableState horizontalScrollable
    {
        ...
        {
            DartRuntimePrimitives.Assert(() =>
                _horizontalInnerScrollableKey.currentState is not null
            );
    ...
    public override Widget build(BuildContext context)
    {
        DartRuntimePrimitives.Assert(
            () =>
                Equals(
                    Basic_typesLibrary.axisDirectionToAxis(widget.verticalDetails.direction),
                    Axis.vertical
                ),
            () => (object?)"TwoDimensionalScrollable.verticalDetails are not Axis.vertical."
        );
        DartRuntimePrimitives.Assert(
            () =>
                Equals(
                    Basic_typesLibrary.axisDirectionToAxis(widget.horizontalDetails.direction),
                    Axis.horizontal
                ),
        ...
        Widget result = new RestorationScope(
            ...
            child: new _VerticalOuterDimension__scrollable(
        ...
        return new _TwoDimensionalScrollableScope__scrollable(
...
{
    public virtual TwoDimensionalScrollableState twoDimensionalScrollable { get; private set; } =
        default!;

    internal _TwoDimensionalScrollableScope__scrollable(
...
internal class _VerticalOuterDimension__scrollable : Scrollable
{
    ...
    internal _VerticalOuterDimension__scrollable(
        Key? key = null,
        GlobalKey<ScrollableState> horizontalKey = default!,
        Func<BuildContext, ViewportOffset, Widget> viewportBuilder = default!,
        ...
        )
    {
        ...
        System.Diagnostics.Debug.Assert(
            Equals(axisDirection, AxisDirection.up) || Equals(axisDirection, AxisDirection.down)
        );
    }

    public override _VerticalOuterDimensionState__scrollable createState() =>
        new _VerticalOuterDimensionState__scrollable();
}
...
internal class _VerticalOuterDimensionState__scrollable : ScrollableState
{
    ...
    public virtual DiagonalDragBehavior diagonalDragBehavior =>
        ((_VerticalOuterDimension__scrollable?)widget)!.diagonalDragBehavior;
    public virtual ScrollableState horizontalScrollable =>
        DartRuntimePrimitives.ConvertValue<ScrollableState>(
            ((_VerticalOuterDimension__scrollable?)widget)!.horizontalKey.currentState!
        );

    internal override (List<Future>, ScrollableState) _performEnsureVisible(
        RenderObject @object,
        double alignment = 0.0,
        Duration duration = default,
        Curve curve = default!,
    ...
    )
    {
        DartRuntimePrimitives.Assert(
            () => false,
            () =>
                (object?)"The _performEnsureVisible method was called for the vertical scrollable "
    ...
    internal override void _handleDragUpdate(DragUpdateDetails details)
    {
        var verticalDragDetails = new DragUpdateDetails(
            ...
            delta: new Offset(0.0, details.delta.dy),
        ...
        var horizontalDragDetails = new DragUpdateDetails(
            sourceTimeStamp: details.sourceTimeStamp,
            delta: new Offset(details.delta.dx, 0.0),
    ...
    internal override void _handleDragEnd(DragEndDetails details)
    {
        ...
        var verticalDragDetails = new DragEndDetails(
            velocity: new Velocity(pixelsPerSecond: new Offset(0.0, dyLocal)),
            primaryVelocity: dyLocal
        );
        var horizontalDragDetails = new DragEndDetails(
            velocity: new Velocity(pixelsPerSecond: new Offset(dxLocal, 0.0)),
            primaryVelocity: dxLocal
        );
        switch (diagonalDragBehavior)
        {
            case DiagonalDragBehavior.none:
...
internal class _HorizontalInnerDimension__scrollable : Scrollable
{
    ...
    internal _HorizontalInnerDimension__scrollable(
        Key? key = null,
        GlobalKey<ScrollableState> verticalOuterKey = default!,
        Func<BuildContext, ViewportOffset, Widget> viewportBuilder = default!,
        AxisDirection axisDirection = default!,
        ScrollController? controller = null,
        ScrollPhysics? physics = null,
        ...
        )
    {
        ...
        this.diagonalDragBehavior = diagonalDragBehavior;
        System.Diagnostics.Debug.Assert(
            Equals(axisDirection, AxisDirection.left) || Equals(axisDirection, AxisDirection.right)
        );
    }

    public override _HorizontalInnerDimensionState__scrollable createState() =>
        new _HorizontalInnerDimensionState__scrollable();
}
...
internal class _HorizontalInnerDimensionState__scrollable : ScrollableState
{
    ...
    public virtual GlobalKey<ScrollableState> verticalOuterKey =>
        ((_HorizontalInnerDimension__scrollable?)widget)!.verticalOuterKey;
    public virtual DiagonalDragBehavior diagonalDragBehavior =>
        ((_HorizontalInnerDimension__scrollable?)widget)!.diagonalDragBehavior;
    ...
    public override void didChangeDependencies()
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            Equals(
                Basic_typesLibrary.axisDirectionToAxis(verticalScrollable.axisDirection),
                Axis.vertical
            )
        );
        base.didChangeDependencies();
    ...
    {
        var newFutures = new List<Future>
        {
