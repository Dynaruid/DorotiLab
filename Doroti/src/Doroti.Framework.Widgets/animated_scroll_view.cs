...
{
    public AnimatedList(Key? key = null, Func<BuildContext, long, Animation<double>, Widget> itemBuilder = default!, long initialItemCount = 0, Axis scrollDirection = Axis.vertical, bool reverse = false, ScrollController? controller = null, bool? primary = null, ScrollPhysics? physics = null, bool shrinkWrap = false, EdgeInsetsGeometry? padding = null, Clip clipBehavior = Clip.hardEdge, ScrollCacheExtent? scrollCacheExtent = null) : base(key: key, itemBuilder: itemBuilder, initialItemCount: initialItemCount, scrollDirection: scrollDirection, reverse: reverse, controller: controller, primary: DartRuntimePrimitives.RequireValue(primary), physics: physics, shrinkWrap: shrinkWrap, padding: padding, clipBehavior: clipBehavior, scrollCacheExtent: scrollCacheExtent)
    {
        System.Diagnostics.Debug.Assert(initialItemCount >= 0L);
    }

    public static AnimatedList CreateSeparated(Key? key = null, Func<BuildContext, long, Animation<double>, Widget> itemBuilder = default!, Func<BuildContext, long, Animation<double>, Widget> separatorBuilder = default!, Func<BuildContext, long, Animation<double>, Widget> removedSeparatorBuilder = default!, long initialItemCount = 0, Axis scrollDirection = Axis.vertical, bool reverse = false, ScrollController? controller = null, bool? primary = null, ScrollPhysics? physics = null, bool shrinkWrap = false, EdgeInsetsGeometry? padding = null, Clip clipBehavior = Clip.hardEdge, ScrollCacheExtent? scrollCacheExtent = null)
    {
...
public class AnimatedListState : _AnimatedScrollViewState__animated_scroll_view<AnimatedList>
{
    ...
    {
        return _wrap(new SliverAnimatedList(key: _sliverAnimatedMultiBoxKey, itemBuilder: widget.itemBuilder, initialItemCount: widget.initialItemCount), widget.scrollDirection);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class AnimatedGrid : _AnimatedScrollView__animated_scroll_view
{
    ...
    public AnimatedGrid(Key? key = null, Func<BuildContext, long, Animation<double>, Widget> itemBuilder = default!, SliverGridDelegate gridDelegate = default!, long initialItemCount = 0, Axis scrollDirection = Axis.vertical, bool reverse = false, ScrollController? controller = null, bool? primary = null, ScrollPhysics? physics = null, EdgeInsetsGeometry? padding = null, Clip clipBehavior = Clip.hardEdge, ScrollCacheExtent? scrollCacheExtent = null) : base(key: key, itemBuilder: itemBuilder, initialItemCount: initialItemCount, scrollDirection: scrollDirection, reverse: reverse, controller: controller, primary: DartRuntimePrimitives.RequireValue(primary), physics: physics, padding: padding, clipBehavior: clipBehavior, scrollCacheExtent: scrollCacheExtent)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            {
                if (result is null)
                {
                    throw DartRuntimePrimitives.AsException(new FlutterError(new List<DiagnosticsNode> { new ErrorSummary("AnimatedGrid.of() called with a context that does not contain an AnimatedGrid."), new ErrorDescription("No AnimatedGrid ancestor could be found starting from the context that was passed to AnimatedGrid.of()."), new ErrorHint("This can happen when the context provided is from the same StatefulWidget that " + "built the AnimatedGrid. Please see the AnimatedGrid documentation for examples " + "of how to refer to an AnimatedGridState object:\n" + "  https://api.flutter.dev/flutter/widgets/AnimatedGridState-class.html"), context.describeElement("The context used was") }));
                }
                return true;
                throw new InvalidOperationException("Dart closure completed without a value.");
            });
...
public class AnimatedGridState : _AnimatedScrollViewState__animated_scroll_view<AnimatedGrid>
{
    public override Widget build(BuildContext context)
    {
        return _wrap(new SliverAnimatedGrid(key: _sliverAnimatedMultiBoxKey, gridDelegate: widget.gridDelegate, itemBuilder: widget.itemBuilder, initialItemCount: widget.initialItemCount), widget.scrollDirection);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
{
    public virtual Func<BuildContext, long, Animation<double>, Widget> itemBuilder { get; private set; } = default!;
    public virtual Func<BuildContext, long, Animation<double>, Widget>? removedSeparatorBuilder { get; protected set; }
    ...
    internal _AnimatedScrollView__animated_scroll_view(Key? key = null, Func<BuildContext, long, Animation<double>, Widget> itemBuilder = default!, Func<BuildContext, long, Animation<double>, Widget>? removedSeparatorBuilder = null, long initialItemCount = 0, Axis scrollDirection = Axis.vertical, bool reverse = false, ScrollController? controller = null, bool? primary = null, ScrollPhysics? physics = null, bool shrinkWrap = false, EdgeInsetsGeometry? padding = null, Clip clipBehavior = Clip.hardEdge, ScrollCacheExtent? scrollCacheExtent = null) : base(key: key)
    {
...
public abstract class _AnimatedScrollViewState__animated_scroll_view<T> : State<T>, TickerProviderStateMixin<T> where T : _AnimatedScrollView__animated_scroll_view
{
    ...
    public virtual void insertItem(long index, Duration? duration = null)
    {
        ...
        {
            _sliverAnimatedMultiBoxKey.currentState!.insertItem(index, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
        }
        else
        {
            long itemIndex = _computeItemIndex(index);
            _sliverAnimatedMultiBoxKey.currentState!.insertItem(itemIndex, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
            if (_itemsCount > 1L)
            {
                _sliverAnimatedMultiBoxKey.currentState!.insertItem(itemIndex, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
            }
    ...
    public virtual void insertAllItems(long index, long length, Duration? duration = null, bool isAsync = false)
    {
        if (widget.removedSeparatorBuilder is null)
        {
            _sliverAnimatedMultiBoxKey.currentState!.insertAllItems(index, length, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
        }
        else
        {
            long itemIndex = _computeItemIndex(index);
            long lengthWithSeparators = (_itemsCount == 0L) ? ((length * 2L) - 1L) : (length * 2L);
            _sliverAnimatedMultiBoxKey.currentState!.insertAllItems(itemIndex, lengthWithSeparators, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
        }
    }

    public virtual void removeItem(long index, Func<BuildContext, Animation<double>, Widget> builder, Duration? duration = null)
    {
        Func<BuildContext, long, Animation<double>, Widget>? removedSeparatorBuilderLocal = widget.removedSeparatorBuilder;
        if (removedSeparatorBuilderLocal is null)
        {
            _sliverAnimatedMultiBoxKey.currentState!.removeItem(index, builder, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
        }
        else
        {
            long itemIndex = _computeItemIndex(index);
            long visibleItemsCount = _itemsCount - _outgoingItemsCount;
            _sliverAnimatedMultiBoxKey.currentState!.removeItem(itemIndex, builder, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
            if (visibleItemsCount > 1L)
            {
                if (itemIndex == (visibleItemsCount - 1L))
                {
                    _sliverAnimatedMultiBoxKey.currentState!.removeItem(itemIndex - 1L, _toRemovedItemBuilder(removedSeparatorBuilderLocal, index - 1L), duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
                }
                else
                {
                    _sliverAnimatedMultiBoxKey.currentState!.removeItem(itemIndex, _toRemovedItemBuilder(removedSeparatorBuilderLocal, index), duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
                }
            }
        }
    }

    public virtual void removeAllItems(Func<BuildContext, Animation<double>, Widget> builder, Duration? duration = null)
    {
        Func<BuildContext, long, Animation<double>, Widget>? removedSeparatorBuilderLocal = widget.removedSeparatorBuilder;
        if (removedSeparatorBuilderLocal is null)
        {
            _sliverAnimatedMultiBoxKey.currentState!.removeAllItems(builder, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
            return;
        }
        for (long index = _itemsCount - 1L; index >= 0L; index--)
        {
            ...
            else
            {
                ...
                _sliverAnimatedMultiBoxKey.currentState!.removeItem(index, _toRemovedItemBuilder(removedSeparatorBuilderLocal, itemIndex), duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
            }
        }
    }

    internal virtual long _itemsCount => _sliverAnimatedMultiBoxKey.currentState!._itemsCount;
    internal virtual long _outgoingItemsCount => checked(_sliverAnimatedMultiBoxKey.currentState!._outgoingItems.Count);
    ...
    internal virtual Func<BuildContext, Animation<double>, Widget> _toRemovedItemBuilder(Func<BuildContext, long, Animation<double>, Widget> builder, long index)
    {
    ...
    internal virtual Widget _wrap(Widget sliver, Axis direction)
    {
        ...
        if (widget.padding is null)
        {
            ...
            if (mediaQuery is not null)
            {
                ...
                effectivePadding = DartRuntimePrimitives.ConvertValue<EdgeInsetsGeometry>(Equals(direction, Axis.vertical) ? mediaQueryVerticalPadding : mediaQueryHorizontalPadding);
        ...
        return new CustomScrollView(scrollDirection: widget.scrollDirection, reverse: widget.reverse, controller: widget.controller, primary: widget.primary, physics: widget.physics, clipBehavior: widget.clipBehavior, shrinkWrap: widget.shrinkWrap, scrollCacheExtent: widget.scrollCacheExtent, slivers: new List<Widget> { sliver });
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public delegate Widget AnimatedItemBuilder(BuildContext context, long index, Animation<double> animation);

public delegate Widget AnimatedRemovedItemBuilder(BuildContext context, Animation<double> animation);
...
internal class _ActiveItem__animated_scroll_view : IComparable<_ActiveItem__animated_scroll_view>
{
    ...
    public virtual Func<BuildContext, Animation<double>, Widget>? removedItemBuilder { get; private set; }
    ...
    internal static _ActiveItem__animated_scroll_view CreateOutgoing(AnimationController? controller, long itemIndex, Func<BuildContext, Animation<double>, Widget>? removedItemBuilder)
    {
    ...
    public virtual long compareTo(_ActiveItem__animated_scroll_view other) => DartRuntimePrimitives.ConvertValue<long>(itemIndex - other.itemIndex);
...
{
    public SliverAnimatedList(Key? key = null, Func<BuildContext, long, Animation<double>, Widget> itemBuilder = default!, Func<Key, long?>? findChildIndexCallback = null, long initialItemCount = 0) : base(key: key, itemBuilder: itemBuilder, findChildIndexCallback: findChildIndexCallback, initialItemCount: initialItemCount)
    {
        System.Diagnostics.Debug.Assert(initialItemCount >= 0L);
    }
...
public class SliverAnimatedGrid : _SliverAnimatedMultiBoxAdaptor__animated_scroll_view
{
    ...
    public SliverAnimatedGrid(Key? key = null, Func<BuildContext, long, Animation<double>, Widget> itemBuilder = default!, SliverGridDelegate gridDelegate = default!, Func<Key, long?>? findChildIndexCallback = null, long initialItemCount = 0) : base(key: key, itemBuilder: itemBuilder, findChildIndexCallback: findChildIndexCallback, initialItemCount: initialItemCount)
    {
        this.gridDelegate = gridDelegate;
        System.Diagnostics.Debug.Assert(initialItemCount >= 0L);
    }
    ...
    {
        SliverAnimatedGridState? result = context.findAncestorStateOfType<SliverAnimatedGridState>();
        DartRuntimePrimitives.Assert(() =>
            {
                if (result is null)
                {
...
public abstract class _SliverAnimatedMultiBoxAdaptor__animated_scroll_view : StatefulWidget
{
    ...
    internal _SliverAnimatedMultiBoxAdaptor__animated_scroll_view(Key? key = null, Func<BuildContext, long, Animation<double>, Widget> itemBuilder = default!, Func<Key, long?>? findChildIndexCallback = null, long initialItemCount = 0) : base(key: key)
    {
        this.itemBuilder = itemBuilder;
...
public abstract class _SliverAnimatedMultiBoxAdaptorState__animated_scroll_view<T> : State<T>, TickerProviderStateMixin<T> where T : _SliverAnimatedMultiBoxAdaptor__animated_scroll_view
{
    ...
    public override void dispose()
    {
        foreach (_ActiveItem__animated_scroll_view item in _incomingItems.followedBy(_outgoingItems.Cast<_ActiveItem__animated_scroll_view>()))
        {
    ...
    {
        return new SliverChildBuilderDelegate(_itemBuilder, childCount: _itemsCount, findChildIndexCallback: (widget.findChildIndexCallback is null) ? null : ((key) =>
        {
    ...
    internal virtual Widget _itemBuilder(BuildContext context, long itemIndex)
    {
        ...
        Animation<double> animation = incomingItem?.controller?.view ?? AnimationsLibrary.kAlwaysCompleteAnimation;
    ...
    public virtual void insertItem(long index, Duration? duration = null)
    {
        ...
        DartRuntimePrimitives.Assert(() => (itemIndexLocal >= 0L) && (itemIndexLocal <= _itemsCount));
        ...
        var controllerLocal = new AnimationController(duration: DartRuntimePrimitives.RequireValue(duration), vsync: this);
        ...
        DartRuntimePrimitives.Ignore(controllerLocal.forward().then((_) =>
        {
    ...
    public virtual void removeItem(long index, Func<BuildContext, Animation<double>, Widget> builder, Duration? duration = null)
    {
        ...
        _ActiveItem__animated_scroll_view? incomingItem = _removeActiveItemAt(_incomingItems, itemIndexLocal);
        AnimationController controllerLocal = incomingItem?.controller ?? new AnimationController(duration: DartRuntimePrimitives.RequireValue(duration), value: 1.0, vsync: this);
        var outgoingItem = _ActiveItem__animated_scroll_view.CreateOutgoing(controllerLocal, itemIndexLocal, builder);
        setState(() =>
        {
            DartRuntimePrimitives.Ignore(((Func<List<_ActiveItem__animated_scroll_view>>)(() =>
            {
        ...
        DartRuntimePrimitives.Ignore(controllerLocal.reverse().then((value) =>
        {
    ...
    public virtual void removeAllItems(Func<BuildContext, Animation<double>, Widget> builder, Duration? duration = null)
    {
        ...
        {
            removeItem(i, builder, duration: DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(duration)));
        }
    }
