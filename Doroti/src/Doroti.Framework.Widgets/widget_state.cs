...
internal class _WidgetStateColor__widget_state : WidgetStateColor
{
    ...
    internal _WidgetStateColor__widget_state(Func<HashSet<WidgetState>, Color> _resolve) : base(_resolve(_defaultStates).value)
    {
...
public abstract class WidgetStateMouseCursor : MouseCursor, WidgetStateProperty<MouseCursor>
{
    ...
    public static WidgetStateMouseCursor CreateResolveWith(Func<HashSet<WidgetState>, MouseCursor> callback, string debugDescription = default!)
        => new _WidgetStateMouseCursor__widget_state(callback, debugDescription);

    public static WidgetStateMouseCursor CreateFromMap(DartMap<WidgetStatesConstraint, MouseCursor> map)
...
{
    internal virtual Func<HashSet<WidgetState>, MouseCursor> _resolve { get; private set; } = default!;
    private string __field_debugDescription = default!;
    public override string debugDescription { get => __field_debugDescription; }

    internal _WidgetStateMouseCursor__widget_state(Func<HashSet<WidgetState>, MouseCursor> _resolve, string debugDescription = "WidgetStateMouseCursor()")
    {
        this._resolve = _resolve;
...
public abstract class WidgetStateBorderSide : BorderSide, WidgetStateProperty<BorderSide?>
{
    ...
    public static WidgetStateBorderSide CreateResolveWith(Func<HashSet<WidgetState>, BorderSide?> callback)
        => new _WidgetStateBorderSide__widget_state(callback);

    public static WidgetStateBorderSide CreateFromMap(DartMap<WidgetStatesConstraint, BorderSide?> map)
        => new _WidgetBorderSideMapper__widget_state(map);

    public abstract BorderSide? resolve(HashSet<WidgetState> states);
    public static WidgetStateProperty<BorderSide?>? lerp(WidgetStateProperty<BorderSide?>? a, WidgetStateProperty<BorderSide?>? b, double t)
    {
...
internal class _LerpSides__widget_state : WidgetStateProperty<BorderSide?>
{
    ...
    internal _LerpSides__widget_state(WidgetStateProperty<BorderSide?>? a, WidgetStateProperty<BorderSide?>? b, double t)
    {
        this.a = a;
        this.b = b;
        this.t = t;
    ...
    public virtual BorderSide? resolve(HashSet<WidgetState> states)
    {
        ...
        {
            return (BorderSide?)BorderSide.lerp(new BorderSide(width: 0, color: resolvedB!.color.withAlpha(0L)), resolvedB, t);
        }
        if (resolvedB is null)
        {
            return (BorderSide?)BorderSide.lerp(resolvedA, new BorderSide(width: 0, color: resolvedA.color.withAlpha(0L)), t);
        }
...
{
    internal virtual Func<HashSet<WidgetState>, BorderSide?> _resolve { get; private set; } = default!;
...
public abstract class WidgetStateOutlinedBorder : OutlinedBorder, WidgetStateProperty<OutlinedBorder?>
{
    protected WidgetStateOutlinedBorder()
    {
    }

    public static WidgetStateOutlinedBorder CreateResolveWith(Func<HashSet<WidgetState>, OutlinedBorder?> callback)
        => new _WidgetStateOutlinedBorder__widget_state(callback);

    public static WidgetStateOutlinedBorder CreateFromMap(DartMap<WidgetStatesConstraint, OutlinedBorder?> map)
...
public abstract class WidgetStateTextStyle : TextStyle, WidgetStateProperty<TextStyle>
{
    ...
    public static WidgetStateTextStyle CreateResolveWith(Func<HashSet<WidgetState>, TextStyle> callback)
        => new _WidgetStateTextStyle__widget_state(callback);

    public static WidgetStateTextStyle CreateFromMap(DartMap<WidgetStatesConstraint, TextStyle> map)
...
{
    internal virtual Func<HashSet<WidgetState>, TextStyle> _resolve { get; private set; } = default!;
...
public static class WidgetStateProperty
{
    ...
    public static WidgetStateProperty<T> resolveWith<T>(Func<HashSet<WidgetState>, T> callback) => WidgetStateProperty<T>.resolveWith(callback);
    public static WidgetStateProperty<T> all<T>(T value) => WidgetStateProperty<T>.all(value);
    public static WidgetStateProperty<T?>? lerp<T>(WidgetStateProperty<T>? a, WidgetStateProperty<T>? b, double t, Func<T?, T?, double, T?> lerpFunction) => WidgetStateProperty<T>.lerp(a, b, t, lerpFunction);
}
...
public interface WidgetStateProperty<out T>
{
    ...
    public static WidgetStateProperty<TValue> resolveWith<TValue>(Func<HashSet<WidgetState>, TValue> callback) => DartRuntimePrimitives.ConvertValue<WidgetStateProperty<TValue>>(new _WidgetStatePropertyWith__widget_state<TValue>(callback));
    ...
    public static WidgetStateProperty<TValue?>? lerp<TValue>(WidgetStateProperty<TValue>? a, WidgetStateProperty<TValue>? b, double t, Func<TValue?, TValue?, double, TValue?> lerpFunction)
    {
        if ((a is null) && (b is null))
        {
            return default;
...
internal class _LerpProperties__widget_state<T> : WidgetStateProperty<T?>
{
    ...
    internal _LerpProperties__widget_state(WidgetStateProperty<T>? a, WidgetStateProperty<T>? b, double t, Func<T?, T?, double, T?> lerpFunction)
    {
        this.a = a;
        this.b = b;
        this.t = t;
...
public class WidgetStateMapper<T> : Diagnosticable, WidgetStateProperty<T>, IWidgetStateMapping<T>
{
    ...
    {
        throw DartRuntimePrimitives.AsException(new FlutterError(new List<DiagnosticsNode> { new ErrorSummary($"There was an attempt to access the \"{invocation.memberName}\" " + $"field of a WidgetStateMapper<{typeof(T)}> object."), new ErrorDescription($"{this}"), new ErrorDescription("WidgetStateProperty objects should only be used " + "in places that document their support."), new ErrorHint("Double-check whether the map was used in a place that " + "documents support for WidgetStateProperty objects. If so, " + "please file a bug report. (The https://pub.dev/ page for a package " + "contains a link to \"View/report issues\".)") }));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
