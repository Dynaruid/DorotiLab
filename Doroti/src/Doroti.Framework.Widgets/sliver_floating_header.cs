...
public class SliverFloatingHeader : StatefulWidget
{
    ...
    public SliverFloatingHeader(global::Doroti.Framework.Foundation.Key? key = null, global::Doroti.Framework.Animation.AnimationStyle? animationStyle = null, FloatingHeaderSnapMode? snapMode = null, Widget child = default!) : base(key: key)
    {
...
{
    public virtual global::Doroti.Framework.Scheduler.TickerProvider? vsync { get; private set; }
    public virtual global::Doroti.Framework.Animation.AnimationStyle? animationStyle { get; private set; }
    public virtual FloatingHeaderSnapMode? snapMode { get; private set; }

    internal _SliverFloatingHeader__sliver_floating_header(global::Doroti.Framework.Scheduler.TickerProvider? vsync = null, global::Doroti.Framework.Animation.AnimationStyle? animationStyle = null, FloatingHeaderSnapMode? snapMode = null, Widget? child = null) : base(child: child)
    {
        this.vsync = vsync;
        this.animationStyle = animationStyle;
        this.snapMode = snapMode;
    ...
    {
        return ((global::Doroti.Framework.Rendering.RenderObject)(object?)new _RenderSliverFloatingHeader__sliver_floating_header(vsync: this.vsync, animationStyle: this.animationStyle, snapMode: this.snapMode));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class _RenderSliverFloatingHeader__sliver_floating_header : global::Doroti.Framework.Rendering.RenderSliverSingleBoxAdapter
{
    public virtual global::Doroti.Framework.Animation.Animation<double> snapAnimation { get; set; } = default!;
    public virtual global::Doroti.Framework.Animation.AnimationController? snapController { get; set; } = default;
    public virtual double? lastScrollOffset { get; set; } = default;
    public virtual double effectiveScrollOffset { get; set; } = default!;
    internal virtual global::Doroti.Framework.Scheduler.TickerProvider? _vsync { get; set; } = default;
    public virtual global::Doroti.Framework.Animation.AnimationStyle? animationStyle { get; set; } = default;
    public virtual FloatingHeaderSnapMode? snapMode { get; set; } = default;

    internal _RenderSliverFloatingHeader__sliver_floating_header(global::Doroti.Framework.Scheduler.TickerProvider? vsync = null, global::Doroti.Framework.Animation.AnimationStyle? animationStyle = null, FloatingHeaderSnapMode? snapMode = null)
    {
        this.animationStyle = animationStyle;
        this.snapMode = snapMode;
        this._vsync = vsync;
    ...
    public virtual void isScrollingUpdate(ScrollPosition position)
    {
        ...
        {
            global::Doroti.Framework.Rendering.ScrollDirection direction__7176 = position.userScrollDirection;
            bool headerIsPartiallyVisible__7235 = (direction__7176 switch { global::Doroti.Framework.Rendering.ScrollDirection.forward when ((this.effectiveScrollOffset <= 0L)) => false, global::Doroti.Framework.Rendering.ScrollDirection.reverse when ((this.effectiveScrollOffset >= this.childExtent)) => false, _ => true });
                ...
                snapController ??= ((Func<global::Doroti.Framework.Animation.AnimationController>)(() =>
{
    ...
    public override void performLayout()
    {
        ...
        {
            double delta__9782 = (DartRuntimePrimitives.RequireValue(this.lastScrollOffset) - ((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).scrollOffset);
            if ((object.Equals(((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).userScrollDirection, global::Doroti.Framework.Rendering.ScrollDirection.forward)))
            {
            ...
            effectiveScrollOffset = Dart_uiLibrary.clampDouble((this.effectiveScrollOffset - delta__9782), 0.0, ((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).scrollOffset);
        }
        ...
        double layoutExtent__10611 = ((this.snapMode ?? FloatingHeaderSnapMode.overlay) switch { FloatingHeaderSnapMode.overlay => (this.childExtent - ((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).scrollOffset), FloatingHeaderSnapMode.scroll => paintExtent__10543, _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        geometry = new global::Doroti.Framework.Rendering.SliverGeometry(paintOrigin: Math.Min(((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).overlap, 0.0), scrollExtent: this.childExtent, paintExtent: Dart_uiLibrary.clampDouble(paintExtent__10543, 0.0, ((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).remainingPaintExtent), layoutExtent: Dart_uiLibrary.clampDouble(layoutExtent__10611, 0.0, ((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).remainingPaintExtent), maxPaintExtent: this.childExtent, hasVisualOverflow: true);
    ...
    public override void paint(global::Doroti.Framework.Rendering.PaintingContext context, Offset offset)
    {
        ...
        {
            offset += (global::Doroti.Framework.Rendering.SliverLibrary.applyGrowthDirectionToAxisDirection(((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).axisDirection, ((global::Doroti.Framework.Rendering.SliverConstraints)this.constraints).growthDirection) switch { global::Doroti.Framework.Painting.AxisDirection.up => new global::Doroti.Ui.Offset(0.0, ((this.geometry!.paintExtent - childMainAxisPosition(this.child!)) - this.childExtent)), global::Doroti.Framework.Painting.AxisDirection.left => new global::Doroti.Ui.Offset(((this.geometry!.paintExtent - childMainAxisPosition(this.child!)) - this.childExtent), 0.0), global::Doroti.Framework.Painting.AxisDirection.right => new global::Doroti.Ui.Offset(childMainAxisPosition(this.child!), 0.0), global::Doroti.Framework.Painting.AxisDirection.down => new global::Doroti.Ui.Offset(0.0, childMainAxisPosition(this.child!)), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
