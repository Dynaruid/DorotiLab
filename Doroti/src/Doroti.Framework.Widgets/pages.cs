...
{
    internal static Widget _defaultTransitionsBuilder(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation, Widget child)
    {
        return child;
...
{
    public virtual Func<BuildContext, Animation<double>, Animation<double>, Widget> pageBuilder { get; private set; } = default!;
    public virtual Func<BuildContext, Animation<double>, Animation<double>, Widget, Widget> transitionsBuilder { get; private set; } = default!;
    ...
    public PageRouteBuilder(RouteSettings? settings = null, bool? requestFocus = null, Func<BuildContext, Animation<double>, Animation<double>, Widget> pageBuilder = default!, Func<BuildContext, Animation<double>, Animation<double>, Widget, Widget> transitionsBuilder = default!, Duration? transitionDuration = null, Duration? reverseTransitionDuration = null, bool opaque = true, bool barrierDismissible = false, Color? barrierColor = null, string? barrierLabel = null, bool maintainState = true, bool fullscreenDialog = false, bool allowSnapshotting = true) : base(settings: settings, requestFocus: requestFocus, fullscreenDialog: fullscreenDialog, allowSnapshotting: allowSnapshotting)
    {
        Func<BuildContext, Animation<double>, Animation<double>, Widget, Widget> __transitionsBuilder = transitionsBuilder ?? PagesLibrary._defaultTransitionsBuilder;
