...
public class SystemContextMenu : StatefulWidget
{
    ...
    public SystemContextMenu(
        Key? key = null,
        Rect anchor = default!,
        List<IOSSystemContextMenuItem> items = default!,
    ...
    public static SystemContextMenu CreateEditableText(
        Key? key = null,
        EditableTextState editableTextState = default!,
        List<IOSSystemContextMenuItem>? items = null
    )
    {
        var (startGlyphHeight, endGlyphHeight) = editableTextState.getGlyphHeights();
        return new SystemContextMenu(
            key: key,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _SystemContextMenuState__system_context_menu()
        );
}

internal class _SystemContextMenuState__system_context_menu : State<SystemContextMenu>
{
    internal virtual SystemContextMenuController _systemContextMenuController
    {
        get;
        private set;
    } = default!;
    ...
    {
        base.initState();
        _systemContextMenuController = new SystemContextMenuController(onSystemHide: () =>
            widget.onSystemHide?.Invoke()
        );
    }
    ...
    public override Widget build(BuildContext context)
    {
        ...
        if (Enumerable.Any(widget.items))
        {
            ...
            List<IOSSystemContextMenuItemData> itemDatas = widget
                .items.map((item) => item.getData(localizations))
                .ToList()
                .ToList();
...
public abstract class IOSSystemContextMenuItem
{
    ...
    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(title?.GetHashCode() ?? 0);
...
public class IOSSystemContextMenuItemSelectAll : IOSSystemContextMenuItem
{
    ...
    public override IOSSystemContextMenuItemDataSelectAll getData(
...
public class IOSSystemContextMenuItemSearchWeb : IOSSystemContextMenuItem, Diagnosticable
{
    ...
    public override IOSSystemContextMenuItemDataSearchWeb getData(
        WidgetsLocalizations localizations
    )
    {
...
public class IOSSystemContextMenuItemCustom : IOSSystemContextMenuItem, Diagnosticable
{
    ...
    public override IOSSystemContextMenuItemData getData(WidgetsLocalizations localizations)
    {
        return new IOSSystemContextMenuItemDataCustom(
    ...
    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(
            FoundationRuntimePorts.ObjectHash(title, onPressed)
        );
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is IOSSystemContextMenuItemCustom)
            && (__other.title == title)
