...
{
    public static AnimationStyle noAnimation = new AnimationStyle(
    ...
    public virtual AnimationStyle copyWith(
        Curve? curve = null,
        Duration? duration = null,
        Curve? reverseCurve = null,
        Duration? reverseDuration = null
    ...
    public static AnimationStyle? lerp(AnimationStyle? a, AnimationStyle? b, double t)
    {
        ...
        return new AnimationStyle(
            curve: _lerp(
                ...
                b?.curve,
                t,
                (arg0, arg1, arg2) => new _LerpedCurve__animation_style(arg0, arg1, arg2)
            ),
            duration: DartRuntimePrimitives.LerpNullable(
                a?.duration,
                b?.duration,
                t,
                _lerpDuration
            ...
            reverseDuration: DartRuntimePrimitives.LerpNullable(
                a?.reverseDuration,
                b?.reverseDuration,
                t,
                _lerpDuration
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is AnimationStyle)
            && Equals(__other.curve, curve)
            && Equals(__other.duration, duration)
            && Equals(__other.reverseCurve, reverseCurve)
            && Equals(__other.reverseDuration, reverseDuration);
    }

    public override int GetHashCode() =>
        FoundationRuntimePorts.ObjectHash(curve, duration, reverseCurve, reverseDuration);
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DiagnosticsProperty<Curve>("reverseCurve", reverseCurve, defaultValue: null)
        );
        properties.add(
...
internal class _LerpedCurve__animation_style : Curve
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is _LerpedCurve__animation_style)
