...
{
    internal static async ValueTask PlayAsync(
        SystemSoundKind kind,
    ...
    )
    {
        ...
        await MainThread.InvokeOnMainThreadAsync(() =>
        {
            ...
            {
                Platform.CurrentActivity?.Window?.DecorView?.PlaySoundEffect(
                    Android.Views.SoundEffects.Click
                );
            }
#else
