...
{
    internal static PlatformEffectSupport Support { get; } = new(true, 1, 16, false,
    ...
    internal double AppliedIntensity => _animator is { } animator ? (double)animator.FractionComplete : 0;
    ...
    internal void SetSigma(double sigma)
    {
        ...
        if (_intensity == intensity && (_animator is not null || intensity == 0)) return;
    ...
    private void Reapply()
    {
        ...
        try
        {
            ...
            _animator = new UIViewPropertyAnimator(1, UIViewAnimationCurve.Linear, () => Effect = _blur)
    ...
    {
        if (_animator is not { } animator) return;
        _animator = null;
    ...
    public override void LayoutSubviews()
    {
        ...
        if (Bounds != _appliedBounds) Reapply();
    }
...
#pragma warning restore CA1422
    public override string ToString() => FormattableString.Invariant($"{base.ToString()} BlurIntensity={AppliedIntensity}");
