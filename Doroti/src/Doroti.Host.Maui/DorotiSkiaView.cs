...
{
    public static readonly BindableProperty HasRenderLoopProperty = BindableProperty.Create(
        nameof(HasRenderLoop),
        typeof(bool),
        typeof(DorotiSkiaView),
        false
    );
    ...
    public static readonly BindableProperty IgnorePixelScalingProperty = BindableProperty.Create(
    ...
    void ISKGLView.OnPaintSurface(SKPaintGLSurfaceEventArgs args) =>
    ...
    protected override void OnPropertyChanged(string? propertyName = null)
    {
        ...
        {
            Handler?.UpdateValue(nameof(HasRenderLoop));
        }
    }
}
#endif
