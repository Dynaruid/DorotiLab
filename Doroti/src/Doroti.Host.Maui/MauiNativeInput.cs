...
internal static class MauiNativeInput
{
    ...
    private static long Logical(string key, long physical)
    {
        ...
        return key switch
        {
            ...
            "PageUp" => 0x100000308,
            "ShiftLeft" => 0x200000100, "ShiftRight" => 0x200000101,
            "ControlLeft" => 0x200000102, "ControlRight" => 0x200000103,
            "AltLeft" => 0x200000104, "AltRight" => 0x200000105,
            "MetaLeft" => 0x200000106, "MetaRight" => 0x200000107,
            _ => physical switch
            {
                0x70028 => 0x10000000d, 0x70029 => 0x10000001b,
                0x7002a => 0x100000008, 0x7002b => 0x100000009,
                0x7004c => 0x10000007f, 0x7004f => 0x100000303,
                0x70050 => 0x100000302, 0x70051 => 0x100000301,
                0x70052 => 0x100000304,
                0x700e0 => 0x200000102, 0x700e1 => 0x200000100,
                0x700e2 => 0x200000104, 0x700e3 => 0x200000106,
                0x700e4 => 0x200000103, 0x700e5 => 0x200000101,
                0x700e6 => 0x200000105, 0x700e7 => 0x200000107,
    ...
    private sealed class NativeKeyboardSubscription : IDisposable
    {
        ...
        private static string KeyName(Windows.System.VirtualKey key)
        {
            ...
            return key switch
            {
                Windows.System.VirtualKey.Enter => "Enter", Windows.System.VirtualKey.Escape => "Escape",
                Windows.System.VirtualKey.Back => "Backspace", Windows.System.VirtualKey.Tab => "Tab",
                Windows.System.VirtualKey.Space => " ", Windows.System.VirtualKey.Delete => "Delete",
                Windows.System.VirtualKey.Home => "Home", Windows.System.VirtualKey.End => "End",
                Windows.System.VirtualKey.PageUp => "PageUp", Windows.System.VirtualKey.PageDown => "PageDown",
                Windows.System.VirtualKey.Left => "ArrowLeft", Windows.System.VirtualKey.Right => "ArrowRight",
                Windows.System.VirtualKey.Up => "ArrowUp", Windows.System.VirtualKey.Down => "ArrowDown",
                Windows.System.VirtualKey.Control => "ControlLeft", Windows.System.VirtualKey.Shift => "ShiftLeft",
                Windows.System.VirtualKey.Menu => "AltLeft", Windows.System.VirtualKey.LeftWindows => "MetaLeft",
