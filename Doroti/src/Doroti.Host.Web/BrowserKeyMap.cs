...
internal static class BrowserKeyMap
{
    ...
    private static readonly IReadOnlyDictionary<string, long> PhysicalKeys = new Dictionary<
        string,
        long
    >(StringComparer.Ordinal)
    {
        ["Enter"] = HidPlane + 0x28,
        ["Escape"] = HidPlane + 0x29,
        ["Backspace"] = HidPlane + 0x2a,
        ["Tab"] = HidPlane + 0x2b,
        ["Space"] = HidPlane + 0x2c,
        ["Minus"] = HidPlane + 0x2d,
        ["Equal"] = HidPlane + 0x2e,
        ["BracketLeft"] = HidPlane + 0x2f,
        ["BracketRight"] = HidPlane + 0x30,
        ["Backslash"] = HidPlane + 0x31,
        ["Semicolon"] = HidPlane + 0x33,
        ["Quote"] = HidPlane + 0x34,
        ["Backquote"] = HidPlane + 0x35,
        ["Comma"] = HidPlane + 0x36,
        ["Period"] = HidPlane + 0x37,
        ["Slash"] = HidPlane + 0x38,
        ["CapsLock"] = HidPlane + 0x39,
        ["PrintScreen"] = HidPlane + 0x46,
        ["ScrollLock"] = HidPlane + 0x47,
        ["Pause"] = HidPlane + 0x48,
        ["Insert"] = HidPlane + 0x49,
        ["Home"] = HidPlane + 0x4a,
        ["PageUp"] = HidPlane + 0x4b,
        ["Delete"] = HidPlane + 0x4c,
        ["End"] = HidPlane + 0x4d,
        ["PageDown"] = HidPlane + 0x4e,
        ["ArrowRight"] = HidPlane + 0x4f,
        ["ArrowLeft"] = HidPlane + 0x50,
        ["ArrowDown"] = HidPlane + 0x51,
        ["ArrowUp"] = HidPlane + 0x52,
        ["NumLock"] = HidPlane + 0x53,
        ["NumpadDivide"] = HidPlane + 0x54,
        ["NumpadMultiply"] = HidPlane + 0x55,
        ["NumpadSubtract"] = HidPlane + 0x56,
        ["NumpadAdd"] = HidPlane + 0x57,
        ["NumpadEnter"] = HidPlane + 0x58,
        ["NumpadDecimal"] = HidPlane + 0x63,
        ["ControlLeft"] = HidPlane + 0xe0,
        ["ShiftLeft"] = HidPlane + 0xe1,
        ["AltLeft"] = HidPlane + 0xe2,
        ["MetaLeft"] = HidPlane + 0xe3,
        ["ControlRight"] = HidPlane + 0xe4,
        ["ShiftRight"] = HidPlane + 0xe5,
        ["AltRight"] = HidPlane + 0xe6,
        ["MetaRight"] = HidPlane + 0xe7,
    };

    private static readonly IReadOnlyDictionary<string, long> LogicalKeys = new Dictionary<
        string,
        long
    >(StringComparer.Ordinal)
    {
    ...
    internal static long Physical(string code)
    {
        ...
        if (
            code.Length is 2 or 3
            && code[0] == 'F'
            && int.TryParse(code.AsSpan(1), out var function)
    ...
    {
        if (LogicalKeys.TryGetValue(code, out var logical))
        {
            return logical;
        }
