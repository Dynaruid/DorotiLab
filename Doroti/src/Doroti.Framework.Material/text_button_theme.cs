...
public class TextButtonThemeData : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return ((__other is TextButtonThemeData) && (Equals(((TextButtonThemeData)((TextButtonThemeData)__other)).style, this.style)));
    }
...
public class TextButtonTheme : global::Doroti.Framework.Widgets.InheritedTheme
{
    ...
    {
        TextButtonTheme? buttonTheme = ((TextButtonTheme?)context.dependOnInheritedWidgetOfExactType<TextButtonTheme>());
    ...
    {
        return ((global::Doroti.Framework.Widgets.Widget)new TextButtonTheme(data: this.data, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override bool updateShouldNotify(global::Doroti.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>((!Equals(this.data, ((TextButtonTheme)oldWidget).data)));
}
