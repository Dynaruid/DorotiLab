...
public class NavigationDrawer : StatelessWidget
{
    ...
    public NavigationDrawer(
        ...
        EdgeInsetsGeometry tilePadding = default!
    )
        : base(key: key)
    {
        EdgeInsetsGeometry __tilePadding =
            tilePadding ?? EdgeInsets.CreateSymmetric(horizontal: 12.0);
    ...
    {
        long totalNumberOfDestinationsLocal = checked(
            children.OfType<NavigationDrawerDestination>().ToList().Count
        );
        var destinationIndex = 0L;
        Widget wrapChild(Widget child, long index)
        {
            return new _SelectableAnimatedBuilder__navigation_drawer(
                isSelected: selectedIndex == index,
                duration: new Duration(500_000L),
                builder: (_, animation) =>
                    new _NavigationDrawerDestinationInfo__navigation_drawer(
                        index: index,
                        totalNumberOfDestinations: totalNumberOfDestinationsLocal,
        ...
        var wrappedChildren = (
            (Func<List<Widget>>)(
                () =>
                {
                    var __collection6931 = new List<Widget>();
                    foreach (var childLocal in children)
                    {
                        if (childLocal is not NavigationDrawerDestination)
                        {
                            __collection6931.Add(
                        ...
                        else
                        {
                            __collection6931.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    wrapChild(
                                        (NavigationDrawerDestination)childLocal,
                                        destinationIndex++
                                    )
                                )
                            );
                ...
                child: new Column(
                    children: (
                        (Func<List<Widget>>)(
                            () =>
                            {
                                var __collection7592 = new List<Widget>();
                                var __collectionElement7614 = header;
                                if (__collectionElement7614 is { } __nonNullCollectionElement7614)
                                {
                                    __collection7592.Add(
                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                            __nonNullCollectionElement7614
                                        )
                                    );
                                }
                                __collection7592.Add(
                                    DartRuntimePrimitives.ConvertValue<Widget>(
                                        new Expanded(
                                            child: new Material(
                                                ...
                                                child: new ListView(children: wrappedChildren)
                                            )
                                        )
                                    )
                                );
                                var __collectionElement7829 = footer;
                                if (__collectionElement7829 is { } __nonNullCollectionElement7829)
                                {
                                    __collection7592.Add(
                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                            __nonNullCollectionElement7829
                                        )
                                    );
                                }
...
public class NavigationDrawerDestination : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        NavigationDrawerThemeData navigationDrawerTheme = NavigationDrawerTheme.of(context);
        NavigationDrawerThemeData defaults = new _NavigationDrawerDefaultsM3__navigation_drawer(
            context
        );
        Animation<double> animation = _NavigationDrawerDestinationInfo__navigation_drawer
            .of(context)
            .selectedAnimation;
        return new _NavigationDestinationBuilder__navigation_drawer(
            buildIcon: (context) =>
            {
...
internal class _NavigationDestinationBuilder__navigation_drawer : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        _NavigationDrawerDestinationInfo__navigation_drawer info =
            _NavigationDrawerDestinationInfo__navigation_drawer.of(context);
        NavigationDrawerThemeData navigationDrawerTheme = NavigationDrawerTheme.of(context);
        NavigationDrawerThemeData defaults = new _NavigationDrawerDefaultsM3__navigation_drawer(
            context
        );
        var inkWell = new InkWell(
            ...
            customBorder: (info.indicatorShape ?? navigationDrawerTheme.indicatorShape)
                ...
                children: new List<Widget>
                {
                    DartRuntimePrimitives.ConvertValue<Widget>(
                        new NavigationIndicator(
                            ...
                            color: (info.indicatorColor ?? navigationDrawerTheme.indicatorColor)
                                ?? defaults.indicatorColor!,
                            shape: (info.indicatorShape ?? navigationDrawerTheme.indicatorShape)
                                ?? defaults.indicatorShape!,
                            width: (
                    ...
                    DartRuntimePrimitives.ConvertValue<Widget>(
                        new Row(
                            children: new List<Widget>
                            {
                                DartRuntimePrimitives.ConvertValue<Widget>(new SizedBox(width: 16)),
                                DartRuntimePrimitives.ConvertValue<Widget>(buildIcon(context)),
                                DartRuntimePrimitives.ConvertValue<Widget>(new SizedBox(width: 12)),
                                DartRuntimePrimitives.ConvertValue<Widget>(buildLabel(context)),
                            }
                        )
                    ),
                }
        ...
        Widget destination = new Padding(
            padding: info.tilePadding,
            child: new _NavigationDestinationSemantics__navigation_drawer(
                child: new SizedBox(
...
internal class _NavigationDestinationSemantics__navigation_drawer : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        _NavigationDrawerDestinationInfo__navigation_drawer destinationInfo =
            _NavigationDrawerDestinationInfo__navigation_drawer.of(context);
        return new _StatusTransitionWidgetBuilder__navigation_drawer(
...
internal class _StatusTransitionWidgetBuilder__navigation_drawer : StatusTransitionWidget
{
    ...
    internal _StatusTransitionWidgetBuilder__navigation_drawer(
...
internal class _NavigationDrawerDestinationInfo__navigation_drawer : InheritedWidget
{
    ...
    {
        _NavigationDrawerDestinationInfo__navigation_drawer? result =
            context.dependOnInheritedWidgetOfExactType<_NavigationDrawerDestinationInfo__navigation_drawer>();
        DartRuntimePrimitives.Assert(
            () => result is not null,
            () =>
                (object?)"Navigation destinations need a _NavigationDrawerDestinationInfo parent, "
...
public class _SelectableAnimatedBuilder__navigation_drawer : StatefulWidget
{
    ...
    internal _SelectableAnimatedBuilder__navigation_drawer(
        bool isSelected,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _SelectableAnimatedBuilderState__navigation_drawer()
        );
}

public class _SelectableAnimatedBuilderState__navigation_drawer
    : State<_SelectableAnimatedBuilder__navigation_drawer>,
        SingleTickerProviderStateMixin<_SelectableAnimatedBuilder__navigation_drawer>
{
...
internal class _NavigationDrawerDefaultsM3__navigation_drawer : NavigationDrawerThemeData
{
    ...
    internal _NavigationDrawerDefaultsM3__navigation_drawer(BuildContext context)
        : base(
            elevation: 1.0,
            tileHeight: 56.0,
            indicatorShape: new StadiumBorder(),
            indicatorSize: new Size(336.0, 56.0)
        )
    {
