...
public static partial class Menu_anchorLibrary
{
    internal static Curve _kMenuPanelHeightReverseCurve = new _TweenCurve__menu_anchor(
        0.35,
        1,
        curve: new FlippedCurve(Easing.emphasizedAccelerate)
    );
}
...
public static partial class Menu_anchorLibrary
{
    internal static Curve _kMenuPanelOpacityReverseCurve = new FlippedCurve(
        new Interval(100L / 150L, 150L / 150L)
    );
}
...
public delegate Widget MenuAnchorChildBuilder(
...
internal class _MenuAnchorScope__menu_anchor : InheritedWidget
{
    ...
    internal _MenuAnchorScope__menu_anchor(
        _MenuAnchorState__menu_anchor state,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget)
    {
        ...
        DartRuntimePrimitives.Assert(
            () => Equals(__oldWidget.state, state),
...
public class MenuAnchor : StatefulWidget
{
    ...
    public MenuAnchor(
        ...
        Offset? alignmentOffset = default,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _MenuAnchorState__menu_anchor());
...
internal class _MenuAnchorState__menu_anchor
    : State<MenuAnchor>,
        SingleTickerProviderStateMixin<MenuAnchor>
{
    ...
    public virtual CurvedAnimation heightAnimation
    {
        get
        {
            ...
            {
                __late_heightAnimation = new CurvedAnimation(
                    parent: _animationController,
                    curve: Menu_anchorLibrary._kMenuPanelHeightForwardCurve,
                    reverseCurve: Menu_anchorLibrary._kMenuPanelHeightReverseCurve
                );
    ...
    public virtual CurvedAnimation opacityAnimation
    {
        get
        {
            ...
            {
                __late_opacityAnimation = new CurvedAnimation(
                    parent: _animationController,
                    curve: Menu_anchorLibrary._kMenuPanelOpacityForwardCurve,
                    reverseCurve: Menu_anchorLibrary._kMenuPanelOpacityReverseCurve
                );
    ...
    internal virtual List<CurvedAnimation> _cachedAnimations { get; set; } =
        new List<CurvedAnimation>();
    ...
    public virtual bool isSubmenu =>
        DartRuntimePrimitives.ConvertValue<bool>(MenuController.maybeOf(context) is not null);
    ...
    public override void didUpdateWidget(MenuAnchor oldWidget)
    {
        ...
        if (
            ...
            || (!Equals(widget.menuChildren, oldWidget.menuChildren))
        )
        {
            _resolveMenuItems();
        }
    ...
    {
        DartRuntimePrimitives.Assert(() =>
            Menu_anchorLibrary._debugMenuInfo($"Disposing of {this}")
        );
        _menuChildren.Clear();
    ...
    internal virtual void _resolveMenuItems()
    {
        ...
        double reverseFinalItemOffset =
            1L
            - Menu_anchorLibrary._kMenuItemRelativeFadeOutDuration
            - Menu_anchorLibrary._kMenuItemRelativeFadeOutDelay;
        ...
        {
            var forwardCurve = new Interval(
                forwardProgress,
                forwardProgress + Menu_anchorLibrary._kMenuItemRelativeFadeInDuration
            );
            var reverseCurveLocal = new Interval(
                reverseProgress,
                reverseProgress + Menu_anchorLibrary._kMenuItemRelativeFadeOutDuration
            );
            var animationLocal = new CurvedAnimation(
                parent: _animationController,
                curve: forwardCurve,
    ...
    {
        Widget childLocal = new _MenuAnchorScope__menu_anchor(
            state: this,
        ...
        return new ExcludeSemantics(
            ...
            child: new IgnorePointer(
                ...
                child: new ExcludeFocus(
                    excluding: isClosingOrClosed,
                    child: new _Submenu__menu_anchor(
                        ...
                        reservedPadding: widget.reservedPadding
                            ?? EdgeInsets.CreateAll(Menu_anchorLibrary._kMenuViewPadding)
                    )
                )
            )
        );
    ...
    internal virtual void _focusButton()
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            Menu_anchorLibrary._debugMenuInfo($"Requesting focus for {widget.childFocusNode}")
        );
...
public class MenuBar : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        return new _MenuBarAnchor__menu_anchor(
    ...
    public override List<DiagnosticsNode> debugDescribeChildren()
    {
        return (
            (Func<List<DiagnosticsNode>>)(
                () =>
                {
                    var __collection33328 = new List<DiagnosticsNode>();
                    __collection33328.AddRange(
                        children.map((item) => ((Diagnosticable)item).toDiagnosticsNode())
                    );
                    return __collection33328;
                }
            )
        )();
        throw new InvalidOperationException("Dart control flow completed without a value.");
...
public class MenuItemButton : StatefulWidget
{
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _MenuItemButtonState__menu_anchor());
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new EnumProperty<Clip>("clipBehavior", clipBehavior, defaultValue: Clip.none)
        );
        properties.add(
            new DiagnosticsProperty<WidgetStatesController?>(
                "statesController",
                statesController,
                defaultValue: null
            )
...
internal class _MenuItemButtonState__menu_anchor : State<MenuItemButton>
{
    ...
    internal virtual _MenuAnchorState__menu_anchor? _anchor =>
        _MenuAnchorState__menu_anchor._maybeOf(context);
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Widget childLocal = new TextButton(
            ...
            clipBehavior: widget.clipBehavior,
            isSemanticButton: Foundation.ConstantsLibrary.kIsWeb ? true : null,
            child: new _MenuItemLabel__menu_anchor(
    ...
    internal virtual void _handlePointerHover(Gestures.PointerHoverEvent @event)
    {
        if (!_isHovered)
        {
            ...
            {
                DartRuntimePrimitives.Assert(() =>
                    Menu_anchorLibrary._debugMenuInfo(
                        $"Requesting focus for {_focusNode} from hover"
                    )
                );
    ...
    {
        DartRuntimePrimitives.Assert(() =>
            Menu_anchorLibrary._debugMenuInfo($"Selected {widget.child} menu")
        );
...
public class SubmenuButton : StatefulWidget
{
    ...
    public SubmenuButton(
        ...
        bool useRootOverlay = false,
        Duration hoverOpenDelay = default,
        bool animated = false,
        AnimationStatusListener? onAnimationStatusChanged = null,
        List<Widget> menuChildren = default!,
        Widget? child = default!
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _SubmenuButtonState__menu_anchor());
    ...
    public override List<DiagnosticsNode> debugDescribeChildren()
    {
        return (
            (Func<List<DiagnosticsNode>>)(
                () =>
                {
                    var __collection71845 = new List<DiagnosticsNode>();
                    __collection71845.AddRange(
                        menuChildren.map(
                            (child) =>
                            {
...
internal class _SubmenuButtonState__menu_anchor : State<SubmenuButton>
{
    ...
    public virtual DartMap<Type, dynamic> actions
    {
        get
        {
            ...
            {
                __late_actions = new DartMap<Type, dynamic>
                {
                    [typeof(DirectionalFocusIntent)] =
                        new _SubmenuDirectionalFocusAction__menu_anchor(submenu: this),
                };
    ...
    internal virtual MenuController? _internalMenuController { get; set; } = default;
    internal virtual FocusNode? _internalFocusNode { get; set; } = default;
    internal virtual GlobalKey<_MenuAnchorState__menu_anchor> _anchorKey { get; private set; } =
        GlobalKey<_MenuAnchorState__menu_anchor>.Create();
    internal virtual bool _isHovered { get; set; } = false;
    ...
    internal virtual _MenuAnchorState__menu_anchor? _parent =>
        _MenuAnchorState__menu_anchor._maybeOf(context);
    internal virtual _MenuAnchorState__menu_anchor? _anchorState => _anchorKey.currentState;
    internal virtual FocusNode _buttonFocusNode =>
        DartRuntimePrimitives.ConvertValue<FocusNode>(widget.focusNode ?? _internalFocusNode!);
    ...
    public override Widget build(BuildContext context)
    {
        ...
        menuPaddingOffset += (orientation, Directionality.of(context)) switch
        {
            (Axis.horizontal, TextDirection.rtl) => new Offset(menuPadding.right, 0),
            (Axis.horizontal, TextDirection.ltr) => new Offset(-menuPadding.left, 0),
        ...
        var states = (
            (Func<HashSet<WidgetState>>)(
                () =>
                {
                    var __collection75817 = new HashSet<WidgetState>();
                    if (!_enabled)
                    {
                        __collection75817.Add(WidgetState.disabled);
                    }
                    if (_isHovered)
                    {
                        __collection75817.Add(WidgetState.hovered);
                    }
                    if (_buttonFocusNode.hasFocus)
                    {
                        __collection75817.Add(WidgetState.focused);
                    }
                    return __collection75817;
                }
            )
        )();
        Widget submenuIconLocal =
            (
                widget.submenuIcon?.resolve(states)
                ?? (MenuTheme.of(context).submenuIcon?.resolve(states))
            ) ?? new Icon(Icons.arrow_right, size: Menu_anchorLibrary._kDefaultSubmenuIconSize);
        return new Actions(
            actions: actions,
                ...
                builder: (context, controller, child) =>
                {
                    ...
                    void handlePointerHover(Gestures.PointerHoverEvent @event)
                    {
                        if (!_isHovered)
                        {
                            _isHovered = true;
                            widget.onHover?.Invoke(true);
                            _MenuAnchorState__menu_anchor root = _MenuAnchorState__menu_anchor
                                ._maybeOf(context)!
                                ._root;
                            if (
                                Equals(_parent?._orientation, Axis.horizontal)
                        ...
                        child: new Widgets.Semantics(
                            ...
                            child: new TextButton(
                                ...
                                child: new _MenuItemLabel__menu_anchor(
                                    ...
                                    trailingIcon: widget.trailingIcon,
                                    hasSubmenu: true,
                                    showDecoration: Equals(
                                        _parent?._orientation ?? Axis.horizontal,
                                        Axis.vertical
                                    ),
                                    submenuIcon: submenuIconLocal,
                                    child: child
                                )
                            )
                        )
                    ...
                    {
                        return new MenuAcceleratorCallbackBinding(
    ...
    {
        WidgetStateProperty<EdgeInsetsGeometry?> insets =
            (widget.menuStyle?.padding ?? MenuTheme.of(context).style?.padding)
            ?? new _MenuDefaultsM3__menu_anchor(context).padding!;
        return insets
    ...
    internal virtual void _handleFocusChange()
    {
        ...
        {
            if (
                !_anchorState!._menuScopeNode.hasFocus
                && AnimationStatusMembers.isForwardOrCompleted(_animationStatus)
            )
            {
    ...
    internal virtual bool _debugValidateHoverOpenDelay()
    {
        if (
            Equals(_parent?._orientation, Axis.horizontal)
            && (widget.hoverOpenDelay > Duration.zero)
        )
        {
            throw DartRuntimePrimitives.AsException(
                new FlutterError(
...
internal class _SubmenuDirectionalFocusAction__menu_anchor : DirectionalFocusAction
{
    ...
    public override object? invoke(DirectionalFocusIntent intent, BuildContext? context = null)
    {
        ...
        switch ((_orientation, directionality, intent.direction))
        {
            ...
            {
                DartRuntimePrimitives.Assert(() =>
                    Menu_anchorLibrary._debugMenuInfo($"Moving to previous {typeof(MenuBar)} item")
                );
                DartRuntimePrimitives.Ignore(
                    (
                        (Func<FocusNode>)(
            ...
            {
                DartRuntimePrimitives.Assert(() =>
                    Menu_anchorLibrary._debugMenuInfo($"Moving to next {typeof(MenuBar)} item")
                );
                DartRuntimePrimitives.Ignore(
                    (
                        (Func<FocusNode>)(
            ...
            case (Axis.vertical, TextDirection.rtl, TraversalDirection.right):
            {
                if (Equals((_parent?._parent)?._orientation, Axis.horizontal))
                {
                    ...
                    {
                        DartRuntimePrimitives.Assert(() =>
                            Menu_anchorLibrary._debugMenuInfo("Exiting submenu")
                        );
            ...
            {
                DartRuntimePrimitives.Assert(() =>
                    Menu_anchorLibrary._debugMenuInfo("Entering submenu")
                );
...
internal class _LocalizedShortcutLabeler__menu_anchor
{
    ...
    internal static DartMap<LogicalKeyboardKey, string> _shortcutGraphicEquivalents = new DartMap<
        LogicalKeyboardKey,
        string
    >
    {
    ...
    internal virtual DartMap<
        ...
        DartMap<LogicalKeyboardKey, string>
    > _cachedShortcutKeys { get; private set; } =
        new DartMap<MaterialLocalizations, DartMap<LogicalKeyboardKey, string>>();

    internal _LocalizedShortcutLabeler__menu_anchor() { }

    public static _LocalizedShortcutLabeler__menu_anchor instance
    {
        get { return _instance ??= new _LocalizedShortcutLabeler__menu_anchor(); }
    }

    public virtual string getShortcutLabel(
        ...
        if (serialized.trigger is not null)
        {
            ...
            var modifiers = (
                (Func<List<string>>)(
                    () =>
                    {
                        var __collection91801 = new List<string>();
                        if (Menu_anchorLibrary._usesSymbolicModifiers)
                        {
                            __collection91801.AddRange(
                                (
                                    (Func<List<string>>)(
                                        () =>
                                        {
                                ...
                                (
                                    (Func<List<string>>)(
                                        () =>
                                        {
                                            ...
                                            return __collection92331;
                                        }
                                    )
                                )()
                            );
                        }
                        return __collection91801;
                    }
                )
            )();
            ...
            else
            {
                ...
                if (
                    (shortcutTrigger is null)
                    && ((logicalKeyId & LogicalKeyboardKey.planeMask) == 0L)
                )
                {
                    shortcutTrigger = char.ConvertFromUtf32(
                            checked((int)(logicalKeyId & LogicalKeyboardKey.valueMask))
                        )
                        .toUpperCase();
                }
            ...
            return string.Join(
                ...
                (
                    (Func<List<string>>)(
                        () =>
                        {
                            var __collection93661 = new List<string>();
                            __collection93661.AddRange(modifiers);
                            if ((shortcutTrigger is not null) && (shortcutTrigger.Length != 0))
                            {
                                __collection93661.Add(shortcutTrigger);
                            }
                            return __collection93661;
                        }
                    )
                )()
            );
            ...
            if (serialized.character is not null)
            {
                var modifiersLocal = (
                    (Func<List<string>>)(
                        () =>
                        {
                            var __collection93876 = new List<string>();
                            if (Menu_anchorLibrary._usesSymbolicModifiers)
                            {
                                __collection93876.AddRange(
                                    (
                                        (Func<List<string>>)(
                                            () =>
                                            {
                                    ...
                                    (
                                        (Func<List<string>>)(
                                            () =>
                                            {
                                                ...
                                                return __collection94377;
                                            }
                                        )
                                    )()
                                );
                            }
                            return __collection93876;
                        }
                    )
                )();
                return string.Join(
                    ...
                    (
                        (Func<List<string>>)(
                            () =>
                            {
                                var __collection94756 = new List<string>();
                                __collection94756.AddRange(modifiersLocal);
                                __collection94756.Add(serialized.character!);
                                return __collection94756;
                            }
                        )
                    )()
                );
    ...
    {
        _cachedShortcutKeys.putIfAbsent(
            localizations,
            () =>
                new DartMap<LogicalKeyboardKey, string>
                {
    ...
    )
    {
        DartRuntimePrimitives.Assert(
            ...
            () => (object?)$"{modifier.keyLabel} is not a modifier key"
        );
        if (
            Equals(modifier, LogicalKeyboardKey.meta)
            || Equals(modifier, LogicalKeyboardKey.metaLeft)
            || Equals(modifier, LogicalKeyboardKey.metaRight)
        )
        {
        ...
        if (
            Equals(modifier, LogicalKeyboardKey.alt)
            || Equals(modifier, LogicalKeyboardKey.altLeft)
            || Equals(modifier, LogicalKeyboardKey.altRight)
        )
        {
            switch (PlatformLibrary.defaultTargetPlatform)
            {
        ...
        if (
            Equals(modifier, LogicalKeyboardKey.control)
            || Equals(modifier, LogicalKeyboardKey.controlLeft)
            || Equals(modifier, LogicalKeyboardKey.controlRight)
        )
        {
            switch (PlatformLibrary.defaultTargetPlatform)
            {
        ...
        if (
            Equals(modifier, LogicalKeyboardKey.shift)
            || Equals(modifier, LogicalKeyboardKey.shiftLeft)
            || Equals(modifier, LogicalKeyboardKey.shiftRight)
        )
        {
            switch (PlatformLibrary.defaultTargetPlatform)
            {
...
{
    internal _MenuBarAnchor__menu_anchor(
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _MenuBarAnchorState__menu_anchor());
}
...
internal class _MenuBarAnchorState__menu_anchor : _MenuAnchorState__menu_anchor
{
    ...
    public virtual DartMap<Type, dynamic> actions
    {
        get
        {
            if (!__late_actions_initialized)
            {
                __late_actions = new DartMap<Type, dynamic>
                {
                    [typeof(DismissIntent)] = new DismissMenuAction(controller: _menuController),
                };
                __late_actions_initialized = true;
            }
            return __late_actions;
    ...
    public override Widget build(BuildContext context)
    {
        var childLocal = new Actions(
            actions: actions,
            child: new Shortcuts(
                shortcuts: Menu_anchorLibrary._kMenuTraversalShortcuts,
                child: new _MenuPanel__menu_anchor(
                    menuStyle: widget.style,
                    clipBehavior: widget.clipBehavior,
        ...
        return new _MenuAnchorScope__menu_anchor(
            state: this,
            animationStatus: _animationController.status,
...
public class MenuAcceleratorLabel : StatefulWidget
{
    ...
    public virtual Func<BuildContext, string, long, Widget> builder { get; private set; } =
        default!;

    public MenuAcceleratorLabel(
        string label,
        Key? key = null,
        Func<BuildContext, string, long, Widget> builder = default!
    )
        : base(key: key)
    {
    ...
    public static Widget defaultLabelBuilder(BuildContext context, string label, long index)
    {
        ...
        return new RichText(text: new TextSpan(children: (
                    (Func<List<TextSpan>>)(
                        () =>
                        {
                            var __collection113074 = new List<TextSpan>();
                            if (index > 0L)
                            {
                                __collection113074.Add(
                                    new TextSpan(
                                        text: charactersLocal.GetRange(0L, index).ToString(),
                                        style: defaultStyle
                                    )
                                );
                            }
                            __collection113074.Add(
                                new TextSpan(
                                    text: charactersLocal.skip(index).take(1L).ToString(),
                                    style: defaultStyle.copyWith(
                                        decoration: TextDecoration.underline
                                    )
                                )
                            );
                            if (index < (charactersLocal.Count - 1L))
                            {
                                __collection113074.Add(
                                    new TextSpan(
                                        text: charactersLocal.GetRange(index + 1L).ToString(),
                                        style: defaultStyle
                                    )
                                );
                            }
                            return __collection113074;
                        }
                    )
    ...
    public static string stripAcceleratorMarkers(string label, Action<long>? setIndex = null)
    {
        ...
        for (var i = 0L; i < labelChars.Count; i += 1L)
        {
            ...
            if (
                (acceleratorIndex == -1L)
                && (!Equals(acceleratorCharacter, ampersand))
                && (acceleratorCharacter.ToString()?.Trim().Length != 0)
            )
            {
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _MenuAcceleratorLabelState__menu_anchor());
...
internal class _MenuAcceleratorLabelState__menu_anchor : State<MenuAcceleratorLabel>
{
    ...
    {
        DartRuntimePrimitives.Assert(() =>
            Menu_anchorLibrary._platformSupportsAccelerators || (_shortcutRegistryEntry is null)
        );
        _displayLabel = "";
        if (Menu_anchorLibrary._platformSupportsAccelerators)
        {
    ...
    internal virtual void _updateAcceleratorShortcut()
    {
        ...
        if (
            _showAccelerators
            && (_acceleratorIndex != -1L)
            && (_binding?.onInvoke is not null)
            && (!_binding!.hasSubmenu || !(_menuController?.isOpen ?? false))
        )
        {
            string acceleratorCharacter = _displayLabel[(int)_acceleratorIndex]
                .ToString()
                .toLowerCase();
...
internal class _MenuItemLabel__menu_anchor : StatelessWidget
{
    ...
    internal _MenuItemLabel__menu_anchor(
        bool hasSubmenu,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        double horizontalPadding = Math.Max(
            Menu_anchorLibrary._kLabelItemMinSpacing,
            Menu_anchorLibrary._kLabelItemDefaultSpacing + (density.horizontal * 2L)
        );
        Widget leadings = default!;
        if (Equals(overflowAxis, Axis.vertical))
        {
            leadings = DartRuntimePrimitives.ConvertValue<Widget>(
                new Expanded(
                    child: new ClipRect(
                        child: new Row(
                            ...
                            children: (
                                (Func<List<Widget>>)(
                                    () =>
                                    {
                                        var __collection121981 = new List<Widget>();
                                        var __collectionElement122005 = leadingIcon;
                                        if (
                                            __collectionElement122005 is
                                            { } __nonNullCollectionElement122005
                                        )
                                        {
                                            __collection121981.Add(
                                            ...
                                            __collection121981.Add(
                                                DartRuntimePrimitives.ConvertValue<Widget>(
                                                    new Expanded(
                                                        child: new ClipRect(
                                                            child: new Padding(
                                                                padding: (leadingIcon is not null)
                                                                    ? global::Doroti.Framework.Painting.EdgeInsetsDirectional.CreateOnly(
                ...
                new Row(
                    ...
                    children: (
                        (Func<List<Widget>>)(
                            () =>
                            {
                                var __collection122566 = new List<Widget>();
                                var __collectionElement122586 = leadingIcon;
                                if (
                                    __collectionElement122586 is
                                    { } __nonNullCollectionElement122586
                                )
                                {
                                    __collection122566.Add(
                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                            __nonNullCollectionElement122586
                                        )
                                    );
        ...
        Widget menuItemLabel = new Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: (
                (Func<List<Widget>>)(
                    () =>
                    {
                        var __collection122978 = new List<Widget>();
                        __collection122978.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(leadings)
                        );
                            ...
                            __collection122978.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Padding(
                                        ...
                                        child: new Text(
                                            _LocalizedShortcutLabeler__menu_anchor.instance.getShortcutLabel(
                                                shortcut!,
        ...
        {
            menuItemLabel = DartRuntimePrimitives.ConvertValue<Widget>(
...
internal class _MenuLayout__menu_anchor : SingleChildLayoutDelegate
{
    ...
    {
        Rect overlayRect = mediaQueryData.padding.deflateRect(
    ...
    internal virtual Offset _positionChild(Size childSize, Rect overlayRect)
    {
        ...
        if (menuPosition is null)
        {
            ...
            if (alignment is AlignmentDirectional)
            {
                ...
                directionalOffset = textDirection switch
                {
    ...
    public override bool shouldRelayout(SingleChildLayoutDelegate oldDelegate)
    {
        ...
        return (!Equals(anchorRect, __oldDelegate.anchorRect))
            ...
            || (!Equals(alignment, __oldDelegate.alignment))
            || (!Equals(alignmentOffset, __oldDelegate.alignmentOffset))
            || (!Equals(menuPosition, __oldDelegate.menuPosition))
            || (!Equals(menuPadding, __oldDelegate.menuPadding))
            || (!Equals(orientation, __oldDelegate.orientation))
            || (!Equals(parentOrientation, __oldDelegate.parentOrientation))
...
internal class _MenuPanel__menu_anchor : StatefulWidget
{
    ...
    internal _MenuPanel__menu_anchor(
        MenuStyle? menuStyle,
        Clip clipBehavior = Clip.none,
        Axis orientation = default!,
        bool crossAxisUnconstrained = true,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _MenuPanelState__menu_anchor());
}
...
internal class _MenuPanelState__menu_anchor : State<_MenuPanel__menu_anchor>
{
    ...
    public override Widget build(BuildContext context)
    {
        (MenuStyle? themeStyle, MenuStyle defaultStyle) = widget.orientation switch
        {
            Axis.horizontal => (
                ...
                new _MenuBarDefaultsM3__menu_anchor(context)
            ),
            Axis.vertical => (
                MenuTheme.of(context).style,
                (MenuStyle)new _MenuDefaultsM3__menu_anchor(context)
            ),
        ...
        VisualDensity visualDensityLocal =
            effectiveValue((style) => style?.visualDensity) ?? VisualDensity.standard;
        ...
        EdgeInsetsGeometry resolvedPadding = paddingLocal
            .add(EdgeInsets.CreateSymmetric(horizontal: dxLocal))
            .clamp(EdgeInsets.zero, EdgeInsetsGeometry.infinity);
        BoxConstraints effectiveConstraintsLocal = visualDensityLocal.effectiveConstraints(
            new BoxConstraints(
                minWidth: minimumSizeLocal?.width ?? 0,
                minHeight: minimumSizeLocal?.height ?? 0,
                maxWidth: maximumSizeLocal?.width ?? double.PositiveInfinity,
                maxHeight: maximumSizeLocal?.height ?? double.PositiveInfinity
            )
        );
        ...
        bool displayScrollbar = _MenuAnchorState__menu_anchor._maybeAnimationStatusOf(
            context
        ) switch
        {
            AnimationStatus.completed => true,
            AnimationStatus.forward or AnimationStatus.reverse or AnimationStatus.dismissed =>
                false,
            null => false,
            _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard =>
                throw new InvalidOperationException("Non-exhaustive Dart switch value."),
        ...
        {
            menuPanel = DartRuntimePrimitives.ConvertValue<Widget>(
                new AnimatedBuilder(
        ...
        menuPanel = _intrinsicCrossSize(
            child: new Material(
                ...
                type: (backgroundColorLocal is null)
    ...
    {
        return widget.orientation switch
        {
            Axis.horizontal => DartRuntimePrimitives.ConvertValue<SingleChildRenderObjectWidget>(
                new IntrinsicHeight(child: child)
            ),
            Axis.vertical => DartRuntimePrimitives.ConvertValue<SingleChildRenderObjectWidget>(
...
internal class _Submenu__menu_anchor : StatelessWidget
{
    ...
    internal _Submenu__menu_anchor(
        _MenuAnchorState__menu_anchor anchor,
        LayerLink? layerLink,
        MenuStyle? menuStyle,
        ...
        bool crossAxisUnconstrained = true,
        List<Widget> menuChildren = default!,
        FocusScopeNode menuScopeNode = default!,
        Animation<double> fadeAnimation = default!,
        Animation<double> heightAnimation = default!,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        T? resolve<T>(Func<MenuStyle?, WidgetStateProperty<T>?> getProperty)
        {
            return effectiveValue(
                ...
                {
                    return (T?)
                        DartRuntimePrimitives.NullAware(
                            getProperty(style),
                            __target =>
                                __target.resolve(
                                    new HashSet<global::Doroti.Framework.Widgets.WidgetState>()
        ...
        double dxLocal = Math.Max(0, densityAdjustment.dx);
        EdgeInsetsGeometry resolvedPadding = paddingLocal
            .add(new EdgeInsets(dxLocal, 0, dxLocal, 0))
            .clamp(EdgeInsets.zero, EdgeInsetsGeometry.infinity);
        Rect anchorRectLocal =
            (layerLink is null)
                ? Rect.fromLTRB(
                    menuPosition.anchorRect.left + dxLocal,
                    menuPosition.anchorRect.top,
                    menuPosition.anchorRect.right,
                    menuPosition.anchorRect.bottom
                )
                : Rect.zero;
        Widget menuPanel = new TapRegion(
            ...
            child: new MouseRegion(
                ...
                child: new FocusScope(
                    ...
                    child: new Actions(
                        ...
                        {
                            [typeof(DismissIntent)] = new DismissMenuAction(
        ...
        Widget layout = new Theme(
            data: Theme.of(context).copyWith(visualDensity: visualDensityLocal),
            child: new ConstrainedBox(
                constraints: BoxConstraints.CreateLoose(menuPosition.overlaySize),
                child: new AnimatedBuilder(
                    ...
                    builder: (context, child) =>
                    {
                        ...
                        return new CustomSingleChildLayout(
                            @delegate: new _MenuLayout__menu_anchor(
...
internal class _MouseCursor__menu_anchor : WidgetStateMouseCursor
{
    ...
    public override MouseCursor resolve(HashSet<WidgetState> states) =>
        DartRuntimePrimitives.ConvertValue<MouseCursor>(resolveCallback(states) ?? uncontrolled);
...
{
    internal static RoundedRectangleBorder _defaultMenuBorder = new RoundedRectangleBorder(
    ...
    internal _MenuBarDefaultsM3__menu_anchor(BuildContext context)
        : base(
            elevation: new WidgetStatePropertyAll<double?>(3.0),
            shape: new WidgetStatePropertyAll<OutlinedBorder>(_defaultMenuBorder),
    ...
    {
        get { return new WidgetStatePropertyAll<Color>(_colors.surfaceContainer); }
    }
    ...
    public override WidgetStateProperty<EdgeInsetsGeometry?>? padding
    {
        get
        {
            return (WidgetStateProperty<EdgeInsetsGeometry?>?)
                new WidgetStatePropertyAll<EdgeInsetsGeometry>(
                    EdgeInsetsDirectional.CreateSymmetric(
                        horizontal: Menu_anchorLibrary._kTopLevelMenuHorizontalMinPadding
                    )
                );
        }
    }
...
internal class _MenuButtonDefaultsM3__menu_anchor : ButtonStyle
{
    ...
    internal _MenuButtonDefaultsM3__menu_anchor(BuildContext context)
        : base(
    ...
    {
        get { return ButtonStyleButton.allOrNull<double?>(0.0); }
    }
    ...
    {
        get { return (WidgetStateProperty<double?>?)new WidgetStatePropertyAll<double?>(24.0); }
    }
    public override WidgetStateProperty<Size>? maximumSize
    {
        get { return ButtonStyleButton.allOrNull(Size.infinite); }
    }
    public override WidgetStateProperty<Size>? minimumSize
    {
        get { return ButtonStyleButton.allOrNull(new Size(64.0, 48.0)); }
    }
    ...
    public override WidgetStateProperty<EdgeInsetsGeometry>? padding
    {
        get { return ButtonStyleButton.allOrNull(_scaledPadding(context)); }
    }
    public override WidgetStateProperty<OutlinedBorder>? shape
    {
        get { return ButtonStyleButton.allOrNull<OutlinedBorder>(new RoundedRectangleBorder()); }
    }
    ...
    {
        get { return new WidgetStatePropertyAll<TextStyle?>(_textTheme.labelLarge); }
    }
    public override VisualDensity? visualDensity => Theme.of(context).visualDensity;
    ...
    internal virtual EdgeInsetsGeometry _scaledPadding(BuildContext context)
    {
        ...
        return ButtonStyleButton.scaledPadding(
            EdgeInsets.CreateSymmetric(
                horizontal: Math.Max(
                    Menu_anchorLibrary._kMenuViewPadding,
                    Menu_anchorLibrary._kLabelItemDefaultSpacing
                        + visualDensityLocal.baseSizeAdjustment.dx
                )
            ),
            EdgeInsets.CreateSymmetric(
                horizontal: Math.Max(
                    Menu_anchorLibrary._kMenuViewPadding,
                    8L + visualDensityLocal.baseSizeAdjustment.dx
                )
            ),
...
internal class _MenuDefaultsM3__menu_anchor : MenuStyle
{
    ...
    internal _MenuDefaultsM3__menu_anchor(BuildContext context)
        : base(
            elevation: new WidgetStatePropertyAll<double?>(3.0),
            shape: new WidgetStatePropertyAll<OutlinedBorder>(_defaultMenuBorder),
    ...
    public override WidgetStateProperty<EdgeInsetsGeometry?>? padding
    {
        get
        {
            return (WidgetStateProperty<EdgeInsetsGeometry?>?)
                new WidgetStatePropertyAll<EdgeInsetsGeometry>(
                    EdgeInsetsDirectional.CreateSymmetric(
                        vertical: Menu_anchorLibrary._kMenuVerticalMinPadding
                    )
                );
        }
    }
