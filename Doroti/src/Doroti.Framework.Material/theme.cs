...
public class Theme : StatelessWidget
{
    ...
    public Theme(Key? key = null, ThemeData data = default!, Widget child = default!)
        : base(key: key)
    {
        this.data = data;
        this.child = child;
    ...
    public static ThemeData of(BuildContext context)
    {
        ...
        MaterialLocalizations? localizations = Localizations.of<MaterialLocalizations>(
            context,
            typeof(MaterialLocalizations)
        );
    ...
    {
        return new _InheritedTheme__theme(
            theme: this,
...
internal class _InheritedTheme__theme : InheritedTheme
{
    ...
    internal _InheritedTheme__theme(Theme theme, Widget child)
        : base(child: child)
    {
        this.theme = theme;
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        !Equals(theme.data, ((_InheritedTheme__theme)oldWidget).theme.data);
}
...
public class AnimatedTheme : ImplicitlyAnimatedWidget
{
    ...
    public AnimatedTheme(
        ...
        : base(
            ...
            duration: duration ?? ThemeLibrary.kThemeAnimationDuration,
            onEnd: onEnd
        )
    {
        this.data = data;
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _AnimatedThemeState__theme());
}
...
internal class _AnimatedThemeState__theme : AnimatedWidgetBaseState<AnimatedTheme>
{
        ...
        _data = (
            (ThemeDataTween?)
                visitor(
                    _data,
                    widget.data,
                    (value) => new ThemeDataTween(begin: ((ThemeData?)value)!)
                )!
        )!;
    }
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder description)
    {
        ...
        description.add(
            new DiagnosticsProperty<ThemeDataTween>(
                "data",
                _data,
                showName: false,
                defaultValue: null
