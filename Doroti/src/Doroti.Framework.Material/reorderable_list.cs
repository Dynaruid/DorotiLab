...
internal class _ReorderableListViewState__reorderable_list : global::Doroti.Framework.Widgets.State<ReorderableListView>
{
    ...
    {
        global::Doroti.Framework.Widgets.Widget item__14081 = this.widget.itemBuilder(context, index);
        DartRuntimePrimitives.Assert(() =>
            {
                if ((((global::Doroti.Framework.Widgets.Widget)item__14081).key is null))
                {
        ...
        global::Doroti.Framework.Foundation.Key itemGlobalKey__14304 = ((global::Doroti.Framework.Foundation.Key)(object?)new _ReorderableListViewChildGlobalKey__reorderable_list(((global::Doroti.Framework.Widgets.Widget)item__14081).key!, this));
        if (((ReorderableListView)this.widget).buildDefaultDragHandles)
        {
            switch (Theme.of(context).platform)
            {
                ...
                case global::Doroti.Framework.Foundation.TargetPlatform.macOS:
                    {
                        var dragHandle__14583 = new global::Doroti.Framework.Widgets.ListenableBuilder(listenable: this._dragging, builder: ((global::System.Func<global::Doroti.Framework.Widgets.BuildContext, global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget>)((context, child) => {
global::Doroti.Framework.Services.MouseCursor effectiveMouseCursor__14743 = ((global::Doroti.Framework.Services.MouseCursor)(object?)WidgetStateProperty.resolveAs<global::Doroti.Framework.Services.MouseCursor>((((ReorderableListView)this.widget).mouseCursor ?? global::Doroti.Framework.Widgets.WidgetStateMouseCursor.CreateFromMap(new DartMap<global::Doroti.Framework.Widgets.WidgetStatesConstraint, global::Doroti.Framework.Services.MouseCursor> { [global::Doroti.Framework.Widgets.WidgetState.dragged.asConstraint()] = ((global::Doroti.Framework.Services.MouseCursor)(object?)global::Doroti.Framework.Services.SystemMouseCursors.grabbing), [global::Doroti.Framework.Widgets.WidgetStateMembers.any] = ((global::Doroti.Framework.Services.MouseCursor)(object?)global::Doroti.Framework.Services.SystemMouseCursors.grab) })), ((Func<HashSet<global::Doroti.Framework.Widgets.WidgetState>>)(() => { var __collection15120 = new HashSet<global::Doroti.Framework.Widgets.WidgetState>(); if (((global::Doroti.Framework.Foundation.ValueNotifier<bool>)this._dragging).value) { __collection15120.Add(global::Doroti.Framework.Widgets.WidgetState.dragged); } return __collection15120; }))()));
return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.MouseRegion(cursor: effectiveMouseCursor__14743, child: child));
throw new InvalidOperationException("Dart closure completed without a value.");
                        ...
                        switch (((ReorderableListView)this.widget).scrollDirection)
                        {
                            case global::Doroti.Framework.Painting.Axis.horizontal:
                                {
                                    return ((global::Doroti.Framework.Widgets.Widget)(object?)global::Doroti.Framework.Widgets.Stack.Create(key: itemGlobalKey__14304, children: new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(item__14081), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(global::Doroti.Framework.Widgets.Positioned.CreateDirectional(textDirection: Directionality.of(context), start: 0, end: 0, bottom: 8, child: new global::Doroti.Framework.Widgets.Align(alignment: global::Doroti.Framework.Painting.AlignmentDirectional.bottomCenter, child: new global::Doroti.Framework.Widgets.ReorderableDragStartListener(index: index, child: dragHandle__14583)))) }));
                                }
                            case global::Doroti.Framework.Painting.Axis.vertical:
                                {
                                    return ((global::Doroti.Framework.Widgets.Widget)(object?)global::Doroti.Framework.Widgets.Stack.Create(key: itemGlobalKey__14304, children: new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(item__14081), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(global::Doroti.Framework.Widgets.Positioned.CreateDirectional(textDirection: Directionality.of(context), top: 0, bottom: 0, end: 8, child: new global::Doroti.Framework.Widgets.Align(alignment: global::Doroti.Framework.Painting.AlignmentDirectional.centerEnd, child: new global::Doroti.Framework.Widgets.ReorderableDragStartListener(index: index, child: dragHandle__14583)))) }));
                                }
                            default:
                ...
                case global::Doroti.Framework.Foundation.TargetPlatform.fuchsia:
                    {
                        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.ReorderableDelayedDragStartListener(key: itemGlobalKey__14304, index: index, child: item__14081));
                    }
            }
        }
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.KeyedSubtree(key: itemGlobalKey__14304, child: item__14081));
...
double animValue__17151 = global::Doroti.Framework.Animation.Curves.easeInOut.transform(((global::Doroti.Framework.Animation.Animation<double>)animation).value);
double elevation__17229 = DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(0L, 6L, animValue__17151));
return ((global::Doroti.Framework.Widgets.Widget)(object?)new Material(elevation: elevation__17229, child: child));
throw new InvalidOperationException("Dart closure completed without a value.");
})), child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Painting.EdgeInsets padding__17798 = (((ReorderableListView)this.widget).padding ?? global::Doroti.Framework.Painting.EdgeInsets.zero);
        ...
        global::Doroti.Framework.Painting.EdgeInsets startPadding__18042 = default!;
        global::Doroti.Framework.Painting.EdgeInsets endPadding__18056 = default!;
        global::Doroti.Framework.Painting.EdgeInsets listPadding__18068 = default!;
        DartRuntimePrimitives.Ignore((startPadding__18042, endPadding__18056, listPadding__18068) = (((ReorderableListView)this.widget).scrollDirection switch { global::Doroti.Framework.Painting.Axis.horizontal or global::Doroti.Framework.Painting.Axis.vertical when ((((start__17855 ?? end__17911)) is null)) => (((global::Doroti.Framework.Painting.EdgeInsets, global::Doroti.Framework.Painting.EdgeInsets, global::Doroti.Framework.Painting.EdgeInsets))((global::Doroti.Framework.Painting.EdgeInsets.zero, global::Doroti.Framework.Painting.EdgeInsets.zero, padding__17798))), global::Doroti.Framework.Painting.Axis.horizontal => (((global::Doroti.Framework.Painting.EdgeInsets, global::Doroti.Framework.Painting.EdgeInsets, global::Doroti.Framework.Painting.EdgeInsets))((padding__17798.copyWith(left: 0), padding__17798.copyWith(right: 0), padding__17798.copyWith(left: start__17855, right: end__17911)))), global::Doroti.Framework.Painting.Axis.vertical => (((global::Doroti.Framework.Painting.EdgeInsets, global::Doroti.Framework.Painting.EdgeInsets, global::Doroti.Framework.Painting.EdgeInsets))((padding__17798.copyWith(top: 0), padding__17798.copyWith(bottom: 0), padding__17798.copyWith(top: start__17855, bottom: end__17911)))), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") }));
        var (headerPadding__18625, footerPadding__18651) = (((ReorderableListView)this.widget).reverse ? (((global::Doroti.Framework.Painting.EdgeInsets, global::Doroti.Framework.Painting.EdgeInsets))(startPadding__18042, endPadding__18056)) : (((global::Doroti.Framework.Painting.EdgeInsets, global::Doroti.Framework.Painting.EdgeInsets))(endPadding__18056, startPadding__18042)));
        global::Doroti.Framework.Rendering.ScrollCacheExtent? scrollCacheExtent__18788 = (((ReorderableListView)this.widget).scrollCacheExtent ?? (((((ReorderableListView)this.widget).cacheExtent is null) ? null : global::Doroti.Framework.Rendering.ScrollCacheExtent.CreatePixels(DartRuntimePrimitives.RequireValue(((ReorderableListView)this.widget).cacheExtent)))));
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.CustomScrollView(scrollDirection: ((ReorderableListView)this.widget).scrollDirection, reverse: ((ReorderableListView)this.widget).reverse, controller: ((ReorderableListView)this.widget).scrollController, primary: ((ReorderableListView)this.widget).primary, physics: ((ReorderableListView)this.widget).physics, shrinkWrap: ((ReorderableListView)this.widget).shrinkWrap, anchor: ((ReorderableListView)this.widget).anchor, scrollCacheExtent: scrollCacheExtent__18788, dragStartBehavior: ((ReorderableListView)this.widget).dragStartBehavior, keyboardDismissBehavior: ((ReorderableListView)this.widget).keyboardDismissBehavior, restorationId: ((ReorderableListView)this.widget).restorationId, clipBehavior: ((ReorderableListView)this.widget).clipBehavior, slivers: ((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection19473 = new List<global::Doroti.Framework.Widgets.Widget>(); if ((((ReorderableListView)this.widget).header is not null)) { __collection19473.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SliverPadding(padding: headerPadding__18625, sliver: new global::Doroti.Framework.Widgets.SliverToBoxAdapter(child: ((ReorderableListView)this.widget).header)))); } __collection19473.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SliverPadding(padding: listPadding__18068, sliver: new global::Doroti.Framework.Widgets.SliverReorderableList(itemBuilder: (global::System.Func<global::Doroti.Framework.Widgets.BuildContext, long, global::Doroti.Framework.Widgets.Widget>)this._itemBuilder, itemExtent: ((ReorderableListView)this.widget).itemExtent, itemExtentBuilder: (ItemExtentBuilder?)((ReorderableListView)this.widget).itemExtentBuilder, prototypeItem: ((ReorderableListView)this.widget).prototypeItem, itemCount: ((ReorderableListView)this.widget).itemCount, onReorder: (global::System.Action<long, long>?)((ReorderableListView)this.widget).onReorder, onReorderItem: (global::System.Action<long, long>?)((ReorderableListView)this.widget).onReorderItem, onReorderStart: ((global::System.Action<long>)((index) => {
