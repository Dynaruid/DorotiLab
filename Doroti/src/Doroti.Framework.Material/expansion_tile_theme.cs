...
public class ExpansionTileThemeData : Diagnosticable
{
    ...
    public virtual ExpansionTileThemeData copyWith(
        Color? backgroundColor = null,
        Color? collapsedBackgroundColor = null,
        EdgeInsetsGeometry? tilePadding = null,
        AlignmentGeometry? expandedAlignment = null,
    ...
    )
    {
        ...
        return new ExpansionTileThemeData(
            ...
            expandedAlignment: AlignmentGeometry.lerp(
                a?.expandedAlignment,
                b?.expandedAlignment,
                t
            ),
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is ExpansionTileThemeData)
            && Equals(__other.backgroundColor, backgroundColor)
            && Equals(__other.collapsedBackgroundColor, collapsedBackgroundColor)
            && Equals(__other.tilePadding, tilePadding)
            && Equals(__other.expandedAlignment, expandedAlignment)
            && Equals(__other.childrenPadding, childrenPadding)
            && Equals(__other.iconColor, iconColor)
            && Equals(__other.collapsedIconColor, collapsedIconColor)
            && Equals(__other.textColor, textColor)
            && Equals(__other.collapsedTextColor, collapsedTextColor)
            && Equals(__other.shape, shape)
            && Equals(__other.collapsedShape, collapsedShape)
            && Equals(__other.clipBehavior, clipBehavior)
            && Equals(__other.expansionAnimationStyle, expansionAnimationStyle);
    }
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new ColorProperty("collapsedIconColor", collapsedIconColor, defaultValue: null)
        );
        properties.add(new ColorProperty("textColor", textColor, defaultValue: null));
        properties.add(
            new ColorProperty("collapsedTextColor", collapsedTextColor, defaultValue: null)
        );
        ...
        properties.add(
            new DiagnosticsProperty<AnimationStyle>(
                "expansionAnimationStyle",
                expansionAnimationStyle,
                defaultValue: null
            )
...
public class ExpansionTileTheme : InheritedTheme
{
    ...
    public ExpansionTileTheme(
        Key? key = null,
        ExpansionTileThemeData data = default!,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(
            !Equals(data, ((ExpansionTileTheme)oldWidget).data)
        );
}
