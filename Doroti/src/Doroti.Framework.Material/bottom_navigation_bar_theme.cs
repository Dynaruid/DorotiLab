...
public class BottomNavigationBarThemeData : Diagnosticable
{
    ...
    public BottomNavigationBarThemeData(Color? backgroundColor = null, double? elevation = null, IconThemeData? selectedIconTheme = null, IconThemeData? unselectedIconTheme = null, Color? selectedItemColor = null, Color? unselectedItemColor = null, TextStyle? selectedLabelStyle = null, TextStyle? unselectedLabelStyle = null, bool? showSelectedLabels = null, bool? showUnselectedLabels = null, BottomNavigationBarType? type = null, bool? enableFeedback = null, BottomNavigationBarLandscapeLayout? landscapeLayout = null, WidgetStateProperty<MouseCursor?>? mouseCursor = null)
    {
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<IconThemeData>("selectedIconTheme", selectedIconTheme, defaultValue: null));
        properties.add(new DiagnosticsProperty<IconThemeData>("unselectedIconTheme", unselectedIconTheme, defaultValue: null));
        properties.add(new ColorProperty("selectedItemColor", selectedItemColor, defaultValue: null));
        properties.add(new ColorProperty("unselectedItemColor", unselectedItemColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("selectedLabelStyle", selectedLabelStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("unselectedLabelStyle", unselectedLabelStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<bool>("showSelectedLabels", showSelectedLabels, defaultValue: null));
        properties.add(new DiagnosticsProperty<bool>("showUnselectedLabels", showUnselectedLabels, defaultValue: null));
        properties.add(new DiagnosticsProperty<BottomNavigationBarType>("type", type, defaultValue: null));
        properties.add(new DiagnosticsProperty<bool>("enableFeedback", enableFeedback, defaultValue: null));
        properties.add(new DiagnosticsProperty<BottomNavigationBarLandscapeLayout>("landscapeLayout", landscapeLayout, defaultValue: null));
...
public class BottomNavigationBarTheme : InheritedWidget
{
    ...
    public BottomNavigationBarTheme(Key? key = null, BottomNavigationBarThemeData data = default!, Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((BottomNavigationBarTheme)oldWidget).data));
}
