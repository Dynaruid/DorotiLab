...
public delegate Widget? InputCounterWidgetBuilder(BuildContext context, long currentLength, bool isFocused, long? maxLength);

internal class _TextFieldSelectionGestureDetectorBuilder__text_field : TextSelectionGestureDetectorBuilder
{
...
public class TextField : StatefulWidget
{
    ...
    public static TextStyle materialMisspelledTextStyle = new TextStyle(decoration: TextDecoration.underline, decorationColor: Colors.red, decorationStyle: TextDecorationStyle.wavy);

    public TextField(Key? key = null, object groupId = default!, TextEditingController? controller = null, FocusNode? focusNode = null, UndoHistoryController? undoController = null, InputDecoration? decoration = default!, TextInputType? keyboardType = null, TextInputAction? textInputAction = null, TextCapitalization textCapitalization = TextCapitalization.none, TextStyle? style = null, Painting.StrutStyle? strutStyle = null, TextAlign textAlign = TextAlign.start, TextAlignVertical? textAlignVertical = null, TextDirection? textDirection = null, bool readOnly = false, ToolbarOptions? toolbarOptions = null, bool? showCursor = null, bool autofocus = false, WidgetStatesController? statesController = null, string obscuringCharacter = "•", bool obscureText = false, bool? autocorrect = null, SmartDashesType? smartDashesType = null, SmartQuotesType? smartQuotesType = null, bool enableSuggestions = true, long? maxLines = 1, long? minLines = null, bool expands = false, long? maxLength = null, MaxLengthEnforcement? maxLengthEnforcement = null, System.Action<string>? onChanged = null, Action? onEditingComplete = null, System.Action<string>? onSubmitted = null, Action<string, DartMap<string, object?>>? onAppPrivateCommand = null, List<TextInputFormatter>? inputFormatters = null, bool? enabled = null, bool? ignorePointers = null, double cursorWidth = 2.0, double? cursorHeight = null, Radius? cursorRadius = null, bool? cursorOpacityAnimates = null, Color? cursorColor = null, Color? cursorErrorColor = null, BoxHeightStyle? selectionHeightStyle = null, BoxWidthStyle? selectionWidthStyle = null, Brightness? keyboardAppearance = null, EdgeInsets scrollPadding = default!, Gestures.DragStartBehavior dragStartBehavior = Gestures.DragStartBehavior.start, bool? enableInteractiveSelection = null, bool? selectAllOnFocus = null, TextSelectionControls? selectionControls = null, Action? onTap = null, bool onTapAlwaysCalled = false, System.Action<Gestures.PointerDownEvent>? onTapOutside = null, System.Action<Gestures.PointerUpEvent>? onTapUpOutside = null, MouseCursor? mouseCursor = null, InputCounterWidgetBuilder? buildCounter = null, ScrollController? scrollController = null, ScrollPhysics? scrollPhysics = null, IEnumerable<string>? autofillHints = default!, ContentInsertionConfiguration? contentInsertionConfiguration = null, Clip clipBehavior = Clip.hardEdge, string? restorationId = null, bool scribbleEnabled = true, bool? stylusHandwritingEnabled = null, bool enableIMEPersonalizedLearning = true, bool? enableInlinePrediction = null, Func<BuildContext, EditableTextState, Widget>? contextMenuBuilder = default!, bool canRequestFocus = true, SpellCheckConfiguration? spellCheckConfiguration = null, TextMagnifierConfiguration? magnifierConfiguration = null, List<Locale>? hintLocales = null) : base(key: key)
    {
    ...
    public static SpellCheckConfiguration inferAndroidSpellCheckConfiguration(SpellCheckConfiguration? configuration)
    {
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<bool>("cursorOpacityAnimates", cursorOpacityAnimates, defaultValue: null));
        ...
        properties.add(new DiagnosticsProperty<EdgeInsetsGeometry>("scrollPadding", scrollPadding, defaultValue: EdgeInsets.CreateAll(20.0)));
...
internal class _TextFieldState__text_field : State<TextField>, RestorationMixin<TextField>, TextSelectionGestureDetectorBuilderDelegate, AutofillClient
{
    ...
    internal virtual MaxLengthEnforcement _effectiveMaxLengthEnforcement => DartRuntimePrimitives.ConvertValue<MaxLengthEnforcement>(widget.maxLengthEnforcement ?? LengthLimitingTextInputFormatter.getDefaultMaxLengthEnforcement(Theme.of(context).platform));
    ...
    internal virtual Color _errorColor => DartRuntimePrimitives.ConvertValue<Color>((widget.cursorErrorColor ?? _getEffectiveDecoration().errorStyle?.color) ?? Theme.of(context).colorScheme.error);
    internal virtual InputDecoration _getEffectiveDecoration()
    {
        ...
        if ((effectiveDecoration.counter is null) && (effectiveDecoration.counterText is null) && (widget.buildCounter is not null))
        {
            ...
            Widget? builtCounter = widget.buildCounter!(context, currentLength: currentLengthLocal, maxLength: widget.maxLength, isFocused: isFocusedLocal);
            if (builtCounter is not null)
            {
                counterLocal = DartRuntimePrimitives.ConvertValue<Widget>(new Widgets.Semantics(container: true, liveRegion: isFocusedLocal, child: builtCounter));
            }
    ...
    public override void didUpdateWidget(TextField oldWidget)
    {
        ...
        else
        {
            ...
            {
                unregisterFromRestoration(DartRuntimePrimitives.ConvertValue<RestorableProperty<object>>(_controller!));
                _controller!.dispose();
                _controller = null;
            }
        }
    ...
    internal virtual WidgetStatesController _statesController => DartRuntimePrimitives.ConvertValue<WidgetStatesController>(widget.statesController ?? _internalStatesController!);
    ...
    public virtual TextInputConfiguration textInputConfiguration
    {
        get
        {
            ...
            AutofillConfiguration autofillConfigurationLocal = (autofillHintsLocal is not null) ? new AutofillConfiguration(uniqueIdentifier: autofillId, autofillHints: autofillHintsLocal, currentEditingValue: _effectiveController.value, hintText: (widget.decoration ?? new InputDecoration()).hintText) : AutofillConfiguration.disabled;
    ...
    internal virtual TextStyle _getInputStyleForState(TextStyle style)
    {
        ...
        TextStyle stateStyle = WidgetStateProperty.resolveAs(Text_fieldLibrary._m3StateInputStyle(context)!, _statesController.value);
    ...
    public override Widget build(BuildContext context)
    {
        ...
        TextStyle? providedStyle = WidgetStateProperty.resolveAs(widget.style, _statesController.value);
        TextStyle styleLocal = _getInputStyleForState(Text_fieldLibrary._m3InputStyle(context)).merge(providedStyle);
        ...
        var formatters = ((Func<List<TextInputFormatter>>)(() => { var __collection58738 = new List<TextInputFormatter>(); var __collectionSpread58766 = widget.inputFormatters; if (__collectionSpread58766 is not null) { __collection58738.AddRange(__collectionSpread58766); } if (widget.maxLength is not null) { __collection58738.Add(new LengthLimitingTextInputFormatter(widget.maxLength, maxLengthEnforcement: _effectiveMaxLengthEnforcement)); } return __collection58738; }))();
        ...
        MouseCursor effectiveMouseCursor = WidgetStateProperty.resolveAs(widget.mouseCursor ?? WidgetStateMouseCursor.textable, _statesController.value);
        ...
        return new MouseRegion(cursor: effectiveMouseCursor, onEnter: (@event) => { _handleHover(true); }, onExit: (@event) => { _handleHover(false); }, child: new TextFieldTapRegion(child: new IgnorePointer(ignoring: widget.ignorePointers ?? !_isEnabled, child: new AnimatedBuilder(animation: controllerLocal, builder: (context, child) =>
        {
            return new Widgets.Semantics(enabled: _isEnabled, maxValueLength: semanticsMaxValueLength, currentValueLength: _currentLength, onTap: widget.readOnly ? null : (() =>
            {
...
{
    internal static TextStyle? _m2StateInputStyle(BuildContext context) => WidgetStateTextStyle.CreateResolveWith((states) =>
    {
        ThemeData theme = Theme.of(context);
...
public static partial class Text_fieldLibrary
{
    internal static TextStyle _m2CounterErrorStyle(BuildContext context) => Theme.of(context).textTheme.bodySmall!.copyWith(color: Theme.of(context).colorScheme.error);
}

public static partial class Text_fieldLibrary
{
    internal static TextStyle? _m3StateInputStyle(BuildContext context) => WidgetStateTextStyle.CreateResolveWith((states) =>
    {
        if (states.Contains(WidgetState.disabled))
        {
            return new TextStyle(color: Theme.of(context).textTheme.bodyLarge!.color?.withOpacity(0.38));
        }
...
public static partial class Text_fieldLibrary
{
    internal static TextStyle _m3InputStyle(BuildContext context) => Theme.of(context).textTheme.bodyLarge!;
}

public static partial class Text_fieldLibrary
{
    internal static TextStyle _m3CounterErrorStyle(BuildContext context) => Theme.of(context).textTheme.bodySmall!.copyWith(color: Theme.of(context).colorScheme.error);
}
