...
public class AppBarTheme : InheritedTheme, Diagnosticable
{
    ...
    public virtual Color? foregroundColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.foregroundColor : _foregroundColor
        );
    public virtual double? elevation => (_data is not null) ? _data.elevation : _elevation;
    public virtual double? scrolledUnderElevation =>
        (_data is not null) ? _data.scrolledUnderElevation : _scrolledUnderElevation;
    ...
    public virtual IconThemeData? actionsIconTheme =>
        (_data is not null) ? _data.actionsIconTheme : _actionsIconTheme;
    ...
    public virtual double? toolbarHeight =>
        (_data is not null) ? _data.toolbarHeight : _toolbarHeight;
    public virtual TextStyle? toolbarTextStyle =>
        (_data is not null) ? _data.toolbarTextStyle : _toolbarTextStyle;
    public virtual TextStyle? titleTextStyle =>
        (_data is not null) ? _data.titleTextStyle : _titleTextStyle;
    public virtual SystemUiOverlayStyle? systemOverlayStyle =>
        (_data is not null) ? _data.systemOverlayStyle : _systemOverlayStyle;
    public virtual EdgeInsetsGeometry? actionsPadding =>
        (_data is not null) ? _data.actionsPadding : _actionsPadding;
    public virtual AppBarThemeData data =>
        DartRuntimePrimitives.ConvertValue<AppBarThemeData>(
            _data
                ?? new AppBarThemeData(
    ...
    public virtual AppBarTheme copyWith(
        IconThemeData? actionsIconTheme = null,
        Color? color = null,
        Color? backgroundColor = null,
        Color? foregroundColor = null,
    ...
    )
    {
        DartRuntimePrimitives.Assert(
            () => (color is null) || (backgroundColor is null),
            () =>
                (object?)
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((AppBarTheme)oldWidget).data));
...
public class AppBarThemeData : Diagnosticable
{
    ...
    public virtual AppBarThemeData copyWith(
        Color? backgroundColor = null,
        Color? foregroundColor = null,
        Color? color = null,
        double? elevation = null,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is AppBarThemeData)
            ...
            && Equals(__other.actionsIconTheme, actionsIconTheme)
            && (__other.centerTitle == centerTitle)
            && (__other.titleSpacing == titleSpacing)
            && (__other.leadingWidth == leadingWidth)
            && (__other.toolbarHeight == toolbarHeight)
            && Equals(__other.toolbarTextStyle, toolbarTextStyle)
            && Equals(__other.titleTextStyle, titleTextStyle)
            && Equals(__other.systemOverlayStyle, systemOverlayStyle)
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DoubleProperty("scrolledUnderElevation", scrolledUnderElevation, defaultValue: null)
        );
        ...
        properties.add(
            new DiagnosticsProperty<bool>("centerTitle", centerTitle, defaultValue: null)
        );
