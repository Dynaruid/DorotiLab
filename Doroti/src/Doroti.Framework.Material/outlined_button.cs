...
public class OutlinedButton : ButtonStyleButton
{
    ...
    public static OutlinedButton CreateIcon(
        Key? key = null,
        Action? onPressed = default!,
        Action? onLongPress = null,
        Action<bool>? onHover = null,
    ...
    {
        var __instance = new OutlinedButton(
            key: key,
            onPressed: onPressed,
            onLongPress: onLongPress,
            onHover: onHover,
            ...
            child: icon is null
                ? label
                : new _OutlinedButtonWithIconChild__outlined_button(
                    label: label,
                    icon: icon,
                    buttonStyle: style,
    ...
    )
    {
        ...
        WidgetStateProperty<Color?>? overlayColorProp = (WidgetStateProperty<Color?>?)(
            (foregroundColor, overlayColor) switch
            {
                ...
                (_, Color { a: 0.0 } __object7771) => DartRuntimePrimitives.ConvertValue<
...
internal class _OutlinedButtonWithIconChild__outlined_button : StatelessWidget
{
    ...
    internal _OutlinedButtonWithIconChild__outlined_button(
        Widget label,
        Widget icon,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        IconAlignment effectiveIconAlignment =
            (
                (iconAlignment ?? outlinedButtonTheme.style?.iconAlignment)
...
internal class _OutlinedButtonDefaultsM3__outlined_button : ButtonStyle
{
    ...
    internal _OutlinedButtonDefaultsM3__outlined_button(BuildContext context)
        : base(
    ...
    public override WidgetStateProperty<EdgeInsetsGeometry?>? padding =>
        DartRuntimePrimitives.ConvertValue<WidgetStateProperty<EdgeInsetsGeometry?>>(
            new WidgetStatePropertyAll<EdgeInsetsGeometry>(
                Outlined_buttonLibrary._scaledPadding(context)
            )
        );
