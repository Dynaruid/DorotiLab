...
public class OutlinedButton : ButtonStyleButton
{
    ...
    public virtual ButtonStyle defaultStyleOf(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        ButtonStyle buttonStyle__14033 = (theme__13929.useMaterial3 ? new _OutlinedButtonDefaultsM3__outlined_button(context) : OutlinedButton.styleFrom(foregroundColor: colorScheme__13978.primary, disabledForegroundColor: colorScheme__13978.onSurface.withOpacity(0.38), backgroundColor: Colors.transparent, disabledBackgroundColor: Colors.transparent, shadowColor: theme__13929.shadowColor, elevation: 0, textStyle: theme__13929.textTheme.labelLarge, padding: Outlined_buttonLibrary._scaledPadding(context), minimumSize: new global::Doroti.Ui.Size(64, 36), maximumSize: Size.infinite, side: new global::Doroti.Framework.Painting.BorderSide(color: colorScheme__13978.onSurface.withOpacity(0.12)), shape: new global::Doroti.Framework.Painting.RoundedRectangleBorder(borderRadius: global::Doroti.Framework.Painting.BorderRadius.CreateAll(global::Doroti.Ui.Radius.circular(4))), enabledMouseCursor: (global::Doroti.Framework.Foundation.ConstantsLibrary.kIsWeb ? global::Doroti.Framework.Services.SystemMouseCursors.click : global::Doroti.Framework.Services.SystemMouseCursors.basic), disabledMouseCursor: global::Doroti.Framework.Services.SystemMouseCursors.basic, visualDensity: theme__13929.visualDensity, tapTargetSize: theme__13929.materialTapTargetSize, animationDuration: ConstantsLibrary.kThemeChangeDuration, enableFeedback: true, alignment: global::Doroti.Framework.Painting.Alignment.center, splashFactory: InkRipple.splashFactory));
        if ((this._addPadding && theme__13929.useMaterial3))
        {
            double defaultFontSize__15371 = (buttonStyle__14033.textStyle?.resolve(new HashSet<global::Doroti.Framework.Widgets.WidgetState>())?.fontSize ?? 14.0);
            double effectiveTextScale__15491 = (MediaQuery.textScalerOf(context).scale(defaultFontSize__15371) / 14.0);
            global::Doroti.Framework.Painting.EdgeInsetsGeometry scaledPadding__15617 = ButtonStyleButton.scaledPadding(new global::Doroti.Framework.Painting.EdgeInsetsDirectional(16, 0, 24, 0), new global::Doroti.Framework.Painting.EdgeInsetsDirectional(8, 0, 12, 0), new global::Doroti.Framework.Painting.EdgeInsetsDirectional(4, 0, 6, 0), effectiveTextScale__15491);
            return buttonStyle__14033.copyWith(padding: new global::Doroti.Framework.Widgets.WidgetStatePropertyAll<global::Doroti.Framework.Painting.EdgeInsetsGeometry>(scaledPadding__15617));
        }
...
public static partial class Outlined_buttonLibrary
{
    internal static global::Doroti.Framework.Painting.EdgeInsetsGeometry _scaledPadding(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        return ButtonStyleButton.scaledPadding(global::Doroti.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: padding1x__16270), global::Doroti.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: (padding1x__16270 / 2L)), global::Doroti.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: ((padding1x__16270 / 2L) / 2L)), effectiveTextScale__16410);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
}
...
internal class _OutlinedButtonWithIconChild__outlined_button : global::Doroti.Framework.Widgets.StatelessWidget
{
    ...
    {
        double defaultFontSize__17132 = (this.buttonStyle?.textStyle?.resolve(new HashSet<global::Doroti.Framework.Widgets.WidgetState>())?.fontSize ?? 14.0);
        ...
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Row(mainAxisSize: global::Doroti.Framework.Rendering.MainAxisSize.min, spacing: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(8L, 4L, scale__17249)), children: ((object.Equals(effectiveIconAlignment__17472, IconAlignment.start)) ? new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(this.icon), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Flexible(child: this.label)) } : new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Flexible(child: this.label)), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(this.icon) })));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _OutlinedButtonDefaultsM3__outlined_button : ButtonStyle
{
    ...
    internal _OutlinedButtonDefaultsM3__outlined_button(global::Doroti.Framework.Widgets.BuildContext context) : base(animationDuration: ConstantsLibrary.kThemeChangeDuration, enableFeedback: true, alignment: global::Doroti.Framework.Painting.Alignment.center)
    {
    ...
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Framework.Painting.EdgeInsetsGeometry>? padding => DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Framework.Painting.EdgeInsetsGeometry>>(new global::Doroti.Framework.Widgets.WidgetStatePropertyAll<global::Doroti.Framework.Painting.EdgeInsetsGeometry>(Outlined_buttonLibrary._scaledPadding(this.context)));
    ...
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Framework.Painting.BorderSide>? side => WidgetStateProperty.resolveWith((states) =>
    {
        if (states.Contains(global::Doroti.Framework.Widgets.WidgetState.disabled))
        {
        ...
        if (states.Contains(global::Doroti.Framework.Widgets.WidgetState.focused))
        {
            return (new global::Doroti.Framework.Painting.BorderSide(color: this._colors.primary));
        }
