...
public class FilterChip : StatelessWidget, ChipAttributes, DeletableChipAttributes, SelectableChipAttributes, CheckmarkableChipAttributes, DisabledChipAttributes
{
    ...
    public static FilterChip CreateElevated(Key? key = null, Widget? avatar = null, Widget label = default!, TextStyle? labelStyle = null, EdgeInsetsGeometry? labelPadding = null, bool selected = false, System.Action<bool>? onSelected = default!, Widget? deleteIcon = null, Action? onDeleted = null, Color? deleteIconColor = null, string? deleteButtonTooltipMessage = null, double? pressElevation = null, Color? disabledColor = null, Color? selectedColor = null, string? tooltip = null, BorderSide? side = null, OutlinedBorder? shape = null, Clip clipBehavior = Clip.none, FocusNode? focusNode = null, bool autofocus = false, WidgetStateProperty<Color?>? color = null, Color? backgroundColor = null, EdgeInsetsGeometry? padding = null, VisualDensity? visualDensity = null, MaterialTapTargetSize? materialTapTargetSize = null, double? elevation = null, Color? shadowColor = null, Color? surfaceTintColor = null, IconThemeData? iconTheme = null, Color? selectedShadowColor = null, bool? showCheckmark = null, Color? checkmarkColor = null, ShapeBorder avatarBorder = default!, BoxConstraints? avatarBoxConstraints = null, BoxConstraints? deleteIconBoxConstraints = null, ChipAnimationStyle? chipAnimationStyle = null, MouseCursor? mouseCursor = null)
    {
...
internal class _FilterChipDefaultsM3__filter_chip : ChipThemeData
{
    ...
    internal _FilterChipDefaultsM3__filter_chip(BuildContext context, bool isEnabled, bool isSelected, _ChipVariant__filter_chip _chipVariant) : base(shape: new RoundedRectangleBorder(borderRadius: BorderRadius.CreateAll(Radius.circular(8.0))), showCheckmark: true)
    {
    ...
    public override Color? shadowColor => DartRuntimePrimitives.ConvertValue<Color>(Equals(_chipVariant, _ChipVariant__filter_chip.flat) ? Colors.transparent : _colors.shadow);
    ...
    public override BorderSide? side => (Equals(_chipVariant, _ChipVariant__filter_chip.flat) && !isSelected) ? (isEnabled ? new BorderSide(color: _colors.outlineVariant) : new BorderSide(color: _colors.onSurface.withOpacity(0.12))) : new BorderSide(color: Colors.transparent);
