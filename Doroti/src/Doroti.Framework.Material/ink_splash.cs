...
public class InkSplash : InteractiveInkFeature
{
        ...
        )
    {
        ...
        _targetRadius =
            radius
            ?? Ink_splashLibrary._getTargetRadius(
                referenceBox,
                containedInkWell,
                rectCallback,
            ...
            (Func<AnimationController>)(
                () =>
                {
                    var __cascade = new AnimationController(
                        duration: Ink_splashLibrary._kUnconfirmedSplashDuration,
        ...
        _radius = _radiusController.drive(
            new Tween<double>(begin: Ink_splashLibrary._kSplashInitialSize, end: _targetRadius)
        );
        _alphaController = (
            (Func<AnimationController>)(
                () =>
                {
                    var __cascade = new AnimationController(
                        duration: Ink_splashLibrary._kSplashFadeDuration,
                        vsync: controller.vsync
                    );
                    __cascade.addListener(controller.markNeedsPaint);
