...
internal class _CalendarDatePickerState__calendar_date_picker : global::Doroti.Framework.Widgets.State<CalendarDatePicker>
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Widgets.Orientation orientation__14928 = MediaQuery.orientationOf(context);
        double maxDayPickerHeight__14994 = ((Theme.of(context).useMaterial3 && (object.Equals(orientation__14928, global::Doroti.Framework.Widgets.Orientation.portrait))) ? Calendar_date_pickerLibrary._maxDayPickerHeightM3 : Calendar_date_pickerLibrary._maxDayPickerHeightM2);
        ...
        var picker__15624 = new global::Doroti.Framework.Widgets.SizedBox(height: (Calendar_date_pickerLibrary._subHeaderHeight + scaledMaxDayPickerHeight__15444), child: _buildPicker());
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Stack(children: ((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection15772 = new List<global::Doroti.Framework.Widgets.Widget>(); if ((MediaQuery.maybeSupportsAnnounceOf(context) ?? false)) { __collection15772.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(picker__15624)); } else { __collection15772.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Semantics(container: true, liveRegion: true, accessibilityFocusBlockType: global::Doroti.Framework.Semantics.AccessibilityFocusBlockType.blockNode, label: this._announcementText, child: picker__15624))); } __collection15772.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(MediaQuery.withClampedTextScaling(maxScaleFactor: Calendar_date_pickerLibrary._kModeToggleButtonMaxScaleFactor, child: new _DatePickerModeToggleButton__calendar_date_picker(mode: this._mode, title: ((CalendarDatePicker)this.widget).calendarDelegate.formatMonthYear(this._currentDisplayedMonthDate, this._localizations), onTitlePressed: ((global::System.Action)(() => { _handleModeChanged((this._mode switch { DatePickerMode.day => DatePickerMode.year, DatePickerMode.year => DatePickerMode.day, _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") })); })))))); return __collection15772; }))()));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class _DatePickerModeToggleButtonState__calendar_date_picker : global::Doroti.Framework.Widgets.State<_DatePickerModeToggleButton__calendar_date_picker>, global::Doroti.Framework.Widgets.SingleTickerProviderStateMixin<_DatePickerModeToggleButton__calendar_date_picker>
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Painting.TextStyle? buttonTextStyle__18504 = (datePickerTheme__18360.toggleButtonTextStyle ?? defaults__18437.toggleButtonTextStyle);
...
internal class _MonthPickerState__calendar_date_picker : global::Doroti.Framework.Widgets.State<_MonthPicker__calendar_date_picker>
{
    ...
    internal virtual void _showMonth(DateTime month, bool jump = false)
    {
        ...
        {
            DartRuntimePrimitives.Ignore(this._pageController.animateToPage(monthPage__27613, duration: Calendar_date_pickerLibrary._monthScrollDuration, curve: global::Doroti.Framework.Animation.Curves.ease));
        }
    }
...
internal class _DayPickerState__calendar_date_picker : global::Doroti.Framework.Widgets.State<_DayPicker__calendar_date_picker>
{
    ...
    public override void initState()
    {
        ...
        _dayFocusNodes = new List<global::Doroti.Framework.Widgets.FocusNode>(System.Linq.Enumerable.Select(System.Linq.Enumerable.Range(0, checked((int)daysInMonth__38135)), ((index) => new global::Doroti.Framework.Widgets.FocusNode(skipTraversal: true, debugLabel: $"Day {(index + 1L)}"))));
    }
    ...
    public override void dispose()
    {
        foreach (global::Doroti.Framework.Widgets.FocusNode node__38886 in this._dayFocusNodes)
        {
            node__38886.dispose();
        }
        base.dispose();
    ...
    {
        var result__39631 = new List<global::Doroti.Framework.Widgets.Widget>();
        for (long i__39672 = ((MaterialLocalizations)localizations).firstDayOfWeekIndex; (checked((long)(result__39631.Count)) < 7L); i__39672 = (((i__39672 + 1L)) % 7L))
        {
            ...
            result__39631.Add(new global::Doroti.Framework.Widgets.ExcludeSemantics(child: new global::Doroti.Framework.Widgets.Center(child: new global::Doroti.Framework.Widgets.Text(weekday__39823, style: headerStyle))));
        }
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Painting.TextStyle? weekdayStyle__40335 = (datePickerTheme__40191.weekdayStyle ?? defaults__40268.weekdayStyle);
        global::Doroti.Framework.Widgets.Orientation orientation__40428 = MediaQuery.orientationOf(context);
        var isLandscapeOrientation__40487 = (object.Equals(orientation__40428, global::Doroti.Framework.Widgets.Orientation.landscape));
        ...
        List<global::Doroti.Framework.Widgets.Widget> dayItems__40851 = ((List<global::Doroti.Framework.Widgets.Widget>)(object?)_dayHeaders(weekdayStyle__40335, localizations__40110));
        ...
        while ((day__41009 < daysInMonth__40666))
        {
            ...
            if ((day__41009 < 1L))
            {
                dayItems__40851.Add(global::Doroti.Framework.Widgets.SizedBox.CreateShrink());
            }
            else
            {
                ...
                dayItems__40851.Add(new _Day__calendar_date_picker(dayToBuild__41178, key: new global::Doroti.Framework.Foundation.ValueKey<DateTime>(dayToBuild__41178), isDisabled: isDisabled__41260, isSelectedDay: isSelectedDay__41496, isToday: isToday__41630, onChanged: (global::System.Action<DateTime>)((_DayPicker__calendar_date_picker)this.widget).onChanged, focusNode: this._dayFocusNodes[(int)((day__41009 - 1L))], calendarDelegate: ((_DayPicker__calendar_date_picker)this.widget).calendarDelegate));
            }
        }
        ...
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Padding(padding: global::Doroti.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: monthPickerHorizontalPadding__42127), child: MediaQuery.withClampedTextScaling(maxScaleFactor: (isLandscapeOrientation__40487 ? Calendar_date_pickerLibrary._kDayPickerGridLandscapeMaxScaleFactor : Calendar_date_pickerLibrary._kDayPickerGridPortraitMaxScaleFactor), child: global::Doroti.Framework.Widgets.GridView.CreateCustom(physics: new global::Doroti.Framework.Widgets.ClampingScrollPhysics(), gridDelegate: new _DayPickerGridDelegate__calendar_date_picker(context), childrenDelegate: new global::Doroti.Framework.Widgets.SliverChildListDelegate(dayItems__40851, addRepaintBoundaries: false)))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _DayState__calendar_date_picker : global::Doroti.Framework.Widgets.State<_Day__calendar_date_picker>
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Painting.TextStyle? dayStyle__43783 = (datePickerTheme__43715.dayStyle ?? defaults__43639.dayStyle);
        ...
        var states__44449 = ((Func<HashSet<global::Doroti.Framework.Widgets.WidgetState>>)(() => { var __collection44458 = new HashSet<global::Doroti.Framework.Widgets.WidgetState>(); if (((_Day__calendar_date_picker)this.widget).isDisabled) { __collection44458.Add(global::Doroti.Framework.Widgets.WidgetState.disabled); } if (((_Day__calendar_date_picker)this.widget).isSelectedDay) { __collection44458.Add(global::Doroti.Framework.Widgets.WidgetState.selected); } return __collection44458; }))();
        ...
        global::Doroti.Framework.Painting.OutlinedBorder dayShape__45284 = resolve<global::Doroti.Framework.Painting.OutlinedBorder?>(((theme) => theme?.dayShape), states__44449)!;
        ...
        global::Doroti.Framework.Painting.BorderSide todayBorderSide__45555 = (hasCustomBorderColor__45413 ? datePickerTheme__43715.todayBorder! : ((datePickerTheme__43715.todayBorder ?? defaults__43639.todayBorder!)).copyWith(color: dayForegroundColor__44642));
        var decoration__45770 = (((_Day__calendar_date_picker)this.widget).isToday ? new global::Doroti.Framework.Painting.ShapeDecoration(color: dayBackgroundColor__44840, shape: dayShape__45284.copyWith(side: todayBorderSide__45555)) : new global::Doroti.Framework.Painting.ShapeDecoration(color: dayBackgroundColor__44840, shape: dayShape__45284));
        global::Doroti.Framework.Widgets.Widget dayWidget__46020 = ((global::Doroti.Framework.Widgets.Widget)(object?)new Ink(decoration: decoration__45770, child: new global::Doroti.Framework.Widgets.Center(child: new global::Doroti.Framework.Widgets.Text(localizations__44294.formatDecimal(((_Day__calendar_date_picker)this.widget).day.Day), style: dayStyle__43783?.apply(color: dayForegroundColor__44642)))));
        global::Doroti.Framework.Widgets.Orientation orientation__46413 = MediaQuery.orientationOf(context);
        if ((Theme.of(context).useMaterial3 && (object.Equals(orientation__46413, global::Doroti.Framework.Widgets.Orientation.portrait))))
        {
            dayWidget__46020 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Padding(padding: global::Doroti.Framework.Painting.EdgeInsets.CreateAll(4.0), child: dayWidget__46020));
        }
        dayWidget__46020 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Semantics(label: $"{localizations__44294.formatDecimal(((_Day__calendar_date_picker)this.widget).day.Day)}, {((_Day__calendar_date_picker)this.widget).calendarDelegate.formatFullDate(((_Day__calendar_date_picker)this.widget).day, localizations__44294)}{semanticLabelSuffix__44355}", button: true, selected: ((_Day__calendar_date_picker)this.widget).isSelectedDay, enabled: !((_Day__calendar_date_picker)this.widget).isDisabled, excludeSemantics: true, child: dayWidget__46020));
        if (!((_Day__calendar_date_picker)this.widget).isDisabled)
        {
            dayWidget__46020 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new InkResponse(focusNode: ((_Day__calendar_date_picker)this.widget).focusNode, onTap: (() => { this.widget.onChanged(((_Day__calendar_date_picker)this.widget).day); }), statesController: this._statesController, overlayColor: dayOverlayColor__45059, customBorder: dayShape__45284, containedInkWell: true, child: dayWidget__46020));
        }
...
internal class _DayPickerGridDelegate__calendar_date_picker : global::Doroti.Framework.Rendering.SliverGridDelegate
{
    ...
    public virtual global::Doroti.Framework.Rendering.SliverGridLayout getLayout(global::Doroti.Framework.Rendering.SliverConstraints constraints)
    {
        ...
        global::Doroti.Framework.Widgets.Orientation orientation__48343 = MediaQuery.orientationOf(this.context);
        double dayPickerRowHeight__48409 = ((Theme.of(this.context).useMaterial3 && (object.Equals(orientation__48343, global::Doroti.Framework.Widgets.Orientation.portrait))) ? Calendar_date_pickerLibrary._dayPickerRowHeightM3 : Calendar_date_pickerLibrary._dayPickerRowHeightM2);
        ...
        double tileWidth__48787 = (((global::Doroti.Framework.Rendering.SliverConstraints)constraints).crossAxisExtent / columnCount__48734);
        double tileHeight__48859 = Math.Min(scaledRowHeight__48590, (((global::Doroti.Framework.Rendering.SliverConstraints)constraints).viewportMainAxisExtent / ((Calendar_date_pickerLibrary._maxDayPickerRowCount + 1L))));
        return ((global::Doroti.Framework.Rendering.SliverGridLayout)(object?)new global::Doroti.Framework.Rendering.SliverGridRegularTileLayout(childCrossAxisExtent: tileWidth__48787, childMainAxisExtent: tileHeight__48859, crossAxisCount: columnCount__48734, crossAxisStride: tileWidth__48787, mainAxisStride: tileHeight__48859, reverseCrossAxis: global::Doroti.Framework.Painting.Basic_typesLibrary.axisDirectionIsReversed(((global::Doroti.Framework.Rendering.SliverConstraints)constraints).crossAxisDirection)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _YearPickerState__calendar_date_picker : global::Doroti.Framework.Widgets.State<YearPicker>
{
    ...
    internal virtual global::Doroti.Framework.Widgets.Widget _buildYearItem(global::Doroti.Framework.Widgets.BuildContext context, long index)
    {
        ...
        var states__54084 = ((Func<HashSet<global::Doroti.Framework.Widgets.WidgetState>>)(() => { var __collection54093 = new HashSet<global::Doroti.Framework.Widgets.WidgetState>(); if (isDisabled__53880) { __collection54093.Add(global::Doroti.Framework.Widgets.WidgetState.disabled); } if (isSelected__53758) { __collection54093.Add(global::Doroti.Framework.Widgets.WidgetState.selected); } return __collection54093; }))();
        ...
        global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?> overlayColor__54621 = ((global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>)(object?)WidgetStateProperty.resolveWith<global::Doroti.Ui.Color?>(((global::System.Func<HashSet<global::Doroti.Framework.Widgets.WidgetState>, global::Doroti.Ui.Color?>)((states) => effectiveValue(((theme) => theme?.yearOverlayColor?.resolve(states)))))));
        global::Doroti.Framework.Painting.OutlinedBorder yearShape__54845 = resolve<global::Doroti.Framework.Painting.OutlinedBorder?>(((theme) => theme?.yearShape), states__54084)!;
        global::Doroti.Framework.Painting.BorderSide? borderSide__54978 = default!;
        ...
        var decoration__55203 = new global::Doroti.Framework.Painting.ShapeDecoration(color: background__54410, shape: yearShape__54845.copyWith(side: borderSide__54978));
        global::Doroti.Framework.Painting.TextStyle? itemStyle__55338 = ((global::Doroti.Framework.Painting.TextStyle?)(object?)((datePickerTheme__52839.yearStyle ?? defaults__52916.yearStyle))?.apply(color: textColor__54221));
        MaterialLocalizations localizations__55471 = ((MaterialLocalizations)(object?)MaterialLocalizations.of(context));
        global::Doroti.Framework.Widgets.Widget yearItem__55533 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Center(child: new global::Doroti.Framework.Widgets.Container(decoration: decoration__55203, height: decorationHeight__53971, width: decorationWidth__54031, alignment: global::Doroti.Framework.Painting.Alignment.center, child: new global::Doroti.Framework.Widgets.Semantics(selected: isSelected__53758, enabled: !isDisabled__53880, button: true, child: new global::Doroti.Framework.Widgets.Text(((YearPicker)this.widget).calendarDelegate.formatYear(year__53701, localizations__55471), style: itemStyle__55338)))));
        if (!isDisabled__53880)
        {
            ...
            yearItem__55533 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new InkWell(key: new global::Doroti.Framework.Foundation.ValueKey<long>(year__53701), onTap: (() => { this.widget.onChanged(date__55989); }), statesController: this._statesController, overlayColor: overlayColor__54621, child: yearItem__55533));
        }
...
internal class _YearPickerGridDelegate__calendar_date_picker : global::Doroti.Framework.Rendering.SliverGridDelegate
{
    ...
    public virtual global::Doroti.Framework.Rendering.SliverGridLayout getLayout(global::Doroti.Framework.Rendering.SliverConstraints constraints)
    {
        ...
        double tileWidth__58322 = Math.Max((((((global::Doroti.Framework.Rendering.SliverConstraints)constraints).crossAxisExtent - (((scaledYearPickerColumnCount__58181 - 1L)) * Calendar_date_pickerLibrary._yearPickerRowSpacing))) / scaledYearPickerColumnCount__58181), 0.0);
