...
public class ElevatedButton : ButtonStyleButton
{
    ...
    public static ElevatedButton CreateIcon(
        Key? key = null,
        Action? onPressed = default!,
        Action? onLongPress = null,
        Action<bool>? onHover = null,
    ...
    {
        var __instance = new ElevatedButton(
            key: key,
            onPressed: onPressed,
            onLongPress: onLongPress,
            onHover: onHover,
            ...
            child: icon is null
                ? label
                : new _ElevatedButtonWithIconChild__elevated_button(
                    label: label,
                    icon: icon,
                    buttonStyle: style,
    ...
    )
    {
        WidgetStateProperty<Color?>? overlayColorProp = (WidgetStateProperty<Color?>?)(
            (foregroundColor, overlayColor) switch
            {
                ...
                (_, Color { a: 0.0 } __object7732) => DartRuntimePrimitives.ConvertValue<
        ...
        return new ButtonStyle(
            ...
            iconAlignment: iconAlignment,
            elevation: DartRuntimePrimitives.ConvertValue<WidgetStateProperty<double?>>(
                elevationValue
            ),
...
internal class _ElevatedButtonWithIconChild__elevated_button : StatelessWidget
{
    ...
    internal _ElevatedButtonWithIconChild__elevated_button(
        Widget label,
        Widget icon,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        IconAlignment effectiveIconAlignment =
            (
                (iconAlignment ?? elevatedButtonTheme.style?.iconAlignment)
...
internal class _ElevatedButtonDefaultsM3__elevated_button : ButtonStyle
{
    ...
    internal _ElevatedButtonDefaultsM3__elevated_button(BuildContext context)
        : base(
    ...
    public override WidgetStateProperty<EdgeInsetsGeometry?>? padding =>
        DartRuntimePrimitives.ConvertValue<WidgetStateProperty<EdgeInsetsGeometry?>>(
            new WidgetStatePropertyAll<EdgeInsetsGeometry>(
                Elevated_buttonLibrary._scaledPadding(context)
            )
        );
