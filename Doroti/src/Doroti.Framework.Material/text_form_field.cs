...
public class TextFormField : FormField<string>
{
    ...
    public TextFormField(
        ...
        : base(
            ...
            initialValue: (controller is not null) ? controller.text : (initialValue ?? ""),
            ...
            builder: (field) =>
            {
                ...
                InputDecoration effectiveDecoration = (
                    ...
                    InputDecorationTheme.of(((_TextFormFieldState__text_form_field)field).context)
                );
                ...
                if (errorTextLocal is not null)
                {
                    effectiveDecoration =
                        (errorBuilder is not null)
                            ...
                            : effectiveDecoration.copyWith(errorText: errorTextLocal);
                }
                ...
                return new UnmanagedRestorationScope(
                    bucket: ((_TextFormFieldState__text_form_field)field).bucket,
                    child: new TextField(
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _TextFormFieldState__text_form_field());
}
...
internal class _TextFormFieldState__text_form_field : FormFieldState<string>
{
    ...
    public override void didUpdateWidget(FormField<string> oldWidget)
    {
        ...
        if (!Equals(_textFormField.controller, ((TextFormField)oldWidget).controller))
        {
            ...
            _textFormField.controller?.addListener(_handleControllerChanged);
            if (
                (((TextFormField)oldWidget).controller is not null)
                && (_textFormField.controller is null)
            )
            {
