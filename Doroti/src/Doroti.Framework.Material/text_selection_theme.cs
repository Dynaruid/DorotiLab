...
public class TextSelectionThemeData : Diagnosticable
{
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new ColorProperty("selectionHandleColor", selectionHandleColor, defaultValue: null));
    }
...
public class TextSelectionTheme : InheritedTheme
{
    ...
    public TextSelectionTheme(Key? key = null, TextSelectionThemeData data = default!, Widget child = default!) : base(key: key, child: new _NullWidget__text_selection_theme())
    {
        this.data = data;
        _child = child;
    }
    ...
    public override Widget child
    {
        get
        {
            return new DefaultSelectionStyle(selectionColor: data.selectionColor, cursorColor: data.cursorColor, child: _child);
        }
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((TextSelectionTheme)oldWidget).data));
}
