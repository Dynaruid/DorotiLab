...
public class SegmentedButton<T> : global::Doroti.Framework.Widgets.StatefulWidget where T : notnull
{
    ...
    public SegmentedButton(global::Doroti.Framework.Foundation.Key? key = null, List<ButtonSegment<T>> segments = default!, HashSet<T> selected = default!, global::System.Action<HashSet<T>>? onSelectionChanged = null, bool multiSelectionEnabled = false, bool emptySelectionAllowed = false, global::Doroti.Framework.Painting.EdgeInsets? expandedInsets = null, ButtonStyle? style = null, bool showSelectedIcon = true, global::Doroti.Framework.Widgets.Widget? selectedIcon = null, global::Doroti.Framework.Painting.Axis direction = Axis.horizontal) : base(key: key)
    {
...
public class SegmentedButtonState<T> : global::Doroti.Framework.Widgets.State<SegmentedButton<T>> where T : notnull
{
