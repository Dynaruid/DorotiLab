...
public static partial class Progress_indicatorLibrary
{
    internal static string _kValueControllerAssertion =
...
public abstract class ProgressIndicator : StatefulWidget
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new PercentProperty("value", value, showName: false, ifNull: "<indeterminate>")
        );
    }
...
internal class _LinearProgressIndicatorPainter__progress_indicator : CustomPainter
{
    ...
    public static Curve line1Head = new Interval(
        0.0,
        750.0 / Progress_indicatorLibrary._kIndeterminateLinearDuration,
        curve: new Cubic(0.2, 0.0, 0.8, 1.0)
    );
    public static Curve line1Tail = new Interval(
        333.0 / Progress_indicatorLibrary._kIndeterminateLinearDuration,
        (333.0 + 750.0) / Progress_indicatorLibrary._kIndeterminateLinearDuration,
        curve: new Cubic(0.4, 0.0, 1.0, 1.0)
    );
    public static Curve line2Head = new Interval(
        1000.0 / Progress_indicatorLibrary._kIndeterminateLinearDuration,
        (1000.0 + 567.0) / Progress_indicatorLibrary._kIndeterminateLinearDuration,
        curve: new Cubic(0.0, 0.0, 0.65, 1.0)
    );
    public static Curve line2Tail = new Interval(
        1267.0 / Progress_indicatorLibrary._kIndeterminateLinearDuration,
        (1267.0 + 533.0) / Progress_indicatorLibrary._kIndeterminateLinearDuration,
        curve: new Cubic(0.1, 0.0, 0.45, 1.0)
    );
    ...
    internal _LinearProgressIndicatorPainter__progress_indicator(
        ...
        BorderRadiusGeometry? indicatorBorderRadius = default!,
        Color? stopIndicatorColor = default!,
        double? stopIndicatorRadius = default!,
        double? trackGap = default!
    )
    {
    ...
    public override void paint(Canvas canvas, Size size)
    {
        ...
        void drawStopIndicator()
        {
            ...
            Offset position = textDirection switch
            {
        ...
        {
            double trackStartFractionLocal =
                (firstLineHead > 0L)
                    ? (
                        firstLineHead
                        + getEffectiveTrackGapFraction(firstLineHead, trackGapFractionLocal)
                    )
                    : 0;
            drawLinearIndicator(
                startFraction: trackStartFractionLocal,
                endFraction: 1,
                color: trackColor
            );
        }
        ...
        {
            double trackStartFractionAlternate =
                (secondLineHead > 0L)
                    ? (
                        secondLineHead
                        + getEffectiveTrackGapFraction(secondLineHead, trackGapFractionLocal)
                    )
                    : 0;
            double trackEndFraction =
                (firstLineTail < 1L)
                    ? (
                        firstLineTail
                        - getEffectiveTrackGapFraction(1L - firstLineTail, trackGapFractionLocal)
                    )
                    : 1;
            drawLinearIndicator(
                startFraction: trackStartFractionAlternate,
        ...
        {
            double trackEndFractionLocal =
                (secondLineTail < 1L)
                    ? (
                        secondLineTail
                        - getEffectiveTrackGapFraction(1L - secondLineTail, trackGapFractionLocal)
                    )
                    : 1;
            drawLinearIndicator(
                startFraction: 0,
                endFraction: trackEndFractionLocal,
                color: trackColor
            );
        }
    }
    ...
    public override bool shouldRepaint(CustomPainter oldDelegate)
    {
        ...
        return (!Equals(__oldPainter.trackColor, trackColor))
            || (!Equals(__oldPainter.valueColor, valueColor))
            || (__oldPainter.value != value)
            || (__oldPainter.animationValue != animationValue)
            || (!Equals(__oldPainter.textDirection, textDirection))
            || (!Equals(__oldPainter.indicatorBorderRadius, indicatorBorderRadius))
...
public class LinearProgressIndicator : ProgressIndicator
{
    ...
    public static Duration defaultAnimationDuration = Duration.Create(
        milliseconds: Progress_indicatorLibrary._kIndeterminateLinearDuration
    );
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _LinearProgressIndicatorState__progress_indicator()
        );
}

internal class _LinearProgressIndicatorState__progress_indicator
        ...
        SingleTickerProviderStateMixin<LinearProgressIndicator>
{
    ...
    {
        base.initState();
        _internalController = new AnimationController(
    ...
    internal virtual AnimationController _controller =>
        DartRuntimePrimitives.ConvertValue<AnimationController>(
            (
                (
                    widget.controller
                    ?? context
                ...
                ?? context
                    ...
                    ?.data.progressIndicatorTheme.controller
            ) ?? _internalController
        );
    ...
    internal virtual Widget _buildIndicator(
    ...
    )
    {
        ...
        ProgressIndicatorThemeData defaults = year2023Local
            ? new _LinearProgressIndicatorDefaultsM3Year2023__progress_indicator(context)
            : new _LinearProgressIndicatorDefaultsM3__progress_indicator(context);
        Color trackColorLocal =
            (widget.backgroundColor ?? indicatorTheme.linearTrackColor)
        ...
        Color? stopIndicatorColorLocal = !year2023Local
            ...
            : null;
        double? stopIndicatorRadiusLocal = !year2023Local
            ? (
                (widget.stopIndicatorRadius ?? indicatorTheme.stopIndicatorRadius)
                ?? defaults.stopIndicatorRadius
            )
            : null;
        double? trackGapLocal = !year2023Local
        ...
        Widget result = new ConstrainedBox(
            ...
            child: new CustomPaint(
                painter: new _LinearProgressIndicatorPainter__progress_indicator(
                    trackColor: trackColorLocal,
                    valueColor: widget._getValueColor(context, defaultColor: defaults.color),
                    value: widget._effectiveValue,
                    animationValue: animationValue,
                    textDirection: textDirection,
                    indicatorBorderRadius: borderRadiusLocal,
                    stopIndicatorColor: stopIndicatorColorLocal,
                    stopIndicatorRadius: stopIndicatorRadiusLocal,
                    trackGap: trackGapLocal
                )
            )
        );
        if ((borderRadiusLocal is not null) && (widget._effectiveValue is null))
        {
            result = DartRuntimePrimitives.ConvertValue<Widget>(
                new ClipRRect(borderRadius: borderRadiusLocal, child: result)
            );
        }
...
internal class _CircularProgressIndicatorPainter__progress_indicator : CustomPainter
{
    ...
    internal _CircularProgressIndicatorPainter__progress_indicator(
        ...
        double headValue = default!,
        double tailValue = default!,
        double offsetValue = default!,
        double rotationValue = default!,
        double strokeWidth = default!,
    ...
    public override bool shouldRepaint(CustomPainter oldDelegate)
    {
        ...
        return (!Equals(__oldPainter.trackColor, trackColor))
            || (!Equals(__oldPainter.valueColor, valueColor))
            || (__oldPainter.value != value)
            || (__oldPainter.headValue != headValue)
            || (__oldPainter.tailValue != tailValue)
            || (__oldPainter.offsetValue != offsetValue)
            || (__oldPainter.rotationValue != rotationValue)
            || (__oldPainter.strokeWidth != strokeWidth)
            || (__oldPainter.strokeAlign != strokeAlign)
...
{
    internal virtual _ActivityIndicatorType__progress_indicator _indicatorType
    {
        get;
        private set;
    } = default!;
    ...
    public static Duration defaultAnimationDuration = Duration.Create(
        milliseconds: Progress_indicatorLibrary._kIndeterminateCircularDuration
    );
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _CircularProgressIndicatorState__progress_indicator()
        );
}

internal class _CircularProgressIndicatorState__progress_indicator
    : State<CircularProgressIndicator>,
        SingleTickerProviderStateMixin<CircularProgressIndicator>
{
    internal static long _pathCount = checked(
        Progress_indicatorLibrary._kIndeterminateCircularDuration / 1333L
    );
    internal static long _rotationCount = checked(
        Progress_indicatorLibrary._kIndeterminateCircularDuration / 2222L
    );
    internal static Animatable<double> _strokeHeadTween = new CurveTween(
        curve: new Interval(0.0, 0.5, curve: Curves.fastOutSlowIn)
    ).chain(new CurveTween(curve: new SawTooth(_pathCount)));
    internal static Animatable<double> _strokeTailTween = new CurveTween(
        curve: new Interval(0.5, 1.0, curve: Curves.fastOutSlowIn)
    ).chain(new CurveTween(curve: new SawTooth(_pathCount)));
    internal static Animatable<double> _offsetTween = new CurveTween(
        curve: new SawTooth(_pathCount)
    );
    internal static Animatable<double> _rotationTween = new CurveTween(
        curve: new SawTooth(_rotationCount)
    );
    internal virtual AnimationController _internalController { get; private set; } = default!;
    public virtual Scheduler.Ticker? _ticker { get; set; } = default;
    public virtual ValueListenable<TickerModeData>? _tickerModeNotifier { get; set; } = default;
    ...
    )
    {
        ...
        ProgressIndicatorThemeData defaults = year2023Local
            ? new _CircularProgressIndicatorDefaultsM3Year2023__progress_indicator(
                context,
                indeterminate: widget._effectiveValue is null
            )
            : new _CircularProgressIndicatorDefaultsM3__progress_indicator(
                context,
                indeterminate: widget._effectiveValue is null
            );
        Color? trackColorLocal =
        ...
        EdgeInsetsGeometry? effectivePadding =
            (widget.padding ?? indicatorTheme.circularTrackPadding)
            ?? defaults.circularTrackPadding;
        Widget result = new ConstrainedBox(
            constraints: constraintsLocal,
            child: new CustomPaint(
                painter: new _CircularProgressIndicatorPainter__progress_indicator(
                    trackColor: trackColorLocal,
                    valueColor: widget._getValueColor(context, defaultColor: defaults.color),
                    value: widget._effectiveValue,
                    headValue: headValue,
                    ...
                    strokeWidth: strokeWidthLocal,
                    strokeAlign: strokeAlignLocal,
                    strokeCap: strokeCapLocal,
                    trackGap: trackGapLocal,
                    year2023: year2023Local
                )
            )
        );
        ...
        {
            result = DartRuntimePrimitives.ConvertValue<Widget>(
                new Padding(padding: effectivePadding, child: result)
            );
        }
        return widget._buildSemanticsWrapper(context: context, child: result);
    }
...
internal class _RefreshProgressIndicatorPainter__progress_indicator
    : _CircularProgressIndicatorPainter__progress_indicator
{
...
public class RefreshProgressIndicator : CircularProgressIndicator
{
    ...
    public RefreshProgressIndicator(
        ...
        EdgeInsetsGeometry indicatorMargin = default!,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _RefreshProgressIndicatorState__progress_indicator()
        );
}

internal class _RefreshProgressIndicatorState__progress_indicator
    : _CircularProgressIndicatorState__progress_indicator
{
    ...
    internal virtual Animatable<double> _convertTween
    {
        get
        {
            ...
            {
                __late__convertTween = new CurveTween(
                    curve: new Interval(0.1, _strokeHeadInterval)
                );
    ...
    internal virtual Animatable<double> _additionalRotationTween
    {
        get
        {
            ...
            {
                __late__additionalRotationTween = new TweenSequence<double>(
                    new List<TweenSequenceItem<double>>
                    {
                        new TweenSequenceItem<double>(
                            tween: new Tween<double>(begin: -0.1, end: -0.2),
                            weight: _strokeHeadInterval
                        ),
                        new TweenSequenceItem<double>(
                            tween: new Tween<double>(begin: -0.2, end: 1.35),
                            weight: 1L - _strokeHeadInterval
                        ),
                    }
                );
    ...
    internal override Widget _buildAnimation()
    {
        return new AnimatedBuilder(
            ...
            builder: (context, child) =>
            {
                return _buildMaterialIndicator(
                    context,
                    1.05 * _strokeHeadTween.transform(_controller.value),
                    _strokeTailTween.transform(_controller.value),
    ...
    )
    {
        ...
        ProgressIndicatorThemeData defaults =
            DartRuntimePrimitives.ConvertValue<ProgressIndicatorThemeData>(
                new _CircularProgressIndicatorDefaultsM3Year2023__progress_indicator(
                    context,
                    indeterminate: valueLocal is null
                )
            );
        ProgressIndicatorThemeData indicatorTheme = ProgressIndicatorTheme.of(context);
        Color backgroundColorLocal =
            (widget.backgroundColor ?? indicatorTheme.refreshBackgroundColor)
                        ...
                        child: new Padding(
                            ...
                            child: new Opacity(
                                ...
                                child: Transform.CreateRotate(
                                    angle: rotation,
                                    child: new CustomPaint(
                                        painter: new _RefreshProgressIndicatorPainter__progress_indicator(
                                            valueColor: valueColorLocal,
                                            value: null,
                                            headValue: headValue,
                                            tailValue: tailValue,
                                            offsetValue: offsetValue,
                                            ...
                                            strokeWidth: strokeWidthLocal,
                                            strokeAlign: strokeAlignLocal,
                                            arrowheadScale: arrowheadScaleLocal,
                                            strokeCap: strokeCapLocal
                                        )
                                    )
                                )
...
internal class _CircularProgressIndicatorDefaultsM3Year2023__progress_indicator
    : ProgressIndicatorThemeData
{
    ...
    internal _CircularProgressIndicatorDefaultsM3Year2023__progress_indicator(
        BuildContext context,
        bool indeterminate
    )
    {
    ...
    public override BoxConstraints constraints =>
        new BoxConstraints(minWidth: 36.0, minHeight: 36.0);
}

internal class _LinearProgressIndicatorDefaultsM3Year2023__progress_indicator
    : ProgressIndicatorThemeData
{
    public virtual BuildContext context { get; private set; } = default!;
    private bool __late__colors_initialized;
    ...
    public override Color color => DartRuntimePrimitives.ConvertValue<Color>(_colors.primary);
    public override Color linearTrackColor =>
...
internal class _CircularProgressIndicatorDefaultsM3__progress_indicator : ProgressIndicatorThemeData
{
    ...
    internal _CircularProgressIndicatorDefaultsM3__progress_indicator(
        BuildContext context,
        bool indeterminate
    )
    {
    ...
    public override Color color => DartRuntimePrimitives.ConvertValue<Color>(_colors.primary);
    public override Color? circularTrackColor =>
    ...
    public override BoxConstraints constraints =>
        new BoxConstraints(minWidth: 40.0, minHeight: 40.0);
    public override double? trackGap => 4.0;
    public override EdgeInsetsGeometry? circularTrackPadding =>
        DartRuntimePrimitives.ConvertValue<EdgeInsetsGeometry>(EdgeInsets.CreateAll(4.0));
}
...
internal class _LinearProgressIndicatorDefaultsM3__progress_indicator : ProgressIndicatorThemeData
{
    ...
    public override Color stopIndicatorColor =>
        DartRuntimePrimitives.ConvertValue<Color>(_colors.primary);
    public override double? stopIndicatorRadius =>
        DartRuntimePrimitives.ConvertValue<double>(4.0 / 2L);
    public override double? trackGap => 4.0;
}
