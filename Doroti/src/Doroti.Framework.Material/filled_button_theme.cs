...
public class FilledButtonThemeData : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return ((__other is FilledButtonThemeData) && (Equals(((FilledButtonThemeData)((FilledButtonThemeData)__other)).style, this.style)));
    }
...
public class FilledButtonTheme : global::Doroti.Framework.Widgets.InheritedTheme
{
    ...
    {
        FilledButtonTheme? buttonTheme = ((FilledButtonTheme?)context.dependOnInheritedWidgetOfExactType<FilledButtonTheme>());
    ...
    {
        return ((global::Doroti.Framework.Widgets.Widget)new FilledButtonTheme(data: this.data, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override bool updateShouldNotify(global::Doroti.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>((!Equals(this.data, ((FilledButtonTheme)oldWidget).data)));
}
