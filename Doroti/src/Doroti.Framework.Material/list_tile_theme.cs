...
public class ListTileThemeData : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    {
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<bool>("dense", this.dense, defaultValue: null));
        ...
        properties.add(new global::Doroti.Framework.Foundation.EnumProperty<ListTileStyle>("style", this.style, defaultValue: null));
        ...
        properties.add(new global::Doroti.Framework.Foundation.DoubleProperty("minTileHeight", this.minTileHeight, defaultValue: null));
        ...
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<ListTileControlAffinity>("controlAffinity", this.controlAffinity, defaultValue: null));
...
public class ListTileTheme : global::Doroti.Framework.Widgets.InheritedTheme
{
    ...
    public virtual global::Doroti.Framework.Painting.ShapeBorder? shape => ((this._data is not null) ? ((ListTileThemeData)this._data).shape : this._shape);
    ...
    public virtual global::Doroti.Framework.Painting.EdgeInsetsGeometry? contentPadding => ((this._data is not null) ? ((ListTileThemeData)this._data).contentPadding : this._contentPadding);
