...
public class ListTileThemeData : Diagnosticable
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is ListTileThemeData)
            && (__other.dense == dense)
            ...
            && Equals(__other.subtitleTextStyle, subtitleTextStyle)
            && Equals(__other.leadingAndTrailingTextStyle, leadingAndTrailingTextStyle)
            && Equals(__other.textColor, textColor)
            && Equals(__other.contentPadding, contentPadding)
            && Equals(__other.tileColor, tileColor)
            && Equals(__other.selectedTileColor, selectedTileColor)
            && (__other.horizontalTitleGap == horizontalTitleGap)
            && (__other.minVerticalPadding == minVerticalPadding)
            && (__other.minLeadingWidth == minLeadingWidth)
            && (__other.minTileHeight == minTileHeight)
            && (__other.enableFeedback == enableFeedback)
            && Equals(__other.mouseCursor, mouseCursor)
            && Equals(__other.visualDensity, visualDensity)
            && Equals(__other.titleAlignment, titleAlignment)
            && Equals(__other.controlAffinity, controlAffinity)
            && (__other.isThreeLine == isThreeLine);
    }
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DiagnosticsProperty<ListTileControlAffinity>(
                "controlAffinity",
                controlAffinity,
                defaultValue: null
            )
        ...
        properties.add(
            new DiagnosticsProperty<bool>("isThreeLine", isThreeLine, defaultValue: null)
        );
    }
...
public class ListTileTheme : InheritedTheme
{
    ...
    public virtual Color? selectedColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.selectedColor : _selectedColor
        );
    ...
    public virtual Color? textColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.textColor : _textColor
        );
    ...
    public virtual Color? tileColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.tileColor : _tileColor
        );
    public virtual Color? selectedTileColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.selectedTileColor : _selectedTileColor
        );
    public virtual double? horizontalTitleGap =>
        (_data is not null) ? _data.horizontalTitleGap : _horizontalTitleGap;
    public virtual double? minVerticalPadding =>
        (_data is not null) ? _data.minVerticalPadding : _minVerticalPadding;
    public virtual double? minLeadingWidth =>
        (_data is not null) ? _data.minLeadingWidth : _minLeadingWidth;
    public virtual bool? enableFeedback =>
        (_data is not null) ? _data.enableFeedback : _enableFeedback;
    public virtual ListTileControlAffinity? controlAffinity =>
        (_data is not null) ? _data.controlAffinity : _controlAffinity;
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((ListTileTheme)oldWidget).data));
}
