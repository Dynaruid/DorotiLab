...
public class Drawer : global::Doroti.Framework.Widgets.StatelessWidget
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        string? labelLocal = PlatformLibrary.defaultTargetPlatform switch { TargetPlatform.iOS => semanticLabel, TargetPlatform.macOS => semanticLabel, TargetPlatform.android or TargetPlatform.fuchsia or TargetPlatform.linux => semanticLabel ?? MaterialLocalizations.of(context).drawerLabel, TargetPlatform.windows => semanticLabel ?? MaterialLocalizations.of(context).drawerLabel, _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") };
        ...
        global::Doroti.Framework.Painting.ShapeBorder? effectiveShape = shape ?? (isDrawerStart ? (drawerTheme.shape ?? defaults.shape) : (drawerTheme.endShape ?? defaults.endShape));
        return new global::Doroti.Framework.Widgets.Semantics(scopesRoute: true, namesRoute: true, explicitChildNodes: true, label: labelLocal, child: new global::Doroti.Framework.Widgets.ConstrainedBox(constraints: BoxConstraints.CreateExpand(width: (width ?? drawerTheme.width) ?? DrawerLibrary._kWidth), child: new Material(color: (backgroundColor ?? drawerTheme.backgroundColor) ?? defaults.backgroundColor, elevation: (elevation ?? drawerTheme.elevation) ?? DartRuntimePrimitives.RequireValue(defaults.elevation), shadowColor: (shadowColor ?? drawerTheme.shadowColor) ?? defaults.shadowColor, surfaceTintColor: (surfaceTintColor ?? drawerTheme.surfaceTintColor) ?? defaults.surfaceTintColor, shape: effectiveShape, clipBehavior: (effectiveShape is not null) ? ((clipBehavior ?? drawerTheme.clipBehavior) ?? DartRuntimePrimitives.RequireValue(defaults.clipBehavior)) : Clip.none, child: child)));
    }
...
public class DrawerControllerState : global::Doroti.Framework.Widgets.State<DrawerController>, global::Doroti.Framework.Widgets.SingleTickerProviderStateMixin<DrawerController>
{
    ...
    {
        base.initState();
        _controller = new global::Doroti.Framework.Animation.AnimationController(value: widget.isDrawerOpen ? 1.0 : 0.0, duration: DrawerLibrary._kBaseSettleDuration, vsync: this);
        DartRuntimePrimitives.Ignore(((Func<global::Doroti.Framework.Animation.AnimationController>)(() =>
{
    ...
    internal virtual void _ensureHistoryEntry()
    {
        if (_historyEntry is null)
        {
            ...
            {
                _historyEntry = new global::Doroti.Framework.Widgets.LocalHistoryEntry(onRemove: () => _handleHistoryEntryRemoved(), impliesAppBarDismissal: false);
    ...
    internal virtual double _width
    {
        get
        {
            var box = ((global::Doroti.Framework.Rendering.RenderBox?)_drawerKey.currentContext?.findRenderObject())!;
    ...
    internal virtual global::Doroti.Framework.Painting.AlignmentDirectional _drawerOuterAlignment => widget.alignment switch { DrawerAlignment.start => AlignmentDirectional.centerStart, DrawerAlignment.end => AlignmentDirectional.centerEnd, _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") };
    internal virtual global::Doroti.Framework.Painting.AlignmentDirectional _drawerInnerAlignment => widget.alignment switch { DrawerAlignment.start => AlignmentDirectional.centerEnd, DrawerAlignment.end => AlignmentDirectional.centerStart, _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") };
    internal virtual global::Doroti.Framework.Widgets.Widget _buildDrawer(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        double dragAreaWidth = widget.edgeDragWidth ?? (DrawerLibrary._kEdgeDragWidth + ((widget.alignment, Directionality.of(context)) switch { (DrawerAlignment.start, TextDirection.ltr) => MediaQuery.paddingOf(context).left, (DrawerAlignment.start, TextDirection.rtl) => MediaQuery.paddingOf(context).right, (DrawerAlignment.end, TextDirection.rtl) => MediaQuery.paddingOf(context).left, (DrawerAlignment.end, TextDirection.ltr) => MediaQuery.paddingOf(context).right, _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") }));
        if (_controller.isDismissed)
        {
            if (widget.enableOpenDragGesture && !isDesktop)
            {
                return new global::Doroti.Framework.Widgets.Align(alignment: _drawerOuterAlignment, child: new global::Doroti.Framework.Widgets.GestureDetector(key: _gestureDetectorKey, onHorizontalDragUpdate: _move, onHorizontalDragEnd: _settle, behavior: HitTestBehavior.translucent, excludeFromSemantics: true, dragStartBehavior: widget.dragStartBehavior, child: new global::Doroti.Framework.Widgets.LimitedBox(maxHeight: 0.0, child: new global::Doroti.Framework.Widgets.SizedBox(width: dragAreaWidth, height: double.PositiveInfinity))));
            }
            else
            {
        ...
        else
        {
            ...
            global::Doroti.Ui.Color scrimColorLocal = (widget.scrimColor ?? DrawerTheme.of(context).scrimColor) ?? Colors.black54;
            global::Doroti.Ui.Color effectiveScrimColor = scrimColorLocal.withValues(alpha: scrimColorLocal.a * _controller.value);
            global::Doroti.Framework.Widgets.Widget drawerScrim = new global::Doroti.Framework.Widgets.ColoredBox(color: effectiveScrimColor, child: new global::Doroti.Framework.Widgets.LimitedBox(maxWidth: 0.0, maxHeight: 0.0, child: SizedBox.CreateExpand()));
            global::Doroti.Framework.Widgets.Widget childLocal = new _DrawerControllerScope__drawer(controller: widget, child: new global::Doroti.Framework.Widgets.RepaintBoundary(child: new global::Doroti.Framework.Widgets.Stack(children: new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.BlockSemantics(child: new global::Doroti.Framework.Widgets.ExcludeSemantics(excluding: platformHasBackButton, child: new global::Doroti.Framework.Widgets.GestureDetector(onTap: widget.drawerBarrierDismissible ? close : null, child: new global::Doroti.Framework.Widgets.Semantics(label: MaterialLocalizations.of(context).modalBarrierDismissLabel, child: drawerScrim))))), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Align(alignment: _drawerOuterAlignment, child: new global::Doroti.Framework.Widgets.Align(alignment: _drawerInnerAlignment, widthFactor: _controller.value, child: new global::Doroti.Framework.Widgets.RepaintBoundary(child: new global::Doroti.Framework.Widgets.FocusScope(key: _drawerKey, node: _focusScopeNode, child: widget.child))))) })));
            if (isDesktop)
            {
                return childLocal;
            }
            return new global::Doroti.Framework.Widgets.GestureDetector(key: _gestureDetectorKey, onHorizontalDragDown: _handleDragDown, onHorizontalDragUpdate: _move, onHorizontalDragEnd: _settle, onHorizontalDragCancel: () => _handleDragCancel(), excludeFromSemantics: true, dragStartBehavior: widget.dragStartBehavior, child: childLocal);
        }
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _DrawerDefaultsM3__drawer : DrawerThemeData
{
    ...
    public override global::Doroti.Ui.Color? backgroundColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Ui.Color>(Theme.of(context).colorScheme.surfaceContainerLow);
