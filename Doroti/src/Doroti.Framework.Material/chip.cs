        ...
        DartRuntimePrimitives.Ignore(((Func<global::Doroti.Framework.Widgets.WidgetStatesController>)(() =>
{
    ...
    __cascade.update(WidgetState.disabled, !((RawChip)this.widget).isEnabled);
    __cascade.update(WidgetState.selected, ((RawChip)this.widget).selected);
    ...
    return __cascade;
        ...
        selectionFade = new global::Doroti.Framework.Animation.CurvedAnimation(parent: this.selectController, curve: Curves.fastOutSlowIn);
        ...
        checkmarkAnimation = new global::Doroti.Framework.Animation.CurvedAnimation(parent: this.selectController, curve: new global::Doroti.Framework.Animation.Interval((1.0 - checkmarkPercentage), 1.0, curve: Curves.fastOutSlowIn), reverseCurve: new global::Doroti.Framework.Animation.Interval((1.0 - checkmarkReversePercentage), 1.0, curve: Curves.fastOutSlowIn));
        deleteDrawerAnimation = new global::Doroti.Framework.Animation.CurvedAnimation(parent: this.deleteDrawerController, curve: Curves.fastOutSlowIn);
        avatarDrawerAnimation = new global::Doroti.Framework.Animation.CurvedAnimation(parent: this.avatarDrawerController, curve: Curves.fastOutSlowIn, reverseCurve: new global::Doroti.Framework.Animation.Interval((1.0 - avatarDrawerReversePercentage), 1.0, curve: Curves.fastOutSlowIn));
        enableAnimation = new global::Doroti.Framework.Animation.CurvedAnimation(parent: this.enableController, curve: Curves.fastOutSlowIn);
    }
    ...
    internal virtual void _handleTapDown(global::Doroti.Framework.Gestures.TapDownDetails details)
    {
        ...
        this.statesController.update(WidgetState.pressed, true);
        setState(((global::System.Action)(() =>
        {
            _isTapping = true;
        })));
    ...
    internal virtual void _handleTapCancel()
    {
        ...
        this.statesController.update(WidgetState.pressed, false);
        setState(((global::System.Action)(() =>
        {
            _isTapping = false;
        })));
    ...
    internal virtual global::Doroti.Framework.Painting.OutlinedBorder _getShape(ThemeData theme, ChipThemeData chipTheme, ChipThemeData chipDefaults)
    {
        ...
        {
            return ((global::Doroti.Framework.Painting.OutlinedBorder)resolvedShape.copyWith(side: resolvedSide));
        }
        return ((!Equals(((global::Doroti.Framework.Painting.OutlinedBorder)resolvedShape).side, BorderSide.none)) ? resolvedShape : resolvedShape.copyWith(side: chipDefaults.side));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    {
        return ((global::Doroti.Ui.Color?)((new _IndividualOverrides__chip(color: color, selectedColor: selectedColor, backgroundColor: backgroundColor, disabledColor: disabledColor).resolve(this.statesController.value) ?? (Color?)defaultColor?.resolve(this.statesController.value))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    {
        {
            global::Doroti.Ui.Color? disabledColorLocal = ((global::Doroti.Ui.Color?)resolveColor(color: (((RawChip)this.widget).color ?? chipTheme.color), disabledColor: (((RawChip)this.widget).disabledColor ?? chipTheme.disabledColor), defaultColor: chipDefaults.color));
            global::Doroti.Ui.Color? backgroundColorLocal = ((global::Doroti.Ui.Color?)resolveColor(color: (((RawChip)this.widget).color ?? chipTheme.color), backgroundColor: (((RawChip)this.widget).backgroundColor ?? chipTheme.backgroundColor), defaultColor: chipDefaults.color));
            global::Doroti.Ui.Color? selectedColorLocal = ((global::Doroti.Ui.Color?)resolveColor(color: (((RawChip)this.widget).color ?? chipTheme.color), selectedColor: (((RawChip)this.widget).selectedColor ?? chipTheme.selectedColor), defaultColor: chipDefaults.color));
            ...
            return ((global::Doroti.Ui.Color?)selectTween.evaluate(this.selectionFade));
        }
    }
    ...
    public override void didUpdateWidget(RawChip oldWidget)
    {
        ...
        if ((((RawChip)oldWidget).isEnabled != ((RawChip)this.widget).isEnabled))
        {
            setState(((global::System.Action)(() =>
            {
                this.statesController.update(WidgetState.disabled, !((RawChip)this.widget).isEnabled);
        ...
        if (((!Equals(((RawChip)oldWidget).avatar, ((RawChip)this.widget).avatar)) || (((RawChip)oldWidget).selected != ((RawChip)this.widget).selected)))
        {
            setState(((global::System.Action)(() =>
            {
        ...
        if ((((RawChip)oldWidget).selected != ((RawChip)this.widget).selected))
        {
            setState(((global::System.Action)(() =>
            {
                this.statesController.update(WidgetState.selected, ((RawChip)this.widget).selected);
        ...
        if ((!Equals((global::System.Action?)((RawChip)oldWidget).onDeleted, (global::System.Action?)((RawChip)this.widget).onDeleted)))
        {
            setState(((global::System.Action)(() =>
            {
    ...
    internal virtual global::Doroti.Framework.Widgets.Widget? _buildDeleteIcon(global::Doroti.Framework.Widgets.BuildContext context, ThemeData theme, ChipThemeData chipTheme, ChipThemeData chipDefaults)
    {
        ...
        global::Doroti.Ui.Color? effectiveDeleteIconColor = ((global::Doroti.Ui.Color?)WidgetStateProperty.resolveAs((((((((RawChip)this.widget).deleteIconColor ?? chipTheme.deleteIconColor) ?? theme.chipTheme.deleteIconColor) ?? ((RawChip)this.widget).iconTheme?.color) ?? chipTheme.iconTheme?.color) ?? chipDefaults.deleteIconColor), this.statesController.value));
        ...
        global::Doroti.Ui.Size semanticSizeLocal = ((global::Doroti.Ui.Size)(effectiveMaterialTapTargetSize switch { var __constant45576 when (Equals(__constant45576, MaterialTapTargetSize.padded)) => new global::Doroti.Ui.Size(ConstantsLibrary.kMinInteractiveDimension), var __constant45659 when (Equals(__constant45659, MaterialTapTargetSize.shrinkWrap)) => new global::Doroti.Ui.Size((ConstantsLibrary.kMinInteractiveDimension - 8.0)), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") }));
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Painting.OutlinedBorder resolvedShape = ((global::Doroti.Framework.Painting.OutlinedBorder)_getShape(themeLocal, chipTheme, chipDefaults));
        ...
        global::Doroti.Ui.Color? shadowColorLocal = ((global::Doroti.Ui.Color?)((((RawChip)this.widget).shadowColor ?? chipTheme.shadowColor) ?? chipDefaults.shadowColor));
        global::Doroti.Ui.Color? surfaceTintColorLocal = ((global::Doroti.Ui.Color?)((((RawChip)this.widget).surfaceTintColor ?? chipTheme.surfaceTintColor) ?? chipDefaults.surfaceTintColor));
        global::Doroti.Ui.Color? selectedShadowColorLocal = ((global::Doroti.Ui.Color?)((((RawChip)this.widget).selectedShadowColor ?? chipTheme.selectedShadowColor) ?? chipDefaults.selectedShadowColor));
        global::Doroti.Ui.Color? checkmarkColorLocal = ((global::Doroti.Ui.Color?)((((RawChip)this.widget).checkmarkColor ?? chipTheme.checkmarkColor) ?? chipDefaults.checkmarkColor));
        ...
        global::Doroti.Framework.Painting.TextStyle effectiveLabelStyle = ((global::Doroti.Framework.Painting.TextStyle)labelStyleLocal.merge(((RawChip)this.widget).labelStyle));
        global::Doroti.Ui.Color? resolvedLabelColor = ((global::Doroti.Ui.Color?)WidgetStateProperty.resolveAs<global::Doroti.Ui.Color?>(((global::Doroti.Framework.Painting.TextStyle)effectiveLabelStyle).color, this.statesController.value));
        global::Doroti.Framework.Painting.TextStyle resolvedLabelStyle = ((global::Doroti.Framework.Painting.TextStyle)effectiveLabelStyle.copyWith(color: resolvedLabelColor));
        ...
        global::Doroti.Framework.Painting.EdgeInsetsGeometry defaultLabelPadding = ((global::Doroti.Framework.Painting.EdgeInsetsGeometry)EdgeInsets.lerp(EdgeInsets.CreateSymmetric(horizontal: 8.0), EdgeInsets.CreateSymmetric(horizontal: 4.0), Dart_uiLibrary.clampDouble((effectiveTextScale - 1.0), 0.0, 1.0))!);
        ...
        {
            this.statesController.update(WidgetState.hovered, value);
        }) : null)), mouseCursor: ((RawChip)this.widget).mouseCursor, hoverColor: ((((((RawChip)this.widget).color ?? chipTheme.color)) is null) ? null : Colors.transparent), customBorder: resolvedShape, child: new global::Doroti.Framework.Widgets.AnimatedBuilder(animation: Listenable.CreateMerge(new List<global::Doroti.Framework.Foundation.Listenable> { this.selectController, this.enableController }.Cast<global::Doroti.Framework.Foundation.Listenable?>()), builder: ((global::System.Func<global::Doroti.Framework.Widgets.BuildContext, global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget>)((context, child) =>
        {
            return ((global::Doroti.Framework.Widgets.Widget)new Ink(decoration: new global::Doroti.Framework.Painting.ShapeDecoration(shape: resolvedShape, color: _getBackgroundColor(themeLocal, chipTheme, chipDefaults)), child: child));
            throw new InvalidOperationException("Dart closure completed without a value.");
        })), child: _wrapWithTooltip(tooltip: ((RawChip)this.widget).tooltip, enabled: ((((RawChip)this.widget).onPressed is not null) || (((RawChip)this.widget).onSelected is not null)), child: new _ChipRenderWidget__chip(theme: new _ChipRenderTheme__chip(label: new global::Doroti.Framework.Widgets.DefaultTextStyle(overflow: TextOverflow.fade, textAlign: TextAlign.start, maxLines: 1L, softWrap: false, style: resolvedLabelStyle, child: ((RawChip)this.widget).label), avatar: new global::Doroti.Framework.Widgets.AnimatedSwitcher(duration: ChipLibrary._kDrawerDuration, switchInCurve: Curves.fastOutSlowIn, child: avatarLocal), deleteIcon: new global::Doroti.Framework.Widgets.AnimatedSwitcher(duration: ChipLibrary._kDrawerDuration, switchInCurve: Curves.fastOutSlowIn, child: _buildDeleteIcon(context, themeLocal, chipTheme, chipDefaults)), brightness: brightnessLocal, padding: paddingLocal.resolve(textDirection), visualDensity: (((RawChip)this.widget).visualDensity ?? themeLocal.visualDensity), labelPadding: labelPaddingLocal.resolve(textDirection), showAvatar: this.hasAvatar, showCheckmark: showCheckmarkLocal, checkmarkColor: checkmarkColorLocal, canTapBody: this.canTap), value: ((RawChip)this.widget).selected, checkmarkAnimation: this.checkmarkAnimation, enableAnimation: this.enableAnimation, avatarDrawerAnimation: this.avatarDrawerAnimation, deleteDrawerAnimation: this.deleteDrawerAnimation, isEnabled: ((RawChip)this.widget).isEnabled, avatarBorder: ((RawChip)this.widget).avatarBorder, avatarBoxConstraints: avatarBoxConstraintsLocal, deleteIconBoxConstraints: deleteIconBoxConstraintsLocal))))));
        global::Doroti.Framework.Rendering.BoxConstraints constraintsLocal = default!;
        global::Doroti.Ui.Offset densityAdjustment = ((global::Doroti.Ui.Offset)((((RawChip)this.widget).visualDensity ?? themeLocal.visualDensity)).baseSizeAdjustment);
        ...
        return ((global::Doroti.Framework.Widgets.Widget)new global::Doroti.Framework.Widgets.Semantics(button: ((RawChip)this.widget).tapEnabled, container: true, selected: (Foundation.ConstantsLibrary.kIsWeb ? null : ((RawChip)this.widget).selected), @checked: (Foundation.ConstantsLibrary.kIsWeb ? ((RawChip)this.widget).selected : null), enabled: (((RawChip)this.widget).tapEnabled ? this.canTap : null), child: result));
    }
...
internal class _IndividualOverrides__chip : global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>
{
    ...
    public virtual Color? resolve(HashSet<global::Doroti.Framework.Widgets.WidgetState> states)
    {
        ...
        {
            return ((Color?)this.color!.resolve(states));
        }
...
internal class _ChipRedirectingHitDetectionWidget__chip : global::Doroti.Framework.Widgets.SingleChildRenderObjectWidget
{
    ...
    {
        return ((global::Doroti.Framework.Rendering.RenderObject)new _RenderChipRedirectingHitDetection__chip(this.constraints));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class _ChipRenderTheme__chip
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (((((((((((__other is _ChipRenderTheme__chip) && (Equals(((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).avatar, this.avatar))) && (Equals(((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).label, this.label))) && (Equals(((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).deleteIcon, this.deleteIcon))) && (Equals(((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).brightness, this.brightness))) && (Equals(((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).padding, this.padding))) && (Equals(((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).labelPadding, this.labelPadding))) && (((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).showAvatar == this.showAvatar)) && (((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).showCheckmark == this.showCheckmark)) && (Equals(((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).checkmarkColor, this.checkmarkColor))) && (((_ChipRenderTheme__chip)((_ChipRenderTheme__chip)__other)).canTapBody == this.canTapBody));
    }
...
public class _RenderChip__chip : global::Doroti.Framework.Rendering.RenderBox, global::Doroti.Framework.Widgets.SlottedContainerRenderObjectMixin<_ChipSlot__chip, global::Doroti.Framework.Rendering.RenderBox>
{
    ...
    public virtual global::Doroti.Framework.Rendering.BoxConstraints? avatarBoxConstraints
    {
        ...
        {
            var __value = value;
            if ((Equals(this._avatarBoxConstraints, __value)))
            {
                return;
            }
    ...
    public virtual global::Doroti.Framework.Rendering.BoxConstraints? deleteIconBoxConstraints
    {
        ...
        {
            var __value = value;
            if ((Equals(this._deleteIconBoxConstraints, __value)))
            {
                return;
            }
    ...
    public virtual IEnumerable<global::Doroti.Framework.Rendering.RenderBox> children
    {
        get
        {
            global::Doroti.Framework.Rendering.RenderBox? avatarLocal = ((global::Doroti.Framework.Rendering.RenderBox?)childForSlot(_ChipSlot__chip.avatar));
            global::Doroti.Framework.Rendering.RenderBox? labelLocal = ((global::Doroti.Framework.Rendering.RenderBox?)childForSlot(_ChipSlot__chip.label));
            global::Doroti.Framework.Rendering.RenderBox? deleteIconLocal = ((global::Doroti.Framework.Rendering.RenderBox?)childForSlot(_ChipSlot__chip.deleteIcon));
            return ((IEnumerable<global::Doroti.Framework.Rendering.RenderBox>)((Func<List<global::Doroti.Framework.Rendering.RenderBox>>)(() => { var __collection64442 = new List<global::Doroti.Framework.Rendering.RenderBox>(); var __collectionElement64454 = avatarLocal; if (__collectionElement64454 is { } __nonNullCollectionElement64454) { __collection64442.Add(__nonNullCollectionElement64454); } var __collectionElement64463 = labelLocal; if (__collectionElement64463 is { } __nonNullCollectionElement64463) { __collection64442.Add(__nonNullCollectionElement64463); } var __collectionElement64471 = deleteIconLocal; if (__collectionElement64471 is { } __nonNullCollectionElement64471) { __collection64442.Add(__nonNullCollectionElement64471); } return __collection64442; }))());
        }
    }
    ...
    internal static global::Doroti.Ui.Rect _boxRect(global::Doroti.Framework.Rendering.RenderBox box) => DartRuntimePrimitives.ConvertValue<global::Doroti.Ui.Rect>((_boxParentData(box).offset & ((global::Doroti.Framework.Rendering.RenderBox)box).size));
    ...
    {
        return ((new global::Doroti.Framework.Rendering.BaselineOffset(this.label.getDistanceToActualBaseline(baseline)).op_Add(_boxParentData(this.label).offset.dy))).offset;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    {
        global::Doroti.Framework.Rendering.BoxConstraints avatarConstraints = (this.avatarBoxConstraints ?? BoxConstraints.CreateTightFor(width: contentSize, height: contentSize));
        global::Doroti.Ui.Size avatarBoxSize = ((global::Doroti.Ui.Size)layoutChild(this.avatar, avatarConstraints));
    ...
    {
        global::Doroti.Framework.Rendering.BoxConstraints deleteIconConstraints = (this.deleteIconBoxConstraints ?? BoxConstraints.CreateTightFor(width: contentSize, height: contentSize));
        global::Doroti.Ui.Size boxSize = ((global::Doroti.Ui.Size)layoutChild(this.deleteIcon, deleteIconConstraints));
    ...
    public override bool hitTest(global::Doroti.Framework.Rendering.BoxHitTestResult result, Offset position)
    {
        ...
        global::Doroti.Ui.Offset centerLocal = ((global::Doroti.Ui.Offset)((global::Doroti.Framework.Rendering.RenderBox)hitTestChild).size.center(Offset.zero));
    ...
    {
        return _computeSizes(constraints, (global::System.Func<global::Doroti.Framework.Rendering.RenderBox, global::Doroti.Framework.Rendering.BoxConstraints, Size>)ChildLayoutHelper.dryLayoutChild).size;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    {
        _ChipSizes__chip sizes = ((_ChipSizes__chip)_computeSizes(constraints, (global::System.Func<global::Doroti.Framework.Rendering.RenderBox, global::Doroti.Framework.Rendering.BoxConstraints, Size>)ChildLayoutHelper.dryLayoutChild));
    ...
    {
        global::Doroti.Framework.Rendering.BoxConstraints contentConstraints = ((global::Doroti.Framework.Rendering.BoxConstraints)constraints.loosen());
        global::Doroti.Ui.Size rawLabelSize = ((global::Doroti.Ui.Size)this.label.getDryLayout(contentConstraints));
        ...
        global::Doroti.Ui.Size avatarSize = ((global::Doroti.Ui.Size)_layoutAvatar(contentSize, (global::System.Func<global::Doroti.Framework.Rendering.RenderBox, global::Doroti.Framework.Rendering.BoxConstraints, Size>)layoutChild));
        global::Doroti.Ui.Size deleteIconSize = ((global::Doroti.Ui.Size)_layoutDeleteIcon(contentSize, (global::System.Func<global::Doroti.Framework.Rendering.RenderBox, global::Doroti.Framework.Rendering.BoxConstraints, Size>)layoutChild));
        global::Doroti.Framework.Rendering.BoxConstraints labelConstraintsLocal = ((global::Doroti.Framework.Rendering.BoxConstraints)_labelConstraintsFrom(contentConstraints, (avatarSize.width + deleteIconSize.width), contentSize, rawLabelSize));
        global::Doroti.Ui.Size labelSize = ((global::Doroti.Ui.Size)((_ChipRenderTheme__chip)this.theme).labelPadding.inflateSize(layoutChild(this.label, labelConstraintsLocal)));
        ...
        global::Doroti.Ui.Size overallSize = ((global::Doroti.Ui.Size)(new global::Doroti.Ui.Size(((avatarSize.width + labelSize.width) + deleteIconSize.width), contentSize) + densityAdjustmentLocal));
    ...
    {
        _ChipSizes__chip sizes = ((_ChipSizes__chip)_computeSizes(this.constraints, (global::System.Func<global::Doroti.Framework.Rendering.RenderBox, global::Doroti.Framework.Rendering.BoxConstraints, Size>)ChildLayoutHelper.layoutChild));
        var leftLocal = 0.0;
        ...
        global::Doroti.Ui.Offset avatarOffset = ((global::Doroti.Ui.Offset)Offset.zero);
        global::Doroti.Ui.Offset labelOffset = ((global::Doroti.Ui.Offset)Offset.zero);
        global::Doroti.Ui.Offset deleteIconOffset = ((global::Doroti.Ui.Offset)Offset.zero);
        switch (this.textDirection)
        {
            case TextDirection.rtl:
                {
                    ...
                    if (this.deleteIconShowing)
                    {
                        _deleteButtonRect = Rect.fromLTWH(0.0, 0.0, (((_ChipSizes__chip)sizes).deleteIcon.width + ((_ChipRenderTheme__chip)this.theme).padding.right), (((_ChipSizes__chip)sizes).overall.height + ((_ChipRenderTheme__chip)this.theme).padding.vertical));
                    ...
                    {
                        _pressRect = Rect.fromLTWH(this._deleteButtonRect.width, 0.0, ((((_ChipSizes__chip)sizes).overall.width - this._deleteButtonRect.width) + ((_ChipRenderTheme__chip)this.theme).padding.horizontal), (((_ChipSizes__chip)sizes).overall.height + ((_ChipRenderTheme__chip)this.theme).padding.vertical));
                    }
                    else
                    {
            ...
            case TextDirection.ltr:
                {
                    ...
                    if (((_ChipRenderTheme__chip)this.theme).canTapBody)
                    {
                        _pressRect = Rect.fromLTWH(0.0, 0.0, (this.deleteIconShowing ? (startLocal + ((_ChipRenderTheme__chip)this.theme).padding.left) : (((_ChipSizes__chip)sizes).overall.width + ((_ChipRenderTheme__chip)this.theme).padding.horizontal)), (((_ChipSizes__chip)sizes).overall.height + ((_ChipRenderTheme__chip)this.theme).padding.vertical));
                    }
                    else
                    {
                        _pressRect = Rect.zero;
                    ...
                    if (this.deleteIconShowing)
                    {
                        ...
                        _deleteButtonRect = Rect.fromLTWH((startLocal + ((_ChipRenderTheme__chip)this.theme).padding.left), 0.0, (((_ChipSizes__chip)sizes).deleteIcon.width + ((_ChipRenderTheme__chip)this.theme).padding.right), (((_ChipSizes__chip)sizes).overall.height + ((_ChipRenderTheme__chip)this.theme).padding.vertical));
                    }
                    else
                    {
                        _deleteButtonRect = Rect.zero;
        ...
        _boxParentData(this.avatar).offset = (((_ChipRenderTheme__chip)this.theme).padding.topLeft + avatarOffset);
        _boxParentData(this.label).offset = ((((_ChipRenderTheme__chip)this.theme).padding.topLeft + labelOffset) + ((_ChipRenderTheme__chip)this.theme).labelPadding.topLeft);
        _boxParentData(this.deleteIcon).offset = (((_ChipRenderTheme__chip)this.theme).padding.topLeft + deleteIconOffset);
    ...
    internal virtual global::Doroti.Ui.Color _disabledColor
    {
        get
        {
            ...
            global::Doroti.Ui.Color color = ((global::Doroti.Ui.Color)(((_ChipRenderTheme__chip)this.theme).brightness switch { Brightness.light => Colors.white, Brightness.dark => Colors.black, _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") }));
        ...
        var paint = ((Func<Paint>)(() =>
{
    ...
    return __cascade;
        ...
        double t = ((Equals(((global::Doroti.Framework.Animation.Animation<double>)this.checkmarkAnimation).status, AnimationStatus.reverse)) ? 1.0 : ((global::Doroti.Framework.Animation.Animation<double>)this.checkmarkAnimation).value);
        if ((t == 0.0))
        {
            return;
        }
        ...
        if ((t < 0.5))
        {
            ...
            global::Doroti.Ui.Offset drawMid = ((global::Doroti.Ui.Offset)DartRuntimePrimitives.RequireValue(Dart_uiLibrary.Offset.lerp(start, mid, strokeT)));
        ...
        else
        {
            ...
            global::Doroti.Ui.Offset drawEnd = ((global::Doroti.Ui.Offset)DartRuntimePrimitives.RequireValue(Dart_uiLibrary.Offset.lerp(mid, endLocal, strokeTLocal)));
            path.moveTo((origin.dx + start.dx), (origin.dy + start.dy));
    ...
    internal virtual void _paintSelectionOverlay(global::Doroti.Framework.Rendering.PaintingContext context, Offset offset)
    {
        if (this.isDrawingCheckmark)
        {
            ...
            {
                global::Doroti.Ui.Rect avatarRect = ((global::Doroti.Ui.Rect)_boxRect(this.avatar).shift(offset));
                var darkenPaint = ((Func<Paint>)(() =>
{
    ...
    return __cascade;
                ...
                {
                    global::Doroti.Ui.Path path = ((global::Doroti.Ui.Path)this.avatarBorder!.getOuterPath(avatarRect));
            ...
            global::Doroti.Ui.Offset checkOffset = ((global::Doroti.Ui.Offset)(_boxParentData(this.avatar).offset + new global::Doroti.Ui.Offset((((global::Doroti.Framework.Rendering.RenderBox)this.avatar).size.height * 0.125), (((global::Doroti.Framework.Rendering.RenderBox)this.avatar).size.height * 0.125))));
    ...
    internal virtual void _paintAvatar(global::Doroti.Framework.Rendering.PaintingContext context, Offset offset)
    {
        ...
        {
            context.paintChild(this.avatar, (_boxParentData(this.avatar).offset + offset));
        ...
        global::Doroti.Ui.Color disabledColor = ((global::Doroti.Ui.Color)this._disabledColor);
        ...
        else
        {
            ...
            {
                ((global::Doroti.Framework.Rendering.PaintingContext)context).canvas.saveLayer(_boxRect(this.avatar).shift(offset).inflate(20.0), ((Func<Paint>)(() =>
{
    var __cascade = new global::Doroti.Ui.Paint();
    ...
    internal virtual void _paintChild(global::Doroti.Framework.Rendering.PaintingContext context, Offset offset, global::Doroti.Framework.Rendering.RenderBox? child, bool isDeleteIcon)
    {
        ...
        if (!((global::Doroti.Framework.Animation.Animation<double>)this.enableAnimation).isCompleted)
        {
            ...
            else
            {
                this._labelOpacityLayerHandler.layer = null;
                this._deleteIconOpacityLayerHandler.layer = null;
                global::Doroti.Ui.Rect childRect = ((global::Doroti.Ui.Rect)_boxRect(child).shift(offset));
...
internal class _UnconstrainedInkSplashFactory__chip : InteractiveInkFeatureFactory
{
    ...
    {
        return ((InteractiveInkFeature)this.parentFactory.create(controller: controller, referenceBox: referenceBox, position: position, color: color, rectCallback: rectCallback, borderRadius: borderRadius, customBorder: customBorder, radius: radius, onRemoved: onRemoved, textDirection: textDirection));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public static partial class ChipLibrary
{
    ...
    {
        global::Doroti.Framework.Painting.EdgeInsets resolvedPadding = ((global::Doroti.Framework.Painting.EdgeInsets)padding.resolve(textDirection));
        global::Doroti.Ui.Size deflatedSize = ((global::Doroti.Ui.Size)resolvedPadding.deflateSize(chipSize));
        global::Doroti.Ui.Offset adjustedPosition = ((global::Doroti.Ui.Offset)(tapPosition - new global::Doroti.Ui.Offset(((global::Doroti.Framework.Painting.EdgeInsets)resolvedPadding).left, ((global::Doroti.Framework.Painting.EdgeInsets)resolvedPadding).top)));
...
internal class _EnsureMinSemanticsSize__chip : global::Doroti.Framework.Widgets.SingleChildRenderObjectWidget
{
    ...
    public override global::Doroti.Framework.Rendering.RenderObject createRenderObject(global::Doroti.Framework.Widgets.BuildContext context)
    {
        return ((global::Doroti.Framework.Rendering.RenderObject)new _RenderEnsureMinSemanticsSize__chip(this.semanticSize));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class _RenderEnsureMinSemanticsSize__chip : global::Doroti.Framework.Rendering.RenderProxyBox
{
    ...
    public virtual global::Doroti.Ui.Size semanticSize
    {
        ...
        {
            var __value = value;
            if ((Equals(this._semanticSize, __value)))
            {
                return;
            }
    ...
    public override Rect semanticBounds
    {
        get
        {
            return Rect.fromCenter(center: ((Offset)(this.paintBounds).center), width: Math.Max(this._semanticSize.width, this.size.width), height: Math.Max(this._semanticSize.height, this.size.height));
        }
    }
}
...
internal class _ChipDefaultsM3__chip : ChipThemeData
{
    ...
    public override global::Doroti.Ui.Color? deleteIconColor => DartRuntimePrimitives.ConvertValue<global::Doroti.Ui.Color>((this.isEnabled ? this._colors.onSurfaceVariant : this._colors.onSurface));
