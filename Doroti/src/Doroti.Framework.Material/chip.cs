...
public class ChipAnimationStyle
{
    ...
    public ChipAnimationStyle(AnimationStyle? enableAnimation = null, AnimationStyle? selectAnimation = null, AnimationStyle? avatarDrawerAnimation = null, AnimationStyle? deleteDrawerAnimation = null)
    {
...
public class Chip : StatelessWidget, ChipAttributes, DeletableChipAttributes
{
    ...
    public Chip(Key? key = null, Widget? avatar = null, Widget label = default!, TextStyle? labelStyle = null, EdgeInsetsGeometry? labelPadding = null, Widget? deleteIcon = null, Action? onDeleted = null, Color? deleteIconColor = null, string? deleteButtonTooltipMessage = null, BorderSide? side = null, OutlinedBorder? shape = null, Clip clipBehavior = Clip.none, FocusNode? focusNode = null, bool autofocus = false, WidgetStateProperty<Color?>? color = null, Color? backgroundColor = null, EdgeInsetsGeometry? padding = null, VisualDensity? visualDensity = null, MaterialTapTargetSize? materialTapTargetSize = null, double? elevation = null, Color? shadowColor = null, Color? surfaceTintColor = null, IconThemeData? iconTheme = null, BoxConstraints? avatarBoxConstraints = null, BoxConstraints? deleteIconBoxConstraints = null, ChipAnimationStyle? chipAnimationStyle = null, MouseCursor? mouseCursor = null) : base(key: key)
    {
        this.avatar = avatar;
        this.label = label;
...
public class RawChip : StatefulWidget, ChipAttributes, DeletableChipAttributes, SelectableChipAttributes, CheckmarkableChipAttributes, DisabledChipAttributes, TappableChipAttributes
{
...
internal class _RawChipState__chip : State<RawChip>, TickerProviderStateMixin<RawChip>
{
    ...
    public virtual WidgetStatesController statesController { get; private set; } = new WidgetStatesController();
    ...
    public override void initState()
    {
        ...
        base.initState();
        DartRuntimePrimitives.Ignore(((Func<WidgetStatesController>)(() =>
{
    ...
    return __cascade;
        ...
        selectController = new AnimationController(duration: widget.chipAnimationStyle?.selectAnimation?.duration ?? ChipLibrary._kSelectDuration, reverseDuration: widget.chipAnimationStyle?.selectAnimation?.reverseDuration, value: widget.selected ? 1.0 : 0.0, vsync: this);
        selectionFade = new CurvedAnimation(parent: selectController, curve: Curves.fastOutSlowIn);
        avatarDrawerController = new AnimationController(duration: widget.chipAnimationStyle?.avatarDrawerAnimation?.duration ?? ChipLibrary._kDrawerDuration, reverseDuration: widget.chipAnimationStyle?.avatarDrawerAnimation?.reverseDuration, value: (hasAvatar || widget.selected) ? 1.0 : 0.0, vsync: this);
        deleteDrawerController = new AnimationController(duration: widget.chipAnimationStyle?.deleteDrawerAnimation?.duration ?? ChipLibrary._kDrawerDuration, reverseDuration: widget.chipAnimationStyle?.deleteDrawerAnimation?.reverseDuration, value: hasDeleteButton ? 1.0 : 0.0, vsync: this);
        enableController = new AnimationController(duration: widget.chipAnimationStyle?.enableAnimation?.duration ?? ChipLibrary._kDisableDuration, reverseDuration: widget.chipAnimationStyle?.enableAnimation?.reverseDuration, value: widget.isEnabled ? 1.0 : 0.0, vsync: this);
        ...
        checkmarkAnimation = new CurvedAnimation(parent: selectController, curve: new Interval(1.0 - checkmarkPercentage, 1.0, curve: Curves.fastOutSlowIn), reverseCurve: new Interval(1.0 - checkmarkReversePercentage, 1.0, curve: Curves.fastOutSlowIn));
        deleteDrawerAnimation = new CurvedAnimation(parent: deleteDrawerController, curve: Curves.fastOutSlowIn);
        avatarDrawerAnimation = new CurvedAnimation(parent: avatarDrawerController, curve: Curves.fastOutSlowIn, reverseCurve: new Interval(1.0 - avatarDrawerReversePercentage, 1.0, curve: Curves.fastOutSlowIn));
        enableAnimation = new CurvedAnimation(parent: enableController, curve: Curves.fastOutSlowIn);
    }
    ...
    internal virtual OutlinedBorder _getShape(ThemeData theme, ChipThemeData chipTheme, ChipThemeData chipDefaults)
    {
        BorderSide? resolvedSide = WidgetStateProperty.resolveAs(widget.side, statesController.value) ?? WidgetStateProperty.resolveAs(chipTheme.side, statesController.value);
        OutlinedBorder resolvedShape = ((WidgetStateProperty.resolveAs(widget.shape, statesController.value) ?? WidgetStateProperty.resolveAs(chipTheme.shape, statesController.value)) ?? WidgetStateProperty.resolveAs(chipDefaults.shape, statesController.value)) ?? new StadiumBorder();
    ...
    public virtual Color? resolveColor(WidgetStateProperty<Color?>? color = null, Color? selectedColor = null, Color? backgroundColor = null, Color? disabledColor = null, WidgetStateProperty<Color?>? defaultColor = null)
    {
    ...
    internal virtual Color? _getBackgroundColor(ThemeData theme, ChipThemeData chipTheme, ChipThemeData chipDefaults)
    {
        {
            Color? disabledColorLocal = resolveColor(color: widget.color ?? chipTheme.color, disabledColor: widget.disabledColor ?? chipTheme.disabledColor, defaultColor: chipDefaults.color);
            Color? backgroundColorLocal = resolveColor(color: widget.color ?? chipTheme.color, backgroundColor: widget.backgroundColor ?? chipTheme.backgroundColor, defaultColor: chipDefaults.color);
            Color? selectedColorLocal = resolveColor(color: widget.color ?? chipTheme.color, selectedColor: widget.selectedColor ?? chipTheme.selectedColor, defaultColor: chipDefaults.color);
            var backgroundTween = new ColorTween(begin: disabledColorLocal, end: backgroundColorLocal);
            var selectTween = new ColorTween(begin: backgroundTween.evaluate(enableController), end: selectedColorLocal);
    ...
    internal virtual Widget? _wrapWithTooltip(string? tooltip = null, bool enabled = true, Widget? child = null)
    {
    ...
    internal virtual Widget? _buildDeleteIcon(BuildContext context, ThemeData theme, ChipThemeData chipTheme, ChipThemeData chipDefaults)
    {
        if (!hasDeleteButton)
        {
            return null;
        }
        IconThemeData iconThemeLocal = ((widget.iconTheme ?? chipTheme.iconTheme) ?? theme.chipTheme.iconTheme) ?? new _ChipDefaultsM3__chip(context, widget.isEnabled).iconTheme!;
        Color? effectiveDeleteIconColor = WidgetStateProperty.resolveAs(((((widget.deleteIconColor ?? chipTheme.deleteIconColor) ?? theme.chipTheme.deleteIconColor) ?? widget.iconTheme?.color) ?? chipTheme.iconTheme?.color) ?? chipDefaults.deleteIconColor, statesController.value);
        ...
        Size semanticSizeLocal = effectiveMaterialTapTargetSize switch { var __constant45576 when Equals(__constant45576, MaterialTapTargetSize.padded) => new Size(ConstantsLibrary.kMinInteractiveDimension), var __constant45659 when Equals(__constant45659, MaterialTapTargetSize.shrinkWrap) => new Size(ConstantsLibrary.kMinInteractiveDimension - 8.0), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") };
        VisualDensity effectiveVisualDensity = widget.visualDensity ?? theme.visualDensity;
        return (Widget?)new _EnsureMinSemanticsSize__chip(semanticSize: semanticSizeLocal + effectiveVisualDensity.baseSizeAdjustment, child: _wrapWithTooltip(tooltip: widget.deleteButtonTooltipMessage ?? MaterialLocalizations.of(context).deleteButtonTooltip, enabled: widget.isEnabled && (widget.onDeleted is not null), child: new InkWell(radius: (ChipLibrary._kChipHeight + (widget.padding?.vertical ?? 0.0)) * 0.45, splashFactory: new _UnconstrainedInkSplashFactory__chip(Theme.of(context).splashFactory), customBorder: new CircleBorder(), onTap: widget.isEnabled ? widget.onDeleted : null, child: new IconTheme(data: iconThemeLocal.copyWith(color: effectiveDeleteIconColor, size: effectiveIconSize), child: widget.deleteIcon))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Color? shadowColorLocal = (widget.shadowColor ?? chipTheme.shadowColor) ?? chipDefaults.shadowColor;
        Color? surfaceTintColorLocal = (widget.surfaceTintColor ?? chipTheme.surfaceTintColor) ?? chipDefaults.surfaceTintColor;
        Color? selectedShadowColorLocal = (widget.selectedShadowColor ?? chipTheme.selectedShadowColor) ?? chipDefaults.selectedShadowColor;
        Color? checkmarkColorLocal = (widget.checkmarkColor ?? chipTheme.checkmarkColor) ?? chipDefaults.checkmarkColor;
        ...
        EdgeInsetsGeometry paddingLocal = (widget.padding ?? chipTheme.padding) ?? chipDefaults.padding!;
        TextStyle labelStyleLocal = chipTheme.labelStyle ?? chipDefaults.labelStyle!;
        IconThemeData? iconThemeLocal = (widget.iconTheme ?? chipTheme.iconTheme) ?? chipDefaults.iconTheme;
        BoxConstraints? avatarBoxConstraintsLocal = widget.avatarBoxConstraints ?? chipTheme.avatarBoxConstraints;
        BoxConstraints? deleteIconBoxConstraintsLocal = widget.deleteIconBoxConstraints ?? chipTheme.deleteIconBoxConstraints;
        TextStyle effectiveLabelStyle = labelStyleLocal.merge(widget.labelStyle);
        Color? resolvedLabelColor = WidgetStateProperty.resolveAs(effectiveLabelStyle.color, statesController.value);
        TextStyle resolvedLabelStyle = effectiveLabelStyle.copyWith(color: resolvedLabelColor);
        Widget? avatarLocal = ((iconThemeLocal is not null) && hasAvatar) ? IconTheme.merge(data: chipDefaults.iconTheme!.merge(iconThemeLocal), child: widget.avatar!) : widget.avatar;
        ...
        EdgeInsetsGeometry defaultLabelPadding = EdgeInsets.lerp(EdgeInsets.CreateSymmetric(horizontal: 8.0), EdgeInsets.CreateSymmetric(horizontal: 4.0), Dart_uiLibrary.clampDouble(effectiveTextScale - 1.0, 0.0, 1.0))!;
        EdgeInsetsGeometry labelPaddingLocal = ((widget.labelPadding ?? chipTheme.labelPadding) ?? chipDefaults.labelPadding) ?? defaultLabelPadding;
        Widget result = new Material(elevation: isTapping ? pressElevationLocal : elevationLocal, shadowColor: widget.selected ? selectedShadowColorLocal : shadowColorLocal, surfaceTintColor: surfaceTintColorLocal, animationDuration: pressedAnimationDuration, shape: resolvedShape, clipBehavior: widget.clipBehavior, child: new InkWell(onFocusChange: (value) =>
        {
        ...
        }) : null, mouseCursor: widget.mouseCursor, hoverColor: ((widget.color ?? chipTheme.color) is null) ? null : Colors.transparent, customBorder: resolvedShape, child: new AnimatedBuilder(animation: Listenable.CreateMerge(new List<Listenable> { selectController, enableController }.Cast<Listenable?>()), builder: (context, child) =>
        {
            return new Ink(decoration: new ShapeDecoration(shape: resolvedShape, color: _getBackgroundColor(themeLocal, chipTheme, chipDefaults)), child: child);
            throw new InvalidOperationException("Dart closure completed without a value.");
        }, child: _wrapWithTooltip(tooltip: widget.tooltip, enabled: (widget.onPressed is not null) || (widget.onSelected is not null), child: new _ChipRenderWidget__chip(theme: new _ChipRenderTheme__chip(label: new DefaultTextStyle(overflow: TextOverflow.fade, textAlign: TextAlign.start, maxLines: 1L, softWrap: false, style: resolvedLabelStyle, child: widget.label), avatar: new AnimatedSwitcher(duration: ChipLibrary._kDrawerDuration, switchInCurve: Curves.fastOutSlowIn, child: avatarLocal), deleteIcon: new AnimatedSwitcher(duration: ChipLibrary._kDrawerDuration, switchInCurve: Curves.fastOutSlowIn, child: _buildDeleteIcon(context, themeLocal, chipTheme, chipDefaults)), brightness: brightnessLocal, padding: paddingLocal.resolve(textDirection), visualDensity: widget.visualDensity ?? themeLocal.visualDensity, labelPadding: labelPaddingLocal.resolve(textDirection), showAvatar: hasAvatar, showCheckmark: showCheckmarkLocal, checkmarkColor: checkmarkColorLocal, canTapBody: canTap), value: widget.selected, checkmarkAnimation: checkmarkAnimation, enableAnimation: enableAnimation, avatarDrawerAnimation: avatarDrawerAnimation, deleteDrawerAnimation: deleteDrawerAnimation, isEnabled: widget.isEnabled, avatarBorder: widget.avatarBorder, avatarBoxConstraints: avatarBoxConstraintsLocal, deleteIconBoxConstraints: deleteIconBoxConstraintsLocal)))));
        BoxConstraints constraintsLocal = default!;
        Offset densityAdjustment = (widget.visualDensity ?? themeLocal.visualDensity).baseSizeAdjustment;
        switch (widget.materialTapTargetSize ?? themeLocal.materialTapTargetSize)
        {
            case var __constant54393 when Equals(__constant54393, MaterialTapTargetSize.padded):
                {
                    constraintsLocal = new BoxConstraints(minWidth: ConstantsLibrary.kMinInteractiveDimension + densityAdjustment.dx, minHeight: ConstantsLibrary.kMinInteractiveDimension + densityAdjustment.dy);
                    break;
                }
        ...
        result = DartRuntimePrimitives.ConvertValue<Widget>(new _ChipRedirectingHitDetectionWidget__chip(constraints: constraintsLocal, child: new Center(widthFactor: 1.0, heightFactor: 1.0, child: result)));
...
internal class _IndividualOverrides__chip : WidgetStateProperty<Color?>
{
    ...
    internal _IndividualOverrides__chip(WidgetStateProperty<Color?>? color = null, Color? backgroundColor = null, Color? selectedColor = null, Color? disabledColor = null)
    {
        this.color = color;
        this.backgroundColor = backgroundColor;
        this.selectedColor = selectedColor;
...
internal class _ChipRedirectingHitDetectionWidget__chip : SingleChildRenderObjectWidget
{
    ...
    internal _ChipRedirectingHitDetectionWidget__chip(Widget? child = null, BoxConstraints constraints = default!) : base(child: child)
    {
...
{
    internal _RenderChipRedirectingHitDetection__chip(BoxConstraints additionalConstraints) : base(additionalConstraints: additionalConstraints)
    {
    }
...
internal class _ChipRenderWidget__chip : SlottedMultiChildRenderObjectWidget<_ChipSlot__chip, RenderBox>
{
    ...
    internal _ChipRenderWidget__chip(_ChipRenderTheme__chip theme, bool? value = null, bool? isEnabled = null, Animation<double> checkmarkAnimation = default!, Animation<double> avatarDrawerAnimation = default!, Animation<double> deleteDrawerAnimation = default!, Animation<double> enableAnimation = default!, ShapeBorder? avatarBorder = null, BoxConstraints? avatarBoxConstraints = null, BoxConstraints? deleteIconBoxConstraints = null)
    {
        this.theme = theme;
        this.value = value;
        this.isEnabled = isEnabled;
...
public class _ChipRenderTheme__chip
{
    ...
    internal _ChipRenderTheme__chip(Widget avatar, Widget label, Widget deleteIcon, Brightness brightness, EdgeInsets padding, VisualDensity visualDensity, EdgeInsets labelPadding, bool showAvatar, bool showCheckmark, Color? checkmarkColor, bool canTapBody)
    {
        this.avatar = avatar;
        this.label = label;
        this.deleteIcon = deleteIcon;
...
public class _RenderChip__chip : RenderBox, SlottedContainerRenderObjectMixin<_ChipSlot__chip, RenderBox>
{
    ...
    public static ColorTween selectionScrimTween = new ColorTween(begin: Colors.transparent, end: ChipLibrary._kSelectScrimColor);
    internal virtual LayerHandle<OpacityLayer> _avatarOpacityLayerHandler { get; private set; } = new LayerHandle<OpacityLayer>();
    internal virtual LayerHandle<OpacityLayer> _labelOpacityLayerHandler { get; private set; } = new LayerHandle<OpacityLayer>();
    internal virtual LayerHandle<OpacityLayer> _deleteIconOpacityLayerHandler { get; private set; } = new LayerHandle<OpacityLayer>();
    internal const bool _debugShowTapTargetOutlines = false;
    public virtual DartMap<_ChipSlot__chip, RenderBox> _slotToChild { get; set; } = new DartMap<_ChipSlot__chip, RenderBox>();
    ...
    public virtual RenderBox avatar => DartRuntimePrimitives.ConvertValue<RenderBox>(childForSlot(_ChipSlot__chip.avatar)!);
    public virtual RenderBox deleteIcon => DartRuntimePrimitives.ConvertValue<RenderBox>(childForSlot(_ChipSlot__chip.deleteIcon)!);
    public virtual RenderBox label => DartRuntimePrimitives.ConvertValue<RenderBox>(childForSlot(_ChipSlot__chip.label)!);
    ...
    internal static Rect _boxRect(RenderBox box) => DartRuntimePrimitives.ConvertValue<Rect>(_boxParentData(box).offset & box.size);
    ...
    {
        return new BaselineOffset(label.getDistanceToActualBaseline(baseline)).op_Add(_boxParentData(label).offset.dy).offset;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual BoxConstraints _labelConstraintsFrom(BoxConstraints contentConstraints, double iconWidth, double contentSize, Size rawLabelSize)
    {
        ...
        return new BoxConstraints(minHeight: rawLabelSize.height, maxHeight: contentSize, maxWidth: double.IsFinite(maxLabelWidth) ? maxLabelWidth : rawLabelSize.width);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual Size _layoutAvatar(double contentSize, Func<RenderBox, BoxConstraints, Size> layoutChild = default!)
    {
        BoxConstraints avatarConstraints = avatarBoxConstraints ?? BoxConstraints.CreateTightFor(width: contentSize, height: contentSize);
    ...
    internal virtual Size _layoutDeleteIcon(double contentSize, Func<RenderBox, BoxConstraints, Size> layoutChild = default!)
    {
        BoxConstraints deleteIconConstraints = deleteIconBoxConstraints ?? BoxConstraints.CreateTightFor(width: contentSize, height: contentSize);
    ...
    public override double? computeDryBaseline(BoxConstraints constraints, TextBaseline baseline)
    {
        ...
        BaselineOffset labelBaseline = new BaselineOffset(label.getDryBaseline(sizes.labelConstraints, baseline)).op_Add((sizes.content - sizes.label.height + sizes.densityAdjustment.dy) / 2L).op_Add(theme.padding.top).op_Add(theme.labelPadding.top);
        return labelBaseline.offset;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual _ChipSizes__chip _computeSizes(BoxConstraints constraints, Func<RenderBox, BoxConstraints, Size> layoutChild)
    {
        ...
        BoxConstraints labelConstraintsLocal = _labelConstraintsFrom(contentConstraints, avatarSize.width + deleteIconSize.width, contentSize, rawLabelSize);
        Size labelSize = theme.labelPadding.inflateSize(layoutChild(label, labelConstraintsLocal));
        var densityAdjustmentLocal = new Offset(0.0, theme.visualDensity.baseSizeAdjustment.dy / 2.0);
        Size overallSize = new Size(avatarSize.width + labelSize.width + deleteIconSize.width, contentSize) + densityAdjustmentLocal;
        var paddedSize = new Size(overallSize.width + theme.padding.horizontal, overallSize.height + theme.padding.vertical);
    ...
    public override void performLayout()
    {
        ...
        Offset centerLayout(Size boxSize, double x)
        {
            ...
            return new Offset(x, (sizes.content - boxSize.height + sizes.densityAdjustment.dy) / 2.0);
            throw new InvalidOperationException("Dart control flow completed without a value.");
        }
        ...
        labelOffset = labelOffset + new Offset(0.0, (sizes.label.height - theme.labelPadding.vertical - label.size.height) / 2.0);
        ...
        var paddedSize = new Size(sizes.overall.width + theme.padding.horizontal, sizes.overall.height + theme.padding.vertical);
    ...
    internal virtual Color _disabledColor
    {
        get
        {
            ...
            Color color = theme.brightness switch { Brightness.light => Colors.white, Brightness.dark => Colors.black, _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") };
            return new ColorTween(begin: color.withAlpha(ChipLibrary._kDisabledAlpha), end: color).evaluate(enableAnimation)!;
        }
    }
    internal virtual void _paintCheck(Canvas canvas, Offset origin, double size)
    {
        Color? paintColor = (Color?)(theme.checkmarkColor ?? ((theme.brightness, theme.showAvatar) switch { (Brightness.light, true) => Colors.white, (Brightness.light, false) => Colors.black.withAlpha(ChipLibrary._kCheckmarkAlpha), (Brightness.dark, true) => Colors.black, (Brightness.dark, false) => Colors.white.withAlpha(ChipLibrary._kCheckmarkAlpha) }));
        ...
        var paint = ((Func<Paint>)(() =>
{
    ...
    return __cascade;
        ...
        else
        {
            ...
            Offset drawEnd = DartRuntimePrimitives.RequireValue(Dart_uiLibrary.Offset.lerp(mid, endLocal, strokeTLocal));
            path.moveTo(origin.dx + start.dx, origin.dy + start.dy);
                ...
                context.canvas.saveLayer(_boxRect(avatar).shift(offset).inflate(20.0), ((Func<Paint>)(() =>
{
    ...
    internal virtual void _paintChild(PaintingContext context, Offset offset, RenderBox? child, bool isDeleteIcon)
    {
        if (child is null)
        {
                ...
                context.canvas.saveLayer(childRect.inflate(20.0), ((Func<Paint>)(() =>
{
    ...
    {
        DartRuntimePrimitives.Assert(() => !_debugShowTapTargetOutlines || ((Func<bool>)(() =>
        {
    ...
    public virtual RenderBox? childForSlot(_ChipSlot__chip slot) => _slotToChild.GetValueOrDefault(slot);
    ...
    public override List<DiagnosticsNode> debugDescribeChildren()
    {
        ...
        var childToSlot = new DartMap<RenderBox, _ChipSlot__chip>(_slotToChild.Values, _slotToChild.Keys);
        foreach (RenderBox child in children)
        {
...
internal class _ChipSizes__chip
{
    ...
    internal _ChipSizes__chip(Size size, Size overall, double content, Size avatar, BoxConstraints labelConstraints, Size label, Size deleteIcon, Offset densityAdjustment)
    {
        this.size = size;
...
public static partial class ChipLibrary
{
    internal static bool _hitIsOnDeleteIcon(EdgeInsetsGeometry padding, EdgeInsetsGeometry labelPadding, Offset tapPosition, Size chipSize, Size deleteButtonSize, TextDirection textDirection)
    {
        EdgeInsets resolvedPadding = padding.resolve(textDirection);
        Size deflatedSize = resolvedPadding.deflateSize(chipSize);
        Offset adjustedPosition = tapPosition - new Offset(resolvedPadding.left, resolvedPadding.top);
...
internal class _EnsureMinSemanticsSize__chip : SingleChildRenderObjectWidget
{
    ...
    internal _EnsureMinSemanticsSize__chip(Widget? child = null, Size semanticSize = default!) : base(child: child)
    {
...
public class _RenderEnsureMinSemanticsSize__chip : RenderProxyBox
{
    ...
    internal _RenderEnsureMinSemanticsSize__chip(Size _semanticSize, RenderBox? child = null) : base(child)
    {
...
internal class _ChipDefaultsM3__chip : ChipThemeData
{
    ...
    internal _ChipDefaultsM3__chip(BuildContext context, bool isEnabled) : base(elevation: 0.0, shape: new RoundedRectangleBorder(borderRadius: BorderRadius.CreateAll(Radius.circular(8.0))), showCheckmark: true)
    {
        this.context = context;
        this.isEnabled = isEnabled;
    }

    public override TextStyle? labelStyle => _textTheme.labelLarge?.copyWith(color: isEnabled ? _colors.onSurfaceVariant : _colors.onSurface);
    public override WidgetStateProperty<Color?>? color => DartRuntimePrimitives.ConvertValue<WidgetStateProperty<Color?>>(null);
    ...
    public override Color? deleteIconColor => DartRuntimePrimitives.ConvertValue<Color>(isEnabled ? _colors.onSurfaceVariant : _colors.onSurface);
    public override BorderSide? side => isEnabled ? new BorderSide(color: _colors.outlineVariant) : new BorderSide(color: _colors.onSurface.withOpacity(0.12));
