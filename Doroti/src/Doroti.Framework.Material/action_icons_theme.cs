...
public class ActionIconThemeData : Diagnosticable
{
    ...
    public ActionIconThemeData(Func<BuildContext, Widget>? backButtonIconBuilder = null, Func<BuildContext, Widget>? closeButtonIconBuilder = null, Func<BuildContext, Widget>? drawerButtonIconBuilder = null, Func<BuildContext, Widget>? endDrawerButtonIconBuilder = null)
    {
    ...
    public virtual ActionIconThemeData copyWith(Func<BuildContext, Widget>? backButtonIconBuilder = null, Func<BuildContext, Widget>? closeButtonIconBuilder = null, Func<BuildContext, Widget>? drawerButtonIconBuilder = null, Func<BuildContext, Widget>? endDrawerButtonIconBuilder = null)
    {
    ...
    {
        properties.add(new DiagnosticsProperty<Func<BuildContext, Widget>>("backButtonIconBuilder", backButtonIconBuilder, defaultValue: null));
        properties.add(new DiagnosticsProperty<Func<BuildContext, Widget>>("closeButtonIconBuilder", closeButtonIconBuilder, defaultValue: null));
        properties.add(new DiagnosticsProperty<Func<BuildContext, Widget>>("drawerButtonIconBuilder", drawerButtonIconBuilder, defaultValue: null));
        properties.add(new DiagnosticsProperty<Func<BuildContext, Widget>>("endDrawerButtonIconBuilder", endDrawerButtonIconBuilder, defaultValue: null));
    }
...
public class ActionIconTheme : InheritedTheme
{
    ...
    public ActionIconTheme(Key? key = null, ActionIconThemeData data = default!, Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((ActionIconTheme)oldWidget).data));
}
