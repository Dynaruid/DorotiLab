...
internal delegate double _ChildBaselineGetter__input_decorator(
    RenderBox child,
...
public class _InputBorderGap__input_decorator : ChangeNotifier
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is _InputBorderGap__input_decorator)
            && (__other.start == start)
            && (__other.extent == extent);
    }

    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(FoundationRuntimePorts.ObjectHash(start, extent));
...
{
    internal _InputBorderTween__input_decorator(InputBorder? begin = null, InputBorder? end = null)
...
internal class _InputBorderPainter__input_decorator : CustomPainter
{
    ...
    internal _InputBorderPainter__input_decorator(
        Listenable repaint,
        Animation<double> borderAnimation,
        _InputBorderTween__input_decorator border,
        Animation<double> gapAnimation,
        _InputBorderGap__input_decorator gap,
    ...
    public override bool shouldRepaint(CustomPainter oldDelegate)
    {
        ...
        return (!Equals(borderAnimation, __oldPainter.borderAnimation))
            || (!Equals(hoverAnimation, __oldPainter.hoverAnimation))
            || (!Equals(gapAnimation, __oldPainter.gapAnimation))
...
public class _BorderContainer__input_decorator : StatefulWidget
{
    ...
    internal _BorderContainer__input_decorator(
        InputBorder border,
        _InputBorderGap__input_decorator gap,
        Animation<double> gapAnimation,
        Color fillColor,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _BorderContainerState__input_decorator());
}

public class _BorderContainerState__input_decorator
    : State<_BorderContainer__input_decorator>,
        TickerProviderStateMixin<_BorderContainer__input_decorator>
{
    ...
    public override void initState()
    {
        ...
        _controller = new AnimationController(
            duration: Input_decoratorLibrary._kTransitionDuration,
            vsync: this
        );
        _borderAnimation = new CurvedAnimation(
            parent: _controller,
            curve: Input_decoratorLibrary._kTransitionCurve,
            reverseCurve: Input_decoratorLibrary._kTransitionCurve.flipped
        );
        ...
        _hoverColorTween = new ColorTween(
            begin: widget.hoverColor.withAlpha(0L),
    ...
    public override void didUpdateWidget(_BorderContainer__input_decorator oldWidget)
    {
        ...
        {
            _border = new _InputBorderTween__input_decorator(
    ...
    public override Widget build(BuildContext context)
    {
        return new CustomPaint(
            foregroundPainter: new _InputBorderPainter__input_decorator(
...
public class _HelperError__input_decorator : StatefulWidget
{
    ...
    internal _HelperError__input_decorator(
        TextAlign? textAlign = null,
        Widget? helper = null,
        string? helperText = null,
        TextStyle? helperStyle = null,
        long? helperMaxLines = null,
        Widget? error = null,
        string? errorText = null,
        TextStyle? errorStyle = null,
        long? errorMaxLines = null
    )
    {
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _HelperErrorState__input_decorator());
}

public class _HelperErrorState__input_decorator
    : State<_HelperError__input_decorator>,
        SingleTickerProviderStateMixin<_HelperError__input_decorator>
{
    ...
    internal virtual bool _hasHelper =>
        DartRuntimePrimitives.ConvertValue<bool>(
            (widget.helperText is not null) || (widget.helper is not null)
        );
    internal virtual bool _hasError =>
        DartRuntimePrimitives.ConvertValue<bool>(
            (widget.errorText is not null) || (widget.error is not null)
        );
    ...
    public override void didUpdateWidget(_HelperError__input_decorator old)
    {
        ...
        bool helperTextStateChanged =
            (newErrorText is null) && ((newHelperText is not null) != (oldHelperText is not null));
        if (
            errorStateChanged
    ...
    {
        DartRuntimePrimitives.Assert(() =>
            (widget.helper is not null) || (widget.helperText is not null)
        );
        return new Widgets.Semantics(
            container: true,
            child: new FadeTransition(
                opacity: new Tween<double>(begin: 1.0, end: 0.0).animate(_controller),
                child: widget.helper
                    ?? new Text(
                        widget.helperText!,
    ...
    {
        DartRuntimePrimitives.Assert(() =>
            (widget.error is not null) || (widget.errorText is not null)
        );
        ...
        {
            capturedError = DartRuntimePrimitives.ConvertValue<Widget>(
                new DefaultTextStyle(style: widget.errorStyle!, child: capturedError)
            );
        }
        return new Builder(
            builder: (context) =>
    ...
    public override Widget build(BuildContext context)
    {
        ...
        if (_hasError)
        {
            return new Stack(
                children: new List<Widget>
                {
                    ...
                    DartRuntimePrimitives.ConvertValue<Widget>(_buildError()),
                }
            );
        }
        if (_hasHelper)
        {
            return new Stack(
                children: new List<Widget>
                {
                    DartRuntimePrimitives.ConvertValue<Widget>(_buildHelper()),
                    DartRuntimePrimitives.ConvertValue<Widget>(
...
public class FloatingLabelAlignment
{
    ...
    internal static string _stringify(double x)
    {
        return x switch
        {
            ...
            _ => $"FloatingLabelAlignment(x: {x.toStringAsFixed(1L)})",
        };
    }
...
public class _Decoration__input_decorator
{
    ...
    internal _Decoration__input_decorator(
        ...
        InputBorder border,
        _InputBorderGap__input_decorator borderGap,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is _Decoration__input_decorator)
            && Equals(__other.contentPadding, contentPadding)
            && (__other.isCollapsed == isCollapsed)
            && (__other.floatingLabelHeight == floatingLabelHeight)
            && (__other.floatingLabelProgress == floatingLabelProgress)
            && Equals(__other.floatingLabelAlignment, floatingLabelAlignment)
            && Equals(__other.border, border)
            && Equals(__other.borderGap, borderGap)
            && (__other.alignLabelWithHint == alignLabelWithHint)
            && (__other.isDense == isDense)
            && (__other.isEmpty == isEmpty)
            && Equals(__other.visualDensity, visualDensity)
            && (__other.inputGap == inputGap)
            && (__other.maintainHintSize == maintainHintSize)
            && (__other.maintainLabelSize == maintainLabelSize)
            && Equals(__other.icon, icon)
            && Equals(__other.input, input)
            && Equals(__other.label, label)
            && Equals(__other.hint, hint)
            && Equals(__other.prefix, prefix)
            && Equals(__other.suffix, suffix)
            && Equals(__other.prefixIcon, prefixIcon)
            && Equals(__other.suffixIcon, suffixIcon)
            && Equals(__other.helperError, helperError)
            && Equals(__other.counter, counter)
            && Equals(__other.container, container);
    }
...
internal class _RenderDecorationLayout__input_decorator
{
    ...
    public virtual (double ascent, double bottomHeight, double subtextHeight)? subtextSize
    {
        get;
        private set;
    }
    ...
    internal _RenderDecorationLayout__input_decorator(
        BoxConstraints inputConstraints,
        double baseline,
        double containerHeight,
        (double ascent, double bottomHeight, double subtextHeight)? subtextSize,
        Size size
    )
    {
...
public class _RenderDecoration__input_decorator
    : RenderBox,
        SlottedContainerRenderObjectMixin<_DecorationSlot__input_decorator, RenderBox>
{
    ...
    public virtual DartMap<_DecorationSlot__input_decorator, RenderBox> _slotToChild { get; set; } =
        new DartMap<_DecorationSlot__input_decorator, RenderBox>();

    internal _RenderDecoration__input_decorator(
        _Decoration__input_decorator decoration,
        TextDirection textDirection,
    ...
    public virtual IEnumerable<RenderBox> children
    {
        get
        {
            RenderBox? helperErrorLocal = childForSlot(
                _DecorationSlot__input_decorator.helperError
            );
            return (
                (Func<List<RenderBox>>)(
                    () =>
                    {
                        var __collection23257 = new List<RenderBox>();
                        var __collectionElement23276 = icon;
                        if (__collectionElement23276 is { } __nonNullCollectionElement23276)
                        {
                            __collection23257.Add(__nonNullCollectionElement23276);
                        }
                        var __collectionElement23289 = input;
                        if (__collectionElement23289 is { } __nonNullCollectionElement23289)
                        {
                            __collection23257.Add(__nonNullCollectionElement23289);
                        }
                        var __collectionElement23303 = prefixIcon;
                        if (__collectionElement23303 is { } __nonNullCollectionElement23303)
                        {
                            __collection23257.Add(__nonNullCollectionElement23303);
                        }
                        var __collectionElement23322 = suffixIcon;
                        if (__collectionElement23322 is { } __nonNullCollectionElement23322)
                        {
                            __collection23257.Add(__nonNullCollectionElement23322);
                        }
                        var __collectionElement23341 = prefix;
                        if (__collectionElement23341 is { } __nonNullCollectionElement23341)
                        {
                            __collection23257.Add(__nonNullCollectionElement23341);
                        }
                        var __collectionElement23356 = suffix;
                        if (__collectionElement23356 is { } __nonNullCollectionElement23356)
                        {
                            __collection23257.Add(__nonNullCollectionElement23356);
                        }
                        var __collectionElement23371 = label;
                        if (__collectionElement23371 is { } __nonNullCollectionElement23371)
                        {
                            __collection23257.Add(__nonNullCollectionElement23371);
                        }
                        var __collectionElement23385 = hint;
                        if (__collectionElement23385 is { } __nonNullCollectionElement23385)
                        {
                            __collection23257.Add(__nonNullCollectionElement23385);
                        }
                        var __collectionElement23398 = helperErrorLocal;
                        if (__collectionElement23398 is { } __nonNullCollectionElement23398)
                        {
                            __collection23257.Add(__nonNullCollectionElement23398);
                        }
                        var __collectionElement23418 = counter;
                        if (__collectionElement23418 is { } __nonNullCollectionElement23418)
                        {
                            __collection23257.Add(__nonNullCollectionElement23418);
                        }
                        var __collectionElement23434 = container;
                        if (__collectionElement23434 is { } __nonNullCollectionElement23434)
                        {
                            __collection23257.Add(__nonNullCollectionElement23434);
                        }
                        return __collection23257;
                    }
                )
            )();
        }
    ...
    internal virtual TextAlignVertical _defaultTextAlignVertical =>
    ...
    internal virtual Offset _densityOffset =>
        DartRuntimePrimitives.ConvertValue<Offset>(decoration.visualDensity.baseSizeAdjustment);
    ...
    internal static double _minWidth(RenderBox? box, double height) =>
        DartRuntimePrimitives.ConvertValue<double>(box?.getMinIntrinsicWidth(height) ?? 0.0);

    internal static double _maxWidth(RenderBox? box, double height) =>
        DartRuntimePrimitives.ConvertValue<double>(box?.getMaxIntrinsicWidth(height) ?? 0.0);

    internal static double _minHeight(RenderBox? box, double width) =>
        DartRuntimePrimitives.ConvertValue<double>(box?.getMinIntrinsicHeight(width) ?? 0.0);

    internal static Size _boxSize(RenderBox? box) =>
        DartRuntimePrimitives.ConvertValue<Size>(box?.size ?? Size.zero);
    ...
    )? _computeSubtextSizes(
        BoxConstraints constraints,
        Func<RenderBox, BoxConstraints, Size> layoutChild,
        Func<RenderBox, BoxConstraints, double> getBaseline
    )
    {
        var (counterSize, counterAscent) = counter switch
        {
            RenderBox box => ((Size, double))
                (layoutChild(box, constraints), getBaseline(box, constraints)),
            null => ((Size, double))(Size.zero, 0.0),
        };
        double counterPadding =
            (counter is not null) ? Input_decoratorLibrary._kSubtextCounterPadding : 0.0;
        BoxConstraints helperErrorConstraints = constraints.deflate(
            EdgeInsets.CreateOnly(left: counterSize.width + counterPadding)
        );
        ...
        return (
            ...
            subtextHeight: subtextHeightLocal
        );
    }

    internal virtual _RenderDecorationLayout__input_decorator _layout(
        BoxConstraints constraints,
        Func<RenderBox, BoxConstraints, Size> layoutChild,
        Func<RenderBox, BoxConstraints, double> getBaseline
    )
    {
        DartRuntimePrimitives.Assert(
            () => constraints.maxWidth < double.PositiveInfinity,
            () =>
                (object?)"An InputDecorator, which is typically created by a TextField, cannot "
        ...
        BoxConstraints containerConstraints = boxConstraints.deflate(
            EdgeInsets.CreateOnly(left: iconWidth)
        );
        ...
        (double ascent, double bottomHeight, double subtextHeight)? subtextSizeLocal =
            _computeSubtextSizes(
        ...
        Size prefixIconSize =
            (prefixIconLocal is null)
                ? Size.zero
                : layoutChild(prefixIconLocal, containerConstraints);
        Size suffixIconSize =
            (suffixIconLocal is null)
                ? Size.zero
                : layoutChild(suffixIconLocal, containerConstraints);
        RenderBox? prefixLocal = prefix;
        RenderBox? suffixLocal = suffix;
        Size prefixSize =
            (prefixLocal is null) ? Size.zero : layoutChild(prefixLocal, contentConstraints);
        Size suffixSize =
            (suffixLocal is null) ? Size.zero : layoutChild(suffixLocal, contentConstraints);
        var accessoryHorizontalInsets = EdgeInsetsDirectional.CreateOnly(
            start: iconWidth
                + prefixSize.width
                + (
                    (prefixIconLocal is null)
        ...
        if (labelLocal is not null)
        {
            ...
            double labelWidth = Math.Max(
                ...
                constraints.maxWidth
                    - (
                        (decoration.inputGap * 2L)
                        + iconWidth
                        + ((prefixIconLocal is null) ? contentPadding.start : prefixIconSize.width)
            ...
            topHeight = decoration.border.isOutline
                ? Math.Max(labelHeight - getBaseline(labelLocal, labelConstraints), 0.0)
                : labelHeight;
        }
        else
        {
        ...
        BoxConstraints inputConstraintsLocal = boxConstraints
            .deflate(
                EdgeInsets.CreateOnly(
                    top: contentPadding.vertical + topHeight + bottomHeightLocal + _densityOffset.dy
                )
            )
        ...
        Size inputSize =
            (inputLocal is null) ? Size.zero : layoutChild(inputLocal, inputConstraintsLocal);
        Size hintSize =
            (hintLocal is null)
                ? Size.zero
                : layoutChild(hintLocal, boxConstraints.tighten(width: inputWidth));
        double inputBaseline =
            (inputLocal is null) ? 0.0 : getBaseline(inputLocal, inputConstraintsLocal);
        double hintBaseline =
            (hintLocal is null)
                ? 0.0
                : getBaseline(hintLocal, boxConstraints.tighten(width: inputWidth));
        ...
        double prefixBaseline =
            (prefixLocal is null) ? 0.0 : getBaseline(prefixLocal, contentConstraints);
        double suffixBaseline =
            (suffixLocal is null) ? 0.0 : getBaseline(suffixLocal, contentConstraints);
        ...
        double maxContentHeight =
            containerHeightLocal - contentPadding.vertical - topHeight - _densityOffset.dy;
        ...
        return new _RenderDecorationLayout__input_decorator(
            inputConstraints: inputConstraintsLocal,
            containerHeight: containerHeightLocal,
            baseline: baselineLocal,
            subtextSize: subtextSizeLocal,
            size: new Size(
                constraints.maxWidth,
    ...
    public override double computeMinIntrinsicWidth(double height)
    {
        ...
        double contentWidth = decoration.maintainLabelSize
            ? Math.Max(inputWidth, _minWidth(label, height))
            : inputWidth;
        return _minWidth(icon, height)
            + (
                (prefixIcon is not null)
                    ? prefixToInputGap
                    : (contentPadding.start + decoration.inputGap)
            )
    ...
    public override double computeMinIntrinsicHeight(double width)
    {
        ...
        double inputHeight = _lineHeight(
            ...
            (
                (Func<List<RenderBox?>>)(
                    () =>
                    {
                        var __collection44130 = new List<RenderBox?>();
                        __collection44130.Add(input);
                        if (decoration.isEmpty)
                        {
                            __collection44130.Add(hint);
                        }
                        return __collection44130;
                    }
                )
            )()
        );
        ...
        double contentHeight =
            contentPadding.top
            + ((label is null) ? 0.0 : decoration.floatingLabelHeight)
            + inputMaxHeight
            + contentPadding.bottom
            + _densityOffset.dy;
        double containerHeight = new List<double>
        {
            iconHeight,
            contentHeight,
            prefixIconHeight,
    ...
    public override double? computeDryBaseline(BoxConstraints constraints, TextBaseline baseline)
    {
        ...
        _RenderDecorationLayout__input_decorator layout = _layout(
            constraints,
        ...
        return (
                baseline switch
                {
                    ...
                    TextBaseline.ideographic => (
                        inputLocal.getDryBaseline(layout.inputConstraints, TextBaseline.ideographic)
                        ?? inputLocal.getDryLayout(layout.inputConstraints).height
                    )
                        - (
                            inputLocal.getDryBaseline(
                                layout.inputConstraints,
    ...
    public override void performLayout()
    {
        ...
        _RenderDecorationLayout__input_decorator layoutLocal = _layout(
            constraintsLocal,
        ...
        DartRuntimePrimitives.Assert(() =>
            size.width == constraintsLocal.constrainWidth(layoutLocal.size.width)
        );
        DartRuntimePrimitives.Assert(() =>
            size.height == constraintsLocal.constrainHeight(layoutLocal.size.height)
        );
        double overallWidth = layoutLocal.size.width;
        RenderBox? containerLocal = container;
        if (containerLocal is not null)
        {
            var containerConstraints = BoxConstraints.CreateTightFor(
                height: layoutLocal.containerHeight,
                width: overallWidth - _boxSize(icon).width
            );
            containerLocal.layout(containerConstraints, parentUsesSize: true);
            double xLocal = textDirection switch
            {
        ...
        if (icon is not null)
        {
            double xAlternate = textDirection switch
            {
        ...
        switch (textDirection)
        {
            case TextDirection.ltr:
            {
                ...
                _boxParentData(helperError).offset = new Offset(
                    startLocal + decoration.inputGap,
                    subtextBaseline - helperErrorBaseline
                );
                if (counterLocal is not null)
                {
                    _boxParentData(counterLocal).offset = new Offset(
                        endLocal - counterLocal.size.width - decoration.inputGap,
            ...
            case TextDirection.rtl:
            {
                ...
                _boxParentData(helperError).offset = new Offset(
                    startLocal - helperError.size.width - decoration.inputGap,
                    subtextBaseline - helperErrorBaseline
                );
                if (counterLocal is not null)
                {
        ...
        if (label is not null)
        {
            ...
            decoration.borderGap.extent =
                label!.size.width * Input_decoratorLibrary._kFinalLabelScale;
        }
        else
        {
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        if (label is not null)
        {
            ...
            double outlinedFloatingY =
                (-labelHeight * Input_decoratorLibrary._kFinalLabelScale / 2.0)
                - (borderSideLocal.strokeOffset / 2.0);
    ...
    )
    {
        ...
        {
            _InputDecoratorState__input_decorator._kPrefixSemanticsTag,
            _InputDecoratorState__input_decorator._kPrefixIconSemanticsTag,
            _InputDecoratorState__input_decorator._kSuffixSemanticsTag,
            _InputDecoratorState__input_decorator._kSuffixIconSemanticsTag,
        };
        foreach (var childConfig in childConfigs)
        {
            SemanticsTag? tagLocal = tags.firstWhereOrNull(
                (tag) => childConfig.tagsChildrenWith(tag)
            );
            if (tagLocal is not null)
            {
                mergeGroups
                    .putIfAbsent(tagLocal, () => new List<SemanticsConfiguration>())
                    .Add(childConfig);
            }
            else
            {
    ...
    public virtual RenderBox? childForSlot(_DecorationSlot__input_decorator slot) =>
    ...
    public override List<DiagnosticsNode> debugDescribeChildren()
    {
        ...
        var childToSlot = new DartMap<RenderBox, _DecorationSlot__input_decorator>(
            _slotToChild.Values,
            _slotToChild.Keys
        );
        foreach (RenderBox child in children)
    ...
    public virtual void _moveChild(
        RenderBox child,
        _DecorationSlot__input_decorator slot,
        _DecorationSlot__input_decorator oldSlot
    )
    {
...
internal class _Decorator__input_decorator
    : SlottedMultiChildRenderObjectWidget<_DecorationSlot__input_decorator, RenderBox>
{
    ...
    internal _Decorator__input_decorator(
        TextAlignVertical? textAlignVertical,
        _Decoration__input_decorator decoration,
        TextDirection textDirection,
        TextBaseline textBaseline,
    ...
    public override IEnumerable<_DecorationSlot__input_decorator> slots =>
        DartRuntimePrimitives.ConvertValue<IEnumerable<_DecorationSlot__input_decorator>>(
            Enum.GetValues<_DecorationSlot__input_decorator>().ToList()
        );
    ...
    public override Widget? childForSlot(_DecorationSlot__input_decorator slot)
    {
        return slot switch
        {
            _DecorationSlot__input_decorator.icon => decoration.icon,
            _DecorationSlot__input_decorator.input => decoration.input,
            _DecorationSlot__input_decorator.label => decoration.label,
            _DecorationSlot__input_decorator.hint => decoration.hint,
            _DecorationSlot__input_decorator.prefix => decoration.prefix,
            _DecorationSlot__input_decorator.suffix => decoration.suffix,
            _DecorationSlot__input_decorator.prefixIcon => decoration.prefixIcon,
            _DecorationSlot__input_decorator.suffixIcon => decoration.suffixIcon,
            _DecorationSlot__input_decorator.helperError => decoration.helperError,
    ...
    {
        return new _RenderDecoration__input_decorator(
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<_RenderDecoration__input_decorator>)(
                    () =>
                    {
...
internal class _AffixText__input_decorator : StatelessWidget
{
    ...
    internal _AffixText__input_decorator(
        bool labelIsFloating,
        string? text = null,
        TextStyle? style = null,
        Widget? child = null,
        SemanticsSortKey? semanticsSortKey = null,
        SemanticsTag semanticsTag = default!
    )
    {
            ...
            child: new IgnorePointer(
                ...
                child: new AnimatedOpacity(
                    ...
                    child: new Widgets.Semantics(
                        ...
                        child: child ?? ((text is null) ? null : new Text(text!, style: style))
                    )
                )
            )
        );
...
public class InputDecorator : StatefulWidget
{
    ...
    internal virtual bool _labelShouldWithdraw =>
        DartRuntimePrimitives.ConvertValue<bool>(!isEmpty || (isFocused && decoration.enabled));

    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _InputDecoratorState__input_decorator());
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DiagnosticsProperty<TextStyle>("baseStyle", baseStyle, defaultValue: null)
        );
...
internal class _InputDecoratorState__input_decorator
    : State<InputDecorator>,
        TickerProviderStateMixin<InputDecorator>
{
    ...
    internal virtual _InputBorderGap__input_decorator _borderGap { get; private set; } =
        new _InputBorderGap__input_decorator();
    ...
    internal virtual OrdinalSortKey _prefixSemanticsSortOrder
    {
        get
        {
            ...
            {
                __late__prefixSemanticsSortOrder = new OrdinalSortKey(
                    0,
    ...
    internal virtual OrdinalSortKey _inputSemanticsSortOrder
    {
        get
        {
            ...
            {
                __late__inputSemanticsSortOrder = new OrdinalSortKey(
                    1,
                    name: GetHashCode().ToString()
                );
    ...
    internal virtual OrdinalSortKey _suffixSemanticsSortOrder
    {
        get
        {
            ...
            {
                __late__suffixSemanticsSortOrder = new OrdinalSortKey(
                    2,
                    name: GetHashCode().ToString()
                );
    ...
    internal static SemanticsTag _kPrefixSemanticsTag = new SemanticsTag(
        "_InputDecoratorState.prefix"
    );
    internal static SemanticsTag _kPrefixIconSemanticsTag = new SemanticsTag(
        "_InputDecoratorState.prefixIcon"
    );
    internal static SemanticsTag _kSuffixSemanticsTag = new SemanticsTag(
        "_InputDecoratorState.suffix"
    );
    internal static SemanticsTag _kSuffixIconSemanticsTag = new SemanticsTag(
    ...
    public override void didChangeDependencies()
    {
        ...
        bool labelIsInitiallyFloating =
            (!Equals(decoration.floatingLabelBehavior, FloatingLabelBehavior.never))
            && labelShouldWithdraw;
    ...
    public virtual InputDecoration decoration =>
        _effectiveDecoration ??= widget.decoration.applyDefaults(InputDecorationTheme.of(context));
    public virtual TextAlign? textAlign =>
        DartRuntimePrimitives.ConvertValue<TextAlign>(widget.textAlign);
    public virtual bool isFocused => widget.isFocused;
    internal virtual bool _hasError =>
        DartRuntimePrimitives.ConvertValue<bool>(
            (decoration.errorText is not null) || (decoration.error is not null)
        );
    public virtual bool isHovering =>
        DartRuntimePrimitives.ConvertValue<bool>(widget.isHovering && decoration.enabled);
    public virtual bool isEmpty => widget.isEmpty;
    internal virtual bool _floatingLabelEnabled
    {
        get { return !Equals(decoration.floatingLabelBehavior, FloatingLabelBehavior.never); }
    }
    public virtual bool labelShouldWithdraw =>
        DartRuntimePrimitives.ConvertValue<bool>(
            widget._labelShouldWithdraw
                || Equals(decoration.floatingLabelBehavior, FloatingLabelBehavior.always)
        );
    ...
    public override void didUpdateWidget(InputDecorator old)
    {
        ...
        var floatBehaviorChanged = !Equals(
        ...
        if (
            _floatingLabelController.isCompleted
            && (errorTextLocal is not null)
            && (errorTextLocal != oldErrorText)
        )
        {
            DartRuntimePrimitives.Ignore(
                (
    ...
    internal virtual bool _hasInlineLabel
    {
        get
        {
            return !labelShouldWithdraw
                && ((decoration.labelText is not null) || (decoration.label is not null));
        }
    }
    internal virtual bool _shouldShowLabel =>
        DartRuntimePrimitives.ConvertValue<bool>(_hasInlineLabel || _floatingLabelEnabled);

    internal virtual TextStyle _getInlineLabelStyle(
        ThemeData themeData,
        InputDecorationThemeData defaults
    )
    {
        ...
        return themeData
            .textTheme.titleMedium!.merge(widget.baseStyle)
            .merge(defaultStyle)
            .merge(style)
            .copyWith(height: 1);
        throw new InvalidOperationException("Control flow completed without returning a value.");
    ...
    )
    {
        ...
        return themeData
            .textTheme.bodyLarge!.merge(widget.baseStyle)
            .merge(defaultStyle)
            .merge(style);
    }

    internal virtual TextStyle _getFloatingLabelStyle(
        ThemeData themeData,
        InputDecorationThemeData defaults
    )
    {
        ...
        TextStyle? style = WidgetStateProperty.resolveAs(
    ...
    public virtual HashSet<WidgetState> widgetState =>
        (
            (Func<HashSet<WidgetState>>)(
                () =>
                {
                    var __collection77750 = new HashSet<WidgetState>();
                    if (!decoration.enabled)
                    {
                        __collection77750.Add(WidgetState.disabled);
                    }
                    if (isFocused)
                    {
                        __collection77750.Add(WidgetState.focused);
                    }
                    if (isHovering)
                    {
                        __collection77750.Add(WidgetState.hovered);
                    }
                    if (_hasError)
                    {
                        __collection77750.Add(WidgetState.error);
                    }
                    return __collection77750;
                }
            )
        )();

    internal virtual InputBorder _getDefaultBorder(
        ThemeData themeData,
        InputDecorationThemeData defaults
    )
    {
        InputBorder borderLocal =
        ...
        return new Stack(
            children: (
                (Func<List<Widget>>)(
                    () =>
                    {
                        var __collection79764 = new List<Widget>();
                        __collection79764.AddRange(previousChildren);
                        var __collectionElement79794 = currentChild;
                        if (__collectionElement79794 is { } __nonNullCollectionElement79794)
                        {
                            __collection79764.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    __nonNullCollectionElement79794
                                )
                            );
                        }
                        return __collection79764;
                    }
                )
            )()
        );
    ...
    public override Widget build(BuildContext context)
    {
            ...
            Widget hintWidget =
                ...
                ?? new Text(
                    ...
                    overflow: hintStyle.overflow
                        ?? (
                            (decoration.hintMaxLines is null)
                                ? null
                                : global::Doroti.Framework.Painting.TextOverflow.ellipsis
                        ),
                    textAlign: textAlign,
                    maxLines: decoration.hintMaxLines
                );
            bool showHint = isEmpty && !_hasInlineLabel;
            hintLocal = DartRuntimePrimitives.ConvertValue<Widget>(
                maintainHintSizeLocal
                    ? new global::Doroti.Framework.Widgets.AnimatedOpacity(
                        opacity: showHint ? 1.0 : 0.0,
                        duration: decoration.hintFadeDuration
                            ?? Input_decoratorLibrary._kHintFadeTransitionDuration,
                        curve: Input_decoratorLibrary._kTransitionCurve,
                        child: hintWidget
                    )
                    : new global::Doroti.Framework.Widgets.AnimatedSwitcher(
                        duration: decoration.hintFadeDuration
                            ?? Input_decoratorLibrary._kHintFadeTransitionDuration,
                        transitionBuilder: (global::System.Func<
                            global::Doroti.Framework.Widgets.Widget,
                            global::Doroti.Framework.Animation.Animation<double>,
                            global::Doroti.Framework.Widgets.FadeTransition
                        >)_buildTransition,
                        layoutBuilder: _topStartLayout,
                        child: showHint
                            ? hintWidget
                            : global::Doroti.Framework.Widgets.SizedBox.CreateShrink()
                    )
            );
        }
        ...
        Widget containerLocal = new _BorderContainer__input_decorator(
            border: borderLocal,
            gap: _borderGap,
        ...
        if (((object?)decoration.labelText ?? decoration.label) is not null)
        {
            labelLocal = DartRuntimePrimitives.ConvertValue<Widget>(
                new MatrixTransition(
                    ...
                    onTransform: (value) =>
                    {
                        double shakeOffset = value switch
                        {
                            <= 0.25 => -value,
                            < 0.75 => value - 0.5,
                            _ => (1.0 - value) * 4.0,
        ...
        bool needsSemanticsSortOrder =
            labelShouldWithdraw
            && ((inputLocal is not null) ? (hasPrefix || hasSuffix) : (hasPrefix && hasSuffix));
        Widget? prefixLocal = hasPrefix
            ? new _AffixText__input_decorator(
                labelIsFloating: labelShouldWithdraw,
                text: decoration.prefixText,
                style: WidgetStateProperty.resolveAs(decoration.prefixStyle, widgetState)
                    ?? hintStyle,
            ...
            : null;
        Widget? suffixLocal = hasSuffix
            ? new _AffixText__input_decorator(
                labelIsFloating: labelShouldWithdraw,
                text: decoration.suffixText,
                style: WidgetStateProperty.resolveAs(decoration.suffixStyle, widgetState)
                    ?? hintStyle,
        ...
        {
            inputLocal = DartRuntimePrimitives.ConvertValue<Widget>(
                new Widgets.Semantics(sortKey: _inputSemanticsSortOrder, child: inputLocal)
            );
        }
        bool decorationIsDense = decoration.isDense ?? false;
        var iconSizeLocal = decorationIsDense ? 18.0 : 24.0;
        Widget? iconLocal =
            (decoration.icon is null)
                ? null
                : new MouseRegion(
                    cursor: SystemMouseCursors.basic,
                    child: new Padding(
                        padding: EdgeInsetsDirectional.CreateOnly(end: 16.0),
        ...
        Widget? prefixIconLocal =
            (decoration.prefixIcon is null)
                ? null
                : new Center(
                    widthFactor: 1.0,
                    heightFactor: 1.0,
                    child: new MouseRegion(
                        ...
                        child: new ConstrainedBox(
                            constraints: decoration.prefixIconConstraints
                                ?? visualDensityLocal.effectiveConstraints(
                                    new BoxConstraints(
                                        minWidth: ConstantsLibrary.kMinInteractiveDimension,
                                        minHeight: ConstantsLibrary.kMinInteractiveDimension
                                    )
                                ),
                            child: IconTheme.merge(
                                data: new IconThemeData(
                                ...
                                child: new IconButtonTheme(
                                    data: new IconButtonThemeData(
                                        style: new ButtonStyle(
                                            ...
                                            iconSize: new WidgetStatePropertyAll<double?>(
                                                iconSizeLocal
                                            )
        ...
        Widget? suffixIconLocal =
            (decoration.suffixIcon is null)
                ? null
                : new Center(
                    widthFactor: 1.0,
                    heightFactor: 1.0,
        ...
        Widget helperErrorLocal = new _HelperError__input_decorator(
            textAlign: textAlign,
        ...
        bool flipHorizontal = textDirectionLocal switch
        {
        ...
        else
        {
            if (!borderLocal.isOutline)
            {
                ...
                if (decoration.filled ?? false)
                {
                    contentPaddingLocal =
                        ...
                        ?? (
                            decorationIsDense
                                ? new EdgeInsetsDirectional(12.0, 4.0, 12.0, 4.0)
                                : new EdgeInsetsDirectional(12.0, 8.0, 12.0, 8.0)
                        );
                }
                else
                {
                    contentPaddingLocal =
                        ...
                        ?? (
                            decorationIsDense
                                ? new EdgeInsetsDirectional(0.0, 4.0, 0.0, 4.0)
                                : new EdgeInsetsDirectional(0.0, 8.0, 0.0, 8.0)
                        );
                }
            }
            else
            {
                ...
                contentPaddingLocal =
                    ...
                    ?? (
                        decorationIsDense
                            ? new EdgeInsetsDirectional(12.0, 16.0, 12.0, 8.0)
                            : new EdgeInsetsDirectional(12.0, 20.0, 12.0, 12.0)
                    );
            }
        }
        var inputGapLocal = 0.0;
        {
            ...
            {
                inputGapLocal =
                    (borderLocal.isOutline || (decoration.filled ?? false))
                        ? Input_decoratorLibrary._kInputExtraPadding
                        : 0.0;
            }
        }
        var decorator = new _Decorator__input_decorator(
            decoration: new _Decoration__input_decorator(
                ...
                isEmpty: isEmpty,
                visualDensity: visualDensityLocal,
                maintainHintSize: maintainHintSizeLocal,
                ...
                prefix: prefixLocal,
                suffix: suffixLocal,
                prefixIcon: prefixIconLocal,
                suffixIcon: suffixIconLocal,
                helperError: helperErrorLocal,
...
public class InputDecoration
{
    ...
    public InputDecoration(
        ...
        long? hintMaxLines = null,
        Duration? hintFadeDuration = null,
    ...
    public static InputDecoration CreateCollapsed(
        string? hintText,
        FloatingLabelBehavior? floatingLabelBehavior = null,
        FloatingLabelAlignment? floatingLabelAlignment = null,
        TextStyle? hintStyle = null,
    ...
    public virtual InputDecoration copyWith(
        Widget? icon = null,
        Color? iconColor = null,
        Widget? label = null,
        string? labelText = null,
        ...
        Duration? hintFadeDuration = null,
        long? hintMaxLines = null,
        bool? maintainHintHeight = null,
        bool? maintainHintSize = null,
        bool? maintainLabelSize = null,
        Widget? error = null,
        string? errorText = null,
        TextStyle? errorStyle = null,
        long? errorMaxLines = null,
        ...
        BoxConstraints? constraints = null,
        VisualDensity? visualDensity = null,
        SemanticsService? semanticsService = null
    )
    {
    ...
    {
        if (
            (inputDecorationTheme is not InputDecorationTheme)
            && (inputDecorationTheme is not InputDecorationThemeData)
        )
        {
            throw DartRuntimePrimitives.AsException(
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is InputDecoration)
            && Equals(__other.icon, icon)
            && Equals(__other.iconColor, iconColor)
            && Equals(__other.label, label)
            && (__other.labelText == labelText)
            && Equals(__other.labelStyle, labelStyle)
            && Equals(__other.floatingLabelStyle, floatingLabelStyle)
            && Equals(__other.helper, helper)
            && (__other.helperText == helperText)
            && Equals(__other.helperStyle, helperStyle)
            && (__other.helperMaxLines == helperMaxLines)
            && (__other.hintText == hintText)
            && Equals(__other.hint, hint)
            && Equals(__other.hintStyle, hintStyle)
            && Equals(__other.hintTextDirection, hintTextDirection)
            && (__other.hintMaxLines == hintMaxLines)
            && Equals(__other.hintFadeDuration, hintFadeDuration)
            && (__other.maintainHintHeight == maintainHintHeight)
            && (__other.maintainHintSize == maintainHintSize)
            && (__other.maintainLabelSize == maintainLabelSize)
            && Equals(__other.error, error)
            && (__other.errorText == errorText)
            && Equals(__other.errorStyle, errorStyle)
            && (__other.errorMaxLines == errorMaxLines)
            && Equals(__other.floatingLabelBehavior, floatingLabelBehavior)
            && Equals(__other.floatingLabelAlignment, floatingLabelAlignment)
            && (__other.isDense == isDense)
            && Equals(__other.contentPadding, contentPadding)
            && (__other.isCollapsed == isCollapsed)
            && Equals(__other.prefixIcon, prefixIcon)
            && Equals(__other.prefixIconColor, prefixIconColor)
            && Equals(__other.prefix, prefix)
            && (__other.prefixText == prefixText)
            && Equals(__other.prefixStyle, prefixStyle)
            && Equals(__other.prefixIconConstraints, prefixIconConstraints)
            && Equals(__other.suffixIcon, suffixIcon)
            && Equals(__other.suffixIconColor, suffixIconColor)
            && Equals(__other.suffix, suffix)
            && (__other.suffixText == suffixText)
            && Equals(__other.suffixStyle, suffixStyle)
            && Equals(__other.suffixIconConstraints, suffixIconConstraints)
            && Equals(__other.counter, counter)
            && (__other.counterText == counterText)
            && Equals(__other.counterStyle, counterStyle)
            && (__other.filled == filled)
            && Equals(__other.fillColor, fillColor)
            && Equals(__other.focusColor, focusColor)
            && Equals(__other.hoverColor, hoverColor)
            && Equals(__other.errorBorder, errorBorder)
            && Equals(__other.focusedBorder, focusedBorder)
            && Equals(__other.focusedErrorBorder, focusedErrorBorder)
            && Equals(__other.disabledBorder, disabledBorder)
            && Equals(__other.enabledBorder, enabledBorder)
            && Equals(__other.border, border)
            && (__other.enabled == enabled)
            && (__other.semanticCounterText == semanticCounterText)
            && (__other.alignLabelWithHint == alignLabelWithHint)
    ...
    public override string ToString()
    {
        var description = (
            (Func<List<string>>)(
                () =>
                {
                    var __collection157531 = new List<string>();
                    if (icon is not null)
                    {
                        __collection157531.Add($"icon: {icon}");
                    }
                    if (iconColor is not null)
                    {
                        __collection157531.Add($"iconColor: {iconColor}");
                    }
                    if (label is not null)
                    {
                        __collection157531.Add($"label: {label}");
                    }
                    if (labelText is not null)
                    {
                        __collection157531.Add($"labelText: \"{labelText}\"");
                    }
                    if (floatingLabelStyle is not null)
                    {
                        __collection157531.Add($"floatingLabelStyle: \"{floatingLabelStyle}\"");
                    }
                    if (helper is not null)
                    {
                        __collection157531.Add($"helper: \"{helper}\"");
                    }
                    if (helperText is not null)
                    {
                        __collection157531.Add($"helperText: \"{helperText}\"");
                    }
                    if (helperMaxLines is not null)
                    {
                        __collection157531.Add($"helperMaxLines: \"{helperMaxLines}\"");
                    }
                    if (hintText is not null)
                    {
                        __collection157531.Add($"hintText: \"{hintText}\"");
                    }
                    if (hint is not null)
                    {
                        __collection157531.Add($"hint: {hint}");
                    }
                    if (hintMaxLines is not null)
                    {
                        __collection157531.Add($"hintMaxLines: \"{hintMaxLines}\"");
                    }
                    if (hintFadeDuration is not null)
                    {
                        __collection157531.Add($"hintFadeDuration: \"{hintFadeDuration}\"");
                    }
                    if (!maintainHintHeight)
                    {
                        __collection157531.Add("maintainHintHeight: false");
                    }
                    if (!maintainHintSize)
                    {
                        __collection157531.Add("maintainHintSize: false");
                    }
                    if (maintainLabelSize)
                    {
                        __collection157531.Add("maintainLabelSize: true");
                    }
                    if (error is not null)
                    {
                        __collection157531.Add($"error: \"{error}\"");
                    }
                    if (errorText is not null)
                    {
                        __collection157531.Add($"errorText: \"{errorText}\"");
                    }
                    if (errorStyle is not null)
                    {
                        __collection157531.Add($"errorStyle: \"{errorStyle}\"");
                    }
                    if (errorMaxLines is not null)
                    {
                        __collection157531.Add($"errorMaxLines: \"{errorMaxLines}\"");
                    }
                    if (floatingLabelBehavior is not null)
                    {
                        __collection157531.Add($"floatingLabelBehavior: {floatingLabelBehavior}");
                    }
                    if (floatingLabelAlignment is not null)
                    {
                        __collection157531.Add($"floatingLabelAlignment: {floatingLabelAlignment}");
                    }
                    if (isDense ?? false)
                    {
                        __collection157531.Add($"isDense: {isDense}");
                    }
                    if (contentPadding is not null)
                    {
                        __collection157531.Add($"contentPadding: {contentPadding}");
                    }
                    if (isCollapsed ?? false)
                    {
                        __collection157531.Add($"isCollapsed: {isCollapsed}");
                    }
                    if (prefixIcon is not null)
                    {
                        __collection157531.Add($"prefixIcon: {prefixIcon}");
                    }
                    if (prefixIconColor is not null)
                    {
                        __collection157531.Add($"prefixIconColor: {prefixIconColor}");
                    }
                    if (prefix is not null)
                    {
                        __collection157531.Add($"prefix: {prefix}");
                    }
                    if (prefixText is not null)
                    {
                        __collection157531.Add($"prefixText: {prefixText}");
                    }
                    if (prefixStyle is not null)
                    {
                        __collection157531.Add($"prefixStyle: {prefixStyle}");
                    }
                    if (prefixIconConstraints is not null)
                    {
                        __collection157531.Add($"prefixIconConstraints: {prefixIconConstraints}");
                    }
                    if (suffixIcon is not null)
                    {
                        __collection157531.Add($"suffixIcon: {suffixIcon}");
                    }
                    if (suffixIconColor is not null)
                    {
                        __collection157531.Add($"suffixIconColor: {suffixIconColor}");
                    }
                    if (suffix is not null)
                    {
                        __collection157531.Add($"suffix: {suffix}");
                    }
                    if (suffixText is not null)
                    {
                        __collection157531.Add($"suffixText: {suffixText}");
                    }
                    if (suffixStyle is not null)
                    {
                        __collection157531.Add($"suffixStyle: {suffixStyle}");
                    }
                    if (suffixIconConstraints is not null)
                    {
                        __collection157531.Add($"suffixIconConstraints: {suffixIconConstraints}");
                    }
                    if (counter is not null)
                    {
                        __collection157531.Add($"counter: {counter}");
                    }
                    if (counterText is not null)
                    {
                        __collection157531.Add($"counterText: {counterText}");
                    }
                    if (counterStyle is not null)
                    {
                        __collection157531.Add($"counterStyle: {counterStyle}");
                    }
                    if (filled ?? false)
                    {
                        __collection157531.Add("filled: true");
                    }
                    if (fillColor is not null)
                    {
                        __collection157531.Add($"fillColor: {fillColor}");
                    }
                    if (focusColor is not null)
                    {
                        __collection157531.Add($"focusColor: {focusColor}");
                    }
                    if (hoverColor is not null)
                    {
                        __collection157531.Add($"hoverColor: {hoverColor}");
                    }
                    if (errorBorder is not null)
                    {
                        __collection157531.Add($"errorBorder: {errorBorder}");
                    }
                    if (focusedBorder is not null)
                    {
                        __collection157531.Add($"focusedBorder: {focusedBorder}");
                    }
                    if (focusedErrorBorder is not null)
                    {
                        __collection157531.Add($"focusedErrorBorder: {focusedErrorBorder}");
                    }
                    if (disabledBorder is not null)
                    {
                        __collection157531.Add($"disabledBorder: {disabledBorder}");
                    }
                    if (enabledBorder is not null)
                    {
                        __collection157531.Add($"enabledBorder: {enabledBorder}");
                    }
                    if (border is not null)
                    {
                        __collection157531.Add($"border: {border}");
                    }
                    if (!enabled)
                    {
                        __collection157531.Add("enabled: false");
                    }
                    if (semanticCounterText is not null)
                    {
                        __collection157531.Add($"semanticCounterText: {semanticCounterText}");
                    }
                    if (alignLabelWithHint is not null)
                    {
                        __collection157531.Add($"alignLabelWithHint: {alignLabelWithHint}");
                    }
                    if (constraints is not null)
                    {
                        __collection157531.Add($"constraints: {constraints}");
                    }
                    if (visualDensity is not null)
                    {
                        __collection157531.Add($"visualDensity: {visualDensity}");
                    }
                    return __collection157531;
                }
            )
        )();
...
public class InputDecorationTheme : InheritedTheme, Diagnosticable
{
    ...
    internal virtual FloatingLabelAlignment _floatingLabelAlignment { get; private set; } =
        default!;
    ...
    public virtual TextStyle? floatingLabelStyle =>
    ...
    public virtual long? helperMaxLines =>
        (_data is not null) ? _data.helperMaxLines : _helperMaxLines;
    public virtual TextStyle? hintStyle => (_data is not null) ? _data.hintStyle : _hintStyle;
    public virtual Duration? hintFadeDuration =>
        (_data is not null) ? _data.hintFadeDuration : _hintFadeDuration;
    ...
    public virtual long? errorMaxLines =>
        (_data is not null) ? _data.errorMaxLines : _errorMaxLines;
    public virtual FloatingLabelBehavior floatingLabelBehavior =>
        (_data is not null) ? _data.floatingLabelBehavior : _floatingLabelBehavior;
    public virtual FloatingLabelAlignment floatingLabelAlignment =>
    ...
    public virtual EdgeInsetsGeometry? contentPadding =>
        (_data is not null) ? _data.contentPadding : _contentPadding;
    ...
    public virtual Color? prefixIconColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.prefixIconColor : _prefixIconColor
        );
    public virtual BoxConstraints? prefixIconConstraints =>
    ...
    public virtual Color? suffixIconColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.suffixIconColor : _suffixIconColor
        );
    public virtual BoxConstraints? suffixIconConstraints =>
        (_data is not null) ? _data.suffixIconConstraints : _suffixIconConstraints;
    public virtual TextStyle? counterStyle =>
        (_data is not null) ? _data.counterStyle : _counterStyle;
    public virtual bool filled => (_data is not null) ? _data.filled : _filled;
    public virtual Color? fillColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.fillColor : _fillColor
        );
    public virtual BorderSide? activeIndicatorBorder =>
        (_data is not null) ? _data.activeIndicatorBorder : _activeIndicatorBorder;
    public virtual BorderSide? outlineBorder =>
        (_data is not null) ? _data.outlineBorder : _outlineBorder;
    public virtual Color? focusColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.focusColor : _focusColor
        );
    public virtual Color? hoverColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.hoverColor : _hoverColor
        );
    public virtual InputBorder? errorBorder =>
        (_data is not null) ? _data.errorBorder : _errorBorder;
    public virtual InputBorder? focusedBorder =>
        (_data is not null) ? _data.focusedBorder : _focusedBorder;
    public virtual InputBorder? focusedErrorBorder =>
        (_data is not null) ? _data.focusedErrorBorder : _focusedErrorBorder;
    public virtual InputBorder? disabledBorder =>
        (_data is not null) ? _data.disabledBorder : _disabledBorder;
    public virtual InputBorder? enabledBorder =>
        (_data is not null) ? _data.enabledBorder : _enabledBorder;
    public virtual InputBorder? border => (_data is not null) ? _data.border : _border;
    public virtual bool alignLabelWithHint =>
        (_data is not null) ? _data.alignLabelWithHint : _alignLabelWithHint;
    public virtual BoxConstraints? constraints =>
        (_data is not null) ? _data.constraints : _constraints;
    public virtual VisualDensity? visualDensity =>
        (_data is not null) ? _data.visualDensity : _visualDensity;
    public virtual InputDecorationThemeData data =>
        DartRuntimePrimitives.ConvertValue<InputDecorationThemeData>(
            _data
...
public class InputDecorationThemeData : Diagnosticable
{
    ...
    public InputDecorationThemeData(
        ...
        FloatingLabelAlignment floatingLabelAlignment = default!,
        bool isDense = false,
        EdgeInsetsGeometry? contentPadding = null,
    ...
    {
        FloatingLabelAlignment __floatingLabelAlignment =
    ...
    public virtual InputDecorationThemeData copyWith(
        TextStyle? labelStyle = null,
        TextStyle? floatingLabelStyle = null,
        TextStyle? helperStyle = null,
        long? helperMaxLines = null,
    ...
    {
        return new InputDecorationThemeData(
            labelStyle: labelStyle ?? this.labelStyle,
            floatingLabelStyle: floatingLabelStyle ?? this.floatingLabelStyle,
            helperStyle: helperStyle ?? this.helperStyle,
            helperMaxLines: helperMaxLines ?? this.helperMaxLines,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is InputDecorationThemeData)
            && Equals(__other.labelStyle, labelStyle)
            && Equals(__other.floatingLabelStyle, floatingLabelStyle)
            && Equals(__other.helperStyle, helperStyle)
            && (__other.helperMaxLines == helperMaxLines)
            ...
            && (__other.filled == filled)
            && Equals(__other.fillColor, fillColor)
            && Equals(__other.activeIndicatorBorder, activeIndicatorBorder)
            && Equals(__other.outlineBorder, outlineBorder)
            && Equals(__other.focusColor, focusColor)
            && Equals(__other.hoverColor, hoverColor)
            && Equals(__other.errorBorder, errorBorder)
            && Equals(__other.focusedBorder, focusedBorder)
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new IntProperty("hintMaxLines", hintMaxLines, defaultValue: defaultTheme.hintMaxLines)
        );
        properties.add(
            new DiagnosticsProperty<TextStyle>(
                "errorStyle",
        ...
        properties.add(
            new DiagnosticsProperty<FloatingLabelBehavior>(
                "floatingLabelBehavior",
                floatingLabelBehavior,
        ...
        properties.add(
            new DiagnosticsProperty<FloatingLabelAlignment>(
                "floatingLabelAlignment",
                floatingLabelAlignment,
        ...
        properties.add(
            new DiagnosticsProperty<bool>("isDense", isDense, defaultValue: defaultTheme.isDense)
        );
        properties.add(
        ...
        properties.add(
            new DiagnosticsProperty<bool>("filled", filled, defaultValue: defaultTheme.filled)
        );
        properties.add(
            new ColorProperty("fillColor", fillColor, defaultValue: defaultTheme.fillColor)
        );
        properties.add(
        ...
        properties.add(
            new ColorProperty("focusColor", focusColor, defaultValue: defaultTheme.focusColor)
        );
        properties.add(
            new ColorProperty("hoverColor", hoverColor, defaultValue: defaultTheme.hoverColor)
        );
        properties.add(
            new DiagnosticsProperty<InputBorder>(
                "errorBorder",
                errorBorder,
...
internal class _InputDecoratorDefaultsM3__input_decorator : InputDecorationThemeData
{
    ...
    public override TextStyle? hintStyle =>
    ...
    public override BorderSide? activeIndicatorBorder =>
        DartRuntimePrimitives.ConvertValue<BorderSide>(
            WidgetStateBorderSide.CreateResolveWith(
                (states) =>
                {
                    if (states.Contains(WidgetState.disabled))
                    {
    ...
    public override BorderSide? outlineBorder =>
        DartRuntimePrimitives.ConvertValue<BorderSide>(
            WidgetStateBorderSide.CreateResolveWith(
                (states) =>
                {
    ...
    public override Color? prefixIconColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            WidgetStateColor.CreateResolveWith(
                (states) =>
                {
    ...
    public override Color? suffixIconColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            WidgetStateColor.CreateResolveWith(
                (states) =>
                {
    ...
    public override TextStyle? floatingLabelStyle =>
        DartRuntimePrimitives.ConvertValue<TextStyle>(
            WidgetStateTextStyle.CreateResolveWith(
                (states) =>
                {
    ...
    public override TextStyle? helperStyle =>
        DartRuntimePrimitives.ConvertValue<TextStyle>(
            WidgetStateTextStyle.CreateResolveWith(
                (states) =>
                {
    ...
    public override TextStyle? errorStyle =>
        DartRuntimePrimitives.ConvertValue<TextStyle>(
            WidgetStateTextStyle.CreateResolveWith(
                (states) =>
                {
