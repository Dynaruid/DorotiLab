            ...
            title: child
                ?? new Text(
                    MaterialLocalizations
                        .of(context)
                        .aboutListTileTitle(
                            applicationName ?? AboutLibrary._defaultApplicationName(context)
                        )
                ),
            dense: dense,
            onTap: () =>
            {
                AboutLibrary.showAboutDialog(
                    context: context,
...
public static partial class AboutLibrary
{
    ...
    )
    {
        DartRuntimePrimitives.Ignore(
            DialogLibrary.showDialog<object?>(
                context: context,
...
public static partial class AboutLibrary
{
    ...
    {
        DartRuntimePrimitives.Ignore(
            DialogLibrary.showAdaptiveDialog<object?>(
                context: context,
                barrierDismissible: barrierDismissible,
                barrierColor: barrierColor,
                barrierLabel: barrierLabel,
                ...
                builder: (context) =>
                {
                    return AboutDialog.CreateAdaptive(
                        applicationName: applicationName,
                        applicationVersion: applicationVersion,
                        applicationIcon: applicationIcon,
                        applicationLegalese: applicationLegalese,
...
public class AboutDialog : StatelessWidget
{
    ...
    public static AboutDialog CreateAdaptive(
        Key? key = null,
        string? applicationName = null,
        string? applicationVersion = null,
        Widget? applicationIcon = null,
        ...
        new _AdaptiveAboutDialog__about(
            key,
            applicationName,
            applicationVersion,
            applicationIcon,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        return new AlertDialog(
            content: new ListBody(
                children: (
                    (Func<List<Widget>>)(
                        () =>
                        {
                            var __collection14686 = new List<Widget>();
                            __collection14686.Add(
                                    ...
                                    new Row(
                                        ...
                                        children: (
                                            (Func<List<Widget>>)(
                                                () =>
                                                {
                                                    var __collection14791 = new List<Widget>();
                                                    if (icon is not null)
                                                    {
                                                        __collection14791.Add(
                                                            DartRuntimePrimitives.ConvertValue<Widget>(
                                                                new IconTheme(
                                                                ...
                                                                child: new Padding(
                                                                    ...
                                                                    child: new ListBody(
                                                                        children: new List<Widget>
                                                                        {
                                                                            ...
                                                                            DartRuntimePrimitives.ConvertValue<Widget>(
                                                                                new SizedBox(
                                                                                    height: AboutLibrary._textVerticalSeparation
                                                                                )
                                                                            ),
                                                                            DartRuntimePrimitives.ConvertValue<Widget>(
                                                                                new Text(
                            ...
                            var __collectionSpread15522 = children;
                            if (__collectionSpread15522 is not null)
                            {
                                __collection14686.AddRange(__collectionSpread15522);
                            }
                            return __collection14686;
                        }
                    )
                )()
            ),
            actions: new List<Widget>
            {
                DartRuntimePrimitives.ConvertValue<Widget>(
                    new TextButton(
                        child: new Text(localizations.viewLicensesButtonLabel),
                        onPressed: () =>
                        {
                            AboutLibrary.showLicensePage(
                                context: context,
                                applicationName: applicationName,
                                applicationVersion: applicationVersion,
                                applicationIcon: applicationIcon,
                ...
                DartRuntimePrimitives.ConvertValue<Widget>(
                    new TextButton(
                        child: new Text(localizations.closeButtonLabel),
                        onPressed: () =>
                        {
...
{
    internal _AdaptiveAboutDialog__about(
        Key? key = null,
        string? applicationName = null,
        string? applicationVersion = null,
        Widget? applicationIcon = null,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        return AlertDialog.CreateAdaptive(
            content: new ListBody(
                children: (
                    (Func<List<Widget>>)(
                        () =>
                        {
                            var __collection19514 = new List<Widget>();
                            __collection19514.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Row(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: (
                                            (Func<List<Widget>>)(
                                                () =>
                                                {
                                                    var __collection19619 = new List<Widget>();
                                                    if (icon is not null)
                                                    {
                                                        __collection19619.Add(
                                                            DartRuntimePrimitives.ConvertValue<Widget>(
                                                                new IconTheme(
                                                                    data: themeData.iconTheme,
                                                                    child: icon
                            ...
                            var __collectionSpread20350 = children;
                            if (__collectionSpread20350 is not null)
                            {
                                __collection19514.AddRange(__collectionSpread20350);
                            }
                            return __collection19514;
                        }
                    )
                )()
            ),
...
public class LicensePage : StatefulWidget
{
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _LicensePageState__about());
}

internal class _LicensePageState__about : State<LicensePage>
{
    public virtual ValueNotifier<long?> selectedId { get; private set; } =
        new ValueNotifier<long?>(null);
    ...
    public override Widget build(BuildContext context)
    {
        return new _MasterDetailFlow__about(
            detailPageFABlessGutterWidth: AboutLibrary._getGutterSize(context),
    ...
    )
    {
        ...
        return new _PackageLicensePage__about(
    ...
    {
        Widget aboutLocal = new _AboutProgram__about(
            name: widget.applicationName ?? AboutLibrary._defaultApplicationName(context),
            icon: widget.applicationIcon ?? AboutLibrary._defaultApplicationIcon(context),
            version: widget.applicationVersion ?? AboutLibrary._defaultApplicationVersion(context),
            legalese: widget.applicationLegalese
        );
        return new _PackagesView__about(
            about: aboutLocal,
            isLateral: isLateral,
...
internal class _AboutProgram__about : StatelessWidget
{
    ...
    internal _AboutProgram__about(
        string name,
        string version,
        Widget? icon = null,
        string? legalese = null
    )
    {
        this.name = name;
    ...
    public override Widget build(BuildContext context)
    {
        return new Padding(
            padding: EdgeInsets.CreateSymmetric(
                horizontal: AboutLibrary._getGutterSize(context),
                vertical: 24.0
            ),
            child: new Column(
                children: (
                    (Func<List<Widget>>)(
                        () =>
                        {
                            var __collection24177 = new List<Widget>();
                            __collection24177.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Text(
                                        name,
                                    ...
                                    DartRuntimePrimitives.ConvertValue<Widget>(
                                        new Padding(
                                            padding: EdgeInsets.CreateOnly(
                                                bottom: AboutLibrary._textVerticalSeparation
                                            ),
                                            child: new Text(
                                                version,
                            ...
                            if ((legalese is not null) && (legalese != ""))
                            {
                                __collection24177.Add(
                                    DartRuntimePrimitives.ConvertValue<Widget>(
                                        new Text(
                            ...
                            __collection24177.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new SizedBox(height: AboutLibrary._textVerticalSeparation)
                                )
                            );
                            __collection24177.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
...
internal class _PackagesView__about : StatefulWidget
{
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _PackagesViewState__about());
}

internal class _PackagesViewState__about : State<_PackagesView__about>
{
    public virtual Future<_LicenseData__about> licenses { get; private set; } =
        Future<_LicenseData__about>.value(new _LicenseData__about());

    public override Widget build(BuildContext context)
    {
        return new FutureBuilder<_LicenseData__about>(
            future: licenses,
                    ...
                    builder: (context, constraints) =>
                    {
                        switch (snapshot.connectionState)
                        {
                            case ConnectionState.done:
                            {
                                ...
                                return new ValueListenableBuilder<long?>(
    ...
    internal virtual void _initDefaultDetailPage(_LicenseData__about data, BuildContext context)
    {
        ...
        _MasterDetailFlow__about
            .of(context)
            .setInitialDetailPage(
                new _DetailArguments__about(
                    packageName,
                    bindings.map((i) => data.licenses[(int)i]).ToList()
                )
            );
    }

    internal virtual Widget _packagesList(
        BuildContext context,
        long? selectedId,
        _LicenseData__about data,
        bool drawSelection
    )
    {
        ...
        return ListView.CreateBuilder(
            ...
            itemCount: checked(data.packages.Count) + 1L,
            itemBuilder: (context, index) =>
            {
                ...
                List<long> bindings = data
                    .packageLicenseBindings.GetValueOrDefault(packageNameLocal)!
                    .ToList();
                return new _PackageListTile__about(
                    packageName: packageNameLocal,
                    index: packageIndex,
                    isSelected: drawSelection && (packageIndex == (selectedId ?? 0L)),
                    numberLicenses: checked(bindings.Count),
                    onTap: () =>
                    {
...
internal class _PackageListTile__about : StatelessWidget
{
    ...
    internal _PackageListTile__about(
        string packageName,
        long? index = null,
        bool isSelected = default!,
        long numberLicenses = default!,
        Action? onTap = null
    )
    {
...
public class _LicenseData__about
{
    ...
    public virtual DartMap<string, List<long>> packageLicenseBindings { get; private set; } =
        new DartMap<string, List<long>>();
    ...
    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(
            FoundationRuntimePorts.ObjectHash(
                packageName,
                FoundationRuntimePorts.ObjectHashAll(licenseEntries)
            )
        );
}
...
internal class _PackageLicensePage__about : StatefulWidget
{
    ...
    internal _PackageLicensePage__about(
        string packageName,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _PackageLicensePageState__about());
}
...
internal class _PackageLicensePageState__about : State<_PackageLicensePage__about>
{
    ...
    internal virtual async Future _initLicenses()
    {
        var debugFlowId = -1L;
        DartRuntimePrimitives.Assert(() =>
        {
            Runtime.Flow flowLocal = Runtime.Flow.begin();
            Timeline.timeSync("_initLicenses()", () => { }, flow: flowLocal);
        ...
        foreach (LicenseEntry license in widget.licenseEntries)
        {
            ...
            List<LicenseParagraph> paragraphsLocal = (
                await Scheduler.SchedulerBinding.instance.scheduleTask<List<LicenseParagraph>>(
                    (Func<object>)(() => license.paragraphs.toList()),
                    Scheduler.Priority.animation,
                    debugLabel: "License"
                )
            ).ToList();
            if (!mounted)
            ...
            {
                _licenses.Add(
                    new Padding(padding: EdgeInsets.CreateAll(18.0), child: new Divider())
                );
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            Timeline.timeSync("Build scheduled", () => { }, flow: Runtime.Flow.end(debugFlowId));
            return true;
        });
    }
    ...
    public override Widget build(BuildContext context)
    {
        ...
        string subtitleLocal = localizations.licensesPackageDetailText(
            checked(widget.licenseEntries.Count)
        );
        ...
        var listWidgets = (
            (Func<List<Widget>>)(
                () =>
                {
                    var __collection36658 = new List<Widget>();
                    __collection36658.AddRange(_licenses);
                    if (!_loaded)
                    {
                        __collection36658.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                new Padding(
                                    padding: EdgeInsets.CreateSymmetric(vertical: 24.0),
        ...
        {
            page = DartRuntimePrimitives.ConvertValue<Widget>(
                new Scaffold(
                    appBar: new AppBar(
                        title: new _PackageLicensePageTitle__about(
                            title: titleLocal,
                            subtitle: subtitleLocal,
                            theme: themeLocal.textTheme,
                            titleTextStyle: themeLocal.appBarTheme.titleTextStyle,
                            foregroundColor: themeLocal.appBarTheme.foregroundColor
                        )
                    ),
                    body: new Center(
                        child: new Material(
                            color: themeLocal.cardColor,
                            elevation: 4.0,
                            child: new ConstrainedBox(
                                constraints: new BoxConstraints(maxWidth: 600.0),
                                child: Localizations.CreateOverride(
                        ...
                        DartRuntimePrimitives.ConvertValue<Widget>(
                            new SliverAppBar(
                                ...
                                title: new _PackageLicensePageTitle__about(
                                    ...
                                    subtitle: subtitleLocal,
                                    theme: themeLocal.textTheme,
                                    titleTextStyle: themeLocal.textTheme.titleLarge
                                )
                            )
                        ),
                        DartRuntimePrimitives.ConvertValue<Widget>(
                            new SliverPadding(
                                padding: paddingLocal,
                                sliver: SliverList.CreateBuilder(
                                    itemCount: checked(listWidgets.Count),
                                    itemBuilder: (context, index) =>
                                    {
                                        return Localizations.CreateOverride(
                                            locale: new Locale("en", "US"),
                                            context: context,
...
internal class _PackageLicensePageTitle__about : StatelessWidget
{
    ...
    internal _PackageLicensePageTitle__about(
        string title,
        string subtitle,
        TextTheme theme,
...
public static partial class AboutLibrary
{
    internal static double _getGutterSize(BuildContext context) =>
...
internal delegate Widget _DetailPageBuilder__about(
    BuildContext context,
    object? arguments,
    ScrollController? scrollController
);

internal delegate List<Widget> _ActionBuilder__about(
    BuildContext context,
    _ActionLevel__about actionLevel
);
...
internal class _MasterDetailFlow__about : StatefulWidget
{
    public virtual Func<BuildContext, bool, Widget> masterViewBuilder { get; private set; } =
        default!;
    public virtual Func<BuildContext, object?, ScrollController?, Widget> detailPageBuilder
    {
        get;
        private set;
    } = default!;
    ...
    internal _MasterDetailFlow__about(
        Func<BuildContext, object?, ScrollController?, Widget> detailPageBuilder,
        Func<BuildContext, bool, Widget> masterViewBuilder,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _MasterDetailFlowState__about());

    public static _MasterDetailFlowProxy__about of(BuildContext context)
    {
        _PageOpener__about? pageOpener =
            context.findAncestorStateOfType<_MasterDetailScaffoldState__about>();
...
internal class _MasterDetailFlowState__about : State<_MasterDetailFlow__about>, _PageOpener__about
{
    ...
    internal virtual GlobalKey<NavigatorState> _navigatorKey { get; private set; } =
    ...
    public virtual void openDetailPage(object arguments)
    {
        ...
        switch (_builtLayout)
        {
            ...
            {
                DartRuntimePrimitives.Ignore(
                    _navigatorKey.currentState!.pushNamed<object>(
                        AboutLibrary._navDetail,
                        arguments: arguments
                    )
                );
                break;
        ...
        return new NavigatorPopHandler<object>(
            ...
            child: new Navigator(
                ...
                onGenerateInitialRoutes: (navigator, initialRoute) =>
                {
                    return focus switch
                    {
                        _Focus__about.master => new List<object> { masterPageRoute },
                        _Focus__about.detail => new List<object>
                        {
                            masterPageRoute,
                ...
                onGenerateRoute: (settings) =>
                {
                    ...
                    {
                        case var __constant48074
                            when Equals(__constant48074, AboutLibrary._navMaster):
                        {
                            focus = _Focus__about.master;
                            return masterPageRoute;
                        }
                        case var __constant48231
                            when Equals(__constant48231, AboutLibrary._navDetail):
                        {
                            focus = _Focus__about.detail;
    ...
    internal virtual Widget _lateralUI(BuildContext context)
    {
        ...
        return new _MasterDetailScaffold__about(
            actionBuilder: (_, _) => new List<Widget>(),
...
internal class _MasterPage__about : StatelessWidget
{
    ...
    internal _MasterPage__about(
        Widget? leading = null,
        Widget? title = null,
        Func<BuildContext, bool, Widget>? masterViewBuilder = null
    )
    {
...
internal class _MasterDetailScaffold__about : StatefulWidget
{
    ...
    public virtual Func<BuildContext, _ActionLevel__about, List<Widget>>? actionBuilder
    {
        get;
        private set;
    }
    ...
    internal _MasterDetailScaffold__about(
        Func<BuildContext, object?, ScrollController?, Widget> detailPageBuilder,
        Func<BuildContext, bool, Widget> masterViewBuilder,
        Func<BuildContext, _ActionLevel__about, List<Widget>>? actionBuilder = null,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _MasterDetailScaffoldState__about());
}

internal class _MasterDetailScaffoldState__about
    : State<_MasterDetailScaffold__about>,
        _PageOpener__about
{
    public virtual FloatingActionButtonLocation floatingActionButtonLocation { get; set; } =
        default!;
    ...
    internal virtual ValueNotifier<object?> _detailArguments { get; private set; } =
        new ValueNotifier<object?>(null);

    public override void initState()
    {
        base.initState();
        detailPageFABlessGutterWidth =
            widget.detailPageFABlessGutterWidth ?? AboutLibrary._kDetailPageFABlessGutterWidth;
    ...
    public virtual void openDetailPage(object arguments)
    {
        Scheduler.SchedulerBinding.instance.addPostFrameCallback(
            (_duration) =>
            {
                _detailArguments.value = arguments;
            }
        );
            ...
            children: new List<Widget>
            {
                DartRuntimePrimitives.ConvertValue<Widget>(
                    new Scaffold(
                        ...
                        appBar: new AppBar(
                            title: widget.title,
                            actions: widget.actionBuilder!(context, _ActionLevel__about.top),
                ...
                DartRuntimePrimitives.ConvertValue<Widget>(
                    new SafeArea(
                        child: new Padding(
                            padding: EdgeInsetsDirectional.CreateOnly(
                                start: masterViewWidth - AboutLibrary._kCardElevation,
                                end: detailPageFABlessGutterWidth
                            ),
                            child: new ValueListenableBuilder<object?>(
                                valueListenable: _detailArguments,
                                builder: (context, value, child) =>
                                {
                                    return new AnimatedSwitcher(
                                        transitionBuilder: (child, animation) =>
                                            new FadeUpwardsPageTransitionsBuilder().buildTransitions<object?>(
                                                null,
                                                null,
                                                animation,
                                                null,
                                        ...
                                        child: SizedBox.CreateExpand(
                                            key: new ValueKey<object?>(
                                                value ?? widget.initialArguments
                                            ),
                                            child: new _DetailView__about(
    ...
    internal virtual ConstrainedBox _masterPanel(BuildContext context, bool needsScaffold = false)
    {
        return new ConstrainedBox(
            constraints: new BoxConstraints(maxWidth: masterViewWidth),
            child: needsScaffold
                ? new Scaffold(
                    appBar: new AppBar(
                        title: widget.title,
...
{
    internal virtual Func<BuildContext, object?, ScrollController?, Widget> _builder
    {
        get;
        private set;
    } = default!;
    ...
    internal _DetailView__about(
        Func<BuildContext, object?, ScrollController?, Widget> builder,
        ...
        return new DraggableScrollableSheet(
            ...
            builder: (context, controller) =>
            {
                return new MouseRegion(
                    child: new Card(
                        color: Theme.of(context).cardColor,
                        elevation: AboutLibrary._kCardElevation,
                        clipBehavior: Clip.antiAlias,
                        margin: new EdgeInsets(
                            AboutLibrary._kCardElevation,
                            0.0,
                            AboutLibrary._kCardElevation,
                            0.0
                        ),
                        shape: new RoundedRectangleBorder(
                            borderRadius: BorderRadius.CreateVertical(top: Radius.circular(3.0))
                        ),
