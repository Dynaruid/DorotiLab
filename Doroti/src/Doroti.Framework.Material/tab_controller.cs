...
public class TabController : ChangeNotifier
{
    ...
    )
    {
        ...
        _animationController = AnimationController.CreateUnbounded(
    ...
    public static TabController Create_(
        long index,
        long previousIndex,
    ...
    {
        var __instance = new TabController(
    ...
    internal virtual TabController _copyWithAndDispose(
        long? index,
        long? length,
        long? previousIndex,
        Duration? animationDuration
    ...
    public virtual bool indexIsChanging =>
        DartRuntimePrimitives.ConvertValue<bool>(_indexIsChangingCount != 0L);
...
internal class _TabControllerScope__tab_controller : InheritedWidget
{
    ...
    internal _TabControllerScope__tab_controller(
...
public class DefaultTabController : StatefulWidget
{
        ...
        : base(key: key)
    {
        ...
        System.Diagnostics.Debug.Assert(length >= 0L);
        System.Diagnostics.Debug.Assert(
            (length == 0L) || ((initialIndex >= 0L) && (initialIndex < length))
        );
    }
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _DefaultTabControllerState__tab_controller()
        );
}

internal class _DefaultTabControllerState__tab_controller
    : State<DefaultTabController>,
        SingleTickerProviderStateMixin<DefaultTabController>
{
    ...
    {
        return new _TabControllerScope__tab_controller(
    ...
    public override void didUpdateWidget(DefaultTabController oldWidget)
    {
        ...
        if (oldWidget.length != widget.length)
        {
            ...
            _controller = _controller._copyWithAndDispose(
                ...
                animationDuration: widget.animationDuration,
                index: newIndex,
                previousIndex: previousIndexLocal
            );
        }
