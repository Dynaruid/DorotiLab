...
public class SpellCheckSuggestionsToolbar : global::Doroti.Framework.Widgets.StatelessWidget
{
    ...
    {
        global::Doroti.Framework.Services.SuggestionSpan? spanAtCursorIndex__3301 = ((global::Doroti.Framework.Services.SuggestionSpan?)(object?)editableTextState.findSuggestionSpanAtCursorIndex(((global::Doroti.Framework.Widgets.EditableTextState)editableTextState).currentTextEditingValue.selection.baseOffset));
        if ((spanAtCursorIndex__3301 is null))
        {
            return null;
        }
        var buttonItems__3523 = new List<global::Doroti.Framework.Widgets.ContextMenuButtonItem>();
        foreach (string suggestion__3620 in ((global::Doroti.Framework.Services.SuggestionSpan)spanAtCursorIndex__3301).suggestions.take(Spell_check_suggestions_toolbarLibrary._kMaxSuggestions))
        {
            buttonItems__3523.Add(new global::Doroti.Framework.Widgets.ContextMenuButtonItem(onPressed: ((global::System.Action)(() =>
            {
                if (!editableTextState.mounted)
                {
                    return;
                }
                SpellCheckSuggestionsToolbar._replaceText(editableTextState, suggestion__3620, ((global::Doroti.Framework.Services.SuggestionSpan)spanAtCursorIndex__3301).range);
            })), label: suggestion__3620));
        }
        var deleteButton__4041 = new global::Doroti.Framework.Widgets.ContextMenuButtonItem(onPressed: ((global::System.Action)(() =>
        {
            if (!editableTextState.mounted)
            {
                return;
    ...
    internal static void _replaceText(global::Doroti.Framework.Widgets.EditableTextState editableTextState, string text, TextRange replacementRange)
    {
        ...
        global::Doroti.Framework.Services.TextEditingValue newValue__4710 = ((global::Doroti.Framework.Services.TextEditingValue)(object?)((global::Doroti.Framework.Widgets.EditableTextState)editableTextState).textEditingValue.replaced(replacementRange, text));
        editableTextState.userUpdateTextEditingValue(newValue__4710, global::Doroti.Framework.Services.SelectionChangedCause.toolbar);
    ...
    internal virtual List<global::Doroti.Framework.Widgets.Widget> _buildToolbarButtons(global::Doroti.Framework.Widgets.BuildContext context)
    {
        return this.buttonItems.map<global::Doroti.Framework.Widgets.ContextMenuButtonItem, global::Doroti.Framework.Widgets.Widget>(((buttonItem) =>
        {
            ...
            {
                return ((global::Doroti.Framework.Widgets.Widget)(object?)button__5837);
            }
            return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.DecoratedBox(decoration: new global::Doroti.Framework.Painting.BoxDecoration(border: new global::Doroti.Framework.Painting.Border(top: new global::Doroti.Framework.Painting.BorderSide(color: Colors.grey))), child: button__5837));
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Widgets.MediaQueryData mediaQueryData__6949 = ((global::Doroti.Framework.Widgets.MediaQueryData)(object?)MediaQuery.of(context));
        double softKeyboardViewInsetsBottom__7007 = ((global::Doroti.Framework.Widgets.MediaQueryData)mediaQueryData__6949).viewInsets.bottom;
        double paddingAbove__7089 = (((global::Doroti.Framework.Widgets.MediaQueryData)mediaQueryData__6949).padding.top + CupertinoTextSelectionToolbar.kToolbarScreenPadding);
        var localAdjustment__7237 = new global::Doroti.Ui.Offset(CupertinoTextSelectionToolbar.kToolbarScreenPadding, paddingAbove__7089);
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Padding(padding: new global::Doroti.Framework.Painting.EdgeInsets(CupertinoTextSelectionToolbar.kToolbarScreenPadding, paddingAbove__7089, CupertinoTextSelectionToolbar.kToolbarScreenPadding, (CupertinoTextSelectionToolbar.kToolbarScreenPadding + softKeyboardViewInsetsBottom__7007)), child: new global::Doroti.Framework.Widgets.CustomSingleChildLayout(@delegate: new SpellCheckSuggestionsToolbarLayoutDelegate(anchor: (this.anchor - localAdjustment__7237)), child: new global::Doroti.Framework.Widgets.AnimatedSize(duration: Duration.Create(milliseconds: 140L), child: new _SpellCheckSuggestionsToolbarContainer__spell_check_suggestions_toolbar(height: spellCheckSuggestionsToolbarHeight__6746, children: ((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection8142 = new List<global::Doroti.Framework.Widgets.Widget>(); __collection8142.AddRange(_buildToolbarButtons(context)); return __collection8142; }))())))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
