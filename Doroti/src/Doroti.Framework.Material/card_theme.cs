...
public class CardTheme : InheritedWidget, Diagnosticable
{
                ...
                || (
                    (
                        (
                            (
                                (
                                    (((object?)clipBehavior ?? color) ?? surfaceTintColor)
                                    ?? shadowColor
                                ) ?? elevation
                            ) ?? margin
                        ) ?? shape
    ...
    public virtual CardTheme copyWith(
        Clip? clipBehavior = null,
        Color? color = null,
        Color? shadowColor = null,
        Color? surfaceTintColor = null,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((CardTheme)oldWidget).data));
...
public class CardThemeData : Diagnosticable
{
    ...
    public virtual CardThemeData copyWith(
        Clip? clipBehavior = null,
        Color? color = null,
        Color? shadowColor = null,
        Color? surfaceTintColor = null,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is CardThemeData)
