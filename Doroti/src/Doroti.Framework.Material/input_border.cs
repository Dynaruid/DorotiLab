...
public abstract class InputBorder : ShapeBorder
{
    ...
    public abstract InputBorder copyWith(BorderSide? borderSide = null, BorderRadius? borderRadius = null, double? gapPadding = null, ShapeBorder? shape = null);
    ...
    public abstract void paint(Canvas canvas, Rect rect, TextDirection? textDirection = null, double? gapStart = 0.0, double gapExtent = 0.0, double gapPercentage = default!, BoxShape shape = BoxShape.rectangle, BorderRadius? borderRadius = null);
}
...
internal class _NoInputBorder__input_border : InputBorder
{
    ...
    public override _NoInputBorder__input_border copyWith(BorderSide? borderSide = null, BorderRadius? borderRadius = null, double? gapPadding = null, ShapeBorder? shape = null) => new _NoInputBorder__input_border();
    public override bool isOutline => false;
    public override EdgeInsetsGeometry dimensions => DartRuntimePrimitives.ConvertValue<EdgeInsetsGeometry>(EdgeInsets.zero);
        ...
        return ((Func<Path>)(() =>
{
    ...
    public override void paint(Canvas canvas, Rect rect, TextDirection? textDirection = null, double? gapStart = 0.0, double gapExtent = 0.0, double gapPercentage = default!, BoxShape shape = BoxShape.rectangle, BorderRadius? borderRadius = null)
    {
    }
...
public class UnderlineInputBorder : InputBorder
{
    ...
    public UnderlineInputBorder(BorderSide borderSide = default!, BorderRadius borderRadius = default!) : base(borderSide: borderSide ?? new BorderSide())
    {
        BorderRadius __borderRadius = DartRuntimePrimitives.ConvertValue<BorderRadius>(borderRadius ?? BorderRadiusGeometry.CreateOnly(topLeft: Radius.circular(4.0), topRight: Radius.circular(4.0)));
        this.borderRadius = __borderRadius;
    }

    public override bool isOutline => false;
    public override UnderlineInputBorder copyWith(BorderSide? borderSide = null, BorderRadius? borderRadius = null, double? gapPadding = null, ShapeBorder? shape = null)
    {
    ...
    public override EdgeInsetsGeometry dimensions
    {
        get
        {
            return EdgeInsets.CreateOnly(bottom: borderSide.width);
        }
    }
...
{
    var __cascade = new Path();
    __cascade.addRect(Rect.fromLTWH(rect.left, rect.top, rect.width, Math.Max(0.0, rect.height - borderSide.width)));
    return __cascade;
}))();
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
        ...
        return ((Func<Path>)(() =>
{
    ...
    public override ShapeBorder? lerpFrom(ShapeBorder? a, double t)
    {
        if (a is UnderlineInputBorder)
        {
            ...
            return (ShapeBorder?)new UnderlineInputBorder(borderSide: BorderSide.lerp(a__as7313.borderSide, borderSide, t), borderRadius: BorderRadius.lerp(a__as7313.borderRadius, borderRadius, t)!);
        }
    ...
    public override ShapeBorder? lerpTo(ShapeBorder? b, double t)
    {
        if (b is UnderlineInputBorder)
        {
            ...
            return (ShapeBorder?)new UnderlineInputBorder(borderSide: BorderSide.lerp(borderSide, b__as7641.borderSide, t), borderRadius: BorderRadius.lerp(borderRadius, b__as7641.borderRadius, t)!);
        }
    ...
    public override void paint(Canvas canvas, Rect rect, TextDirection? textDirection = null, double? gapStart = 0.0, double gapExtent = 0.0, double gapPercentage = default!, BoxShape shape = BoxShape.rectangle, BorderRadius? borderRadius = null)
    {
        ...
        if ((!Equals(this.borderRadius.bottomLeft, Radius.zero)) || (!Equals(this.borderRadius.bottomRight, Radius.zero)))
        {
            var updatedBorderRadius = new BorderRadius(bottomLeft: this.borderRadius.bottomLeft.clamp(maximum: Radius.circular(rect.height / 2L)), bottomRight: this.borderRadius.bottomRight.clamp(maximum: Radius.circular(rect.height / 2L)));
            BoxBorder.paintNonUniformBorder(canvas, rect, textDirection: textDirection, borderRadius: updatedBorderRadius, bottom: borderSide.copyWith(strokeAlign: BorderSide.strokeAlignInside), color: borderSide.color);
        }
        else
        {
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is UnderlineInputBorder) && Equals(__other.borderSide, borderSide) && Equals(__other.borderRadius, borderRadius);
    }

    public override int GetHashCode() => DartRuntimePrimitives.ConvertValue<int>(FoundationRuntimePorts.ObjectHash(borderSide, borderRadius));
}
...
public class OutlineInputBorder : InputBorder
{
    ...
    public OutlineInputBorder(BorderSide borderSide = default!, BorderRadius borderRadius = default!, double gapPadding = 4.0) : base(borderSide: borderSide ?? new BorderSide())
    {
    ...
    public override OutlineInputBorder copyWith(BorderSide? borderSide = null, BorderRadius? borderRadius = null, double? gapPadding = null, ShapeBorder? shape = null)
    {
    ...
    public override EdgeInsetsGeometry dimensions
    {
        get
        {
            return EdgeInsets.CreateAll(borderSide.strokeInset);
        }
    }
    public override OutlineInputBorder scale(double t)
    {
        return new OutlineInputBorder(borderSide: borderSide.scale(t), borderRadius: borderRadius.op_Multiply(t), gapPadding: gapPadding * t);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override ShapeBorder? lerpFrom(ShapeBorder? a, double t)
    {
        if (a is OutlineInputBorder)
        {
            ...
            return (ShapeBorder?)new OutlineInputBorder(borderRadius: BorderRadius.lerp(outline.borderRadius, borderRadius, t)!, borderSide: BorderSide.lerp(outline.borderSide, borderSide, t), gapPadding: DartRuntimePrimitives.RequireValue(outline.gapPadding));
        }
        return base.lerpFrom(a, t);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override ShapeBorder? lerpTo(ShapeBorder? b, double t)
    {
        if (b is OutlineInputBorder)
        {
            ...
            return (ShapeBorder?)new OutlineInputBorder(borderRadius: BorderRadius.lerp(borderRadius, outline.borderRadius, t)!, borderSide: BorderSide.lerp(borderSide, outline.borderSide, t), gapPadding: DartRuntimePrimitives.RequireValue(outline.gapPadding));
        }
        return base.lerpTo(b, t);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
{
    var __cascade = new Path();
    __cascade.addRRect(borderRadius.resolve(textDirection).toRRect(rect).deflate(borderSide.strokeInset));
    return __cascade;
}))();
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
        ...
        return ((Func<Path>)(() =>
{
    ...
    public override bool preferPaintInterior => true;
    internal virtual Path _gapBorderPath(Canvas canvas, RRect center, double outerWidth, double start, double extent)
    {
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is OutlineInputBorder) && Equals(__other.borderSide, borderSide) && Equals(__other.borderRadius, borderRadius) && (__other.gapPadding == gapPadding);
    }

    public override int GetHashCode() => DartRuntimePrimitives.ConvertValue<int>(FoundationRuntimePorts.ObjectHash(borderSide, borderRadius, gapPadding));
}
...
public class ShapedInputBorder : InputBorder
{
    ...
    public ShapedInputBorder(BorderSide borderSide = default!, ShapeBorder shape = default!, double gapPadding = 4.0) : base(borderSide: borderSide ?? new BorderSide())
    {
        this.shape = shape;
        this.gapPadding = gapPadding;
        System.Diagnostics.Debug.Assert(gapPadding >= 0.0);
    ...
    public override bool isOutline => true;
    public override ShapedInputBorder copyWith(BorderSide? borderSide = null, BorderRadius? borderRadius = null, double? gapPadding = null, ShapeBorder? shape = null)
    {
    ...
    public override EdgeInsetsGeometry dimensions
    {
        get
        {
            return EdgeInsets.CreateAll(borderSide.width);
        }
    }
    public override ShapedInputBorder scale(double t)
    {
        return new ShapedInputBorder(borderSide: borderSide.scale(t), shape: shape.scale(t), gapPadding: gapPadding * t);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override ShapeBorder? lerpFrom(ShapeBorder? a, double t)
    {
        if (a is ShapedInputBorder)
        {
            ...
            return (ShapeBorder?)new ShapedInputBorder(borderSide: BorderSide.lerp(a__as23771.borderSide, borderSide, t), shape: lerp(a__as23771.shape, shape, t)!, gapPadding: DartRuntimePrimitives.RequireValue(a__as23771.gapPadding));
        }
        return base.lerpFrom(a, t);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override ShapeBorder? lerpTo(ShapeBorder? b, double t)
    {
        if (b is ShapedInputBorder)
        {
            ...
            return (ShapeBorder?)new ShapedInputBorder(borderSide: BorderSide.lerp(borderSide, b__as24105.borderSide, t), shape: lerp(shape, b__as24105.shape, t)!, gapPadding: DartRuntimePrimitives.RequireValue(b__as24105.gapPadding));
        }
        return base.lerpTo(b, t);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    internal virtual Path _gapBorderPath(Rect rect, double start, double extent, TextDirection? textDirection = null)
    {
        ...
        var gapRect = ((Func<Path>)(() =>
{
    ...
    public override void paint(Canvas canvas, Rect rect, TextDirection? textDirection = null, double? gapStart = 0.0, double gapExtent = 0.0, double gapPercentage = default!, BoxShape shape = BoxShape.rectangle, BorderRadius? borderRadius = null)
    {
        ...
        if ((gapStart is null) || (gapExtent <= 0.0) || (gapPercentage == 0.0))
        {
            ...
            {
                OutlinedBorder shape__as27236 = DartRuntimePrimitives.ConvertValue<OutlinedBorder>(shape);
        ...
        else
        {
            double extent = DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(0.0, gapExtent + (gapPadding * 2.0), gapPercentage));
            double start = DartRuntimePrimitives.RequireValue(textDirection) switch { TextDirection.rtl => DartRuntimePrimitives.RequireValue(gapStart) + gapPadding - extent, TextDirection.ltr => DartRuntimePrimitives.RequireValue(gapStart) - gapPadding, _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") };
            Path path = _gapBorderPath(deflatedRect, Math.Max(0.0, start), extent, textDirection: DartRuntimePrimitives.RequireValue(textDirection));
            canvas.drawPath(path, paintLocal);
        }
    }
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is ShapedInputBorder) && Equals(__other.borderSide, borderSide) && Equals(__other.shape, shape) && (__other.gapPadding == gapPadding);
    }

    public override int GetHashCode() => DartRuntimePrimitives.ConvertValue<int>(FoundationRuntimePorts.ObjectHash(borderSide, shape, gapPadding));
}
