...
public class CheckboxListTile : global::Doroti.Framework.Widgets.StatelessWidget
{
    ...
    {
        global::Doroti.Framework.Widgets.Widget control__19024 = default!;
        switch (this._checkboxType)
        {
            case _CheckboxType__checkbox_list_tile.material:
                {
                    control__19024 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.ExcludeFocus(child: new Checkbox(value: this.value, onChanged: ((global::System.Action<bool?>)((this.enabled ?? true) ? this.onChanged : null)), mouseCursor: this.mouseCursor, activeColor: this.activeColor, fillColor: this.fillColor, checkColor: this.checkColor, hoverColor: this.hoverColor, overlayColor: this.overlayColor, splashRadius: this.splashRadius, materialTapTargetSize: (this.materialTapTargetSize ?? MaterialTapTargetSize.shrinkWrap), autofocus: this.autofocus, tristate: this.tristate, shape: this.checkboxShape, side: this.side, isError: this.isError, semanticLabel: this.checkboxSemanticLabel)));
                    break;
                }
            case _CheckboxType__checkbox_list_tile.adaptive:
                {
                    control__19024 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.ExcludeFocus(child: Checkbox.CreateAdaptive(value: this.value, onChanged: ((global::System.Action<bool?>)((this.enabled ?? true) ? this.onChanged : null)), mouseCursor: this.mouseCursor, activeColor: this.activeColor, fillColor: this.fillColor, checkColor: this.checkColor, hoverColor: this.hoverColor, overlayColor: this.overlayColor, splashRadius: this.splashRadius, materialTapTargetSize: (this.materialTapTargetSize ?? MaterialTapTargetSize.shrinkWrap), autofocus: this.autofocus, tristate: this.tristate, shape: this.checkboxShape, side: this.side, isError: this.isError, semanticLabel: this.checkboxSemanticLabel)));
                    break;
                }
        }
        if ((this.checkboxScaleFactor != 1.0))
        {
            control__19024 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(global::Doroti.Framework.Widgets.Transform.CreateScale(scale: this.checkboxScaleFactor, child: control__19024));
        }
        ...
        var (leading__20971, trailing__20988) = (effectiveControlAffinity__20831 switch { ListTileControlAffinity.leading => (((global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?)>((control__19024, this.secondary)))), ListTileControlAffinity.trailing => (((global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?)>((this.secondary, control__19024)))), ListTileControlAffinity.platform => (((global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?)>((this.secondary, control__19024)))), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        ThemeData theme__21227 = Theme.of(context);
        CheckboxThemeData checkboxTheme__21282 = CheckboxTheme.of(context);
        var states__21335 = ((Func<HashSet<global::Doroti.Framework.Widgets.WidgetState>>)(() => { var __collection21344 = new HashSet<global::Doroti.Framework.Widgets.WidgetState>(); if (this.selected) { __collection21344.Add(global::Doroti.Framework.Widgets.WidgetState.selected); } return __collection21344; }))();
