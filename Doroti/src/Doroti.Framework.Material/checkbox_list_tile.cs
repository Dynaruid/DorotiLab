...
public class CheckboxListTile : global::Doroti.Framework.Widgets.StatelessWidget
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        {
            control = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(Transform.CreateScale(scale: this.checkboxScaleFactor, child: control));
        }
        ...
        var states = ((Func<HashSet<global::Doroti.Framework.Widgets.WidgetState>>)(() => { var __collection21344 = new HashSet<global::Doroti.Framework.Widgets.WidgetState>(); if (this.selected) { __collection21344.Add(WidgetState.selected); } return __collection21344; }))();
        global::Doroti.Ui.Color effectiveActiveColor = ((global::Doroti.Ui.Color)(((this.activeColor ?? (Color?)checkboxTheme.fillColor?.resolve(states))) ?? theme.colorScheme.secondary));
