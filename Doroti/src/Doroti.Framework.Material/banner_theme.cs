...
public class MaterialBannerThemeData : Diagnosticable
{
    ...
    public virtual MaterialBannerThemeData copyWith(
        Color? backgroundColor = null,
        Color? surfaceTintColor = null,
        Color? shadowColor = null,
        Color? dividerColor = null,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is MaterialBannerThemeData)
            ...
            && Equals(__other.leadingPadding, leadingPadding);
    }
...
public class MaterialBannerTheme : InheritedTheme
{
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(
            !Equals(data, ((MaterialBannerTheme)oldWidget).data)
        );
}
