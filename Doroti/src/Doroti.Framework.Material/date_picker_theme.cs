...
public class DatePickerThemeData : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    public virtual global::Doroti.Framework.Painting.TextStyle? headerHeadlineStyle { get; private set; }
    public virtual global::Doroti.Framework.Painting.TextStyle? headerHelpStyle { get; private set; }
    public virtual global::Doroti.Framework.Painting.TextStyle? weekdayStyle { get; private set; }
    public virtual global::Doroti.Framework.Painting.TextStyle? dayStyle { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? dayForegroundColor { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? dayBackgroundColor { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? dayOverlayColor { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Framework.Painting.OutlinedBorder?>? dayShape { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? todayForegroundColor { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? todayBackgroundColor { get; private set; }
    public virtual global::Doroti.Framework.Painting.BorderSide? todayBorder { get; private set; }
    public virtual global::Doroti.Framework.Painting.TextStyle? yearStyle { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? yearForegroundColor { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? yearBackgroundColor { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? yearOverlayColor { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Framework.Painting.OutlinedBorder?>? yearShape { get; private set; }
    ...
    public virtual global::Doroti.Framework.Painting.ShapeBorder? rangePickerShape { get; private set; }
    ...
    public virtual global::Doroti.Framework.Painting.TextStyle? rangePickerHeaderHeadlineStyle { get; private set; }
    public virtual global::Doroti.Framework.Painting.TextStyle? rangePickerHeaderHelpStyle { get; private set; }
    public virtual Color? rangeSelectionBackgroundColor { get; private set; }
    public virtual global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? rangeSelectionOverlayColor { get; private set; }
    ...
    public virtual global::Doroti.Framework.Painting.TextStyle? toggleButtonTextStyle { get; private set; }
    ...
    public static DatePickerThemeData lerp(DatePickerThemeData? a, DatePickerThemeData? b, double t)
    {
        ...
        return new DatePickerThemeData(backgroundColor: Dart_uiLibrary.Color.lerp(a?.backgroundColor, b?.backgroundColor, t), elevation: Dart_uiLibrary.lerpDouble(a?.elevation, b?.elevation, t), shadowColor: Dart_uiLibrary.Color.lerp(a?.shadowColor, b?.shadowColor, t), surfaceTintColor: Dart_uiLibrary.Color.lerp(a?.surfaceTintColor, b?.surfaceTintColor, t), shape: ShapeBorder.lerp(a?.shape, b?.shape, t), headerBackgroundColor: Dart_uiLibrary.Color.lerp(a?.headerBackgroundColor, b?.headerBackgroundColor, t), headerForegroundColor: Dart_uiLibrary.Color.lerp(a?.headerForegroundColor, b?.headerForegroundColor, t), headerHeadlineStyle: TextStyle.lerp(a?.headerHeadlineStyle, b?.headerHeadlineStyle, t), headerHelpStyle: TextStyle.lerp(a?.headerHelpStyle, b?.headerHelpStyle, t), weekdayStyle: TextStyle.lerp(a?.weekdayStyle, b?.weekdayStyle, t), dayStyle: TextStyle.lerp(a?.dayStyle, b?.dayStyle, t), dayForegroundColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.dayForegroundColor, b?.dayForegroundColor, t, Color.lerp), dayBackgroundColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.dayBackgroundColor, b?.dayBackgroundColor, t, Color.lerp), dayOverlayColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.dayOverlayColor, b?.dayOverlayColor, t, Color.lerp), dayShape: WidgetStateProperty.lerp<global::Doroti.Framework.Painting.OutlinedBorder?>(a?.dayShape, b?.dayShape, t, OutlinedBorder.lerp), todayForegroundColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.todayForegroundColor, b?.todayForegroundColor, t, Color.lerp), todayBackgroundColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.todayBackgroundColor, b?.todayBackgroundColor, t, Color.lerp), todayBorder: _lerpBorderSide(a?.todayBorder, b?.todayBorder, t), yearStyle: TextStyle.lerp(a?.yearStyle, b?.yearStyle, t), yearForegroundColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.yearForegroundColor, b?.yearForegroundColor, t, Color.lerp), yearBackgroundColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.yearBackgroundColor, b?.yearBackgroundColor, t, Color.lerp), yearOverlayColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.yearOverlayColor, b?.yearOverlayColor, t, Color.lerp), yearShape: WidgetStateProperty.lerp<global::Doroti.Framework.Painting.OutlinedBorder?>(a?.yearShape, b?.yearShape, t, OutlinedBorder.lerp), rangePickerBackgroundColor: Dart_uiLibrary.Color.lerp(a?.rangePickerBackgroundColor, b?.rangePickerBackgroundColor, t), rangePickerElevation: Dart_uiLibrary.lerpDouble(a?.rangePickerElevation, b?.rangePickerElevation, t), rangePickerShadowColor: Dart_uiLibrary.Color.lerp(a?.rangePickerShadowColor, b?.rangePickerShadowColor, t), rangePickerSurfaceTintColor: Dart_uiLibrary.Color.lerp(a?.rangePickerSurfaceTintColor, b?.rangePickerSurfaceTintColor, t), rangePickerShape: ShapeBorder.lerp(a?.rangePickerShape, b?.rangePickerShape, t), rangePickerHeaderBackgroundColor: Dart_uiLibrary.Color.lerp(a?.rangePickerHeaderBackgroundColor, b?.rangePickerHeaderBackgroundColor, t), rangePickerHeaderForegroundColor: Dart_uiLibrary.Color.lerp(a?.rangePickerHeaderForegroundColor, b?.rangePickerHeaderForegroundColor, t), rangePickerHeaderHeadlineStyle: TextStyle.lerp(a?.rangePickerHeaderHeadlineStyle, b?.rangePickerHeaderHeadlineStyle, t), rangePickerHeaderHelpStyle: TextStyle.lerp(a?.rangePickerHeaderHelpStyle, b?.rangePickerHeaderHelpStyle, t), rangeSelectionBackgroundColor: Dart_uiLibrary.Color.lerp(a?.rangeSelectionBackgroundColor, b?.rangeSelectionBackgroundColor, t), rangeSelectionOverlayColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.rangeSelectionOverlayColor, b?.rangeSelectionOverlayColor, t, Color.lerp), dividerColor: Dart_uiLibrary.Color.lerp(a?.dividerColor, b?.dividerColor, t), inputDecorationTheme: (t < 0.5) ? a?.inputDecorationTheme : b?.inputDecorationTheme, cancelButtonStyle: ButtonStyle.lerp(a?.cancelButtonStyle, b?.cancelButtonStyle, t), confirmButtonStyle: ButtonStyle.lerp(a?.confirmButtonStyle, b?.confirmButtonStyle, t), locale: (t < 0.5) ? a?.locale : b?.locale, toggleButtonTextStyle: TextStyle.lerp(a?.toggleButtonTextStyle, b?.toggleButtonTextStyle, t), subHeaderForegroundColor: Dart_uiLibrary.Color.lerp(a?.subHeaderForegroundColor, b?.subHeaderForegroundColor, t));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal static global::Doroti.Framework.Painting.BorderSide? _lerpBorderSide(global::Doroti.Framework.Painting.BorderSide? a, global::Doroti.Framework.Painting.BorderSide? b, double t)
    {
        ...
        return (global::Doroti.Framework.Painting.BorderSide?)BorderSide.lerp(a, new global::Doroti.Framework.Painting.BorderSide(width: 0, color: a.color.withAlpha(0L)), t);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is DatePickerThemeData) && Equals(__other.backgroundColor, backgroundColor) && (__other.elevation == elevation) && Equals(__other.shadowColor, shadowColor) && Equals(__other.surfaceTintColor, surfaceTintColor) && Equals(__other.shape, shape) && Equals(__other.headerBackgroundColor, headerBackgroundColor) && Equals(__other.headerForegroundColor, headerForegroundColor) && Equals(__other.headerHeadlineStyle, headerHeadlineStyle) && Equals(__other.headerHelpStyle, headerHelpStyle) && Equals(__other.weekdayStyle, weekdayStyle) && Equals(__other.dayStyle, dayStyle) && Equals(__other.dayForegroundColor, dayForegroundColor) && Equals(__other.dayBackgroundColor, dayBackgroundColor) && Equals(__other.dayOverlayColor, dayOverlayColor) && Equals(__other.dayShape, dayShape) && Equals(__other.todayForegroundColor, todayForegroundColor) && Equals(__other.todayBackgroundColor, todayBackgroundColor) && Equals(__other.todayBorder, todayBorder) && Equals(__other.yearStyle, yearStyle) && Equals(__other.yearForegroundColor, yearForegroundColor) && Equals(__other.yearBackgroundColor, yearBackgroundColor) && Equals(__other.yearOverlayColor, yearOverlayColor) && Equals(__other.yearShape, yearShape) && Equals(__other.rangePickerBackgroundColor, rangePickerBackgroundColor) && (__other.rangePickerElevation == rangePickerElevation) && Equals(__other.rangePickerShadowColor, rangePickerShadowColor) && Equals(__other.rangePickerSurfaceTintColor, rangePickerSurfaceTintColor) && Equals(__other.rangePickerShape, rangePickerShape) && Equals(__other.rangePickerHeaderBackgroundColor, rangePickerHeaderBackgroundColor) && Equals(__other.rangePickerHeaderForegroundColor, rangePickerHeaderForegroundColor) && Equals(__other.rangePickerHeaderHeadlineStyle, rangePickerHeaderHeadlineStyle) && Equals(__other.rangePickerHeaderHelpStyle, rangePickerHeaderHelpStyle) && Equals(__other.rangeSelectionBackgroundColor, rangeSelectionBackgroundColor) && Equals(__other.rangeSelectionOverlayColor, rangeSelectionOverlayColor) && Equals(__other.dividerColor, dividerColor) && Equals(__other.inputDecorationTheme, inputDecorationTheme) && Equals(__other.cancelButtonStyle, cancelButtonStyle) && Equals(__other.confirmButtonStyle, confirmButtonStyle) && Equals(__other.locale, locale) && Equals(__other.toggleButtonTextStyle, toggleButtonTextStyle) && Equals(__other.subHeaderForegroundColor, subHeaderForegroundColor);
    }
    ...
    public virtual void debugFillProperties(global::Doroti.Framework.Foundation.DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("headerBackgroundColor", headerBackgroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("headerForegroundColor", headerForegroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("headerHeadlineStyle", headerHeadlineStyle, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("headerHelpStyle", headerHelpStyle, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("weekDayStyle", weekdayStyle, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("dayStyle", dayStyle, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("dayForegroundColor", dayForegroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("dayBackgroundColor", dayBackgroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("dayOverlayColor", dayOverlayColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Framework.Painting.OutlinedBorder?>>("dayShape", dayShape, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("todayForegroundColor", todayForegroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("todayBackgroundColor", todayBackgroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.BorderSide?>("todayBorder", todayBorder, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("yearStyle", yearStyle, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("yearForegroundColor", yearForegroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("yearBackgroundColor", yearBackgroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("yearOverlayColor", yearOverlayColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Framework.Painting.OutlinedBorder?>>("yearShape", yearShape, defaultValue: null));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("rangePickerBackgroundColor", rangePickerBackgroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DoubleProperty("rangePickerElevation", rangePickerElevation, defaultValue: null));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("rangePickerShadowColor", rangePickerShadowColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("rangePickerSurfaceTintColor", rangePickerSurfaceTintColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.ShapeBorder>("rangePickerShape", rangePickerShape, defaultValue: null));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("rangePickerHeaderBackgroundColor", rangePickerHeaderBackgroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("rangePickerHeaderForegroundColor", rangePickerHeaderForegroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("rangePickerHeaderHeadlineStyle", rangePickerHeaderHeadlineStyle, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("rangePickerHeaderHelpStyle", rangePickerHeaderHelpStyle, defaultValue: null));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("rangeSelectionBackgroundColor", rangeSelectionBackgroundColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("rangeSelectionOverlayColor", rangeSelectionOverlayColor, defaultValue: null));
        ...
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("toggleButtonTextStyle", toggleButtonTextStyle, defaultValue: null));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("subHeaderForegroundColor", subHeaderForegroundColor, defaultValue: null));
    }
...
public class DatePickerTheme : global::Doroti.Framework.Widgets.InheritedTheme
{
    public virtual DatePickerThemeData data { get; private set; } = default!;

    public DatePickerTheme(global::Doroti.Framework.Foundation.Key? key = null, DatePickerThemeData data = default!, global::Doroti.Framework.Widgets.Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }
    ...
    public static DatePickerThemeData? maybeOf(global::Doroti.Framework.Widgets.BuildContext context)
    {
        return context.dependOnInheritedWidgetOfExactType<DatePickerTheme>()?.data;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public static DatePickerThemeData defaults(global::Doroti.Framework.Widgets.BuildContext context)
    {
    ...
    public override bool updateShouldNotify(global::Doroti.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((DatePickerTheme)oldWidget).data));
}
...
internal class _DatePickerDefaultsM3__date_picker_theme : DatePickerThemeData
{
    ...
    public override global::Doroti.Framework.Painting.TextStyle? toggleButtonTextStyle => _textTheme.titleSmall?.apply(color: subHeaderForegroundColor);
    ...
    public override global::Doroti.Framework.Painting.TextStyle? headerHeadlineStyle => _textTheme.headlineLarge;
    public override global::Doroti.Framework.Painting.TextStyle? headerHelpStyle => _textTheme.labelLarge;
    public override global::Doroti.Framework.Painting.TextStyle? weekdayStyle => _textTheme.bodyLarge?.apply(color: _colors.onSurface);
    public override global::Doroti.Framework.Painting.TextStyle? dayStyle => _textTheme.bodyLarge;
    ...
    public override global::Doroti.Framework.Widgets.WidgetStateProperty<Color?>? todayBackgroundColor => dayBackgroundColor;
    public override global::Doroti.Framework.Painting.BorderSide? todayBorder => new global::Doroti.Framework.Painting.BorderSide(color: _colors.primary);
    public override global::Doroti.Framework.Painting.TextStyle? yearStyle => _textTheme.bodyLarge;
    ...
    public override global::Doroti.Framework.Painting.TextStyle? rangePickerHeaderHeadlineStyle => _textTheme.titleLarge;
    public override global::Doroti.Framework.Painting.TextStyle? rangePickerHeaderHelpStyle => _textTheme.titleSmall;
}
