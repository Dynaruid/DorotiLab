...
public class DatePickerThemeData : Diagnosticable
{
    ...
    public DatePickerThemeData(Color? backgroundColor = null, double? elevation = null, Color? shadowColor = null, Color? surfaceTintColor = null, ShapeBorder? shape = null, Color? headerBackgroundColor = null, Color? headerForegroundColor = null, TextStyle? headerHeadlineStyle = null, TextStyle? headerHelpStyle = null, TextStyle? weekdayStyle = null, TextStyle? dayStyle = null, WidgetStateProperty<Color?>? dayForegroundColor = null, WidgetStateProperty<Color?>? dayBackgroundColor = null, WidgetStateProperty<Color?>? dayOverlayColor = null, WidgetStateProperty<OutlinedBorder?>? dayShape = null, WidgetStateProperty<Color?>? todayForegroundColor = null, WidgetStateProperty<Color?>? todayBackgroundColor = null, BorderSide? todayBorder = null, TextStyle? yearStyle = null, WidgetStateProperty<Color?>? yearForegroundColor = null, WidgetStateProperty<Color?>? yearBackgroundColor = null, WidgetStateProperty<Color?>? yearOverlayColor = null, WidgetStateProperty<OutlinedBorder?>? yearShape = null, Color? rangePickerBackgroundColor = null, double? rangePickerElevation = null, Color? rangePickerShadowColor = null, Color? rangePickerSurfaceTintColor = null, ShapeBorder? rangePickerShape = null, Color? rangePickerHeaderBackgroundColor = null, Color? rangePickerHeaderForegroundColor = null, TextStyle? rangePickerHeaderHeadlineStyle = null, TextStyle? rangePickerHeaderHelpStyle = null, Color? rangeSelectionBackgroundColor = null, WidgetStateProperty<Color?>? rangeSelectionOverlayColor = null, Color? dividerColor = null, object? inputDecorationTheme = null, ButtonStyle? cancelButtonStyle = null, ButtonStyle? confirmButtonStyle = null, Locale? locale = null, TextStyle? toggleButtonTextStyle = null, Color? subHeaderForegroundColor = null)
    {
    ...
    internal static BorderSide? _lerpBorderSide(BorderSide? a, BorderSide? b, double t)
    {
        ...
        if (a is null)
        {
            return (BorderSide?)BorderSide.lerp(new BorderSide(width: 0, color: b!.color.withAlpha(0L)), b, t);
        }
        return (BorderSide?)BorderSide.lerp(a, new BorderSide(width: 0, color: a.color.withAlpha(0L)), t);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new ColorProperty("headerBackgroundColor", headerBackgroundColor, defaultValue: null));
        properties.add(new ColorProperty("headerForegroundColor", headerForegroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("headerHeadlineStyle", headerHeadlineStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("headerHelpStyle", headerHelpStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("weekDayStyle", weekdayStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("dayStyle", dayStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("dayForegroundColor", dayForegroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("dayBackgroundColor", dayBackgroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("dayOverlayColor", dayOverlayColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<OutlinedBorder?>>("dayShape", dayShape, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("todayForegroundColor", todayForegroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("todayBackgroundColor", todayBackgroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<BorderSide?>("todayBorder", todayBorder, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("yearStyle", yearStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("yearForegroundColor", yearForegroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("yearBackgroundColor", yearBackgroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("yearOverlayColor", yearOverlayColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<OutlinedBorder?>>("yearShape", yearShape, defaultValue: null));
        properties.add(new ColorProperty("rangePickerBackgroundColor", rangePickerBackgroundColor, defaultValue: null));
        properties.add(new DoubleProperty("rangePickerElevation", rangePickerElevation, defaultValue: null));
        properties.add(new ColorProperty("rangePickerShadowColor", rangePickerShadowColor, defaultValue: null));
        properties.add(new ColorProperty("rangePickerSurfaceTintColor", rangePickerSurfaceTintColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<ShapeBorder>("rangePickerShape", rangePickerShape, defaultValue: null));
        properties.add(new ColorProperty("rangePickerHeaderBackgroundColor", rangePickerHeaderBackgroundColor, defaultValue: null));
        properties.add(new ColorProperty("rangePickerHeaderForegroundColor", rangePickerHeaderForegroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("rangePickerHeaderHeadlineStyle", rangePickerHeaderHeadlineStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("rangePickerHeaderHelpStyle", rangePickerHeaderHelpStyle, defaultValue: null));
        properties.add(new ColorProperty("rangeSelectionBackgroundColor", rangeSelectionBackgroundColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("rangeSelectionOverlayColor", rangeSelectionOverlayColor, defaultValue: null));
        ...
        properties.add(new DiagnosticsProperty<TextStyle>("toggleButtonTextStyle", toggleButtonTextStyle, defaultValue: null));
        properties.add(new ColorProperty("subHeaderForegroundColor", subHeaderForegroundColor, defaultValue: null));
    }
...
public class DatePickerTheme : InheritedTheme
{
    ...
    public DatePickerTheme(Key? key = null, DatePickerThemeData data = default!, Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((DatePickerTheme)oldWidget).data));
}
...
internal class _DatePickerDefaultsM3__date_picker_theme : DatePickerThemeData
{
    ...
    internal _DatePickerDefaultsM3__date_picker_theme(BuildContext context) : base(elevation: 6.0, shape: new RoundedRectangleBorder(borderRadius: BorderRadius.CreateAll(Radius.circular(28.0))), dayShape: new WidgetStatePropertyAll<OutlinedBorder>(new CircleBorder()), yearShape: new WidgetStatePropertyAll<OutlinedBorder>(new StadiumBorder()), rangePickerElevation: 0.0, rangePickerShape: new RoundedRectangleBorder())
    {
    ...
    public override TextStyle? toggleButtonTextStyle => _textTheme.titleSmall?.apply(color: subHeaderForegroundColor);
    ...
    public override TextStyle? weekdayStyle => _textTheme.bodyLarge?.apply(color: _colors.onSurface);
    public override TextStyle? dayStyle => _textTheme.bodyLarge;
    public override WidgetStateProperty<Color?>? dayForegroundColor => WidgetStateProperty.resolveWith((states) =>
    {
    ...
    public override WidgetStateProperty<Color?>? dayBackgroundColor => WidgetStateProperty.resolveWith((states) =>
    {
        if (states.Contains(WidgetState.selected))
        {
    ...
    public override WidgetStateProperty<Color?>? dayOverlayColor => WidgetStateProperty.resolveWith((states) =>
    {
        if (states.Contains(WidgetState.selected))
        {
    ...
    public override WidgetStateProperty<Color?>? todayForegroundColor => WidgetStateProperty.resolveWith((states) =>
    {
        if (states.Contains(WidgetState.selected))
        {
            return _colors.onPrimary;
    ...
    public override WidgetStateProperty<Color?>? yearForegroundColor => WidgetStateProperty.resolveWith((states) =>
    {
        if (states.Contains(WidgetState.selected))
        {
            return _colors.onPrimary;
    ...
    public override WidgetStateProperty<Color?>? yearBackgroundColor => WidgetStateProperty.resolveWith((states) =>
    {
        if (states.Contains(WidgetState.selected))
        {
            return _colors.primary;
    ...
    public override WidgetStateProperty<Color?>? yearOverlayColor => WidgetStateProperty.resolveWith((states) =>
    {
        if (states.Contains(WidgetState.selected))
        {
            if (states.Contains(WidgetState.pressed))
    ...
    public override WidgetStateProperty<Color?>? rangeSelectionOverlayColor => WidgetStateProperty.resolveWith((states) =>
    {
        if (states.Contains(WidgetState.pressed))
        {
