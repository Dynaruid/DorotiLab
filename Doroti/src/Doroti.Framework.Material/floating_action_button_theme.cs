...
public class FloatingActionButtonThemeData : Diagnosticable
{
    ...
    public virtual FloatingActionButtonThemeData copyWith(
        Color? foregroundColor = null,
        Color? backgroundColor = null,
        Color? focusColor = null,
        Color? hoverColor = null,
    ...
    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(
            FoundationRuntimePorts.ObjectHash(
                ...
                extendedPadding,
                FoundationRuntimePorts.ObjectHash(extendedTextStyle, mouseCursor)
            )
        );
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is FloatingActionButtonThemeData)
            ...
            && (__other.focusElevation == focusElevation)
            && (__other.hoverElevation == hoverElevation)
            && (__other.disabledElevation == disabledElevation)
            && (__other.highlightElevation == highlightElevation)
            && Equals(__other.shape, shape)
            && (__other.enableFeedback == enableFeedback)
            && (__other.iconSize == iconSize)
            && Equals(__other.sizeConstraints, sizeConstraints)
            && Equals(__other.smallSizeConstraints, smallSizeConstraints)
            && Equals(__other.largeSizeConstraints, largeSizeConstraints)
            && Equals(__other.extendedSizeConstraints, extendedSizeConstraints)
            && (__other.extendedIconLabelSpacing == extendedIconLabelSpacing)
            && Equals(__other.extendedPadding, extendedPadding)
            && Equals(__other.extendedTextStyle, extendedTextStyle)
...
public class FloatingActionButtonTheme : InheritedTheme
{
    ...
    public FloatingActionButtonTheme(
        Key? key = null,
        FloatingActionButtonThemeData data = default!,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(
            !Equals(data, ((FloatingActionButtonTheme)oldWidget).data)
        );
}
