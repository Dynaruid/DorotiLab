...
public class FloatingActionButtonThemeData : Diagnosticable
{
    ...
    public virtual BoxConstraints? sizeConstraints { get; private set; }
    public virtual BoxConstraints? smallSizeConstraints { get; private set; }
    public virtual BoxConstraints? largeSizeConstraints { get; private set; }
    public virtual BoxConstraints? extendedSizeConstraints { get; private set; }
    ...
    public FloatingActionButtonThemeData(Color? foregroundColor = null, Color? backgroundColor = null, Color? focusColor = null, Color? hoverColor = null, Color? splashColor = null, double? elevation = null, double? focusElevation = null, double? hoverElevation = null, double? disabledElevation = null, double? highlightElevation = null, ShapeBorder? shape = null, bool? enableFeedback = null, double? iconSize = null, BoxConstraints? sizeConstraints = null, BoxConstraints? smallSizeConstraints = null, BoxConstraints? largeSizeConstraints = null, BoxConstraints? extendedSizeConstraints = null, double? extendedIconLabelSpacing = null, EdgeInsetsGeometry? extendedPadding = null, TextStyle? extendedTextStyle = null, WidgetStateProperty<MouseCursor?>? mouseCursor = null)
    {
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<BoxConstraints>("sizeConstraints", sizeConstraints, defaultValue: null));
        properties.add(new DiagnosticsProperty<BoxConstraints>("smallSizeConstraints", smallSizeConstraints, defaultValue: null));
        properties.add(new DiagnosticsProperty<BoxConstraints>("largeSizeConstraints", largeSizeConstraints, defaultValue: null));
        properties.add(new DiagnosticsProperty<BoxConstraints>("extendedSizeConstraints", extendedSizeConstraints, defaultValue: null));
        properties.add(new DoubleProperty("extendedIconLabelSpacing", extendedIconLabelSpacing, defaultValue: null));
        properties.add(new DiagnosticsProperty<EdgeInsetsGeometry>("extendedPadding", extendedPadding, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("extendedTextStyle", extendedTextStyle, defaultValue: null));
...
public class FloatingActionButtonTheme : InheritedTheme
{
    public virtual FloatingActionButtonThemeData data { get; private set; } = default!;

    public FloatingActionButtonTheme(Key? key = null, FloatingActionButtonThemeData data = default!, Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((FloatingActionButtonTheme)oldWidget).data));
}
