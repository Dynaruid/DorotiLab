...
public class DesktopTextSelectionToolbarButton : StatelessWidget
{
    ...
    public static DesktopTextSelectionToolbarButton CreateText(
        Key? key = null,
    ...
    {
        var __instance = new DesktopTextSelectionToolbarButton(
            key: key,
            onPressed: onPressed,
            child: default!
        );
        __instance.onPressed = onPressed;
        __instance.child = new Text(
            text,
            overflow: TextOverflow.ellipsis,
            style: Desktop_text_selection_toolbar_buttonLibrary._kToolbarButtonFontStyle.copyWith(
                color: Equals(Theme.of(context).colorScheme.brightness, Brightness.dark)
                    ? Colors.white
                    : Colors.black87
            )
        );
        ...
        return new SizedBox(
            ...
            child: new TextButton(
                style: TextButton.styleFrom(
                    ...
                    foregroundColor: foregroundColorLocal,
                    shape: new RoundedRectangleBorder(),
                    minimumSize: new Size(ConstantsLibrary.kMinInteractiveDimension, 36.0),
