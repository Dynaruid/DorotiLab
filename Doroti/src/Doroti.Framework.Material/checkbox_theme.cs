...
public class CheckboxThemeData : global::Doroti.Generated.Framework.Foundation.Diagnosticable
{
    ...
    public static CheckboxThemeData lerp(CheckboxThemeData? a, CheckboxThemeData? b, double t)
    {
        ...
        return new CheckboxThemeData(mouseCursor: ((t < 0.5) ? a?.mouseCursor : b?.mouseCursor), fillColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.fillColor, b?.fillColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), checkColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.checkColor, b?.checkColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), overlayColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.overlayColor, b?.overlayColor, t, (global::System.Func<Color?, Color?, double, Color?>)Color.lerp), splashRadius: Dart_uiLibrary.lerpDouble(a?.splashRadius, b?.splashRadius, t), materialTapTargetSize: ((t < 0.5) ? a?.materialTapTargetSize : b?.materialTapTargetSize), visualDensity: ((t < 0.5) ? a?.visualDensity : b?.visualDensity), shape: ((global::Doroti.Generated.Framework.Painting.OutlinedBorder?)(object?)ShapeBorder.lerp(a?.shape, b?.shape, t))!, side: CheckboxThemeData._lerpSides(a?.side, b?.side, t));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual void debugFillProperties(global::Doroti.Generated.Framework.Foundation.DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("fillColor", this.fillColor, defaultValue: null));
        properties.add(new global::Doroti.Generated.Framework.Foundation.DiagnosticsProperty<global::Doroti.Generated.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("checkColor", this.checkColor, defaultValue: null));
