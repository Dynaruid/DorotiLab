...
public class PaginatedDataTableState : global::Doroti.Framework.Widgets.State<PaginatedDataTable>
{
    ...
    internal virtual global::Doroti.Framework.Widgets.GlobalKey<IState> _tableKey { get; private set; } = global::Doroti.Framework.Widgets.GlobalKey<IState>.Create();
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        if ((((PaginatedDataTable)this.widget).onRowsPerPageChanged is not null))
        {
            ...
            footerWidgets.AddRange(new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: 14.0)), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Text(localizations.rowsPerPageTitle)), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.ConstrainedBox(constraints: new global::Doroti.Framework.Rendering.BoxConstraints(minWidth: 64.0), child: new global::Doroti.Framework.Widgets.Align(alignment: global::Doroti.Framework.Painting.AlignmentDirectional.centerEnd, child: new DropdownButtonHideUnderline(child: new DropdownButton<long>(items: availableRowsPerPageLocal.cast<DropdownMenuItem<long>>().ToList(), value: ((PaginatedDataTable)this.widget).rowsPerPage, onChanged: (value => ((PaginatedDataTable)this.widget).onRowsPerPageChanged?.Invoke(value)), style: footerTextStyle))))) }.Cast<global::Doroti.Framework.Widgets.Widget>());
        }
        footerWidgets.AddRange(((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection19346 = new List<global::Doroti.Framework.Widgets.Widget>(); __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: 32.0))); __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Text(localizations.pageRowsInfoTitle((this._firstRowIndex + 1L), Math.Min((this._firstRowIndex + ((PaginatedDataTable)this.widget).rowsPerPage), this._rowCount), this._rowCount, this._rowCountApproximate)))); __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: 32.0))); if (((PaginatedDataTable)this.widget).showFirstLastButtons) { __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new IconButton(icon: new global::Doroti.Framework.Widgets.Icon(Icons.skip_previous), padding: global::Doroti.Framework.Painting.EdgeInsets.zero, color: ((PaginatedDataTable)this.widget).arrowHeadColor, tooltip: localizations.firstPageTooltip, onPressed: ((global::System.Action)((this._firstRowIndex <= 0L) ? null : this._handleFirst))))); } __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new IconButton(icon: new global::Doroti.Framework.Widgets.Icon(Icons.chevron_left), padding: global::Doroti.Framework.Painting.EdgeInsets.zero, color: ((PaginatedDataTable)this.widget).arrowHeadColor, tooltip: localizations.previousPageTooltip, onPressed: ((global::System.Action)((this._firstRowIndex <= 0L) ? null : this._handlePrevious))))); __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: 24.0))); __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new IconButton(icon: new global::Doroti.Framework.Widgets.Icon(Icons.chevron_right), padding: global::Doroti.Framework.Painting.EdgeInsets.zero, color: ((PaginatedDataTable)this.widget).arrowHeadColor, tooltip: localizations.nextPageTooltip, onPressed: ((global::System.Action)(_isNextPageUnavailable() ? null : this._handleNext))))); if (((PaginatedDataTable)this.widget).showFirstLastButtons) { __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new IconButton(icon: new global::Doroti.Framework.Widgets.Icon(Icons.skip_next), padding: global::Doroti.Framework.Painting.EdgeInsets.zero, color: ((PaginatedDataTable)this.widget).arrowHeadColor, tooltip: localizations.lastPageTooltip, onPressed: ((global::System.Action)(_isNextPageUnavailable() ? null : this._handleLast))))); } __collection19346.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: 14.0))); return __collection19346; }))().Cast<global::Doroti.Framework.Widgets.Widget>());
