...
public class PaginatedDataTableState : global::Doroti.Framework.Widgets.State<PaginatedDataTable>
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        var headerWidgets__17380 = new List<global::Doroti.Framework.Widgets.Widget>();
        if (((this._selectedRowCount == 0L) && (((PaginatedDataTable)this.widget).header is not null)))
        {
            headerWidgets__17380.Add(new global::Doroti.Framework.Widgets.Expanded(child: ((PaginatedDataTable)this.widget).header!));
        }
        else
        {
            if ((((PaginatedDataTable)this.widget).header is not null))
            {
                headerWidgets__17380.Add(new global::Doroti.Framework.Widgets.Expanded(child: new global::Doroti.Framework.Widgets.Text(localizations__17305.selectedRowCountTitle(this._selectedRowCount))));
            }
        }
