...
public abstract class _ActionButton__action_buttons : IconButton
{
    ...
    internal _ActionButton__action_buttons(
        Key? key = null,
        Color? color = null,
        ButtonStyle? style = null,
        Action? onPressed = null,
        Widget icon = default!,
        StandardComponentType? standardComponent = null
    )
        : base(key: key, color: color, style: style, onPressed: onPressed, icon: icon)
    {
    ...
    public override Widget build(BuildContext context)
    {
        ...
        return new IconButton(
            key: standardComponent is { } component
                ? StandardComponentTypeMembers.key(component)
                : null,
            icon: icon,
            style: style,
            color: color,
...
internal delegate Func<BuildContext, Widget>? _ActionIconBuilderCallback__action_buttons(
    ActionIconThemeData? actionIconTheme
);

internal delegate IconData _ActionIconDataCallback__action_buttons(BuildContext context);

internal delegate string _AndroidSemanticsLabelCallback__action_buttons(
    MaterialLocalizations materialLocalization
);

internal class _ActionIcon__action_buttons : StatelessWidget
{
    public virtual Func<ActionIconThemeData?, Func<BuildContext, Widget>?> iconBuilderCallback
    {
        get;
        private set;
    } = default!;
    public virtual Func<BuildContext, IconData> getIcon { get; private set; } = default!;
    public virtual Func<MaterialLocalizations, string> getAndroidSemanticsLabel
    {
        get;
        private set;
    } = default!;
...
public class BackButtonIcon : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        return new _ActionIcon__action_buttons(
...
public class BackButton : _ActionButton__action_buttons
{
    ...
    internal override void _onPressedCallback(BuildContext context) =>
...
{
    public CloseButtonIcon(Key? key = null)
        : base(key: key) { }
...
{
    public DrawerButtonIcon(Key? key = null)
        : base(key: key) { }
...
{
    public EndDrawerButtonIcon(Key? key = null)
        : base(key: key) { }
