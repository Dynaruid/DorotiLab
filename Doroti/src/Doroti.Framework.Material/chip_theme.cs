...
public class ChipTheme : InheritedTheme
{
    ...
    public ChipTheme(Key? key = null, ChipThemeData data = default!, Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((ChipTheme)oldWidget).data));
}
...
public class ChipThemeData : Diagnosticable
{
    ...
    public ChipThemeData(WidgetStateProperty<Color?>? color = null, Color? backgroundColor = null, Color? deleteIconColor = null, Color? disabledColor = null, Color? selectedColor = null, Color? secondarySelectedColor = null, Color? shadowColor = null, Color? surfaceTintColor = null, Color? selectedShadowColor = null, bool? showCheckmark = null, Color? checkmarkColor = null, EdgeInsetsGeometry? labelPadding = null, EdgeInsetsGeometry? padding = null, BorderSide? side = null, OutlinedBorder? shape = null, TextStyle? labelStyle = null, TextStyle? secondaryLabelStyle = null, Brightness? brightness = null, double? elevation = null, double? pressElevation = null, IconThemeData? iconTheme = null, BoxConstraints? avatarBoxConstraints = null, BoxConstraints? deleteIconBoxConstraints = null)
    {
        this.color = color;
    ...
    public static ChipThemeData CreateFromDefaults(Brightness? brightness = null, Color? primaryColor = null, Color secondaryColor = default!, TextStyle labelStyle = default!)
    {
    ...
    {
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("color", color, defaultValue: null));
        ...
        properties.add(new ColorProperty("secondarySelectedColor", secondarySelectedColor, defaultValue: null));
        ...
        properties.add(new ColorProperty("selectedShadowColor", selectedShadowColor, defaultValue: null));
        properties.add(new DiagnosticsProperty<bool>("showCheckmark", showCheckmark, defaultValue: null));
        ...
        properties.add(new DiagnosticsProperty<TextStyle>("secondaryLabelStyle", secondaryLabelStyle, defaultValue: null));
        ...
        properties.add(new DiagnosticsProperty<BoxConstraints>("avatarBoxConstraints", avatarBoxConstraints, defaultValue: null));
        properties.add(new DiagnosticsProperty<BoxConstraints>("deleteIconBoxConstraints", deleteIconBoxConstraints, defaultValue: null));
    }
