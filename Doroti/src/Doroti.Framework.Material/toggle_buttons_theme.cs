...
public class ToggleButtonsThemeData : Diagnosticable
{
    ...
    public virtual ToggleButtonsThemeData copyWith(
        TextStyle? textStyle = null,
        BoxConstraints? constraints = null,
        Color? color = null,
        Color? selectedColor = null,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is ToggleButtonsThemeData)
            ...
            && Equals(__other.borderColor, borderColor)
            && Equals(__other.selectedBorderColor, selectedBorderColor)
            && Equals(__other.disabledBorderColor, disabledBorderColor)
            && Equals(__other.borderRadius, borderRadius)
            && (__other.borderWidth == borderWidth);
    }
...
public class ToggleButtonsTheme : InheritedTheme
{
    ...
    public ToggleButtonsTheme(
        Key? key = null,
        ToggleButtonsThemeData data = default!,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(
            !Equals(data, ((ToggleButtonsTheme)oldWidget).data)
        );
}
