...
public class ChoiceChip : StatelessWidget, ChipAttributes, SelectableChipAttributes, CheckmarkableChipAttributes, DisabledChipAttributes
{
    ...
    public ChoiceChip(Key? key = null, Widget? avatar = null, Widget label = default!, TextStyle? labelStyle = null, EdgeInsetsGeometry? labelPadding = null, System.Action<bool>? onSelected = null, double? pressElevation = null, bool selected = default!, Color? selectedColor = null, Color? disabledColor = null, string? tooltip = null, BorderSide? side = null, OutlinedBorder? shape = null, Clip clipBehavior = Clip.none, FocusNode? focusNode = null, bool autofocus = false, WidgetStateProperty<Color?>? color = null, Color? backgroundColor = null, EdgeInsetsGeometry? padding = null, VisualDensity? visualDensity = null, MaterialTapTargetSize? materialTapTargetSize = null, double? elevation = null, Color? shadowColor = null, Color? surfaceTintColor = null, IconThemeData? iconTheme = null, Color? selectedShadowColor = null, bool? showCheckmark = null, Color? checkmarkColor = null, ShapeBorder avatarBorder = default!, BoxConstraints? avatarBoxConstraints = null, ChipAnimationStyle? chipAnimationStyle = null, MouseCursor? mouseCursor = null) : base(key: key)
    {
    ...
    public static ChoiceChip CreateElevated(Key? key = null, Widget? avatar = null, Widget label = default!, TextStyle? labelStyle = null, EdgeInsetsGeometry? labelPadding = null, System.Action<bool>? onSelected = null, double? pressElevation = null, bool selected = default!, Color? selectedColor = null, Color? disabledColor = null, string? tooltip = null, BorderSide? side = null, OutlinedBorder? shape = null, Clip clipBehavior = Clip.none, FocusNode? focusNode = null, bool autofocus = false, WidgetStateProperty<Color?>? color = null, Color? backgroundColor = null, EdgeInsetsGeometry? padding = null, VisualDensity? visualDensity = null, MaterialTapTargetSize? materialTapTargetSize = null, double? elevation = null, Color? shadowColor = null, Color? surfaceTintColor = null, IconThemeData? iconTheme = null, Color? selectedShadowColor = null, bool? showCheckmark = null, Color? checkmarkColor = null, ShapeBorder avatarBorder = default!, BoxConstraints? avatarBoxConstraints = null, ChipAnimationStyle? chipAnimationStyle = null, MouseCursor? mouseCursor = null)
    {
...
internal class _ChoiceChipDefaultsM3__choice_chip : ChipThemeData
{
    ...
    internal _ChoiceChipDefaultsM3__choice_chip(BuildContext context, bool isEnabled, bool isSelected, _ChipVariant__choice_chip _chipVariant) : base(shape: new RoundedRectangleBorder(borderRadius: BorderRadius.CreateAll(Radius.circular(8.0))), showCheckmark: true)
    {
    ...
    public override Color? shadowColor => DartRuntimePrimitives.ConvertValue<Color>(Equals(_chipVariant, _ChipVariant__choice_chip.flat) ? Colors.transparent : _colors.shadow);
    public override Color? surfaceTintColor => DartRuntimePrimitives.ConvertValue<Color>(Colors.transparent);
    public override Color? checkmarkColor => DartRuntimePrimitives.ConvertValue<Color>(isEnabled ? (isSelected ? _colors.onSecondaryContainer : _colors.primary) : _colors.onSurface);
    ...
    public override BorderSide? side => (Equals(_chipVariant, _ChipVariant__choice_chip.flat) && !isSelected) ? (isEnabled ? new BorderSide(color: _colors.outlineVariant) : new BorderSide(color: _colors.onSurface.withOpacity(0.12))) : new BorderSide(color: Colors.transparent);
    public override IconThemeData? iconTheme => new IconThemeData(color: isEnabled ? (isSelected ? _colors.onSecondaryContainer : _colors.primary) : _colors.onSurface, size: 18.0);
