...
public class ThemeData : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    public static ThemeData CreateLight() => ThemeData.Create(brightness: Brightness.light);

    public static ThemeData CreateDark() => ThemeData.Create(brightness: Brightness.dark);

    public static ThemeData CreateFallback() => ThemeData.CreateLight();
