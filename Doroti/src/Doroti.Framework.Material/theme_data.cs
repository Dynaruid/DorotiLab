...
public class ThemeData : Diagnosticable
{
    ...
    public virtual DartMap<object, ThemeExtension<object>> extensions { get; private set; } =
        default!;
    ...
    public virtual TargetPlatform platform { get; private set; } = default!;
    ...
    public virtual IconThemeData primaryIconTheme { get; private set; } = default!;
    ...
    public virtual BottomNavigationBarThemeData bottomNavigationBarTheme { get; private set; } =
        default!;
    ...
    public virtual FloatingActionButtonThemeData floatingActionButtonTheme { get; private set; } =
        default!;
    ...
    public virtual ProgressIndicatorThemeData progressIndicatorTheme { get; private set; } =
        default!;
    ...
    internal static _FifoCache__theme_data<
        _IdentityThemeDataCacheKey__theme_data,
        ThemeData
    > _localizedThemeDataCache = new _FifoCache__theme_data<
        _IdentityThemeDataCacheKey__theme_data,
        ThemeData
    >(_localizedThemeDataCacheSize);

    public static ThemeData Create(
        IEnumerable<Adaptation<object>>? adaptations = null,
        bool? applyElevationOverlayColor = null,
        NoDefaultCupertinoThemeData? cupertinoOverrideTheme = null,
        IEnumerable<ThemeExtension<object>>? extensions = null,
    ...
    )
    {
        ...
        var isDark = Equals(effectiveBrightness, Brightness.dark);
        {
            ...
            {
                colorScheme = ColorScheme.CreateFromSeed(
            ...
            colorScheme ??= (
                isDark
                    ? Theme_dataLibrary._colorSchemeDarkM3
                    : Theme_dataLibrary._colorSchemeLightM3
            );
        ...
        Brightness estimatedPrimaryColorBrightness = estimateBrightnessForColor(primaryColor);
        ...
        dividerColor ??= (isDark ? new Color(536870911L) : new Color(520093696L));
        colorScheme ??= ColorScheme.CreateFromSwatch(
            primarySwatch: primarySwatch,
            accentColor: isDark ? Colors.tealAccent[200L]! : primarySwatch[500L]!,
            cardColor: cardColor,
            backgroundColor: isDark ? Colors.grey[700L]! : primarySwatch[200L]!,
            errorColor: Colors.red[700L],
            brightness: effectiveBrightness
        );
        ...
        buttonTheme ??= new ButtonThemeData(
            ...
            buttonColor: isDark ? primarySwatch[600L]! : Colors.grey[300L]!,
        ...
        iconTheme ??= (
            isDark
                ? new IconThemeData(color: ConstantsLibrary.kDefaultIconLightColor)
                : new IconThemeData(color: ConstantsLibrary.kDefaultIconDarkColor)
        );
        primaryIconTheme ??= (
            primaryIsDark
        ...
        indicatorColor ??= (
            Equals(colorScheme.secondary, primaryColor) ? Colors.white : colorScheme.secondary
        );
        var theme = new ThemeData(
            ...
            appBarTheme: ((AppBarThemeData?)appBarTheme)! ?? new AppBarThemeData(),
    ...
    public ThemeData(
        DartMap<Type, Adaptation<object>> adaptationMap,
        bool applyElevationOverlayColor,
        NoDefaultCupertinoThemeData? cupertinoOverrideTheme,
        DartMap<object, ThemeExtension<object>> extensions,
        ...
        ButtonBarThemeData? buttonBarTheme = null,
        Color dialogBackgroundColor = default!,
    ...
    public virtual Adaptation<T>? getAdaptation<T>() =>
        ((Adaptation<T>?)(object?)adaptationMap.GetValueOrDefault(typeof(T)))!;

    internal static DartMap<Type, Adaptation<object>> _createAdaptationMap(
        IEnumerable<Adaptation<object>> adaptations
    )
    {
    ...
    public virtual Brightness brightness =>
        DartRuntimePrimitives.ConvertValue<Brightness>(colorScheme.brightness);

    public virtual T? extension<T>() => ((T?)(object?)extensions.GetValueOrDefault(typeof(T)))!;

    public virtual ButtonBarThemeData buttonBarTheme =>
        DartRuntimePrimitives.ConvertValue<ButtonBarThemeData>(_buttonBarTheme!);

    public virtual ThemeData copyWith(
        IEnumerable<Adaptation<object>>? adaptations = null,
        bool? applyElevationOverlayColor = null,
        NoDefaultCupertinoThemeData? cupertinoOverrideTheme = null,
        IEnumerable<ThemeExtension<object>>? extensions = null,
    ...
    )
    {
        ...
        return new ThemeData(
            adaptationMap: (adaptations is not null)
                ? _createAdaptationMap(adaptations.Cast<Adaptation<object>>())
                : adaptationMap,
            applyElevationOverlayColor: applyElevationOverlayColor
                ?? this.applyElevationOverlayColor,
            cupertinoOverrideTheme: cupertinoOverrideTheme ?? this.cupertinoOverrideTheme,
            extensions: (extensions is not null)
    ...
    public static ThemeData localize(ThemeData baseTheme, TextTheme localTextGeometry)
    {
        return _localizedThemeDataCache.putIfAbsent(
            new _IdentityThemeDataCacheKey__theme_data(baseTheme, localTextGeometry),
            () =>
            {
    ...
    {
        DartMap<object, ThemeExtension<object>> newExtensions = a.extensions.map(
            (id, extensionA) =>
            {
                ThemeExtension<object>? extensionB = b.extensions.GetValueOrDefault(id);
                return new MapEntry<object, ThemeExtension<object>>(
                    id,
        ...
        newExtensions.addEntries(
            b.extensions.entries.where((entry) => !a.extensions.ContainsKey(entry.key))
    ...
    internal static DartMap<object, ThemeExtension<object>> _themeExtensionIterableToMap(
        IEnumerable<ThemeExtension<object>> extensionsIterable
    )
    {
    ...
    internal virtual ThemeData _overrideWithSystemColors()
    {
        ...
        SystemColorPalette systemColors = Equals(brightness, Brightness.dark)
            ? SystemColor.dark
            : SystemColor.light;
        var theme = this;
        ...
        bool overrideButtons =
            (systemColors.buttonFace.value is not null)
            || (systemColors.buttonBorder.value is not null)
            || (systemColors.buttonText.value is not null);
        if (overrideButtons)
        {
            theme = theme.copyWith(
                elevatedButtonTheme: new ElevatedButtonThemeData(
                    style: ElevatedButton.styleFrom(
                        ...
                        side: (systemColors.buttonBorder.value is null)
                            ? null
                            : new BorderSide(color: systemColors.buttonBorder.value!)
                    )
                ),
                textButtonTheme: new TextButtonThemeData(
        ...
        bool overrideInputDecoration =
            (systemColors.field.value is not null) || (systemColors.fieldText.value is not null);
            ...
            theme = theme.copyWith(
                inputDecorationTheme: inputDecorationTheme.copyWith(
                    ...
                    labelStyle: inputDecorationTheme.labelStyle?.copyWith(
                        color: systemColors.fieldText.value
                    ) ?? new TextStyle(color: systemColors.fieldText.value),
    ...
    public static ThemeData lerp(ThemeData a, ThemeData b, double t)
    {
        ...
        return new ThemeData(
            ...
            carouselViewTheme: CarouselViewThemeData.lerp(
                a.carouselViewTheme,
                b.carouselViewTheme,
                t
            ),
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is ThemeData)
            && CollectionsLibrary.mapEquals(__other.adaptationMap, adaptationMap)
            && (__other.applyElevationOverlayColor == applyElevationOverlayColor)
            && Equals(__other.cupertinoOverrideTheme, cupertinoOverrideTheme)
            && CollectionsLibrary.mapEquals(__other.extensions, extensions)
            && Equals(__other.inputDecorationTheme, inputDecorationTheme)
            && Equals(__other.materialTapTargetSize, materialTapTargetSize)
            && Equals(__other.pageTransitionsTheme, pageTransitionsTheme)
            && Equals(__other.platform, platform)
            && Equals(__other.scrollbarTheme, scrollbarTheme)
            && Equals(__other.splashFactory, splashFactory)
            && Equals(__other.visualDensity, visualDensity)
            && Equals(__other.canvasColor, canvasColor)
            && Equals(__other.cardColor, cardColor)
            ...
            && Equals(__other.highlightColor, highlightColor)
            && Equals(__other.hintColor, hintColor)
            && Equals(__other.hoverColor, hoverColor)
            && Equals(__other.primaryColor, primaryColor)
            && Equals(__other.primaryColorDark, primaryColorDark)
            && Equals(__other.primaryColorLight, primaryColorLight)
            && Equals(__other.scaffoldBackgroundColor, scaffoldBackgroundColor)
            && Equals(__other.secondaryHeaderColor, secondaryHeaderColor)
            && Equals(__other.shadowColor, shadowColor)
            && Equals(__other.splashColor, splashColor)
            && Equals(__other.unselectedWidgetColor, unselectedWidgetColor)
            && Equals(__other.iconTheme, iconTheme)
            && Equals(__other.primaryIconTheme, primaryIconTheme)
            && Equals(__other.primaryTextTheme, primaryTextTheme)
            && Equals(__other.textTheme, textTheme)
            && Equals(__other.typography, typography)
            && Equals(__other.actionIconTheme, actionIconTheme)
            && Equals(__other.appBarTheme, appBarTheme)
            && Equals(__other.badgeTheme, badgeTheme)
            && Equals(__other.bannerTheme, bannerTheme)
            && Equals(__other.bottomAppBarTheme, bottomAppBarTheme)
            && Equals(__other.bottomNavigationBarTheme, bottomNavigationBarTheme)
            && Equals(__other.bottomSheetTheme, bottomSheetTheme)
            && Equals(__other.buttonTheme, buttonTheme)
            && Equals(__other.cardTheme, cardTheme)
            && Equals(__other.carouselViewTheme, carouselViewTheme)
            && Equals(__other.checkboxTheme, checkboxTheme)
            && Equals(__other.chipTheme, chipTheme)
            && Equals(__other.dataTableTheme, dataTableTheme)
            && Equals(__other.datePickerTheme, datePickerTheme)
            && Equals(__other.dialogTheme, dialogTheme)
            && Equals(__other.dividerTheme, dividerTheme)
            && Equals(__other.drawerTheme, drawerTheme)
            && Equals(__other.dropdownMenuTheme, dropdownMenuTheme)
            && Equals(__other.elevatedButtonTheme, elevatedButtonTheme)
            && Equals(__other.expansionTileTheme, expansionTileTheme)
            && Equals(__other.filledButtonTheme, filledButtonTheme)
            && Equals(__other.floatingActionButtonTheme, floatingActionButtonTheme)
            && Equals(__other.iconButtonTheme, iconButtonTheme)
            && Equals(__other.listTileTheme, listTileTheme)
            && Equals(__other.menuBarTheme, menuBarTheme)
            && Equals(__other.menuButtonTheme, menuButtonTheme)
            && Equals(__other.menuTheme, menuTheme)
            && Equals(__other.navigationBarTheme, navigationBarTheme)
            && Equals(__other.navigationDrawerTheme, navigationDrawerTheme)
            && Equals(__other.navigationRailTheme, navigationRailTheme)
            && Equals(__other.outlinedButtonTheme, outlinedButtonTheme)
            && Equals(__other.popupMenuTheme, popupMenuTheme)
            && Equals(__other.progressIndicatorTheme, progressIndicatorTheme)
            && Equals(__other.radioTheme, radioTheme)
            && Equals(__other.searchBarTheme, searchBarTheme)
            && Equals(__other.searchViewTheme, searchViewTheme)
            && Equals(__other.segmentedButtonTheme, segmentedButtonTheme)
            && Equals(__other.sliderTheme, sliderTheme)
            && Equals(__other.snackBarTheme, snackBarTheme)
            && Equals(__other.switchTheme, switchTheme)
            && Equals(__other.tabBarTheme, tabBarTheme)
            && Equals(__other.textButtonTheme, textButtonTheme)
            && Equals(__other.textSelectionTheme, textSelectionTheme)
            && Equals(__other.timePickerTheme, timePickerTheme)
            && Equals(__other.toggleButtonsTheme, toggleButtonsTheme)
            && Equals(__other.tooltipTheme, tooltipTheme)
            && Equals(__other.buttonBarTheme, buttonBarTheme)
            && Equals(__other.dialogBackgroundColor, dialogBackgroundColor)
    ...
    public override int GetHashCode()
    {
        var values = (
            (Func<List<object?>>)(
                () =>
                {
                    var __collection95592 = new List<object?>();
                    __collection95592.AddRange(adaptationMap.Keys);
                    __collection95592.AddRange(adaptationMap.Values);
                    __collection95592.Add(applyElevationOverlayColor);
                    __collection95592.Add(cupertinoOverrideTheme);
                    __collection95592.AddRange(extensions.Keys);
                    __collection95592.AddRange(extensions.Values);
                    __collection95592.Add(inputDecorationTheme);
                    __collection95592.Add(materialTapTargetSize);
                    __collection95592.Add(pageTransitionsTheme);
                    __collection95592.Add(platform);
                    __collection95592.Add(scrollbarTheme);
                    __collection95592.Add(splashFactory);
                    __collection95592.Add(visualDensity);
                    __collection95592.Add(canvasColor);
                    __collection95592.Add(cardColor);
                    __collection95592.Add(colorScheme);
                    __collection95592.Add(disabledColor);
                    __collection95592.Add(dividerColor);
                    __collection95592.Add(focusColor);
                    __collection95592.Add(highlightColor);
                    __collection95592.Add(hintColor);
                    __collection95592.Add(hoverColor);
                    __collection95592.Add(primaryColor);
                    __collection95592.Add(primaryColorDark);
                    __collection95592.Add(primaryColorLight);
                    __collection95592.Add(scaffoldBackgroundColor);
                    __collection95592.Add(secondaryHeaderColor);
                    __collection95592.Add(shadowColor);
                    __collection95592.Add(splashColor);
                    __collection95592.Add(unselectedWidgetColor);
                    __collection95592.Add(iconTheme);
                    __collection95592.Add(primaryIconTheme);
                    __collection95592.Add(primaryTextTheme);
                    __collection95592.Add(textTheme);
                    __collection95592.Add(typography);
                    __collection95592.Add(actionIconTheme);
                    __collection95592.Add(appBarTheme);
                    __collection95592.Add(badgeTheme);
                    __collection95592.Add(bannerTheme);
                    __collection95592.Add(bottomAppBarTheme);
                    __collection95592.Add(bottomNavigationBarTheme);
                    __collection95592.Add(bottomSheetTheme);
                    __collection95592.Add(buttonTheme);
                    __collection95592.Add(cardTheme);
                    __collection95592.Add(carouselViewTheme);
                    __collection95592.Add(checkboxTheme);
                    __collection95592.Add(chipTheme);
                    __collection95592.Add(dataTableTheme);
                    __collection95592.Add(datePickerTheme);
                    __collection95592.Add(dialogTheme);
                    __collection95592.Add(dividerTheme);
                    __collection95592.Add(drawerTheme);
                    __collection95592.Add(dropdownMenuTheme);
                    __collection95592.Add(elevatedButtonTheme);
                    __collection95592.Add(expansionTileTheme);
                    __collection95592.Add(filledButtonTheme);
                    __collection95592.Add(floatingActionButtonTheme);
                    __collection95592.Add(iconButtonTheme);
                    __collection95592.Add(listTileTheme);
                    __collection95592.Add(menuBarTheme);
                    __collection95592.Add(menuButtonTheme);
                    __collection95592.Add(menuTheme);
                    __collection95592.Add(navigationBarTheme);
                    __collection95592.Add(navigationDrawerTheme);
                    __collection95592.Add(navigationRailTheme);
                    __collection95592.Add(outlinedButtonTheme);
                    __collection95592.Add(popupMenuTheme);
                    __collection95592.Add(progressIndicatorTheme);
                    __collection95592.Add(radioTheme);
                    __collection95592.Add(searchBarTheme);
                    __collection95592.Add(searchViewTheme);
                    __collection95592.Add(segmentedButtonTheme);
                    __collection95592.Add(sliderTheme);
                    __collection95592.Add(snackBarTheme);
                    __collection95592.Add(switchTheme);
                    __collection95592.Add(tabBarTheme);
                    __collection95592.Add(textButtonTheme);
                    __collection95592.Add(textSelectionTheme);
                    __collection95592.Add(timePickerTheme);
                    __collection95592.Add(toggleButtonsTheme);
                    __collection95592.Add(tooltipTheme);
                    __collection95592.Add(buttonBarTheme);
                    __collection95592.Add(dialogBackgroundColor);
                    __collection95592.Add(indicatorColor);
                    return __collection95592;
                }
            )
        )();
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new IterableProperty<Adaptation<object>>(
                "adaptations",
                adaptationMap.Values.Cast<Adaptation<object>>(),
        ...
        properties.add(
            new DiagnosticsProperty<NoDefaultCupertinoThemeData>(
        ...
        properties.add(
            new IterableProperty<ThemeExtension<object>>(
                "extensions",
                extensions.Values.Cast<ThemeExtension<object>>(),
        ...
        properties.add(
            new DiagnosticsProperty<PageTransitionsTheme>(
        ...
        properties.add(
            new EnumProperty<TargetPlatform>(
                "platform",
                platform,
                defaultValue: PlatformLibrary.defaultTargetPlatform,
                level: DiagnosticLevel.debug
            )
        );
        properties.add(
            new DiagnosticsProperty<ScrollbarThemeData>(
                "scrollbarTheme",
                scrollbarTheme,
        ...
        properties.add(
            new DiagnosticsProperty<InteractiveInkFeatureFactory>(
                "splashFactory",
                splashFactory,
        ...
        properties.add(
            new DiagnosticsProperty<TextTheme>("textTheme", textTheme, level: DiagnosticLevel.debug)
        );
        properties.add(
            new DiagnosticsProperty<Typography>(
                "typography",
                typography,
        ...
        properties.add(
            new DiagnosticsProperty<ActionIconThemeData>(
                "actionIconTheme",
                actionIconTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<AppBarThemeData>(
                "appBarTheme",
                appBarTheme,
        ...
        properties.add(
            new DiagnosticsProperty<BadgeThemeData>(
                "badgeTheme",
                badgeTheme,
        ...
        properties.add(
            new DiagnosticsProperty<MaterialBannerThemeData>(
                "bannerTheme",
                bannerTheme,
        ...
        properties.add(
            new DiagnosticsProperty<BottomAppBarThemeData>(
                "bottomAppBarTheme",
                bottomAppBarTheme,
        ...
        properties.add(
            new DiagnosticsProperty<BottomNavigationBarThemeData>(
        ...
        properties.add(
            new DiagnosticsProperty<BottomSheetThemeData>(
                "bottomSheetTheme",
                bottomSheetTheme,
        ...
        properties.add(
            new DiagnosticsProperty<ButtonThemeData>(
                "buttonTheme",
                buttonTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<CardThemeData>(
                "cardTheme",
                cardTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<CarouselViewThemeData>(
                "carouselViewTheme",
                carouselViewTheme,
        ...
        properties.add(
            new DiagnosticsProperty<CheckboxThemeData>(
                "checkboxTheme",
                checkboxTheme,
        ...
        properties.add(
            new DiagnosticsProperty<ChipThemeData>(
                "chipTheme",
                chipTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<DataTableThemeData>(
                "dataTableTheme",
                dataTableTheme,
        ...
        properties.add(
            new DiagnosticsProperty<DatePickerThemeData>(
                "datePickerTheme",
                datePickerTheme,
        ...
        properties.add(
            new DiagnosticsProperty<DialogThemeData>(
                "dialogTheme",
                dialogTheme,
        ...
        properties.add(
            new DiagnosticsProperty<DividerThemeData>(
                "dividerTheme",
                dividerTheme,
        ...
        properties.add(
            new DiagnosticsProperty<DrawerThemeData>(
                "drawerTheme",
                drawerTheme,
        ...
        properties.add(
            new DiagnosticsProperty<DropdownMenuThemeData>(
                "dropdownMenuTheme",
                dropdownMenuTheme,
        ...
        properties.add(
            new DiagnosticsProperty<ElevatedButtonThemeData>(
                "elevatedButtonTheme",
                elevatedButtonTheme,
        ...
        properties.add(
            new DiagnosticsProperty<ExpansionTileThemeData>(
                "expansionTileTheme",
                expansionTileTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<FilledButtonThemeData>(
                "filledButtonTheme",
                filledButtonTheme,
        ...
        properties.add(
            new DiagnosticsProperty<FloatingActionButtonThemeData>(
        ...
        properties.add(
            new DiagnosticsProperty<IconButtonThemeData>(
                "iconButtonTheme",
                iconButtonTheme,
        ...
        properties.add(
            new DiagnosticsProperty<ListTileThemeData>(
                "listTileTheme",
                listTileTheme,
        ...
        properties.add(
            new DiagnosticsProperty<MenuBarThemeData>(
                "menuBarTheme",
                menuBarTheme,
        ...
        properties.add(
            new DiagnosticsProperty<MenuButtonThemeData>(
                "menuButtonTheme",
                menuButtonTheme,
        ...
        properties.add(
            new DiagnosticsProperty<MenuThemeData>(
                "menuTheme",
                menuTheme,
        ...
        properties.add(
            new DiagnosticsProperty<NavigationBarThemeData>(
                "navigationBarTheme",
                navigationBarTheme,
        ...
        properties.add(
            new DiagnosticsProperty<NavigationDrawerThemeData>(
        ...
        properties.add(
            new DiagnosticsProperty<NavigationRailThemeData>(
                "navigationRailTheme",
                navigationRailTheme,
        ...
        properties.add(
            new DiagnosticsProperty<OutlinedButtonThemeData>(
                "outlinedButtonTheme",
                outlinedButtonTheme,
        ...
        properties.add(
            new DiagnosticsProperty<PopupMenuThemeData>(
                "popupMenuTheme",
                popupMenuTheme,
        ...
        properties.add(
            new DiagnosticsProperty<ProgressIndicatorThemeData>(
        ...
        properties.add(
            new DiagnosticsProperty<RadioThemeData>(
                "radioTheme",
                radioTheme,
        ...
        properties.add(
            new DiagnosticsProperty<SearchBarThemeData>(
                "searchBarTheme",
                searchBarTheme,
        ...
        properties.add(
            new DiagnosticsProperty<SearchViewThemeData>(
                "searchViewTheme",
                searchViewTheme,
        ...
        properties.add(
            new DiagnosticsProperty<SegmentedButtonThemeData>(
        ...
        properties.add(
            new DiagnosticsProperty<SliderThemeData>(
                "sliderTheme",
                sliderTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<SnackBarThemeData>(
                "snackBarTheme",
                snackBarTheme,
        ...
        properties.add(
            new DiagnosticsProperty<SwitchThemeData>(
                "switchTheme",
                switchTheme,
        ...
        properties.add(
            new DiagnosticsProperty<TabBarThemeData>(
                "tabBarTheme",
                tabBarTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<TextButtonThemeData>(
                "textButtonTheme",
                textButtonTheme,
        ...
        properties.add(
            new DiagnosticsProperty<TextSelectionThemeData>(
                "textSelectionTheme",
                textSelectionTheme,
        ...
        properties.add(
            new DiagnosticsProperty<TimePickerThemeData>(
                "timePickerTheme",
                timePickerTheme,
        ...
        properties.add(
            new DiagnosticsProperty<ToggleButtonsThemeData>(
                "toggleButtonsTheme",
                toggleButtonsTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<TooltipThemeData>(
                "tooltipTheme",
                tooltipTheme,
                level: DiagnosticLevel.debug
            )
        ...
        properties.add(
            new DiagnosticsProperty<ButtonBarThemeData>(
                "buttonBarTheme",
                buttonBarTheme,
...
public class MaterialBasedCupertinoThemeData : CupertinoThemeData
{
    ...
    internal virtual NoDefaultCupertinoThemeData _cupertinoOverrideTheme { get; private set; } =
        default!;
    ...
    public override Brightness? brightness =>
...
public class CupertinoBasedMaterialThemeData
{
    ...
    {
        materialTheme = ThemeData.Create(
            colorScheme: ColorScheme.CreateFromSeed(
...
internal class _IdentityThemeDataCacheKey__theme_data
{
    ...
    internal _IdentityThemeDataCacheKey__theme_data(
        ThemeData baseTheme,
    ...
    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(
            Dart_coreLibrary.identityHashCode(baseTheme)
                ^ Dart_coreLibrary.identityHashCode(localTextGeometry)
        );
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is _IdentityThemeDataCacheKey__theme_data)
            && DartRuntimePrimitives.Identical(__other.baseTheme, baseTheme)
            && DartRuntimePrimitives.Identical(__other.localTextGeometry, localTextGeometry);
    }
}

internal class _FifoCache__theme_data<K, V>
    where K : notnull
{
...
public class VisualDensity : Diagnosticable
{
    ...
    public static VisualDensity adaptivePlatformDensity =>
        defaultDensityForPlatform(PlatformLibrary.defaultTargetPlatform);

    public static VisualDensity defaultDensityForPlatform(TargetPlatform platform)
    {
        return platform switch
        {
            TargetPlatform.android or TargetPlatform.iOS => standard,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is VisualDensity)
            && (__other.horizontal == horizontal)
            && (__other.vertical == vertical);
    }

    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(
            FoundationRuntimePorts.ObjectHash(horizontal, vertical)
        );
...
{
    internal static ColorScheme _colorSchemeLightM3 = new ColorScheme(
        brightness: Brightness.light,
        primary: new Color(4284960932L),
        onPrimary: new Color(4294967295L),
        primaryContainer: new Color(4293582335L),
        onPrimaryContainer: new Color(4283381643L),
        primaryFixed: new Color(4293582335L),
        primaryFixedDim: new Color(4291869951L),
        onPrimaryFixed: new Color(4280352861L),
        onPrimaryFixedVariant: new Color(4283381643L),
        secondary: new Color(4284636017L),
        onSecondary: new Color(4294967295L),
        secondaryContainer: new Color(4293451512L),
        onSecondaryContainer: new Color(4283057240L),
        secondaryFixed: new Color(4293451512L),
        secondaryFixedDim: new Color(4291609308L),
        onSecondaryFixed: new Color(4280097067L),
        onSecondaryFixedVariant: new Color(4283057240L),
        tertiary: new Color(4286403168L),
        onTertiary: new Color(4294967295L),
        tertiaryContainer: new Color(4294957284L),
        onTertiaryContainer: new Color(4284693320L),
        tertiaryFixed: new Color(4294957284L),
        tertiaryFixedDim: new Color(4293900488L),
        onTertiaryFixed: new Color(4281405725L),
        onTertiaryFixedVariant: new Color(4284693320L),
        error: new Color(4289930782L),
        onError: new Color(4294967295L),
        errorContainer: new Color(4294565596L),
        onErrorContainer: new Color(4287372568L),
        background: new Color(4294899711L),
        onBackground: new Color(4280097568L),
        surface: new Color(4294899711L),
        surfaceBright: new Color(4294899711L),
        surfaceContainerLowest: new Color(4294967295L),
        surfaceContainerLow: new Color(4294439674L),
        surfaceContainer: new Color(4294176247L),
        surfaceContainerHigh: new Color(4293715696L),
        surfaceContainerHighest: new Color(4293320937L),
        surfaceDim: new Color(4292794593L),
        onSurface: new Color(4280097568L),
        surfaceVariant: new Color(4293386476L),
        onSurfaceVariant: new Color(4282991951L),
        outline: new Color(4286149758L),
        outlineVariant: new Color(4291478736L),
        shadow: new Color(4278190080L),
        scrim: new Color(4278190080L),
        inverseSurface: new Color(4281478965L),
        onInverseSurface: new Color(4294307831L),
        inversePrimary: new Color(4291869951L),
        surfaceTint: new Color(4284960932L)
    );
}

public static partial class Theme_dataLibrary
{
    internal static ColorScheme _colorSchemeDarkM3 = new ColorScheme(
        brightness: Brightness.dark,
        primary: new Color(4291869951L),
        onPrimary: new Color(4281867890L),
        primaryContainer: new Color(4283381643L),
        onPrimaryContainer: new Color(4293582335L),
        primaryFixed: new Color(4293582335L),
        primaryFixedDim: new Color(4291869951L),
        onPrimaryFixed: new Color(4280352861L),
        onPrimaryFixedVariant: new Color(4283381643L),
        secondary: new Color(4291609308L),
        onSecondary: new Color(4281544001L),
        secondaryContainer: new Color(4283057240L),
        onSecondaryContainer: new Color(4293451512L),
        secondaryFixed: new Color(4293451512L),
        secondaryFixedDim: new Color(4291609308L),
        onSecondaryFixed: new Color(4280097067L),
        onSecondaryFixedVariant: new Color(4283057240L),
        tertiary: new Color(4293900488L),
        onTertiary: new Color(4282983730L),
        tertiaryContainer: new Color(4284693320L),
        onTertiaryContainer: new Color(4294957284L),
        tertiaryFixed: new Color(4294957284L),
        tertiaryFixedDim: new Color(4293900488L),
        onTertiaryFixed: new Color(4281405725L),
        onTertiaryFixedVariant: new Color(4284693320L),
        error: new Color(4294097077L),
        onError: new Color(4284486672L),
        errorContainer: new Color(4287372568L),
        onErrorContainer: new Color(4294565596L),
        background: new Color(4279505432L),
        onBackground: new Color(4293320937L),
        surface: new Color(4279505432L),
        surfaceBright: new Color(4282071102L),
        surfaceContainerLowest: new Color(4279176467L),
        surfaceContainerLow: new Color(4280097568L),
        surfaceContainer: new Color(4280360742L),
        surfaceContainerHigh: new Color(4281018672L),
        surfaceContainerHighest: new Color(4281742395L),
        surfaceDim: new Color(4279505432L),
        onSurface: new Color(4293320937L),
        surfaceVariant: new Color(4282991951L),
        onSurfaceVariant: new Color(4291478736L),
        outline: new Color(4287860633L),
        outlineVariant: new Color(4282991951L),
        shadow: new Color(4278190080L),
        scrim: new Color(4278190080L),
        inverseSurface: new Color(4293320937L),
        onInverseSurface: new Color(4281478965L),
        inversePrimary: new Color(4284960932L),
        surfaceTint: new Color(4291869951L)
    );
}
