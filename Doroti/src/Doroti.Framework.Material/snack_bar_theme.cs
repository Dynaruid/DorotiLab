...
public class SnackBarThemeData : Diagnosticable
{
    ...
    )
    {
        ...
        System.Diagnostics.Debug.Assert(
            (width is null) || DartRuntimePrimitives.Identical(behavior, SnackBarBehavior.floating)
        );
        System.Diagnostics.Debug.Assert(
        ...
        System.Diagnostics.Debug.Assert(
            (actionBackgroundColor is not WidgetStateColor)
                || (disabledActionBackgroundColor is null)
        );
    }

    public virtual SnackBarThemeData copyWith(
        Color? backgroundColor = null,
        Color? actionTextColor = null,
        Color? disabledActionTextColor = null,
        TextStyle? contentTextStyle = null,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is SnackBarThemeData)
            && Equals(__other.backgroundColor, backgroundColor)
            && Equals(__other.actionTextColor, actionTextColor)
            && Equals(__other.disabledActionTextColor, disabledActionTextColor)
            && Equals(__other.contentTextStyle, contentTextStyle)
            && (__other.elevation == elevation)
            && Equals(__other.shape, shape)
            && Equals(__other.behavior, behavior)
            && (__other.width == width)
            && Equals(__other.insetPadding, insetPadding)
            && (__other.showCloseIcon == showCloseIcon)
            && Equals(__other.closeIconColor, closeIconColor)
            && (__other.actionOverflowThreshold == actionOverflowThreshold)
            && Equals(__other.actionBackgroundColor, actionBackgroundColor)
            && Equals(__other.disabledActionBackgroundColor, disabledActionBackgroundColor)
            && Equals(__other.dismissDirection, dismissDirection);
    }
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DiagnosticsProperty<SnackBarBehavior>("behavior", behavior, defaultValue: null)
        );
        ...
        properties.add(
            new DiagnosticsProperty<bool>("showCloseIcon", showCloseIcon, defaultValue: null)
        );
        ...
        properties.add(
            new ColorProperty("actionBackgroundColor", actionBackgroundColor, defaultValue: null)
        );
        properties.add(
            new ColorProperty(
                "disabledActionBackgroundColor",
        ...
        properties.add(
            new DiagnosticsProperty<DismissDirection>(
                "dismissDirection",
                dismissDirection,
                defaultValue: null
            )
...
public class SnackBarTheme : InheritedTheme
{
    ...
    public SnackBarTheme(
        Key? key = null,
        SnackBarThemeData data = default!,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((SnackBarTheme)oldWidget).data));
}
