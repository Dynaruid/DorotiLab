        ...
        TappableChipAttributes
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        ChipThemeData? defaults = (ChipThemeData?)
            new _InputChipDefaultsM3__input_chip(context, isEnabled, selected);
        ...
        return new RawChip(
            ...
            isEnabled: isEnabled
                && ((onSelected is not null) || (onDeleted is not null) || (onPressed is not null)),
...
internal class _InputChipDefaultsM3__input_chip : ChipThemeData
{
    ...
    internal _InputChipDefaultsM3__input_chip(BuildContext context, bool isEnabled, bool isSelected)
        : base(
            elevation: 0.0,
    ...
    public override Color? checkmarkColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            isEnabled
                ? (isSelected ? _colors.primary : _colors.onSurfaceVariant)
                : _colors.onSurface
        );
