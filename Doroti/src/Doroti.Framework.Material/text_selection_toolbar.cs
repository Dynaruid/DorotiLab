...
public class TextSelectionToolbar : StatelessWidget
{
    ...
    public virtual Func<BuildContext, Widget, Widget> toolbarBuilder { get; private set; } =
        default!;
    ...
    public TextSelectionToolbar(
        ...
        Func<BuildContext, Widget, Widget> toolbarBuilder = default!,
        List<Widget> children = default!
    )
        : base(key: key)
    {
        Func<BuildContext, Widget, Widget> __toolbarBuilder =
    ...
    {
        Offset anchorAbovePadded =
            anchorAbove - new Offset(0.0, Text_selectionLibrary._kToolbarContentDistance);
        ...
        double availableHeight =
            anchorAbovePadded.dy - Text_selectionLibrary._kToolbarContentDistance - paddingAbove;
        ...
        return new Padding(
            padding: new EdgeInsets(screenPadding, paddingAbove, screenPadding, screenPadding),
            child: new CustomSingleChildLayout(
                @delegate: new TextSelectionToolbarLayoutDelegate(
                    ...
                    fitsAbove: fitsAboveLocal
                ),
                child: new _TextSelectionToolbarOverflowable__text_selection_toolbar(
                    isAbove: fitsAboveLocal,
...
public class _TextSelectionToolbarOverflowable__text_selection_toolbar : StatefulWidget
{
    ...
    internal _TextSelectionToolbarOverflowable__text_selection_toolbar(
        bool isAbove,
        Func<BuildContext, Widget, Widget> toolbarBuilder,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _TextSelectionToolbarOverflowableState__text_selection_toolbar()
        );
}

public class _TextSelectionToolbarOverflowableState__text_selection_toolbar
    : State<_TextSelectionToolbarOverflowable__text_selection_toolbar>,
        TickerProviderStateMixin<_TextSelectionToolbarOverflowable__text_selection_toolbar>
{
    ...
    public override void didUpdateWidget(
        _TextSelectionToolbarOverflowable__text_selection_toolbar oldWidget
    )
    {
        ...
        return new _TextSelectionToolbarTrailingEdgeAlign__text_selection_toolbar(
            ...
            child: new AnimatedSize(
                ...
                child: widget.toolbarBuilder(
                    context,
                    new _TextSelectionToolbarItemsLayout__text_selection_toolbar(
                        ...
                        children: (
                            (Func<List<Widget>>)(
                                () =>
                                {
                                    var __collection7958 = new List<Widget>();
                                    __collection7958.Add(
                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                            new _TextSelectionToolbarOverflowButton__text_selection_toolbar(
                                                key: _overflowOpen
                                                    ? StandardComponentTypeMembers.key(
                                    ...
                                    __collection7958.AddRange(widget.children);
                                    return __collection7958;
                                }
                            )
                        )()
                    )
...
internal class _TextSelectionToolbarTrailingEdgeAlign__text_selection_toolbar
    : SingleChildRenderObjectWidget
{
    public virtual bool overflowOpen { get; private set; } = default!;
    public virtual TextDirection textDirection { get; private set; } = default!;

    internal _TextSelectionToolbarTrailingEdgeAlign__text_selection_toolbar(
        Key? key = null,
        Widget child = default!,
        bool overflowOpen = default!,
    ...
    {
        return new _TextSelectionToolbarTrailingEdgeAlignRenderBox__text_selection_toolbar(
    ...
    {
        var __renderObject =
            (_TextSelectionToolbarTrailingEdgeAlignRenderBox__text_selection_toolbar)renderObject;
        DartRuntimePrimitives.Ignore(
            (
                (Func<_TextSelectionToolbarTrailingEdgeAlignRenderBox__text_selection_toolbar>)(
                    () =>
                    {
...
public class _TextSelectionToolbarTrailingEdgeAlignRenderBox__text_selection_toolbar
    : RenderProxyBox
{
    ...
    internal _TextSelectionToolbarTrailingEdgeAlignRenderBox__text_selection_toolbar(
        bool overflowOpen,
        TextDirection textDirection
    )
    {
    ...
    public override void performLayout()
    {
        ...
        childParentData.offset = new Offset(
            Equals(textDirection, TextDirection.rtl) ? 0.0 : (size.width - child!.size.width),
            0.0
        );
    }
...
internal class _TextSelectionToolbarItemsLayout__text_selection_toolbar
    : MultiChildRenderObjectWidget
{
    ...
    internal _TextSelectionToolbarItemsLayout__text_selection_toolbar(
        bool isAbove,
        bool overflowOpen,
        TextDirection textDirection,
        List<Widget> children
    ...
    public override RenderObject createRenderObject(BuildContext context)
    {
        return new _RenderTextSelectionToolbarItemsLayout__text_selection_toolbar(
            isAbove: isAbove,
            overflowOpen: overflowOpen,
            textDirection: textDirection
        );
    ...
    {
        var __renderObject =
            (_RenderTextSelectionToolbarItemsLayout__text_selection_toolbar)renderObject;
        DartRuntimePrimitives.Ignore(
            (
                (Func<_RenderTextSelectionToolbarItemsLayout__text_selection_toolbar>)(
                    () =>
                    {
                        var __cascade = __renderObject;
    ...
    public override _TextSelectionToolbarItemsLayoutElement__text_selection_toolbar createElement() =>
        new _TextSelectionToolbarItemsLayoutElement__text_selection_toolbar(this);
}

public class _TextSelectionToolbarItemsLayoutElement__text_selection_toolbar
    : MultiChildRenderObjectElement
{
    internal _TextSelectionToolbarItemsLayoutElement__text_selection_toolbar(
        ...
        ContainerRenderObjectMixin<RenderBox, ToolbarItemsParentData>
{
    ...
    internal _RenderTextSelectionToolbarItemsLayout__text_selection_toolbar(
        bool isAbove,
        bool overflowOpen,
        TextDirection textDirection
    )
    ...
    internal virtual void _layoutChildren()
    {
        BoxConstraints sizedConstraints = _overflowOpen
            ? constraints
            : BoxConstraints.CreateLoose(
                new Size(constraints.maxWidth, Text_selection_toolbarLibrary._kToolbarHeight)
            );
        var i = -1L;
        var widthLocal = 0.0;
        visitChildren(
        ...
        if (
            ...
            && (_lastIndexThatFits == (childCount - 2L))
            && ((widthLocal - navButton.size.width) <= sizedConstraints.maxWidth)
        )
        {
            _lastIndexThatFits = -1L;
        }
    ...
    internal virtual void _resizeChildrenWhenOverflow()
    {
        ...
        visitChildren(
            (renderObjectChild) =>
            {
                ...
                child.layout(
                    BoxConstraints.CreateTightFor(width: size.width),
                    parentUsesSize: true
                );
            }
        );
...
internal class _TextSelectionToolbarContainer__text_selection_toolbar : StatelessWidget
{
    ...
    {
        bool isDefaultSurface = colorScheme.brightness switch
        {
            Brightness.light => DartRuntimePrimitives.Identical(
                ThemeData.Create().colorScheme.surface,
                colorScheme.surface
            ),
    ...
    public override Widget build(BuildContext context)
    {
        ...
        return new Material(
            borderRadius: BorderRadius.CreateAll(
                Radius.circular(Text_selection_toolbarLibrary._kToolbarHeight / 2L)
            ),
...
internal class _TextSelectionToolbarOverflowButton__text_selection_toolbar : StatelessWidget
{
    ...
    internal _TextSelectionToolbarOverflowButton__text_selection_toolbar(
        Key? key = null,
        Icon icon = default!,
