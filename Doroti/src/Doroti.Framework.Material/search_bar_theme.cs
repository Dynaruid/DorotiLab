...
public class SearchBarThemeData : Diagnosticable
{
    ...
    public virtual SearchBarThemeData copyWith(
        WidgetStateProperty<double?>? elevation = null,
        WidgetStateProperty<Color?>? backgroundColor = null,
        WidgetStateProperty<Color?>? shadowColor = null,
        WidgetStateProperty<Color?>? surfaceTintColor = null,
    ...
    public static SearchBarThemeData? lerp(SearchBarThemeData? a, SearchBarThemeData? b, double t)
    {
        ...
        return new SearchBarThemeData(
            ...
            hintStyle: WidgetStateProperty.lerp(a?.hintStyle, b?.hintStyle, t, TextStyle.lerp),
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new DiagnosticsProperty<TextCapitalization>(
                "textCapitalization",
                textCapitalization,
                defaultValue: null
            )
...
public class SearchBarTheme : InheritedWidget
{
    ...
    public SearchBarTheme(
        Key? key = null,
        SearchBarThemeData data = default!,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((SearchBarTheme)oldWidget).data));
}
