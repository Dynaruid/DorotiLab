...
public class ScrollbarThemeData : Diagnosticable
{
    ...
    public virtual ScrollbarThemeData copyWith(
        WidgetStateProperty<bool?>? thumbVisibility = null,
        WidgetStateProperty<double?>? thickness = null,
        WidgetStateProperty<bool?>? trackVisibility = null,
        bool? interactive = null,
    ...
    public static ScrollbarThemeData lerp(ScrollbarThemeData? a, ScrollbarThemeData? b, double t)
    {
        ...
        return new ScrollbarThemeData(
            thumbVisibility: WidgetStateProperty.lerp(
                a?.thumbVisibility,
                b?.thumbVisibility,
                t,
                Scrollbar_themeLibrary._lerpBool
            ),
            thickness: WidgetStateProperty.lerp(
                a?.thickness,
                b?.thickness,
                t,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is ScrollbarThemeData)
            && Equals(__other.thumbVisibility, thumbVisibility)
            && Equals(__other.thickness, thickness)
            && Equals(__other.trackVisibility, trackVisibility)
            && (__other.interactive == interactive)
            && Equals(__other.radius, radius)
            && Equals(__other.thumbColor, thumbColor)
            && Equals(__other.trackColor, trackColor)
            && Equals(__other.trackBorderColor, trackBorderColor)
            && (__other.crossAxisMargin == crossAxisMargin)
            && (__other.mainAxisMargin == mainAxisMargin)
            && (__other.minThumbLength == minThumbLength);
    }

    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        properties.add(
            new DiagnosticsProperty<WidgetStateProperty<bool?>>(
                "thumbVisibility",
                thumbVisibility,
                defaultValue: null
            )
        ...
        properties.add(
            new DiagnosticsProperty<bool>("interactive", interactive, defaultValue: null)
        );
        ...
        properties.add(
            new DiagnosticsProperty<double>("crossAxisMargin", crossAxisMargin, defaultValue: null)
        );
        properties.add(
            new DiagnosticsProperty<double>("mainAxisMargin", mainAxisMargin, defaultValue: null)
        );
        properties.add(
            new DiagnosticsProperty<double>("minThumbLength", minThumbLength, defaultValue: null)
        );
    }
...
public class ScrollbarTheme : InheritedTheme
{
    ...
    public ScrollbarTheme(
        Key? key = null,
        ScrollbarThemeData data = default!,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((ScrollbarTheme)oldWidget).data));
}
