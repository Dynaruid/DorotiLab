...
public class ScrollbarThemeData : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    public static ScrollbarThemeData lerp(ScrollbarThemeData? a, ScrollbarThemeData? b, double t)
    {
        ...
        return new ScrollbarThemeData(thumbVisibility: WidgetStateProperty.lerp<bool?>(a?.thumbVisibility, b?.thumbVisibility, t, Scrollbar_themeLibrary._lerpBool), thickness: WidgetStateProperty.lerp<double?>(a?.thickness, b?.thickness, t, Dart_uiLibrary.lerpDouble), trackVisibility: WidgetStateProperty.lerp<bool?>(a?.trackVisibility, b?.trackVisibility, t, Scrollbar_themeLibrary._lerpBool), interactive: Scrollbar_themeLibrary._lerpBool(a?.interactive, b?.interactive, t), radius: Dart_uiLibrary.Radius.lerp(a?.radius, b?.radius, t), thumbColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.thumbColor, b?.thumbColor, t, Color.lerp), trackColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.trackColor, b?.trackColor, t, Color.lerp), trackBorderColor: WidgetStateProperty.lerp<global::Doroti.Ui.Color?>(a?.trackBorderColor, b?.trackBorderColor, t, Color.lerp), crossAxisMargin: Dart_uiLibrary.lerpDouble(a?.crossAxisMargin, b?.crossAxisMargin, t), mainAxisMargin: Dart_uiLibrary.lerpDouble(a?.mainAxisMargin, b?.mainAxisMargin, t), minThumbLength: Dart_uiLibrary.lerpDouble(a?.minThumbLength, b?.minThumbLength, t));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    {
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<bool?>>("thumbVisibility", thumbVisibility, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<double?>>("thickness", thickness, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<bool?>>("trackVisibility", trackVisibility, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<bool>("interactive", interactive, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Ui.Radius>("radius", radius, defaultValue: null));
        ...
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Color?>>("trackBorderColor", trackBorderColor, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<double>("crossAxisMargin", crossAxisMargin, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<double>("mainAxisMargin", mainAxisMargin, defaultValue: null));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<double>("minThumbLength", minThumbLength, defaultValue: null));
    }
...
public class ScrollbarTheme : global::Doroti.Framework.Widgets.InheritedTheme
{
    ...
    public override bool updateShouldNotify(global::Doroti.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((ScrollbarTheme)oldWidget).data));
}
