...
internal class _NavigationRailState__navigation_rail : global::Doroti.Framework.Widgets.State<NavigationRail>, global::Doroti.Framework.Widgets.TickerProviderStateMixin<NavigationRail>
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Painting.TextStyle unselectedLabelTextStyle__18048 = ((((NavigationRail)this.widget).unselectedLabelTextStyle ?? navigationRailTheme__17223.unselectedLabelTextStyle) ?? defaults__17312.unselectedLabelTextStyle!);
        global::Doroti.Framework.Painting.TextStyle selectedLabelTextStyle__18238 = ((((NavigationRail)this.widget).selectedLabelTextStyle ?? navigationRailTheme__17223.selectedLabelTextStyle) ?? defaults__17312.selectedLabelTextStyle!);
        global::Doroti.Framework.Widgets.IconThemeData unselectedIconTheme__18424 = ((((NavigationRail)this.widget).unselectedIconTheme ?? navigationRailTheme__17223.unselectedIconTheme) ?? defaults__17312.unselectedIconTheme!);
        global::Doroti.Framework.Widgets.IconThemeData selectedIconTheme__18598 = ((((NavigationRail)this.widget).selectedIconTheme ?? navigationRailTheme__17223.selectedIconTheme) ?? defaults__17312.selectedIconTheme!);
        ...
        global::Doroti.Framework.Painting.ShapeBorder? indicatorShape__19273 = ((((NavigationRail)this.widget).indicatorShape ?? navigationRailTheme__17223.indicatorShape) ?? defaults__17312.indicatorShape);
        global::Doroti.Framework.Widgets.IconThemeData effectiveUnselectedIconTheme__19618 = (Theme.of(context).useMaterial3 ? unselectedIconTheme__18424 : unselectedIconTheme__18424.copyWith(opacity: (((global::Doroti.Framework.Widgets.IconThemeData)unselectedIconTheme__18424).opacity ?? defaults__17312.unselectedIconTheme!.opacity)));
        var isRTLDirection__19865 = (object.Equals(Directionality.of(context), TextDirection.rtl));
        global::Doroti.Framework.Widgets.Widget mainGroup__19943 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Column(mainAxisSize: ((((NavigationRail)this.widget).mainAxisAlignment is not null) ? global::Doroti.Framework.Rendering.MainAxisSize.max : global::Doroti.Framework.Rendering.MainAxisSize.min), mainAxisAlignment: (((NavigationRail)this.widget).mainAxisAlignment ?? global::Doroti.Framework.Rendering.MainAxisAlignment.start), children: ((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection20149 = new List<global::Doroti.Framework.Widgets.Widget>(); if ((!((NavigationRail)this.widget).leadingAtTop && (((NavigationRail)this.widget).leading is not null))) { __collection20149.AddRange(new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(((NavigationRail)this.widget).leading!), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(Navigation_railLibrary._verticalSpacer) }); } for (long i__20314 = 0L; (i__20314 < checked((long)(((NavigationRail)this.widget).destinations.Count))); i__20314 += 1L) { __collection20149.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new _RailDestination__navigation_rail(minWidth: minWidth__17791, minExtendedWidth: minExtendedWidth__17890, extendedTransitionAnimation: this._extendedAnimation, selected: (((NavigationRail)this.widget).selectedIndex == i__20314), icon: ((((NavigationRail)this.widget).selectedIndex == i__20314) ? ((NavigationRail)this.widget).destinations[(int)(i__20314)].selectedIcon : ((NavigationRail)this.widget).destinations[(int)(i__20314)].icon), label: ((NavigationRail)this.widget).destinations[(int)(i__20314)].label, destinationAnimation: this._destinationAnimations[(int)(i__20314)], labelType: labelType__18905, iconTheme: ((((NavigationRail)this.widget).selectedIndex == i__20314) ? selectedIconTheme__18598 : effectiveUnselectedIconTheme__19618), labelTextStyle: ((((NavigationRail)this.widget).selectedIndex == i__20314) ? selectedLabelTextStyle__18238 : unselectedLabelTextStyle__18048), padding: ((NavigationRail)this.widget).destinations[(int)(i__20314)].padding, useIndicator: useIndicator__19014, indicatorColor: (useIndicator__19014 ? indicatorColor__19137 : null), indicatorShape: (useIndicator__19014 ? indicatorShape__19273 : null), onTap: ((global::System.Action)(() => {
if ((((NavigationRail)this.widget).onDestinationSelected is not null))
{
    ((NavigationRail)this.widget).onDestinationSelected!(i__20314);
}
})), indexLabel: localizations__17477.tabLabel(tabIndex: (i__20314 + 1L), tabCount: checked((long)(((NavigationRail)this.widget).destinations.Count))), disabled: ((NavigationRail)this.widget).destinations[(int)(i__20314)].disabled))); } if ((!((NavigationRail)this.widget).trailingAtBottom && (((NavigationRail)this.widget).trailing is not null))) { __collection20149.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(((NavigationRail)this.widget).trailing!)); } return __collection20149; }))()));
        if (((NavigationRail)this.widget).scrollable)
        {
            mainGroup__19943 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SingleChildScrollView(child: mainGroup__19943));
        }
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Semantics(container: true, child: new _ExtendedNavigationRailAnimation__navigation_rail(animation: this._extendedAnimation, child: new global::Doroti.Framework.Widgets.Semantics(explicitChildNodes: true, child: new Material(elevation: elevation__17680, color: backgroundColor__17545, child: new global::Doroti.Framework.Widgets.SafeArea(right: isRTLDirection__19865, left: !isRTLDirection__19865, child: new global::Doroti.Framework.Widgets.Column(children: ((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection22353 = new List<global::Doroti.Framework.Widgets.Widget>(); __collection22353.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(Navigation_railLibrary._verticalSpacer)); if ((((NavigationRail)this.widget).leadingAtTop && (((NavigationRail)this.widget).leading is not null))) { __collection22353.AddRange(new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(((NavigationRail)this.widget).leading!), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(Navigation_railLibrary._verticalSpacer) }); } __collection22353.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Flexible(child: new global::Doroti.Framework.Widgets.Align(alignment: new global::Doroti.Framework.Painting.Alignment(0, groupAlignment__18757), child: mainGroup__19943)))); if ((((NavigationRail)this.widget).trailingAtBottom && (((NavigationRail)this.widget).trailing is not null))) { __collection22353.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(((NavigationRail)this.widget).trailing!)); } return __collection22353; }))())))))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual void _disposeControllers()
    {
        foreach (global::Doroti.Framework.Animation.AnimationController controller__22971 in this._destinationControllers)
        {
...
internal class _RailDestinationState__navigation_rail : global::Doroti.Framework.Widgets.State<_RailDestination__navigation_rail>
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Painting.EdgeInsets destinationPadding__26598 = ((global::Doroti.Framework.Painting.EdgeInsets)(object?)((((_RailDestination__navigation_rail)this.widget).padding ?? global::Doroti.Framework.Painting.EdgeInsets.zero)).resolve(textDirection__26486));
        global::Doroti.Ui.Offset indicatorOffset__26703 = default!;
        var applyXOffset__26728 = false;
        global::Doroti.Framework.Widgets.Widget themedIcon__26768 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.IconTheme(data: (((_RailDestination__navigation_rail)this.widget).disabled ? ((_RailDestination__navigation_rail)this.widget).iconTheme.copyWith(color: theme__26435.colorScheme.onSurface.withOpacity(0.38)) : ((_RailDestination__navigation_rail)this.widget).iconTheme), child: ((_RailDestination__navigation_rail)this.widget).icon));
        global::Doroti.Framework.Widgets.Widget styledLabel__26992 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.DefaultTextStyle(style: (((_RailDestination__navigation_rail)this.widget).disabled ? ((_RailDestination__navigation_rail)this.widget).labelTextStyle.copyWith(color: theme__26435.colorScheme.onSurface.withOpacity(0.38)) : ((_RailDestination__navigation_rail)this.widget).labelTextStyle), child: ((_RailDestination__navigation_rail)this.widget).label));
        global::Doroti.Framework.Widgets.Widget content__27231 = default!;
        ...
        switch (((_RailDestination__navigation_rail)this.widget).labelType)
        {
            case NavigationRailLabelType.none:
                {
                    global::Doroti.Framework.Widgets.Widget? spacing__27894 = ((global::Doroti.Framework.Widgets.Widget?)(object?)(material3__26545 ? new global::Doroti.Framework.Widgets.SizedBox(height: (Navigation_railLibrary._verticalDestinationSpacingM3 / 2L)) : null));
                    indicatorOffset__26703 = new global::Doroti.Ui.Offset(((((_RailDestination__navigation_rail)this.widget).minWidth / 2L) + ((global::Doroti.Framework.Painting.EdgeInsets)destinationPadding__26598).left), (((Navigation_railLibrary._verticalDestinationSpacingM3 / 2L) + ((global::Doroti.Framework.Painting.EdgeInsets)destinationPadding__26598).top) + indicatorVerticalOffset__27590));
                    global::Doroti.Framework.Widgets.Widget iconPart__28225 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Column(children: ((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection28264 = new List<global::Doroti.Framework.Widgets.Widget>(); var __collectionElement28286 = spacing__27894; if (__collectionElement28286 is { } __nonNullCollectionElement28286) { __collection28264.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(__nonNullCollectionElement28286)); } __collection28264.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: ((_RailDestination__navigation_rail)this.widget).minWidth, height: (material3__26545 ? null : ((_RailDestination__navigation_rail)this.widget).minWidth), child: new global::Doroti.Framework.Widgets.Center(child: new _AddIndicator__navigation_rail(addIndicator: ((_RailDestination__navigation_rail)this.widget).useIndicator, indicatorColor: ((_RailDestination__navigation_rail)this.widget).indicatorColor, indicatorShape: ((_RailDestination__navigation_rail)this.widget).indicatorShape, isCircular: !material3__26545, indicatorAnimation: ((_RailDestination__navigation_rail)this.widget).destinationAnimation, child: themedIcon__26768))))); var __collectionElement28857 = spacing__27894; if (__collectionElement28857 is { } __nonNullCollectionElement28857) { __collection28264.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(__nonNullCollectionElement28857)); } return __collection28264; }))()));
                    if ((((_RailDestination__navigation_rail)this.widget).extendedTransitionAnimation.value == 0L))
                    {
                        content__27231 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Padding(padding: (((_RailDestination__navigation_rail)this.widget).padding ?? global::Doroti.Framework.Painting.EdgeInsets.zero), child: new global::Doroti.Framework.Widgets.Stack(children: new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(iconPart__28225), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(global::Doroti.Framework.Widgets.SizedBox.CreateShrink(child: global::Doroti.Framework.Widgets.Visibility.CreateMaintain(visible: false, child: ((_RailDestination__navigation_rail)this.widget).label))) })));
                    }
                    else
                    {
                        global::Doroti.Framework.Animation.Animation<double> labelFadeAnimation__29377 = ((global::Doroti.Framework.Animation.Animation<double>)(object?)((_RailDestination__navigation_rail)this.widget).extendedTransitionAnimation.drive(new global::Doroti.Framework.Animation.CurveTween(curve: new global::Doroti.Framework.Animation.Interval(0.0, 0.25))));
                        applyXOffset__26728 = true;
                        content__27231 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Padding(padding: (((_RailDestination__navigation_rail)this.widget).padding ?? global::Doroti.Framework.Painting.EdgeInsets.zero), child: new global::Doroti.Framework.Widgets.ConstrainedBox(constraints: new global::Doroti.Framework.Rendering.BoxConstraints(minWidth: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(((_RailDestination__navigation_rail)this.widget).minWidth, ((_RailDestination__navigation_rail)this.widget).minExtendedWidth, ((_RailDestination__navigation_rail)this.widget).extendedTransitionAnimation.value))), child: new global::Doroti.Framework.Widgets.ClipRect(child: new global::Doroti.Framework.Widgets.Row(mainAxisSize: global::Doroti.Framework.Rendering.MainAxisSize.min, children: new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(iconPart__28225), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Flexible(child: new global::Doroti.Framework.Widgets.Align(heightFactor: 1.0, widthFactor: ((_RailDestination__navigation_rail)this.widget).extendedTransitionAnimation.value, alignment: global::Doroti.Framework.Painting.AlignmentDirectional.centerStart, child: new global::Doroti.Framework.Widgets.FadeTransition(alwaysIncludeSemantics: true, opacity: labelFadeAnimation__29377, child: styledLabel__26992)))), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: (Navigation_railLibrary._horizontalDestinationPadding * ((_RailDestination__navigation_rail)this.widget).extendedTransitionAnimation.value))) })))));
                    }
                    break;
                }
            case NavigationRailLabelType.selected:
                {
                    double appearingAnimationValue__30974 = (1L - ((global::Doroti.Framework.Animation.CurvedAnimation)this._positionAnimation).value);
                    ...
                    var interval__31236 = (((_RailDestination__navigation_rail)this.widget).selected ? new global::Doroti.Framework.Animation.Interval(0.25, 0.75) : new global::Doroti.Framework.Animation.Interval(0.75, 1.0));
                    global::Doroti.Framework.Animation.Animation<double> labelFadeAnimation__31353 = ((global::Doroti.Framework.Animation.Animation<double>)(object?)((_RailDestination__navigation_rail)this.widget).destinationAnimation.drive(new global::Doroti.Framework.Animation.CurveTween(curve: interval__31236)));
                    double minHeight__31480 = (material3__26545 ? 0 : ((_RailDestination__navigation_rail)this.widget).minWidth);
                    global::Doroti.Framework.Widgets.Widget topSpacing__31546 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.SizedBox(height: (material3__26545 ? 0 : verticalPadding__31051)));
                    global::Doroti.Framework.Widgets.Widget labelSpacing__31631 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.SizedBox(height: (material3__26545 ? DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(0L, Navigation_railLibrary._verticalIconLabelSpacingM3, appearingAnimationValue__30974)) : 0)));
                    global::Doroti.Framework.Widgets.Widget bottomSpacing__31820 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.SizedBox(height: (material3__26545 ? Navigation_railLibrary._verticalDestinationSpacingM3 : verticalPadding__31051)));
                    double indicatorHorizontalPadding__31957 = (((((global::Doroti.Framework.Painting.EdgeInsets)destinationPadding__26598).left / 2L)) - ((((global::Doroti.Framework.Painting.EdgeInsets)destinationPadding__26598).right / 2L)));
                    double indicatorVerticalPadding__32083 = ((global::Doroti.Framework.Painting.EdgeInsets)destinationPadding__26598).top;
                    ...
                    content__27231 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.ConstrainedBox(constraints: new global::Doroti.Framework.Rendering.BoxConstraints(minWidth: ((_RailDestination__navigation_rail)this.widget).minWidth, minHeight: minHeight__31480), child: new global::Doroti.Framework.Widgets.Padding(padding: (((_RailDestination__navigation_rail)this.widget).padding ?? global::Doroti.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: Navigation_railLibrary._horizontalDestinationPadding)), child: new global::Doroti.Framework.Widgets.ClipRect(child: new global::Doroti.Framework.Widgets.Column(mainAxisSize: global::Doroti.Framework.Rendering.MainAxisSize.min, mainAxisAlignment: global::Doroti.Framework.Rendering.MainAxisAlignment.center, children: new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(topSpacing__31546), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new _AddIndicator__navigation_rail(addIndicator: ((_RailDestination__navigation_rail)this.widget).useIndicator, indicatorColor: ((_RailDestination__navigation_rail)this.widget).indicatorColor, indicatorShape: ((_RailDestination__navigation_rail)this.widget).indicatorShape, isCircular: false, indicatorAnimation: ((_RailDestination__navigation_rail)this.widget).destinationAnimation, child: themedIcon__26768)), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(labelSpacing__31631), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Align(alignment: global::Doroti.Framework.Painting.Alignment.topCenter, heightFactor: appearingAnimationValue__30974, widthFactor: 1.0, child: new global::Doroti.Framework.Widgets.FadeTransition(alwaysIncludeSemantics: true, opacity: labelFadeAnimation__31353, child: styledLabel__26992))), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(bottomSpacing__31820) })))));
                    break;
                }
            case NavigationRailLabelType.all:
                {
                    double minHeight__34073 = (material3__26545 ? 0 : ((_RailDestination__navigation_rail)this.widget).minWidth);
                    global::Doroti.Framework.Widgets.Widget topSpacing__34139 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.SizedBox(height: (material3__26545 ? 0 : Navigation_railLibrary._verticalDestinationPaddingWithLabel)));
                    global::Doroti.Framework.Widgets.Widget labelSpacing__34266 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.SizedBox(height: (material3__26545 ? Navigation_railLibrary._verticalIconLabelSpacingM3 : 0)));
                    global::Doroti.Framework.Widgets.Widget bottomSpacing__34365 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.SizedBox(height: (material3__26545 ? Navigation_railLibrary._verticalDestinationSpacingM3 : Navigation_railLibrary._verticalDestinationPaddingWithLabel)));
                    double indicatorHorizontalPadding__34523 = (((((global::Doroti.Framework.Painting.EdgeInsets)destinationPadding__26598).left / 2L)) - ((((global::Doroti.Framework.Painting.EdgeInsets)destinationPadding__26598).right / 2L)));
                    double indicatorVerticalPadding__34649 = ((global::Doroti.Framework.Painting.EdgeInsets)destinationPadding__26598).top;
                    ...
                    content__27231 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.ConstrainedBox(constraints: new global::Doroti.Framework.Rendering.BoxConstraints(minWidth: ((_RailDestination__navigation_rail)this.widget).minWidth, minHeight: minHeight__34073), child: new global::Doroti.Framework.Widgets.Padding(padding: (((_RailDestination__navigation_rail)this.widget).padding ?? global::Doroti.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: Navigation_railLibrary._horizontalDestinationPadding)), child: new global::Doroti.Framework.Widgets.Column(children: new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(topSpacing__34139), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new _AddIndicator__navigation_rail(addIndicator: ((_RailDestination__navigation_rail)this.widget).useIndicator, indicatorColor: ((_RailDestination__navigation_rail)this.widget).indicatorColor, indicatorShape: ((_RailDestination__navigation_rail)this.widget).indicatorShape, isCircular: false, indicatorAnimation: ((_RailDestination__navigation_rail)this.widget).destinationAnimation, child: themedIcon__26768)), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(labelSpacing__34266), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(styledLabel__26992), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(bottomSpacing__34365) }))));
                    break;
                }
        }
...
internal class _IndicatorInkWell__navigation_rail : InkResponse
{
    ...
    public virtual RectCallback? getRectCallback(global::Doroti.Framework.Rendering.RenderBox referenceBox)
    {
        ...
        {
            double boxWidth__38404 = ((global::Doroti.Framework.Rendering.RenderBox)referenceBox).size.width;
...
internal class _AddIndicator__navigation_rail : global::Doroti.Framework.Widgets.StatelessWidget
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        global::Doroti.Framework.Widgets.Widget indicator__39780 = default!;
        if (this.isCircular)
        {
            indicator__39780 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new NavigationIndicator(animation: this.indicatorAnimation, height: Navigation_railLibrary._kCircularIndicatorDiameter, width: Navigation_railLibrary._kCircularIndicatorDiameter, borderRadius: global::Doroti.Framework.Painting.BorderRadius.CreateAll(global::Doroti.Ui.Radius.circular((Navigation_railLibrary._kCircularIndicatorDiameter / 2L))), color: this.indicatorColor));
        }
        else
        {
            indicator__39780 = DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new NavigationIndicator(animation: this.indicatorAnimation, width: Navigation_railLibrary._kCircularIndicatorDiameter, shape: this.indicatorShape, color: this.indicatorColor));
        }
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Stack(alignment: global::Doroti.Framework.Painting.Alignment.center, children: new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(indicator__39780), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(this.child) }));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
