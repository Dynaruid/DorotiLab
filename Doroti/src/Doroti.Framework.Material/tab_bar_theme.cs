...
public class TabBarTheme : InheritedTheme, Diagnosticable
{
    ...
    public virtual Color? indicatorColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.indicatorColor : _indicatorColor
        );
    public virtual TabBarIndicatorSize? indicatorSize =>
        (_data is not null) ? _data.indicatorSize : _indicatorSize;
    public virtual Color? dividerColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.dividerColor : _dividerColor
        );
    public virtual double? dividerHeight =>
        (_data is not null) ? _data.dividerHeight : _dividerHeight;
    public virtual Color? labelColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.labelColor : _labelColor
        );
    public virtual EdgeInsetsGeometry? labelPadding =>
        (_data is not null) ? _data.labelPadding : _labelPadding;
    public virtual TextStyle? labelStyle => (_data is not null) ? _data.labelStyle : _labelStyle;
    public virtual Color? unselectedLabelColor =>
        DartRuntimePrimitives.ConvertValue<Color>(
            (_data is not null) ? _data.unselectedLabelColor : _unselectedLabelColor
        );
    public virtual TextStyle? unselectedLabelStyle =>
        (_data is not null) ? _data.unselectedLabelStyle : _unselectedLabelStyle;
    public virtual WidgetStateProperty<Color?>? overlayColor =>
        DartRuntimePrimitives.ConvertValue<WidgetStateProperty<Color?>>(
            (_data is not null) ? _data.overlayColor : _overlayColor
        );
    public virtual InteractiveInkFeatureFactory? splashFactory =>
        (_data is not null) ? _data.splashFactory : _splashFactory;
    public virtual WidgetStateProperty<MouseCursor?>? mouseCursor =>
        (_data is not null) ? _data.mouseCursor : _mouseCursor;
    public virtual TabAlignment? tabAlignment =>
        (_data is not null) ? _data.tabAlignment : _tabAlignment;
    public virtual TextScaler? textScaler => (_data is not null) ? _data.textScaler : _textScaler;
    public virtual TabIndicatorAnimation? indicatorAnimation =>
        (_data is not null) ? _data.indicatorAnimation : _indicatorAnimation;
    public virtual TabBarThemeData data =>
        DartRuntimePrimitives.ConvertValue<TabBarThemeData>(
            _data
                ?? new TabBarThemeData(
    ...
    public virtual TabBarTheme copyWith(
        Decoration? indicator = null,
        Color? indicatorColor = null,
        TabBarIndicatorSize? indicatorSize = null,
        Color? dividerColor = null,
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((TabBarTheme)oldWidget).data));
...
public class TabBarThemeData : Diagnosticable
{
    ...
    public virtual TabBarThemeData copyWith(
        Decoration? indicator = null,
        Color? indicatorColor = null,
        TabBarIndicatorSize? indicatorSize = null,
        Color? dividerColor = null,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is TabBarThemeData)
            && Equals(__other.indicator, indicator)
            ...
            && Equals(__other.tabAlignment, tabAlignment)
            && Equals(__other.textScaler, textScaler)
            && Equals(__other.indicatorAnimation, indicatorAnimation)
            && Equals(__other.splashBorderRadius, splashBorderRadius);
    }

    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        properties.add(
            new DiagnosticsProperty<Decoration?>("indicator", indicator, defaultValue: null)
        );
        properties.add(
            new DiagnosticsProperty<Color?>("indicatorColor", indicatorColor, defaultValue: null)
        );
        properties.add(
            new DiagnosticsProperty<TabBarIndicatorSize?>(
                "indicatorSize",
                indicatorSize,
                defaultValue: null
            )
        ...
        properties.add(
            new DiagnosticsProperty<double?>("dividerHeight", dividerHeight, defaultValue: null)
        );
        properties.add(
            new DiagnosticsProperty<Color?>("labelColor", labelColor, defaultValue: null)
        );
        properties.add(
        ...
        properties.add(
            new DiagnosticsProperty<TabAlignment?>("tabAlignment", tabAlignment, defaultValue: null)
        );
        properties.add(
            new DiagnosticsProperty<TextScaler?>("textScaler", textScaler, defaultValue: null)
        );
        properties.add(
            new DiagnosticsProperty<TabIndicatorAnimation?>(
                "indicatorAnimation",
                indicatorAnimation,
                defaultValue: null
            )
        ...
        properties.add(
            new DiagnosticsProperty<BorderRadius?>(
                "splashBorderRadius",
                splashBorderRadius,
                defaultValue: null
            )
