...
internal class _AccountPictures__user_accounts_drawer_header : StatelessWidget
{
    ...
    internal _AccountPictures__user_accounts_drawer_header(
...
public class _AccountDetails__user_accounts_drawer_header : StatefulWidget
{
    ...
    internal _AccountDetails__user_accounts_drawer_header(
        Widget? accountName,
        Widget? accountEmail,
        Action? onTap = null,
        bool isOpen = default!,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _AccountDetailsState__user_accounts_drawer_header()
        );
}

public class _AccountDetailsState__user_accounts_drawer_header
    : State<_AccountDetails__user_accounts_drawer_header>,
        SingleTickerProviderStateMixin<_AccountDetails__user_accounts_drawer_header>
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Widget accountDetails = new CustomMultiChildLayout(
            ...
            children: (
                (Func<List<Widget>>)(
                    () =>
                    {
                        var __collection4021 = new List<Widget>();
                        if (widget.accountName is not null)
                        {
                            __collection4021.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new LayoutId(
                                        id: _AccountDetailsLayout__user_accounts_drawer_header.accountName,
                                        child: new Padding(
                                            padding: EdgeInsets.CreateSymmetric(vertical: 2.0),
                        ...
                        if (widget.accountEmail is not null)
                        {
                            __collection4021.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new LayoutId(
                                        id: _AccountDetailsLayout__user_accounts_drawer_header.accountEmail,
                                        child: new Padding(
                                            padding: EdgeInsets.CreateSymmetric(vertical: 2.0),
                                            child: new DefaultTextStyle(
                        ...
                        if (widget.onTap is not null)
                        {
                            __collection4021.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new LayoutId(
                                        id: _AccountDetailsLayout__user_accounts_drawer_header.dropdownIcon,
                                        child: new Widgets.Semantics(
                                            container: true,
                                            button: true,
                                            onTap: () => widget.onTap(),
                                            child: SizedBox.CreateSquare(
                                                dimension: User_accounts_drawer_headerLibrary._kAccountDetailsHeight,
                                                child: new Center(
        ...
        if (widget.onTap is not null)
        {
            accountDetails = DartRuntimePrimitives.ConvertValue<Widget>(
                new InkWell(onTap: widget.onTap, excludeFromSemantics: true, child: accountDetails)
            );
        }
        return new SizedBox(
...
internal class _AccountDetailsLayout__user_accounts_drawer_header : MultiChildLayoutDelegate
{
    ...
    public override void performLayout(Size size)
    {
        ...
        if (bottomLine is not null)
        {
            ...
            iconSize ??= new Size(
                User_accounts_drawer_headerLibrary._kAccountDetailsHeight,
                User_accounts_drawer_headerLibrary._kAccountDetailsHeight
            );
            Size bottomLineSize = layoutChild(
                bottomLine,
                BoxConstraints.CreateLoose(constraintSize)
            );
...
public class UserAccountsDrawerHeader : StatefulWidget
{
    ...
    public UserAccountsDrawerHeader(
        ...
        Size? currentAccountPictureSize = null,
        Size? otherAccountsPicturesSize = null,
        Widget? accountName = default!,
        Widget? accountEmail = default!,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _UserAccountsDrawerHeaderState__user_accounts_drawer_header()
        );
}

internal class _UserAccountsDrawerHeaderState__user_accounts_drawer_header
    : State<UserAccountsDrawerHeader>
{
        ...
        return new Widgets.Semantics(
            ...
            child: new DrawerHeader(
                decoration: widget.decoration
                    ?? new BoxDecoration(color: Theme.of(context).colorScheme.primary),
                margin: widget.margin,
                padding: EdgeInsetsDirectional.CreateOnly(top: 16.0, start: 16.0),
                child: new SafeArea(
                    bottom: false,
                    child: new Column(
                        ...
                        children: new List<Widget>
                        {
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                new Expanded(
                                    child: new Padding(
                                        ...
                                        child: new _AccountPictures__user_accounts_drawer_header(
                            ...
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                new _AccountDetails__user_accounts_drawer_header(
                                    accountName: widget.accountName,
                                    accountEmail: widget.accountEmail,
                                    isOpen: _isOpen,
                                    onTap: (widget.onDetailsPressed is null)
                                        ? null
