...
{
    internal async Future<QuantizerResult> quantize(
        dynamic pixels,
        long maxColors,
        bool returnInputPixelToClusterPixel = false
    )
    {
        var input = ((System.Collections.IEnumerable)(object)pixels)
            .Cast<object>()
...
internal static class Score
{
    internal static IEnumerable<long> score(DartMap<long, long> colors, long desired = 1) =>
        MaterialImageColorRuntime.Score(
            colors.ToDictionary(entry => entry.Key, entry => entry.Value),
            checked((int)desired)
        );
}
...
internal sealed class SchemeTonalSpot(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "tonalSpot");

internal sealed class SchemeFidelity(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "fidelity");

internal sealed class SchemeContent(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "content");

internal sealed class SchemeMonochrome(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "monochrome");

internal sealed class SchemeNeutral(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "neutral");

internal sealed class SchemeVibrant(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "vibrant");

internal sealed class SchemeExpressive(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "expressive");

internal sealed class SchemeRainbow(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "rainbow");

internal sealed class SchemeFruitSalad(Hct sourceColorHct, bool isDark, double contrastLevel)
    : DynamicScheme(sourceColorHct, isDark, contrastLevel, "fruitSalad");
...
internal sealed class _MaterialDynamicColor
{
    ...
    internal long getArgb(DynamicScheme scheme) =>
        MaterialColorSchemeRuntime.GetArgb(
            scheme.seedArgb,
            scheme.isDark,
            scheme.variant,
...
{
    internal static readonly _MaterialDynamicColor primary = new("primary"),
        onPrimary = new("onPrimary"),
        primaryContainer = new("primaryContainer"),
        onPrimaryContainer = new("onPrimaryContainer"),
        primaryFixed = new("primaryFixed"),
        primaryFixedDim = new("primaryFixedDim"),
        onPrimaryFixed = new("onPrimaryFixed"),
        onPrimaryFixedVariant = new("onPrimaryFixedVariant"),
        secondary = new("secondary"),
        onSecondary = new("onSecondary"),
        secondaryContainer = new("secondaryContainer"),
        onSecondaryContainer = new("onSecondaryContainer"),
        secondaryFixed = new("secondaryFixed"),
        secondaryFixedDim = new("secondaryFixedDim"),
        onSecondaryFixed = new("onSecondaryFixed"),
        onSecondaryFixedVariant = new("onSecondaryFixedVariant"),
        tertiary = new("tertiary"),
        onTertiary = new("onTertiary"),
        tertiaryContainer = new("tertiaryContainer"),
        onTertiaryContainer = new("onTertiaryContainer"),
        tertiaryFixed = new("tertiaryFixed"),
        tertiaryFixedDim = new("tertiaryFixedDim"),
        onTertiaryFixed = new("onTertiaryFixed"),
        onTertiaryFixedVariant = new("onTertiaryFixedVariant"),
        error = new("error"),
        onError = new("onError"),
        errorContainer = new("errorContainer"),
        onErrorContainer = new("onErrorContainer"),
        outline = new("outline"),
        outlineVariant = new("outlineVariant"),
        surface = new("surface"),
        surfaceDim = new("surfaceDim"),
        surfaceBright = new("surfaceBright"),
        surfaceContainerLowest = new("surfaceContainerLowest"),
        surfaceContainerLow = new("surfaceContainerLow"),
        surfaceContainer = new("surfaceContainer"),
        surfaceContainerHigh = new("surfaceContainerHigh"),
        surfaceContainerHighest = new("surfaceContainerHighest"),
        onSurface = new("onSurface"),
        onSurfaceVariant = new("onSurfaceVariant"),
        inverseSurface = new("inverseSurface"),
        inverseOnSurface = new("inverseOnSurface"),
        inversePrimary = new("inversePrimary"),
        shadow = new("shadow"),
        scrim = new("scrim"),
        background = new("background"),
        onBackground = new("onBackground"),
        surfaceVariant = new("surfaceVariant");
}
...
public class ColorScheme : Diagnosticable
{
    ...
    public static ColorScheme CreateFromSeed(
        Color seedColor,
    ...
    )
    {
        ...
        return new ColorScheme(
            primary: primary ?? new Color(MaterialDynamicColors.primary.getArgb(scheme)),
            onPrimary: onPrimary ?? new Color(MaterialDynamicColors.onPrimary.getArgb(scheme)),
            primaryContainer: primaryContainer
                ?? new Color(MaterialDynamicColors.primaryContainer.getArgb(scheme)),
            onPrimaryContainer: onPrimaryContainer
                ?? new Color(MaterialDynamicColors.onPrimaryContainer.getArgb(scheme)),
            primaryFixed: primaryFixed
                ?? new Color(MaterialDynamicColors.primaryFixed.getArgb(scheme)),
            primaryFixedDim: primaryFixedDim
                ?? new Color(MaterialDynamicColors.primaryFixedDim.getArgb(scheme)),
            onPrimaryFixed: onPrimaryFixed
                ?? new Color(MaterialDynamicColors.onPrimaryFixed.getArgb(scheme)),
            onPrimaryFixedVariant: onPrimaryFixedVariant
                ?? new Color(MaterialDynamicColors.onPrimaryFixedVariant.getArgb(scheme)),
            secondary: secondary ?? new Color(MaterialDynamicColors.secondary.getArgb(scheme)),
            onSecondary: onSecondary
                ?? new Color(MaterialDynamicColors.onSecondary.getArgb(scheme)),
            secondaryContainer: secondaryContainer
                ?? new Color(MaterialDynamicColors.secondaryContainer.getArgb(scheme)),
            onSecondaryContainer: onSecondaryContainer
                ?? new Color(MaterialDynamicColors.onSecondaryContainer.getArgb(scheme)),
            secondaryFixed: secondaryFixed
                ?? new Color(MaterialDynamicColors.secondaryFixed.getArgb(scheme)),
            secondaryFixedDim: secondaryFixedDim
                ?? new Color(MaterialDynamicColors.secondaryFixedDim.getArgb(scheme)),
            onSecondaryFixed: onSecondaryFixed
                ?? new Color(MaterialDynamicColors.onSecondaryFixed.getArgb(scheme)),
            onSecondaryFixedVariant: onSecondaryFixedVariant
                ?? new Color(MaterialDynamicColors.onSecondaryFixedVariant.getArgb(scheme)),
            tertiary: tertiary ?? new Color(MaterialDynamicColors.tertiary.getArgb(scheme)),
            onTertiary: onTertiary ?? new Color(MaterialDynamicColors.onTertiary.getArgb(scheme)),
            tertiaryContainer: tertiaryContainer
                ?? new Color(MaterialDynamicColors.tertiaryContainer.getArgb(scheme)),
            onTertiaryContainer: onTertiaryContainer
                ?? new Color(MaterialDynamicColors.onTertiaryContainer.getArgb(scheme)),
            tertiaryFixed: tertiaryFixed
                ?? new Color(MaterialDynamicColors.tertiaryFixed.getArgb(scheme)),
            tertiaryFixedDim: tertiaryFixedDim
                ?? new Color(MaterialDynamicColors.tertiaryFixedDim.getArgb(scheme)),
            onTertiaryFixed: onTertiaryFixed
                ?? new Color(MaterialDynamicColors.onTertiaryFixed.getArgb(scheme)),
            onTertiaryFixedVariant: onTertiaryFixedVariant
                ?? new Color(MaterialDynamicColors.onTertiaryFixedVariant.getArgb(scheme)),
            error: error ?? new Color(MaterialDynamicColors.error.getArgb(scheme)),
            onError: onError ?? new Color(MaterialDynamicColors.onError.getArgb(scheme)),
            errorContainer: errorContainer
                ?? new Color(MaterialDynamicColors.errorContainer.getArgb(scheme)),
            onErrorContainer: onErrorContainer
                ?? new Color(MaterialDynamicColors.onErrorContainer.getArgb(scheme)),
            outline: outline ?? new Color(MaterialDynamicColors.outline.getArgb(scheme)),
            outlineVariant: outlineVariant
                ?? new Color(MaterialDynamicColors.outlineVariant.getArgb(scheme)),
            surface: surface ?? new Color(MaterialDynamicColors.surface.getArgb(scheme)),
            surfaceDim: surfaceDim ?? new Color(MaterialDynamicColors.surfaceDim.getArgb(scheme)),
            surfaceBright: surfaceBright
                ?? new Color(MaterialDynamicColors.surfaceBright.getArgb(scheme)),
            surfaceContainerLowest: surfaceContainerLowest
                ?? new Color(MaterialDynamicColors.surfaceContainerLowest.getArgb(scheme)),
            surfaceContainerLow: surfaceContainerLow
                ?? new Color(MaterialDynamicColors.surfaceContainerLow.getArgb(scheme)),
            surfaceContainer: surfaceContainer
                ?? new Color(MaterialDynamicColors.surfaceContainer.getArgb(scheme)),
            surfaceContainerHigh: surfaceContainerHigh
                ?? new Color(MaterialDynamicColors.surfaceContainerHigh.getArgb(scheme)),
            surfaceContainerHighest: surfaceContainerHighest
                ?? new Color(MaterialDynamicColors.surfaceContainerHighest.getArgb(scheme)),
            onSurface: onSurface ?? new Color(MaterialDynamicColors.onSurface.getArgb(scheme)),
            onSurfaceVariant: onSurfaceVariant
                ?? new Color(MaterialDynamicColors.onSurfaceVariant.getArgb(scheme)),
            inverseSurface: inverseSurface
                ?? new Color(MaterialDynamicColors.inverseSurface.getArgb(scheme)),
            onInverseSurface: onInverseSurface
                ?? new Color(MaterialDynamicColors.inverseOnSurface.getArgb(scheme)),
            inversePrimary: inversePrimary
                ?? new Color(MaterialDynamicColors.inversePrimary.getArgb(scheme)),
    ...
    public static ColorScheme CreateLight(
        Brightness brightness = Brightness.light,
        ...
        Color? onBackground = default!,
        Color? surfaceVariant = null
    )
    {
        var __instance = new ColorScheme(
            brightness: brightness,
            primary: primary,
            onPrimary: onPrimary,
            primaryContainer: primaryContainer,
    ...
    public static ColorScheme CreateDark(
    ...
    public static ColorScheme CreateHighContrastLight(
        Brightness brightness = Brightness.light,
        Color primary = default!,
        Color onPrimary = default!,
        Color? primaryContainer = null,
    ...
    public static ColorScheme CreateHighContrastDark(
        Brightness brightness = Brightness.dark,
        Color primary = default!,
        Color onPrimary = default!,
        Color? primaryContainer = null,
    ...
    public static ColorScheme CreateFromSwatch(
        MaterialColor primarySwatch = default!,
    ...
    )
    {
        ...
        return new ColorScheme(
            primary: __primarySwatch,
            secondary: secondaryLocal,
            surface: cardColor ?? (isDark ? Colors.grey[800L]! : Colors.white),
            error: errorColor ?? Colors.red[700L]!,
    ...
    internal static Brightness _brightnessFor(Color color) =>
        DartRuntimePrimitives.ConvertValue<Brightness>(ThemeData.estimateBrightnessForColor(color));

    public virtual Color primaryContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_primaryContainer ?? primary);
    public virtual Color onPrimaryContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_onPrimaryContainer ?? onPrimary);
    public virtual Color primaryFixed =>
        DartRuntimePrimitives.ConvertValue<Color>(_primaryFixed ?? primary);
    public virtual Color primaryFixedDim =>
        DartRuntimePrimitives.ConvertValue<Color>(_primaryFixedDim ?? primary);
    public virtual Color onPrimaryFixed =>
        DartRuntimePrimitives.ConvertValue<Color>(_onPrimaryFixed ?? onPrimary);
    public virtual Color onPrimaryFixedVariant =>
        DartRuntimePrimitives.ConvertValue<Color>(_onPrimaryFixedVariant ?? onPrimary);
    public virtual Color secondaryContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_secondaryContainer ?? secondary);
    public virtual Color onSecondaryContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_onSecondaryContainer ?? onSecondary);
    public virtual Color secondaryFixed =>
        DartRuntimePrimitives.ConvertValue<Color>(_secondaryFixed ?? secondary);
    public virtual Color secondaryFixedDim =>
        DartRuntimePrimitives.ConvertValue<Color>(_secondaryFixedDim ?? secondary);
    public virtual Color onSecondaryFixed =>
        DartRuntimePrimitives.ConvertValue<Color>(_onSecondaryFixed ?? onSecondary);
    public virtual Color onSecondaryFixedVariant =>
        DartRuntimePrimitives.ConvertValue<Color>(_onSecondaryFixedVariant ?? onSecondary);
    public virtual Color tertiary =>
        DartRuntimePrimitives.ConvertValue<Color>(_tertiary ?? secondary);
    public virtual Color onTertiary =>
        DartRuntimePrimitives.ConvertValue<Color>(_onTertiary ?? onSecondary);
    public virtual Color tertiaryContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_tertiaryContainer ?? tertiary);
    public virtual Color onTertiaryContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_onTertiaryContainer ?? onTertiary);
    public virtual Color tertiaryFixed =>
        DartRuntimePrimitives.ConvertValue<Color>(_tertiaryFixed ?? tertiary);
    public virtual Color tertiaryFixedDim =>
        DartRuntimePrimitives.ConvertValue<Color>(_tertiaryFixedDim ?? tertiary);
    public virtual Color onTertiaryFixed =>
        DartRuntimePrimitives.ConvertValue<Color>(_onTertiaryFixed ?? onTertiary);
    public virtual Color onTertiaryFixedVariant =>
        DartRuntimePrimitives.ConvertValue<Color>(_onTertiaryFixedVariant ?? onTertiary);
    public virtual Color errorContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_errorContainer ?? error);
    public virtual Color onErrorContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_onErrorContainer ?? onError);
    public virtual Color surfaceVariant =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceVariant ?? surface);
    public virtual Color surfaceDim =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceDim ?? surface);
    public virtual Color surfaceBright =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceBright ?? surface);
    public virtual Color surfaceContainerLowest =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainerLowest ?? surface);
    public virtual Color surfaceContainerLow =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainerLow ?? surface);
    public virtual Color surfaceContainer =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainer ?? surface);
    public virtual Color surfaceContainerHigh =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainerHigh ?? surface);
    public virtual Color surfaceContainerHighest =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainerHighest ?? surface);
    public virtual Color onSurfaceVariant =>
        DartRuntimePrimitives.ConvertValue<Color>(_onSurfaceVariant ?? onSurface);
    public virtual Color outline =>
        DartRuntimePrimitives.ConvertValue<Color>(_outline ?? onBackground);
    public virtual Color outlineVariant =>
        DartRuntimePrimitives.ConvertValue<Color>(_outlineVariant ?? onBackground);
    public virtual Color shadow =>
        DartRuntimePrimitives.ConvertValue<Color>(_shadow ?? new Color(4278190080L));
    public virtual Color scrim =>
        DartRuntimePrimitives.ConvertValue<Color>(_scrim ?? new Color(4278190080L));
    public virtual Color inverseSurface =>
        DartRuntimePrimitives.ConvertValue<Color>(_inverseSurface ?? onSurface);
    public virtual Color onInverseSurface =>
        DartRuntimePrimitives.ConvertValue<Color>(_onInverseSurface ?? surface);
    public virtual Color inversePrimary =>
        DartRuntimePrimitives.ConvertValue<Color>(_inversePrimary ?? onPrimary);
    public virtual Color surfaceTint =>
        DartRuntimePrimitives.ConvertValue<Color>(_surfaceTint ?? primary);
    public virtual Color background =>
        DartRuntimePrimitives.ConvertValue<Color>(_background ?? surface);
    public virtual Color onBackground =>
        DartRuntimePrimitives.ConvertValue<Color>(_onBackground ?? onSurface);

    public virtual ColorScheme copyWith(
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is ColorScheme)
            && Equals(__other.brightness, brightness)
            && Equals(__other.primary, primary)
            && Equals(__other.onPrimary, onPrimary)
            && Equals(__other.primaryContainer, primaryContainer)
            && Equals(__other.onPrimaryContainer, onPrimaryContainer)
            && Equals(__other.primaryFixed, primaryFixed)
            && Equals(__other.primaryFixedDim, primaryFixedDim)
            && Equals(__other.onPrimaryFixed, onPrimaryFixed)
            && Equals(__other.onPrimaryFixedVariant, onPrimaryFixedVariant)
            && Equals(__other.secondary, secondary)
            && Equals(__other.onSecondary, onSecondary)
            && Equals(__other.secondaryContainer, secondaryContainer)
            && Equals(__other.onSecondaryContainer, onSecondaryContainer)
            && Equals(__other.secondaryFixed, secondaryFixed)
            && Equals(__other.secondaryFixedDim, secondaryFixedDim)
            && Equals(__other.onSecondaryFixed, onSecondaryFixed)
            && Equals(__other.onSecondaryFixedVariant, onSecondaryFixedVariant)
            && Equals(__other.tertiary, tertiary)
            && Equals(__other.onTertiary, onTertiary)
            && Equals(__other.tertiaryContainer, tertiaryContainer)
            && Equals(__other.onTertiaryContainer, onTertiaryContainer)
            && Equals(__other.tertiaryFixed, tertiaryFixed)
            && Equals(__other.tertiaryFixedDim, tertiaryFixedDim)
            && Equals(__other.onTertiaryFixed, onTertiaryFixed)
            && Equals(__other.onTertiaryFixedVariant, onTertiaryFixedVariant)
            && Equals(__other.error, error)
            && Equals(__other.onError, onError)
            && Equals(__other.errorContainer, errorContainer)
            && Equals(__other.onErrorContainer, onErrorContainer)
            && Equals(__other.surface, surface)
            && Equals(__other.onSurface, onSurface)
            && Equals(__other.surfaceDim, surfaceDim)
            && Equals(__other.surfaceBright, surfaceBright)
            && Equals(__other.surfaceContainerLowest, surfaceContainerLowest)
            && Equals(__other.surfaceContainerLow, surfaceContainerLow)
            && Equals(__other.surfaceContainer, surfaceContainer)
            && Equals(__other.surfaceContainerHigh, surfaceContainerHigh)
            && Equals(__other.surfaceContainerHighest, surfaceContainerHighest)
            && Equals(__other.onSurfaceVariant, onSurfaceVariant)
            && Equals(__other.outline, outline)
            && Equals(__other.outlineVariant, outlineVariant)
            && Equals(__other.shadow, shadow)
            && Equals(__other.scrim, scrim)
            && Equals(__other.inverseSurface, inverseSurface)
            && Equals(__other.onInverseSurface, onInverseSurface)
            && Equals(__other.inversePrimary, inversePrimary)
            && Equals(__other.surfaceTint, surfaceTint)
            && Equals(__other.background, background)
            && Equals(__other.onBackground, onBackground)
            && Equals(__other.surfaceVariant, surfaceVariant);
    }
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(
            new ColorProperty("onPrimary", onPrimary, defaultValue: defaultScheme.onPrimary)
        );
        properties.add(
            new ColorProperty(
                "primaryContainer",
        ...
        properties.add(
            new ColorProperty("secondary", secondary, defaultValue: defaultScheme.secondary)
        );
        properties.add(
            new ColorProperty("onSecondary", onSecondary, defaultValue: defaultScheme.onSecondary)
        );
        properties.add(
            new ColorProperty(
                "secondaryContainer",
        ...
        properties.add(
            new ColorProperty("tertiary", tertiary, defaultValue: defaultScheme.tertiary)
        );
        properties.add(
            new ColorProperty("onTertiary", onTertiary, defaultValue: defaultScheme.onTertiary)
        );
        properties.add(
            new ColorProperty(
                "tertiaryContainer",
        ...
        properties.add(
            new ColorProperty("onSurface", onSurface, defaultValue: defaultScheme.onSurface)
        );
        properties.add(
            new ColorProperty("surfaceDim", surfaceDim, defaultValue: defaultScheme.surfaceDim)
        );
        properties.add(
            new ColorProperty(
                "surfaceBright",
        ...
        properties.add(new ColorProperty("outline", outline, defaultValue: defaultScheme.outline));
        properties.add(
            new ColorProperty(
                "outlineVariant",
                outlineVariant,
        ...
        properties.add(new ColorProperty("shadow", shadow, defaultValue: defaultScheme.shadow));
        properties.add(new ColorProperty("scrim", scrim, defaultValue: defaultScheme.scrim));
        properties.add(
            new ColorProperty(
                "inverseSurface",
                inverseSurface,
        ...
        properties.add(
            new ColorProperty("surfaceTint", surfaceTint, defaultValue: defaultScheme.surfaceTint)
        );
        properties.add(
            new ColorProperty("background", background, defaultValue: defaultScheme.background)
        );
        properties.add(
            new ColorProperty(
                "onBackground",
    ...
    public static async Future<ColorScheme> fromImageProvider(
    ...
    {
        using Ui.Image scaledImage = await _imageProviderToScaled(imageProvider);
        var bytes =
            await scaledImage.toByteData(ImageByteFormat.rawRgba)
            ?? throw new InvalidOperationException("Image readback returned no RGBA bytes.");
        return await new QuantizerCelebi().quantize(
            MaterialImageColorRuntime.ArgbFromRgba(bytes.asMemory().Span),
            128L
        );
    }

    internal static async Future<Ui.Image> _imageProviderToScaled(IImageProvider imageProvider)
    {
        var stream = imageProvider.resolve(new ImageConfiguration(size: new Size(112, 112)));
        var completion = new TaskCompletionSource<Ui.Image>(
        ...
        listener = new ImageStreamListener(
            async (info, synchronous) =>
            {
                using var image = info.image;
                if (Interlocked.Exchange(ref admitted, 1) != 0)
                {
                    return;
                }
                ...
                try
                {
                    ...
                    var scaled = await picture.toImage(
                        Math.Max(1, (int)paintWidth),
                        Math.Max(1, (int)paintHeight)
                    );
                    if (!completion.TrySetResult(scaled))
                    {
                        scaled.Dispose();
                    }
                }
            ...
            onError: (exception, stack) =>
                completion.TrySetException(
                    exception as Exception
                        ?? new InvalidOperationException($"Failed to load image: {exception}")
                )
        );
        try
        {
    ...
    )
    {
        ...
        {
            DynamicSchemeVariant.tonalSpot => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
                new SchemeTonalSpot(
            ...
            DynamicSchemeVariant.fidelity => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
                new SchemeFidelity(
                    sourceColorHct: sourceColor,
                    isDark: isDarkLocal,
                    contrastLevel: contrastLevel
            ...
            DynamicSchemeVariant.content => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
                new SchemeContent(
                    sourceColorHct: sourceColor,
                    isDark: isDarkLocal,
                    contrastLevel: contrastLevel
            ...
            DynamicSchemeVariant.monochrome => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
            ...
            DynamicSchemeVariant.neutral => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
                new SchemeNeutral(
                    sourceColorHct: sourceColor,
                    isDark: isDarkLocal,
                    contrastLevel: contrastLevel
            ...
            DynamicSchemeVariant.vibrant => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
                new SchemeVibrant(
                    sourceColorHct: sourceColor,
                    isDark: isDarkLocal,
                    contrastLevel: contrastLevel
            ...
            DynamicSchemeVariant.expressive => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
            ...
            DynamicSchemeVariant.rainbow => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
                new SchemeRainbow(
                    sourceColorHct: sourceColor,
                    isDark: isDarkLocal,
                    contrastLevel: contrastLevel
            ...
            DynamicSchemeVariant.fruitSalad => DartRuntimePrimitives.ConvertValue<DynamicScheme>(
                new SchemeFruitSalad(
                    sourceColorHct: sourceColor,
                    isDark: isDarkLocal,
                    contrastLevel: contrastLevel
                )
