...
public class ColorScheme : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    {
        DynamicScheme scheme = ((DynamicScheme)(object?)ColorScheme._buildDynamicScheme(DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(brightness)), seedColor, dynamicSchemeVariant, contrastLevel));
    ...
    public static ColorScheme CreateFromSwatch(MaterialColor primarySwatch = default!, Color? accentColor = null, Color? cardColor = null, Color? backgroundColor = null, Color? errorColor = null, Brightness brightness = Brightness.light)
    {
        ...
        var isDark = (object.Equals(DartRuntimePrimitives.RequireValue(brightness), Brightness.dark));
        var primaryIsDark = (object.Equals(ColorScheme._brightnessFor(__primarySwatch), Brightness.dark));
        global::Doroti.Ui.Color secondaryLocal = ((global::Doroti.Ui.Color)(object?)(accentColor ?? ((isDark ? Colors.tealAccent[200L]! : __primarySwatch))));
        var secondaryIsDark = (object.Equals(ColorScheme._brightnessFor(secondaryLocal), Brightness.dark));
    ...
    {
        var defaultScheme = ColorScheme.CreateLight();
    ...
    internal static DynamicScheme _buildDynamicScheme(Brightness brightness, Color seedColor, DynamicSchemeVariant schemeVariant, double contrastLevel)
    {
        ...
        var isDarkLocal = (object.Equals(DartRuntimePrimitives.RequireValue(brightness), Brightness.dark));
