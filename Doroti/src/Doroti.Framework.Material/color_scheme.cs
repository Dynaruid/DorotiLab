...
public class ColorScheme : Diagnosticable
{
    ...
    public static ColorScheme CreateFromSeed(Color seedColor, Brightness brightness = Brightness.light, DynamicSchemeVariant dynamicSchemeVariant = DynamicSchemeVariant.tonalSpot, double contrastLevel = 0.0, Color? primary = null, Color? onPrimary = null, Color? primaryContainer = null, Color? onPrimaryContainer = null, Color? primaryFixed = null, Color? primaryFixedDim = null, Color? onPrimaryFixed = null, Color? onPrimaryFixedVariant = null, Color? secondary = null, Color? onSecondary = null, Color? secondaryContainer = null, Color? onSecondaryContainer = null, Color? secondaryFixed = null, Color? secondaryFixedDim = null, Color? onSecondaryFixed = null, Color? onSecondaryFixedVariant = null, Color? tertiary = null, Color? onTertiary = null, Color? tertiaryContainer = null, Color? onTertiaryContainer = null, Color? tertiaryFixed = null, Color? tertiaryFixedDim = null, Color? onTertiaryFixed = null, Color? onTertiaryFixedVariant = null, Color? error = null, Color? onError = null, Color? errorContainer = null, Color? onErrorContainer = null, Color? outline = null, Color? outlineVariant = null, Color? surface = null, Color? onSurface = null, Color? surfaceDim = null, Color? surfaceBright = null, Color? surfaceContainerLowest = null, Color? surfaceContainerLow = null, Color? surfaceContainer = null, Color? surfaceContainerHigh = null, Color? surfaceContainerHighest = null, Color? onSurfaceVariant = null, Color? inverseSurface = null, Color? onInverseSurface = null, Color? inversePrimary = null, Color? shadow = null, Color? scrim = null, Color? surfaceTint = null, Color? background = null, Color? onBackground = null, Color? surfaceVariant = null)
    {
        ...
        return new ColorScheme(primary: primary ?? new Color(MaterialDynamicColors.primary.getArgb(scheme)), onPrimary: onPrimary ?? new Color(MaterialDynamicColors.onPrimary.getArgb(scheme)), primaryContainer: primaryContainer ?? new Color(MaterialDynamicColors.primaryContainer.getArgb(scheme)), onPrimaryContainer: onPrimaryContainer ?? new Color(MaterialDynamicColors.onPrimaryContainer.getArgb(scheme)), primaryFixed: primaryFixed ?? new Color(MaterialDynamicColors.primaryFixed.getArgb(scheme)), primaryFixedDim: primaryFixedDim ?? new Color(MaterialDynamicColors.primaryFixedDim.getArgb(scheme)), onPrimaryFixed: onPrimaryFixed ?? new Color(MaterialDynamicColors.onPrimaryFixed.getArgb(scheme)), onPrimaryFixedVariant: onPrimaryFixedVariant ?? new Color(MaterialDynamicColors.onPrimaryFixedVariant.getArgb(scheme)), secondary: secondary ?? new Color(MaterialDynamicColors.secondary.getArgb(scheme)), onSecondary: onSecondary ?? new Color(MaterialDynamicColors.onSecondary.getArgb(scheme)), secondaryContainer: secondaryContainer ?? new Color(MaterialDynamicColors.secondaryContainer.getArgb(scheme)), onSecondaryContainer: onSecondaryContainer ?? new Color(MaterialDynamicColors.onSecondaryContainer.getArgb(scheme)), secondaryFixed: secondaryFixed ?? new Color(MaterialDynamicColors.secondaryFixed.getArgb(scheme)), secondaryFixedDim: secondaryFixedDim ?? new Color(MaterialDynamicColors.secondaryFixedDim.getArgb(scheme)), onSecondaryFixed: onSecondaryFixed ?? new Color(MaterialDynamicColors.onSecondaryFixed.getArgb(scheme)), onSecondaryFixedVariant: onSecondaryFixedVariant ?? new Color(MaterialDynamicColors.onSecondaryFixedVariant.getArgb(scheme)), tertiary: tertiary ?? new Color(MaterialDynamicColors.tertiary.getArgb(scheme)), onTertiary: onTertiary ?? new Color(MaterialDynamicColors.onTertiary.getArgb(scheme)), tertiaryContainer: tertiaryContainer ?? new Color(MaterialDynamicColors.tertiaryContainer.getArgb(scheme)), onTertiaryContainer: onTertiaryContainer ?? new Color(MaterialDynamicColors.onTertiaryContainer.getArgb(scheme)), tertiaryFixed: tertiaryFixed ?? new Color(MaterialDynamicColors.tertiaryFixed.getArgb(scheme)), tertiaryFixedDim: tertiaryFixedDim ?? new Color(MaterialDynamicColors.tertiaryFixedDim.getArgb(scheme)), onTertiaryFixed: onTertiaryFixed ?? new Color(MaterialDynamicColors.onTertiaryFixed.getArgb(scheme)), onTertiaryFixedVariant: onTertiaryFixedVariant ?? new Color(MaterialDynamicColors.onTertiaryFixedVariant.getArgb(scheme)), error: error ?? new Color(MaterialDynamicColors.error.getArgb(scheme)), onError: onError ?? new Color(MaterialDynamicColors.onError.getArgb(scheme)), errorContainer: errorContainer ?? new Color(MaterialDynamicColors.errorContainer.getArgb(scheme)), onErrorContainer: onErrorContainer ?? new Color(MaterialDynamicColors.onErrorContainer.getArgb(scheme)), outline: outline ?? new Color(MaterialDynamicColors.outline.getArgb(scheme)), outlineVariant: outlineVariant ?? new Color(MaterialDynamicColors.outlineVariant.getArgb(scheme)), surface: surface ?? new Color(MaterialDynamicColors.surface.getArgb(scheme)), surfaceDim: surfaceDim ?? new Color(MaterialDynamicColors.surfaceDim.getArgb(scheme)), surfaceBright: surfaceBright ?? new Color(MaterialDynamicColors.surfaceBright.getArgb(scheme)), surfaceContainerLowest: surfaceContainerLowest ?? new Color(MaterialDynamicColors.surfaceContainerLowest.getArgb(scheme)), surfaceContainerLow: surfaceContainerLow ?? new Color(MaterialDynamicColors.surfaceContainerLow.getArgb(scheme)), surfaceContainer: surfaceContainer ?? new Color(MaterialDynamicColors.surfaceContainer.getArgb(scheme)), surfaceContainerHigh: surfaceContainerHigh ?? new Color(MaterialDynamicColors.surfaceContainerHigh.getArgb(scheme)), surfaceContainerHighest: surfaceContainerHighest ?? new Color(MaterialDynamicColors.surfaceContainerHighest.getArgb(scheme)), onSurface: onSurface ?? new Color(MaterialDynamicColors.onSurface.getArgb(scheme)), onSurfaceVariant: onSurfaceVariant ?? new Color(MaterialDynamicColors.onSurfaceVariant.getArgb(scheme)), inverseSurface: inverseSurface ?? new Color(MaterialDynamicColors.inverseSurface.getArgb(scheme)), onInverseSurface: onInverseSurface ?? new Color(MaterialDynamicColors.inverseOnSurface.getArgb(scheme)), inversePrimary: inversePrimary ?? new Color(MaterialDynamicColors.inversePrimary.getArgb(scheme)), shadow: shadow ?? new Color(MaterialDynamicColors.shadow.getArgb(scheme)), scrim: scrim ?? new Color(MaterialDynamicColors.scrim.getArgb(scheme)), surfaceTint: surfaceTint ?? new Color(MaterialDynamicColors.primary.getArgb(scheme)), brightness: DartRuntimePrimitives.RequireValue(brightness), background: background ?? new Color(MaterialDynamicColors.background.getArgb(scheme)), onBackground: onBackground ?? new Color(MaterialDynamicColors.onBackground.getArgb(scheme)), surfaceVariant: surfaceVariant ?? new Color(MaterialDynamicColors.surfaceVariant.getArgb(scheme)));
    }
    ...
    internal static Brightness _brightnessFor(Color color) => DartRuntimePrimitives.ConvertValue<Brightness>(ThemeData.estimateBrightnessForColor(color));
    public virtual Color primaryContainer => DartRuntimePrimitives.ConvertValue<Color>(_primaryContainer ?? primary);
    public virtual Color onPrimaryContainer => DartRuntimePrimitives.ConvertValue<Color>(_onPrimaryContainer ?? onPrimary);
    public virtual Color primaryFixed => DartRuntimePrimitives.ConvertValue<Color>(_primaryFixed ?? primary);
    public virtual Color primaryFixedDim => DartRuntimePrimitives.ConvertValue<Color>(_primaryFixedDim ?? primary);
    public virtual Color onPrimaryFixed => DartRuntimePrimitives.ConvertValue<Color>(_onPrimaryFixed ?? onPrimary);
    public virtual Color onPrimaryFixedVariant => DartRuntimePrimitives.ConvertValue<Color>(_onPrimaryFixedVariant ?? onPrimary);
    public virtual Color secondaryContainer => DartRuntimePrimitives.ConvertValue<Color>(_secondaryContainer ?? secondary);
    public virtual Color onSecondaryContainer => DartRuntimePrimitives.ConvertValue<Color>(_onSecondaryContainer ?? onSecondary);
    public virtual Color secondaryFixed => DartRuntimePrimitives.ConvertValue<Color>(_secondaryFixed ?? secondary);
    public virtual Color secondaryFixedDim => DartRuntimePrimitives.ConvertValue<Color>(_secondaryFixedDim ?? secondary);
    public virtual Color onSecondaryFixed => DartRuntimePrimitives.ConvertValue<Color>(_onSecondaryFixed ?? onSecondary);
    public virtual Color onSecondaryFixedVariant => DartRuntimePrimitives.ConvertValue<Color>(_onSecondaryFixedVariant ?? onSecondary);
    public virtual Color tertiary => DartRuntimePrimitives.ConvertValue<Color>(_tertiary ?? secondary);
    public virtual Color onTertiary => DartRuntimePrimitives.ConvertValue<Color>(_onTertiary ?? onSecondary);
    public virtual Color tertiaryContainer => DartRuntimePrimitives.ConvertValue<Color>(_tertiaryContainer ?? tertiary);
    public virtual Color onTertiaryContainer => DartRuntimePrimitives.ConvertValue<Color>(_onTertiaryContainer ?? onTertiary);
    public virtual Color tertiaryFixed => DartRuntimePrimitives.ConvertValue<Color>(_tertiaryFixed ?? tertiary);
    public virtual Color tertiaryFixedDim => DartRuntimePrimitives.ConvertValue<Color>(_tertiaryFixedDim ?? tertiary);
    public virtual Color onTertiaryFixed => DartRuntimePrimitives.ConvertValue<Color>(_onTertiaryFixed ?? onTertiary);
    public virtual Color onTertiaryFixedVariant => DartRuntimePrimitives.ConvertValue<Color>(_onTertiaryFixedVariant ?? onTertiary);
    public virtual Color errorContainer => DartRuntimePrimitives.ConvertValue<Color>(_errorContainer ?? error);
    public virtual Color onErrorContainer => DartRuntimePrimitives.ConvertValue<Color>(_onErrorContainer ?? onError);
    public virtual Color surfaceVariant => DartRuntimePrimitives.ConvertValue<Color>(_surfaceVariant ?? surface);
    public virtual Color surfaceDim => DartRuntimePrimitives.ConvertValue<Color>(_surfaceDim ?? surface);
    public virtual Color surfaceBright => DartRuntimePrimitives.ConvertValue<Color>(_surfaceBright ?? surface);
    public virtual Color surfaceContainerLowest => DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainerLowest ?? surface);
    public virtual Color surfaceContainerLow => DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainerLow ?? surface);
    public virtual Color surfaceContainer => DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainer ?? surface);
    public virtual Color surfaceContainerHigh => DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainerHigh ?? surface);
    public virtual Color surfaceContainerHighest => DartRuntimePrimitives.ConvertValue<Color>(_surfaceContainerHighest ?? surface);
    public virtual Color onSurfaceVariant => DartRuntimePrimitives.ConvertValue<Color>(_onSurfaceVariant ?? onSurface);
    public virtual Color outline => DartRuntimePrimitives.ConvertValue<Color>(_outline ?? onBackground);
    public virtual Color outlineVariant => DartRuntimePrimitives.ConvertValue<Color>(_outlineVariant ?? onBackground);
    public virtual Color shadow => DartRuntimePrimitives.ConvertValue<Color>(_shadow ?? new Color(4278190080L));
    public virtual Color scrim => DartRuntimePrimitives.ConvertValue<Color>(_scrim ?? new Color(4278190080L));
    public virtual Color inverseSurface => DartRuntimePrimitives.ConvertValue<Color>(_inverseSurface ?? onSurface);
    public virtual Color onInverseSurface => DartRuntimePrimitives.ConvertValue<Color>(_onInverseSurface ?? surface);
    public virtual Color inversePrimary => DartRuntimePrimitives.ConvertValue<Color>(_inversePrimary ?? onPrimary);
    public virtual Color surfaceTint => DartRuntimePrimitives.ConvertValue<Color>(_surfaceTint ?? primary);
    public virtual Color background => DartRuntimePrimitives.ConvertValue<Color>(_background ?? surface);
    public virtual Color onBackground => DartRuntimePrimitives.ConvertValue<Color>(_onBackground ?? onSurface);
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new ColorProperty("primaryContainer", primaryContainer, defaultValue: defaultScheme.primaryContainer));
        properties.add(new ColorProperty("onPrimaryContainer", onPrimaryContainer, defaultValue: defaultScheme.onPrimaryContainer));
        properties.add(new ColorProperty("primaryFixed", primaryFixed, defaultValue: defaultScheme.primaryFixed));
        properties.add(new ColorProperty("primaryFixedDim", primaryFixedDim, defaultValue: defaultScheme.primaryFixedDim));
        properties.add(new ColorProperty("onPrimaryFixed", onPrimaryFixed, defaultValue: defaultScheme.onPrimaryFixed));
        properties.add(new ColorProperty("onPrimaryFixedVariant", onPrimaryFixedVariant, defaultValue: defaultScheme.onPrimaryFixedVariant));
        ...
        properties.add(new ColorProperty("secondaryContainer", secondaryContainer, defaultValue: defaultScheme.secondaryContainer));
        properties.add(new ColorProperty("onSecondaryContainer", onSecondaryContainer, defaultValue: defaultScheme.onSecondaryContainer));
        properties.add(new ColorProperty("secondaryFixed", secondaryFixed, defaultValue: defaultScheme.secondaryFixed));
        properties.add(new ColorProperty("secondaryFixedDim", secondaryFixedDim, defaultValue: defaultScheme.secondaryFixedDim));
        properties.add(new ColorProperty("onSecondaryFixed", onSecondaryFixed, defaultValue: defaultScheme.onSecondaryFixed));
        properties.add(new ColorProperty("onSecondaryFixedVariant", onSecondaryFixedVariant, defaultValue: defaultScheme.onSecondaryFixedVariant));
        properties.add(new ColorProperty("tertiary", tertiary, defaultValue: defaultScheme.tertiary));
        properties.add(new ColorProperty("onTertiary", onTertiary, defaultValue: defaultScheme.onTertiary));
        properties.add(new ColorProperty("tertiaryContainer", tertiaryContainer, defaultValue: defaultScheme.tertiaryContainer));
        properties.add(new ColorProperty("onTertiaryContainer", onTertiaryContainer, defaultValue: defaultScheme.onTertiaryContainer));
        properties.add(new ColorProperty("tertiaryFixed", tertiaryFixed, defaultValue: defaultScheme.tertiaryFixed));
        properties.add(new ColorProperty("tertiaryFixedDim", tertiaryFixedDim, defaultValue: defaultScheme.tertiaryFixedDim));
        properties.add(new ColorProperty("onTertiaryFixed", onTertiaryFixed, defaultValue: defaultScheme.onTertiaryFixed));
        properties.add(new ColorProperty("onTertiaryFixedVariant", onTertiaryFixedVariant, defaultValue: defaultScheme.onTertiaryFixedVariant));
        ...
        properties.add(new ColorProperty("errorContainer", errorContainer, defaultValue: defaultScheme.errorContainer));
        properties.add(new ColorProperty("onErrorContainer", onErrorContainer, defaultValue: defaultScheme.onErrorContainer));
        ...
        properties.add(new ColorProperty("surfaceDim", surfaceDim, defaultValue: defaultScheme.surfaceDim));
        properties.add(new ColorProperty("surfaceBright", surfaceBright, defaultValue: defaultScheme.surfaceBright));
        properties.add(new ColorProperty("surfaceContainerLowest", surfaceContainerLowest, defaultValue: defaultScheme.surfaceContainerLowest));
        properties.add(new ColorProperty("surfaceContainerLow", surfaceContainerLow, defaultValue: defaultScheme.surfaceContainerLow));
        properties.add(new ColorProperty("surfaceContainer", surfaceContainer, defaultValue: defaultScheme.surfaceContainer));
        properties.add(new ColorProperty("surfaceContainerHigh", surfaceContainerHigh, defaultValue: defaultScheme.surfaceContainerHigh));
        properties.add(new ColorProperty("surfaceContainerHighest", surfaceContainerHighest, defaultValue: defaultScheme.surfaceContainerHighest));
        properties.add(new ColorProperty("onSurfaceVariant", onSurfaceVariant, defaultValue: defaultScheme.onSurfaceVariant));
        properties.add(new ColorProperty("outline", outline, defaultValue: defaultScheme.outline));
        properties.add(new ColorProperty("outlineVariant", outlineVariant, defaultValue: defaultScheme.outlineVariant));
        ...
        properties.add(new ColorProperty("inverseSurface", inverseSurface, defaultValue: defaultScheme.inverseSurface));
        properties.add(new ColorProperty("onInverseSurface", onInverseSurface, defaultValue: defaultScheme.onInverseSurface));
        properties.add(new ColorProperty("inversePrimary", inversePrimary, defaultValue: defaultScheme.inversePrimary));
        properties.add(new ColorProperty("surfaceTint", surfaceTint, defaultValue: defaultScheme.surfaceTint));
        ...
        properties.add(new ColorProperty("surfaceVariant", surfaceVariant, defaultValue: defaultScheme.surfaceVariant));
    }

    public static async Future<ColorScheme> fromImageProvider(IImageProvider provider, Brightness brightness = Brightness.light, DynamicSchemeVariant dynamicSchemeVariant = DynamicSchemeVariant.tonalSpot, double contrastLevel = 0.0, Color? primary = null, Color? onPrimary = null, Color? primaryContainer = null, Color? onPrimaryContainer = null, Color? primaryFixed = null, Color? primaryFixedDim = null, Color? onPrimaryFixed = null, Color? onPrimaryFixedVariant = null, Color? secondary = null, Color? onSecondary = null, Color? secondaryContainer = null, Color? onSecondaryContainer = null, Color? secondaryFixed = null, Color? secondaryFixedDim = null, Color? onSecondaryFixed = null, Color? onSecondaryFixedVariant = null, Color? tertiary = null, Color? onTertiary = null, Color? tertiaryContainer = null, Color? onTertiaryContainer = null, Color? tertiaryFixed = null, Color? tertiaryFixedDim = null, Color? onTertiaryFixed = null, Color? onTertiaryFixedVariant = null, Color? error = null, Color? onError = null, Color? errorContainer = null, Color? onErrorContainer = null, Color? outline = null, Color? outlineVariant = null, Color? surface = null, Color? onSurface = null, Color? surfaceDim = null, Color? surfaceBright = null, Color? surfaceContainerLowest = null, Color? surfaceContainerLow = null, Color? surfaceContainer = null, Color? surfaceContainerHigh = null, Color? surfaceContainerHighest = null, Color? onSurfaceVariant = null, Color? inverseSurface = null, Color? onInverseSurface = null, Color? inversePrimary = null, Color? shadow = null, Color? scrim = null, Color? surfaceTint = null, Color? background = null, Color? onBackground = null, Color? surfaceVariant = null)
    {
    ...
    internal static async Future<QuantizerResult> _extractColorsFromImageProvider(IImageProvider imageProvider)
    {
    ...
    internal static async Future<Ui.Image> _imageProviderToScaled(IImageProvider imageProvider)
    {
        var stream = imageProvider.resolve(
            new ImageConfiguration(size: new Size(112, 112)));
        var completion = new TaskCompletionSource<Ui.Image>(TaskCreationOptions.RunContinuationsAsynchronously);
        var admitted = 0;
        var removed = 0;
        ...
        listener = new ImageStreamListener(async (info, synchronous) =>
        {
