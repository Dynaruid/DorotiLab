...
internal class _TimePickerModel__time_picker : InheritedModel<_TimePickerAspect__time_picker>
{
    ...
    public virtual Action<_HourMinuteMode__time_picker> onHourMinuteModeChanged
    {
        get;
        private set;
    } = default!;
    ...
    internal _TimePickerModel__time_picker(
        TimePickerEntryMode entryMode,
        _HourMinuteMode__time_picker hourMinuteMode,
        Action<_HourMinuteMode__time_picker> onHourMinuteModeChanged,
        Action onHourDoubleTapped,
        Action onMinuteDoubleTapped,
        TimeOfDay selectedTime,
        Action<TimeOfDay> onSelectedTimeChanged,
        bool use24HourFormat,
        _HourDialType__time_picker hourDialType,
    ...
    public static _TimePickerModel__time_picker of(
        BuildContext context,
        _TimePickerAspect__time_picker? aspect = null
    ) =>
        DartRuntimePrimitives.ConvertValue<_TimePickerModel__time_picker>(
            InheritedModel<object>.inheritFrom<_TimePickerModel__time_picker>(
                context,
                aspect: aspect
            )!
        );
    ...
    public static TimePickerEntryMode entryModeOf(BuildContext context) =>
        of(context, _TimePickerAspect__time_picker.entryMode).entryMode;

    public static _HourMinuteMode__time_picker hourMinuteModeOf(BuildContext context) =>
        of(context, _TimePickerAspect__time_picker.hourMinuteMode).hourMinuteMode;

    public static TimeOfDay selectedTimeOf(BuildContext context) =>
        of(context, _TimePickerAspect__time_picker.selectedTime).selectedTime;

    public static bool use24HourFormatOf(BuildContext context) =>
        of(context, _TimePickerAspect__time_picker.use24HourFormat).use24HourFormat;

    public static _HourDialType__time_picker hourDialTypeOf(BuildContext context) =>
        of(context, _TimePickerAspect__time_picker.hourDialType).hourDialType;

    public static Orientation orientationOf(BuildContext context) =>
        of(context, _TimePickerAspect__time_picker.orientation).orientation;

    public static TimePickerThemeData themeOf(BuildContext context) =>
        of(context, _TimePickerAspect__time_picker.theme).theme;

    public static _TimePickerDefaults__time_picker defaultThemeOf(BuildContext context) =>
        of(context, _TimePickerAspect__time_picker.defaultTheme).defaultTheme;

    public static void setSelectedTime(BuildContext context, TimeOfDay value) =>
        of(context, _TimePickerAspect__time_picker.onSelectedTimeChanged)
            .onSelectedTimeChanged(value);

    public static void setHourMinuteMode(
        BuildContext context,
        _HourMinuteMode__time_picker value
    ) =>
        of(context, _TimePickerAspect__time_picker.onHourMinuteModeChanged)
            .onHourMinuteModeChanged(value);

    public override bool updateShouldNotifyDependent(
        InheritedModel<_TimePickerAspect__time_picker> oldWidget,
        HashSet<_TimePickerAspect__time_picker> dependencies
    )
    {
        var __oldWidget = (_TimePickerModel__time_picker)oldWidget;
        if (
            (use24HourFormat != __oldWidget.use24HourFormat)
            && dependencies.Contains(_TimePickerAspect__time_picker.use24HourFormat)
        )
        {
            return true;
        }
        if (
            (!Equals(entryMode, __oldWidget.entryMode))
            && dependencies.Contains(_TimePickerAspect__time_picker.entryMode)
        )
        {
            return true;
        }
        if (
            (!Equals(hourMinuteMode, __oldWidget.hourMinuteMode))
            && dependencies.Contains(_TimePickerAspect__time_picker.hourMinuteMode)
        )
        {
            return true;
        }
        if (
            (!Equals(onHourMinuteModeChanged, __oldWidget.onHourMinuteModeChanged))
            && dependencies.Contains(_TimePickerAspect__time_picker.onHourMinuteModeChanged)
        )
        {
            return true;
        }
        if (
            (!Equals(onHourMinuteModeChanged, __oldWidget.onHourDoubleTapped))
            && dependencies.Contains(_TimePickerAspect__time_picker.onHourDoubleTapped)
        )
        {
            return true;
        }
        if (
            (!Equals(onHourMinuteModeChanged, __oldWidget.onMinuteDoubleTapped))
            && dependencies.Contains(_TimePickerAspect__time_picker.onMinuteDoubleTapped)
        )
        {
            return true;
        }
        if (
            (!Equals(hourDialType, __oldWidget.hourDialType))
            && dependencies.Contains(_TimePickerAspect__time_picker.hourDialType)
        )
        {
            return true;
        }
        if (
            (!Equals(selectedTime, __oldWidget.selectedTime))
            && dependencies.Contains(_TimePickerAspect__time_picker.selectedTime)
        )
        {
            return true;
        }
        if (
            (!Equals(onSelectedTimeChanged, __oldWidget.onSelectedTimeChanged))
            && dependencies.Contains(_TimePickerAspect__time_picker.onSelectedTimeChanged)
        )
        {
            return true;
        }
        if (
            (!Equals(orientation, __oldWidget.orientation))
            && dependencies.Contains(_TimePickerAspect__time_picker.orientation)
        )
        {
            return true;
        }
        if (
            (!Equals(theme, __oldWidget.theme))
            && dependencies.Contains(_TimePickerAspect__time_picker.theme)
        )
        {
            return true;
        }
        if (
            (!Equals(defaultTheme, __oldWidget.defaultTheme))
            && dependencies.Contains(_TimePickerAspect__time_picker.defaultTheme)
        )
        {
            return true;
        }
    ...
    {
        var __oldWidget = (_TimePickerModel__time_picker)oldWidget;
        return use24HourFormat != __oldWidget.use24HourFormat
            || (!Equals(entryMode, __oldWidget.entryMode))
            || (!Equals(hourMinuteMode, __oldWidget.hourMinuteMode))
            || (!Equals(onHourMinuteModeChanged, __oldWidget.onHourMinuteModeChanged))
            || (!Equals(onHourDoubleTapped, __oldWidget.onHourDoubleTapped))
            || (!Equals(onMinuteDoubleTapped, __oldWidget.onMinuteDoubleTapped))
            || (!Equals(hourDialType, __oldWidget.hourDialType))
            || (!Equals(selectedTime, __oldWidget.selectedTime))
            || (!Equals(onSelectedTimeChanged, __oldWidget.onSelectedTimeChanged))
            || (!Equals(orientation, __oldWidget.orientation))
...
internal class _DialTimePickerHeader__time_picker : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        DartRuntimePrimitives.Assert(() =>
            Time_pickerLibrary._debugDialTimePickerEntryMode(context)
        );
        TimeOfDayFormat timeOfDayFormatLocal = MaterialLocalizations
            .of(context)
            .timeOfDayFormat(
                alwaysUse24HourFormat: _TimePickerModel__time_picker.use24HourFormatOf(context)
            );
        _TimePickerDefaults__time_picker defaultTheme =
            _TimePickerModel__time_picker.defaultThemeOf(context);
        Orientation orientation = _TimePickerModel__time_picker.orientationOf(context);
        double dayPeriodHeight = Equals(orientation, Orientation.portrait)
            ? defaultTheme.dayPeriodPortraitSize.height
            : defaultTheme.dayPeriodLandscapeSize.height;
        double minInteractiveVerticalPadding = Equals(orientation, Orientation.portrait)
            ? Math.Max(
                0,
                (2L * Widgets.ConstantsLibrary.kMinInteractiveDimension) - dayPeriodHeight
            )
            : Math.Max(0, Widgets.ConstantsLibrary.kMinInteractiveDimension - dayPeriodHeight);
        _HourDialType__time_picker hourDialType = _TimePickerModel__time_picker.hourDialTypeOf(
            context
        );
        RenderObjectWidget orientationSpecificHeader = orientation switch
        {
            Orientation.portrait => DartRuntimePrimitives.ConvertValue<RenderObjectWidget>(
                new Column(
                    ...
                    children: new List<Widget>
                    {
                        DartRuntimePrimitives.ConvertValue<Widget>(
                            new Padding(
                                padding: EdgeInsetsDirectional.CreateOnly(
                                    bottom: 20L - (minInteractiveVerticalPadding / 2L)
                                ),
                                child: new Text(
                                    helpText,
                                    style: _TimePickerModel__time_picker
                                        .themeOf(context)
                                        .helpTextStyle
                        ...
                        DartRuntimePrimitives.ConvertValue<Widget>(
                            new Row(
                                textDirection: Equals(
                                    timeOfDayFormatLocal,
                                ...
                                children: (
                                    (Func<List<Widget>>)(
                                        () =>
                                        {
                                            var __collection10472 = new List<Widget>();
                                            __collection10472.Add(
                                                DartRuntimePrimitives.ConvertValue<Widget>(
                                                    new Expanded(
                                                        child: new Row(
                                                            ...
                                                            children: new List<Widget>
                                                            {
                                                                DartRuntimePrimitives.ConvertValue<Widget>(
                                                                    new Expanded(
                                                                        child: new _DialHourControl__time_picker()
                                                                    )
                                                                ),
                                                                DartRuntimePrimitives.ConvertValue<Widget>(
                                                                    new _TimeSelectorSeparator__time_picker(
                                                                        timeOfDayFormat: timeOfDayFormatLocal
                                                                    )
                                                                ),
                                                                DartRuntimePrimitives.ConvertValue<Widget>(
                                                                    new Expanded(
                                                                        child: new _DialMinuteControl__time_picker()
                                                                    )
                                                                ),
                                                            }
                                                        )
                                            ...
                                            if (
                                                Equals(
                                                    hourDialType,
                                                    _HourDialType__time_picker.twelveHour
                                                )
                                            )
                                            {
                                                __collection10472.Add(
                                                    DartRuntimePrimitives.ConvertValue<Widget>(
                                                        new _DayPeriodControl__time_picker()
                                                    )
                                                );
                                            }
                                            return __collection10472;
                                        }
                                    )
                                )()
                            )
            ...
            Orientation.landscape => DartRuntimePrimitives.ConvertValue<RenderObjectWidget>(
                new SizedBox(
                    width: Time_pickerLibrary._kTimePickerHeaderLandscapeWidth,
                    child: new Stack(
                        children: new List<Widget>
                        {
                            DartRuntimePrimitives.ConvertValue<Widget>(
                            ...
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                new Column(
                                    ...
                                    spacing: Math.Max(
                                        0,
                                        16L - (minInteractiveVerticalPadding / 2L)
                                    ),
                                    children: (
                                        (Func<List<Widget>>)(
                                            () =>
                                            {
                                                var __collection11810 = new List<Widget>();
                                                __collection11810.Add(
                                                    DartRuntimePrimitives.ConvertValue<Widget>(
                                                        new Row(
                                                            textDirection: TextDirection.ltr,
                                                            children: new List<Widget>
        ...
        return new Widgets.Semantics(
            label: MaterialLocalizations
                .of(context)
                .formatTimeOfDay(
                    _TimePickerModel__time_picker.selectedTimeOf(context),
...
internal class _DialTimeSelectorControl__time_picker : StatelessWidget
{
    ...
    internal _DialTimeSelectorControl__time_picker(
        string text,
        Action onTap,
        Action onDoubleTap,
        bool isSelected
    ...
    public override Widget build(BuildContext context)
    {
        ...
        var states = (
            (Func<HashSet<WidgetState>>)(
                () =>
                {
                    var __collection13567 = new HashSet<WidgetState>();
                    if (isSelected)
                    {
                        __collection13567.Add(WidgetState.selected);
                    }
                    return __collection13567;
                }
            )
        )();
        Color effectiveTextColor = WidgetStateProperty.resolveAs(
            _TimePickerModel__time_picker.themeOf(context).hourMinuteTextColor
                ?? _TimePickerModel__time_picker.defaultThemeOf(context).hourMinuteTextColor,
            states
        );
        TextStyle effectiveStyle = WidgetStateProperty
            .resolveAs(
...
internal class _DialHourControl__time_picker : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        string formattedNextHour = localizations.formatHour(
            nextHour,
            alwaysUse24HourFormat: alwaysUse24HourFormatLocal
        );
        ...
        return new Widgets.Semantics(
            ...
            child: new _DialTimeSelectorControl__time_picker(
                isSelected: Equals(
                    _TimePickerModel__time_picker.hourMinuteModeOf(context),
                    _HourMinuteMode__time_picker.hour
                ),
                text: formattedHour,
                onTap: () =>
                {
                    _TimePickerModel__time_picker.setHourMinuteMode(
                        context,
                        _HourMinuteMode__time_picker.hour
                    );
                },
                onDoubleTap: () =>
                    _TimePickerModel__time_picker
                        .of(context, _TimePickerAspect__time_picker.onHourDoubleTapped)
                        .onHourDoubleTapped()
            )
        );
        throw new InvalidOperationException("Control flow completed without returning a value.");
...
internal class _TimeSelectorSeparator__time_picker : StatelessWidget
{
    ...
    internal virtual string _timeSelectorSeparatorValue(TimeOfDayFormat timeOfDayFormat) =>
        timeOfDayFormat switch
        {
            TimeOfDayFormat.h_colon_mm_space_a
            or TimeOfDayFormat.a_space_h_colon_mm
            or TimeOfDayFormat.H_colon_mm => ":",
    ...
    public override Widget build(BuildContext context)
    {
        ...
        _TimePickerDefaults__time_picker defaultTheme = new _TimePickerDefaultsM3__time_picker(
            context
        );
        ...
        double heightLocal = _TimePickerModel__time_picker.entryModeOf(context) switch
        {
            TimePickerEntryMode.dial => defaultTheme.hourMinuteSize.height,
        ...
        return new ExcludeSemantics(
            child: new SizedBox(
                width: Equals(timeOfDayFormat, TimeOfDayFormat.frenchCanadian) ? 36 : 24,
                height: heightLocal,
                child: new Center(
                    child: new Text(
    ...
    public override Widget build(BuildContext context)
    {
        ...
        return new Widgets.Semantics(
            ...
            child: new _DialTimeSelectorControl__time_picker(
                isSelected: Equals(
                    _TimePickerModel__time_picker.hourMinuteModeOf(context),
                    _HourMinuteMode__time_picker.minute
                ),
                ...
                onDoubleTap: () =>
                    _TimePickerModel__time_picker
                        .of(context, _TimePickerAspect__time_picker.onMinuteDoubleTapped)
                        .onMinuteDoubleTapped()
            )
        );
        throw new InvalidOperationException("Control flow completed without returning a value.");
    ...
    public override Widget build(BuildContext context)
    {
        ...
        switch (_TimePickerModel__time_picker.entryModeOf(context))
        {
            ...
            case TimePickerEntryMode.dialOnly:
            {
                ...
                dayPeriodSize = orientationLocal switch
                {
        ...
        bool hasRoundedBorder =
            ...
            && (((RoundedRectangleBorder)resolvedShape).borderRadius is BorderRadius);
        switch (orientationLocal)
        {
            case Orientation.portrait:
            {
                if (hasRoundedBorder)
                {
                    var borderRadiusLocal = (
                        (BorderRadius?)((RoundedRectangleBorder)resolvedShape).borderRadius
                    )!;
                    amShape = DartRuntimePrimitives.ConvertValue<OutlinedBorder>(
                        ((RoundedRectangleBorder)resolvedShape).copyWith(
                            borderRadius: new BorderRadius(
                                topLeft: borderRadiusLocal.topLeft,
                                topRight: borderRadiusLocal.topRight
                            )
                        )
                    );
                    pmShape = DartRuntimePrimitives.ConvertValue<OutlinedBorder>(
                        ((RoundedRectangleBorder)resolvedShape).copyWith(
                            borderRadius: new BorderRadius(
                                bottomLeft: borderRadiusLocal.bottomLeft,
                                bottomRight: borderRadiusLocal.bottomRight
                            )
                        )
                    );
                }
                var minInteractiveSize = new Size(
                    dayPeriodSize.width,
                    Math.Max(
                        dayPeriodSize.height,
                        2L * Widgets.ConstantsLibrary.kMinInteractiveDimension
                    )
                );
                Widget amButton = new _AmPmButton__time_picker(
                    selected: amSelected,
                    onPressed: () =>
                    {
                        _setAm(context);
                    ...
                    padding: EdgeInsets.CreateOnly(
                        top: (minInteractiveSize.height - dayPeriodSize.height) / 2L
                    ),
                    shape: amShape
                );
                Widget pmButton = new _AmPmButton__time_picker(
                    selected: pmSelected,
                    onPressed: () =>
                    {
                        _setPm(context);
                    ...
                    padding: EdgeInsets.CreateOnly(
                        bottom: (minInteractiveSize.height - dayPeriodSize.height) / 2L
                    ),
                    shape: pmShape
                );
                return new _DayPeriodInputPadding__time_picker(
                    minSize: minInteractiveSize,
                    orientation: orientationLocal,
                    child: SizedBox.CreateFromSize(
                        size: minInteractiveSize,
                        child: new Column(
                            children: new List<Widget>
                            {
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Expanded(child: amButton)
                                ),
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Expanded(child: pmButton)
                                ),
                            }
                        )
                    )
            ...
            case Orientation.landscape:
            {
                if (hasRoundedBorder)
                {
                    var borderRadiusAlternate = (
                        (BorderRadius?)((RoundedRectangleBorder)resolvedShape).borderRadius
                    )!;
                    amShape = DartRuntimePrimitives.ConvertValue<OutlinedBorder>(
                        ((RoundedRectangleBorder)resolvedShape).copyWith(
                            borderRadius: new BorderRadius(
                                topLeft: borderRadiusAlternate.topLeft,
                                bottomLeft: borderRadiusAlternate.bottomLeft
                            )
                        )
                    );
                    pmShape = DartRuntimePrimitives.ConvertValue<OutlinedBorder>(
                        ((RoundedRectangleBorder)resolvedShape).copyWith(
                            borderRadius: new BorderRadius(
                                topRight: borderRadiusAlternate.topRight,
                                bottomRight: borderRadiusAlternate.bottomRight
                            )
                        )
                    );
                }
                var minInteractiveSizeLocal = new Size(
                    dayPeriodSize.width,
                    Math.Max(
                        dayPeriodSize.height,
                ...
                Widget amButtonLocal = new _AmPmButton__time_picker(
                    selected: amSelected,
                    onPressed: () =>
                    {
                        _setAm(context);
                    ...
                    padding: EdgeInsets.CreateSymmetric(
                        vertical: (minInteractiveSizeLocal.height - dayPeriodSize.height) / 2L
                    ),
                    shape: amShape
                );
                Widget pmButtonLocal = new _AmPmButton__time_picker(
                    selected: pmSelected,
                    onPressed: () =>
                    {
                        _setPm(context);
                ...
                return new _DayPeriodInputPadding__time_picker(
                    minSize: minInteractiveSizeLocal,
                    orientation: orientationLocal,
                    child: new SizedBox(
                        height: minInteractiveSizeLocal.height,
                        child: new Row(
                            children: new List<Widget>
                            {
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Expanded(child: amButtonLocal)
                                ),
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Expanded(child: pmButtonLocal)
                                ),
                            }
                        )
                    )
...
internal class _AmPmButton__time_picker : StatelessWidget
{
    ...
    internal _AmPmButton__time_picker(
        Action onPressed,
        bool selected,
        string label,
        EdgeInsets padding,
    ...
    public override Widget build(BuildContext context)
    {
        var states = (
            (Func<HashSet<WidgetState>>)(
                () =>
                {
                    var __collection28792 = new HashSet<WidgetState>();
                    if (selected)
                    {
                        __collection28792.Add(WidgetState.selected);
                    }
                    return __collection28792;
                }
            )
        )();
        TimePickerThemeData timePickerTheme = _TimePickerModel__time_picker.themeOf(context);
        _TimePickerDefaults__time_picker defaultTheme =
            _TimePickerModel__time_picker.defaultThemeOf(context);
        Color resolvedBackgroundColor = WidgetStateProperty.resolveAs(
            timePickerTheme.dayPeriodColor ?? defaultTheme.dayPeriodColor,
            states
        );
        Color resolvedTextColor = WidgetStateProperty.resolveAs(
            timePickerTheme.dayPeriodTextColor ?? defaultTheme.dayPeriodTextColor,
            states
        );
        TextStyle? resolvedTextStyle = WidgetStateProperty
            .resolveAs<TextStyle?>(
        ...
        return new Widgets.Semantics(
            selected: Equals(PlatformLibrary.defaultTargetPlatform, TargetPlatform.iOS)
                ? selected
                : null,
            @checked: Equals(PlatformLibrary.defaultTargetPlatform, TargetPlatform.iOS)
                ? null
                : selected,
...
internal class _DayPeriodInputPadding__time_picker : SingleChildRenderObjectWidget
{
    ...
    internal _DayPeriodInputPadding__time_picker(
        Widget child,
        Size minSize,
        Orientation orientation
    )
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<_RenderInputPadding__time_picker>)(
                    () =>
                    {
...
public class _RenderInputPadding__time_picker : RenderShiftedBox
{
    ...
    internal _RenderInputPadding__time_picker(
        Size _minSize,
    ...
    public override bool hitTest(BoxHitTestResult result, Offset position)
    {
        ...
        newPosition += orientation switch
        {
            Orientation.portrait when position.dy > newPosition.dy => new Offset(0, 1),
            Orientation.landscape when position.dx > newPosition.dx => new Offset(1, 0),
...
public class _DialPainter__time_picker : CustomPainter
{
    ...
    public virtual List<_TappableLabel__time_picker> selectedLabels { get; private set; } =
        default!;
    ...
    internal _DialPainter__time_picker(
        List<_TappableLabel__time_picker> primaryLabels,
        List<_TappableLabel__time_picker> selectedLabels,
        ...
        : base(repaint: PaintingBinding.instance.systemFonts)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            Foundation.DebugLibrary.debugMaybeDispatchCreated("material", "_DialPainter", this)
        );
    }
    ...
    public override bool shouldRepaint(CustomPainter oldDelegate)
    {
        ...
        return (!Equals(__oldPainter.primaryLabels, primaryLabels))
            || (!Equals(__oldPainter.selectedLabels, selectedLabels))
...
public class _Dial__time_picker : StatefulWidget
{
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _DialState__time_picker());
}

public class _DialState__time_picker
    : State<_Dial__time_picker>,
        SingleTickerProviderStateMixin<_Dial__time_picker>
{
    ...
    internal static List<TimeOfDay> _amHours = new List<TimeOfDay>
    {
        new TimeOfDay(hour: 12L, minute: 0L),
        new TimeOfDay(hour: 1L, minute: 0L),
        new TimeOfDay(hour: 2L, minute: 0L),
        new TimeOfDay(hour: 3L, minute: 0L),
        new TimeOfDay(hour: 4L, minute: 0L),
        new TimeOfDay(hour: 5L, minute: 0L),
        new TimeOfDay(hour: 6L, minute: 0L),
        new TimeOfDay(hour: 7L, minute: 0L),
        new TimeOfDay(hour: 8L, minute: 0L),
        new TimeOfDay(hour: 9L, minute: 0L),
        new TimeOfDay(hour: 10L, minute: 0L),
        new TimeOfDay(hour: 11L, minute: 0L),
    };
    internal static List<TimeOfDay> _twentyFourHours = new List<TimeOfDay>
    {
        new TimeOfDay(hour: 0L, minute: 0L),
        new TimeOfDay(hour: 1L, minute: 0L),
        new TimeOfDay(hour: 2L, minute: 0L),
        new TimeOfDay(hour: 3L, minute: 0L),
        new TimeOfDay(hour: 4L, minute: 0L),
        ...
        new TimeOfDay(hour: 11L, minute: 0L),
        new TimeOfDay(hour: 12L, minute: 0L),
        new TimeOfDay(hour: 13L, minute: 0L),
        new TimeOfDay(hour: 14L, minute: 0L),
        new TimeOfDay(hour: 15L, minute: 0L),
        new TimeOfDay(hour: 16L, minute: 0L),
        new TimeOfDay(hour: 17L, minute: 0L),
        new TimeOfDay(hour: 18L, minute: 0L),
        new TimeOfDay(hour: 19L, minute: 0L),
        new TimeOfDay(hour: 20L, minute: 0L),
        new TimeOfDay(hour: 21L, minute: 0L),
        new TimeOfDay(hour: 22L, minute: 0L),
        new TimeOfDay(hour: 23L, minute: 0L),
    };
    ...
    public override void initState()
    {
        ...
        _animationController = new AnimationController(
            duration: Time_pickerLibrary._kDialAnimateDuration,
            vsync: this
        );
            ...
            (Func<Animation<double>>)(
                () =>
                {
                    var __cascade = _animationController
                        .drive(new CurveTween(curve: CurvesLibrary.standardEasing))
                        .drive(_thetaTween);
    ...
    public override void didUpdateWidget(_Dial__time_picker oldWidget)
    {
        ...
        if (
            (!Equals(widget.hourMinuteMode, oldWidget.hourMinuteMode))
            || (!Equals(widget.selectedTime, oldWidget.selectedTime))
        )
        {
            if (!_dragging)
            {
    ...
    internal virtual void _animateTo(double targetTheta, double targetRadius)
    {
        ...
        animateToValue(
            ...
            min: _theta.value - Time_pickerLibrary._kTwoPi,
            max: _theta.value + Time_pickerLibrary._kTwoPi
        );
        animateToValue(
            target: targetRadius,
            animation: _radius,
    ...
    internal virtual double _getRadiusForTime(TimeOfDay time)
    {
        switch (widget.hourMinuteMode)
        {
            ...
            {
                return widget.hourDialType switch
                {
                    _HourDialType__time_picker.twentyFourHourDoubleRing => (time.hour >= 12L)
                        ? 0
                        : 1,
    ...
    {
        long hoursFactor = widget.hourDialType switch
        {
    ...
    {
        TimeOfDay current = _getTimeForTheta(
            _theta.value,
        ...
        setState(() =>
        {
            ...
            if (roundMinutes)
            {
                angle = _getThetaForTime(
                    _getTimeForTheta(angle, roundMinutes: roundMinutes, radius: radiusLocal)
                );
            }
            DartRuntimePrimitives.Ignore(
                (
    ...
    internal virtual void _selectHour(long hour)
    {
        ...
        {
            return widget.selectedTime.period switch
            {
                DayPeriod.am => new TimeOfDay(hour: hour, minute: widget.selectedTime.minute),
                DayPeriod.pm => new TimeOfDay(
    ...
    internal virtual _TappableLabel__time_picker _buildTappableLabel(
        TextStyle? textStyle,
        long selectedValue,
        long value,
        bool inner,
    ...
    {
        return new _TappableLabel__time_picker(
            value: value,
            inner: inner,
            painter: (
                (Func<TextPainter>)(
    ...
    {
        return (
            (Func<List<_TappableLabel__time_picker>>)(
                () =>
                {
                    var __collection52599 = new List<_TappableLabel__time_picker>();
                    {
                        ...
                        {
                            __collection52599.Add(
                                _buildTappableLabel(
                                    textStyle: textStyle,
                                    selectedValue: selectedValue,
                                    inner: timeOfDay.hour >= 12L,
                                    value: timeOfDay.hour,
                                    label: (timeOfDay.hour != 0L)
    ...
    internal virtual List<_TappableLabel__time_picker> _build12HourRing(
        TextStyle? textStyle,
        long selectedValue
    )
    {
        return (
            (Func<List<_TappableLabel__time_picker>>)(
                () =>
                {
                    var __collection53903 = new List<_TappableLabel__time_picker>();
                    foreach (var timeOfDay in _amHours)
                    {
                        __collection53903.Add(
                            _buildTappableLabel(
                                textStyle: textStyle,
                                selectedValue: selectedValue,
                                inner: false,
    ...
    {
        var minuteMarkerValues = new List<TimeOfDay>
        {
            new TimeOfDay(hour: 0L, minute: 0L),
            new TimeOfDay(hour: 0L, minute: 5L),
            new TimeOfDay(hour: 0L, minute: 10L),
            new TimeOfDay(hour: 0L, minute: 15L),
            new TimeOfDay(hour: 0L, minute: 20L),
            new TimeOfDay(hour: 0L, minute: 25L),
            new TimeOfDay(hour: 0L, minute: 30L),
            new TimeOfDay(hour: 0L, minute: 35L),
            new TimeOfDay(hour: 0L, minute: 40L),
            new TimeOfDay(hour: 0L, minute: 45L),
            new TimeOfDay(hour: 0L, minute: 50L),
            new TimeOfDay(hour: 0L, minute: 55L),
        };
        return (
            (Func<List<_TappableLabel__time_picker>>)(
                () =>
                {
                    var __collection55004 = new List<_TappableLabel__time_picker>();
                    foreach (var timeOfDay in minuteMarkerValues)
                    {
                        __collection55004.Add(
                            _buildTappableLabel(
                                textStyle: textStyle,
                                selectedValue: selectedValue,
                                inner: false,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Color dialTextUnselectedColor = WidgetStateProperty.resolveAs(
            timePickerTheme.dialTextColor ?? defaultTheme.dialTextColor,
            new HashSet<WidgetState>()
        );
        Color dialTextSelectedColor = WidgetStateProperty.resolveAs(
            timePickerTheme.dialTextColor ?? defaultTheme.dialTextColor,
            new HashSet<WidgetState> { WidgetState.selected }
        );
        TextStyle resolvedUnselectedLabelStyle = labelStyle.copyWith(
        ...
        switch (widget.hourMinuteMode)
        {
            case _HourMinuteMode__time_picker.hour:
            {
                switch (widget.hourDialType)
                {
                    case _HourDialType__time_picker.twentyFourHourDoubleRing:
                    {
                        ...
                        primaryLabelsLocal = _build24HourRing(
                            textStyle: resolvedUnselectedLabelStyle,
                            selectedValue: selectedDialValue
                        );
                        selectedLabelsLocal = _build24HourRing(
                    ...
                    case _HourDialType__time_picker.twelveHour:
                    {
                        ...
                        primaryLabelsLocal = _build12HourRing(
                            textStyle: resolvedUnselectedLabelStyle,
                            selectedValue: selectedDialValue
                        );
                        selectedLabelsLocal = _build12HourRing(
                            textStyle: resolvedSelectedLabelStyle,
                            selectedValue: selectedDialValue
                        );
                        radiusValue = 1;
            ...
            case _HourMinuteMode__time_picker.minute:
            {
                ...
                primaryLabelsLocal = _buildMinutes(
                    textStyle: resolvedUnselectedLabelStyle,
                    selectedValue: selectedDialValue
                );
                selectedLabelsLocal = _buildMinutes(
                    textStyle: resolvedSelectedLabelStyle,
                    selectedValue: selectedDialValue
                );
                radiusValue = 1;
        ...
        painter = new _DialPainter__time_picker(
            selectedValue: selectedDialValue,
            primaryLabels: primaryLabelsLocal,
            selectedLabels: selectedLabelsLocal,
            backgroundColor: backgroundColorLocal,
            handColor: dialHandColorLocal,
            handWidth: defaultTheme.handWidth,
            dotColor: dotColorLocal,
...
internal class _TimePickerInput__time_picker : StatefulWidget
{
    ...
    internal _TimePickerInput__time_picker(
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _TimePickerInputState__time_picker());
}

internal class _TimePickerInputState__time_picker
    : State<_TimePickerInput__time_picker>,
        RestorationMixin<_TimePickerInput__time_picker>
{
    ...
    internal virtual long? _parseMinute(string? value)
    {
        ...
        long? newMinute = DartRuntimePrimitives.ConvertValue<long?>(
            Dart_coreLibrary.tryParse(value)
        );
    ...
    public override Widget build(BuildContext context)
    {
        ...
        var use24HourDials = !Equals(
            TimeLibrary.hourFormat(of: timeOfDayFormatLocal),
            HourFormat.h
        );
        ThemeData theme = Theme.of(context);
        TimePickerThemeData timePickerTheme = _TimePickerModel__time_picker.themeOf(context);
        _TimePickerDefaults__time_picker defaultTheme =
            _TimePickerModel__time_picker.defaultThemeOf(context);
        TextStyle hourMinuteStyle =
            timePickerTheme.hourMinuteTextStyle ?? defaultTheme.hourMinuteTextStyle;
        double minInteractiveVerticalPadding = Math.Max(
            0,
            (2L * Widgets.ConstantsLibrary.kMinInteractiveDimension)
                - defaultTheme.dayPeriodInputSize.height
        );
        return new Padding(
            ...
            child: new Column(
                ...
                children: (
                    (Func<List<Widget>>)(
                        () =>
                        {
                            var __collection65491 = new List<Widget>();
                            __collection65491.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Padding(
                                        padding: EdgeInsetsDirectional.CreateOnly(
                                            bottom: 20L - (minInteractiveVerticalPadding / 2L)
                                    ...
                                    new Row(
                                        ...
                                        children: (
                                            (Func<List<Widget>>)(
                                                () =>
                                                {
                                                    var __collection66075 = new List<Widget>();
                                                    if (
                                                        !use24HourDials
                                                        && Equals(
                                                            timeOfDayFormatLocal,
                                                            ...
                                                            new List<Widget>
                                                            {
                                                                DartRuntimePrimitives.ConvertValue<Widget>(
                                                                    new Padding(
                                                                        ...
                                                                        child: new _DayPeriodControl__time_picker(
                                                    ...
                                                    __collection66075.Add(
                                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                                            new Expanded(
                                                                child: new Padding(
                                                                    padding: EdgeInsetsDirectional.CreateOnly(
                                                                        top: minInteractiveVerticalPadding
                                                                            / 2L
                                                                    ),
                                                                    child: new Row(
                                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                                                    ...
                                                                                    child: new Column(
                                                                                        ...
                                                                                        children: (
                                                                                            ...
                                                                                            >)(
                                                                                                () =>
                                                                                                {
                                                                                                    var __collection67027 =
                                                                                                        new List<Widget>();
                                                                                                    __collection67027.Add(
                                                                                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                                                                                            new Padding(
                                                                                                                padding: EdgeInsets.CreateOnly(
                                                                                                                    bottom: 10
                                                                                                                ),
                                                                                                                child: new _HourTextField__time_picker(
                                                                                    ...
                                                                                    child: new Column(
                                                                                        ...
                                                                                        children: (
                                                                                            ...
                                                                                            >)(
                                                                                                () =>
                                                                                                {
                                                                                                    var __collection68842 =
                                                                                                        new List<Widget>();
                                                                                                    __collection68842.Add(
                                                                                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                                                                                            new Padding(
                                                                                                                padding: EdgeInsets.CreateOnly(
                                                                                                                    bottom: 10
                                                                                                                ),
                                                                                                                child: new _MinuteTextField__time_picker(
...
internal class _HourTextField__time_picker : StatelessWidget
{
    ...
    internal _HourTextField__time_picker(
        TimeOfDay selectedTime,
        TextStyle style,
        bool? autofocus,
    ...
    public override Widget build(BuildContext context)
    {
        return new _HourMinuteTextField__time_picker(
...
internal class _MinuteTextField__time_picker : StatelessWidget
{
    ...
    internal _MinuteTextField__time_picker(
        TimeOfDay selectedTime,
        TextStyle style,
        bool? autofocus,
        TextInputAction inputAction,
...
internal class _HourMinuteTextField__time_picker : StatefulWidget
{
    ...
    internal _HourMinuteTextField__time_picker(
        TimeOfDay selectedTime,
        bool isHour,
        bool? autofocus,
        TextInputAction inputAction,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _HourMinuteTextFieldState__time_picker());
}

internal class _HourMinuteTextFieldState__time_picker
    : State<_HourMinuteTextField__time_picker>,
        RestorationMixin<_HourMinuteTextField__time_picker>
{
    public virtual RestorableTextEditingController controller { get; private set; } =
        RestorableTextEditingController.Create();
    public virtual RestorableBool controllerHasBeenSet { get; private set; } =
                    ...
                    __cascade.addListener(() =>
                    {
                        setState(() =>
                        {
                            if (
                                ...
                                && focusNode.hasFocus
                                && (Focus_managerLibrary.primaryFocus?.context is not null)
                            )
                            {
                                Actions.maybeInvoke(
    ...
    public override Widget build(BuildContext context)
    {
        ...
        InputDecorationThemeData inputDecorationThemeLocal =
        ...
        ).applyDefaults(inputDecorationThemeLocal);
        string? hintTextLocal =
            (focusNode.hasFocus || widget.emptyInitialTime) ? null : _formattedValue;
        Color startingFillColor =
            (timePickerTheme.inputDecorationTheme?.fillColor ?? timePickerTheme.hourMinuteColor)
            ?? defaultTheme.hourMinuteColor;
        Color fillColorLocal = default!;
        {
            fillColorLocal = WidgetStateProperty.resolveAs(
                startingFillColor,
                (
                    (Func<HashSet<WidgetState>>)(
                        () =>
                        {
                            var __collection78509 = new HashSet<WidgetState>();
                            if (focusNode.hasFocus)
                            {
                                __collection78509.Add(WidgetState.focused);
                            }
                            if (focusNode.hasFocus)
                            {
                                __collection78509.Add(WidgetState.selected);
                            }
                            return __collection78509;
                        }
                    )
                )()
            );
        ...
        inputDecoration = inputDecoration.copyWith(
            ...
            fillColor: fillColorLocal
        );
        var states = (
            (Func<HashSet<WidgetState>>)(
                () =>
                {
                    var __collection78850 = new HashSet<WidgetState>();
                    if (focusNode.hasFocus)
                    {
                        __collection78850.Add(WidgetState.focused);
                    }
                    if (focusNode.hasFocus)
                    {
                        __collection78850.Add(WidgetState.selected);
                    }
                    return __collection78850;
                }
            )
        )();
        Color effectiveTextColor = WidgetStateProperty.resolveAs(
        ...
        TextStyle effectiveStyle = WidgetStateProperty
            .resolveAs(widget.style, states)
            .copyWith(color: effectiveTextColor);
        return SizedBox.CreateFromSize(
                ...
                child: new UnmanagedRestorationScope(
                    ...
                    child: new Widgets.Semantics(
                        ...
                        child: new TextFormField(
                            ...
                            {
                                new LengthLimitingTextInputFormatter(2L),
                            },
                            focusNode: focusNode,
...
public class TimePickerDialog : StatefulWidget
{
    ...
    public TimePickerDialog(
        ...
        Action<TimePickerEntryMode>? onEntryModeChanged = null,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _TimePickerDialogState__time_picker());
}

internal class _TimePickerDialogState__time_picker
    : State<TimePickerDialog>,
        RestorationMixin<TimePickerDialog>
{
    ...
    internal virtual RestorableEnum<TimePickerEntryMode> _entryMode
    {
        get
        {
            ...
            {
                __late__entryMode = new RestorableEnum<TimePickerEntryMode>(
                    widget.initialEntryMode,
                    values: Enum.GetValues<TimePickerEntryMode>()
                        .ToList()
                        .Cast<TimePickerEntryMode>()
                );
    ...
    internal virtual RestorableEnum<AutovalidateMode> _autovalidateMode { get; private set; } =
        new RestorableEnum<AutovalidateMode>(
            AutovalidateMode.disabled,
            values: Enum.GetValues<AutovalidateMode>().ToList().Cast<AutovalidateMode>()
        );
    ...
    internal virtual RestorableEnumN<Orientation> _orientation
    {
        get
        {
            ...
            {
                __late__orientation = new RestorableEnumN<Orientation>(
                    widget.orientation,
                    values: Enum.GetValues<Orientation>().ToList().Cast<Orientation>()
                );
    ...
    {
        if (
            Equals(_entryMode.value, TimePickerEntryMode.input)
            || Equals(_entryMode.value, TimePickerEntryMode.inputOnly)
        )
        {
    ...
    internal virtual Size _minDialogSize(BuildContext context)
    {
        ...
        switch (_entryMode.value)
        {
            ...
            {
                MaterialLocalizations localizations = MaterialLocalizations.of(context);
                TimeOfDayFormat timeOfDayFormatLocal = localizations.timeOfDayFormat(
                    alwaysUse24HourFormat: MediaQuery.alwaysUse24HourFormatOf(context)
                );
                ...
                switch (timeOfDayFormatLocal)
                {
                    ...
                    {
                        _TimePickerDefaults__time_picker defaultTheme =
                            new _TimePickerDefaultsM3__time_picker(context);
                        timePickerWidth =
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Color entryModeIconColorLocal =
            pickerTheme.entryModeIconColor ?? defaultTheme.entryModeIconColor;
        MaterialLocalizations localizations = MaterialLocalizations.of(context);
        Widget actions = new Padding(
            padding: EdgeInsetsDirectional.CreateOnly(start: 0),
            child: new Row(
                children: (
                    (Func<List<Widget>>)(
                        () =>
                        {
                            var __collection92775 = new List<Widget>();
                            if (
                                Equals(_entryMode.value, TimePickerEntryMode.dial)
                                || Equals(_entryMode.value, TimePickerEntryMode.input)
                            )
                            {
                                __collection92775.Add(
                                    DartRuntimePrimitives.ConvertValue<Widget>(
                                        new IconButton(
                                            color: null,
                                            style: IconButton.styleFrom(
                                                foregroundColor: entryModeIconColorLocal
                                            ),
                                            onPressed: _toggleEntryMode,
                                            icon: Equals(_entryMode.value, TimePickerEntryMode.dial)
                                                ? (
                                                    widget.switchToInputEntryModeIcon
                                                    ?? new Icon(Icons.keyboard_outlined)
                                                )
                                                : (
                                ...
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Expanded(
                                        child: new ConstrainedBox(
                                            constraints: new BoxConstraints(minHeight: 36),
                                            child: new Align(
        ...
        Offset tapTargetSizeOffset = theme.materialTapTargetSize switch
        {
            var __constant95285 when Equals(__constant95285, MaterialTapTargetSize.padded) =>
                Offset.zero,
        ...
        return new Dialog(
            ...
            insetPadding: EdgeInsets.CreateSymmetric(
                horizontal: 16,
                vertical: (
                    Equals(_entryMode.value, TimePickerEntryMode.input)
                    || Equals(_entryMode.value, TimePickerEntryMode.inputOnly)
                        ...
                        return new SingleChildScrollView(
                            ...
                            child: new SingleChildScrollView(
                                ...
                                child: new AnimatedContainer(
                                    ...
                                    duration: Time_pickerLibrary._kDialogSizeAnimationDuration,
                                    curve: Curves.easeIn,
                                        ...
                                        children: new List<Widget>
                                        {
                                            DartRuntimePrimitives.ConvertValue<Widget>(
                                                new Builder(
                                                    builder: (context) =>
                                                    {
                                                        Widget childLocal = new Form(
                                                            key: _formKey,
                                                            autovalidateMode: _autovalidateMode.value,
                                                            child: new _TimePicker__time_picker(
...
public class _TimePicker__time_picker : StatefulWidget
{
    ...
    internal _TimePicker__time_picker(
        TimeOfDay time,
        ...
        Icon? switchToInputEntryModeIcon = null,
        Icon? switchToTimerEntryModeIcon = null,
        bool emptyInitialInput = default!
    )
    {
        this.time = time;
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _TimePickerState__time_picker());
}

internal class _TimePickerState__time_picker
    : State<_TimePicker__time_picker>,
        RestorationMixin<_TimePicker__time_picker>
{
    internal virtual Timer? _vibrateTimer { get; set; } = default;
    public virtual MaterialLocalizations localizations { get; set; } = default!;
    internal virtual RestorableEnum<_HourMinuteMode__time_picker> _hourMinuteMode
    {
        get;
        private set;
    } =
        new RestorableEnum<_HourMinuteMode__time_picker>(
            _HourMinuteMode__time_picker.hour,
            values: Enum.GetValues<_HourMinuteMode__time_picker>()
                .ToList()
                .Cast<_HourMinuteMode__time_picker>()
        );
    internal virtual RestorableEnumN<_HourMinuteMode__time_picker> _lastModeAnnounced
    {
        get;
        private set;
    } =
        new RestorableEnumN<_HourMinuteMode__time_picker>(
            null,
            values: Enum.GetValues<_HourMinuteMode__time_picker>()
                .ToList()
                .Cast<_HourMinuteMode__time_picker>()
        );
    internal virtual RestorableBoolN _autofocusHour { get; private set; } =
        new RestorableBoolN(null);
    internal virtual RestorableBoolN _autofocusMinute { get; private set; } =
        new RestorableBoolN(null);
    private bool __late__orientation_initialized;
    private RestorableEnumN<Orientation> __late__orientation = default!;
    internal virtual RestorableEnumN<Orientation> _orientation
    ...
    internal virtual void _vibrate()
    {
        switch (Theme.of(context).platform)
        {
            ...
            {
                _vibrateTimer?.cancel();
                _vibrateTimer = new Timer(
                    Time_pickerLibrary._kVibrateCommitDelay,
                    () =>
                    {
    ...
    public override Widget build(BuildContext context)
    {
        ...
        _TimePickerDefaults__time_picker defaultThemeLocal = new _TimePickerDefaultsM3__time_picker(
            context,
        ...
        _HourDialType__time_picker hourMode = timeOfDayHour switch
        {
        ...
        switch (widget.entryMode)
        {
            ...
            case TimePickerEntryMode.dialOnly:
            {
                ...
                double portraitMinInteractiveVerticalAdjustment = Math.Max(
                    0,
                    (2L * Widgets.ConstantsLibrary.kMinInteractiveDimension)
                        - defaultThemeLocal.dayPeriodPortraitSize.height
                );
                EdgeInsetsGeometry dialPadding = orientationLocal switch
                {
                    Orientation.portrait => DartRuntimePrimitives.ConvertValue<EdgeInsetsGeometry>(
                        EdgeInsets.CreateOnly(
                            left: 12,
                            right: 12,
                            top: 36L - (portraitMinInteractiveVerticalAdjustment / 2L)
                        )
                    ),
                    Orientation.landscape => DartRuntimePrimitives.ConvertValue<EdgeInsetsGeometry>(
                ...
                Widget dialLocal = new Padding(
                    ...
                    child: new ExcludeSemantics(
                        child: SizedBox.CreateFromSize(
                            size: defaultThemeLocal.dialSize,
                ...
                switch (orientationLocal)
                {
                    case Orientation.portrait:
                    {
                        picker = DartRuntimePrimitives.ConvertValue<Widget>(
                            new Column(
                                mainAxisSize: MainAxisSize.min,
                                crossAxisAlignment: CrossAxisAlignment.stretch,
                                children: new List<Widget>
                                {
                                    DartRuntimePrimitives.ConvertValue<Widget>(
                                        new Padding(
                                            padding: EdgeInsets.CreateSymmetric(horizontal: 0),
                                            child: new _DialTimePickerHeader__time_picker(
                                        ...
                                        new Expanded(
                                            child: new Padding(
                                                ...
                                                child: new Row(
                                                    ...
                                                    {
                                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                                            new _DialTimePickerHeader__time_picker(
                                                                helpText: helpTextLocal
                                                            )
                                                        ),
                                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                                            new Expanded(child: dialLocal)
                                                        ),
                                                    }
                                                )
                                            )
            ...
            case TimePickerEntryMode.inputOnly:
            {
                ...
                picker = DartRuntimePrimitives.ConvertValue<Widget>(
                    new Column(
                        ...
                        {
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                new _TimePickerInput__time_picker(
                                    initialSelectedTime: _selectedTime.value,
                                    errorInvalidText: widget.errorInvalidText,
                                    hourLabelText: widget.hourLabelText,
                                    minuteLabelText: widget.minuteLabelText,
                                    helpText: helpTextAlternate,
        ...
        return new _TimePickerModel__time_picker(
            ...
            defaultTheme: defaultThemeLocal,
            child: picker
        );
    }
...
public static partial class Time_pickerLibrary
{
    public static async Future<TimeOfDay?> showTimePicker(
        BuildContext context,
    ...
    )
    {
        ...
        return await DialogLibrary.showDialog<TimeOfDay>(
            context: context,
...
internal class _TimePickerDefaultsM3__time_picker : _TimePickerDefaults__time_picker
{
    ...
    internal _TimePickerDefaultsM3__time_picker(
        BuildContext context,
        TimePickerEntryMode entryMode = TimePickerEntryMode.dial
    )
    {
    ...
    {
        get { return _colors.surfaceContainerHigh; }
    }
    ...
    {
        get { return new BorderSide(color: _colors.outline); }
    }
    ...
    {
        get { return new Size(52, 80); }
    }
    public override Size dayPeriodLandscapeSize
    {
        get { return new Size(216, 38); }
    }
    public override Size dayPeriodInputSize
    {
        get { return new Size(dayPeriodPortraitSize.width, dayPeriodPortraitSize.height - 8L); }
    }
    ...
    {
        get { return _textTheme.titleMedium!.copyWith(color: dayPeriodTextColor); }
    }
    public override Color dialBackgroundColor
    {
        get { return _colors.surfaceContainerHighest; }
    }
    public override Color dialHandColor
    {
        get { return _colors.primary; }
    }
    public override Size dialSize
    {
        get { return new Size(256.0); }
    }
    public override double handWidth
    {
        get { return new Size(2, double.PositiveInfinity).width; }
    }
    public override double dotRadius
    {
        get { return new Size(48.0).width / 2L; }
    }
    public override double centerRadius
    {
        get { return new Size(8.0).width / 2L; }
    }
    ...
    {
        get { return _textTheme.bodyLarge!; }
    }
    ...
    {
        get { return _colors.onSurface; }
    }
    public override TextStyle helpTextStyle
    {
        get
        {
            return WidgetStateTextStyle.CreateResolveWith(
                (states) =>
                {
    ...
    {
        get { return EdgeInsets.CreateAll(24); }
    }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (states.Contains(WidgetState.focused))
                                {
                                    ...
                                    overlayColor = _colors.onPrimaryContainer.withOpacity(
                                        focusOpacity
                                    );
                                }
                            }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (states.Contains(WidgetState.hovered))
                            {
                                ...
                                overlayColorLocal = _colors.onSurface.withOpacity(
                                    hoverOpacityLocal
                                );
                            }
                            else
    ...
    {
        get { return new Size(hourMinuteSize.width, hourMinuteSize.height - 8L); }
    }
    public override Size hourMinuteInputSize24Hour
    {
        get { return new Size(hourMinuteSize24Hour.width, hourMinuteSize24Hour.height - 8L); }
    }
        ...
        get
        {
            return WidgetStateTextStyle.CreateResolveWith(
                (states) =>
                {
                    ...
                    {
                        TimePickerEntryMode.dial => _textTheme.displayLarge!.copyWith(
                            color: _hourMinuteTextColor.resolve(states)
                        ),
                        TimePickerEntryMode.dialOnly => _textTheme.displayLarge!.copyWith(
                            color: _hourMinuteTextColor.resolve(states)
                        ),
                        TimePickerEntryMode.input => _textTheme.displayMedium!.copyWith(
                            color: _hourMinuteTextColor.resolve(states)
                        ),
                        TimePickerEntryMode.inputOnly => _textTheme.displayMedium!.copyWith(
                            color: _hourMinuteTextColor.resolve(states)
                        ),
                        _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard =>
                            throw new InvalidOperationException(
    ...
    public override InputDecorationThemeData inputDecorationTheme
    {
        get
        {
            BorderRadius selectorRadius = new RoundedRectangleBorder(
                borderRadius: BorderRadius.CreateAll(Radius.circular(8.0))
            ...
            return new InputDecorationThemeData(
                ...
                errorBorder: new OutlineInputBorder(
                    borderRadius: selectorRadius,
                    borderSide: new BorderSide(color: _colors.error, width: 2)
                ),
                focusedBorder: new OutlineInputBorder(
                    borderRadius: selectorRadius,
                    borderSide: new BorderSide(color: _colors.primary, width: 2)
                ),
    ...
    public override WidgetStateProperty<Color?>? timeSelectorSeparatorColor
    {
        get
        {
            return (WidgetStateProperty<Color?>?)
                new WidgetStatePropertyAll<Color>(_colors.onSurface);
        }
    }
    public override WidgetStateProperty<TextStyle?>? timeSelectorSeparatorTextStyle
    {
        get
        {
            return (WidgetStateProperty<TextStyle?>?)
                new WidgetStatePropertyAll<TextStyle?>(_textTheme.displayLarge);
        }
    }
}
