...
internal class _DesktopTextSelectionHandleControls__desktop_text_selection
...
{
    public static TextSelectionControls desktopTextSelectionHandleControls =
        new _DesktopTextSelectionHandleControls__desktop_text_selection();
}

public static partial class Desktop_text_selectionLibrary
{
    public static TextSelectionControls desktopTextSelectionControls =
        new DesktopTextSelectionControls();
}
...
public class _DesktopTextSelectionControlsToolbar__desktop_text_selection : StatefulWidget
{
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _DesktopTextSelectionControlsToolbarState__desktop_text_selection()
        );
}

public class _DesktopTextSelectionControlsToolbarState__desktop_text_selection
    : State<_DesktopTextSelectionControlsToolbar__desktop_text_selection>
{
    ...
    public override void didUpdateWidget(
        _DesktopTextSelectionControlsToolbar__desktop_text_selection oldWidget
    )
    {
    ...
    public override Widget build(BuildContext context)
    {
        ...
        {
            items.Add(
                DesktopTextSelectionToolbarButton.CreateText(
                    context: context,
                    onPressed: () => onPressed(),
                    text: text
                )
