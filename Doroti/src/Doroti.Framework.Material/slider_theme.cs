...
public class SliderTheme : global::Doroti.Framework.Widgets.InheritedTheme
{
    ...
    public override bool updateShouldNotify(global::Doroti.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((SliderTheme)oldWidget).data));
}
...
public class SliderThemeData : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    public static SliderThemeData lerp(SliderThemeData a, SliderThemeData b, double t)
    {
        ...
        return new SliderThemeData(trackHeight: Dart_uiLibrary.lerpDouble(a.trackHeight, b.trackHeight, t), activeTrackColor: Dart_uiLibrary.Color.lerp(a.activeTrackColor, b.activeTrackColor, t), inactiveTrackColor: Dart_uiLibrary.Color.lerp(a.inactiveTrackColor, b.inactiveTrackColor, t), secondaryActiveTrackColor: Dart_uiLibrary.Color.lerp(a.secondaryActiveTrackColor, b.secondaryActiveTrackColor, t), disabledActiveTrackColor: Dart_uiLibrary.Color.lerp(a.disabledActiveTrackColor, b.disabledActiveTrackColor, t), disabledInactiveTrackColor: Dart_uiLibrary.Color.lerp(a.disabledInactiveTrackColor, b.disabledInactiveTrackColor, t), disabledSecondaryActiveTrackColor: Dart_uiLibrary.Color.lerp(a.disabledSecondaryActiveTrackColor, b.disabledSecondaryActiveTrackColor, t), activeTickMarkColor: Dart_uiLibrary.Color.lerp(a.activeTickMarkColor, b.activeTickMarkColor, t), inactiveTickMarkColor: Dart_uiLibrary.Color.lerp(a.inactiveTickMarkColor, b.inactiveTickMarkColor, t), disabledActiveTickMarkColor: Dart_uiLibrary.Color.lerp(a.disabledActiveTickMarkColor, b.disabledActiveTickMarkColor, t), disabledInactiveTickMarkColor: Dart_uiLibrary.Color.lerp(a.disabledInactiveTickMarkColor, b.disabledInactiveTickMarkColor, t), thumbColor: Dart_uiLibrary.Color.lerp(a.thumbColor, b.thumbColor, t), overlappingShapeStrokeColor: Dart_uiLibrary.Color.lerp(a.overlappingShapeStrokeColor, b.overlappingShapeStrokeColor, t), disabledThumbColor: Dart_uiLibrary.Color.lerp(a.disabledThumbColor, b.disabledThumbColor, t), overlayColor: Dart_uiLibrary.Color.lerp(a.overlayColor, b.overlayColor, t), valueIndicatorColor: Dart_uiLibrary.Color.lerp(a.valueIndicatorColor, b.valueIndicatorColor, t), valueIndicatorStrokeColor: Dart_uiLibrary.Color.lerp(a.valueIndicatorStrokeColor, b.valueIndicatorStrokeColor, t), overlayShape: (t < 0.5) ? a.overlayShape : b.overlayShape, tickMarkShape: (t < 0.5) ? a.tickMarkShape : b.tickMarkShape, thumbShape: (t < 0.5) ? a.thumbShape : b.thumbShape, trackShape: (t < 0.5) ? a.trackShape : b.trackShape, valueIndicatorShape: (t < 0.5) ? a.valueIndicatorShape : b.valueIndicatorShape, rangeTickMarkShape: (t < 0.5) ? a.rangeTickMarkShape : b.rangeTickMarkShape, rangeThumbShape: (t < 0.5) ? a.rangeThumbShape : b.rangeThumbShape, rangeTrackShape: (t < 0.5) ? a.rangeTrackShape : b.rangeTrackShape, rangeValueIndicatorShape: (t < 0.5) ? a.rangeValueIndicatorShape : b.rangeValueIndicatorShape, showValueIndicator: (t < 0.5) ? a.showValueIndicator : b.showValueIndicator, valueIndicatorTextStyle: TextStyle.lerp(a.valueIndicatorTextStyle, b.valueIndicatorTextStyle, t), minThumbSeparation: Dart_uiLibrary.lerpDouble(a.minThumbSeparation, b.minThumbSeparation, t), thumbSelector: (t < 0.5) ? a.thumbSelector : b.thumbSelector, mouseCursor: (t < 0.5) ? a.mouseCursor : b.mouseCursor, allowedInteraction: (t < 0.5) ? a.allowedInteraction : b.allowedInteraction, padding: EdgeInsetsGeometry.lerp(a.padding, b.padding, t), thumbSize: WidgetStateProperty.lerp<global::Doroti.Ui.Size?>(a.thumbSize, b.thumbSize, t, Size.lerp), trackGap: Dart_uiLibrary.lerpDouble(a.trackGap, b.trackGap, t), year2023: (t < 0.5) ? a.year2023 : b.year2023);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override int GetHashCode() => DartRuntimePrimitives.ConvertValue<int>(FoundationRuntimePorts.ObjectHash(trackHeight, activeTrackColor, inactiveTrackColor, secondaryActiveTrackColor, disabledActiveTrackColor, disabledInactiveTrackColor, disabledSecondaryActiveTrackColor, activeTickMarkColor, inactiveTickMarkColor, disabledActiveTickMarkColor, disabledInactiveTickMarkColor, thumbColor, overlappingShapeStrokeColor, disabledThumbColor, overlayColor, valueIndicatorColor, overlayShape, tickMarkShape, thumbShape, FoundationRuntimePorts.ObjectHash(trackShape, valueIndicatorShape, rangeTickMarkShape, rangeThumbShape, rangeTrackShape, rangeValueIndicatorShape, showValueIndicator, valueIndicatorTextStyle, minThumbSeparation, thumbSelector, mouseCursor, allowedInteraction, padding, thumbSize, trackGap, year2023)));
    public override bool Equals(object? other)
    {
        ...
        return (__other is SliderThemeData) && (__other.trackHeight == trackHeight) && Equals(__other.activeTrackColor, activeTrackColor) && Equals(__other.inactiveTrackColor, inactiveTrackColor) && Equals(__other.secondaryActiveTrackColor, secondaryActiveTrackColor) && Equals(__other.disabledActiveTrackColor, disabledActiveTrackColor) && Equals(__other.disabledInactiveTrackColor, disabledInactiveTrackColor) && Equals(__other.disabledSecondaryActiveTrackColor, disabledSecondaryActiveTrackColor) && Equals(__other.activeTickMarkColor, activeTickMarkColor) && Equals(__other.inactiveTickMarkColor, inactiveTickMarkColor) && Equals(__other.disabledActiveTickMarkColor, disabledActiveTickMarkColor) && Equals(__other.disabledInactiveTickMarkColor, disabledInactiveTickMarkColor) && Equals(__other.thumbColor, thumbColor) && Equals(__other.overlappingShapeStrokeColor, overlappingShapeStrokeColor) && Equals(__other.disabledThumbColor, disabledThumbColor) && Equals(__other.overlayColor, overlayColor) && Equals(__other.valueIndicatorColor, valueIndicatorColor) && Equals(__other.valueIndicatorStrokeColor, valueIndicatorStrokeColor) && Equals(__other.overlayShape, overlayShape) && Equals(__other.tickMarkShape, tickMarkShape) && Equals(__other.thumbShape, thumbShape) && Equals(__other.trackShape, trackShape) && Equals(__other.valueIndicatorShape, valueIndicatorShape) && Equals(__other.rangeTickMarkShape, rangeTickMarkShape) && Equals(__other.rangeThumbShape, rangeThumbShape) && Equals(__other.rangeTrackShape, rangeTrackShape) && Equals(__other.rangeValueIndicatorShape, rangeValueIndicatorShape) && Equals(__other.showValueIndicator, showValueIndicator) && Equals(__other.valueIndicatorTextStyle, valueIndicatorTextStyle) && (__other.minThumbSeparation == minThumbSeparation) && Equals(__other.thumbSelector, thumbSelector) && Equals(__other.mouseCursor, mouseCursor) && Equals(__other.allowedInteraction, allowedInteraction) && Equals(__other.padding, padding) && Equals(__other.thumbSize, thumbSize) && (__other.trackGap == trackGap) && (__other.year2023 == year2023);
    }

    public virtual void debugFillProperties(global::Doroti.Framework.Foundation.DiagnosticPropertiesBuilder properties)
    {
        var defaultData = new SliderThemeData();
        properties.add(new global::Doroti.Framework.Foundation.DoubleProperty("trackHeight", trackHeight, defaultValue: defaultData.trackHeight));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("activeTrackColor", activeTrackColor, defaultValue: defaultData.activeTrackColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("inactiveTrackColor", inactiveTrackColor, defaultValue: defaultData.inactiveTrackColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("secondaryActiveTrackColor", secondaryActiveTrackColor, defaultValue: defaultData.secondaryActiveTrackColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("disabledActiveTrackColor", disabledActiveTrackColor, defaultValue: defaultData.disabledActiveTrackColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("disabledInactiveTrackColor", disabledInactiveTrackColor, defaultValue: defaultData.disabledInactiveTrackColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("disabledSecondaryActiveTrackColor", disabledSecondaryActiveTrackColor, defaultValue: defaultData.disabledSecondaryActiveTrackColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("activeTickMarkColor", activeTickMarkColor, defaultValue: defaultData.activeTickMarkColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("inactiveTickMarkColor", inactiveTickMarkColor, defaultValue: defaultData.inactiveTickMarkColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("disabledActiveTickMarkColor", disabledActiveTickMarkColor, defaultValue: defaultData.disabledActiveTickMarkColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("disabledInactiveTickMarkColor", disabledInactiveTickMarkColor, defaultValue: defaultData.disabledInactiveTickMarkColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("thumbColor", thumbColor, defaultValue: defaultData.thumbColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("overlappingShapeStrokeColor", overlappingShapeStrokeColor, defaultValue: defaultData.overlappingShapeStrokeColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("disabledThumbColor", disabledThumbColor, defaultValue: defaultData.disabledThumbColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("overlayColor", overlayColor, defaultValue: defaultData.overlayColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("valueIndicatorColor", valueIndicatorColor, defaultValue: defaultData.valueIndicatorColor));
        properties.add(new global::Doroti.Framework.Painting.ColorProperty("valueIndicatorStrokeColor", valueIndicatorStrokeColor, defaultValue: defaultData.valueIndicatorStrokeColor));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<SliderComponentShape>("overlayShape", overlayShape, defaultValue: defaultData.overlayShape));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<SliderTickMarkShape>("tickMarkShape", tickMarkShape, defaultValue: defaultData.tickMarkShape));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<SliderComponentShape>("thumbShape", thumbShape, defaultValue: defaultData.thumbShape));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<SliderTrackShape>("trackShape", trackShape, defaultValue: defaultData.trackShape));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<SliderComponentShape>("valueIndicatorShape", valueIndicatorShape, defaultValue: defaultData.valueIndicatorShape));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<RangeSliderTickMarkShape>("rangeTickMarkShape", rangeTickMarkShape, defaultValue: defaultData.rangeTickMarkShape));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<RangeSliderThumbShape>("rangeThumbShape", rangeThumbShape, defaultValue: defaultData.rangeThumbShape));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<RangeSliderTrackShape>("rangeTrackShape", rangeTrackShape, defaultValue: defaultData.rangeTrackShape));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<RangeSliderValueIndicatorShape>("rangeValueIndicatorShape", rangeValueIndicatorShape, defaultValue: defaultData.rangeValueIndicatorShape));
        properties.add(new global::Doroti.Framework.Foundation.EnumProperty<ShowValueIndicator>("showValueIndicator", showValueIndicator, defaultValue: defaultData.showValueIndicator));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.TextStyle>("valueIndicatorTextStyle", valueIndicatorTextStyle, defaultValue: defaultData.valueIndicatorTextStyle));
        properties.add(new global::Doroti.Framework.Foundation.DoubleProperty("minThumbSeparation", minThumbSeparation, defaultValue: defaultData.minThumbSeparation));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<RangeThumbSelector>("thumbSelector", thumbSelector, defaultValue: defaultData.thumbSelector));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Framework.Services.MouseCursor?>>("mouseCursor", mouseCursor, defaultValue: defaultData.mouseCursor));
        properties.add(new global::Doroti.Framework.Foundation.EnumProperty<SliderInteraction>("allowedInteraction", allowedInteraction, defaultValue: defaultData.allowedInteraction));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Painting.EdgeInsetsGeometry>("padding", padding, defaultValue: defaultData.padding));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<global::Doroti.Framework.Widgets.WidgetStateProperty<global::Doroti.Ui.Size?>>("thumbSize", thumbSize, defaultValue: defaultData.thumbSize));
        properties.add(new global::Doroti.Framework.Foundation.DoubleProperty("trackGap", trackGap, defaultValue: defaultData.trackGap));
        properties.add(new global::Doroti.Framework.Foundation.DiagnosticsProperty<bool>("year2023", year2023, defaultValue: defaultData.year2023));
    }
