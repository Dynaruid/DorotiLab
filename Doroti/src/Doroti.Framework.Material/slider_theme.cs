...
public class SliderTheme : global::Doroti.Framework.Widgets.InheritedTheme
{
    ...
    {
        SliderTheme? inheritedTheme = ((SliderTheme?)context.dependOnInheritedWidgetOfExactType<SliderTheme>());
    ...
    {
        return ((global::Doroti.Framework.Widgets.Widget)new SliderTheme(data: this.data, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override bool updateShouldNotify(global::Doroti.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>((!Equals(this.data, ((SliderTheme)oldWidget).data)));
}
...
public class SliderThemeData : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (((((((((((((((((((((((((((((((((((((__other is SliderThemeData) && (((SliderThemeData)((SliderThemeData)__other)).trackHeight == this.trackHeight)) && (Equals(((SliderThemeData)((SliderThemeData)__other)).activeTrackColor, this.activeTrackColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).inactiveTrackColor, this.inactiveTrackColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).secondaryActiveTrackColor, this.secondaryActiveTrackColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).disabledActiveTrackColor, this.disabledActiveTrackColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).disabledInactiveTrackColor, this.disabledInactiveTrackColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).disabledSecondaryActiveTrackColor, this.disabledSecondaryActiveTrackColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).activeTickMarkColor, this.activeTickMarkColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).inactiveTickMarkColor, this.inactiveTickMarkColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).disabledActiveTickMarkColor, this.disabledActiveTickMarkColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).disabledInactiveTickMarkColor, this.disabledInactiveTickMarkColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).thumbColor, this.thumbColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).overlappingShapeStrokeColor, this.overlappingShapeStrokeColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).disabledThumbColor, this.disabledThumbColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).overlayColor, this.overlayColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).valueIndicatorColor, this.valueIndicatorColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).valueIndicatorStrokeColor, this.valueIndicatorStrokeColor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).overlayShape, this.overlayShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).tickMarkShape, this.tickMarkShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).thumbShape, this.thumbShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).trackShape, this.trackShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).valueIndicatorShape, this.valueIndicatorShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).rangeTickMarkShape, this.rangeTickMarkShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).rangeThumbShape, this.rangeThumbShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).rangeTrackShape, this.rangeTrackShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).rangeValueIndicatorShape, this.rangeValueIndicatorShape))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).showValueIndicator, this.showValueIndicator))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).valueIndicatorTextStyle, this.valueIndicatorTextStyle))) && (((SliderThemeData)((SliderThemeData)__other)).minThumbSeparation == this.minThumbSeparation)) && (Equals((global::System.Func<TextDirection, RangeValues, double, Size, Size, double, Thumb?>?)((SliderThemeData)((SliderThemeData)__other)).thumbSelector, (global::System.Func<TextDirection, RangeValues, double, Size, Size, double, Thumb?>?)this.thumbSelector))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).mouseCursor, this.mouseCursor))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).allowedInteraction, this.allowedInteraction))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).padding, this.padding))) && (Equals(((SliderThemeData)((SliderThemeData)__other)).thumbSize, this.thumbSize))) && (((SliderThemeData)((SliderThemeData)__other)).trackGap == this.trackGap)) && (((SliderThemeData)((SliderThemeData)__other)).year2023 == this.year2023));
    }
