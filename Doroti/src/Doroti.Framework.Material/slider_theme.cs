...
public class SliderTheme : InheritedTheme
{
    ...
    public SliderTheme(Key? key = null, SliderThemeData data = default!, Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((SliderTheme)oldWidget).data));
}
...
public class SliderThemeData : Diagnosticable
{
    ...
    public virtual Func<TextDirection, RangeValues, double, Size, Size, double, Thumb?>? thumbSelector { get; private set; }
    ...
    public static SliderThemeData CreateFromPrimaryColors(Color primaryColor, Color primaryColorDark, Color primaryColorLight, TextStyle valueIndicatorTextStyle)
    {
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new ColorProperty("secondaryActiveTrackColor", secondaryActiveTrackColor, defaultValue: defaultData.secondaryActiveTrackColor));
        ...
        properties.add(new ColorProperty("disabledSecondaryActiveTrackColor", disabledSecondaryActiveTrackColor, defaultValue: defaultData.disabledSecondaryActiveTrackColor));
        ...
        properties.add(new ColorProperty("valueIndicatorStrokeColor", valueIndicatorStrokeColor, defaultValue: defaultData.valueIndicatorStrokeColor));
        ...
        properties.add(new DiagnosticsProperty<WidgetStateProperty<MouseCursor?>>("mouseCursor", mouseCursor, defaultValue: defaultData.mouseCursor));
        properties.add(new EnumProperty<SliderInteraction>("allowedInteraction", allowedInteraction, defaultValue: defaultData.allowedInteraction));
        properties.add(new DiagnosticsProperty<EdgeInsetsGeometry>("padding", padding, defaultValue: defaultData.padding));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Size?>>("thumbSize", thumbSize, defaultValue: defaultData.thumbSize));
        properties.add(new DoubleProperty("trackGap", trackGap, defaultValue: defaultData.trackGap));
        properties.add(new DiagnosticsProperty<bool>("year2023", year2023, defaultValue: defaultData.year2023));
    }
