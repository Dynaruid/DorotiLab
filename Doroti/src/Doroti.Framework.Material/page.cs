...
{
    internal static PageTransitionsBuilder Resolve(BuildContext context)
    {
        ...
        {
            TargetPlatform.iOS or TargetPlatform.macOS => new CupertinoPageTransitionsBuilder(),
...
public class MaterialPageRoute<T> : PageRoute<T>, MaterialRouteTransitionMixin<T>
{
    ...
    public override Duration transitionDuration =>
        MaterialPageTransitionResolver.Resolve(navigator!.context).transitionDuration;
    public override Duration reverseTransitionDuration =>
        MaterialPageTransitionResolver.Resolve(navigator!.context).reverseTransitionDuration;
    ...
    public override Func<
        ...
        Widget?,
        Widget?
    >? delegatedTransition => MaterialRouteTransitionMixin<T>._delegatedTransition;
...
public interface MaterialRouteTransitionMixin<T> : IMaterialRouteTransition
{
    ...
    public static Widget? _delegatedTransition(
        BuildContext context,
        Animation<double> animation,
        Animation<double> secondaryAnimation,
    ...
    )
    {
        ...
        Func<
            ...
            Widget?,
            Widget?
        >? themeDelegatedTransition = theme.delegatedTransition(platformLocal);
        return (themeDelegatedTransition is not null)
...
public class MaterialPage<T> : Page<T>
{
    ...
    public MaterialPage(
        ...
        : base(
            ...
            onPopInvoked: onPopInvoked
                ?? ((didPop, result) => _defaultPopInvokedHandler(didPop, result)),
            name: name,
            arguments: arguments,
    ...
    {
        return new _PageBasedMaterialPageRoute__page<T>(
            page: this,
            allowSnapshotting: allowSnapshotting
        );
        throw new InvalidOperationException("Dart control flow completed without a value.");
...
{
    internal _PageBasedMaterialPageRoute__page(MaterialPage<T> page, bool allowSnapshotting = true)
