...
internal sealed class _WidgetInputBorderMapper__material_state : WidgetStateInputBorder, IWidgetStateMapping<InputBorder>
{
    ...
    public override BorderSide borderSide => throw WidgetStateMapping.Unresolved(nameof(borderSide));
    public override InputBorder copyWith(BorderSide? borderSide = null, BorderRadius? borderRadius = null, double? gapPadding = null, ShapeBorder? shape = null) => throw WidgetStateMapping.Unresolved(nameof(copyWith));
    ...
    public override void paint(Canvas canvas, Rect rect, TextDirection? textDirection = null, double? gapStart = 0.0, double gapExtent = 0.0, double gapPercentage = default!, BoxShape shape = BoxShape.rectangle, BorderRadius? borderRadius = null) => throw WidgetStateMapping.Unresolved(nameof(paint));
}
