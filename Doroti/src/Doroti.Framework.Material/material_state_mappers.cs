...
internal sealed class _WidgetStateInputBorder__material_state : WidgetStateInputBorder
{
    ...
    internal _WidgetStateInputBorder__material_state(
        Func<HashSet<WidgetState>, InputBorder> resolver
    ...
    public override InputBorder copyWith(
        BorderSide? borderSide = null,
        BorderRadius? borderRadius = null,
        double? gapPadding = null,
        ShapeBorder? shape = null
    ) => this.shape.copyWith(borderSide, borderRadius, gapPadding, shape);
...
internal sealed class _WidgetInputBorderMapper__material_state
    : WidgetStateInputBorder,
        IWidgetStateMapping<InputBorder>
{
    private readonly WidgetStateMapper<InputBorder> mapper;
    DartMap<WidgetStatesConstraint, InputBorder> IWidgetStateMapping<InputBorder>.Mapping =>
        ((IWidgetStateMapping<InputBorder>)mapper).Mapping;

    internal _WidgetInputBorderMapper__material_state(
        DartMap<WidgetStatesConstraint, InputBorder> map
    ) => mapper = new(map);

    public override InputBorder resolve(HashSet<WidgetState> states) =>
    ...
    public override BorderSide borderSide =>
        throw WidgetStateMapping.Unresolved(nameof(borderSide));
