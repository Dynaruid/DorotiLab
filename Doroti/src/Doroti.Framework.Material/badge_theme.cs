...
public class BadgeThemeData : Diagnosticable
{
    ...
    public virtual BadgeThemeData copyWith(
        Color? backgroundColor = null,
        Color? textColor = null,
        double? smallSize = null,
        double? largeSize = null,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is BadgeThemeData)
            && Equals(__other.backgroundColor, backgroundColor)
            && Equals(__other.textColor, textColor)
            && (__other.smallSize == smallSize)
            && (__other.largeSize == largeSize)
...
public class BadgeTheme : InheritedTheme
{
    ...
    public BadgeTheme(Key? key = null, BadgeThemeData data = default!, Widget child = default!)
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) =>
        DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((BadgeTheme)oldWidget).data));
}
