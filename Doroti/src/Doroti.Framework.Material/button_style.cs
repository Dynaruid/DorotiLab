...
public class ButtonStyle : global::Doroti.Framework.Foundation.Diagnosticable
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return ((((((((((((((((((((((((((__other is ButtonStyle) && (Equals(((ButtonStyle)((ButtonStyle)__other)).textStyle, this.textStyle))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).backgroundColor, this.backgroundColor))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).foregroundColor, this.foregroundColor))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).overlayColor, this.overlayColor))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).shadowColor, this.shadowColor))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).surfaceTintColor, this.surfaceTintColor))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).elevation, this.elevation))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).padding, this.padding))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).minimumSize, this.minimumSize))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).fixedSize, this.fixedSize))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).maximumSize, this.maximumSize))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).iconColor, this.iconColor))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).iconSize, this.iconSize))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).iconAlignment, this.iconAlignment))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).side, this.side))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).shape, this.shape))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).mouseCursor, this.mouseCursor))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).visualDensity, this.visualDensity))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).tapTargetSize, this.tapTargetSize))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).animationDuration, this.animationDuration))) && (((ButtonStyle)((ButtonStyle)__other)).enableFeedback == this.enableFeedback)) && (Equals(((ButtonStyle)((ButtonStyle)__other)).alignment, this.alignment))) && (Equals(((ButtonStyle)((ButtonStyle)__other)).splashFactory, this.splashFactory))) && (Equals((global::System.Func<global::Doroti.Framework.Widgets.BuildContext, HashSet<global::Doroti.Framework.Widgets.WidgetState>, global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget>?)((ButtonStyle)((ButtonStyle)__other)).backgroundBuilder, (global::System.Func<global::Doroti.Framework.Widgets.BuildContext, HashSet<global::Doroti.Framework.Widgets.WidgetState>, global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget>?)this.backgroundBuilder))) && (Equals((global::System.Func<global::Doroti.Framework.Widgets.BuildContext, HashSet<global::Doroti.Framework.Widgets.WidgetState>, global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget>?)((ButtonStyle)((ButtonStyle)__other)).foregroundBuilder, (global::System.Func<global::Doroti.Framework.Widgets.BuildContext, HashSet<global::Doroti.Framework.Widgets.WidgetState>, global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget>?)this.foregroundBuilder)));
    }
