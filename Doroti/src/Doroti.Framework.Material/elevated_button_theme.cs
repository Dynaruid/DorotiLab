...
public class ElevatedButtonTheme : global::Doroti.Framework.Widgets.InheritedTheme
{
    ...
    {
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new ElevatedButtonTheme(data: this.data, child: child));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public override bool updateShouldNotify(global::Doroti.Framework.Widgets.InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>((!object.Equals(this.data, ((ElevatedButtonTheme)oldWidget).data)));
}
