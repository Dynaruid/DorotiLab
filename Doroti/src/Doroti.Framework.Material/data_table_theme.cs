...
public class DataTableThemeData : Diagnosticable
{
    ...
    public DataTableThemeData(Decoration? decoration = null, WidgetStateProperty<Color?>? dataRowColor = null, double? dataRowHeight = null, double? dataRowMinHeight = null, double? dataRowMaxHeight = null, TextStyle? dataTextStyle = null, WidgetStateProperty<Color?>? headingRowColor = null, double? headingRowHeight = null, TextStyle? headingTextStyle = null, double? horizontalMargin = null, double? columnSpacing = null, double? dividerThickness = null, double? checkboxHorizontalMargin = null, WidgetStateProperty<MouseCursor?>? headingCellCursor = null, WidgetStateProperty<MouseCursor?>? dataRowCursor = null, MainAxisAlignment? headingRowAlignment = null)
    {
    ...
    public virtual DataTableThemeData copyWith(Decoration? decoration = null, WidgetStateProperty<Color?>? dataRowColor = null, double? dataRowHeight = null, double? dataRowMinHeight = null, double? dataRowMaxHeight = null, TextStyle? dataTextStyle = null, WidgetStateProperty<Color?>? headingRowColor = null, double? headingRowHeight = null, TextStyle? headingTextStyle = null, double? horizontalMargin = null, double? columnSpacing = null, double? dividerThickness = null, double? checkboxHorizontalMargin = null, WidgetStateProperty<MouseCursor?>? headingCellCursor = null, WidgetStateProperty<MouseCursor?>? dataRowCursor = null, MainAxisAlignment? headingRowAlignment = null)
    {
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("dataRowColor", dataRowColor, defaultValue: null));
        properties.add(new DoubleProperty("dataRowMinHeight", dataRowMinHeight, defaultValue: null));
        properties.add(new DoubleProperty("dataRowMaxHeight", dataRowMaxHeight, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("dataTextStyle", dataTextStyle, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<Color?>>("headingRowColor", headingRowColor, defaultValue: null));
        properties.add(new DoubleProperty("headingRowHeight", headingRowHeight, defaultValue: null));
        properties.add(new DiagnosticsProperty<TextStyle>("headingTextStyle", headingTextStyle, defaultValue: null));
        properties.add(new DoubleProperty("horizontalMargin", horizontalMargin, defaultValue: null));
        properties.add(new DoubleProperty("columnSpacing", columnSpacing, defaultValue: null));
        properties.add(new DoubleProperty("dividerThickness", dividerThickness, defaultValue: null));
        properties.add(new DoubleProperty("checkboxHorizontalMargin", checkboxHorizontalMargin, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<MouseCursor?>?>("headingCellCursor", headingCellCursor, defaultValue: null));
        properties.add(new DiagnosticsProperty<WidgetStateProperty<MouseCursor?>?>("dataRowCursor", dataRowCursor, defaultValue: null));
        properties.add(new EnumProperty<MainAxisAlignment>("headingRowAlignment", headingRowAlignment, defaultValue: null));
    }
...
public class DataTableTheme : InheritedWidget
{
    ...
    public DataTableTheme(Key? key = null, DataTableThemeData data = default!, Widget child = default!) : base(key: key, child: child)
    {
        this.data = data;
    }
    ...
    public override bool updateShouldNotify(InheritedWidget oldWidget) => DartRuntimePrimitives.ConvertValue<bool>(!Equals(data, ((DataTableTheme)oldWidget).data));
}
