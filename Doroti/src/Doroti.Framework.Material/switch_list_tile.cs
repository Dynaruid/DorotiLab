...
public class SwitchListTile : global::Doroti.Framework.Widgets.StatelessWidget
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        ...
        DartRuntimePrimitives.Ignore((leadingLocal, trailingLocal) = (effectiveControlAffinity switch { var __constant23578 when (Equals(__constant23578, ListTileControlAffinity.leading)) => (((global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?)>((control, this.secondary)))), var __constant23641 when (Equals(__constant23641, ListTileControlAffinity.trailing)) => (((global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?)>((this.secondary, control)))), var __constant23677 when (Equals(__constant23677, ListTileControlAffinity.platform)) => (((global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?))(DartRuntimePrimitives.ConvertValue<(global::Doroti.Framework.Widgets.Widget?, global::Doroti.Framework.Widgets.Widget?)>((this.secondary, control)))), _ when DartRuntimePrimitives.NonExhaustiveSwitchGuard => throw new InvalidOperationException("Non-exhaustive Dart switch value.") }));
        ThemeData theme = Theme.of(context);
        SwitchThemeData switchTheme = SwitchTheme.of(context);
        var states = ((Func<HashSet<global::Doroti.Framework.Widgets.WidgetState>>)(() => { var __collection23874 = new HashSet<global::Doroti.Framework.Widgets.WidgetState>(); if (this.selected) { __collection23874.Add(WidgetState.selected); } return __collection23874; }))();
        global::Doroti.Ui.Color effectiveActiveColor = ((global::Doroti.Ui.Color)((((this.activeThumbColor ?? this.activeColor) ?? (Color?)switchTheme.thumbColor?.resolve(states))) ?? theme.colorScheme.secondary));
