...
public class TextButton : ButtonStyleButton
{
    ...
    public static TextButton CreateIcon(
        Key? key = null,
        Action? onPressed = default!,
        Action? onLongPress = null,
        Action<bool>? onHover = null,
    ...
    )
    {
        var __instance = new TextButton(
            ...
            child: icon is null
                ? label
                : new _TextButtonWithIconChild__text_button(
                    label: label,
                    icon: icon,
                    buttonStyle: style,
    ...
    {
        WidgetStateProperty<Color?>? backgroundColorProp = (
            backgroundColor,
            disabledBackgroundColor
        ) switch
        {
            (_, null) => DartRuntimePrimitives.ConvertValue<WidgetStateProperty<Color?>>(
                new WidgetStatePropertyAll<Color?>(backgroundColor)
            ),
            (_, _) => defaultColor(backgroundColor, disabledBackgroundColor),
        };
        WidgetStateProperty<Color?>? iconColorProp = (iconColor, disabledIconColor) switch
        {
            (_, null) => DartRuntimePrimitives.ConvertValue<WidgetStateProperty<Color?>>(
                new WidgetStatePropertyAll<Color?>(iconColor)
            ),
        ...
        WidgetStateProperty<Color?>? overlayColorProp = (WidgetStateProperty<Color?>?)(
            (foregroundColor, overlayColor) switch
            {
                ...
                (_, Color { a: 0.0 } __object8320) => DartRuntimePrimitives.ConvertValue<
...
public static partial class Text_buttonLibrary
{
    internal static EdgeInsetsGeometry _scaledPadding(BuildContext context)
    {
        ...
        return ButtonStyleButton.scaledPadding(
            EdgeInsets.CreateSymmetric(horizontal: 12, vertical: 8),
            EdgeInsets.CreateSymmetric(horizontal: 8),
            EdgeInsets.CreateSymmetric(horizontal: 4),
            effectiveTextScale
        );
    }
...
internal class _TextButtonWithIconChild__text_button : StatelessWidget
{
    ...
    internal _TextButtonWithIconChild__text_button(
        Widget label,
        Widget icon,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        IconAlignment effectiveIconAlignment =
            ((iconAlignment ?? textButtonTheme.style?.iconAlignment) ?? buttonStyle?.iconAlignment)
            ?? IconAlignment.start;
        return new Row(
...
internal class _TextButtonDefaultsM3__text_button : ButtonStyle
{
    ...
    internal _TextButtonDefaultsM3__text_button(BuildContext context)
        : base(
    ...
    public override WidgetStateProperty<EdgeInsetsGeometry>? padding =>
        DartRuntimePrimitives.ConvertValue<WidgetStateProperty<EdgeInsetsGeometry>>(
            new WidgetStatePropertyAll<EdgeInsetsGeometry>(
                Text_buttonLibrary._scaledPadding(context)
            )
        );
