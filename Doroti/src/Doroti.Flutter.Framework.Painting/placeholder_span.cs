...
public abstract class PlaceholderSpan : InlineSpan
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new EnumProperty<global::Doroti.Flutter.Ui.PlaceholderAlignment>("alignment", this.alignment, defaultValue: null));
        properties.add(new EnumProperty<global::Doroti.Flutter.Ui.TextBaseline>("baseline", this.baseline, defaultValue: null));
    }
