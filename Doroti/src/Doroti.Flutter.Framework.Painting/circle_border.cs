        ...
        return ((Func<Path>)(() =>
{
    ...
    {
        global::Doroti.Flutter.Ui.Rect adjustedRect__3136 = _adjustRect(rect);
        return global::Doroti.Flutter.Ui.RRect.fromRectAndRadius(adjustedRect__3136, global::Doroti.Flutter.Ui.Radius.elliptical((adjustedRect__3136.width / 2.0), (adjustedRect__3136.height / 2.0))).contains(position);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
            ...
            case BorderStyle.solid:
                {
                    ...
                    {
                        global::Doroti.Flutter.Ui.Rect borderRect__4262 = _adjustRect(rect);
    ...
    internal virtual global::Doroti.Flutter.Ui.Rect _adjustRect(Rect rect)
    {
        ...
        {
            return global::Doroti.Flutter.Ui.Rect.fromCircle(center: rect.center, radius: (rect.shortestSide / 2.0));
        }
        if ((rect.width < rect.height))
        {
            double delta__4638 = ((((1.0 - this.eccentricity)) * ((rect.height - rect.width))) / 2.0);
            return global::Doroti.Flutter.Ui.Rect.fromLTRB(rect.left, (rect.top + delta__4638), rect.right, (rect.bottom - delta__4638));
        }
        else
        {
            double delta__4825 = ((((1.0 - this.eccentricity)) * ((rect.width - rect.height))) / 2.0);
            return global::Doroti.Flutter.Ui.Rect.fromLTRB((rect.left + delta__4825), rect.top, (rect.right - delta__4825), rect.bottom);
        }
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
