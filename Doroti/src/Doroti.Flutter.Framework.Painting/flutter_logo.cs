...
internal class _FlutterLogoPainter__flutter_logo : BoxPainter
{
    ...
    internal virtual void _prepareText()
    {
        ...
        global::Doroti.Flutter.Ui.TextBox textSize__7478 = this._textPainter.getBoxesForSelection(new TextSelection(baseOffset: 0L, extentOffset: kLabel__6912.Length)).Single();
        _textBoundingRect = global::Doroti.Flutter.Ui.Rect.fromLTRB(textSize__7478.left, textSize__7478.top, textSize__7478.right, textSize__7478.bottom);
    }
        ...
        var lightPaint__8627 = ((Func<Paint>)(() =>
{
    ...
    __cascade.color = new global::Doroti.Flutter.Ui.Color(4283745784L);
    return __cascade;
}))();
        var mediumPaint__8692 = ((Func<Paint>)(() =>
{
    var __cascade = new global::Doroti.Flutter.Ui.Paint();
    __cascade.color = new global::Doroti.Flutter.Ui.Color(4280923894L);
    return __cascade;
}))();
        var darkPaint__8758 = ((Func<Paint>)(() =>
{
    var __cascade = new global::Doroti.Flutter.Ui.Paint();
    __cascade.color = new global::Doroti.Flutter.Ui.Color(4278278043L);
    return __cascade;
}))();
        var triangleGradient__8823 = global::Doroti.Flutter.Ui.Gradient.linear(new global::Doroti.Flutter.Ui.Offset((87.2623 + 37.9092), (28.8384 + 123.4389)), new global::Doroti.Flutter.Ui.Offset((42.9205 + 37.9092), (35.0952 + 123.4389)), new List<global::Doroti.Flutter.Ui.Color> { new global::Doroti.Flutter.Ui.Color(1713022L), new global::Doroti.Flutter.Ui.Color(1712989054L) });
        ...
        var bottomBeam__9526 = ((Func<Path>)(() =>
{
    ...
    return __cascade;
        ...
        canvas.drawRect(global::Doroti.Flutter.Ui.Rect.fromLTWH(59.8, 123.1, 39.4, 39.4), mediumPaint__8692);
        canvas.restore();
        var triangle__10226 = ((Func<Path>)(() =>
{
    ...
    public override void paint(Canvas canvas, Offset offset, ImageConfiguration configuration)
    {
        ...
        global::Doroti.Flutter.Ui.Size canvasSize__10549 = ((FlutterLogoDecoration)this._config).margin.deflateSize(DartRuntimePrimitives.RequireValue(((ImageConfiguration)configuration).size));
        if (canvasSize__10549.isEmpty)
        {
            return;
        }
        global::Doroti.Flutter.Ui.Size logoSize__10676 = (((FlutterLogoDecoration)this._config)._position switch { > 0.0 => new global::Doroti.Flutter.Ui.Size(820.0, 232.0), < 0.0 => new global::Doroti.Flutter.Ui.Size(252.0, 306.0), _ => new global::Doroti.Flutter.Ui.Size(202.0, 202.0) });
        ...
        global::Doroti.Flutter.Ui.Rect rect__11040 = Alignment.center.inscribe(((FittedSizes)fittedSize__10918).destination, (offset & canvasSize__10549));
        double centerSquareHeight__11136 = canvasSize__10549.shortestSide;
        var centerSquare__11192 = global::Doroti.Flutter.Ui.Rect.fromLTWH((offset.dx + (((canvasSize__10549.width - centerSquareHeight__11136)) / 2.0)), (offset.dy + (((canvasSize__10549.height - centerSquareHeight__11136)) / 2.0)), centerSquareHeight__11136, centerSquareHeight__11136);
        global::Doroti.Flutter.Ui.Rect logoTargetSquare__11428 = default!;
        if ((((FlutterLogoDecoration)this._config)._position > 0.0))
        {
            logoTargetSquare__11428 = global::Doroti.Flutter.Ui.Rect.fromLTWH(rect__11040.left, rect__11040.top, rect__11040.height, rect__11040.height);
        }
        else
        {
            if ((((FlutterLogoDecoration)this._config)._position < 0.0))
            {
                ...
                logoTargetSquare__11428 = global::Doroti.Flutter.Ui.Rect.fromLTWH((rect__11040.left + (((rect__11040.width - logoHeight__11678)) / 2.0)), rect__11040.top, logoHeight__11678, logoHeight__11678);
            }
            else
            {
        ...
        global::Doroti.Flutter.Ui.Rect logoSquare__11976 = DartRuntimePrimitives.RequireValue(Dart_uiLibrary.Rect.lerp(centerSquare__11192, logoTargetSquare__11428, ((FlutterLogoDecoration)this._config)._position.abs()));
        if ((((FlutterLogoDecoration)this._config)._opacity < 1.0))
        {
            canvas.saveLayer((offset & canvasSize__10549), ((Func<Paint>)(() =>
{
    var __cascade = new global::Doroti.Flutter.Ui.Paint();
    __cascade.colorFilter = global::Doroti.Flutter.Ui.ColorFilter.mode(new global::Doroti.Flutter.Ui.Color(4294967295L).withOpacity(((FlutterLogoDecoration)this._config)._opacity), BlendMode.modulate);
    return __cascade;
}))());
        }
        if ((((FlutterLogoDecoration)this._config)._position != 0.0))
        {
            if ((((FlutterLogoDecoration)this._config)._position > 0.0))
            {
                ...
                var textOffset__13152 = new global::Doroti.Flutter.Ui.Offset((rect__11040.left + DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(initialLeftTextPosition__12995, finalLeftTextPosition__12594, ((FlutterLogoDecoration)this._config)._position))), (rect__11040.top + (((rect__11040.height - (this._textBoundingRect.height * scale__12547))) / 2.0)));
                canvas.save();
                if ((((FlutterLogoDecoration)this._config)._position < 1.0))
                {
                    global::Doroti.Flutter.Ui.Offset center__13465 = logoSquare__11976.center;
    ...
    return __cascade;
            ...
            else
            {
                if ((((FlutterLogoDecoration)this._config)._position < 0.0))
                {
                    ...
                    if ((((FlutterLogoDecoration)this._config)._position > -1.0))
                    {
                        canvas.saveLayer(this._textBoundingRect, new global::Doroti.Flutter.Ui.Paint());
                    }
                    else
                    {
                        canvas.save();
                        ...
                        canvas.drawRect(this._textBoundingRect.inflate((this._textBoundingRect.width * 0.5)), ((Func<Paint>)(() =>
{
    ...
    __cascade.shader = global::Doroti.Flutter.Ui.Gradient.linear(new global::Doroti.Flutter.Ui.Offset((this._textBoundingRect.width * -0.5), 0.0), new global::Doroti.Flutter.Ui.Offset((this._textBoundingRect.width * 1.5), 0.0), new List<global::Doroti.Flutter.Ui.Color> { new global::Doroti.Flutter.Ui.Color(4294967295L), new global::Doroti.Flutter.Ui.Color(4294967295L), new global::Doroti.Flutter.Ui.Color(16777215L), new global::Doroti.Flutter.Ui.Color(16777215L) }, new List<double> { 0.0, Math.Max(0.0, (((FlutterLogoDecoration)this._config)._position.abs() - 0.1)), Math.Min((((FlutterLogoDecoration)this._config)._position.abs() + 0.1), 1.0), 1.0 });
    return __cascade;
}))());
                    }
                    canvas.restore();
