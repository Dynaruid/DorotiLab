...
public class RoundedRectangleBorder : OutlinedBorder, _RRectLikeBorder__rounded_rectangle_border
{
    ...
    {
        global::Doroti.Flutter.Ui.RRect borderRect__3146 = this.borderRadius.resolve(textDirection).toRRect(rect);
        global::Doroti.Flutter.Ui.RRect adjustedRect__3226 = borderRect__3146.deflate(((BorderSide)side).strokeInset);
        return ((Func<Path>)(() =>
{
                        ...
                        var paint__4521 = ((Func<Paint>)(() =>
{
    ...
    return __cascade;
                        ...
                        global::Doroti.Flutter.Ui.RRect borderRect__4580 = this.borderRadius.resolve(textDirection).toRRect(rect);
                        global::Doroti.Flutter.Ui.RRect inner__4666 = borderRect__4580.deflate(((BorderSide)side).strokeInset);
                        global::Doroti.Flutter.Ui.RRect outer__4734 = borderRect__4580.inflate(((BorderSide)side).strokeOutset);
...
internal class _RoundedRectangleToCircleBorder__rounded_rectangle_border : _ShapeToCircleBorder__rounded_rectangle_border<RoundedRectangleBorder>
{
    ...
    {
        global::Doroti.Flutter.Ui.RRect rrect__5681 = radius.toRRect(rect);
    ...
    {
        global::Doroti.Flutter.Ui.RRect rrect__5921 = radius.toRRect(rect);
        if ((inflation is not null))
        {
            ...
            return ((Func<Path>)(() =>
{
    ...
    return __cascade;
        ...
        {
            global::Doroti.Flutter.Ui.RSuperellipse borderRect__9851 = this.borderRadius.resolve(textDirection).toRSuperellipse(rect);
            global::Doroti.Flutter.Ui.RSuperellipse adjustedRect__9949 = borderRect__9851.deflate(((BorderSide)side).strokeInset);
            return ((Func<Path>)(() =>
{
    var __cascade = new global::Doroti.Flutter.Ui.Path();
            ...
            case BorderStyle.solid:
                {
                    ...
                    if ((object.Equals(this.borderRadius, BorderRadius.zero)))
                    {
                        global::Doroti.Flutter.Ui.Rect @base__11391 = rect.inflate(strokeOffset__11262);
                        canvas.drawRect(@base__11391, side.toPaint());
                    }
                    else
                    {
                        global::Doroti.Flutter.Ui.RSuperellipse @base__11522 = this.borderRadius.resolve(textDirection).toRSuperellipse(rect).inflate(strokeOffset__11262);
...
internal class _RoundedSuperellipseToCircleBorder__rounded_rectangle_border : _ShapeToCircleBorder__rounded_rectangle_border<RoundedSuperellipseBorder>
{
    ...
    public override void drawShape(Canvas canvas, Rect rect, BorderRadius radius, Paint paint, double? inflation = null)
    {
        global::Doroti.Flutter.Ui.RSuperellipse rsuperellipse__12586 = radius.toRSuperellipse(rect);
        if ((inflation is not null))
        {
    ...
    public override Path buildPath(Rect rect, BorderRadius radius, double? inflation = null)
    {
        global::Doroti.Flutter.Ui.RSuperellipse rsuperellipse__12882 = radius.toRSuperellipse(rect);
        if ((inflation is not null))
        {
...
internal abstract class _ShapeToCircleBorder__rounded_rectangle_border<T> : OutlinedBorder where T : _RRectLikeBorder__rounded_rectangle_border
{
    ...
    public abstract global::Doroti.Flutter.Ui.Path buildPath(Rect rect, BorderRadius radius, double? inflation = null);
    ...
    internal virtual global::Doroti.Flutter.Ui.Rect _adjustRect(Rect rect)
    {
        ...
        if ((rect.width < rect.height))
        {
            ...
            return global::Doroti.Flutter.Ui.Rect.fromLTRB(rect.left, (rect.top + delta__16552), rect.right, (rect.bottom - delta__16552));
        }
        else
        {
            ...
            return global::Doroti.Flutter.Ui.Rect.fromLTRB((rect.left + delta__16799), rect.top, (rect.right - delta__16799), rect.bottom);
        }
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    internal virtual BorderRadius _adjustBorderRadius(Rect rect, TextDirection? textDirection)
    {
        ...
        if ((this.eccentricity != 0.0))
        {
            if ((rect.width < rect.height))
            {
                return BorderRadius.lerp(resolvedRadius__17060, BorderRadius.CreateAll(global::Doroti.Flutter.Ui.Radius.elliptical((rect.width / 2L), ((((0.5 + (this.eccentricity / 2L))) * rect.height) / 2L))), DartRuntimePrimitives.RequireValue(this.circularity))!;
            }
            else
            {
                return BorderRadius.lerp(resolvedRadius__17060, BorderRadius.CreateAll(global::Doroti.Flutter.Ui.Radius.elliptical(((((0.5 + (this.eccentricity / 2L))) * rect.width) / 2L), (rect.height / 2L))), DartRuntimePrimitives.RequireValue(this.circularity))!;
            }
        }
    ...
    public override bool hitTest(Rect rect, Offset position, TextDirection? textDirection = null)
    {
        global::Doroti.Flutter.Ui.Rect adjustedRect__18376 = _adjustRect(rect);
