...
{
    var __cascade = new global::Doroti.Flutter.Ui.Paint();
    __cascade.color = new global::Doroti.Flutter.Ui.Color(0L);
    ...
    public static BorderSide lerp(BorderSide a, BorderSide b, double t)
    {
        ...
        global::Doroti.Flutter.Ui.Color colorA__10117 = (((BorderSide)a).style switch { BorderStyle.solid => ((BorderSide)a).color, BorderStyle.none => ((BorderSide)a).color.withAlpha(0L), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        global::Doroti.Flutter.Ui.Color colorB__10255 = (((BorderSide)b).style switch { BorderStyle.solid => ((BorderSide)b).color, BorderStyle.none => ((BorderSide)b).color.withAlpha(0L), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Color>("color", this.color, defaultValue: new global::Doroti.Flutter.Ui.Color(4278190080L)));
...
public abstract class ShapeBorder
{
    ...
    public abstract global::Doroti.Flutter.Ui.Path getOuterPath(Rect rect, TextDirection? textDirection = null);
    public abstract global::Doroti.Flutter.Ui.Path getInnerPath(Rect rect, TextDirection? textDirection = null);
        ...
        var paint__35920 = ((Func<Paint>)(() =>
{
    ...
    return __cascade;
        ...
        var path__35965 = new global::Doroti.Flutter.Ui.Path();
