...
}))())) : (((TextStyle)b).background ?? (((Func<Paint>)(() =>
{
    ...
    public virtual global::Doroti.Flutter.Ui.TextStyle getTextStyle(double textScaleFactor = 1.0, TextScaler textScaler = default!)
    {
        ...
        return new global::Doroti.Flutter.Ui.TextStyle(color: this.color, decoration: this.decoration, decorationColor: this.decorationColor, decorationStyle: this.decorationStyle, decorationThickness: this.decorationThickness, fontWeight: this.fontWeight, fontStyle: this.fontStyle, textBaseline: this.textBaseline, leadingDistribution: this.leadingDistribution, fontFamily: this.fontFamily, fontFamilyFallback: this.fontFamilyFallback, fontSize: fontSize__56839, letterSpacing: this.letterSpacing, wordSpacing: this.wordSpacing, height: this.height, locale: this.locale, foreground: this.foreground, background: ((this.background, this.backgroundColor) switch
        {
            (global::Doroti.Flutter.Ui.Paint paint__57711, _) => paint__57711,
            (_, global::Doroti.Flutter.Ui.Color color__57755) => ((Func<Paint>)(() =>
{
    var __cascade = new global::Doroti.Flutter.Ui.Paint();
    ...
    public virtual global::Doroti.Flutter.Ui.ParagraphStyle getParagraphStyle(TextAlign? textAlign = null, TextDirection? textDirection = null, TextScaler textScaler = default!, string? ellipsis = null, long? maxLines = null, TextHeightBehavior? textHeightBehavior = null, Locale? locale = null, string? fontFamily = null, double? fontSize = null, FontWeight? fontWeight = null, FontStyle? fontStyle = null, double? height = null, StrutStyle? strutStyle = null)
    {
        ...
        global::Doroti.Flutter.Ui.TextLeadingDistribution? leadingDistribution__58864 = this.leadingDistribution;
        global::Doroti.Flutter.Ui.TextHeightBehavior? effectiveTextHeightBehavior__58942 = (textHeightBehavior ?? (((leadingDistribution__58864 is null) ? null : new global::Doroti.Flutter.Ui.TextHeightBehavior(leadingDistribution: DartRuntimePrimitives.RequireValue(leadingDistribution__58864)))));
        return new global::Doroti.Flutter.Ui.ParagraphStyle(textAlign: textAlign, textDirection: textDirection, fontWeight: (fontWeight ?? this.fontWeight), fontStyle: (fontStyle ?? this.fontStyle), fontFamily: (fontFamily ?? this.fontFamily), fontSize: textScaler.scale(((fontSize ?? this.fontSize) ?? global::Doroti.Generated.Framework.Painting.Text_painterLibrary.kDefaultFontSize)), height: (height ?? this.height), textHeightBehavior: effectiveTextHeightBehavior__58942, strutStyle: ((strutStyle is null) ? null : new global::Doroti.Flutter.Ui.StrutStyle(fontFamily: ((StrutStyle)strutStyle).fontFamily, fontFamilyFallback: ((StrutStyle)strutStyle).fontFamilyFallback, fontSize: (((StrutStyle)strutStyle).fontSize switch { null => null, double unscaled__59989 => textScaler.scale(unscaled__59989) }), height: ((StrutStyle)strutStyle).height, leading: ((StrutStyle)strutStyle).leading, leadingDistribution: ((StrutStyle)strutStyle).leadingDistribution, fontWeight: ((StrutStyle)strutStyle).fontWeight, fontStyle: ((StrutStyle)strutStyle).fontStyle, forceStrutHeight: ((StrutStyle)strutStyle).forceStrutHeight)), maxLines: maxLines, ellipsis: ellipsis, locale: locale);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override int GetHashCode()
    {
        ...
        List<global::Doroti.Flutter.Ui.Shadow>? shadows__63768 = this.shadows;
        List<global::Doroti.Flutter.Ui.FontFeature>? fontFeatures__63821 = this.fontFeatures;
        List<global::Doroti.Flutter.Ui.FontVariation>? fontVariations__63886 = this.fontVariations;
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties, string prefix = "")
    {
        ...
        styles__64887.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.FontWeight>($"{prefix}weight", this.fontWeight, description: weightDescription__65342, defaultValue: null));
        styles__64887.Add(new EnumProperty<global::Doroti.Flutter.Ui.FontStyle>($"{prefix}style", this.fontStyle, defaultValue: null));
        ...
        styles__64887.Add(new EnumProperty<global::Doroti.Flutter.Ui.TextBaseline>($"{prefix}baseline", this.textBaseline, defaultValue: null));
        styles__64887.Add(new DoubleProperty($"{prefix}height", this.height, unit: "x", defaultValue: null));
        styles__64887.Add(new EnumProperty<global::Doroti.Flutter.Ui.TextLeadingDistribution>($"{prefix}leadingDistribution", this.leadingDistribution, defaultValue: null));
        styles__64887.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Locale>($"{prefix}locale", this.locale, defaultValue: null));
        styles__64887.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Paint>($"{prefix}foreground", this.foreground, defaultValue: null));
        styles__64887.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Paint>($"{prefix}background", this.background, defaultValue: null));
        if (((((this.decoration is not null) || (this.decorationColor is not null)) || (this.decorationStyle is not null)) || (this.decorationThickness is not null)))
        {
            ...
            styles__64887.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.TextDecoration>($"{prefix}decoration", this.decoration, defaultValue: null, level: DiagnosticLevel.hidden));
...
public static partial class Text_styleLibrary
{
    public static List<FontVariation>? lerpFontVariations(List<FontVariation>? a, List<FontVariation>? b, double t)
    {
        ...
        var result__71534 = new List<global::Doroti.Flutter.Ui.FontVariation>();
        var index__71661 = 0L;
        ...
        if ((index__71661 < maxLength__71956))
        {
            ...
            DartMap<string, global::Doroti.Flutter.Ui.FontVariation> aVariations__72221 = new DartMap<string, global::Doroti.Flutter.Ui.FontVariation>().cast<string, global::Doroti.Flutter.Ui.FontVariation>();
            ...
            DartMap<string, global::Doroti.Flutter.Ui.FontVariation> bVariations__72454 = new DartMap<string, global::Doroti.Flutter.Ui.FontVariation>().cast<string, global::Doroti.Flutter.Ui.FontVariation>();
            ...
            {
                global::Doroti.Flutter.Ui.FontVariation? variation__72708 = Dart_uiLibrary.FontVariation.lerp(aVariations__72221.GetValueOrDefault(axis__72665), bVariations__72454.GetValueOrDefault(axis__72665), t);
