...
public abstract class EdgeInsetsGeometry
{
    ...
    public virtual global::Doroti.Flutter.Ui.Size collapsedSize => new global::Doroti.Flutter.Ui.Size(this.horizontal, this.vertical);
    ...
    public virtual global::Doroti.Flutter.Ui.Size inflateSize(Size size)
    {
        return new global::Doroti.Flutter.Ui.Size((size.width + this.horizontal), (size.height + this.vertical));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual global::Doroti.Flutter.Ui.Size deflateSize(Size size)
    {
        return new global::Doroti.Flutter.Ui.Size((size.width - this.horizontal), (size.height - this.vertical));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class EdgeInsets : EdgeInsetsGeometry
{
    ...
    public virtual global::Doroti.Flutter.Ui.Offset topLeft => new global::Doroti.Flutter.Ui.Offset(this.left, this.top);
    public virtual global::Doroti.Flutter.Ui.Offset topRight => new global::Doroti.Flutter.Ui.Offset(-this.right, this.top);
    public virtual global::Doroti.Flutter.Ui.Offset bottomLeft => new global::Doroti.Flutter.Ui.Offset(this.left, -this.bottom);
    public virtual global::Doroti.Flutter.Ui.Offset bottomRight => new global::Doroti.Flutter.Ui.Offset(-this.right, -this.bottom);
    public override EdgeInsets flipped => new EdgeInsets(this.right, this.bottom, this.left, this.top);
    public virtual global::Doroti.Flutter.Ui.Rect inflateRect(Rect rect)
    {
        return global::Doroti.Flutter.Ui.Rect.fromLTRB((rect.left - this.left), (rect.top - this.top), (rect.right + this.right), (rect.bottom + this.bottom));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual global::Doroti.Flutter.Ui.Rect deflateRect(Rect rect)
    {
        return global::Doroti.Flutter.Ui.Rect.fromLTRB((rect.left + this.left), (rect.top + this.top), (rect.right - this.right), (rect.bottom - this.bottom));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual global::Doroti.Flutter.Ui.RRect inflateRRect(RRect rect)
    {
        return global::Doroti.Flutter.Ui.RRect.fromLTRBAndCorners((rect.left - this.left), (rect.top - this.top), (rect.right + this.right), (rect.bottom + this.bottom), topLeft: ((rect.tlRadius + global::Doroti.Flutter.Ui.Radius.elliptical(this.left, this.top))).clamp(minimum: Radius.zero), topRight: ((rect.trRadius + global::Doroti.Flutter.Ui.Radius.elliptical(this.right, this.top))).clamp(minimum: Radius.zero), bottomRight: ((rect.brRadius + global::Doroti.Flutter.Ui.Radius.elliptical(this.right, this.bottom))).clamp(minimum: Radius.zero), bottomLeft: ((rect.blRadius + global::Doroti.Flutter.Ui.Radius.elliptical(this.left, this.bottom))).clamp(minimum: Radius.zero));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual global::Doroti.Flutter.Ui.RRect deflateRRect(RRect rect)
    {
        return global::Doroti.Flutter.Ui.RRect.fromLTRBAndCorners((rect.left + this.left), (rect.top + this.top), (rect.right - this.right), (rect.bottom - this.bottom), topLeft: ((rect.tlRadius - global::Doroti.Flutter.Ui.Radius.elliptical(this.left, this.top))).clamp(minimum: Radius.zero), topRight: ((rect.trRadius - global::Doroti.Flutter.Ui.Radius.elliptical(this.right, this.top))).clamp(minimum: Radius.zero), bottomRight: ((rect.brRadius - global::Doroti.Flutter.Ui.Radius.elliptical(this.right, this.bottom))).clamp(minimum: Radius.zero), bottomLeft: ((rect.blRadius - global::Doroti.Flutter.Ui.Radius.elliptical(this.left, this.bottom))).clamp(minimum: Radius.zero));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
