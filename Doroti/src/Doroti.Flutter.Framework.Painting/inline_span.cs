...
public class InlineSpanSemanticsInformation
{
    ...
    {
        List<StringAttribute> __stringAttributes = stringAttributes ?? new List<global::Doroti.Flutter.Ui.StringAttribute>();
        this.text = text;
    ...
    public override bool Equals(object? other)
    {
        ...
        return (((((((__other is InlineSpanSemanticsInformation) && (((InlineSpanSemanticsInformation)((InlineSpanSemanticsInformation)__other)).text == this.text)) && (((InlineSpanSemanticsInformation)((InlineSpanSemanticsInformation)__other)).semanticsLabel == this.semanticsLabel)) && (((InlineSpanSemanticsInformation)((InlineSpanSemanticsInformation)__other)).semanticsIdentifier == this.semanticsIdentifier)) && (object.Equals(((InlineSpanSemanticsInformation)((InlineSpanSemanticsInformation)__other)).recognizer, this.recognizer))) && (((InlineSpanSemanticsInformation)((InlineSpanSemanticsInformation)__other)).isPlaceholder == this.isPlaceholder)) && global::Doroti.Generated.Framework.Foundation.CollectionsLibrary.listEquals<global::Doroti.Flutter.Ui.StringAttribute>(((InlineSpanSemanticsInformation)((InlineSpanSemanticsInformation)__other)).stringAttributes, this.stringAttributes));
    }
...
public static partial class Inline_spanLibrary
{
    public static List<InlineSpanSemanticsInformation> combineSemanticsInfo(List<InlineSpanSemanticsInformation> infoList)
    {
        ...
        var workingAttributes__4442 = new List<global::Doroti.Flutter.Ui.StringAttribute>();
        foreach (var info__4499 in infoList)
        {
            if (((InlineSpanSemanticsInformation)info__4499).requiresOwnNode)
            {
                ...
                workingText__4393 = "";
                workingLabel__4417 = "";
                workingAttributes__4442 = new List<global::Doroti.Flutter.Ui.StringAttribute>();
            ...
            else
            {
                ...
                foreach (global::Doroti.Flutter.Ui.StringAttribute infoAttribute__5017 in ((InlineSpanSemanticsInformation)info__4499).stringAttributes)
                {
                    workingAttributes__4442.Add(infoAttribute__5017.copy(range: new global::Doroti.Flutter.Ui.TextRange(start: (infoAttribute__5017.range.start + workingLabel__4417.Length), end: (infoAttribute__5017.range.end + workingLabel__4417.Length))));
                }
