...
public class WordBoundary : TextBoundary
{
    ...
    public virtual global::Doroti.Flutter.Ui.TextRange getTextBoundaryAt(long position) => this._paragraph.getWordBoundary(new global::Doroti.Flutter.Ui.TextPosition(offset: Math.Max(position, 0L)));
...
internal class _TextLayout__text_painter
{
    ...
    internal virtual _LineCaretMetrics__text_painter _computeEndOfTextCaretAnchorOffset()
    {
        ...
        global::Doroti.Flutter.Ui.LineMetrics lineMetrics__13834 = this._paragraph.getLineMetricsAt(lastLineIndex__13731)!;
        ...
        global::Doroti.Flutter.Ui.GlyphInfo? lastGlyph__14907 = this._paragraph.getGlyphInfoAt((rawString__13685.Length - 1L));
        if ((hasTrailingSpaces__14504 && (lastGlyph__14907 is not null)))
        {
            global::Doroti.Flutter.Ui.Rect glyphBounds__15171 = lastGlyph__14907.graphemeClusterLayoutBounds;
        ...
        return new _LineCaretMetrics__text_painter(offset: new global::Doroti.Flutter.Ui.Offset(dx__14849, baseline__14799), writingDirection: this.writingDirection, height: height__14870);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _TextPainterLayoutCacheWithOffset__text_painter
{
    ...
    public virtual global::Doroti.Flutter.Ui.Offset paintOffset
    {
        get
        {
            ...
            {
                return new global::Doroti.Flutter.Ui.Offset(double.PositiveInfinity, 0.0);
            }
            ...
            return new global::Doroti.Flutter.Ui.Offset(dx__17434, 0);
            return default!;
        }
    }
    public virtual global::Doroti.Flutter.Ui.Paragraph paragraph => ((_TextLayout__text_painter)this.layout)._paragraph;
    ...
    public virtual List<global::Doroti.Flutter.Ui.TextBox> inlinePlaceholderBoxes => _cachedInlinePlaceholderBoxes ??= this.paragraph.getBoxesForPlaceholders();
    public virtual List<global::Doroti.Flutter.Ui.LineMetrics> lineMetrics => _cachedLineMetrics ??= this.paragraph.computeLineMetrics();
}
        ...
        var painter__27638 = ((Func<TextPainter>)(() =>
{
    ...
    public virtual List<global::Doroti.Flutter.Ui.TextBox>? inlinePlaceholderBoxes
    {
        get
        {
            ...
            global::Doroti.Flutter.Ui.Offset offset__38839 = ((_TextPainterLayoutCacheWithOffset__text_painter)layout__38748).paintOffset;
            if ((!double.IsFinite(offset__38839.dx) || !double.IsFinite(offset__38839.dy)))
            {
                return new List<global::Doroti.Flutter.Ui.TextBox>();
            }
            List<global::Doroti.Flutter.Ui.TextBox> rawBoxes__38978 = ((_TextPainterLayoutCacheWithOffset__text_painter)layout__38748).inlinePlaceholderBoxes;
    ...
    internal virtual global::Doroti.Flutter.Ui.ParagraphStyle _createParagraphStyle(TextAlign? textAlignOverride = null)
    {
    ...
    internal virtual global::Doroti.Flutter.Ui.Paragraph _createLayoutTemplate()
    {
        var builder__40910 = new global::Doroti.Flutter.Ui.ParagraphBuilder(_createParagraphStyle(TextAlign.left));
        global::Doroti.Flutter.Ui.TextStyle? textStyle__41067 = this.text?.style?.getTextStyle(textScaler: this.textScaler);
        ...
        return ((Func<Paragraph>)(() =>
{
    ...
    __cascade.layout(new global::Doroti.Flutter.Ui.ParagraphConstraints(width: double.PositiveInfinity));
    return __cascade;
}))();
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal virtual global::Doroti.Flutter.Ui.Paragraph _getOrCreateLayoutTemplate() => _layoutTemplate ??= _createLayoutTemplate();
    ...
    public virtual global::Doroti.Flutter.Ui.Size size
    {
        get
        {
            DartRuntimePrimitives.Assert(() => this._debugAssertTextLayoutIsValid);
            DartRuntimePrimitives.Assert(() => !this._debugNeedsRelayout);
            return new global::Doroti.Flutter.Ui.Size(this.width, this.height);
            return default!;
        }
    }
    ...
    internal virtual global::Doroti.Flutter.Ui.Paragraph _createParagraph(InlineSpan text)
    {
        var builder__44548 = new global::Doroti.Flutter.Ui.ParagraphBuilder(_createParagraphStyle());
    ...
    public virtual void layout(double minWidth = 0.0, double maxWidth = double.PositiveInfinity)
    {
        ...
        global::Doroti.Flutter.Ui.TextDirection? textDirection__45936 = this.textDirection;
        ...
        global::Doroti.Flutter.Ui.Paragraph paragraph__47147 = ((Func<Paragraph>)(() =>
{
    var __cascade = ((cachedLayout__45571?.paragraph ?? _createParagraph(text__45740)));
    __cascade.layout(new global::Doroti.Flutter.Ui.ParagraphConstraints(width: layoutMaxWidth__46644));
    return __cascade;
}))();
        ...
        if (((adjustedMaxWidth__46518 is null) && double.IsFinite(minWidth)))
        {
            ...
            paragraph__47147.layout(new global::Doroti.Flutter.Ui.ParagraphConstraints(width: newInputWidth__47789));
    ...
    public virtual void paint(Canvas canvas, Offset offset)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Size? debugSize__50182 = default!;
            DartRuntimePrimitives.Assert(() =>
                {
                    debugSize__50182 = this.size;
                    return true;
                });
            global::Doroti.Flutter.Ui.Paragraph paragraph__50296 = ((_TextPainterLayoutCacheWithOffset__text_painter)layoutCache__49757).paragraph;
            ...
            ((_TextPainterLayoutCacheWithOffset__text_painter)layoutCache__49757).layout._paragraph = ((Func<Paragraph>)(() =>
{
    ...
    __cascade.layout(new global::Doroti.Flutter.Ui.ParagraphConstraints(width: ((_TextPainterLayoutCacheWithOffset__text_painter)layoutCache__49757).layoutMaxWidth));
    return __cascade;
}))();
        ...
        var paint__51229 = ((Func<Paint>)(() =>
{
    ...
    __cascade.color = new global::Doroti.Flutter.Ui.Color(4278255615L);
    return __cascade;
}))();
        List<global::Doroti.Flutter.Ui.TextBox> textBoxes__51373 = getBoxesForSelection(new TextSelection(baseOffset: 0L, extentOffset: this.plainText.Length));
    ...
    public virtual global::Doroti.Flutter.Ui.Offset getOffsetForCaret(TextPosition position, Rect caretPrototype)
    {
        ...
        if ((caretMetrics__54505 is null))
        {
            ...
            return new global::Doroti.Flutter.Ui.Offset(dx__54900, 0.0);
        }
        global::Doroti.Flutter.Ui.Offset rawOffset__55060 = (caretMetrics__54505 switch { _LineCaretMetrics__text_painter { writingDirection: TextDirection.ltr, offset: global::Doroti.Flutter.Ui.Offset offset__55171 } __object55102 => offset__55171, _LineCaretMetrics__text_painter { writingDirection: TextDirection.rtl, offset: global::Doroti.Flutter.Ui.Offset offset__55265 } __object55196 => new global::Doroti.Flutter.Ui.Offset((offset__55265.dx - caretPrototype.width), offset__55265.dy), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        ...
        return new global::Doroti.Flutter.Ui.Offset(adjustedDx__55719, (rawOffset__55060.dy + ((_TextPainterLayoutCacheWithOffset__text_painter)layoutCache__54447).paintOffset.dy));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual double getFullHeightForCaret(TextPosition position, Rect caretPrototype)
    {
        ...
        List<global::Doroti.Flutter.Ui.TextBox> boxes__56949 = _getOrCreateLayoutTemplate().getBoxesForRange(0L, 1L, boxHeightStyle: BoxHeightStyle.strut);
    ...
    internal virtual _LineCaretMetrics__text_painter? _computeCaretMetrics(TextPosition position)
    {
        ...
        var (offset__60617, anchorToLeadingEdge__60630) = (position switch { global::Doroti.Flutter.Ui.TextPosition { offset: 0L } __object60679 => (((long, bool))((0L, true))), global::Doroti.Flutter.Ui.TextPosition { offset: long offset__60878, affinity: TextAffinity.downstream } __object60854 => (((long, bool))((offset__60878, true))), global::Doroti.Flutter.Ui.TextPosition { offset: long offset__60970, affinity: TextAffinity.upstream } __object60946 when _isNewlineAtOffset((offset__60970 - 1L)) => (((long, bool))((offset__60970, true))), global::Doroti.Flutter.Ui.TextPosition { offset: long offset__61114, affinity: TextAffinity.upstream } __object61090 => (((long, bool))(((offset__61114 - 1L), false))), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        ...
        global::Doroti.Flutter.Ui.GlyphInfo? glyphInfo__61403 = ((_TextPainterLayoutCacheWithOffset__text_painter)cachedLayout__60322).paragraph.getGlyphInfoAt(offset__60617);
        if ((glyphInfo__61403 is null))
        {
            global::Doroti.Flutter.Ui.Paragraph template__61807 = _getOrCreateLayoutTemplate();
            ...
            return ((_TextPainterLayoutCacheWithOffset__text_painter)cachedLayout__60322).layout._endOfTextCaretMetrics.shift(new global::Doroti.Flutter.Ui.Offset(0.0, -baselineOffset__61910));
        }
        global::Doroti.Flutter.Ui.TextRange graphemeRange__62087 = glyphInfo__61403.graphemeClusterCodeUnitRange;
        if (graphemeRange__62087.isCollapsed)
        {
            DartRuntimePrimitives.Assert(() => (graphemeRange__62087.start == 0L));
            return _computeCaretMetrics(new global::Doroti.Flutter.Ui.TextPosition(offset: (offset__60617 + 1L)));
        }
        if ((anchorToLeadingEdge__60630 && (graphemeRange__62087.start != offset__60617)))
        {
            ...
            return _computeCaretMetrics(new global::Doroti.Flutter.Ui.TextPosition(offset: graphemeRange__62087.end));
        }
        _LineCaretMetrics__text_painter metrics__62869 = default!;
        List<global::Doroti.Flutter.Ui.TextBox> boxes__62902 = ((_TextPainterLayoutCacheWithOffset__text_painter)cachedLayout__60322).paragraph.getBoxesForRange(graphemeRange__62087.start, graphemeRange__62087.end, boxHeightStyle: Dart_uiLibrary.BoxHeightStyle.strut);
        ...
        global::Doroti.Flutter.Ui.TextBox box__63248 = (anchorToLeft__63073 ? boxes__62902.First() : boxes__62902.Last());
        metrics__62869 = new _LineCaretMetrics__text_painter(offset: new global::Doroti.Flutter.Ui.Offset((anchorToLeft__63073 ? box__63248.left : box__63248.right), box__63248.top), writingDirection: box__63248.direction, height: (box__63248.bottom - box__63248.top));
    ...
    public virtual List<global::Doroti.Flutter.Ui.TextBox> getBoxesForSelection(TextSelection selection, BoxHeightStyle boxHeightStyle = BoxHeightStyle.tight, BoxWidthStyle boxWidthStyle = BoxWidthStyle.tight)
    {
        ...
        global::Doroti.Flutter.Ui.Offset offset__64868 = ((_TextPainterLayoutCacheWithOffset__text_painter)cachedLayout__64821).paintOffset;
        if ((!double.IsFinite(offset__64868.dx) || !double.IsFinite(offset__64868.dy)))
        {
            return new List<global::Doroti.Flutter.Ui.TextBox>();
        }
        List<global::Doroti.Flutter.Ui.TextBox> boxes__65013 = ((_TextPainterLayoutCacheWithOffset__text_painter)cachedLayout__64821).paragraph.getBoxesForRange(selection.start, selection.end, boxHeightStyle: boxHeightStyle, boxWidthStyle: boxWidthStyle);
    ...
    public virtual global::Doroti.Flutter.Ui.GlyphInfo? getClosestGlyphForOffset(Offset offset)
    {
        DartRuntimePrimitives.Assert(() => this._debugAssertTextLayoutIsValid);
        DartRuntimePrimitives.Assert(() => !this._debugNeedsRelayout);
        _TextPainterLayoutCacheWithOffset__text_painter cachedLayout__65854 = this._layoutCache!;
        global::Doroti.Flutter.Ui.GlyphInfo? rawGlyphInfo__65908 = ((_TextPainterLayoutCacheWithOffset__text_painter)cachedLayout__65854).paragraph.getClosestGlyphInfoForOffset((offset - ((_TextPainterLayoutCacheWithOffset__text_painter)cachedLayout__65854).paintOffset));
        ...
        return new global::Doroti.Flutter.Ui.GlyphInfo(rawGlyphInfo__65908.graphemeClusterLayoutBounds.shift(((_TextPainterLayoutCacheWithOffset__text_painter)cachedLayout__65854).paintOffset), rawGlyphInfo__65908.graphemeClusterCodeUnitRange, rawGlyphInfo__65908.writingDirection);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual global::Doroti.Flutter.Ui.TextRange getLineBoundary(TextPosition position)
    {
        DartRuntimePrimitives.Assert(() => this._debugAssertTextLayoutIsValid);
    ...
    internal static global::Doroti.Flutter.Ui.LineMetrics _shiftLineMetrics(LineMetrics metrics, Offset offset)
    {
        DartRuntimePrimitives.Assert(() => double.IsFinite(offset.dx));
        DartRuntimePrimitives.Assert(() => double.IsFinite(offset.dy));
        return new global::Doroti.Flutter.Ui.LineMetrics(hardBreak: metrics.hardBreak, ascent: metrics.ascent, descent: metrics.descent, unscaledAscent: metrics.unscaledAscent, height: metrics.height, width: metrics.width, left: (metrics.left + offset.dx), baseline: (metrics.baseline + offset.dy), lineNumber: metrics.lineNumber);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal static global::Doroti.Flutter.Ui.TextBox _shiftTextBox(TextBox box, Offset offset)
    {
        DartRuntimePrimitives.Assert(() => double.IsFinite(offset.dx));
        DartRuntimePrimitives.Assert(() => double.IsFinite(offset.dy));
        return new global::Doroti.Flutter.Ui.TextBox((box.left + offset.dx), (box.top + offset.dy), (box.right + offset.dx), (box.bottom + offset.dy), box.direction);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual List<global::Doroti.Flutter.Ui.LineMetrics> computeLineMetrics()
    {
        DartRuntimePrimitives.Assert(() => this._debugAssertTextLayoutIsValid);
        DartRuntimePrimitives.Assert(() => !this._debugNeedsRelayout);
        _TextPainterLayoutCacheWithOffset__text_painter layout__69725 = this._layoutCache!;
        global::Doroti.Flutter.Ui.Offset offset__69766 = ((_TextPainterLayoutCacheWithOffset__text_painter)layout__69725).paintOffset;
        if ((!double.IsFinite(offset__69766.dx) || !double.IsFinite(offset__69766.dy)))
        {
            return new List<global::Doroti.Flutter.Ui.LineMetrics>();
        }
        List<global::Doroti.Flutter.Ui.LineMetrics> rawMetrics__69925 = ((_TextPainterLayoutCacheWithOffset__text_painter)layout__69725).lineMetrics;
