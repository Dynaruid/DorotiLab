...
public class LinearBorder : OutlinedBorder
{
    ...
    {
        global::Doroti.Flutter.Ui.Rect adjustedRect__8845 = this.dimensions.resolve(textDirection).deflateRect(rect);
        return ((Func<Path>)(() =>
{
        ...
        return ((Func<Path>)(() =>
{
    ...
    public override void paint(Canvas canvas, Rect rect, TextDirection? textDirection = null, BoxShape shape = BoxShape.rectangle, BorderRadius? borderRadius = null)
    {
        ...
        var path__9289 = new global::Doroti.Flutter.Ui.Path();
        var paint__9314 = ((Func<Paint>)(() =>
{
    ...
    return __cascade;
        ...
        {
            var insetRect__10063 = global::Doroti.Flutter.Ui.Rect.fromLTWH(rect.left, (rect.top + ((EdgeInsets)insets__9182).top), rect.width, (rect.height - insets__9182.vertical));
            ...
            var r__10496 = global::Doroti.Flutter.Ui.Rect.fromLTWH(x__10227, y__10416, width__10295, height__10356);
        ...
        {
            var insetRect__10663 = global::Doroti.Flutter.Ui.Rect.fromLTWH(rect.left, (rect.top + ((EdgeInsets)insets__9182).top), rect.width, (rect.height - insets__9182.vertical));
            ...
            var r__11092 = global::Doroti.Flutter.Ui.Rect.fromLTWH(x__10827, y__11014, width__10895, height__10956);
        ...
        if ((((this.top is not null) && (this.top!.size != 0.0)) && (!object.Equals(((BorderSide)side).style, BorderStyle.none))))
        {
            ...
            var r__11460 = global::Doroti.Flutter.Ui.Rect.fromLTWH(x__11400, rect.top, width__11266, ((EdgeInsets)insets__9182).top);
        ...
        if ((((this.bottom is not null) && (this.bottom!.size != 0.0)) && (!object.Equals(((BorderSide)side).style, BorderStyle.none))))
        {
            ...
            var r__11851 = global::Doroti.Flutter.Ui.Rect.fromLTWH(x__11791, (rect.bottom - ((EdgeInsets)insets__9182).bottom), width__11651, ((BorderSide)side).width);
