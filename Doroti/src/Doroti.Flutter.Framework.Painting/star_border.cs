...
public class StarBorder : OutlinedBorder
{
    ...
    public virtual double innerRadiusRatio
    {
        get
        {
            return (this._innerRadiusRatio ?? global::Doroti.Flutter.Runtime.Dart_mathLibrary.cos((Dart_mathLibrary.pi / this.points)));
            return default!;
        }
    }
    ...
    public override ShapeBorder? lerpFrom(ShapeBorder? a, double t)
    {
        ...
        if ((a is CircleBorder))
        {
            ...
            if ((this.points >= 2.5))
            {
                ...
                return new StarBorder(side: BorderSide.lerp(((CircleBorder)a__as8105).side, side, t), points: lerpedPoints__8174, squash: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(((CircleBorder)((CircleBorder)a__as8105)).eccentricity, this.squash, t)), rotation: this.rotation, innerRadiusRatio: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(global::Doroti.Flutter.Runtime.Dart_mathLibrary.cos((Dart_mathLibrary.pi / lerpedPoints__8174)), this.innerRadiusRatio, t)), pointRounding: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(1.0, this.pointRounding, t)), valleyRounding: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(0.0, this.valleyRounding, t)));
            }
            else
            {
    ...
    public override ShapeBorder? lerpTo(ShapeBorder? b, double t)
    {
        ...
        if ((b is CircleBorder))
        {
            ...
            if ((this.points >= 2.5))
            {
                ...
                return new StarBorder(side: BorderSide.lerp(side, ((CircleBorder)b__as11105).side, t), points: lerpedPoints__11314, squash: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(this.squash, ((CircleBorder)((CircleBorder)b__as11105)).eccentricity, t)), rotation: this.rotation, innerRadiusRatio: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(this.innerRadiusRatio, global::Doroti.Flutter.Runtime.Dart_mathLibrary.cos((Dart_mathLibrary.pi / lerpedPoints__11314)), t)), pointRounding: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(this.pointRounding, 1.0, t)), valleyRounding: DartRuntimePrimitives.RequireValue(Dart_uiLibrary.lerpDouble(this.valleyRounding, 0.0, t)));
            }
            else
            {
    ...
    {
        global::Doroti.Flutter.Ui.Rect adjustedRect__14022 = rect.deflate(((BorderSide)side).strokeInset);
    ...
    public override void paint(Canvas canvas, Rect rect, TextDirection? textDirection = null, BoxShape shape = BoxShape.rectangle, BorderRadius? borderRadius = null)
    {
        switch (((BorderSide)side).style)
        {
            ...
            case BorderStyle.solid:
                {
                    global::Doroti.Flutter.Ui.Rect adjustedRect__14854 = rect.inflate((((BorderSide)side).strokeOffset / 2L));
                    global::Doroti.Flutter.Ui.Path path__14925 = new _StarGenerator__star_border(points: this.points, rotation: this._rotationRadians, innerRadiusRatio: this.innerRadiusRatio, pointRounding: this.pointRounding, valleyRounding: this.valleyRounding, squash: this.squash).generate(adjustedRect__14854);
...
internal class _StarGenerator__star_border
{
    ...
    public virtual global::Doroti.Flutter.Ui.Path generate(Rect rect)
    {
        double radius__17050 = (rect.shortestSide / 2L);
        global::Doroti.Flutter.Ui.Offset center__17099 = rect.center;
        ...
        var path__18169 = new global::Doroti.Flutter.Ui.Path();
        _drawPoints(path__18169, points__17843);
        var scale__18224 = new global::Doroti.Flutter.Ui.Offset((rect.width / maxDiameter__17885), (rect.height / maxDiameter__17885));
        if ((rect.shortestSide == rect.width))
        {
            scale__18224 = new global::Doroti.Flutter.Ui.Offset(scale__18224.dx, ((this.squash * scale__18224.dy) + (((1L - this.squash)) * scale__18224.dx)));
        }
        else
        {
            scale__18224 = new global::Doroti.Flutter.Ui.Offset(((this.squash * scale__18224.dx) + (((1L - this.squash)) * scale__18224.dy)), scale__18224.dy);
        }
    ...
    internal virtual double _generatePoints(List<_PointInfo__star_border> pointList, Offset center, double radius, double innerRadius)
    {
        ...
        var valley__19353 = new global::Doroti.Flutter.Ui.Offset((center.dx + (global::Doroti.Flutter.Runtime.Dart_mathLibrary.cos(angle__19316) * innerRadius)), (center.dy + (global::Doroti.Flutter.Runtime.Dart_mathLibrary.sin(angle__19316) * innerRadius)));
        ...
        double addPoint(double pointAngle, double pointStep, double pointRadius, double pointInnerRadius)
        {
            ...
            var point__20171 = new global::Doroti.Flutter.Ui.Offset((center.dx + (global::Doroti.Flutter.Runtime.Dart_mathLibrary.cos(pointAngle) * pointRadius)), (center.dy + (global::Doroti.Flutter.Runtime.Dart_mathLibrary.sin(pointAngle) * pointRadius)));
            pointAngle += pointStep;
            var nextValley__20351 = new global::Doroti.Flutter.Ui.Offset((center.dx + (global::Doroti.Flutter.Runtime.Dart_mathLibrary.cos(pointAngle) * pointInnerRadius)), (center.dy + (global::Doroti.Flutter.Runtime.Dart_mathLibrary.sin(pointAngle) * pointInnerRadius)));
            global::Doroti.Flutter.Ui.Offset valleyArc1__20522 = (valley__19353 + (((point__20171 - valley__19353)) * this.valleyRounding));
            global::Doroti.Flutter.Ui.Offset pointArc1__20598 = (point__20171 + (((valley__19353 - point__20171)) * this.pointRounding));
            global::Doroti.Flutter.Ui.Offset pointArc2__20671 = (point__20171 + (((nextValley__20351 - point__20171)) * this.pointRounding));
            global::Doroti.Flutter.Ui.Offset valleyArc2__20748 = (nextValley__20351 + (((point__20171 - nextValley__20351)) * this.valleyRounding));
        ...
        global::Doroti.Flutter.Ui.Offset pointMidpoint__21578 = getCurveMidpoint(((_PointInfo__star_border)thisPoint__21487).valley, ((_PointInfo__star_border)thisPoint__21487).point, ((_PointInfo__star_border)nextPoint__21534).valley, ((_PointInfo__star_border)thisPoint__21487).pointArc1, ((_PointInfo__star_border)thisPoint__21487).pointArc2);
        global::Doroti.Flutter.Ui.Offset valleyMidpoint__21761 = getCurveMidpoint(((_PointInfo__star_border)thisPoint__21487).point, ((_PointInfo__star_border)nextPoint__21534).valley, ((_PointInfo__star_border)nextPoint__21534).point, ((_PointInfo__star_border)thisPoint__21487).valleyArc2, ((_PointInfo__star_border)nextPoint__21534).valleyArc1);
    ...
    {
        global::Doroti.Flutter.Ui.Offset startingPoint__23013 = points.First().pointArc1;
    ...
    {
        return global::Doroti.Flutter.Runtime.Dart_mathLibrary.cos((((angle / 2L)) % ((Dart_mathLibrary.pi / 2L))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    internal virtual double _getAngle(Offset a, Offset b, Offset c)
    {
        ...
        global::Doroti.Flutter.Ui.Offset u__24634 = (a - b);
        global::Doroti.Flutter.Ui.Offset v__24662 = (c - b);
        ...
        double angle__24874 = global::Doroti.Flutter.Runtime.Dart_mathLibrary.atan2((m1__24740 - m2__24810), (1L + (m1__24740 * m2__24810))).abs();
        if ((dot__24690 < 0L))
        {
