    ...
    public override Path getClipPath(Rect rect, TextDirection textDirection)
    {
        switch (this.shape)
        {
            case BoxShape.circle:
                {
                    global::Doroti.Flutter.Ui.Offset center__8185 = rect.center;
                    double radius__8228 = (rect.shortestSide / 2.0);
                    var square__8276 = global::Doroti.Flutter.Ui.Rect.fromCircle(center: center__8185, radius: radius__8228);
                    return ((Func<Path>)(() =>
{
        ...
        ((Func<DiagnosticPropertiesBuilder>)(() =>
{
    ...
    public override bool hitTest(Size size, Offset position, TextDirection? textDirection = null)
    {
        ...
        switch (this.shape)
        {
            case BoxShape.rectangle:
                {
                    if ((this.borderRadius is not null))
                    {
                        global::Doroti.Flutter.Ui.RRect bounds__13482 = this.borderRadius!.resolve(textDirection).toRRect((Offset.zero & size));
            ...
            case BoxShape.circle:
                {
                    global::Doroti.Flutter.Ui.Offset center__13743 = size.center(Offset.zero);
...
internal class _BoxDecorationPainter__box_decoration : BoxPainter
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Paint _getBackgroundPaint(Rect rect, TextDirection? textDirection)
    {
        ...
        {
            var paint__14758 = new global::Doroti.Flutter.Ui.Paint();
            ...
            case BoxShape.circle:
                {
                    ...
                    global::Doroti.Flutter.Ui.Offset center__15608 = rect.center;
    ...
    internal virtual void _paintShadows(Canvas canvas, Rect rect, TextDirection? textDirection)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Paint paint__16262 = boxShadow__16205.toPaint();
            global::Doroti.Flutter.Ui.Rect bounds__16308 = rect.shift(boxShadow__16205.offset).inflate(((BoxShadow)boxShadow__16205).spreadRadius);
    ...
    internal virtual void _paintBackgroundColor(Canvas canvas, Rect rect, TextDirection? textDirection)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Rect adjustedRect__17136 = _adjustedRectOnOutlinedBorder(rect, textDirection);
    ...
    internal virtual global::Doroti.Flutter.Ui.Rect _adjustedRectOnOutlinedBorder(Rect rect, TextDirection? textDirection)
    {
        ...
        if ((((BoxDecoration)this._decoration).border is Border))
        {
            ...
            return global::Doroti.Flutter.Ui.Rect.fromLTRB((rect.left + ((EdgeInsets)insets__17747).left), (rect.top + ((EdgeInsets)insets__17747).top), (rect.right - ((EdgeInsets)insets__17747).right), (rect.bottom - ((EdgeInsets)insets__17747).bottom));
        }
        else
        {
            if (((((BoxDecoration)this._decoration).border is BorderDirectional) && (textDirection is not null)))
            {
                ...
                return global::Doroti.Flutter.Ui.Rect.fromLTRB((rect.left + ((EdgeInsets)insets__18553).left), (rect.top + ((EdgeInsets)insets__18553).top), (rect.right - ((EdgeInsets)insets__18553).right), (rect.bottom - ((EdgeInsets)insets__18553).bottom));
            }
        }
        return rect;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    ...
    internal virtual void _paintBackgroundImage(Canvas canvas, Rect rect, ImageConfiguration configuration)
    {
        ...
        global::Doroti.Flutter.Ui.Path? clipPath__19281 = default!;
        switch (((BoxDecoration)this._decoration).shape)
        {
            case BoxShape.circle:
                {
                    DartRuntimePrimitives.Assert(() => (((BoxDecoration)this._decoration).borderRadius is null));
                    global::Doroti.Flutter.Ui.Offset center__19549 = rect.center;
                    double radius__19592 = (rect.shortestSide / 2.0);
                    var square__19640 = global::Doroti.Flutter.Ui.Rect.fromCircle(center: center__19549, radius: radius__19592);
                        ...
                        clipPath__19281 = ((Func<Path>)(() =>
{
    ...
    public override void paint(Canvas canvas, Offset offset, ImageConfiguration configuration)
    {
        ...
        global::Doroti.Flutter.Ui.Rect rect__20375 = (offset & DartRuntimePrimitives.RequireValue(((ImageConfiguration)configuration).size));
        global::Doroti.Flutter.Ui.TextDirection? textDirection__20437 = ((ImageConfiguration)configuration).textDirection;
