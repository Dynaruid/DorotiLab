...
internal class _ShapeDecorationPainter__shape_decoration : BoxPainter
{
    ...
    internal virtual void _precache(Rect rect, TextDirection? textDirection)
    {
        ...
        {
            _interiorPaint = new global::Doroti.Flutter.Ui.Paint();
    ...
    internal virtual void _paintShadows(Canvas canvas, Rect rect, TextDirection? textDirection)
    {
        bool debugHandleDisabledShadowStart(Canvas canvas, BoxShadow boxShadow, Path path)
        {
            ...
            {
                canvas.save();
                var clipPath__14580 = new global::Doroti.Flutter.Ui.Path();
    ...
    internal virtual void _paintInterior(Canvas canvas, Rect rect, TextDirection? textDirection)
    {
        if ((this._interiorPaint is not null))
        {
            if (((ShapeDecoration)this._decoration).shape.preferPaintInterior)
            {
                global::Doroti.Flutter.Ui.Rect adjustedRect__16492 = _adjustedRectOnOutlinedBorder(rect);
    ...
    internal virtual global::Doroti.Flutter.Ui.Rect _adjustedRectOnOutlinedBorder(Rect rect)
    {
    ...
    public override void paint(Canvas canvas, Offset offset, ImageConfiguration configuration)
    {
        ...
        global::Doroti.Flutter.Ui.Rect rect__17698 = (offset & DartRuntimePrimitives.RequireValue(((ImageConfiguration)configuration).size));
        global::Doroti.Flutter.Ui.TextDirection? textDirection__17760 = ((ImageConfiguration)configuration).textDirection;
