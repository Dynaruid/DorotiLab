...
public abstract class ShaderWarmUp
{
    ...
    public virtual global::Doroti.Flutter.Ui.Size size => new global::Doroti.Flutter.Ui.Size(100.0, 100.0);
    public abstract Future warmUpOnCanvas(Canvas canvas);
    public async virtual Future execute()
    {
        var recorder__4062 = new global::Doroti.Flutter.Ui.PictureRecorder();
        var canvas__4105 = new global::Doroti.Flutter.Ui.Canvas(recorder__4062);
        await warmUpOnCanvas(canvas__4105);
        global::Doroti.Flutter.Ui.Picture picture__4190 = recorder__4062.endRecording();
            ...
            debugShaderWarmUpTask__4297 = ((Func<TimelineTask>)(() =>
{
    ...
    return __cascade;
        ...
        try
        {
            global::Doroti.Flutter.Ui.Image image__4453 = await picture__4190.toImage(this.size.width.ceil(), this.size.height.ceil());
