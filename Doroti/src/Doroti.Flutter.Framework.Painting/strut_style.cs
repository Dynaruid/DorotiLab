...
public class StrutStyle : Diagnosticable
{
    ...
    public virtual string toStringShort() => global::Doroti.Generated.Framework.Foundation.objectRuntimeTypeFunctions.objectRuntimeType(this, "StrutStyle");
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties, string prefix = "")
    {
        ...
        styles__25171.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.FontWeight>($"{prefix}weight", this.fontWeight, description: weightDescription__25474, defaultValue: null));
        styles__25171.Add(new EnumProperty<global::Doroti.Flutter.Ui.FontStyle>($"{prefix}style", this.fontStyle, defaultValue: null));
        ...
        if ((this.height is not null))
        {
            ...
            styles__25171.Add(new EnumProperty<global::Doroti.Flutter.Ui.TextLeadingDistribution>($"{prefix}leadingDistribution", this.leadingDistribution, defaultValue: null));
        }
