...
public class Alignment : AlignmentGeometry
{
    ...
    public virtual global::Doroti.Flutter.Ui.Offset alongOffset(Offset other)
    {
        double centerX__14331 = (other.dx / 2.0);
        double centerY__14374 = (other.dy / 2.0);
        return new global::Doroti.Flutter.Ui.Offset((centerX__14331 + (this.x * centerX__14331)), (centerY__14374 + (this.y * centerY__14374)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual global::Doroti.Flutter.Ui.Offset alongSize(Size other)
    {
        double centerX__14590 = (other.width / 2.0);
        double centerY__14636 = (other.height / 2.0);
        return new global::Doroti.Flutter.Ui.Offset((centerX__14590 + (this.x * centerX__14590)), (centerY__14636 + (this.y * centerY__14636)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual global::Doroti.Flutter.Ui.Offset withinRect(Rect rect)
    {
        double halfWidth__14855 = (rect.width / 2.0);
        double halfHeight__14902 = (rect.height / 2.0);
        return new global::Doroti.Flutter.Ui.Offset(((rect.left + halfWidth__14855) + (this.x * halfWidth__14855)), ((rect.top + halfHeight__14902) + (this.y * halfHeight__14902)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual global::Doroti.Flutter.Ui.Rect inscribe(Size size, Rect rect)
    {
        double halfWidthDelta__15367 = (((rect.width - size.width)) / 2.0);
        double halfHeightDelta__15434 = (((rect.height - size.height)) / 2.0);
        return global::Doroti.Flutter.Ui.Rect.fromLTWH(((rect.left + halfWidthDelta__15367) + (this.x * halfWidthDelta__15367)), ((rect.top + halfHeightDelta__15434) + (this.y * halfHeightDelta__15434)), size.width, size.height);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
