...
public abstract class AssetBundleImageProvider : ImageProvider<AssetBundleImageKey>
{
    ...
    internal async virtual Future<global::Doroti.Flutter.Ui.Codec> _loadAsync(AssetBundleImageKey key, Func<ImmutableBuffer, Future<Codec>> decode)
    {
        global::Doroti.Flutter.Ui.ImmutableBuffer buffer__28251 = default!;
        try
        {
                    ...
                    case ResizeImagePolicy.exact:
                        {
                            ...
                            return new global::Doroti.Flutter.Ui.TargetImageSize(width: targetWidth__43553, height: targetHeight__43593);
                        }
                    case ResizeImagePolicy.fit:
                        {
                            ...
                            return new global::Doroti.Flutter.Ui.TargetImageSize(width: targetWidth__44297, height: targetHeight__44345);
                        }
                }
                return default;
            }));
...
{
    public virtual global::Doroti.Flutter.Runtime.DartFile file { get; private set; } = default!;
    public virtual double scale { get; private set; } = default!;

    public FileImage(global::Doroti.Flutter.Runtime.DartFile file, double scale = 1.0)
    {
        this.file = file;
        this.scale = scale;
    }
    ...
    internal async virtual Future<global::Doroti.Flutter.Ui.Codec> _loadAsync(FileImage key, Func<ImmutableBuffer, Future<Codec>> decode)
    {
        ...
        return await (((object.Equals(DartRuntimePrimitives.RuntimeType(this.file), typeof(global::Doroti.Flutter.Runtime.DartFile)))) ? decode(await Dart_uiLibrary.ImmutableBuffer.fromFilePath(this.file.path)) : decode(await Dart_uiLibrary.ImmutableBuffer.fromUint8List(await this.file.readAsBytes())));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class MemoryImage : ImageProvider<MemoryImage>
{
    ...
    internal async virtual Future<global::Doroti.Flutter.Ui.Codec> _loadAsync(MemoryImage key, Func<ImmutableBuffer, Future<Codec>> decode)
    {
        DartRuntimePrimitives.Assert(() => (object.Equals(key, this)));
