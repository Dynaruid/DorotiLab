...
public abstract class BorderRadiusGeometry
{
    ...
    internal abstract global::Doroti.Flutter.Ui.Radius _topLeft { get; }
    internal abstract global::Doroti.Flutter.Ui.Radius _topRight { get; }
    internal abstract global::Doroti.Flutter.Ui.Radius _bottomLeft { get; }
    internal abstract global::Doroti.Flutter.Ui.Radius _bottomRight { get; }
    internal abstract global::Doroti.Flutter.Ui.Radius _topStart { get; }
    internal abstract global::Doroti.Flutter.Ui.Radius _topEnd { get; }
    internal abstract global::Doroti.Flutter.Ui.Radius _bottomStart { get; }
    internal abstract global::Doroti.Flutter.Ui.Radius _bottomEnd { get; }
...
public class BorderRadius : BorderRadiusGeometry
{
    ...
    {
        return BorderRadius.CreateAll(global::Doroti.Flutter.Ui.Radius.circular(radius));
    }
    ...
    public virtual global::Doroti.Flutter.Ui.RRect toRRect(Rect rect)
    {
        return global::Doroti.Flutter.Ui.RRect.fromRectAndCorners(rect, topLeft: this.topLeft.clamp(minimum: Radius.zero), topRight: this.topRight.clamp(minimum: Radius.zero), bottomLeft: this.bottomLeft.clamp(minimum: Radius.zero), bottomRight: this.bottomRight.clamp(minimum: Radius.zero));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual global::Doroti.Flutter.Ui.RSuperellipse toRSuperellipse(Rect rect)
    {
        return global::Doroti.Flutter.Ui.RSuperellipse.fromRectAndCorners(rect, topLeft: this.topLeft.clamp(minimum: Radius.zero), topRight: this.topRight.clamp(minimum: Radius.zero), bottomLeft: this.bottomLeft.clamp(minimum: Radius.zero), bottomRight: this.bottomRight.clamp(minimum: Radius.zero));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class BorderRadiusDirectional : BorderRadiusGeometry
{
    ...
    {
        return BorderRadiusDirectional.CreateAll(global::Doroti.Flutter.Ui.Radius.circular(radius));
    }
