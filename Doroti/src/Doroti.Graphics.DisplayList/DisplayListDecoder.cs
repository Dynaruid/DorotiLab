...
public static class DisplayListDecoder
{
    ...
    public static DisplayListDecodeResult Decode(ReadOnlySpan<byte> buffer)
    {
        ...
        try
        {
            ...
            {
                throw reader.Error(
                    DisplayListFailureCode.InvalidMagic,
                    0,
                    "The DisplayList magic is not 'DLST'."
                );
            }
            ...
            {
                throw reader.Error(
                    DisplayListFailureCode.UnknownFlags,
                    12,
                    "The DisplayList header contains unknown flag bits."
                );
            }
            ...
            if (reserved != 0)
            {
                throw reader.Error(
                    ...
                    108,
                    "The DisplayList header reserved field must be zero."
                );
            }
            ...
            resourceReader.RequireFinished(
                DisplayListFailureCode.InvalidResource,
                "The resource table contains trailing bytes."
            );
            ...
            stringReader.RequireFinished(
                DisplayListFailureCode.InvalidString,
                "The string table contains trailing bytes."
            );
            ...
            commandReader.RequireFinished(
                DisplayListFailureCode.InvalidCommand,
                "The command table contains trailing bytes."
            );
            reader.RequireFinished(
                DisplayListFailureCode.LengthMismatch,
                "The DisplayList contains bytes beyond its declared sections."
            );
    ...
    )
    {
        ...
        return DisplayListDecodeResult.Failed(
            new DisplayListFailure(code, offset, message, terminal)
        );
    }
    ...
    private static ulong TryReadSceneSequence(ReadOnlySpan<byte> buffer)
    {
        if (
            buffer.Length < 32
            || BinaryPrimitives.ReadUInt32LittleEndian(buffer) != DisplayListFormat.Magic
        )
        {
            return 0;
        }
    ...
    )
    {
        ...
        {
            throw reader.Error(
                DisplayListFailureCode.LimitExceeded,
                8,
        ...
        if (stringTableByteLength > DisplayListFormat.MaximumStringTableByteLength)
        {
            throw reader.Error(
                DisplayListFailureCode.LimitExceeded,
                92,
                "The DisplayList string-table limit was exceeded."
            );
        }
        ...
        var expectedLength =
            (ulong)DisplayListFormat.HeaderSize
            + resourceTableByteLength
            + stringTableByteLength
            + commandByteLength;
    ...
    )
    {
        ...
        for (var index = 0u; index < count; index++)
        {
            ...
            var reference = new DisplayResourceReference(ReadResourceKind(ref reader), 0, 0);
            var flags = (DisplayResourceFlags)reader.ReadUInt16();
            reference = reference with { Version = reader.ReadUInt32(), Id = reader.ReadUInt64() };
            ...
            if ((flags & ~KnownResourceFlags) != 0)
            {
                throw reader.Error(
                    DisplayListFailureCode.InvalidResource,
                    offset + 2,
                    "A resource contains unknown flag bits."
                );
            }
            ...
            if (previous is { } previousReference)
            {
                ...
                {
                    throw reader.Error(
                        DisplayListFailureCode.DuplicateResource,
                        offset,
                        "A resource is declared more than once."
                    );
                }
    ...
    private static int CompareResource(
        DisplayResourceReference left,
        DisplayResourceReference right
    )
    {
        ...
        while (reader.Remaining != 0)
        {
            if (result.Count >= DisplayListFormat.MaximumCollectionCount)
            {
                throw reader.Error(
                    ...
                    "The DisplayList string count limit was exceeded."
                );
            }
            ...
            if (length > reader.Remaining)
            {
                throw reader.Error(
                    ...
                    lengthOffset,
                    "A string extends beyond the string-table bounds."
                );
            }
    ...
    )
    {
        ...
        for (var index = 0u; index < count; index++)
        {
            ...
            var command = ReadCommandPayload(
                ref payloadReader,
                (DisplayListOpcode)rawOpcode,
                context
            );
    ...
    private static DisplayListCommand ReadCommandPayload(
        ...
        opcode switch
        {
            ...
            DisplayListOpcode.DrawPaint => new DisplayDrawPaintCommand(
            ...
            _ => throw reader.Error(
                DisplayListFailureCode.UnknownOpcode,
                reader.AbsoluteOffset,
                $"DisplayList opcode {opcode} is unknown."
            ),
        };
    ...
    private static DisplayClipRectCommand ReadClipRect(ref DisplayListBinaryReader reader)
    {
        ...
        RequireZero(
            reader.ReadUInt16(),
            reader.AbsoluteOffset - 2,
            "clip-rect reserved field",
            ref reader
        );
        return result;
    }

    private static DisplayClipRoundedRectCommand ReadClipRoundedRect(
        ref DisplayListBinaryReader reader
    )
    {
        ...
        RequireZero(
            reader.ReadUInt16(),
            reader.AbsoluteOffset - 2,
            "clip-rounded-rect reserved field",
            ref reader
        );
        return result;
    }
    ...
    )
    {
        ...
        if ((long)count * 8 > reader.Remaining)
        {
            throw reader.Error(
                DisplayListFailureCode.BoundsExceeded,
                reader.AbsoluteOffset,
                "The point array exceeds the command payload."
            );
        }
    ...
    )
    {
        ...
        )
        {
            throw reader.Error(
                DisplayListFailureCode.InvalidValue,
                hintOffset,
                "The retained-scene cache hint contains unknown bits."
            );
        }
    ...
    )
    {
        ...
        if ((long)fallbackCount * 16 > reader.Remaining)
        {
            throw reader.Error(
                DisplayListFailureCode.BoundsExceeded,
                reader.AbsoluteOffset,
                "The fallback-font array exceeds the command payload."
            );
        }
        ...
        for (var index = 0; index < runCount; index++)
        {
            ...
            bool? halfLeading = reader.ReadByte() switch
            {
                ...
                1 => false,
                2 => true,
                var value => throw reader.Error(
                    DisplayListFailureCode.InvalidValue,
                    reader.AbsoluteOffset - 1,
                    $"Run half-leading state {value} is invalid."
                ),
            };
            ...
            for (var featureIndex = 0; featureIndex < featureCount; featureIndex++)
            {
                features[featureIndex] = new DisplayFontFeature(
                    context.ReadString(ref reader, false)!,
                    reader.ReadInt32()
                );
            }
        ...
        if (
            textRuns.Length != 0
            && !string.Equals(
                string.Concat(textRuns.Select(run => run.Text)),
                text,
    ...
    )
    {
        ...
        return tag switch
        {
            ...
            0 => throw reader.Error(
                DisplayListFailureCode.InvalidValue,
                tagOffset,
                "A required shader cannot use the null tag."
            ),
            ...
            _ => throw reader.Error(
                DisplayListFailureCode.InvalidValue,
                tagOffset,
                $"Shader tag {tag} is unknown."
            ),
        };
    }

    private static DisplayLinearGradientShader ReadLinearGradient(
        ref DisplayListBinaryReader reader
    )
    {
        ...
        return new DisplayLinearGradientShader(
            start,
            end,
            colors,
            stops,
    ...
    private static DisplayRadialGradientShader ReadRadialGradient(
        ref DisplayListBinaryReader reader
    )
    {
    ...
    private static DisplaySweepGradientShader ReadSweepGradient(ref DisplayListBinaryReader reader)
    {
        ...
        var tile = ReadEnumByte<DisplayTileMode>(ref reader, "tile mode");
        var (colors, stops) = ReadGradient(ref reader);
        return new DisplaySweepGradientShader(
            center,
            start,
            end,
            colors,
    ...
    )
    {
        ...
        if (uniformCount > reader.Remaining)
        {
            throw reader.Error(
                DisplayListFailureCode.BoundsExceeded,
                reader.AbsoluteOffset,
                "The uniform byte array exceeds the command payload."
            );
        }
        ...
        if ((long)childCount * 16 > reader.Remaining)
        {
            throw reader.Error(
                DisplayListFailureCode.BoundsExceeded,
                reader.AbsoluteOffset,
                "The runtime-effect child array exceeds the command payload."
            );
        }
    ...
    private static (uint[] Colors, float[] Stops) ReadGradient(ref DisplayListBinaryReader reader)
    {
        ...
        if (count < 2)
        {
            throw reader.Error(
                DisplayListFailureCode.InvalidValue,
                reader.AbsoluteOffset - sizeof(uint),
        ...
        if ((long)count * 8 > reader.Remaining)
        {
            throw reader.Error(
                DisplayListFailureCode.BoundsExceeded,
                reader.AbsoluteOffset,
                "The gradient array exceeds the command payload."
            );
        }
        ...
        for (var index = 0; index < count; index++)
        {
            ...
            if (stops[index] < previous)
            {
                throw reader.Error(
                    DisplayListFailureCode.InvalidValue,
                    stopOffset,
                    "Gradient stops must be nondecreasing."
                );
            }
    ...
    )
    {
        ...
        return tag switch
        {
            ...
            0 => throw reader.Error(
                DisplayListFailureCode.InvalidValue,
                tagOffset,
                "A required color filter cannot use the null tag."
            ),
            ...
            _ => throw reader.Error(
                DisplayListFailureCode.InvalidValue,
                tagOffset,
                $"Color-filter tag {tag} is unknown."
            ),
        };
    }
    ...
    )
    {
        ...
        return tag switch
        {
            ...
            0 => throw reader.Error(
                DisplayListFailureCode.InvalidValue,
                tagOffset,
                "A required image filter cannot use the null tag."
            ),
            ...
            2 => new DisplayColorImageFilter(
                ReadRequiredColorFilter(ref reader, context, depth + 1)
            ),
            ...
            _ => throw reader.Error(
                DisplayListFailureCode.InvalidValue,
                tagOffset,
                $"Image-filter tag {tag} is unknown."
            ),
        };
    }
    ...
    private static DisplayPath ReadPath(ref DisplayListBinaryReader reader)
    {
        ...
        if (verbCount > reader.Remaining)
        {
            throw reader.Error(
                DisplayListFailureCode.BoundsExceeded,
                reader.AbsoluteOffset,
                "The path verb stream exceeds the command payload."
            );
        }
        ...
        if ((long)valueCount * sizeof(float) > reader.Remaining)
        {
            throw reader.Error(
                DisplayListFailureCode.BoundsExceeded,
                reader.AbsoluteOffset,
                "The path value stream exceeds the command payload."
            );
        }
    ...
    private static float[] ReadSingles(ref DisplayListBinaryReader reader, int count)
    {
        if ((long)count * sizeof(float) > reader.Remaining)
        {
            throw reader.Error(
                DisplayListFailureCode.BoundsExceeded,
                reader.AbsoluteOffset,
                "A float array exceeds the command payload."
            );
        }
    ...
    private static int ReadCount(ref DisplayListBinaryReader reader, string name)
    {
        ...
        if (count > DisplayListFormat.MaximumCollectionCount)
        {
            throw reader.Error(
                DisplayListFailureCode.LimitExceeded,
                offset,
                $"The DisplayList {name} count limit was exceeded."
            );
        }
    ...
    private static TEnum ReadEnumByte<TEnum>(ref DisplayListBinaryReader reader, string name)
    ...
    )
    {
        if (reference.Id == 0 || reference.Version == 0)
        {
            throw reader.Error(
                DisplayListFailureCode.InvalidResource,
                offset,
                "Resource id and version must be nonzero."
            );
        }
    ...
    private static void RequireDepth(int depth, ref DisplayListBinaryReader reader)
    {
        if (depth > DisplayListFormat.MaximumNestingDepth)
        {
            throw reader.Error(
                DisplayListFailureCode.LimitExceeded,
                reader.AbsoluteOffset,
                "The tagged-value nesting limit was exceeded."
            );
        }
    }
    ...
    )
    {
        ...
        )
        {
            ...
            RequireZero(
                reader.ReadUInt16(),
                reader.AbsoluteOffset - 2,
                "resource-reference reserved field",
                ref reader
            );
        ...
        internal string? ReadString(ref DisplayListBinaryReader reader, bool allowNull)
        {
            ...
            if (id >= strings.Count)
            {
                throw reader.Error(
                    DisplayListFailureCode.InvalidString,
                    offset,
                    $"String-table id {id} is not declared."
                );
            }
