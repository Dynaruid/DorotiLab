...
public sealed class Scene : IDisposable
{
    ...
    public Doroti.Flutter.Runtime.Future<Image> toImage(long width, long height) =>
        Doroti.Flutter.Runtime.Future<Image>.value(toImageSync(width, height));
...
public sealed class Image : IDisposable
{
    ...
    public Image clone()
    {
        if (HostHandle is IFlutterImageHandle handle)
        {
