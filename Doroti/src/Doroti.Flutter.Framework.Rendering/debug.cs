        ...
        DartRuntimePrimitives.Assert(() =>
            {
                if (((innerRect is not null) && !DartRuntimePrimitives.RequireValue(innerRect).isEmpty))
                {
                    ...
                    DebugLibrary._debugDrawDoubleRect(canvas, outerRect, DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(innerRect__value12483)), new global::Doroti.Flutter.Ui.Color(2415956223L));
                    DebugLibrary._debugDrawDoubleRect(canvas, DartRuntimePrimitives.RequireValue(innerRect__value12483).inflate(outlineWidth).intersect(outerRect), DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(innerRect__value12483)), new global::Doroti.Flutter.Ui.Color(4278227199L));
                }
                else
                {
