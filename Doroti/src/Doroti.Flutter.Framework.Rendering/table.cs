...
public class RenderTable : RenderBox
{
    ...
    public override void assembleSemanticsNode(global::Doroti.Generated.Framework.Semantics.SemanticsNode node, global::Doroti.Generated.Framework.Semantics.SemanticsConfiguration config, IEnumerable<global::Doroti.Generated.Framework.Semantics.SemanticsNode> children)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Offset offset__22262 = ((((((global::Doroti.Generated.Framework.Semantics.SemanticsNode)node).transform is not null) ? MatrixUtils.getAsTranslation(((global::Doroti.Generated.Framework.Semantics.SemanticsNode)node).transform!) : null)) ?? Offset.zero);
        ...
        void shiftTransform(global::Doroti.Generated.Framework.Semantics.SemanticsNode node, double dx, double dy)
        {
            ...
            global::Doroti.Flutter.Ui.Offset offset__23179 = ((((previousTransform__23124 is not null) ? MatrixUtils.getAsTranslation(previousTransform__23124) : null)) ?? Offset.zero);
        ...
        foreach (var child__23457 in children)
        {
            ...
            {
                global::Doroti.Flutter.Ui.Rect rect__23766 = rectWithOffset(child__23457);
        ...
        {
            global::Doroti.Flutter.Ui.Rect rowBox__24043 = getRowBox(y__24001);
                    ...
                    ((Func<global::Doroti.Generated.Framework.Semantics.SemanticsNode>)(() =>
{
    ...
    __cascade.rect = global::Doroti.Flutter.Ui.Rect.fromLTWH(0, 0, cellWidth__25623, rowBox__24043.height);
    return __cascade;
}))();
                }
                foreach (var child__26147 in rawChildrens__24540)
                {
                    ...
                    global::Doroti.Flutter.Ui.Rect localRect__26280 = rectWithOffset(child__26147);
    ...
    __cascade.updateWith(config: ((Func<global::Doroti.Generated.Framework.Semantics.SemanticsConfiguration>)(() =>
{
    ...
    __cascade.rect = global::Doroti.Flutter.Ui.Rect.fromLTWH(0, 0, rowBox__24043.width, rowBox__24043.height);
    return __cascade;
}))();
    ...
    public virtual global::Doroti.Flutter.Ui.Rect getRowBox(long row)
    {
        DartRuntimePrimitives.Assert(() => (row >= 0L));
        DartRuntimePrimitives.Assert(() => (row < this.rows));
        DartRuntimePrimitives.Assert(() => !debugNeedsLayout);
        return global::Doroti.Flutter.Ui.Rect.fromLTRB(0.0, this._rowTops[(int)(row)], size.width, this._rowTops[(int)((row + 1L))]);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override Size computeDryLayout(BoxConstraints constraints)
    {
                ...
                if ((child__45665 is not null))
                {
                    ...
                    switch ((((TableCellParentData)childParentData__45733).verticalAlignment ?? this.defaultVerticalAlignment))
                    {
                        ...
                        case TableCellVerticalAlignment.intrinsicHeight:
                            {
                                global::Doroti.Flutter.Ui.Size childSize__46452 = child__45665.getDryLayout(BoxConstraints.CreateTightFor(width: widths__45343[(int)(x__45570)]));
        ...
        return constraints.constrain(new global::Doroti.Flutter.Ui.Size(tableWidth__45404, rowTop__45474));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override void performLayout()
    {
                        ...
                        case TableCellVerticalAlignment.baseline:
                            {
                                ...
                                else
                                {
                                    ...
                                    childParentData__48546.offset = new global::Doroti.Flutter.Ui.Offset(positions__47371[(int)(x__48383)], rowTop__48089);
                                }
                                break;
                            }
                        case TableCellVerticalAlignment.top:
            ...
            for (var x__50474 = 0L; (x__50474 < DartRuntimePrimitives.RequireValue(columns__46931)); x__50474 += 1L)
            {
                ...
                if ((child__50569 is not null))
                {
                    ...
                    switch ((((TableCellParentData)childParentData__50637).verticalAlignment ?? this.defaultVerticalAlignment))
                    {
                        case TableCellVerticalAlignment.baseline:
                            {
                                childParentData__50637.offset = new global::Doroti.Flutter.Ui.Offset(positions__47371[(int)(x__50474)], ((rowTop__48089 + beforeBaselineDistance__48240) - baselines__48321[(int)(x__50474)]));
                                break;
                            }
                        case TableCellVerticalAlignment.top:
                            {
                                childParentData__50637.offset = new global::Doroti.Flutter.Ui.Offset(positions__47371[(int)(x__50474)], rowTop__48089);
                                break;
                            }
                        case TableCellVerticalAlignment.middle:
                            {
                                childParentData__50637.offset = new global::Doroti.Flutter.Ui.Offset(positions__47371[(int)(x__50474)], (rowTop__48089 + (((rowHeight__48181 - ((RenderBox)child__50569).size.height)) / 2.0)));
                                break;
                            }
                        case TableCellVerticalAlignment.bottom:
                            {
                                childParentData__50637.offset = new global::Doroti.Flutter.Ui.Offset(positions__47371[(int)(x__50474)], ((rowTop__48089 + rowHeight__48181) - ((RenderBox)child__50569).size.height));
                                break;
                            }
                        case TableCellVerticalAlignment.fill:
                        case TableCellVerticalAlignment.intrinsicHeight:
        ...
        this._rowTops.Add(rowTop__48089);
        size = constraints__46853.constrain(new global::Doroti.Flutter.Ui.Size(this._tableWidth, rowTop__48089));
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        if (((this.rows * this.columns) == 0L))
        {
            ...
            {
                var borderRect__52921 = global::Doroti.Flutter.Ui.Rect.fromLTWH(offset.dx, offset.dy, this._tableWidth, 0.0);
        ...
        if ((this._rowDecorations is not null))
        {
            ...
            global::Doroti.Flutter.Ui.Canvas canvas__53338 = ((PaintingContext)context).canvas;
            for (var y__53378 = 0L; (y__53378 < this.rows); y__53378 += 1L)
            {
                ...
                if ((this._rowDecorations![(int)(y__53378)] is not null))
                {
                    ...
                    this._rowDecorationPainters![(int)(y__53378)]!.paint(canvas__53338, new global::Doroti.Flutter.Ui.Offset(offset.dx, (offset.dy + this._rowTops[(int)(y__53378)])), this.configuration.copyWith(size: new global::Doroti.Flutter.Ui.Size(size.width, (this._rowTops[(int)((y__53378 + 1L))] - this._rowTops[(int)(y__53378)]))));
                }
            }
        }
        ...
        if ((this.border is not null))
        {
            var borderRect__54511 = global::Doroti.Flutter.Ui.Rect.fromLTWH(offset.dx, offset.dy, this._tableWidth, this._rowTops.Last());
