...
public abstract class Layer : DiagnosticableTreeMixin
{
    ...
    public virtual global::Doroti.Flutter.Ui.Rect? describeClipBounds() => null;
    ...
    public virtual global::Doroti.Flutter.Ui.EngineLayer? engineLayer
    {
...
public class PictureLayer : Layer
{
    ...
    public virtual global::Doroti.Flutter.Ui.Picture? picture
    {
        get => this._picture;
        set
        {
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Rect>("paint bounds", this.canvasBounds));
...
public class PerformanceOverlayLayer : Layer
{
    ...
    public virtual global::Doroti.Flutter.Ui.Rect overlayRect
    {
...
public class ContainerLayer : Layer
{
    ...
    public virtual global::Doroti.Flutter.Ui.Scene buildScene(SceneBuilder builder)
    {
        ...
        _needsAddToScene = false;
        global::Doroti.Flutter.Ui.Scene scene__41403 = builder.build();
        return scene__41403;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class OffsetLayer : ContainerLayer
{
    ...
    public override void addToScene(SceneBuilder builder)
    {
        engineLayer = builder.pushOffset(this.offset.dx, this.offset.dy, oldLayer: ((global::Doroti.Flutter.Ui.OffsetEngineLayer?)(object?)_engineLayer)!);
        addChildrenToScene(builder);
        builder.pop();
    }
    ...
    internal virtual global::Doroti.Flutter.Ui.Scene _createSceneForImage(Rect bounds, double pixelRatio = 1.0)
    {
        var builder__54038 = new global::Doroti.Flutter.Ui.SceneBuilder();
    ...
    public async virtual Future<global::Doroti.Flutter.Ui.Image> toImage(Rect bounds, double pixelRatio = 1.0)
    {
        global::Doroti.Flutter.Ui.Scene scene__55344 = _createSceneForImage(bounds, pixelRatio: pixelRatio);
        try
        {
    ...
    public virtual global::Doroti.Flutter.Ui.Image toImageSync(Rect bounds, double pixelRatio = 1.0)
    {
        global::Doroti.Flutter.Ui.Scene scene__56760 = _createSceneForImage(bounds, pixelRatio: pixelRatio);
        try
        {
...
public class ClipRectLayer : ContainerLayer
{
    ...
    public virtual global::Doroti.Flutter.Ui.Rect? clipRect
    {
        get => this._clipRect;
        set
        {
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        if (enabled__59084)
        {
            engineLayer = builder.pushClipRect(DartRuntimePrimitives.RequireValue(this.clipRect), clipBehavior: this.clipBehavior, oldLayer: ((global::Doroti.Flutter.Ui.ClipRectEngineLayer?)(object?)_engineLayer)!);
        }
        else
        {
            engineLayer = null;
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Rect>("clipRect", this.clipRect));
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Clip>("clipBehavior", this.clipBehavior));
    }
...
public class ClipRRectLayer : ContainerLayer
{
    ...
    public virtual global::Doroti.Flutter.Ui.RRect? clipRRect
    {
        get => this._clipRRect;
        set
        {
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        if (enabled__61652)
        {
            engineLayer = builder.pushClipRRect(this.clipRRect!, clipBehavior: this.clipBehavior, oldLayer: ((global::Doroti.Flutter.Ui.ClipRRectEngineLayer?)(object?)_engineLayer)!);
        }
        else
        {
            engineLayer = null;
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.RRect>("clipRRect", this.clipRRect));
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Clip>("clipBehavior", this.clipBehavior));
    }
...
public class ClipRSuperellipseLayer : ContainerLayer
{
    ...
    public virtual global::Doroti.Flutter.Ui.RSuperellipse? clipRSuperellipse
    {
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        if (enabled__64482)
        {
            engineLayer = builder.pushClipRSuperellipse(this.clipRSuperellipse!, clipBehavior: this.clipBehavior, oldLayer: ((global::Doroti.Flutter.Ui.ClipRSuperellipseEngineLayer?)(object?)_engineLayer)!);
        }
        else
        {
            engineLayer = null;
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.RSuperellipse>("clipRSuperellipse", this.clipRSuperellipse));
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Clip>("clipBehavior", this.clipBehavior));
    }
...
public class ClipPathLayer : ContainerLayer
{
    ...
    public virtual global::Doroti.Flutter.Ui.Path? clipPath
    {
        get => this._clipPath;
        set
        {
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        if (enabled__67057)
        {
            engineLayer = builder.pushClipPath(this.clipPath!, clipBehavior: this.clipBehavior, oldLayer: ((global::Doroti.Flutter.Ui.ClipPathEngineLayer?)(object?)_engineLayer)!);
        }
        else
        {
            engineLayer = null;
...
public class ColorFilterLayer : ContainerLayer
{
    ...
    public virtual global::Doroti.Flutter.Ui.ColorFilter? colorFilter
    {
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        engineLayer = builder.pushColorFilter(this.colorFilter!, oldLayer: ((global::Doroti.Flutter.Ui.ColorFilterEngineLayer?)(object?)_engineLayer)!);
        addChildrenToScene(builder);
        builder.pop();
    }
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.ColorFilter>("colorFilter", this.colorFilter));
    }
...
public class ImageFilterLayer : OffsetLayer
{
    ...
    public virtual global::Doroti.Flutter.Ui.ImageFilter? imageFilter
    {
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        engineLayer = builder.pushImageFilter(this.imageFilter!, offset: offset, oldLayer: ((global::Doroti.Flutter.Ui.ImageFilterEngineLayer?)(object?)_engineLayer)!);
        addChildrenToScene(builder);
        builder.pop();
    }
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.ImageFilter>("imageFilter", this.imageFilter));
    }
            ...
            _lastEffectiveTransform = ((Func<Matrix4>)(() =>
{
    ...
    return __cascade;
        ...
        engineLayer = builder.pushTransform(this._lastEffectiveTransform!.storage, oldLayer: ((global::Doroti.Flutter.Ui.TransformEngineLayer?)(object?)_engineLayer)!);
        addChildrenToScene(builder);
        builder.pop();
    }

    internal virtual global::Doroti.Flutter.Ui.Offset? _transformOffset(Offset localPosition)
    {
    ...
    public override bool findAnnotations<S>(AnnotationResult<S> result, Offset localPosition, bool onlyFirst)
    {
        global::Doroti.Flutter.Ui.Offset? transformedOffset__72553 = _transformOffset(localPosition);
...
public class OpacityLayer : OffsetLayer
{
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        {
            DartRuntimePrimitives.Assert(() => (_engineLayer is global::Doroti.Flutter.Ui.OpacityEngineLayer));
            engineLayer = builder.pushOpacity(realizedAlpha__74987, offset: offset, oldLayer: ((global::Doroti.Flutter.Ui.OpacityEngineLayer?)(object?)_engineLayer)!);
        }
        else
        {
            DartRuntimePrimitives.Assert(() => (_engineLayer is global::Doroti.Flutter.Ui.OffsetEngineLayer));
            engineLayer = builder.pushOffset(offset.dx, offset.dy, oldLayer: ((global::Doroti.Flutter.Ui.OffsetEngineLayer?)(object?)_engineLayer)!);
        }
        addChildrenToScene(builder);
        builder.pop();
    }
...
public class ShaderMaskLayer : ContainerLayer
{
    ...
    public virtual global::Doroti.Flutter.Ui.Shader? shader
    {
        get => this._shader;
        set
        {
    ...
    public virtual global::Doroti.Flutter.Ui.Rect? maskRect
    {
        get => this._maskRect;
        set
        {
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        engineLayer = builder.pushShaderMask(this.shader!, DartRuntimePrimitives.RequireValue(this.maskRect), DartRuntimePrimitives.RequireValue(this.blendMode), oldLayer: ((global::Doroti.Flutter.Ui.ShaderMaskEngineLayer?)(object?)_engineLayer)!);
        addChildrenToScene(builder);
        builder.pop();
    }
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Shader>("shader", this.shader));
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Rect>("maskRect", this.maskRect));
...
public class BackdropFilterLayer : ContainerLayer
{
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        engineLayer = builder.pushBackdropFilter(this.filter!, blendMode: this.blendMode, oldLayer: ((global::Doroti.Flutter.Ui.BackdropFilterEngineLayer?)(object?)_engineLayer)!, backdropId: this._backdropKey?._key);
        addChildrenToScene(builder);
        builder.pop();
    }
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.ImageFilter>("filter", this.filter));
        properties.add(new EnumProperty<global::Doroti.Flutter.Ui.BlendMode>("blendMode", this.blendMode));
...
public class LeaderLayer : ContainerLayer
{
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        {
            engineLayer = builder.pushTransform(Matrix4.translationValues(this.offset.dx, this.offset.dy, 0.0).storage, oldLayer: ((global::Doroti.Flutter.Ui.TransformEngineLayer?)(object?)_engineLayer)!);
        }
        else
        {
            engineLayer = null;
...
public class FollowerLayer : ContainerLayer
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Offset? _transformOffset(Offset localPosition)
    {
        ...
        return new global::Doroti.Flutter.Ui.Offset((result__91093[(int)(0L)] - DartRuntimePrimitives.RequireValue(this.linkedOffset).dx), (result__91093[(int)(1L)] - DartRuntimePrimitives.RequireValue(this.linkedOffset).dy));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override bool findAnnotations<S>(AnnotationResult<S> result, Offset localPosition, bool onlyFirst)
    {
        ...
        global::Doroti.Flutter.Ui.Offset? transformedOffset__91590 = _transformOffset(localPosition);
    ...
    public override void addToScene(SceneBuilder builder)
    {
        ...
        if ((this._lastTransform is not null))
        {
            ...
            engineLayer = builder.pushTransform(this._lastTransform!.storage, oldLayer: ((global::Doroti.Flutter.Ui.TransformEngineLayer?)(object?)_engineLayer)!);
            addChildrenToScene(builder);
            builder.pop();
        }
        else
        {
            ...
            engineLayer = builder.pushTransform(matrix__98426.storage, oldLayer: ((global::Doroti.Flutter.Ui.TransformEngineLayer?)(object?)_engineLayer)!);
            addChildrenToScene(builder);
            builder.pop();
        }
        _inverseDirty = true;
...
public class AnnotatedRegionLayer<T> : ContainerLayer
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Size>("size", this.size, defaultValue: null));
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Offset>("offset", this.offset, defaultValue: null));
