...
public static partial class Sliver_persistent_headerLibrary
{
    internal static Rect? _trim(Rect? original, double? top = null, double right = double.PositiveInfinity, double bottom = double.PositiveInfinity, double? left = null)
    {
        ...
        return original?.intersect(global::Doroti.Flutter.Ui.Rect.fromLTRB(__left, __top, right, bottom));
    }
}
...
public abstract class RenderSliverPersistentHeader : RenderSliver, RenderObjectWithChildMixin<RenderBox>, RenderSliverHelpers
{
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        {
            offset += (global::Doroti.Generated.Framework.Rendering.SliverLibrary.applyGrowthDirectionToAxisDirection(((SliverConstraints)constraints).axisDirection, ((SliverConstraints)constraints).growthDirection) switch { global::Doroti.Generated.Framework.Painting.AxisDirection.up => new global::Doroti.Flutter.Ui.Offset(0.0, ((geometry!.paintExtent - childMainAxisPosition(child!)) - this.childExtent)), global::Doroti.Generated.Framework.Painting.AxisDirection.left => new global::Doroti.Flutter.Ui.Offset(((geometry!.paintExtent - childMainAxisPosition(child!)) - this.childExtent), 0.0), global::Doroti.Generated.Framework.Painting.AxisDirection.right => new global::Doroti.Flutter.Ui.Offset(childMainAxisPosition(child!), 0.0), global::Doroti.Generated.Framework.Painting.AxisDirection.down => new global::Doroti.Flutter.Ui.Offset(0.0, childMainAxisPosition(child!)), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        ...
        AnimationController effectiveController__23786 = _controller ??= ((Func<AnimationController>)(() =>
{
    ...
    public override void showOnScreen(RenderObject? descendant = null, Rect? rect = null, Duration duration = default, Curve curve = default!)
    {
        ...
        global::Doroti.Flutter.Ui.Rect? childBounds__27993 = ((descendant is not null) ? MatrixUtils.transformRect(descendant.getTransformTo(child), (rect ?? ((RenderObject)descendant).paintBounds)) : rect);
        double targetExtent__28193 = default!;
        global::Doroti.Flutter.Ui.Rect? targetRect__28217 = default!;
