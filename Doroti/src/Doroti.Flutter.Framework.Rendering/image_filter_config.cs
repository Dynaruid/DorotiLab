...
public abstract class ImageFilterConfig
{
    ...
    public abstract global::Doroti.Flutter.Ui.ImageFilter resolve(ImageFilterContext context);
    public virtual global::Doroti.Flutter.Ui.ImageFilter? filter => null;
...
internal class _BlurImageFilterConfig__image_filter_config : ImageFilterConfig
{
    ...
    public override ImageFilter resolve(ImageFilterContext context)
    {
        return new global::Doroti.Flutter.Ui.ImageFilter(sigmaX: this.sigmaX, sigmaY: this.sigmaY, tileMode: this.tileMode, bounds: (this.bounded ? ((ImageFilterContext)context).bounds : null));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _ComposeImageFilterConfig__image_filter_config : ImageFilterConfig
{
    ...
    public override ImageFilter resolve(ImageFilterContext context)
    {
        return new global::Doroti.Flutter.Ui.ImageFilter(outer: this.outer.resolve(context), inner: this.inner.resolve(context));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
