...
public class TextureBox : RenderBox
{
    ...
    {
        context.addLayer(new TextureLayer(rect: global::Doroti.Flutter.Ui.Rect.fromLTWH(offset.dx, offset.dy, size.width, size.height), textureId: this._textureId, freeze: this.freeze, filterQuality: this._filterQuality));
    }
