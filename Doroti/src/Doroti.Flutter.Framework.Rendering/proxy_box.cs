...
public interface RenderProxyBoxMixin<T> where T : RenderBox
{
    ...
    public global::Doroti.Flutter.Ui.Size computeSizeForNoChild(BoxConstraints constraints);
...
public class RenderConstrainedBox : RenderProxyBox
{
    ...
    public override void debugPaintSize(PaintingContext context, Offset offset)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            {
                global::Doroti.Flutter.Ui.Paint paint__10749 = default!;
...
public class RenderLimitedBox : RenderProxyBox
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Size _computeSize(BoxConstraints constraints, Func<RenderBox, BoxConstraints, Size> layoutChild)
    {
        if ((child is not null))
        {
            global::Doroti.Flutter.Ui.Size childSize__13568 = layoutChild(child!, _limitConstraints(constraints));
...
public class RenderAspectRatio : RenderProxyBox
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Size _applyAspectRatio(BoxConstraints constraints)
    {
        ...
        return constraints.constrain(new global::Doroti.Flutter.Ui.Size(width__18340, height__18381));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class RenderIntrinsicWidth : RenderProxyBox
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Size _computeSize(Func<RenderBox, BoxConstraints, Size> layoutChild, BoxConstraints constraints)
    {
...
public class RenderShaderMask : RenderProxyBox
{
    ...
    public virtual global::Doroti.Flutter.Ui.BlendMode blendMode
    {
        get => this._blendMode;
        set
        {
...
public class RenderBackdropFilter : RenderProxyBox
{
    ...
    public virtual global::Doroti.Flutter.Ui.ImageFilter filter
    {
        get
        {
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        global::Doroti.Flutter.Ui.ImageFilter effectiveFilter__44613 = this._filterConfig.resolve(new ImageFilterContext(bounds: (offset & size)));
        if ((child is not null))
        {
            DartRuntimePrimitives.Assert(() => needsCompositing);
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new EnumProperty<global::Doroti.Flutter.Ui.BlendMode>("blendMode", this.blendMode));
...
public abstract class CustomClipper<T> : Listenable
{
    ...
    public virtual global::Doroti.Flutter.Ui.Rect getApproximateClipRect(Size size) => (Offset.zero & size);
...
public class ShapeBorderClipper : CustomClipper<Path>
{
    ...
    public override global::Doroti.Flutter.Ui.Path getClip(Size size)
    {
...
public abstract class _RenderCustomClip__proxy_box<T> : RenderProxyBox
{
    ...
    public override void performLayout()
    {
        global::Doroti.Flutter.Ui.Size? oldSize__52169 = (hasSize ? size : null);
        base.performLayout();
...
{
    var __cascade = new global::Doroti.Flutter.Ui.Paint();
    __cascade.shader = global::Doroti.Flutter.Ui.Gradient.linear(Offset.zero, new global::Doroti.Flutter.Ui.Offset(10.0, 10.0), new List<global::Doroti.Flutter.Ui.Color> { new global::Doroti.Flutter.Ui.Color(0L), new global::Doroti.Flutter.Ui.Color(4294902015L), new global::Doroti.Flutter.Ui.Color(4294902015L), new global::Doroti.Flutter.Ui.Color(0L) }, new List<double> { 0.25, 0.25, 0.75, 0.75 }, TileMode.repeated);
...
{
    var __cascade = new global::Doroti.Generated.Framework.Painting.TextPainter(text: new global::Doroti.Generated.Framework.Painting.TextSpan(text: "✂", style: new global::Doroti.Generated.Framework.Painting.TextStyle(color: new global::Doroti.Flutter.Ui.Color(4294902015L), fontSize: 14.0)), textDirection: TextDirection.rtl);
    __cascade.layout();
    return __cascade;
}))();
                return true;
...
public class RenderClipRect : _RenderCustomClip__proxy_box<Rect>
{
    ...
    internal override global::Doroti.Flutter.Ui.Rect _defaultClip => (Offset.zero & size);
    public override bool hitTest(BoxHitTestResult result, Offset position)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            {
                if ((child is not null))
                {
                    ...
                    if ((!object.Equals(clipBehavior, Clip.none)))
                    {
                        ...
                        _debugText!.paint(((PaintingContext)context).canvas, (offset + new global::Doroti.Flutter.Ui.Offset((DartRuntimePrimitives.RequireValue(_clip).width / 8.0), (-DartRuntimePrimitives.RequireValue(_debugText!.text!.style!.fontSize) * 1.1))));
                    }
                }
                return true;
            });
...
public class RenderClipRRect : _RenderCustomClip__proxy_box<RRect>
{
    ...
    internal override global::Doroti.Flutter.Ui.RRect _defaultClip => this._borderRadius.resolve(this.textDirection).toRRect((Offset.zero & size));
    public override bool hitTest(BoxHitTestResult result, Offset position)
    {
        if ((_clipper is not null))
        {
        ...
        DartRuntimePrimitives.Assert(() =>
            {
                if ((child is not null))
                {
                    ...
                    if ((!object.Equals(clipBehavior, Clip.none)))
                    {
                        ...
                        _debugText!.paint(((PaintingContext)context).canvas, (offset + new global::Doroti.Flutter.Ui.Offset(_clip!.tlRadiusX, (-DartRuntimePrimitives.RequireValue(_debugText!.text!.style!.fontSize) * 1.1))));
                    }
                }
                return true;
            });
...
public class RenderClipRSuperellipse : _RenderCustomClip__proxy_box<RSuperellipse>
{
    ...
    internal override global::Doroti.Flutter.Ui.RSuperellipse _defaultClip => this._borderRadius.resolve(this.textDirection).toRSuperellipse((Offset.zero & size));
    public override bool hitTest(BoxHitTestResult result, Offset position)
    {
        if ((_clipper is not null))
        {
...
public class RenderClipOval : _RenderCustomClip__proxy_box<Rect>
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Path _getClipPath(Rect rect)
    {
            ...
            _cachedPath = ((Func<Path>)(() =>
{
    ...
    public override bool hitTest(BoxHitTestResult result, Offset position)
    {
        _updateClip();
        DartRuntimePrimitives.Assert(() => !object.Equals(_clip, null));
        global::Doroti.Flutter.Ui.Offset center__62845 = DartRuntimePrimitives.RequireValue(_clip).center;
        var offset__62955 = new global::Doroti.Flutter.Ui.Offset((((position.dx - center__62845.dx)) / DartRuntimePrimitives.RequireValue(_clip).width), (((position.dy - center__62845.dy)) / DartRuntimePrimitives.RequireValue(_clip).height));
        ...
        DartRuntimePrimitives.Assert(() =>
            {
                if ((child is not null))
                {
                    ...
                    if ((!object.Equals(clipBehavior, Clip.none)))
                    {
                        ...
                        _debugText!.paint(((PaintingContext)context).canvas, (offset + new global::Doroti.Flutter.Ui.Offset((((DartRuntimePrimitives.RequireValue(_clip).width - _debugText!.width)) / 2.0), (-DartRuntimePrimitives.RequireValue(_debugText!.text!.style!.fontSize) * 1.1))));
                    }
                }
                return true;
            });
...
public class RenderClipPath : _RenderCustomClip__proxy_box<Path>
{
    ...
    internal override global::Doroti.Flutter.Ui.Path _defaultClip => ((Func<Path>)(() =>
{
    var __cascade = new global::Doroti.Flutter.Ui.Path();
...
public abstract class _RenderPhysicalModelBase__proxy_box<T> : _RenderCustomClip__proxy_box<T>
{
    ...
    public virtual global::Doroti.Flutter.Ui.Color shadowColor
    {
...
public class RenderPhysicalModel : _RenderPhysicalModelBase__proxy_box<RRect>
{
    ...
    internal override global::Doroti.Flutter.Ui.RRect _defaultClip
    {
        get
        {
            DartRuntimePrimitives.Assert(() => hasSize);
            global::Doroti.Flutter.Ui.Rect rect__70286 = (Offset.zero & size);
            return (this._shape switch { global::Doroti.Generated.Framework.Painting.BoxShape.rectangle => ((this.borderRadius ?? global::Doroti.Generated.Framework.Painting.BorderRadius.zero)).toRRect(rect__70286), global::Doroti.Generated.Framework.Painting.BoxShape.circle => global::Doroti.Flutter.Ui.RRect.fromRectXY(rect__70286, (rect__70286.width / 2L), (rect__70286.height / 2L)), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
            return default!;
        }
    }
    public override bool hitTest(BoxHitTestResult result, Offset position)
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        _updateClip();
        global::Doroti.Flutter.Ui.RRect offsetRRect__70978 = _clip!.shift(offset);
                        ...
                        ((PaintingContext)context).canvas.drawRRect(offsetRRect__70978, ((Func<Paint>)(() =>
{
    ...
    return __cascade;
        ...
        global::Doroti.Flutter.Ui.Canvas canvas__71440 = ((PaintingContext)context).canvas;
    ...
    internal override global::Doroti.Flutter.Ui.Path _defaultClip => ((Func<Path>)(() =>
{
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        _updateClip();
        global::Doroti.Flutter.Ui.Path offsetPath__74160 = _clip!.shift(offset);
                        ...
                        ((PaintingContext)context).canvas.drawPath(offsetPath__74160, ((Func<Paint>)(() =>
{
    ...
    return __cascade;
        ...
        global::Doroti.Flutter.Ui.Canvas canvas__74619 = ((PaintingContext)context).canvas;
            ...
            canvas__74619.drawPath(offsetPath__74160, ((Func<Paint>)(() =>
{
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<CustomClipper<global::Doroti.Flutter.Ui.Path>>("clipper", clipper));
    }
...
public class RenderTransform : RenderProxyBox
{
    ...
    public virtual global::Doroti.Flutter.Ui.Offset? origin
    {
        get => this._origin;
        set
        {
    ...
    public virtual global::Doroti.Flutter.Ui.FilterQuality? filterQuality
    {
    ...
    internal virtual Matrix4? _effectiveTransform
    {
        get
        {
            ...
            global::Doroti.Flutter.Ui.Offset? translation__86519 = default!;
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        if ((child is not null))
        {
            ...
            {
                global::Doroti.Flutter.Ui.Offset? childOffset__87955 = MatrixUtils.getAsTranslation(transform__87864);
                ...
                var effectiveTransform__88720 = ((Func<Matrix4>)(() =>
{
    ...
    return __cascade;
                ...
                var filter__88901 = new global::Doroti.Flutter.Ui.ImageFilter(effectiveTransform__88720.storage, filterQuality: DartRuntimePrimitives.RequireValue(this.filterQuality));
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Offset>("origin", this.origin));
...
public class RenderFittedBox : RenderProxyBox
{
    ...
    public override Size computeDryLayout(BoxConstraints constraints)
    {
        if ((child is not null))
        {
            global::Doroti.Flutter.Ui.Size childSize__92776 = child!.getDryLayout(new BoxConstraints());
            switch (this.fit)
            {
                case global::Doroti.Generated.Framework.Painting.BoxFit.scaleDown:
                    {
                        BoxConstraints sizeConstraints__92917 = constraints.loosen();
                        global::Doroti.Flutter.Ui.Size unconstrainedSize__92978 = sizeConstraints__92917.constrainSizeAndAttemptToPreserveAspectRatio(childSize__92776);
                ...
                case global::Doroti.Generated.Framework.Painting.BoxFit.scaleDown:
                    {
                        ...
                        global::Doroti.Flutter.Ui.Size unconstrainedSize__94071 = sizeConstraints__94010.constrainSizeAndAttemptToPreserveAspectRatio(child!.size);
    ...
    internal virtual void _updatePaintData()
    {
        ...
        else
        {
            ...
            global::Doroti.Flutter.Ui.Size childSize__95320 = child!.size;
            ...
            global::Doroti.Flutter.Ui.Rect sourceRect__95580 = resolvedAlignment__95271.inscribe(((global::Doroti.Generated.Framework.Painting.FittedSizes)sizes__95369).source, (Offset.zero & childSize__95320));
            global::Doroti.Flutter.Ui.Rect destinationRect__95677 = resolvedAlignment__95271.inscribe(((global::Doroti.Generated.Framework.Painting.FittedSizes)sizes__95369).destination, (Offset.zero & size));
            ...
            _transform = ((Func<Matrix4>)(() =>
{
    ...
    {
        global::Doroti.Flutter.Ui.Offset? childOffset__96350 = MatrixUtils.getAsTranslation(this._transform!);
...
public class RenderFractionalTranslation : RenderProxyBox
{
    ...
    public virtual global::Doroti.Flutter.Ui.Offset translation
    {
    ...
    public override bool hitTestChildren(BoxHitTestResult result, Offset position)
    {
        ...
        return result.addWithPaintOffset(offset: (this.transformHitTests ? new global::Doroti.Flutter.Ui.Offset((this.translation.dx * size.width), (this.translation.dy * size.height)) : null), position: position, hitTest: ((Func<BoxHitTestResult, Offset, bool>)((result, position) =>
        {
            return base.hitTestChildren(result, position: position);
            return default;
        })));
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        if ((child is not null))
        {
            base.paint(context, new global::Doroti.Flutter.Ui.Offset((offset.dx + (this.translation.dx * size.width)), (offset.dy + (this.translation.dy * size.height))));
        }
    }
    ...
    {
        DiagnosticableDefaults.debugFillProperties(properties);
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Offset>("translation", this.translation));
        properties.add(new DiagnosticsProperty<bool>("transformHitTests", this.transformHitTests));
    }
...
public class RenderRepaintBoundary : RenderProxyBox
{
    ...
    public virtual Future<global::Doroti.Flutter.Ui.Image> toImage(double pixelRatio = 1.0)
    {
    ...
    public virtual global::Doroti.Flutter.Ui.Image toImageSync(double pixelRatio = 1.0)
    {
        DartRuntimePrimitives.Assert(() => !debugNeedsPaint);
...
public class RenderSemanticsGestureHandler : RenderProxyBoxWithHitTestBehavior
{
    ...
    public virtual HashSet<global::Doroti.Flutter.Ui.SemanticsAction>? validActions
    {
        get => this._validActions;
        set
        {
            var __value = value is null ? null : (HashSet<SemanticsAction>)(object)value;
            if (global::Doroti.Generated.Framework.Foundation.CollectionsLibrary.setEquals<global::Doroti.Flutter.Ui.SemanticsAction>(__value, this._validActions))
            {
                return;
            }
    ...
    internal virtual void _performSemanticScrollLeft()
    {
        if ((this.onHorizontalDragUpdate is not null))
        {
            ...
            this.onHorizontalDragUpdate!(new DragUpdateDetails(delta: new global::Doroti.Flutter.Ui.Offset(primaryDelta__139388, 0.0), primaryDelta: primaryDelta__139388, globalPosition: localToGlobal(size.center(Offset.zero))));
        }
    }
    ...
    internal virtual void _performSemanticScrollRight()
    {
        if ((this.onHorizontalDragUpdate is not null))
        {
            ...
            this.onHorizontalDragUpdate!(new DragUpdateDetails(delta: new global::Doroti.Flutter.Ui.Offset(primaryDelta__139769, 0.0), primaryDelta: primaryDelta__139769, globalPosition: localToGlobal(size.center(Offset.zero))));
        }
    }
    ...
    internal virtual void _performSemanticScrollUp()
    {
        if ((this.onVerticalDragUpdate is not null))
        {
            ...
            this.onVerticalDragUpdate!(new DragUpdateDetails(delta: new global::Doroti.Flutter.Ui.Offset(0.0, primaryDelta__140144), primaryDelta: primaryDelta__140144, globalPosition: localToGlobal(size.center(Offset.zero))));
        }
    }
    ...
    internal virtual void _performSemanticScrollDown()
    {
        if ((this.onVerticalDragUpdate is not null))
        {
            ...
            this.onVerticalDragUpdate!(new DragUpdateDetails(delta: new global::Doroti.Flutter.Ui.Offset(0.0, primaryDelta__140521), primaryDelta: primaryDelta__140521, globalPosition: localToGlobal(size.center(Offset.zero))));
        }
    }
...
public class RenderFollowerLayer : RenderProxyBox
{
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        global::Doroti.Flutter.Ui.Size? leaderSize__154066 = ((LayerLink)this.link).leaderSize;
        ...
        global::Doroti.Flutter.Ui.Offset effectiveLinkedOffset__154426 = ((leaderSize__154066 is null) ? this.offset : ((this.leaderAnchor.alongSize(DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(leaderSize__154066))) - this.followerAnchor.alongSize(size)) + this.offset));
            ...
            ((Func<FollowerLayer?>)(() =>
{
    ...
    return __cascade;
        ...
        context.pushLayer(this.layer!, (Action<PaintingContext, Offset>)base.paint, Offset.zero, childPaintBounds: global::Doroti.Flutter.Ui.Rect.fromLTRB(double.NegativeInfinity, double.NegativeInfinity, double.PositiveInfinity, double.PositiveInfinity));
        DartRuntimePrimitives.Assert(() =>
            {
                this.layer!.debugCreator = debugCreator;
                return true;
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Offset>("offset", this.offset));
