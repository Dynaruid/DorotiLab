...
public interface RendererBinding
{
    ...
    public global::Doroti.Flutter.Ui.SceneBuilder createSceneBuilder();
    public global::Doroti.Flutter.Ui.PictureRecorder createPictureRecorder();
    public global::Doroti.Flutter.Ui.Canvas createCanvas(PictureRecorder recorder);
...
public class RenderingFlutterBinding : global::Doroti.Generated.Framework.Gestures.GestureBinding, global::Doroti.Generated.Framework.Semantics.SemanticsBinding, global::Doroti.Generated.Framework.Painting.PaintingBinding, RendererBinding
{
    ...
    public virtual ObserverList<Action<SemanticsActionEvent>> _semanticsActionListeners { get; set; } = new ObserverList<Action<global::Doroti.Flutter.Ui.SemanticsActionEvent>>();
        ...
        ((Func<PlatformDispatcher>)(() =>
{
    ...
    public virtual void _handleSemanticsActionEvent(SemanticsActionEvent action)
    {
        ...
        global::Doroti.Flutter.Ui.SemanticsActionEvent decodedAction__6706 = ((arguments__6642 is ByteData) ? action.copyWith(arguments: new StandardMessageCodec().decodeMessage(((ByteData)arguments__6642))) : action);
        List<Action<global::Doroti.Flutter.Ui.SemanticsActionEvent>> localListeners__7088 = this._semanticsActionListeners.ToList();
    ...
    {
        return new global::Doroti.Flutter.Ui.SemanticsUpdateBuilder();
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual SceneBuilder createSceneBuilder() => new global::Doroti.Flutter.Ui.SceneBuilder();
    public virtual PictureRecorder createPictureRecorder() => new global::Doroti.Flutter.Ui.PictureRecorder();
    public virtual Canvas createCanvas(PictureRecorder recorder) => new global::Doroti.Flutter.Ui.Canvas(recorder);
    ...
    public void handleMetricsChanged(FlutterView _) => handleMetricsChanged();
}
...
internal class _ReusableRenderView__binding : RenderView
{
    ...
    internal _ReusableRenderView__binding(FlutterView view) : base(view: view)
    {
    }
