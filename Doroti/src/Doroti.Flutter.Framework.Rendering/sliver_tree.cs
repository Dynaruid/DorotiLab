    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        void paintUpTo(long index, RenderBox? startWith, PaintingContext context, Offset offset)
        {
            ...
            while (((child__12415 is not null) && (indexOf(child__12415) <= index)))
            {
                ...
                global::Doroti.Flutter.Ui.Offset childOffset__12653 = (new global::Doroti.Flutter.Ui.Offset((((TreeSliverNodeParentData)parentData__12572).depth * this.indentation), (DartRuntimePrimitives.RequireValue(parentData__12572.layoutOffset) - ((SliverConstraints)constraints).scrollOffset)) + offset);
        ...
        List<long> animationIndices__13620 = ((Func<List<long>>)(() =>
{
    ...
    return __cascade;
        ...
        while ((checked((long)(paintSegments__13697.Count)) != 0))
        {
            ...
            var rect__15246 = global::Doroti.Flutter.Ui.Rect.fromPoints(new global::Doroti.Flutter.Ui.Offset(0.0, leadingOffset__14950), new global::Doroti.Flutter.Ui.Offset(((SliverConstraints)constraints).crossAxisExtent, trailingOffset__15086));
