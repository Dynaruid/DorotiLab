...
{
    internal static Color _black = new global::Doroti.Flutter.Ui.Color(3204448256L);
    internal static Color _yellow = new global::Doroti.Flutter.Ui.Color(3221225216L);
    ...
    internal static global::Doroti.Generated.Framework.Painting.TextStyle _indicatorTextStyle = new global::Doroti.Generated.Framework.Painting.TextStyle(color: new global::Doroti.Flutter.Ui.Color(4287627264L), fontSize: _indicatorFontSizePixels, fontWeight: FontWeight.w800);
    internal static Paint _indicatorPaint = ((Func<Paint>)(() =>
{
    var __cascade = new global::Doroti.Flutter.Ui.Paint();
    __cascade.shader = global::Doroti.Flutter.Ui.Gradient.linear(Offset.zero, new global::Doroti.Flutter.Ui.Offset(10.0, 10.0), new List<global::Doroti.Flutter.Ui.Color> { _black, _yellow, _yellow, _black }, new List<double> { 0.25, 0.25, 0.75, 0.75 }, TileMode.repeated);
    return __cascade;
}))();
