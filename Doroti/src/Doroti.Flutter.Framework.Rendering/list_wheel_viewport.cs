...
public class RenderListWheelViewport : RenderBox, ContainerRenderObjectMixin<RenderBox, ListWheelParentData>
{
    ...
    internal virtual double _maxVisibleRadian
    {
        get
        {
            ...
            return global::Doroti.Flutter.Runtime.Dart_mathLibrary.asin((1.0 / this._diameterRatio));
            return default!;
        }
    }
    ...
    internal virtual void _layoutChild(RenderBox child, BoxConstraints constraints, long index)
    {
        ...
        childParentData__24044.offset = new global::Doroti.Flutter.Ui.Offset(crossPosition__24160, indexToScrollOffset(index));
    }
    ...
    {
        global::Doroti.Flutter.Ui.Offset untransformedPaintingCoordinates__32680 = (offset + new global::Doroti.Flutter.Ui.Offset(layoutOffset.dx, _getUntransformedPaintingCoordinateY(layoutOffset.dy)));
        ...
        var offsetToCenter__33668 = new global::Doroti.Flutter.Ui.Offset(untransformedPaintingCoordinates__32680.dx, -this._topScrollMarginExtent);
    ...
    internal virtual void _paintChildWithMagnifier(PaintingContext context, Offset offset, RenderBox child, Matrix4 cylindricalTransform, Offset offsetToCenter, Offset untransformedPaintingCoordinates, bool? center)
    {
        ...
        var centerRect__35680 = global::Doroti.Flutter.Ui.Rect.fromLTWH(0.0, magnifierTopLinePosition__35216, size.width, (this._itemExtent * this._magnification));
        var topHalfRect__35822 = global::Doroti.Flutter.Ui.Rect.fromLTWH(0.0, 0.0, size.width, magnifierTopLinePosition__35216);
        var bottomHalfRect__35909 = global::Doroti.Flutter.Ui.Rect.fromLTWH(0.0, magnifierBottomLinePosition__35312, size.width, magnifierTopLinePosition__35216);
    ...
    {
        global::Doroti.Flutter.Ui.Offset paintOriginOffset__37569 = (offset + offsetToCenter);
        ...
        return ((Func<Matrix4>)(() =>
{
    ...
    internal virtual Matrix4 _centerOriginTransform(Matrix4 originalMatrix)
    {
        ...
        global::Doroti.Flutter.Ui.Offset centerOriginTranslation__39142 = global::Doroti.Generated.Framework.Painting.Alignment.center.alongSize(size);
    ...
    public virtual RevealedOffset getOffsetToReveal(RenderObject target, double alignment, Rect? rect = null, global::Doroti.Generated.Framework.Painting.Axis? axis = null)
    {
        ...
        global::Doroti.Flutter.Ui.Rect bounds__42562 = MatrixUtils.transformRect(transform__42505, DartRuntimePrimitives.RequireValue(DartRuntimePrimitives.RequireValue(rect)));
        global::Doroti.Flutter.Ui.Rect targetRect__42630 = bounds__42562.translate(0.0, (((size.height - this.itemExtent)) / 2L));
