...
{
    public static global::Doroti.Flutter.Ui.Size dryLayoutChild(RenderBox child, BoxConstraints constraints)
    {
        return child.getDryLayout(constraints);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public static global::Doroti.Flutter.Ui.Size layoutChild(RenderBox child, BoxConstraints constraints)
    {
