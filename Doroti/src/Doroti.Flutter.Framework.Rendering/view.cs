...
public class ViewConfiguration
{
    ...
    public static ViewConfiguration CreateFromView(FlutterView view)
    {
    ...
    public virtual global::Doroti.Flutter.Ui.Size toPhysicalSize(Size logicalSize)
    {
...
public class RenderView : RenderObject, RenderObjectWithChildMixin<RenderBox>
{
    ...
    internal virtual FlutterView _view { get; private set; } = default!;
    ...
    public RenderView(RenderBox? child = null, ViewConfiguration? configuration = null, FlutterView view = default!)
    {
        this._view = view;
    }

    public virtual global::Doroti.Flutter.Ui.Size size => this._size;
    ...
    public virtual global::Doroti.Flutter.Ui.FlutterView flutterView => this._view;
    ...
    public virtual void compositeFrame()
    {
        ...
        try
        {
            ...
            global::Doroti.Flutter.Ui.SceneBuilder builder__14028 = RendererBinding.instance.createSceneBuilder();
            global::Doroti.Flutter.Ui.Scene scene__14106 = layer!.buildScene(builder__14028);
    ...
    {
        global::Doroti.Flutter.Ui.Rect bounds__16131 = this.paintBounds;
        var top__16195 = new global::Doroti.Flutter.Ui.Offset(bounds__16131.center.dx, (this._view.padding.top / 2.0));
        var bottom__16482 = new global::Doroti.Flutter.Ui.Offset(bounds__16131.center.dx, ((bounds__16131.bottom - 1.0) - (this._view.padding.bottom / 2.0)));
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Size>("view size", this._view.physicalSize, tooltip: "in physical pixels"));
