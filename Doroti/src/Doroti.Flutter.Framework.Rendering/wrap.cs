...
public class _AxisSize__wrap
{
    ...
    private _AxisSize__wrap(global::Doroti.Flutter.Ui.Size _size)
    {
        this._size = _size;
    }

    public static _AxisSize__wrap Create_(global::Doroti.Flutter.Ui.Size _size) => new _AxisSize__wrap(_size);

    public static implicit operator global::Doroti.Flutter.Ui.Size(_AxisSize__wrap value) => value._size;
    public static implicit operator _AxisSize__wrap(global::Doroti.Flutter.Ui.Size value) => new _AxisSize__wrap(value);
    ...
    public virtual _AxisSize__wrap op_Add(_AxisSize__wrap other) => _AxisSize__wrap.Create_(new global::Doroti.Flutter.Ui.Size((_size.width + other._size.width), Math.Max(_size.height, other._size.height)));
    public virtual _AxisSize__wrap op_Subtract(_AxisSize__wrap other) => _AxisSize__wrap.Create_(new global::Doroti.Flutter.Ui.Size((_size.width - other._size.width), (_size.height - other._size.height)));
}
...
public class RenderWrap : RenderBox, ContainerRenderObjectMixin<RenderBox, WrapParentData>, RenderBoxContainerDefaultsMixin<RenderBox, WrapParentData>
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Offset _getOffset(double mainAxisOffset, double crossAxisOffset)
    {
        return (this.direction switch { global::Doroti.Generated.Framework.Painting.Axis.horizontal => new global::Doroti.Flutter.Ui.Offset(mainAxisOffset, crossAxisOffset), global::Doroti.Generated.Framework.Painting.Axis.vertical => new global::Doroti.Flutter.Ui.Offset(crossAxisOffset, mainAxisOffset), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    internal virtual global::Doroti.Flutter.Ui.Size _computeDryLayout(BoxConstraints constraints, Func<RenderBox, BoxConstraints, Size> layoutChild = default!)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Size childSize__23442 = layoutChild(child__23377, childConstraints__22944);
        ...
        mainAxisExtent__23218 = Math.Max(mainAxisExtent__23218, runMainAxisExtent__23279);
        return constraints.constrain((this.direction switch { global::Doroti.Generated.Framework.Painting.Axis.horizontal => new global::Doroti.Flutter.Ui.Size(mainAxisExtent__23218, crossAxisExtent__23248), global::Doroti.Generated.Framework.Painting.Axis.vertical => new global::Doroti.Flutter.Ui.Size(crossAxisExtent__23248, mainAxisExtent__23218), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") }));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal static global::Doroti.Flutter.Ui.Size _getChildSize(RenderBox child) => ((RenderBox)child).size;
