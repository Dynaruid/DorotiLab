...
public class RenderPerformanceOverlay : RenderBox
{
    ...
    {
        return constraints.constrain(new global::Doroti.Flutter.Ui.Size(double.PositiveInfinity, this._intrinsicHeight));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        context.addLayer(new PerformanceOverlayLayer(overlayRect: global::Doroti.Flutter.Ui.Rect.fromLTWH(offset.dx, offset.dy, size.width, size.height), optionsMask: this.optionsMask));
    }
