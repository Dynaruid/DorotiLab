...
public class RenderRotatedBox : RenderBox, RenderObjectWithChildMixin<RenderBox>
{
    ...
    public override Size computeDryLayout(BoxConstraints constraints)
    {
        ...
        global::Doroti.Flutter.Ui.Size childSize__2401 = child!.getDryLayout((this._isVertical ? ((BoxConstraints)constraints).flipped : constraints));
        return (this._isVertical ? new global::Doroti.Flutter.Ui.Size(childSize__2401.height, childSize__2401.width) : childSize__2401);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override void performLayout()
    {
        ...
        if ((child is not null))
        {
            ...
            size = (this._isVertical ? new global::Doroti.Flutter.Ui.Size(child!.size.height, child!.size.width) : child!.size);
