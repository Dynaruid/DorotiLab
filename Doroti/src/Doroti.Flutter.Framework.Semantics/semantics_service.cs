...
public abstract class SemanticsService
{
    ...
    {
        global::Doroti.Flutter.Ui.FlutterView? view__2464 = PlatformDispatcher.instance.implicitView;
    ...
    public static async Future sendAnnouncement(FlutterView view, string message, TextDirection textDirection, Assertiveness assertiveness = Assertiveness.polite)
    {
