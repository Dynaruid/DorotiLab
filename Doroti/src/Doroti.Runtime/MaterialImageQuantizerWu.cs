...
/// </remarks>
internal sealed class MaterialImageQuantizerWu : IQuantizer
{
    long[] weights;
    long[] momentsR;
    long[] momentsG;
    ...
    {
        weights = new long[TOTAL_SIZE];
        momentsR = new long[TOTAL_SIZE];
        momentsG = new long[TOTAL_SIZE];
        momentsB = new long[TOTAL_SIZE];
        moments = new double[TOTAL_SIZE];

        foreach (var pair in pixels)
        {
            uint pixel = pair.Key;
            long count = (int)pair.Value;
    ...
    void CreateMoments()
    {
        ...
        {
            long[] area = new long[INDEX_COUNT];
            long[] areaR = new long[INDEX_COUNT];
            long[] areaG = new long[INDEX_COUNT];
            long[] areaB = new long[INDEX_COUNT];
    ...
    {
        long dr = Volume(cube, momentsR);
        long dg = Volume(cube, momentsG);
        long db = Volume(cube, momentsB);
        double xx =
    ...
    {
        long wholeR = Volume(one, momentsR);
        long wholeG = Volume(one, momentsG);
