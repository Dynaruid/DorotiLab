...
public sealed record DesktopFrameworkFrameDiagnostics(
    long Submitted,
    long Presented,
    long Superseded,
    long Stale,
...
public sealed record DesktopFrameworkRetainedDiagnostics(
    long Hits,
    long Misses,
    ...
    IDisposable
{
    ...
    internal DesktopFrameworkFrameDiagnostics Diagnostics
    {
        get
        {
    ...
    internal DesktopFrameworkRetainedDiagnostics RetainedDiagnostics
    {
        get
        {
            lock (_gate)
    ...
    internal async Task<DesktopFrameworkPixelReadback> CaptureNextFrameAsync()
    {
    ...
    public void Submit(ulong viewId, Scene scene, DartUiInvocation invocation)
    {
        ...
        {
            throw new DorotiCapabilityException(DorotiCapabilityIds.GraphicsScene, viewId, invocation, "scene/view ownership mismatch");
        }
    ...
    private sealed class DesktopImageHandle : IDorotiImageHandle
    {
