...
public class FrictionSimulation : Simulation
{
    ...
    {
        this._drag = drag;
        this._dragLog = global::Doroti.Flutter.Runtime.Dart_mathLibrary.log(drag);
        this._x = position;
        this._v = velocity;
    ...
    {
        return ((double)global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(global::Doroti.Flutter.Runtime.Dart_mathLibrary.e, (((startVelocity - endVelocity)) / ((startPosition - endPosition)))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override double x(double time)
    {
        ...
        return (((this._x + ((this._v * global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(this._drag, time)) / this._dragLog)) - (this._v / this._dragLog)) - (((((this._constantDeceleration / 2L)) * time) * time)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override double dx(double time)
    {
        ...
        return ((this._v * global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(this._drag, time)) - (this._constantDeceleration * time));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
