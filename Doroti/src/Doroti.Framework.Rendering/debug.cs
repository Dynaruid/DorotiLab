...
public static partial class DebugLibrary
{
    internal static void _debugDrawDoubleRect(
        Canvas canvas,
        Rect outerRect,
        Rect innerRect,
        Color color
...
public static partial class DebugLibrary
{
    public static void debugPaintPadding(
        Canvas canvas,
        Rect outerRect,
        Rect? innerRect,
...
public static partial class DebugLibrary
{
    public static bool debugAssertAllRenderVarsUnset(
        string reason,
    ...
    )
    {
        DartRuntimePrimitives.Assert(() =>
        {
            if (
                ...
                || (!Equals(debugCurrentRepaintColor, _kDebugDefaultRepaintColor))
                ...
                || (debugOnProfilePaint is not null)
