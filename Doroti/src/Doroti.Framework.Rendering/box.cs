...
internal class _DebugSize__box : Size
{
    ...
    internal _DebugSize__box(Size source, RenderBox _owner, bool _canBeUsedByParent)
        : base(source)
    {
        this._owner = _owner;
...
public class BoxConstraints : Constraints
{
    ...
    public static BoxConstraints CreateTightForFinite(
    ...
    public virtual BoxConstraints copyWith(
    ...
    public virtual BoxConstraints deflate(EdgeInsetsGeometry edges)
    {
        ...
        return new BoxConstraints(
            ...
            maxWidth: Math.Max(deflatedMinWidth, maxWidth - horizontalLocal),
    ...
    public virtual BoxConstraints widthConstraints() =>
        new BoxConstraints(minWidth: minWidth, maxWidth: maxWidth);

    public virtual BoxConstraints heightConstraints() =>
    ...
    internal virtual Size _debugPropagateDebugSize(Size size, Size result)
    {
        DartRuntimePrimitives.Assert(() =>
        {
            if (size is _DebugSize__box)
            {
                ...
                result = new _DebugSize__box(
                    result,
                    size__as10760._owner,
                    size__as10760._canBeUsedByParent
                );
            }
            return true;
        });
    ...
    {
        return new BoxConstraints(
            minWidth: checked((long)(minWidth / factor)).toDouble(),
            maxWidth: checked((long)(maxWidth / factor)).toDouble(),
    ...
    public static BoxConstraints? lerp(BoxConstraints? a, BoxConstraints? b, double t)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            (double.IsFinite(a.minWidth) && double.IsFinite(b.minWidth))
    ...
    )
    {
        DartRuntimePrimitives.Assert(() =>
        {
            ...
            )
            {
                ...
                string whichFields = checked((long)affectedFieldsList.Count) switch
                {
                    1L => affectedFieldsList.Single(),
                    2L => string.Join(" ", affectedFieldsList),
                    _ => string.Join(", ", affectedFieldsList),
                };
                throwError(
                    new ErrorSummary(
                        $"BoxConstraints has {((checked(affectedFieldsList.Count) == 1L) ? "a NaN value" : "NaN values")} in {whichFields}."
                    )
                );
            }
            ...
            {
                throwError(
                    new ErrorSummary("BoxConstraints has non-normalized width constraints.")
                );
            }
            if (maxHeight < minHeight)
            {
                throwError(
                    new ErrorSummary("BoxConstraints has non-normalized height constraints.")
                );
            }
    ...
    public override bool Equals(object? other)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            (__other is BoxConstraints) && __other.debugAssertIsValid()
        );
        return (__other is BoxConstraints)
            && (__other.minWidth == minWidth)
            && (__other.maxWidth == maxWidth)
            && (__other.minHeight == minHeight)
            && (__other.maxHeight == maxHeight);
    }
...
public class BoxHitTestResult : HitTestResult
{
    ...
    private BoxHitTestResult(HitTestResult result)
        : base(result) { }

    public static new BoxHitTestResult CreateWrap(HitTestResult result)
    {
        return new BoxHitTestResult(result);
    }

    public virtual bool addWithPaintTransform(
        Matrix4? transform,
        Offset position,
        Func<BoxHitTestResult, Offset, bool> hitTest
    )
    {
    ...
    {
        Offset transformedPosition =
            (transform is null) ? position : MatrixUtils.transformPoint(transform, position);
        if (transform is not null)
        {
    ...
    public virtual bool addWithOutOfBandPosition(
        ...
        Func<BoxHitTestResult, bool> hitTest = default!
    )
    {
        DartRuntimePrimitives.Assert(() =>
...
public class BoxHitTestEntry : HitTestEntry<RenderBox>
{
    ...
    public override string ToString() =>
        $"{DiagnosticsLibrary.describeIdentity(target)}@{localPosition}";
}
...
public abstract class ContainerBoxParentData<ChildType>
    : BoxParentData,
...
public class BaselineOffset
{
    ...
    public virtual BaselineOffset minOf(BaselineOffset other)
    {
        ...
        {
            (double lhs, double rhs) => (lhs >= rhs) ? other : this,
...
internal interface _CachedLayoutCalculation__box<Input, Output>
{
    ...
    public Output memoize(
        _LayoutCacheStorage__box cacheStorage,
        Input input,
        Func<Input, Output> computer
    );
    public DartMap<string, string> debugFillTimelineArguments(
        DartMap<string, string> timelineArguments,
        Input input
    );
...
public class _DryLayout__box : _CachedLayoutCalculation__box<BoxConstraints, Size>
{
    ...
    public virtual Size memoize(
        _LayoutCacheStorage__box cacheStorage,
        BoxConstraints input,
        Func<BoxConstraints, Size> computer
    )
    {
        using var profile = FrameworkComponentProfile.Begin(
            FrameworkComponentProfile.Kind.DryCache
        );
        return (
    ...
    public virtual string eventLabel(RenderBox renderBox) =>
        $"{DartRuntimePrimitives.RuntimeType(renderBox)}.getDryLayout";
}

public class _Baseline__box
    : _CachedLayoutCalculation__box<(BoxConstraints, TextBaseline), BaselineOffset>
{
    internal _Baseline__box() { }

    public virtual BaselineOffset memoize(
        _LayoutCacheStorage__box cacheStorage,
    ...
    {
        using var profile = FrameworkComponentProfile.Begin(
            FrameworkComponentProfile.Kind.BaselineCache
        );
        DartMap<BoxConstraints, BaselineOffset> cache = input.Item2 switch
        {
    ...
    public virtual string eventLabel(RenderBox renderBox) =>
        $"{DartRuntimePrimitives.RuntimeType(renderBox)}.getDryBaseline";
}
...
{
    public static double memoize(
        this _IntrinsicDimension__box value,
        _LayoutCacheStorage__box cacheStorage,
        double input,
    ...
    {
        using var profile = FrameworkComponentProfile.Begin(
            FrameworkComponentProfile.Kind.IntrinsicCache
        );
        return (
    ...
    public static string eventLabel(this _IntrinsicDimension__box value, RenderBox renderBox) =>
        $"{DartRuntimePrimitives.RuntimeType(renderBox)} intrinsics";
}

internal sealed class _IntrinsicDimension__boxInterfaceAdapter
    : _CachedLayoutCalculation__box<double, double>
{
    private readonly _IntrinsicDimension__box _value;

    public _IntrinsicDimension__boxInterfaceAdapter(_IntrinsicDimension__box value) =>
        _value = value;
    ...
    public double memoize(
        ...
        double input,
        Func<double, double> computer
    ) => _value.memoize(cacheStorage, input, computer);

    public DartMap<string, string> debugFillTimelineArguments(
        DartMap<string, string> timelineArguments,
        double input
    ) => _value.debugFillTimelineArguments(timelineArguments, input);
...
public class _LayoutCacheStorage__box
{
    internal virtual DartMap<
        (_IntrinsicDimension__box, double),
        double
    >? _cachedIntrinsicDimensions { get; set; } = default;
    internal virtual DartMap<BoxConstraints, Size>? _cachedDryLayoutSizes { get; set; } = default;
    internal virtual DartMap<
        BoxConstraints,
        BaselineOffset
    >? _cachedAlphabeticBaseline { get; set; } = default;
    internal virtual DartMap<BoxConstraints, BaselineOffset>? _cachedIdeoBaseline { get; set; } =
        default;
    ...
    public virtual bool clear()
    {
        bool hasCache =
            (
                (
                    ((long?)(_cachedDryLayoutSizes?.Count)) is { } __count42271
                        ? __count42271 != 0
                        : (bool?)null
                ) ?? false
            )
            || (
                (
                    ((long?)(_cachedIntrinsicDimensions?.Count)) is { } __count42327
                        ? __count42327 != 0
                        : (bool?)null
                ) ?? false
            )
            || (
                (
                    ((long?)(_cachedAlphabeticBaseline?.Count)) is { } __count42388
                        ? __count42388 != 0
                        : (bool?)null
                ) ?? false
            )
            || (
                (
                    ((long?)(_cachedIdeoBaseline?.Count)) is { } __count42448
                        ? __count42448 != 0
                        : (bool?)null
                ) ?? false
            );
...
{
    internal virtual _LayoutCacheStorage__box _layoutCacheStorage { get; private set; } =
        new _LayoutCacheStorage__box();
    ...
    internal virtual Output _computeIntrinsics<Input, Output>(
        _CachedLayoutCalculation__box<Input, Output> type,
        Input input,
        Func<Input, Output> computer
    )
    {
    ...
    )
    {
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            DartMap<string, string> argumentsLocal =
                DebugLibrary.debugEnhanceLayoutTimelineArguments
                    ? toDiagnosticsNode().toTimelineArguments()!
                    : new DartMap<string, string>();
    ...
    public virtual double getMinIntrinsicWidth(double height)
    {
        ...
        return _computeIntrinsics(
            new _IntrinsicDimension__boxInterfaceAdapter(_IntrinsicDimension__box.minWidth),
            height,
    ...
    public virtual double getMaxIntrinsicWidth(double height)
    {
        ...
        return _computeIntrinsics(
            new _IntrinsicDimension__boxInterfaceAdapter(_IntrinsicDimension__box.maxWidth),
            height,
    ...
    public virtual double getMinIntrinsicHeight(double width)
    {
        ...
        return _computeIntrinsics(
            new _IntrinsicDimension__boxInterfaceAdapter(_IntrinsicDimension__box.minHeight),
            width,
    ...
    public virtual double getMaxIntrinsicHeight(double width)
    {
        ...
        return _computeIntrinsics(
            new _IntrinsicDimension__boxInterfaceAdapter(_IntrinsicDimension__box.maxHeight),
            width,
    ...
    {
        return _computeIntrinsics(
            _CachedLayoutCalculation__box<object, object>.dryLayout,
            constraints,
        ...
        DartRuntimePrimitives.Assert(() =>
            debugCannotComputeDryLayout(
                error: new FlutterError(
                    ...
                    {
                        new ErrorSummary(
                            $"The {objectRuntimeTypeFunctions.objectRuntimeType(this, "RenderBox")} class does not implement \"computeDryLayout\"."
                        ),
                        new ErrorHint(
    ...
    {
        double? baselineOffset = _computeIntrinsics(
            _CachedLayoutCalculation__box<object, object>.baseline,
        ...
        DartRuntimePrimitives.Assert(() =>
            debugCannotComputeDryLayout(
                error: new FlutterError(
                    ...
                    {
                        new ErrorSummary(
                            $"The {objectRuntimeTypeFunctions.objectRuntimeType(this, "RenderBox")} class does not implement \"computeDryBaseline\"."
                        ),
                        new ErrorHint(
                            "If you are not writing your own RenderBox subclass, then this is not\n"
                                + "your fault. Contact support: https://github.com/flutter/flutter/issues/new?template=02_bug.yml"
            ...
            if (!debugCheckingIntrinsics)
            {
                if (reason is not null)
                {
                    ...
                    throw new FlutterError(
                        ...
                        {
                            new ErrorSummary(
                                $"The {objectRuntimeTypeFunctions.objectRuntimeType(this, "RenderBox")} class does not support dry layout."
                            ),
                        }
                    );
                }
        ...
        get
        {
            ...
            DartRuntimePrimitives.Assert(() =>
            {
                ...
                if (size is _DebugSize__box)
                {
                    ...
                    bool doingRegularLayout = !(
                        debugActiveLayout?.debugDoingThisLayoutWithCallback ?? true
                    );
                    bool sizeAccessAllowed =
                        !doingRegularLayout
                        || debugDoingThisResize
                        || debugDoingThisLayout
                        || _debugDoingBaseline
                        || (
                            Equals(debugActiveLayout, parentLocal)
                            && size__93552__as93576._canBeUsedByParent
                        );
                    ...
                    RenderBox? renderBoxDoingDryLayout = _computingThisDryLayout
                        ...
                        : (
                            (
                                (parentLocal is RenderBox)
                                && ((RenderBox)parentLocal)._computingThisDryLayout
                            )
                                ? ((RenderBox)parentLocal)
                                : null
                        );
                    ...
                    RenderBox? renderBoxDoingDryBaseline = _computingThisDryBaseline
                        ...
                        : (
                            (
                                (parentLocal is RenderBox)
                                && ((RenderBox)parentLocal)._computingThisDryBaseline
                            )
                                ? ((RenderBox)parentLocal)
                                : null
                        );
            ...
            return _size
                ?? throw new InvalidOperationException(
                    $"RenderBox was not laid out: {GetType()}#{DiagnosticsLibrary.shortHash(this)}"
                );
        }
        set
        {
                    ...
                    if (!Equals(value__as99138._owner.parent, this))
                    {
                        throw new FlutterError(
                            new List<DiagnosticsNode>
                            {
                                ...
                                value__as99138._owner.describeForError(
    ...
    public virtual double? getDistanceToBaseline(TextBaseline baseline, bool onlyReal = false)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            ...
            || (
                owner! switch
                {
                    PipelineOwner { debugDoingLayout: true } __object103560 => Equals(
                        debugActiveLayout,
                        parent
                    ) && parent!.debugDoingThisLayout,
                    PipelineOwner { debugDoingPaint: true } __object103701 => (
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            ...
            if (!DartRuntimePrimitives.RequireValue(_size).isFinite)
            {
                ...
                if (!constraints.hasBoundedHeight)
                {
                    var nodeLocal = this;
                    while (
                        !nodeLocal.constraints.hasBoundedHeight && (nodeLocal.parent is RenderBox)
                    )
                    {
                        nodeLocal = ((RenderBox?)(object?)nodeLocal.parent!)!;
                    }
                    information.Add(
                        nodeLocal.describeForError(
            ...
            if (!constraints.isSatisfiedBy(DartRuntimePrimitives.RequireValue(_size)))
            {
                throw new FlutterError(
                    new List<DiagnosticsNode>
                    {
                        new ErrorSummary($"{GetType()} does not meet its constraints."),
                        new DiagnosticsProperty<BoxConstraints>(
                            "Constraints",
                            constraints,
                            style: DiagnosticsTreeStyle.errorProperty
            ...
            if (DebugLibrary.debugCheckIntrinsicSizes)
            {
                ...
                if (checked((long)failures.Count) != 0)
                {
                    throw new FlutterError(
                        ...
                        {
                            new ErrorSummary(
                                $"The intrinsic dimension methods of the {GetType()} class returned values that violate the intrinsic protocol contract."
                            ),
                            new ErrorDescription(
                                $"The following {((checked(failures.Count) > 1L) ? "failures" : "failure")} was detected:"
                            ),
                            new ErrorHint(
                                "If you are not writing your own RenderBox subclass, then this is not\n"
                                    + "your fault. Contact support: https://github.com/flutter/flutter/issues/new?template=02_bug.yml"
                ...
                if (_debugDryLayoutCalculationValid && (!Equals(dryLayoutSize, _size)))
                {
                    throw new FlutterError(
                        ...
                        {
                            new ErrorSummary(
                                $"The size given to the {objectRuntimeTypeFunctions.objectRuntimeType(this, "RenderBox")} class differs from the size computed by computeDryLayout."
                            ),
                            new ErrorDescription(
    ...
    internal virtual void _debugVerifyDryBaselines()
    {
        DartRuntimePrimitives.Assert(() =>
        {
            var messages = new List<DiagnosticsNode>
            {
                new ErrorDescription($"The constraints used were {constraints}."),
                new ErrorHint(
                    "If you are not writing your own RenderBox subclass, then this is not\n"
            ...
            foreach (TextBaseline baseline in Enum.GetValues<TextBaseline>().ToList())
            {
                ...
                {
                    var (methodReturnedNull, methodReturnedNonNull) =
                        (dryBaseline is null)
                            ? (
                                ((string, string))
                    ...
                    throw new FlutterError(
                        ...
                        {
                            new ErrorSummary(
                                $"The {baseline} location returned by {objectRuntimeTypeFunctions.objectRuntimeType(this, "RenderBox")}.computeDistanceToActualBaseline "
                            ...
                            new ErrorDescription(
                                $"The {methodReturnedNull} method returned null while the {methodReturnedNonNull} returned a non-null {baseline} of {dryBaseline ?? realBaseline}. "
                                    + $"Did you forget to implement {methodReturnedNull} for {objectRuntimeTypeFunctions.objectRuntimeType(this, "RenderBox")}?"
                            ),
                        }
                    );
                }
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            if (!sizedByParent)
            {
                throw new FlutterError(
                    new List<DiagnosticsNode>
                    {
                        new ErrorSummary($"{GetType()} did not implement performLayout()."),
                        new ErrorHint(
                    ...
                    new List<DiagnosticsNode>
                    {
                        ...
                        new ErrorHint(
                            "The default applyPaintTransform implementation provided by RenderBox assumes that the "
                                ...
                                + $"subclass used by its children (which apparently is {DartRuntimePrimitives.RuntimeType(child.parentData)})."
                        ),
                    }
                );
            }
    ...
    public virtual Offset globalToLocal(Offset point, RenderObject? ancestor = null)
    {
        ...
        Vector3 localScreenPoint = transform.perspectiveTransform(
            new Vector3(point.dx, point.dy, 0.0)
        );
        Vector3 localPoint =
    ...
    public virtual bool debugHandleEvent(PointerEvent @event, HitTestEntry<HitTestTarget> entry)
    {
        DartRuntimePrimitives.Assert(() =>
        {
            if (DebugLibrary.debugPaintPointersEnabled)
            {
                ...
                {
                    if (
                        (@event is Gestures.PointerUpEvent)
                        || (@event is Gestures.PointerCancelEvent)
                    )
                    {
                        _debugActivePointers -= 1L;
                    }
            ...
            if (_debugActivePointers > 0L)
            {
                var paint = (
                    (Func<Paint>)(
                        ...
                        {
                            var __cascade = new Paint();
                            __cascade.color = new Color(
                                48059L | ((67108864L * depth) & 4278190080L)
                            );
                            return __cascade;
                        }
                    )
...
public interface RenderBoxContainerDefaultsMixin<ChildType, ParentDataType>
    : ContainerRenderObjectMixin<ChildType, ParentDataType>
    where ChildType : RenderBox
    where ParentDataType : ContainerBoxParentData<ChildType>
{
