...
public class _AxisSize__flex
{
    ...
    public virtual _AxisSize__flex op_Add(_AxisSize__flex other) =>
        Create_(
            new Size(_size.width + other._size.width, Math.Max(_size.height, other._size.height))
        );
}
...
internal class _AscentDescent__flex
{
    ...
    public static _AscentDescent__flex Create_((double, double)? ascentDescent) =>
        new _AscentDescent__flex(ascentDescent);

    public static implicit operator (double, double)?(_AscentDescent__flex value) =>
        value.ascentDescent;

    public static implicit operator _AscentDescent__flex((double, double)? value) =>
        new _AscentDescent__flex(value);
    ...
    public virtual _AscentDescent__flex op_Add(_AscentDescent__flex other) =>
        (ascentDescent, other.ascentDescent) switch
        {
            (null, var v) => v,
            (var vLocal, null) => vLocal,
            ((double xAscent, double xDescent), (double yAscent, double yDescent)) => Create_(
...
internal class _LayoutSizes__flex
{
    ...
    internal _LayoutSizes__flex(
        _AxisSize__flex axisSize,
    ...
    )
    {
        ...
        System.Diagnostics.Debug.Assert(
            (spacePerFlex is { } __finite3047 ? double.IsFinite(__finite3047) : (bool?)null) ?? true
        );
    }
}
...
{
    internal static (double, double) _distributeSpace(
    ...
    )
    {
        ...
        return value switch
        {
            MainAxisAlignment.start => flipped
                ? (freeSpace, spacing)
                : (((double, double))(0.0, spacing)),
            ...
            MainAxisAlignment.spaceBetween when itemCount < 2L =>
                MainAxisAlignment.start._distributeSpace(freeSpace, itemCount, flipped, spacing),
            MainAxisAlignment.spaceAround when itemCount == 0L =>
                MainAxisAlignment.start._distributeSpace(freeSpace, itemCount, flipped, spacing),
            MainAxisAlignment.center => (freeSpace / 2.0, spacing),
            MainAxisAlignment.spaceBetween => (0.0, (freeSpace / (itemCount - 1L)) + spacing),
            MainAxisAlignment.spaceAround => (
                freeSpace / itemCount / 2L,
...
{
    internal static double _getChildCrossAxisOffset(
    ...
    )
    {
        return value switch
        {
            ...
            CrossAxisAlignment.center => freeSpace / 2L,
        ...
        DebugOverflowIndicatorMixin
{
    ...
    public virtual TextBaseline? textBaseline
    {
        ...
        set
        {
            ...
            DartRuntimePrimitives.Assert(() =>
                (!Equals(_crossAxisAlignment, CrossAxisAlignment.baseline)) || (__value is not null)
            );
    ...
    internal virtual bool _debugHasNecessaryDirections
    {
        get
        {
            ...
            if (
                Equals(mainAxisAlignment, MainAxisAlignment.start)
                || Equals(mainAxisAlignment, MainAxisAlignment.end)
            )
            {
                switch (direction)
                {
            ...
            if (
                Equals(crossAxisAlignment, CrossAxisAlignment.start)
    ...
    internal virtual bool _hasOverflow =>
        _overflow > Foundation.ConstantsLibrary.precisionErrorTolerance;
    ...
    internal virtual double _getIntrinsicSize(
    ...
    )
    {
        if (Equals(_direction, sizingDirection))
        {
            ...
            for (
                ...
                childLocal is not null;
                childLocal = childAfter(childLocal)
            )
            {
        ...
        {
            bool isHorizontal = direction switch
            {
            ...
            Size layoutChild(RenderBox child, BoxConstraints constraints)
            {
                ...
                DartRuntimePrimitives.Assert(() =>
                    ((_getFlex(child) != 0L) && double.IsFinite(extent))
                    == double.IsFinite(mainAxisSizeFromConstraints)
                );
    ...
    internal virtual BoxConstraints _constraintsForNonFlexChild(BoxConstraints constraints)
    {
        ...
        return _direction switch
        {
            Axis.horizontal => fillCrossAxis
                ? BoxConstraints.CreateTightFor(height: constraints.maxHeight)
    ...
    {
        _LayoutSizes__flex sizes = _computeSizes(
    ...
    )
    {
        ...
        BoxConstraints constraintsForChild(RenderBox child)
        {
            ...
            long flex = default!;
            return ((spacePerFlexLocal is not null) && ((flex = _getFlex(child)) > 0L))
        ...
        var (nextChild, topLeftChild) = flipMainAxis
            ? (((Func<RenderBox, RenderBox?>, RenderBox?))(childBefore, lastChild))
            : (((Func<RenderBox, RenderBox?>, RenderBox?))(childAfter, firstChild));
        double? baselineOffsetLocal =
            (_isBaselineAligned && (textBaseline is not null)) ? sizes.baselineOffset : null;
        BaselineOffset minBaseline = BaselineOffset.noBaseline;
        for (
            var childLocal = topLeftChild;
            childLocal is not null;
            childLocal = nextChild(childLocal)
        )
        {
            ...
            if (childBaseline is not null)
            {
                ...
                double? childBaselineOffset =
                    (_isBaselineAligned && (textBaseline is not null))
                        ...
                        : null;
                bool baselineAlign =
                    (baselineOffsetLocal is not null) && (childBaselineOffset is not null);
                ...
                {
                    if (
                        Equals(crossAxisAlignment, CrossAxisAlignment.baseline)
                        && Equals(direction, Axis.horizontal)
                    )
                    {
                    ...
                    else
                    {
                        ...
                        childCrossPosition = crossAxisAlignment._getChildCrossAxisOffset(
                            sizes.axisSize.crossAxisExtent - _getCrossSize(childSizeLocal),
                            flipCrossAxis
                        );
                    }
                }
    ...
    )
    {
        ...
        bool flipMainAxis = _flipMainAxis;
        var (leadingSpace, betweenSpace) = mainAxisAlignment._distributeSpace(
            remainingSpace,
            childCount,
            flipMainAxis,
            spacing
        ...
        var (nextChildPaintOrder, startChild) = flipMainAxis
            ? (((Func<RenderBox, RenderBox?>, RenderBox?))(childBefore, lastChild))
            : (((Func<RenderBox, RenderBox?>, RenderBox?))(childAfter, firstChild));
        var pos = leadingSpace;
        for (
            var childLocal = startChild;
            childLocal is not null;
            childLocal = nextChildPaintOrder(childLocal)
        )
        {
        ...
        for (
            RenderBox? childAlternate = firstChild;
            childAlternate is not null;
            childAlternate = childAfter(childAlternate)
        )
        {
    ...
    )
    {
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            double maxMainSize = Equals(_direction, Axis.horizontal)
                ? constraints.maxWidth
                : constraints.maxHeight;
            ...
            while (child is not null)
            {
                ...
                if (flex > 0L)
                {
                    ...
                    if (
                        !canFlex
                        && (
                            Equals(mainAxisSize, MainAxisSize.max)
                            || Equals(_getFit(child), FlexFit.tight)
                        )
                    )
                    {
                        error = new ErrorSummary(
                            $"RenderFlex children have non-zero flex__44015 but incoming {dimension} constraints are unbounded."
                        );
                        message = new ErrorDescription(
                        ...
                        if (reportParentConstraints)
                        {
                            ...
                            switch (_direction)
                            {
                                ...
                                {
                                    while (
                                        !node!.constraints.hasBoundedWidth
                        ...
                        addendum.Add(
                            new ErrorHint("See also: https://flutter.dev/unbounded-constraints")
                        );
                    }
                    else
                    {
    ...
    )
    {
        ...
        using var flexProfile = FrameworkWorkProfile.LayoutEnabled
            ? FrameworkWorkProfile.Begin(GetType(), 8)
            : default;
        ...
        TextBaseline? textBaselineLocal = _isBaselineAligned
            ? (
                textBaseline
            ...
            else
            {
                ...
                accumulatedAscentDescent = accumulatedAscentDescent.op_Add(
                    _AscentDescent__flex.Create(
                        baselineOffset: baselineOffsetLocal,
        ...
        for (
            var childLocal = firstFlexChild;
            (childLocal is not null) && (totalFlex > 0L);
            childLocal = childAfter(childLocal)
        )
        {
            ...
            DartRuntimePrimitives.Assert(() =>
                Equals(_getFit(childLocal), FlexFit.loose)
                || (maxChildExtent < double.PositiveInfinity)
            );
            ...
            var childSizeLocal = _AxisSize__flex.CreateFromSize(
                size: layoutChild(childLocal, childConstraints),
                direction: direction
            );
            accumulatedSize = accumulatedSize.op_Add(childSizeLocal);
            double? baselineOffsetAlternate =
                (textBaselineLocal is null)
                    ? null
                    : getBaseline(
                        childLocal,
            ...
            accumulatedAscentDescent = accumulatedAscentDescent.op_Add(
                _AscentDescent__flex.Create(
                    baselineOffset: baselineOffsetAlternate,
                    crossSize: childSizeLocal.crossAxisExtent
                )
            );
        }
        DartRuntimePrimitives.Assert(() => totalFlex == 0L);
        accumulatedSize = accumulatedSize.op_Add(
            accumulatedAscentDescent.ascentDescent switch
            {
                null => _AxisSize__flex.empty,
                (double ascent, double descent) => new _AxisSize__flex(
                    mainAxisExtent: 0,
    ...
    public override void performLayout()
    {
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            FlutterError? constraintsError = _debugCheckConstraints(
        ...
        for (var child = topLeftChild; child is not null; child = nextChild(child))
        {
            ...
            bool baselineAlign =
                (baselineOffsetLocal is not null)
                && (
                    (
            ...
            else
            {
                ...
                {
                    childCrossPosition = CrossAxisAlignment.start._getChildCrossAxisOffset(
                        crossAxisExtentLocal - _getCrossSize(child.size),
                        false
                    );
                }
                else
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
        {
            var debugOverflowHints = new List<DiagnosticsNode>
            {
                new ErrorDescription(
            ...
            Rect overflowChildRect = _direction switch
            {
        ...
        else
        {
            ...
            else
            {
                ...
                var childPreviousSiblingParentData = (
                    (FlexParentData?)(object?)childParentData.previousSibling!.parentData!
                )!;
                var childNextSiblingParentData = (
                    (FlexParentData?)(object?)childParentData.nextSibling!.parentData!
                )!;
