...
public abstract class DragGestureRecognizer : OneSequenceGestureRecognizer
{
    ...
    internal abstract global::Doroti.Flutter.Ui.Offset _getDeltaForDetails(Offset delta);
    ...
    internal virtual void _recordMoveDeltaForMultitouch(long pointer, Offset localDelta)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Offset offset__19155 = DartRuntimePrimitives.RequireValue(this._moveDeltaBeforeFrame.GetValueOrDefault(pointer));
    ...
    internal virtual double _getSumDelta(long pointer, bool positive, _DragDirection__monodrag axis)
    {
        ...
        global::Doroti.Flutter.Ui.Offset offset__19568 = DartRuntimePrimitives.RequireValue(this._moveDeltaBeforeFrame.GetValueOrDefault(pointer));
        if (positive)
        {
    ...
    internal virtual global::Doroti.Flutter.Ui.Offset _resolveLocalDeltaForMultitouch(long pointer, Offset localDelta)
    {
        if ((!object.Equals(this.multitouchDragStrategy, MultitouchDragStrategy.averageBoundaryPointers)))
        {
        ...
        else
        {
            ...
            else
            {
                ...
                global::Doroti.Flutter.Ui.Offset updatedDelta__22393 = (new global::Doroti.Flutter.Ui.Offset(averageX__22115, averageY__22255) - this._lastUpdatedDeltaForPan);
                _lastUpdatedDeltaForPan = new global::Doroti.Flutter.Ui.Offset(averageX__22115, averageY__22255);
                dx__21654 = updatedDelta__22393.dx;
                dy__21658 = updatedDelta__22393.dy;
            }
        }
        return new global::Doroti.Flutter.Ui.Offset(dx__21654, dy__21658);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    internal virtual double _resolveDeltaForPanGesture(_DragDirection__monodrag axis, Offset localDelta)
    {
        ...
        foreach (global::Doroti.Flutter.Ui.Offset offset__24130 in this._moveDeltaBeforeFrame.Values)
        {
    ...
    public override void handleEvent(PointerEvent @event)
    {
        ...
        {
            global::Doroti.Flutter.Ui.Offset position__24657 = (@event switch { PointerPanZoomStartEvent __object24693 => Offset.zero, PointerPanZoomUpdateEvent __object24744 => ((PointerPanZoomUpdateEvent)((PointerPanZoomUpdateEvent)__object24744)).pan, _ => ((PointerEvent)@event).localPosition });
        ...
        {
            global::Doroti.Flutter.Ui.Offset delta__25189 = (((@event is PointerMoveEvent)) ? ((PointerMoveEvent)@event).delta : (((PointerPanZoomUpdateEvent?)(object?)(((PointerPanZoomUpdateEvent?)(object?)@event)!))!).panDelta);
            global::Doroti.Flutter.Ui.Offset localDelta__25327 = (((@event is PointerMoveEvent)) ? ((PointerMoveEvent)@event).localDelta : (((PointerPanZoomUpdateEvent?)(object?)(((PointerPanZoomUpdateEvent?)(object?)@event)!))!).localPanDelta);
            global::Doroti.Flutter.Ui.Offset position__25480 = (((@event is PointerMoveEvent)) ? ((PointerMoveEvent)@event).position : ((((PointerEvent)@event).position + (((PointerPanZoomUpdateEvent?)(object?)(((PointerPanZoomUpdateEvent?)(object?)@event)!))!).pan)));
            global::Doroti.Flutter.Ui.Offset localPosition__25638 = (((@event is PointerMoveEvent)) ? ((PointerMoveEvent)@event).localPosition : ((((PointerEvent)@event).localPosition + (((PointerPanZoomUpdateEvent?)(object?)(((PointerPanZoomUpdateEvent?)(object?)@event)!))!).localPan)));
            _lastPosition = new OffsetPair(local: DartRuntimePrimitives.RequireValue(localPosition__25638), global: position__25480);
            global::Doroti.Flutter.Ui.Offset resolvedDelta__25890 = _resolveLocalDeltaForMultitouch(((PointerEvent)@event).pointer, localDelta__25327);
            switch (this._state)
            {
                case _DragState__monodrag.ready or _DragState__monodrag.possible:
                    {
                        ...
                        _lastPendingEventTimestamp = ((PointerEvent)@event).timeStamp;
                        _lastTransform = ((PointerEvent)@event).transform;
                        global::Doroti.Flutter.Ui.Offset movedLocally__26245 = _getDeltaForDetails(localDelta__25327);
    ...
    internal virtual void _checkDrag(long pointer)
    {
        ...
        global::Doroti.Flutter.Ui.Offset localUpdateDelta__30146 = default!;
        ...
        if (((!object.Equals(localUpdateDelta__30146, Offset.zero)) && (this.onUpdate is not null)))
        {
            ...
            global::Doroti.Flutter.Ui.Offset correctedLocalPosition__30749 = (((OffsetPair)this._initialPosition).local + localUpdateDelta__30146);
            global::Doroti.Flutter.Ui.Offset globalUpdateDelta__30836 = PointerEvent.transformDeltaViaPositions(untransformedEndPosition: correctedLocalPosition__30749, untransformedDelta: localUpdateDelta__30146, transform: localToGlobal__30657);
...
public class VerticalDragGestureRecognizer : DragGestureRecognizer
{
    ...
    public override DragEndDetails? considerFling(VelocityEstimate estimate, PointerDeviceKind kind)
    {
        ...
        return new DragEndDetails(velocity: new Velocity(pixelsPerSecond: new global::Doroti.Flutter.Ui.Offset(0, dy__35348)), primaryVelocity: dy__35348, globalPosition: ((OffsetPair)lastPosition).global, localPosition: ((OffsetPair)lastPosition).local);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    internal override Offset _getDeltaForDetails(Offset delta) => new global::Doroti.Flutter.Ui.Offset(0.0, delta.dy);
...
public class HorizontalDragGestureRecognizer : DragGestureRecognizer
{
    ...
    public override DragEndDetails? considerFling(VelocityEstimate estimate, PointerDeviceKind kind)
    {
        ...
        return new DragEndDetails(velocity: new Velocity(pixelsPerSecond: new global::Doroti.Flutter.Ui.Offset(dx__37455, 0)), primaryVelocity: dx__37455, globalPosition: ((OffsetPair)_lastPosition).global, localPosition: ((OffsetPair)_lastPosition).local);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    internal override Offset _getDeltaForDetails(Offset delta) => new global::Doroti.Flutter.Ui.Offset(delta.dx, 0.0);
