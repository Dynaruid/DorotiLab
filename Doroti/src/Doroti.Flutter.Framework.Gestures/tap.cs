...
public abstract class BaseTapGestureRecognizer : PrimaryPointerGestureRecognizer
{
    ...
    public override void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Offset>("finalPosition", this._up?.position, defaultValue: null));
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Offset>("finalLocalPosition", this._up?.localPosition, defaultValue: this._up?.position));
