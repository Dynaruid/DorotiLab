...
public static partial class Tap_and_dragLibrary
{
    internal static double _getGlobalDistance(PointerEvent @event, OffsetPair? originPosition)
    {
        ...
        global::Doroti.Flutter.Ui.Offset offset__699 = (((PointerEvent)@event).position - originPosition!.global);
...
public class TapDragUpdateDetails : PositionedGestureDetails, Diagnosticable
{
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Offset>("localPosition", this.localPosition));
        properties.add(new DiagnosticsProperty<Duration?>("sourceTimeStamp", this.sourceTimeStamp));
        properties.add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.Offset>("delta", this.delta));
...
public abstract class BaseTapAndDragGestureRecognizer : OneSequenceGestureRecognizer, _TapStatusTrackerMixin__tap_and_drag
{
    ...
    internal virtual void _acceptDrag(PointerEvent @event)
    {
        ...
        global::Doroti.Flutter.Ui.Offset localDelta__46354 = ((PointerEvent)@event).localDelta;
        if ((!object.Equals(localDelta__46354, Offset.zero)))
        {
            _currentPosition = OffsetPair.CreateFromEventPosition(@event);
            global::Doroti.Flutter.Ui.Offset correctedLocalPosition__46503 = (((OffsetPair)this._initialPosition).local + localDelta__46354);
            ...
            global::Doroti.Flutter.Ui.Offset globalUpdateDelta__46720 = PointerEvent.transformDeltaViaPositions(transform: localToGlobalTransform__46586, untransformedDelta: localDelta__46354, untransformedEndPosition: correctedLocalPosition__46503);
    ...
    internal virtual void _checkDrag(PointerMoveEvent @event)
    {
        ...
        global::Doroti.Flutter.Ui.Offset movedLocally__47335 = _getDeltaForDetails(@event.localDelta);
    ...
    {
        global::Doroti.Flutter.Ui.Offset globalPosition__49925 = (corrected?.global ?? ((PointerEvent)@event).position);
        global::Doroti.Flutter.Ui.Offset localPosition__49996 = (corrected?.local ?? ((PointerEvent)@event).localPosition);
    ...
    {
        global::Doroti.Flutter.Ui.Offset globalPosition__50912 = ((OffsetPair)this._currentPosition).global;
        global::Doroti.Flutter.Ui.Offset localPosition__50971 = ((OffsetPair)this._currentPosition).local;
    ...
    public virtual bool _isWithinConsecutiveTapTolerance(Offset secondTapOffset)
    {
        ...
        global::Doroti.Flutter.Ui.Offset difference__23425 = (secondTapOffset - DartRuntimePrimitives.RequireValue(this._lastTapOffset));
