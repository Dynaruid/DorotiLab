...
public class LogicalKeyboardKey : KeyboardKey
{
    ...
    public static LogicalKeyboardKey tvAudioDescriptionMixDown = new LogicalKeyboardKey(
        4294971652L
    );
    ...
    internal static DartMap<long, LogicalKeyboardKey> _knownLogicalKeys = new DartMap<
        long,
        LogicalKeyboardKey
    >
    {
        ...
        [125L] = braceRight,
        [126L] = tilde,
        [4294967297L] = unidentified,
        [4294967304L] = backspace,
        [4294967305L] = tab,
        [4294967309L] = enter,
        [4294967323L] = escape,
        [4294967423L] = delete,
        [4294967553L] = accel,
        [4294967555L] = altGraph,
        [4294967556L] = capsLock,
        [4294967558L] = fn,
        [4294967559L] = fnLock,
        [4294967560L] = hyper,
        [4294967562L] = numLock,
        [4294967564L] = scrollLock,
        [4294967566L] = superKey,
        [4294967567L] = symbol,
        [4294967568L] = symbolLock,
        [4294967569L] = shiftLevel5,
        [4294968065L] = arrowDown,
        [4294968066L] = arrowLeft,
        [4294968067L] = arrowRight,
        [4294968068L] = arrowUp,
        [4294968069L] = end,
        [4294968070L] = home,
        [4294968071L] = pageDown,
        [4294968072L] = pageUp,
        [4294968321L] = clear,
        [4294968322L] = copy,
        [4294968323L] = crSel,
        [4294968324L] = cut,
        [4294968325L] = eraseEof,
        [4294968326L] = exSel,
        [4294968327L] = insert,
        [4294968328L] = paste,
        [4294968329L] = redo,
        ...
        [4294968589L] = zoomIn,
        [4294968590L] = zoomOut,
        [4294968833L] = brightnessDown,
        [4294968834L] = brightnessUp,
        [4294968835L] = camera,
        [4294968836L] = eject,
        [4294968837L] = logOff,
        [4294968838L] = power,
        [4294968839L] = powerOff,
        [4294968840L] = printScreen,
        [4294968841L] = hibernate,
        [4294968842L] = standby,
        [4294968843L] = wakeUp,
        [4294969089L] = allCandidates,
        [4294969090L] = alphanumeric,
        [4294969091L] = codeInput,
        [4294969092L] = compose,
        [4294969093L] = convert,
        [4294969094L] = finalMode,
        [4294969095L] = groupFirst,
        [4294969096L] = groupLast,
        [4294969097L] = groupNext,
        [4294969098L] = groupPrevious,
        [4294969099L] = modeChange,
        [4294969100L] = nextCandidate,
        [4294969101L] = nonConvert,
        [4294969102L] = previousCandidate,
        [4294969103L] = process,
        [4294969104L] = singleCandidate,
        [4294969105L] = hangulMode,
        [4294969106L] = hanjaMode,
        [4294969107L] = junjaMode,
        [4294969108L] = eisu,
        [4294969109L] = hankaku,
        [4294969110L] = hiragana,
        [4294969111L] = hiraganaKatakana,
        [4294969112L] = kanaMode,
        [4294969113L] = kanjiMode,
        [4294969114L] = katakana,
        [4294969115L] = romaji,
        [4294969116L] = zenkaku,
        [4294969117L] = zenkakuHankaku,
        [4294969345L] = f1,
        [4294969346L] = f2,
        [4294969347L] = f3,
        [4294969348L] = f4,
        ...
        [4294969608L] = soft8,
        [4294969857L] = close,
        [4294969858L] = mailForward,
        [4294969859L] = mailReply,
        [4294969860L] = mailSend,
        [4294969861L] = mediaPlayPause,
        [4294969863L] = mediaStop,
        [4294969864L] = mediaTrackNext,
        [4294969865L] = mediaTrackPrevious,
        [4294969866L] = newKey,
        [4294969867L] = open,
        [4294969868L] = print,
        [4294969869L] = save,
        [4294969870L] = spellCheck,
        [4294969871L] = audioVolumeDown,
        [4294969872L] = audioVolumeUp,
        [4294969873L] = audioVolumeMute,
        [4294970113L] = launchApplication2,
        [4294970114L] = launchCalendar,
        [4294970115L] = launchMail,
        [4294970116L] = launchMediaPlayer,
        [4294970117L] = launchMusicPlayer,
        [4294970118L] = launchApplication1,
        [4294970119L] = launchScreenSaver,
        [4294970120L] = launchSpreadsheet,
        [4294970121L] = launchWebBrowser,
        [4294970122L] = launchWebCam,
        [4294970123L] = launchWordProcessor,
        [4294970124L] = launchContacts,
        [4294970125L] = launchPhone,
        [4294970126L] = launchAssistant,
        [4294970127L] = launchControlPanel,
        [4294970369L] = browserBack,
        [4294970370L] = browserFavorites,
        [4294970371L] = browserForward,
        [4294970372L] = browserHome,
        [4294970373L] = browserRefresh,
        [4294970374L] = browserSearch,
        [4294970375L] = browserStop,
        [4294970625L] = audioBalanceLeft,
        [4294970626L] = audioBalanceRight,
        [4294970627L] = audioBassBoostDown,
        [4294970628L] = audioBassBoostUp,
        [4294970629L] = audioFaderFront,
        [4294970630L] = audioFaderRear,
        [4294970631L] = audioSurroundModeNext,
        [4294970632L] = avrInput,
        [4294970633L] = avrPower,
        [4294970634L] = channelDown,
        [4294970635L] = channelUp,
        [4294970636L] = colorF0Red,
        [4294970637L] = colorF1Green,
        [4294970638L] = colorF2Yellow,
        [4294970639L] = colorF3Blue,
        [4294970640L] = colorF4Grey,
        [4294970641L] = colorF5Brown,
        [4294970642L] = closedCaptionToggle,
        [4294970643L] = dimmer,
        [4294970644L] = displaySwap,
        [4294970645L] = exit,
        [4294970646L] = favoriteClear0,
        [4294970647L] = favoriteClear1,
        [4294970648L] = favoriteClear2,
        [4294970649L] = favoriteClear3,
        [4294970650L] = favoriteRecall0,
        [4294970651L] = favoriteRecall1,
        [4294970652L] = favoriteRecall2,
        [4294970653L] = favoriteRecall3,
        [4294970654L] = favoriteStore0,
        [4294970655L] = favoriteStore1,
        [4294970656L] = favoriteStore2,
        [4294970657L] = favoriteStore3,
        [4294970658L] = guide,
        [4294970659L] = guideNextDay,
        [4294970660L] = guidePreviousDay,
        [4294970661L] = info,
        [4294970662L] = instantReplay,
        [4294970663L] = link,
        [4294970664L] = listProgram,
        [4294970665L] = liveContent,
        [4294970666L] = @lock,
        [4294970667L] = mediaApps,
        [4294970668L] = mediaFastForward,
        [4294970669L] = mediaLast,
        [4294970670L] = mediaPause,
        [4294970671L] = mediaPlay,
        [4294970672L] = mediaRecord,
        [4294970673L] = mediaRewind,
        [4294970674L] = mediaSkip,
        [4294970675L] = nextFavoriteChannel,
        [4294970676L] = nextUserProfile,
        [4294970677L] = onDemand,
        [4294970678L] = pInPDown,
        [4294970679L] = pInPMove,
        [4294970680L] = pInPToggle,
        [4294970681L] = pInPUp,
        [4294970682L] = playSpeedDown,
        [4294970683L] = playSpeedReset,
        [4294970684L] = playSpeedUp,
        [4294970685L] = randomToggle,
        [4294970686L] = rcLowBattery,
        [4294970687L] = recordSpeedNext,
        [4294970688L] = rfBypass,
        [4294970689L] = scanChannelsToggle,
        [4294970690L] = screenModeNext,
        [4294970691L] = settings,
        [4294970692L] = splitScreenToggle,
        [4294970693L] = stbInput,
        [4294970694L] = stbPower,
        [4294970695L] = subtitle,
        [4294970696L] = teletext,
        [4294970697L] = tv,
        [4294970698L] = tvInput,
        [4294970699L] = tvPower,
        [4294970700L] = videoModeNext,
        [4294970701L] = wink,
        [4294970702L] = zoomToggle,
        [4294970703L] = dvr,
        [4294970704L] = mediaAudioTrack,
        [4294970705L] = mediaSkipBackward,
        [4294970706L] = mediaSkipForward,
        [4294970707L] = mediaStepBackward,
        [4294970708L] = mediaStepForward,
        [4294970709L] = mediaTopMenu,
        [4294970710L] = navigateIn,
        [4294970711L] = navigateNext,
        [4294970712L] = navigateOut,
        [4294970713L] = navigatePrevious,
        [4294970714L] = pairing,
        [4294970715L] = mediaClose,
        [4294970882L] = audioBassBoostToggle,
        [4294970884L] = audioTrebleDown,
        [4294970885L] = audioTrebleUp,
        [4294970886L] = microphoneToggle,
        [4294970887L] = microphoneVolumeDown,
        [4294970888L] = microphoneVolumeUp,
        [4294970889L] = microphoneVolumeMute,
        [4294971137L] = speechCorrectionList,
        [4294971138L] = speechInputToggle,
        [4294971393L] = appSwitch,
        [4294971394L] = call,
        [4294971395L] = cameraFocus,
        [4294971396L] = endCall,
        [4294971397L] = goBack,
        [4294971398L] = goHome,
        [4294971399L] = headsetHook,
        [4294971400L] = lastNumberRedial,
        [4294971401L] = notification,
        [4294971402L] = mannerMode,
        [4294971403L] = voiceDial,
        [4294971649L] = tv3DMode,
        [4294971650L] = tvAntennaCable,
        [4294971651L] = tvAudioDescription,
        [4294971652L] = tvAudioDescriptionMixDown,
        [4294971653L] = tvAudioDescriptionMixUp,
        [4294971654L] = tvContentsMenu,
        [4294971655L] = tvDataService,
        [4294971656L] = tvInputComponent1,
        [4294971657L] = tvInputComponent2,
        [4294971658L] = tvInputComposite1,
        [4294971659L] = tvInputComposite2,
        [4294971660L] = tvInputHDMI1,
        [4294971661L] = tvInputHDMI2,
        [4294971662L] = tvInputHDMI3,
        [4294971663L] = tvInputHDMI4,
        [4294971664L] = tvInputVGA1,
        [4294971665L] = tvMediaContext,
        [4294971666L] = tvNetwork,
        [4294971667L] = tvNumberEntry,
        [4294971668L] = tvRadioService,
        [4294971669L] = tvSatellite,
        [4294971670L] = tvSatelliteBS,
        [4294971671L] = tvSatelliteCS,
        [4294971672L] = tvSatelliteToggle,
        [4294971673L] = tvTerrestrialAnalog,
        [4294971674L] = tvTerrestrialDigital,
        [4294971675L] = tvTimer,
        [4294971905L] = key11,
        [4294971906L] = key12,
        [8589934592L] = suspend,
        ...
        [8589934611L] = lang4,
        [8589934612L] = lang5,
        [8589934624L] = intlBackslash,
        [8589934625L] = intlRo,
        [8589934626L] = intlYen,
        [8589934848L] = controlLeft,
        [8589934849L] = controlRight,
        [8589934850L] = shiftLeft,
        [8589934851L] = shiftRight,
        [8589934852L] = altLeft,
        [8589934853L] = altRight,
        [8589934854L] = metaLeft,
        [8589934855L] = metaRight,
        [8589935088L] = control,
        [8589935090L] = shift,
        [8589935092L] = alt,
        [8589935094L] = meta,
        [8589935117L] = numpadEnter,
        [8589935144L] = numpadParenLeft,
        [8589935145L] = numpadParenRight,
        [8589935146L] = numpadMultiply,
        [8589935147L] = numpadAdd,
        [8589935148L] = numpadComma,
        [8589935149L] = numpadSubtract,
        [8589935150L] = numpadDecimal,
        [8589935151L] = numpadDivide,
        [8589935152L] = numpad0,
        [8589935153L] = numpad1,
        [8589935154L] = numpad2,
        [8589935155L] = numpad3,
        ...
        [8589935160L] = numpad8,
        [8589935161L] = numpad9,
        [8589935165L] = numpadEqual,
        [8589935361L] = gameButton1,
        [8589935362L] = gameButton2,
        [8589935363L] = gameButton3,
        [8589935364L] = gameButton4,
        [8589935365L] = gameButton5,
        [8589935366L] = gameButton6,
        [8589935367L] = gameButton7,
        [8589935368L] = gameButton8,
        [8589935369L] = gameButton9,
        [8589935370L] = gameButton10,
        [8589935371L] = gameButton11,
        [8589935372L] = gameButton12,
        [8589935373L] = gameButton13,
        [8589935374L] = gameButton14,
        [8589935375L] = gameButton15,
        [8589935376L] = gameButton16,
        [8589935377L] = gameButtonA,
        [8589935378L] = gameButtonB,
        [8589935379L] = gameButtonC,
        [8589935380L] = gameButtonLeft1,
        [8589935381L] = gameButtonLeft2,
        [8589935382L] = gameButtonMode,
        [8589935383L] = gameButtonRight1,
        [8589935384L] = gameButtonRight2,
        [8589935385L] = gameButtonSelect,
        [8589935386L] = gameButtonStart,
        [8589935387L] = gameButtonThumbLeft,
        [8589935388L] = gameButtonThumbRight,
        [8589935389L] = gameButtonX,
        [8589935390L] = gameButtonY,
        [8589935391L] = gameButtonZ,
    };
    internal static DartMap<LogicalKeyboardKey, HashSet<LogicalKeyboardKey>> _synonyms =
        new DartMap<LogicalKeyboardKey, HashSet<LogicalKeyboardKey>>
        {
    ...
    internal static DartMap<long, string> _keyLabels = new DartMap<long, string>
    {
        [32L] = "Space",
        [33L] = "Exclamation",
        [34L] = "Quote",
        ...
        [38L] = "Ampersand",
        [39L] = "Quote Single",
        [40L] = "Parenthesis Left",
        [41L] = "Parenthesis Right",
        [42L] = "Asterisk",
        [43L] = "Add",
        [44L] = "Comma",
        [45L] = "Minus",
        ...
        [4294967423L] = "Delete",
        [4294967553L] = "Accel",
        [4294967555L] = "Alt Graph",
        [4294967556L] = "Caps Lock",
        [4294967558L] = "Fn",
        [4294967559L] = "Fn Lock",
        [4294967560L] = "Hyper",
        [4294967562L] = "Num Lock",
        [4294967564L] = "Scroll Lock",
        [4294967566L] = "Super",
        [4294967567L] = "Symbol",
        [4294967568L] = "Symbol Lock",
        [4294967569L] = "Shift Level 5",
        [4294968065L] = "Arrow Down",
        [4294968066L] = "Arrow Left",
        [4294968067L] = "Arrow Right",
        [4294968068L] = "Arrow Up",
        [4294968069L] = "End",
        [4294968070L] = "Home",
        [4294968071L] = "Page Down",
        [4294968072L] = "Page Up",
        [4294968321L] = "Clear",
        [4294968322L] = "Copy",
        [4294968323L] = "Cr Sel",
        [4294968324L] = "Cut",
        [4294968325L] = "Erase Eof",
        [4294968326L] = "Ex Sel",
        [4294968327L] = "Insert",
        [4294968328L] = "Paste",
        [4294968329L] = "Redo",
        ...
        [4294968588L] = "Select",
        [4294968589L] = "Zoom In",
        [4294968590L] = "Zoom Out",
        [4294968833L] = "Brightness Down",
        [4294968834L] = "Brightness Up",
        [4294968835L] = "Camera",
        [4294968836L] = "Eject",
        [4294968837L] = "Log Off",
        [4294968838L] = "Power",
        [4294968839L] = "Power Off",
        [4294968840L] = "Print Screen",
        [4294968841L] = "Hibernate",
        [4294968842L] = "Standby",
        [4294968843L] = "Wake Up",
        [4294969089L] = "All Candidates",
        [4294969090L] = "Alphanumeric",
        [4294969091L] = "Code Input",
        [4294969092L] = "Compose",
        [4294969093L] = "Convert",
        [4294969094L] = "Final Mode",
        [4294969095L] = "Group First",
        [4294969096L] = "Group Last",
        [4294969097L] = "Group Next",
        [4294969098L] = "Group Previous",
        [4294969099L] = "Mode Change",
        [4294969100L] = "Next Candidate",
        [4294969101L] = "Non Convert",
        [4294969102L] = "Previous Candidate",
        [4294969103L] = "Process",
        [4294969104L] = "Single Candidate",
        [4294969105L] = "Hangul Mode",
        [4294969106L] = "Hanja Mode",
        [4294969107L] = "Junja Mode",
        [4294969108L] = "Eisu",
        [4294969109L] = "Hankaku",
        [4294969110L] = "Hiragana",
        [4294969111L] = "Hiragana Katakana",
        [4294969112L] = "Kana Mode",
        [4294969113L] = "Kanji Mode",
        [4294969114L] = "Katakana",
        [4294969115L] = "Romaji",
        [4294969116L] = "Zenkaku",
        [4294969117L] = "Zenkaku Hankaku",
        [4294969345L] = "F1",
        [4294969346L] = "F2",
        [4294969347L] = "F3",
        [4294969348L] = "F4",
        ...
        [4294969608L] = "Soft 8",
        [4294969857L] = "Close",
        [4294969858L] = "Mail Forward",
        [4294969859L] = "Mail Reply",
        [4294969860L] = "Mail Send",
        [4294969861L] = "Media Play Pause",
        [4294969863L] = "Media Stop",
        [4294969864L] = "Media Track Next",
        [4294969865L] = "Media Track Previous",
        [4294969866L] = "New",
        [4294969867L] = "Open",
        [4294969868L] = "Print",
        [4294969869L] = "Save",
        [4294969870L] = "Spell Check",
        [4294969871L] = "Audio Volume Down",
        [4294969872L] = "Audio Volume Up",
        [4294969873L] = "Audio Volume Mute",
        [4294970113L] = "Launch Application 2",
        [4294970114L] = "Launch Calendar",
        [4294970115L] = "Launch Mail",
        [4294970116L] = "Launch Media Player",
        [4294970117L] = "Launch Music Player",
        [4294970118L] = "Launch Application 1",
        [4294970119L] = "Launch Screen Saver",
        [4294970120L] = "Launch Spreadsheet",
        [4294970121L] = "Launch Web Browser",
        [4294970122L] = "Launch Web Cam",
        [4294970123L] = "Launch Word Processor",
        [4294970124L] = "Launch Contacts",
        [4294970125L] = "Launch Phone",
        [4294970126L] = "Launch Assistant",
        [4294970127L] = "Launch Control Panel",
        [4294970369L] = "Browser Back",
        [4294970370L] = "Browser Favorites",
        [4294970371L] = "Browser Forward",
        [4294970372L] = "Browser Home",
        [4294970373L] = "Browser Refresh",
        [4294970374L] = "Browser Search",
        [4294970375L] = "Browser Stop",
        [4294970625L] = "Audio Balance Left",
        [4294970626L] = "Audio Balance Right",
        [4294970627L] = "Audio Bass Boost Down",
        [4294970628L] = "Audio Bass Boost Up",
        [4294970629L] = "Audio Fader Front",
        [4294970630L] = "Audio Fader Rear",
        [4294970631L] = "Audio Surround Mode Next",
        [4294970632L] = "AVR Input",
        [4294970633L] = "AVR Power",
        [4294970634L] = "Channel Down",
        [4294970635L] = "Channel Up",
        [4294970636L] = "Color F0 Red",
        [4294970637L] = "Color F1 Green",
        [4294970638L] = "Color F2 Yellow",
        [4294970639L] = "Color F3 Blue",
        [4294970640L] = "Color F4 Grey",
        [4294970641L] = "Color F5 Brown",
        [4294970642L] = "Closed Caption Toggle",
        [4294970643L] = "Dimmer",
        [4294970644L] = "Display Swap",
        [4294970645L] = "Exit",
        [4294970646L] = "Favorite Clear 0",
        [4294970647L] = "Favorite Clear 1",
        [4294970648L] = "Favorite Clear 2",
        [4294970649L] = "Favorite Clear 3",
        [4294970650L] = "Favorite Recall 0",
        [4294970651L] = "Favorite Recall 1",
        [4294970652L] = "Favorite Recall 2",
        [4294970653L] = "Favorite Recall 3",
        [4294970654L] = "Favorite Store 0",
        [4294970655L] = "Favorite Store 1",
        [4294970656L] = "Favorite Store 2",
        [4294970657L] = "Favorite Store 3",
        [4294970658L] = "Guide",
        [4294970659L] = "Guide Next Day",
        [4294970660L] = "Guide Previous Day",
        [4294970661L] = "Info",
        [4294970662L] = "Instant Replay",
        [4294970663L] = "Link",
        [4294970664L] = "List Program",
        [4294970665L] = "Live Content",
        [4294970666L] = "Lock",
        [4294970667L] = "Media Apps",
        [4294970668L] = "Media Fast Forward",
        [4294970669L] = "Media Last",
        [4294970670L] = "Media Pause",
        [4294970671L] = "Media Play",
        [4294970672L] = "Media Record",
        [4294970673L] = "Media Rewind",
        [4294970674L] = "Media Skip",
        [4294970675L] = "Next Favorite Channel",
        [4294970676L] = "Next User Profile",
        [4294970677L] = "On Demand",
        [4294970678L] = "P In P Down",
        [4294970679L] = "P In P Move",
        [4294970680L] = "P In P Toggle",
        [4294970681L] = "P In P Up",
        [4294970682L] = "Play Speed Down",
        [4294970683L] = "Play Speed Reset",
        [4294970684L] = "Play Speed Up",
        [4294970685L] = "Random Toggle",
        [4294970686L] = "Rc Low Battery",
        [4294970687L] = "Record Speed Next",
        [4294970688L] = "Rf Bypass",
        [4294970689L] = "Scan Channels Toggle",
        [4294970690L] = "Screen Mode Next",
        [4294970691L] = "Settings",
        [4294970692L] = "Split Screen Toggle",
        [4294970693L] = "STB Input",
        [4294970694L] = "STB Power",
        [4294970695L] = "Subtitle",
        [4294970696L] = "Teletext",
        [4294970697L] = "TV",
        [4294970698L] = "TV Input",
        [4294970699L] = "TV Power",
        [4294970700L] = "Video Mode Next",
        [4294970701L] = "Wink",
        [4294970702L] = "Zoom Toggle",
        [4294970703L] = "DVR",
        [4294970704L] = "Media Audio Track",
        [4294970705L] = "Media Skip Backward",
        [4294970706L] = "Media Skip Forward",
        [4294970707L] = "Media Step Backward",
        [4294970708L] = "Media Step Forward",
        [4294970709L] = "Media Top Menu",
        [4294970710L] = "Navigate In",
        [4294970711L] = "Navigate Next",
        [4294970712L] = "Navigate Out",
        [4294970713L] = "Navigate Previous",
        [4294970714L] = "Pairing",
        [4294970715L] = "Media Close",
        [4294970882L] = "Audio Bass Boost Toggle",
        [4294970884L] = "Audio Treble Down",
        [4294970885L] = "Audio Treble Up",
        [4294970886L] = "Microphone Toggle",
        [4294970887L] = "Microphone Volume Down",
        [4294970888L] = "Microphone Volume Up",
        [4294970889L] = "Microphone Volume Mute",
        [4294971137L] = "Speech Correction List",
        [4294971138L] = "Speech Input Toggle",
        [4294971393L] = "App Switch",
        [4294971394L] = "Call",
        [4294971395L] = "Camera Focus",
        [4294971396L] = "End Call",
        [4294971397L] = "Go Back",
        [4294971398L] = "Go Home",
        [4294971399L] = "Headset Hook",
        [4294971400L] = "Last Number Redial",
        [4294971401L] = "Notification",
        [4294971402L] = "Manner Mode",
        [4294971403L] = "Voice Dial",
        [4294971649L] = "TV 3 D Mode",
        [4294971650L] = "TV Antenna Cable",
        [4294971651L] = "TV Audio Description",
        [4294971652L] = "TV Audio Description Mix Down",
        [4294971653L] = "TV Audio Description Mix Up",
        [4294971654L] = "TV Contents Menu",
        [4294971655L] = "TV Data Service",
        [4294971656L] = "TV Input Component 1",
        [4294971657L] = "TV Input Component 2",
        [4294971658L] = "TV Input Composite 1",
        [4294971659L] = "TV Input Composite 2",
        [4294971660L] = "TV Input HDMI 1",
        [4294971661L] = "TV Input HDMI 2",
        [4294971662L] = "TV Input HDMI 3",
        [4294971663L] = "TV Input HDMI 4",
        [4294971664L] = "TV Input VGA 1",
        [4294971665L] = "TV Media Context",
        [4294971666L] = "TV Network",
        [4294971667L] = "TV Number Entry",
        [4294971668L] = "TV Radio Service",
        [4294971669L] = "TV Satellite",
        [4294971670L] = "TV Satellite BS",
        [4294971671L] = "TV Satellite CS",
        [4294971672L] = "TV Satellite Toggle",
        [4294971673L] = "TV Terrestrial Analog",
        [4294971674L] = "TV Terrestrial Digital",
        [4294971675L] = "TV Timer",
        [4294971905L] = "Key 11",
        [4294971906L] = "Key 12",
        [8589934592L] = "Suspend",
        [8589934593L] = "Resume",
        ...
        [8589934611L] = "Lang 4",
        [8589934612L] = "Lang 5",
        [8589934624L] = "Intl Backslash",
        [8589934625L] = "Intl Ro",
        [8589934626L] = "Intl Yen",
        [8589934848L] = "Control Left",
        [8589934849L] = "Control Right",
        [8589934850L] = "Shift Left",
        [8589934851L] = "Shift Right",
        [8589934852L] = "Alt Left",
        [8589934853L] = "Alt Right",
        [8589934854L] = "Meta Left",
        [8589934855L] = "Meta Right",
        [8589935088L] = "Control",
        [8589935090L] = "Shift",
        [8589935092L] = "Alt",
        [8589935094L] = "Meta",
        [8589935117L] = "Numpad Enter",
        [8589935144L] = "Numpad Paren Left",
        [8589935145L] = "Numpad Paren Right",
        [8589935146L] = "Numpad Multiply",
        [8589935147L] = "Numpad Add",
        [8589935148L] = "Numpad Comma",
        [8589935149L] = "Numpad Subtract",
        [8589935150L] = "Numpad Decimal",
        [8589935151L] = "Numpad Divide",
        [8589935152L] = "Numpad 0",
        [8589935153L] = "Numpad 1",
        [8589935154L] = "Numpad 2",
        [8589935155L] = "Numpad 3",
        [8589935156L] = "Numpad 4",
        [8589935157L] = "Numpad 5",
        [8589935158L] = "Numpad 6",
        [8589935159L] = "Numpad 7",
        [8589935160L] = "Numpad 8",
        [8589935161L] = "Numpad 9",
        [8589935165L] = "Numpad Equal",
        [8589935361L] = "Game Button 1",
        [8589935362L] = "Game Button 2",
        [8589935363L] = "Game Button 3",
        [8589935364L] = "Game Button 4",
        [8589935365L] = "Game Button 5",
        [8589935366L] = "Game Button 6",
        [8589935367L] = "Game Button 7",
        [8589935368L] = "Game Button 8",
        [8589935369L] = "Game Button 9",
        [8589935370L] = "Game Button 10",
        [8589935371L] = "Game Button 11",
        [8589935372L] = "Game Button 12",
        [8589935373L] = "Game Button 13",
        [8589935374L] = "Game Button 14",
        [8589935375L] = "Game Button 15",
        [8589935376L] = "Game Button 16",
        [8589935377L] = "Game Button A",
        [8589935378L] = "Game Button B",
        [8589935379L] = "Game Button C",
        [8589935380L] = "Game Button Left 1",
        [8589935381L] = "Game Button Left 2",
        [8589935382L] = "Game Button Mode",
        [8589935383L] = "Game Button Right 1",
        [8589935384L] = "Game Button Right 2",
        [8589935385L] = "Game Button Select",
        [8589935386L] = "Game Button Start",
        [8589935387L] = "Game Button Thumb Left",
        [8589935388L] = "Game Button Thumb Right",
        [8589935389L] = "Game Button X",
        [8589935390L] = "Game Button Y",
        [8589935391L] = "Game Button Z",
    };
    ...
    internal static long _nonValueBits(long n)
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            divisorForValueMask
            == ((1L << (int)firstDivisorWidth) * (1L << (int)(valueMaskWidth - firstDivisorWidth)))
        );
    ...
    {
        get { return (_unicodeKeyLabel(keyId) ?? _keyLabels.GetValueOrDefault(keyId)) ?? ""; }
    }
    ...
    public static LogicalKeyboardKey? findKeyByKeyId(long keyId) =>
        _knownLogicalKeys.GetValueOrDefault(keyId);
    ...
    public static bool isControlCharacter(string label)
    {
        ...
        return ((codeUnit <= 31L) && (codeUnit >= 0L))
            || ((codeUnit >= 127L) && (codeUnit <= 159L));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual bool isAutogenerated => (keyId & planeMask) >= startOfPlatformPlanes;
    public virtual HashSet<LogicalKeyboardKey> synonyms =>
        _synonyms.GetValueOrDefault(this) ?? new HashSet<LogicalKeyboardKey>();
    ...
    public static HashSet<LogicalKeyboardKey> collapseSynonyms(HashSet<LogicalKeyboardKey> input)
    {
        return input
            .expand(
                (element) =>
                {
                    return _synonyms.GetValueOrDefault(element)
                        ?? new HashSet<LogicalKeyboardKey> { element };
                }
            )
            .toSet();
        throw new InvalidOperationException("Dart control flow completed without a value.");
    ...
    public static HashSet<LogicalKeyboardKey> expandSynonyms(HashSet<LogicalKeyboardKey> input)
    {
        return input
            .expand(
                (element) =>
                {
                    return _reverseSynonyms.GetValueOrDefault(element)
                        ?? new HashSet<LogicalKeyboardKey> { element };
                }
            )
            .toSet();
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.Add(
            new StringProperty("keyId", $"0x{keyId.toRadixString(16L).padLeft(8L, "0")}")
        );
...
public class PhysicalKeyboardKey : KeyboardKey
{
    ...
    internal static DartMap<long, PhysicalKeyboardKey> _knownPhysicalKeys = new DartMap<
        long,
        PhysicalKeyboardKey
    >
    {
        ...
        [21L] = resume,
        [22L] = turbo,
        [23L] = privacyScreenToggle,
        [24L] = microphoneMuteToggle,
        [65666L] = sleep,
        [65667L] = wakeUp,
        [65717L] = displayToggleIntExt,
        [392961L] = gameButton1,
        [392962L] = gameButton2,
        [392963L] = gameButton3,
        [392964L] = gameButton4,
        ...
        [392968L] = gameButton8,
        [392969L] = gameButton9,
        [392970L] = gameButton10,
        [392971L] = gameButton11,
        [392972L] = gameButton12,
        [392973L] = gameButton13,
        [392974L] = gameButton14,
        [392975L] = gameButton15,
        [392976L] = gameButton16,
        [392977L] = gameButtonA,
        [392978L] = gameButtonB,
        [392979L] = gameButtonC,
        [392980L] = gameButtonLeft1,
        [392981L] = gameButtonLeft2,
        [392982L] = gameButtonMode,
        [392983L] = gameButtonRight1,
        [392984L] = gameButtonRight2,
        [392985L] = gameButtonSelect,
        [392986L] = gameButtonStart,
        [392987L] = gameButtonThumbLeft,
        [392988L] = gameButtonThumbRight,
        [392989L] = gameButtonX,
        [392990L] = gameButtonY,
        [392991L] = gameButtonZ,
        [458752L] = usbReserved,
        [458753L] = usbErrorRollOver,
        [458754L] = usbPostFail,
        [458755L] = usbErrorUndefined,
        [458756L] = keyA,
        [458757L] = keyB,
        [458758L] = keyC,
        [458759L] = keyD,
        ...
        [458834L] = arrowUp,
        [458835L] = numLock,
        [458836L] = numpadDivide,
        [458837L] = numpadMultiply,
        [458838L] = numpadSubtract,
        [458839L] = numpadAdd,
        [458840L] = numpadEnter,
        [458841L] = numpad1,
        [458842L] = numpad2,
        ...
        [458849L] = numpad9,
        [458850L] = numpad0,
        [458851L] = numpadDecimal,
        [458852L] = intlBackslash,
        [458853L] = contextMenu,
        [458854L] = power,
        [458855L] = numpadEqual,
        [458856L] = f13,
        ...
        [458877L] = paste,
        [458878L] = find,
        [458879L] = audioVolumeMute,
        [458880L] = audioVolumeUp,
        [458881L] = audioVolumeDown,
        [458885L] = numpadComma,
        [458887L] = intlRo,
        [458888L] = kanaMode,
        [458889L] = intlYen,
        ...
        [458907L] = abort,
        [458915L] = props,
        [458934L] = numpadParenLeft,
        [458935L] = numpadParenRight,
        [458939L] = numpadBackspace,
        [458960L] = numpadMemoryStore,
        [458961L] = numpadMemoryRecall,
        [458962L] = numpadMemoryClear,
        [458963L] = numpadMemoryAdd,
        [458964L] = numpadMemorySubtract,
        [458967L] = numpadSignChange,
        [458968L] = numpadClear,
        [458969L] = numpadClearEntry,
        [458976L] = controlLeft,
        [458977L] = shiftLeft,
        [458978L] = altLeft,
        [458979L] = metaLeft,
        [458980L] = controlRight,
        [458981L] = shiftRight,
        [458982L] = altRight,
        [458983L] = metaRight,
        [786528L] = info,
        [786529L] = closedCaptionToggle,
        [786543L] = brightnessUp,
        [786544L] = brightnessDown,
        [786546L] = brightnessToggle,
        [786547L] = brightnessMinimum,
        [786548L] = brightnessMaximum,
        [786549L] = brightnessAuto,
        [786553L] = kbdIllumUp,
        [786554L] = kbdIllumDown,
        [786563L] = mediaLast,
        [786572L] = launchPhone,
        [786573L] = programGuide,
        [786580L] = exit,
        [786588L] = channelUp,
        [786589L] = channelDown,
        [786608L] = mediaPlay,
        [786609L] = mediaPause,
        [786610L] = mediaRecord,
        [786611L] = mediaFastForward,
        [786612L] = mediaRewind,
        [786613L] = mediaTrackNext,
        [786614L] = mediaTrackPrevious,
        [786615L] = mediaStop,
        [786616L] = eject,
        [786637L] = mediaPlayPause,
        [786639L] = speechInputToggle,
        [786661L] = bassBoost,
        [786819L] = mediaSelect,
        [786820L] = launchWordProcessor,
        [786822L] = launchSpreadsheet,
        [786826L] = launchMail,
        [786829L] = launchContacts,
        [786830L] = launchCalendar,
        [786834L] = launchApp2,
        [786836L] = launchApp1,
        [786838L] = launchInternetBrowser,
        [786844L] = logOff,
        [786846L] = lockScreen,
        [786847L] = launchControlPanel,
        [786850L] = selectTask,
        [786855L] = launchDocuments,
        [786859L] = spellCheck,
        [786862L] = launchKeyboardLayout,
        [786865L] = launchScreenSaver,
        [786871L] = launchAudioBrowser,
        [786891L] = launchAssistant,
        [786945L] = newKey,
        [786947L] = close,
        [786951L] = save,
        [786952L] = print,
        [786977L] = browserSearch,
        [786979L] = browserHome,
        [786980L] = browserBack,
        [786981L] = browserForward,
        [786982L] = browserStop,
        [786983L] = browserRefresh,
        [786986L] = browserFavorites,
        [786989L] = zoomIn,
        [786990L] = zoomOut,
        [786994L] = zoomToggle,
        [787065L] = redo,
        ...
        [787083L] = mailForward,
        [787084L] = mailSend,
        [787101L] = keyboardLayoutSelect,
        [787103L] = showAllWindows,
    };
    internal static DartMap<long, string> _debugNames = ConstantsLibrary.kReleaseMode
        ? new DartMap<long, string>()
        : new DartMap<long, string>
        {
            [16L] = "Hyper",
            [17L] = "Super Key",
            ...
            [21L] = "Resume",
            [22L] = "Turbo",
            [23L] = "Privacy Screen Toggle",
            [24L] = "Microphone Mute Toggle",
            [65666L] = "Sleep",
            [65667L] = "Wake Up",
            [65717L] = "Display Toggle Int Ext",
            [392961L] = "Game Button 1",
            [392962L] = "Game Button 2",
            [392963L] = "Game Button 3",
            [392964L] = "Game Button 4",
            [392965L] = "Game Button 5",
            [392966L] = "Game Button 6",
            [392967L] = "Game Button 7",
            [392968L] = "Game Button 8",
            [392969L] = "Game Button 9",
            [392970L] = "Game Button 10",
            [392971L] = "Game Button 11",
            [392972L] = "Game Button 12",
            [392973L] = "Game Button 13",
            [392974L] = "Game Button 14",
            [392975L] = "Game Button 15",
            [392976L] = "Game Button 16",
            [392977L] = "Game Button A",
            [392978L] = "Game Button B",
            [392979L] = "Game Button C",
            [392980L] = "Game Button Left 1",
            [392981L] = "Game Button Left 2",
            [392982L] = "Game Button Mode",
            [392983L] = "Game Button Right 1",
            [392984L] = "Game Button Right 2",
            [392985L] = "Game Button Select",
            [392986L] = "Game Button Start",
            [392987L] = "Game Button Thumb Left",
            [392988L] = "Game Button Thumb Right",
            [392989L] = "Game Button X",
            [392990L] = "Game Button Y",
            [392991L] = "Game Button Z",
            [458752L] = "Usb Reserved",
            [458753L] = "Usb Error Roll Over",
            [458754L] = "Usb Post Fail",
            [458755L] = "Usb Error Undefined",
            [458756L] = "Key A",
            [458757L] = "Key B",
            [458758L] = "Key C",
            [458759L] = "Key D",
            ...
            [458797L] = "Minus",
            [458798L] = "Equal",
            [458799L] = "Bracket Left",
            [458800L] = "Bracket Right",
            [458801L] = "Backslash",
            [458803L] = "Semicolon",
            [458804L] = "Quote",
            [458805L] = "Backquote",
            ...
            [458834L] = "Arrow Up",
            [458835L] = "Num Lock",
            [458836L] = "Numpad Divide",
            [458837L] = "Numpad Multiply",
            [458838L] = "Numpad Subtract",
            [458839L] = "Numpad Add",
            [458840L] = "Numpad Enter",
            [458841L] = "Numpad 1",
            [458842L] = "Numpad 2",
            [458843L] = "Numpad 3",
            [458844L] = "Numpad 4",
            ...
            [458849L] = "Numpad 9",
            [458850L] = "Numpad 0",
            [458851L] = "Numpad Decimal",
            [458852L] = "Intl Backslash",
            [458853L] = "Context Menu",
            [458854L] = "Power",
            [458855L] = "Numpad Equal",
            [458856L] = "F13",
            [458857L] = "F14",
            [458858L] = "F15",
            [458859L] = "F16",
            ...
            [458877L] = "Paste",
            [458878L] = "Find",
            [458879L] = "Audio Volume Mute",
            [458880L] = "Audio Volume Up",
            [458881L] = "Audio Volume Down",
            [458885L] = "Numpad Comma",
            [458887L] = "Intl Ro",
            [458888L] = "Kana Mode",
            [458889L] = "Intl Yen",
            [458890L] = "Convert",
            ...
            [458907L] = "Abort",
            [458915L] = "Props",
            [458934L] = "Numpad Paren Left",
            [458935L] = "Numpad Paren Right",
            [458939L] = "Numpad Backspace",
            [458960L] = "Numpad Memory Store",
            [458961L] = "Numpad Memory Recall",
            [458962L] = "Numpad Memory Clear",
            [458963L] = "Numpad Memory Add",
            [458964L] = "Numpad Memory Subtract",
            [458967L] = "Numpad Sign Change",
            [458968L] = "Numpad Clear",
            [458969L] = "Numpad Clear Entry",
            [458976L] = "Control Left",
            [458977L] = "Shift Left",
            [458978L] = "Alt Left",
            [458979L] = "Meta Left",
            [458980L] = "Control Right",
            [458981L] = "Shift Right",
            [458982L] = "Alt Right",
            [458983L] = "Meta Right",
            [786528L] = "Info",
            [786529L] = "Closed Caption Toggle",
            [786543L] = "Brightness Up",
            [786544L] = "Brightness Down",
            [786546L] = "Brightness Toggle",
            [786547L] = "Brightness Minimum",
            [786548L] = "Brightness Maximum",
            [786549L] = "Brightness Auto",
            [786553L] = "Kbd Illum Up",
            [786554L] = "Kbd Illum Down",
            [786563L] = "Media Last",
            [786572L] = "Launch Phone",
            [786573L] = "Program Guide",
            [786580L] = "Exit",
            [786588L] = "Channel Up",
            [786589L] = "Channel Down",
            [786608L] = "Media Play",
            [786609L] = "Media Pause",
            [786610L] = "Media Record",
            [786611L] = "Media Fast Forward",
            [786612L] = "Media Rewind",
            [786613L] = "Media Track Next",
            [786614L] = "Media Track Previous",
            [786615L] = "Media Stop",
            [786616L] = "Eject",
            [786637L] = "Media Play Pause",
            [786639L] = "Speech Input Toggle",
            [786661L] = "Bass Boost",
            [786819L] = "Media Select",
            [786820L] = "Launch Word Processor",
            [786822L] = "Launch Spreadsheet",
            [786826L] = "Launch Mail",
            [786829L] = "Launch Contacts",
            [786830L] = "Launch Calendar",
            [786834L] = "Launch App2",
            [786836L] = "Launch App1",
            [786838L] = "Launch Internet Browser",
            [786844L] = "Log Off",
            [786846L] = "Lock Screen",
            [786847L] = "Launch Control Panel",
            [786850L] = "Select Task",
            [786855L] = "Launch Documents",
            [786859L] = "Spell Check",
            [786862L] = "Launch Keyboard Layout",
            [786865L] = "Launch Screen Saver",
            [786871L] = "Launch Audio Browser",
            [786891L] = "Launch Assistant",
            [786945L] = "New Key",
            [786947L] = "Close",
            [786951L] = "Save",
            [786952L] = "Print",
            [786977L] = "Browser Search",
            [786979L] = "Browser Home",
            [786980L] = "Browser Back",
            [786981L] = "Browser Forward",
            [786982L] = "Browser Stop",
            [786983L] = "Browser Refresh",
            [786986L] = "Browser Favorites",
            [786989L] = "Zoom In",
            [786990L] = "Zoom Out",
            [786994L] = "Zoom Toggle",
            [787065L] = "Redo",
            [787081L] = "Mail Reply",
            [787083L] = "Mail Forward",
            [787084L] = "Mail Send",
            [787101L] = "Keyboard Layout Select",
            [787103L] = "Show All Windows",
        };
    ...
    public virtual string? debugName
    {
        get
        {
            ...
            {
                result =
                    _debugNames.GetValueOrDefault(usbHidUsage)
                    ?? $"Key with ID 0x{usbHidUsage.toRadixString(16L).padLeft(8L, "0")}";
                return true;
            });
            return result;
        }
    ...
    public static PhysicalKeyboardKey? findKeyByCode(long usageCode) =>
        _knownPhysicalKeys.GetValueOrDefault(usageCode);
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.Add(
            new StringProperty(
                "usbHidUsage",
                $"0x{usbHidUsage.toRadixString(16L).padLeft(8L, "0")}"
            )
        );
        properties.Add(new StringProperty("debugName", debugName, defaultValue: null));
    }
