...
public class LogicalKeyboardKey : KeyboardKey
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is LogicalKeyboardKey) && (__other.keyId == keyId);
    }
...
public class PhysicalKeyboardKey : KeyboardKey
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is PhysicalKeyboardKey) && (__other.usbHidUsage == usbHidUsage);
    }
