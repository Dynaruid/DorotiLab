...
{
    public static MethodChannel navigation = new OptionalMethodChannel(
        "flutter/navigation",
        new JSONMethodCodec()
    );
    ...
    public static OptionalMethodChannel statusBar = new OptionalMethodChannel(
        "flutter/status_bar",
        new JSONMethodCodec()
    );
    ...
    public static MethodChannel scribe = new OptionalMethodChannel(
        "flutter/scribe",
        new JSONMethodCodec()
    );
    public static MethodChannel spellCheck = new OptionalMethodChannel("flutter/spellcheck");
    public static MethodChannel undoManager = new OptionalMethodChannel(
        "flutter/undomanager",
        new JSONMethodCodec()
    );
    ...
    public static BasicMessageChannel<string> lifecycle = new BasicMessageChannel<string>(
        "flutter/lifecycle",
        new StringCodec()
    );
    public static BasicMessageChannel<object?> system = new BasicMessageChannel<object?>(
        "flutter/system",
        new JSONMessageCodec()
    );
    public static BasicMessageChannel<object?> accessibility = new BasicMessageChannel<object?>(
    ...
    public static MethodChannel deferredComponent = new OptionalMethodChannel(
        "flutter/deferredcomponent"
    );
    public static MethodChannel localization = new OptionalMethodChannel(
        "flutter/localization",
        new JSONMethodCodec()
    );
    public static MethodChannel menu = new OptionalMethodChannel("flutter/menu");
    public static MethodChannel contextMenu = new OptionalMethodChannel(
        "flutter/contextmenu",
        new JSONMethodCodec()
    );
    public static MethodChannel keyboard = new OptionalMethodChannel("flutter/keyboard");
    public static MethodChannel sensitiveContent = new OptionalMethodChannel(
