...
public class TextInputType : IDartEnumIndex
{
    ...
    public static TextInputType number = CreateNumberWithOptions();
    ...
    public static List<TextInputType> values = new List<TextInputType>
    {
        text,
        multiline,
        number,
    ...
    internal static List<string> _names = new List<string>
    {
        "text",
        "multiline",
        "number",
    ...
    public static TextInputType CreateNumberWithOptions(
        bool? signed = false,
        bool? @decimal = false
    )
    {
    ...
    {
        return $"{objectRuntimeTypeFunctions.objectRuntimeType(this, "TextInputType")}("
            + $"name: {_name}, "
            + $"signed: {signed}, "
            + $"decimal: {@decimal})";
        throw new InvalidOperationException("Dart control flow completed without a value.");
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is TextInputType)
            && (FoundationRuntimePorts.EnumIndex(__other) == index)
            && (__other.signed == signed)
            && (__other.@decimal == @decimal);
    }
...
public class TextInputConfiguration
{
    ...
    public TextInputConfiguration(
        ...
        AutofillConfiguration autofillConfiguration = default!,
        bool enableIMEPersonalizedLearning = true,
        List<string> allowedMimeTypes = default!,
        bool enableDeltaModel = false,
        List<Locale>? hintLocales = default!,
    ...
    public virtual TextInputConfiguration copyWith(
        long? viewId = null,
        ...
        string? actionLabel = null,
        TextInputAction? inputAction = null,
    ...
    public virtual DartMap<string, object?> toJson()
    {
        ...
        return new DartMap<string, object?>
        {
            ...
            ["smartDashesType"] = FoundationRuntimePorts.EnumIndex(smartDashesType).ToString(),
            ["smartQuotesType"] = FoundationRuntimePorts.EnumIndex(smartQuotesType).ToString(),
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is TextInputConfiguration)
            && (__other.viewId == viewId)
            && Equals(__other.inputType, inputType)
            && (__other.readOnly == readOnly)
            && (__other.obscureText == obscureText)
            && (__other.autocorrect == autocorrect)
            && Equals(__other.smartDashesType, smartDashesType)
            && Equals(__other.smartQuotesType, smartQuotesType)
            && (__other.enableSuggestions == enableSuggestions)
            && (__other.enableInteractiveSelection == enableInteractiveSelection)
            && (__other.actionLabel == actionLabel)
            && Equals(__other.inputAction, inputAction)
            && Equals(__other.keyboardAppearance, keyboardAppearance)
            && Equals(__other.textCapitalization, textCapitalization)
            && Equals(__other.autofillConfiguration, autofillConfiguration)
            && (__other.enableIMEPersonalizedLearning == enableIMEPersonalizedLearning)
            && CollectionsLibrary.listEquals(__other.allowedMimeTypes, allowedMimeTypes)
            && (__other.enableDeltaModel == enableDeltaModel)
            && Equals(__other.hintLocales, hintLocales)
            && (__other.enableInlinePrediction == enableInlinePrediction);
    }
    ...
    public override int GetHashCode()
    {
        return FoundationRuntimePorts.ObjectHash(
            ...
            FoundationRuntimePorts.ObjectHashAll(allowedMimeTypes),
            enableDeltaModel,
            hintLocales,
...
public static partial class Text_inputLibrary
{
    internal static TextAffinity? _toTextAffinity(string? affinity)
    {
        ...
        {
            var __case35229 when Equals(__case35229, "TextAffinity.downstream") =>
                TextAffinity.downstream,
            var __case35287 when Equals(__case35287, "TextAffinity.upstream") =>
...
public class RawFloatingCursorPoint
{
    ...
    public RawFloatingCursorPoint(
        Offset? offset = null,
        (Offset, TextPosition)? startLocation = null,
        FloatingCursorDragState state = default!
    )
    {
        this.offset = offset;
...
public class TextEditingValue
{
    ...
    public static TextEditingValue CreateFromJSON(DartMap<string, object?> encoded)
    {
        ...
        var selection = new TextSelection(
            ...
            affinity: Text_inputLibrary._toTextAffinity(
    ...
    public virtual TextEditingValue copyWith(
        string? text = null,
        TextSelection? selection = null,
        TextRange? composing = null
    )
    ...
    public virtual TextEditingValue replaced(TextRange replacementRange, string replacementString)
    {
        ...
        var adjustedComposing = new TextRange(
    ...
    public override string ToString() =>
        $"{objectRuntimeTypeFunctions.objectRuntimeType(this, "TextEditingValue")}(text: ┤{text}├, selection: {selection}, composing: {composing})";
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is TextEditingValue)
            && (__other.text == text)
            && Equals(__other.selection, selection)
            && Equals(__other.composing, composing);
    }
...
public interface TextInputClient
{
    ...
    public void didChangeInputControl(
...
public class SelectionRect
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is SelectionRect)
            && (__other.position == position)
            && Equals(__other.bounds, bounds)
...
public class TextInputStyle : Diagnosticable
{
    ...
    public virtual DartMap<string, object?> toJson()
    {
        return new DartMap<string, object?>
        {
            ...
            ["fontSize"] = fontSize,
            ["fontWeightIndex"] = FoundationRuntimePorts.EnumIndex(fontWeight),
            ["textAlignIndex"] = FoundationRuntimePorts.EnumIndex(textAlign),
            ["textDirectionIndex"] = FoundationRuntimePorts.EnumIndex(textDirection),
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.Add(
            new DiagnosticsProperty<FontWeight>("fontWeight", fontWeight, defaultValue: null)
        );
...
public static partial class Text_inputLibrary
{
    internal static TextInputAction _toTextInputAction(string action)
    {
        ...
        {
            var __case70013 when Equals(__case70013, "TextInputAction.none") =>
                TextInputAction.none,
            var __case70065 when Equals(__case70065, "TextInputAction.unspecified") =>
                TextInputAction.unspecified,
            var __case70131 when Equals(__case70131, "TextInputAction.go") => TextInputAction.go,
            var __case70179 when Equals(__case70179, "TextInputAction.search") =>
                TextInputAction.search,
            var __case70235 when Equals(__case70235, "TextInputAction.send") =>
                TextInputAction.send,
            var __case70287 when Equals(__case70287, "TextInputAction.next") =>
                TextInputAction.next,
            var __case70339 when Equals(__case70339, "TextInputAction.previous") =>
                TextInputAction.previous,
            var __case70399 when Equals(__case70399, "TextInputAction.continueAction") =>
                TextInputAction.continueAction,
            var __case70471 when Equals(__case70471, "TextInputAction.join") =>
                TextInputAction.join,
            var __case70523 when Equals(__case70523, "TextInputAction.route") =>
                TextInputAction.route,
            var __case70577 when Equals(__case70577, "TextInputAction.emergencyCall") =>
                TextInputAction.emergencyCall,
            var __case70647 when Equals(__case70647, "TextInputAction.done") =>
                TextInputAction.done,
            var __case70699 when Equals(__case70699, "TextInputAction.newline") =>
                TextInputAction.newline,
            _ => throw new FlutterError(
                new List<DiagnosticsNode>
                {
                    new ErrorSummary($"Unknown text input action: {action}"),
                }
            ),
        };
        throw new InvalidOperationException("Dart control flow completed without a value.");
...
public static partial class Text_inputLibrary
{
    internal static FloatingCursorDragState _toTextCursorAction(string state)
    {
        return state switch
        {
            var __case70974 when Equals(__case70974, "FloatingCursorDragState.start") =>
                FloatingCursorDragState.Start,
            var __case71044 when Equals(__case71044, "FloatingCursorDragState.update") =>
                FloatingCursorDragState.Update,
            var __case71116 when Equals(__case71116, "FloatingCursorDragState.end") =>
...
public static partial class Text_inputLibrary
{
    internal static RawFloatingCursorPoint _toTextPoint(
        FloatingCursorDragState state,
        DartMap<string, object?> encoded
    )
    {
        double ReadCoordinate(string key) =>
            encoded.GetValueOrDefault(key) switch
            {
                double value => value,
                long value => value,
                int value => value,
        ...
        Offset offset = Equals(state, FloatingCursorDragState.Update)
...
public static partial class Text_inputLibrary
{
    internal static void _reportError(
        object exception,
        StackTrace stack,
        string context,
...
public class TextInput
{
    ...
    internal virtual TextInputControl? _currentControl { get; set; } =
        _HostTextInputControl.instance;
    internal virtual HashSet<TextInputControl> _inputControls { get; private set; } =
        new HashSet<TextInputControl> { _HostTextInputControl.instance };
    internal static List<TextInputAction> _androidSupportedInputActions = new List<TextInputAction>
    {
        TextInputAction.none,
        TextInputAction.unspecified,
        TextInputAction.done,
    ...
    internal static List<TextInputAction> _iOSSupportedInputActions = new List<TextInputAction>
    {
        TextInputAction.unspecified,
        TextInputAction.done,
        TextInputAction.send,
    ...
    internal virtual DartMap<string, ScribbleClient> _scribbleClients { get; private set; } =
        new DartMap<string, ScribbleClient>();
    ...
    internal virtual async Future<object> _loudlyHandleTextInputInvocation(MethodCall call)
    {
        try
        {
        ...
        catch (Exception exception)
        {
            ...
            Text_inputLibrary._reportError(
                exception,
                stack,
    ...
    internal virtual async Future<object> _handleTextInputInvocation(MethodCall methodCall)
    {
        ...
        switch (method)
        {
            case var __case81975 when Equals(__case81975, "TextInputClient.focusElement"):
            {
                ...
                _scribbleClients
                    .GetValueOrDefault(argsLocal[(int)0L])
                    ?.onScribbleFocus(
                        new Offset(
                            ((double)argsLocal[(int)1L]).toDouble(),
                            ((double)argsLocal[(int)2L]).toDouble()
                        )
                    );
                return default!;
            }
            ...
            {
                List<double> argsAlternate = ((List<object>?)methodCall.arguments)!
                    .cast<double>()
                    .map((value) => value.toDouble())
                    .ToList();
                return _scribbleClients
                    .Keys.where(
                        (elementIdentifier) =>
                        {
                            var rect = new Rect(
                                argsAlternate[(int)0L],
                                argsAlternate[(int)1L],
                                argsAlternate[(int)2L],
                                argsAlternate[(int)3L]
                            );
                            if (
                                !(
                                    _scribbleClients
                                        .GetValueOrDefault(elementIdentifier)
                                        ?.isInScribbleRect(rect)
                                    ?? false
                                )
                            )
                            {
                            ...
                            Rect boundsLocal =
                                _scribbleClients.GetValueOrDefault(elementIdentifier)?.bounds
                                ?? Rect.zero;
                            return !(
                                Equals(boundsLocal, Rect.zero)
                                || boundsLocal.hasNaN
                                || boundsLocal.isInfinite
                            );
                        }
                    )
                    .map(
                        (elementIdentifier) =>
                        {
                            Rect boundsLocal = _scribbleClients
                                .GetValueOrDefault(elementIdentifier)!
                                .bounds;
            ...
            case var __case83288
                when Equals(__case83288, "TextInputClient.scribbleInteractionBegan"):
            {
                _scribbleInProgress = true;
                return default!;
            }
            case var __case83395
                when Equals(__case83395, "TextInputClient.scribbleInteractionFinished"):
            {
        ...
        if (method == "TextInputClient.updateEditingStateWithTag")
        {
            ...
            var editingValueLocal = DartRuntimePrimitives.ConvertMap<string, object?>(
                (System.Collections.IDictionary)args[(int)1L]
            );
            foreach (string tag in editingValueLocal.Keys)
            {
                var textEditingValue = TextEditingValue.CreateFromJSON(
                    DartRuntimePrimitives.ConvertMap<string, object?>(
                        editingValueLocal.GetValueOrDefault(tag) as System.Collections.IDictionary
                            ?? throw new FormatException("Autofill editing values require a map.")
                    )
                );
                AutofillClient? clientAlternate = scope?.getAutofillClient(tag);
                if (
                    (clientAlternate is not null)
                    && clientAlternate.textInputConfiguration.autofillConfiguration.enabled
                )
                {
        ...
        switch (method)
        {
            ...
            {
                var valueLocal = TextEditingValue.CreateFromJSON(
                    DartRuntimePrimitives.ConvertMap<string, object?>(
                        (System.Collections.IDictionary)args[(int)1L]
                    )
                );
                _instance._updateEditingValue(
                    valueLocal,
                    exclude: _PlatformTextInputControl.instance
                );
                break;
            }
            case var __case86093
                when Equals(__case86093, "TextInputClient.updateEditingStateWithDeltas"):
            {
                DartRuntimePrimitives.Assert(() =>
                    _currentConnection!._client is DeltaTextInputClient
                );
                var encoded = DartRuntimePrimitives.ConvertMap<string, object?>(
                    (System.Collections.IDictionary)args[(int)1L]
                );
                var deltas = new List<TextEditingDelta>();
                ((DeltaTextInputClient?)_currentConnection!._client)!.updateEditingValueWithDeltas(
                    deltas
                );
                break;
            }
            case var __case86724 when Equals(__case86724, "TextInputClient.performAction"):
            {
                ...
                {
                    var content = KeyboardInsertedContent.CreateFromJson(
                        DartRuntimePrimitives.ConvertMap<string, object?>(
                            (System.Collections.IDictionary)args[(int)2L]
                        )
                    );
                ...
                else
                {
                    _currentConnection!._client.performAction(
                        Text_inputLibrary._toTextInputAction(((string?)args[(int)1L])!)
                    );
                }
                break;
            }
            ...
            {
                var firstArg = DartRuntimePrimitives.ConvertMap<string, object?>(
                    (System.Collections.IDictionary)args[(int)1L]
                );
                _currentConnection!._client.performPrivateCommand(
                    ((string?)firstArg.GetValueOrDefault("action"))!,
                    firstArg.GetValueOrDefault("data") is { } privateData
                        ? DartRuntimePrimitives.ConvertMap<string, object?>(
                            (System.Collections.IDictionary)privateData
                        )
            ...
            case var __case87632 when Equals(__case87632, "TextInputClient.updateFloatingCursor"):
            {
                _currentConnection!._client.updateFloatingCursor(
                    Text_inputLibrary._toTextPoint(
                        Text_inputLibrary._toTextCursorAction(((string?)args[(int)1L])!),
                        DartRuntimePrimitives.ConvertMap<string, object?>(
                            (System.Collections.IDictionary)args[(int)2L]
                        )
                    )
            ...
            case var __case87954
                when Equals(__case87954, "TextInputClient.showAutocorrectionPromptRect"):
            {
            ...
            case var __case88204 when Equals(__case88204, "TextInputClient.insertTextPlaceholder"):
            {
                _currentConnection!._client.insertTextPlaceholder(
                    new Size(((double)args[(int)1L]).toDouble(), ((double)args[(int)2L]).toDouble())
                );
                break;
            }
    ...
    internal virtual void _updateEditingValue(
        TextEditingValue value,
        TextInputControl? exclude = null
    )
    {
        if (_currentConnection is null)
        {
    ...
    public static void registerScribbleElement(
...
internal sealed class _HostTextInputControl : TextInputControl
{
    ...
    public override void attach(TextInputClient client, TextInputConfiguration configuration)
    {
        ...
        _capability.SetClient(
            ToHost(configuration),
            ToHost(client.currentTextEditingValue ?? TextEditingValue.empty)
        );
    }
    ...
    public override void updateStyle(TextInputStyle style) =>
        RequireCapability("TextInput.setStyle")
            .SetStyle(
                new DorotiTextInputStyle(
                    style.fontFamily,
                    style.fontSize,
                    style.fontWeight,
                    style.textDirection,
    ...
    private void OnEditingStateChanged(DorotiTextEditingState state)
    {
        ...
        {
            if (!ReferenceEquals(client, _client) || !ReferenceEquals(view, _view))
            {
                return;
            }
    ...
    private void OnFloatingCursorChanged(DorotiFloatingCursorEvent point)
    {
        ...
        view.DispatchPlatformEvent(() =>
        {
            ...
            client.updateFloatingCursor(
                new RawFloatingCursorPoint(
                    offset: point.offset,
                    state: point.phase switch
                    {
    ...
    private static DorotiTextInputConfiguration ToHost(TextInputConfiguration configuration) =>
        new(
...
internal class _PlatformTextInputControl : TextInputControl
{
    ...
    internal virtual DartMap<string, object?> _configurationToJson(
        TextInputConfiguration configuration
    )
    {
    ...
    {
        _ = _channel
            .invokeMethod<object?>("TextInput.clearClient")
            .then(
                (_) => { },
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(
                        error,
                        stack,
                        "while detaching the text input client"
                    )
            );
    }
    ...
    {
        _ = _channel
            .invokeMethod<object?>("TextInput.updateConfig", _configurationToJson(configuration))
            .then(
                (_) => { },
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(
    ...
    {
        _ = _channel
            .invokeMethod<object?>("TextInput.setEditingState", value.toJSON())
            .then(
                (_) => { },
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(
                        error,
                        stack,
                        "while setting text input editing state"
                    )
            );
    }
            ...
            .then(
                ...
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(
                        error,
                        stack,
                        "while showing the text input client"
                    )
            );
    }
            ...
            .then(
                ...
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(
                        error,
                        stack,
                        "while hiding the text input client"
                    )
            );
    }
            ...
            .then(
                ...
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(
                        error,
                        stack,
                        "while setting text input composing rect"
                    )
            );
    }
            ...
            .then(
                ...
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(
                        error,
                        stack,
                        "while setting text input caret rect"
                    )
            );
    }
                    ...
                    .map(
                        (rect) =>
                        {
                            return new List<double>
                            {
                                ...
                                rect.bounds.height,
                                rect.position,
                                FoundationRuntimePorts.EnumIndex(rect.direction),
                            };
                        }
                    )
                    .ToList()
    ...
    {
        _ = _channel
            .invokeMethod<object?>("TextInput.setStyle", style.toJson())
            .then(
                (_) => { },
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(error, stack, "while updating text input style")
            );
    }
    ...
    {
        _ = _channel
            .invokeMethod<object?>("TextInput.requestAutofill")
            .then(
                (_) => { },
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(error, stack, "while requesting autofill")
            );
    }
    ...
    {
        _ = _channel
            .invokeMethod<object?>("TextInput.finishAutofillContext", shouldSave)
            .then(
                (_) => { },
                onError: (error, stack) =>
                    Text_inputLibrary._reportError(error, stack, "while finishing autofill context")
            );
    }
}
...
public class SystemContextMenuController : SystemContextMenuClient, Diagnosticable
{
    ...
    internal virtual DartMap<string, Action> _customActionCallbacks { get; private set; } =
        new DartMap<string, Action>();
    ...
    public virtual Future show(Rect targetRect)
    {
        ...
        if (
            (_lastShown is not null)
            && _lastShown!.isVisible
            && Equals(_lastShown!._lastTargetRect, targetRect)
        )
        {
            return Future.value();
        }
        DartRuntimePrimitives.Assert(() =>
            (_lastShown is null) || Equals(_lastShown, this) || !_lastShown!.isVisible
        );
        ...
        return _channel.invokeMethod<object?>(
            ...
            new DartMap<string, object?>
            {
                ["targetRect"] = new DartMap<string, double>
                {
                    ["x"] = targetRect.left,
                    ["y"] = targetRect.top,
    ...
    public virtual Future showWithItems(Rect targetRect, List<IOSSystemContextMenuItemData> items)
    {
        ...
        if (
            ...
            && _lastShown!.isVisible
            && Equals(_lastShown!._lastTargetRect, targetRect)
            && CollectionsLibrary.listEquals(_lastShown!._lastItems, items)
        )
        {
            return Future.value();
        }
        ...
        foreach (var item in items)
        {
            ...
            {
                DartRuntimePrimitives.Assert(() =>
                    !_customActionCallbacks.ContainsKey(item__as114122.callbackId)
                    || Equals(
                        _customActionCallbacks.GetValueOrDefault(item__as114122.callbackId),
                        item__as114122.onPressed
                    )
                );
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.Add(
            new FlagProperty(
                "onSystemHide",
                value: onSystemHide is not null,
                ifTrue: "callback set",
...
public class IOSSystemContextMenuItemDataCustom : IOSSystemContextMenuItemData, Diagnosticable
{
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is IOSSystemContextMenuItemDataCustom)
            && (__other.title == title)
            && Equals(__other.onPressed, onPressed);
    }
}
