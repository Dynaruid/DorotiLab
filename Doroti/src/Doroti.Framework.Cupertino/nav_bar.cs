...
{
    internal static double _kNavBarPersistentHeight =
...
public static partial class Nav_barLibrary
{
    internal static Border _kDefaultNavBarBorder = new Border(
        bottom: new BorderSide(color: _kDefaultNavBarBorderColor, width: 0.0)
    );
}

public static partial class Nav_barLibrary
{
    internal static Border _kTransparentNavBarBorder = new Border(
        bottom: new BorderSide(color: new Color(0L), width: 0.0)
    );
}
...
internal class _HeroTag__nav_bar
{
    ...
    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(Dart_coreLibrary.identityHashCode(navigator));
}
...
public class _FixedSizeSlidingTransition__nav_bar : AnimatedWidget
{
    ...
    internal _FixedSizeSlidingTransition__nav_bar(
        bool isLTR,
        ...
        : base(listenable: offsetAnimation)
    {
        this.isLTR = isLTR;
...
public static partial class Nav_barLibrary
{
    internal static Widget _wrapWithBackground(
        Border? border = null,
    ...
    )
    {
        ...
        if (updateSystemUiOverlay)
        {
            ...
            SystemUiOverlayStyle overlayStyle = newBrightness switch
            {
...
public static partial class Nav_barLibrary
{
    internal static double _dampScaleFactor(
...
public class CupertinoNavigationBar : StatefulWidget, ObstructingPreferredSizeWidget
{
        ...
        : base(key: key)
    {
        ...
        System.Diagnostics.Debug.Assert(
            !transitionBetweenRoutes
                || DartRuntimePrimitives.Identical(__heroTag, Nav_barLibrary._defaultHeroTag)
        );
    }

    public static CupertinoNavigationBar CreateLarge(
        Key? key = null,
    ...
    public virtual Size preferredSize
    {
        get
        {
            ...
            double effectiveLargeHeight =
                (largeTitle is not null) ? Nav_barLibrary._kNavBarLargeTitleHeightExtension : 0.0;
            return new Size(
                Nav_barLibrary._kNavBarPersistentHeight + bottomHeight + effectiveLargeHeight
            );
        }
    }

    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _CupertinoNavigationBarState__nav_bar());
}
...
internal class _CupertinoNavigationBarState__nav_bar : State<CupertinoNavigationBar>
{
    ...
    internal virtual void _handleScrollNotification(ScrollNotification notification)
    {
        if (
            ...
            && (((ScrollUpdateNotification)notification).depth == 0L)
        )
        {
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Color backgroundColorLocal =
            ...
            ?? CupertinoTheme.of(context).barBackgroundColor;
        Color? parentPageScaffoldBackgroundColor = CupertinoPageScaffoldBackgroundColor.maybeOf(
            context
        );
        Border? initialBorder =
            (
                widget.automaticBackgroundVisibility
                && (parentPageScaffoldBackgroundColor is not null)
            )
                ? Nav_barLibrary._kTransparentNavBarBorder
                : widget.border;
        Border? effectiveBorder =
            (widget.border is null)
                ? null
        ...
        double persistentHeight =
            Nav_barLibrary._kNavBarPersistentHeight
            + bottomHeight
        ...
        var componentsLocal = new _NavigationBarStaticComponents__nav_bar(
            keys: keys,
            route: ModalRoute<object>.untypedOf(context),
            ...
            userBottom: DartRuntimePrimitives.ConvertValue<Widget>(widget.bottom),
            large: widget.largeTitle is not null,
            staticBar: true,
            context: context
        );
        Widget navBar = new _PersistentNavigationBar__nav_bar(
            components: componentsLocal,
            padding: widget.padding,
            middleVisible: widget.largeTitle is null
        );
        if (widget.largeTitle is not null)
        {
            navBar = DartRuntimePrimitives.ConvertValue<Widget>(
                new ConstrainedBox(
                    ...
                    child: new Column(
                        children: (
                            (Func<List<Widget>>)(
                                () =>
                                {
                                    var __collection31165 = new List<Widget>();
                                    __collection31165.Add(
                                        DartRuntimePrimitives.ConvertValue<Widget>(navBar)
                                    );
                                    __collection31165.Add(
                                            ...
                                            new Expanded(
                                                child: new Padding(
                                                    padding: EdgeInsetsDirectional.CreateOnly(
                                                        start: Nav_barLibrary._kNavBarEdgePadding,
                                                        bottom: Nav_barLibrary._kNavBarBottomPadding
                                                    ),
                                                    child: new Widgets.Semantics(
                                                        ...
                                                        child: new DefaultTextStyle(
                                                            ...
                                                            child: new _LargeTitle__nav_bar(
                                                                height: Nav_barLibrary._kNavBarLargeTitleHeightExtension,
                                                                child: componentsLocal.largeTitle
                                                            )
                                                        )
                                                    )
                                                )
                                    ...
                                    if (widget.bottom is not null)
                                    {
                                        __collection31165.Add(
                                            DartRuntimePrimitives.ConvertValue<Widget>(
                                                new SizedBox(
                                                    height: bottomHeight,
                                                    child: componentsLocal.navBarBottom
                                                )
                                            )
                                        );
                                    }
                                    return __collection31165;
                                }
                            )
                        )()
                    )
                    ...
                    child: new Column(
                        children: (
                            (Func<List<Widget>>)(
                                () =>
                                {
                                    var __collection32281 = new List<Widget>();
                                    __collection32281.Add(
                                        DartRuntimePrimitives.ConvertValue<Widget>(navBar)
                                    );
                                    if (widget.bottom is not null)
                                    {
        ...
        navBar = Nav_barLibrary._wrapWithBackground(
            border: effectiveBorder,
        ...
        return new Builder(
            ...
            {
                return new Hero(
                    tag: Equals(widget.heroTag, Nav_barLibrary._defaultHeroTag)
                        ? new _HeroTag__nav_bar(Navigator.of(context))
                        : widget.heroTag,
                    createRectTween: (Func<Rect?, Rect?, RectTween>)
                        Nav_barLibrary._linearTranslateWithLargestRectSizeTween,
                    placeholderBuilder: Nav_barLibrary._navBarHeroLaunchPadBuilder,
                    flightShuttleBuilder: Nav_barLibrary._navBarHeroFlightShuttleBuilder,
                    transitionOnUserGestures: true,
                    child: new _TransitionableNavigationBar__nav_bar(
                        componentsKeys: keys,
                        backgroundColor: effectiveBackgroundColor,
                        ...
                        largeTitleTextStyle: CupertinoTheme
                            .of(context)
                            .textTheme.navLargeTitleTextStyle,
                        border: effectiveBorder,
                        hasUserMiddle: widget.middle is not null,
                        largeExpanded: widget.largeTitle is not null,
                        searchable: false,
...
public class CupertinoSliverNavigationBar : StatefulWidget
{
    ...
    public static CupertinoSliverNavigationBar CreateSearch(
        Key? key = null,
        Widget searchField = default!,
        Widget? largeTitle = null,
        Widget? leading = null,
        bool automaticallyImplyLeading = true,
        bool automaticallyImplyTitle = true,
    ...
    {
        var __instance = new CupertinoSliverNavigationBar(
            key: key,
    ...
    public virtual bool opaque =>
        DartRuntimePrimitives.ConvertValue<bool>(backgroundColor?.alpha == 255L);

    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _CupertinoSliverNavigationBarState__nav_bar()
        );
}

internal class _CupertinoSliverNavigationBarState__nav_bar
    : State<CupertinoSliverNavigationBar>,
        TickerProviderStateMixin<CupertinoSliverNavigationBar>
{
    public virtual _NavigationBarStaticComponentsKeys__nav_bar keys { get; set; } = default!;
    ...
    public override void initState()
    {
        ...
        _animationController = new AnimationController(
            vsync: this,
            duration: Nav_barLibrary._kNavBarSearchDuration
        );
        _searchAnimation = new CurvedAnimation(
            parent: _animationController,
            curve: Nav_barLibrary._kNavBarSearchCurve
        );
    }
    ...
    internal virtual void _computeScaledHeights()
    {
        ...
        scaledSearchFieldHeight =
            Nav_barLibrary._kSearchFieldHeight
            * Nav_barLibrary._dampScaleFactor(
                textScaler.scale(Nav_barLibrary._kSearchFieldHeight),
                Nav_barLibrary._kSearchFieldHeight,
                Nav_barLibrary._kMaxScaleFactor
            );
        scaledLargeTitleHeight = isPortrait
            ? (
                Nav_barLibrary._kNavBarLargeTitleHeightExtension
                * Nav_barLibrary._dampScaleFactor(
                    textScaler.scale(Nav_barLibrary._kNavBarLargeTitleHeightExtension),
                    Nav_barLibrary._kNavBarLargeTitleHeightExtension,
                    Nav_barLibrary._kLargeTitleScaleDampingRatio
                )
            )
            : 0.0;
    }
    ...
    {
        var persistentHeightTween = new Tween<double>(
            begin: Nav_barLibrary._kNavBarPersistentHeight,
            end: 0.0
        );
        persistentHeightAnimation = (
    ...
    internal virtual void _handleScrollChange()
    {
        ...
        double bottomScrollOffset = Equals(widget.bottomMode, NavigationBarBottomMode.always)
            ? 0.0
            : _bottomHeight;
        bool canScrollBottom =
            (widget._searchable || (widget.bottom is not null)) && (bottomScrollOffset > 0.0);
        ...
        {
            if (
                (positionLocal.pixels > bottomScrollOffset)
                && (positionLocal.pixels < (bottomScrollOffset + scaledLargeTitleHeight))
            )
            {
                target =
                    (positionLocal.pixels > (bottomScrollOffset + (scaledLargeTitleHeight / 2L)))
    ...
    public override Widget build(BuildContext context)
    {
        var componentsLocal = new _NavigationBarStaticComponents__nav_bar(
            keys: keys,
            route: ModalRoute<object>.untypedOf(context),
            userLeading: (widget.leading is not null)
                ? new Visibility(visible: !searchIsActive, child: widget.leading!)
                : null,
            automaticallyImplyLeading: widget.automaticallyImplyLeading,
            automaticallyImplyTitle: widget.automaticallyImplyTitle,
            previousPageTitle: widget.previousPageTitle,
            userMiddle: _animationController.isAnimating ? new Text("") : effectiveMiddle,
            userTrailing: (widget.trailing is not null)
                ? new Visibility(visible: !searchIsActive, child: widget.trailing!)
                : null,
            userLargeTitle: widget.largeTitle,
            userBottom: (
                widget._searchable
                    ? (
                        searchIsActive
                            ...
                            : new _InactiveSearchableBottom__nav_bar(
                                animationController: _animationController,
                                animation: persistentHeightAnimation,
                                searchField: widget.searchField,
                                searchFieldHeight: scaledSearchFieldHeight,
            ...
            child: new AnimatedBuilder(
                ...
                builder: (context, child) =>
                {
                    return new SliverPersistentHeader(
                        pinned: true,
                        @delegate: new _LargeTitleNavigationBarSliverDelegate__nav_bar(
                            keys: keys,
                            components: componentsLocal,
...
{
    public virtual _NavigationBarStaticComponentsKeys__nav_bar keys { get; private set; } =
        default!;
    public virtual _NavigationBarStaticComponents__nav_bar components { get; private set; } =
        default!;
    ...
    public override OverScrollHeaderStretchConfiguration? stretchConfiguration =>
        __field_stretchConfiguration;

    internal _LargeTitleNavigationBarSliverDelegate__nav_bar(
        _NavigationBarStaticComponentsKeys__nav_bar keys,
        _NavigationBarStaticComponents__nav_bar components,
        Widget? userMiddle,
    ...
    public override double minExtent =>
        DartRuntimePrimitives.ConvertValue<double>(
            persistentHeight
                + (Equals(bottomMode, NavigationBarBottomMode.always) ? bottomHeight : 0.0)
        );
    public override double maxExtent =>
        DartRuntimePrimitives.ConvertValue<double>(
            persistentHeight + largeTitleHeight + bottomHeight
        );
    ...
    public override Widget build(BuildContext context, double shrinkOffset, bool overlapsContent)
    {
        ...
        var persistentNavigationBar = new _PersistentNavigationBar__nav_bar(
        ...
        Border? initialBorder =
            (automaticBackgroundVisibility && (parentPageScaffoldBackgroundColor is not null))
                ...
                : border;
        Border? effectiveBorder =
            (border is null) ? null : Border.lerp(initialBorder, border, shrinkAnimationValue);
        Color effectiveBackgroundColor =
            (automaticBackgroundVisibility && (parentPageScaffoldBackgroundColor is not null))
                ? (
                    Dart_uiLibrary.Color.lerp(
                ...
                : backgroundColor;
        Widget navBar = Nav_barLibrary._wrapWithBackground(
            border: effectiveBorder,
            backgroundColor: effectiveBackgroundColor,
            brightness: brightness,
            enableBackgroundFilterBlur: enableBackgroundFilterBlur,
                ...
                child: new Column(
                    children: (
                        (Func<List<Widget>>)(
                            () =>
                            {
                                var __collection60282 = new List<Widget>();
                                __collection60282.Add(
                                    DartRuntimePrimitives.ConvertValue<Widget>(
                                        new Expanded(
                                            child: new Stack(
                                                children: (
                                                    (Func<List<Widget>>)(
                                                        () =>
                                                        {
                                                            var __collection60368 =
                                                                new List<Widget>();
                                                            __collection60368.Add(
                                                                DartRuntimePrimitives.ConvertValue<Widget>(
                                                                    new Positioned(
                                ...
                                if (Equals(bottomMode, NavigationBarBottomMode.always))
                                {
                                    __collection60282.Add(
                                        DartRuntimePrimitives.ConvertValue<Widget>(
                                            new SizedBox(
        ...
        return new Hero(
            tag: Equals(heroTag, Nav_barLibrary._defaultHeroTag)
                ? new _HeroTag__nav_bar(Navigator.of(context))
                : heroTag,
            createRectTween: (Func<Rect?, Rect?, RectTween>)
                Nav_barLibrary._linearTranslateWithLargestRectSizeTween,
            ...
            child: new _TransitionableNavigationBar__nav_bar(
                ...
                border: effectiveBorder,
                hasUserMiddle: (userMiddle is not null) && (alwaysShowMiddle || !showLargeTitle),
    ...
    public override bool shouldRebuild(SliverPersistentHeaderDelegate oldDelegate)
    {
        ...
        return (!Equals(components, __oldDelegate.components))
            || (!Equals(userMiddle, __oldDelegate.userMiddle))
            || (!Equals(backgroundColor, __oldDelegate.backgroundColor))
            || (automaticBackgroundVisibility != __oldDelegate.automaticBackgroundVisibility)
            || (!Equals(border, __oldDelegate.border))
            || (!Equals(padding, __oldDelegate.padding))
            || (!Equals(actionsForegroundColor, __oldDelegate.actionsForegroundColor))
            || (transitionBetweenRoutes != __oldDelegate.transitionBetweenRoutes)
            || (persistentHeight != __oldDelegate.persistentHeight)
            || (largeTitleHeight != __oldDelegate.largeTitleHeight)
            || (alwaysShowMiddle != __oldDelegate.alwaysShowMiddle)
            || (!Equals(heroTag, __oldDelegate.heroTag))
            || (enableBackgroundFilterBlur != __oldDelegate.enableBackgroundFilterBlur)
            || (!Equals(bottomMode, __oldDelegate.bottomMode))
...
internal class _LargeTitle__nav_bar : SingleChildRenderObjectWidget
{
    ...
    internal _LargeTitle__nav_bar(Widget? child = null, double height = default!)
        : base(child: child)
    {
        this.height = height;
    }
    ...
    {
        return new _RenderLargeTitle__nav_bar(
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<_RenderLargeTitle__nav_bar>)(
                    () =>
                    {
                        var __cascade = __renderObject;
                        __cascade.alignment = AlignmentDirectional.bottomStart.resolve(
...
public class _RenderLargeTitle__nav_bar : RenderShiftedBox
{
    ...
    internal _RenderLargeTitle__nav_bar(Alignment alignment, double height)
        : base(null)
    {
    ...
    internal static double _computeTitleScale(
        Size childSize,
...
internal class _PersistentNavigationBar__nav_bar : StatelessWidget
{
    ...
    internal _PersistentNavigationBar__nav_bar(
        _NavigationBarStaticComponents__nav_bar components,
        EdgeInsetsDirectional? padding = null,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        {
            middleLocal = DartRuntimePrimitives.ConvertValue<Widget>(
                new DefaultTextStyle(
                    style: CupertinoTheme.of(context).textTheme.navTitleTextStyle,
                    child: new Widgets.Semantics(header: true, child: middleLocal)
                )
            );
            middleLocal =
        ...
        if (
            (leadingLocal is null)
            && (backChevronLocal is not null)
            && (backLabelLocal is not null)
            && !CupertinoSheetRoute<object>.hasParentSheet(context)
        )
        {
            leadingLocal = DartRuntimePrimitives.ConvertValue<Widget>(
                CupertinoNavigationBarBackButton.Create_assemble(backChevronLocal, backLabelLocal)
            );
        }
        else
        {
            leadingLocal = DartRuntimePrimitives.ConvertValue<Widget>(
                new Align(widthFactor: 1.0, child: leadingLocal)
            );
        }
        ...
        {
            paddedToolbar = DartRuntimePrimitives.ConvertValue<Widget>(
                new Padding(
                    padding: EdgeInsets.CreateOnly(top: padding!.top, bottom: padding!.bottom),
                    child: paddedToolbar
                )
            );
        }
        return new SizedBox(
            height: Nav_barLibrary._kNavBarPersistentHeight + MediaQuery.paddingOf(context).top,
            child: new SafeArea(
                top: !CupertinoSheetRoute<object>.hasParentSheet(context),
                bottom: false,
                child: paddedToolbar
            )
        );
...
public class _NavigationBarStaticComponents__nav_bar
{
    ...
    internal static Widget? _derivedTitle(
        bool automaticallyImplyTitle,
        IModalRoute? currentRoute = null
    )
    {
        if (
            automaticallyImplyTitle
            && (currentRoute is ICupertinoRouteTitle)
            && (((ICupertinoRouteTitle)currentRoute).title is not null)
        )
        {
    ...
    )
    {
        ...
        else
        {
            ...
            )
            {
                ...
                leadingContent = DartRuntimePrimitives.ConvertValue<Widget>(
                    new CupertinoButton(
                        padding: EdgeInsets.zero,
                        onPressed: () =>
                        {
                            DartRuntimePrimitives.Ignore(
                                route__as77104.navigator!.maybePop<object>()
                            );
                        },
        ...
        return new KeyedSubtree(
            ...
            child: new Padding(
                padding: EdgeInsetsDirectional.CreateOnly(
                    start: padding?.start ?? Nav_barLibrary._kNavBarEdgePadding
                ),
    ...
    public static KeyedSubtree? createBackChevron(
        GlobalKey<IState> backChevronKey,
        Widget? userLeading,
        IModalRoute? route,
        bool automaticallyImplyLeading,
        BuildContext context
    ...
    {
        if (
            (userLeading is not null)
            || !automaticallyImplyLeading
            || (route is null)
            || !route.canPop
            || ((route is IPageRoute) && route.fullscreenDialog)
        )
        {
            return null;
        }
    ...
    )
    {
        ...
        return new KeyedSubtree(
            ...
            child: new Padding(
                padding: EdgeInsetsDirectional.CreateOnly(
                    end: padding?.end ?? Nav_barLibrary._kNavBarEdgePadding
                ),
                child: new MediaQuery(
                    data: MediaQuery.of(context).copyWith(textScaler: _clampedTextScaler(context)),
                    child: IconTheme.merge(data: new IconThemeData(size: 32.0), child: userTrailing)
                )
            )
        );
        throw new InvalidOperationException("Control flow completed without returning a value.");
    ...
    public static KeyedSubtree? createLargeTitle(
        GlobalKey<IState> largeTitleKey,
        Widget? userLargeTitle,
        bool large,
    ...
    )
    {
        ...
        Widget? largeTitleContent =
            userLargeTitle
            ?? _derivedTitle(automaticallyImplyTitle: automaticImplyTitle, currentRoute: route);
        DartRuntimePrimitives.Assert(
            () => largeTitleContent is not null,
            () => (object?)"largeTitle was not provided and there was no title from the route."
        );
        return new KeyedSubtree(
            key: largeTitleKey,
            child: new MediaQuery(
                        ...
                        textScaler: TextScaler.CreateLinear(
                            Nav_barLibrary._dampScaleFactor(
                                MediaQuery
                                    ...
                                    .scale(Nav_barLibrary._kNavBarLargeTitleHeightExtension),
                                Nav_barLibrary._kNavBarLargeTitleHeightExtension,
                                Nav_barLibrary._kLargeTitleScaleDampingRatio
                            )
                        )
    ...
    public static KeyedSubtree? createNavBarBottom(
        GlobalKey<IState> navBarBottomKey,
        Widget? userBottom,
        BuildContext context
    )
    {
...
public class CupertinoNavigationBarBackButton : StatelessWidget
{
    ...
    public static CupertinoNavigationBarBackButton Create_assemble(
        Widget? _backChevron,
        Widget? _backLabel
    )
    {
                ...
                child: new DefaultTextStyle(
                    ...
                    child: new ConstrainedBox(
                        constraints: new BoxConstraints(
                            minWidth: Nav_barLibrary._kNavBarBackButtonTapWidth
                        ),
                        child: new Row(
                            ...
                            children: new List<Widget>
                            {
                                ...
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    _backChevron ?? new _BackChevron__nav_bar()
                                ),
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Padding(
                                        padding: EdgeInsetsDirectional.CreateOnly(start: 6.0)
                                    )
                                ),
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new Flexible(
                                        child: _backLabel
                                            ?? new _BackLabel__nav_bar(
                                                specifiedPreviousTitle: previousPageTitle,
                                                route: currentRoute
                                            )
                                    )
...
internal class _BackChevron__nav_bar : StatelessWidget
{
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Widget iconWidget = new Padding(
            padding: EdgeInsetsDirectional.CreateOnly(start: 6, end: 2),
            child: Text.CreateRich(
                new TextSpan(
                    text: char.ConvertFromUtf32(checked((int)CupertinoIcons.back.codePoint)),
                    style: new TextStyle(
                        inherit: false,
...
internal class _BackLabel__nav_bar : StatelessWidget
{
    ...
    internal virtual Widget _buildPreviousTitleWidget(
        BuildContext context,
...
internal class _InactiveSearchableBottom__nav_bar : StatelessWidget
{
    ...
    internal _InactiveSearchableBottom__nav_bar(
                ...
                child: new AbsorbPointer(
                    child: new FocusableActionDetector(
                        ...
                        child: new Padding(
                            padding: EdgeInsetsDirectional.CreateOnly(
                                start: Nav_barLibrary._kNavBarEdgePadding,
                                end: Nav_barLibrary._kNavBarEdgePadding,
                                bottom: Nav_barLibrary._kNavBarBottomPadding
                            ),
                                ...
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new SizedBox(
                                        width: constraints.maxWidth
                                            - (
                                                Nav_barLibrary._kSearchFieldCancelButtonWidth
                                ...
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    new SizedBox(
                                        ...
                                        child: new Padding(
                                            ...
                                            child: new _CancelButton__nav_bar(
                                                opacity: 0.4,
                                                onPressed: () => { }
                                            )
                                        )
                    ...
                    DartRuntimePrimitives.ConvertValue<Widget>(
                        new Expanded(
                            child: new SizedBox(
                                ...
                                child: searchField ?? SizedBox.CreateShrink()
                            )
                        )
                    ),
                    DartRuntimePrimitives.ConvertValue<Widget>(
                        new AnimatedBuilder(
                            ...
                            child: new FadeTransition(
                                ...
                                child: new _CancelButton__nav_bar(onPressed: onSearchFieldTap)
                            ),
                            builder: (context, child) =>
                            {
                                return new SizedBox(
...
{
    public virtual _NavigationBarStaticComponentsKeys__nav_bar componentsKeys
    {
        get;
        private set;
    } = default!;
    ...
    internal _TransitionableNavigationBar__nav_bar(
        _NavigationBarStaticComponentsKeys__nav_bar componentsKeys,
        Color? backgroundColor,
    ...
    public virtual RenderBox renderBox
    {
        ...
        {
            var box = (
                (RenderBox?)componentsKeys.navBarBoxKey.currentContext!.findRenderObject()!
            )!;
            DartRuntimePrimitives.Assert(
                () => box.attached,
                () =>
    ...
    public override Widget build(BuildContext context)
    {
        DartRuntimePrimitives.Assert(() =>
        {
                ...
                (ancestor) =>
                {
                    if (ancestor is ComponentElement)
                    {
                        DartRuntimePrimitives.Assert(
                            () =>
                                !Equals(
                                    DartRuntimePrimitives.RuntimeType(
                                        ((ComponentElement)ancestor).widget
                                    ),
                                    typeof(_NavigationBarTransition__nav_bar)
                                ),
                            () =>
                                (object?)
            ...
            DartRuntimePrimitives.Assert(
                () => inHero,
                () =>
                    (object?)"_TransitionableNavigationBar should only be added as the immediate "
...
internal class _NavigationBarTransition__nav_bar : StatelessWidget
{
    ...
    public virtual _TransitionableNavigationBar__nav_bar bottomNavBar { get; private set; } =
        default!;
    public virtual Tween<double> heightTween { get; private set; } = default!;

    internal _NavigationBarTransition__nav_bar(
        Animation<double> animation,
        _TransitionableNavigationBar__nav_bar topNavBar,
        _TransitionableNavigationBar__nav_bar bottomNavBar
    )
    {
        this.animation = animation;
    ...
    public override Widget build(BuildContext context)
    {
        var componentsTransition = new _NavigationBarComponentsTransition__nav_bar(
            animation: animation,
        ...
        var childrenLocal = (
            (Func<List<Widget>>)(
                () =>
                {
                    var __collection98801 = new List<Widget>();
                    var __collectionElement98817 = componentsTransition.bottomNavBarBackground;
                    if (__collectionElement98817 is { } __nonNullCollectionElement98817)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement98817
                            )
                        );
                    }
                    var __collectionElement98869 = componentsTransition.bottomBackChevron;
                    if (__collectionElement98869 is { } __nonNullCollectionElement98869)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement98869
                            )
                        );
                    }
                    var __collectionElement98916 = componentsTransition.bottomBackLabel;
                    if (__collectionElement98916 is { } __nonNullCollectionElement98916)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement98916
                            )
                        );
                    }
                    var __collectionElement98961 = componentsTransition.bottomLeading;
                    if (__collectionElement98961 is { } __nonNullCollectionElement98961)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement98961
                            )
                        );
                    }
                    var __collectionElement99004 = componentsTransition.bottomMiddle;
                    if (__collectionElement99004 is { } __nonNullCollectionElement99004)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99004
                            )
                        );
                    }
                    var __collectionElement99046 = componentsTransition.bottomLargeTitle;
                    if (__collectionElement99046 is { } __nonNullCollectionElement99046)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99046
                            )
                        );
                    }
                    var __collectionElement99092 = componentsTransition.bottomTrailing;
                    if (__collectionElement99092 is { } __nonNullCollectionElement99092)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99092
                            )
                        );
                    }
                    var __collectionElement99136 = componentsTransition.bottomNavBarBottom;
                    if (__collectionElement99136 is { } __nonNullCollectionElement99136)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99136
                            )
                        );
                    }
                    var __collectionElement99246 = componentsTransition.topNavBarBackground;
                    if (__collectionElement99246 is { } __nonNullCollectionElement99246)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99246
                            )
                        );
                    }
                    var __collectionElement99295 = componentsTransition.topLeading;
                    if (__collectionElement99295 is { } __nonNullCollectionElement99295)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99295
                            )
                        );
                    }
                    var __collectionElement99335 = componentsTransition.topBackChevron;
                    if (__collectionElement99335 is { } __nonNullCollectionElement99335)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99335
                            )
                        );
                    }
                    var __collectionElement99379 = componentsTransition.topBackLabel;
                    if (__collectionElement99379 is { } __nonNullCollectionElement99379)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99379
                            )
                        );
                    }
                    var __collectionElement99421 = componentsTransition.topMiddle;
                    if (__collectionElement99421 is { } __nonNullCollectionElement99421)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99421
                            )
                        );
                    }
                    var __collectionElement99460 = componentsTransition.topLargeTitle;
                    if (__collectionElement99460 is { } __nonNullCollectionElement99460)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99460
                            )
                        );
                    }
                    var __collectionElement99503 = componentsTransition.topTrailing;
                    if (__collectionElement99503 is { } __nonNullCollectionElement99503)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99503
                            )
                        );
                    }
                    var __collectionElement99544 = componentsTransition.topNavBarBottom;
                    if (__collectionElement99544 is { } __nonNullCollectionElement99544)
                    {
                        __collection98801.Add(
                            DartRuntimePrimitives.ConvertValue<Widget>(
                                __nonNullCollectionElement99544
                            )
                        );
                    }
                    return __collection98801;
                }
            )
        )();
        return MediaQuery.withNoTextScaling(
...
internal class _NavigationBarComponentsTransition__nav_bar
{
    ...
    public virtual Animation<double> animation { get; private set; } = default!;
    public virtual _NavigationBarStaticComponentsKeys__nav_bar bottomComponents
    {
        get;
        private set;
    } = default!;
    public virtual _NavigationBarStaticComponentsKeys__nav_bar topComponents { get; private set; } =
        default!;
    ...
    internal _NavigationBarComponentsTransition__nav_bar(
        Animation<double> animation,
        _TransitionableNavigationBar__nav_bar bottomNavBar,
        _TransitionableNavigationBar__nav_bar topNavBar,
    ...
    )
    {
        ...
        transitionBox = bottomNavBar.renderBox.paintBounds.expandToInclude(
    ...
    public virtual RelativeRect positionInTransitionBox(GlobalKey<IState> key, RenderBox from)
    {
        ...
        return RelativeRect.CreateFromRect(
    ...
    public virtual _FixedSizeSlidingTransition__nav_bar slideFromLeadingEdge(
        GlobalKey<IState> fromKey,
        RenderBox fromNavBarBox,
        GlobalKey<IState> toKey,
    ...
    )
    {
        ...
        var fromAnchorLocal = new Offset(
            isLTRLocal ? 0 : fromBox.size.width,
            fromBox.size.height / 2L
        );
        var toAnchorLocal = new Offset(isLTRLocal ? 0 : toBox.size.width, toBox.size.height / 2L);
        Offset fromAnchorInFromBox = fromBox.localToGlobal(
            fromAnchorLocal,
            ancestor: fromNavBarBox
        );
        Offset toAnchorInToBox = toBox.localToGlobal(toAnchorLocal, ancestor: toNavBarBox);
        Offset translation = isLTRLocal
            ? (toAnchorInToBox - fromAnchorInFromBox)
            : (
                new Offset(toNavBarBox.size.width - toAnchorInToBox.dx, toAnchorInToBox.dy)
                - new Offset(
        ...
        var fromOriginInTransitionBox = new Offset(
            isLTRLocal ? fromBoxMargin.left : fromBoxMargin.right,
            fromBoxMargin.top
        );
        var anchorMovementInTransitionBox = new Tween<Offset>(
        ...
        return new _FixedSizeSlidingTransition__nav_bar(
            ...
            offsetAnimation: animation
                .drive(new CurveTween(curve: curve))
    ...
    public virtual Widget? bottomNavBarBackground
    {
        ...
        {
            if (
                (bottomBackgroundColor is null)
                || (bottomLargeExpanded && bottomAutomaticBackgroundVisibility)
            )
            {
                return null;
            }
            Curve animationCurve = Equals(animation.status, AnimationStatus.forward)
                ? Curves.fastEaseInToSlowEaseOut
                : Curves.fastEaseInToSlowEaseOut.flipped;
            Animation<double> pageTransitionAnimation = routeAnimation.drive(
                new CurveTween(curve: userGestureInProgress ? Curves.linear : animationCurve)
            );
            RelativeRect fromLocal = positionInTransitionBox(
                bottomComponents.navBarBoxKey,
                from: bottomNavBarBox
            );
            var positionTween = new RelativeRectTween(
                end: fromLocal.shift(
                    new Offset(forwardDirection * -bottomNavBarBox.size.width, 0.0)
                ),
                begin: fromLocal
            );
            return (Widget?)
                new PositionedTransition(
                    ...
                    child: Nav_barLibrary._wrapWithBackground(
    ...
    public virtual Widget? bottomLeading
    {
        get
        {
            ...
            return (Widget?)
                Positioned.CreateFromRelativeRect(
        ...
        get
        {
            ...
            var positionTween = new RelativeRectTween(
                begin: fromLocal,
                    ...
                    new Offset(forwardDirection * (-bottomNavBarBox.size.width / 2.0), 0.0)
                )
            );
            return (Widget?)
                new PositionedTransition(
    ...
    public virtual Widget? bottomMiddle
    {
        get
        {
            ...
            {
                return (Widget?)slideFromLeadingEdge(
        ...
        get
        {
            ...
            if (topBackLabel is not null)
            {
                return (Widget?)slideFromLeadingEdge(
                    ...
                    curve: new Interval(
                        0.0,
                        Equals(animation.status, AnimationStatus.forward) ? 0.7 : 1.0
                    ),
                    child: new FadeTransition(
                        opacity: fadeOutBy(0.6),
                        child: new Align(
            ...
            var positionTween = new RelativeRectTween(
                begin: fromLocal,
                    ...
                    new Offset(forwardDirection * bottomNavBarBox.size.width / 4.0, 0.0)
                )
            );
            return (Widget?)
                new PositionedTransition(
    ...
    public virtual Widget? bottomNavBarBottom
    {
        get
        {
            var bottomNavBarBottom = (
                (KeyedSubtree?)bottomComponents.navBarBottomKey.currentWidget
            )!;
            ...
            Curve animationCurve = Equals(animation.status, AnimationStatus.forward)
                ? Nav_barLibrary._kBottomNavBarHeaderTransitionCurve
                : Nav_barLibrary._kBottomNavBarHeaderTransitionCurve.flipped;
            if (!searchable)
            {
            ...
            return (Widget?)
                new PositionedTransition(
                    rect: userGestureInProgress
                        ? routeAnimation
                            .drive(new CurveTween(curve: Curves.linear))
                            .drive(positionTween)
                        : animation
                            .drive(new CurveTween(curve: animationCurve))
                            .drive(positionTween),
                    child: new ClipRect(child: childLocal)
                );
        }
    }
    public virtual Widget? topNavBarBackground
    {
        get
        {
            ...
            RelativeRect to = positionInTransitionBox(
                topComponents.navBarBoxKey,
                from: topNavBarBox
            );
            var positionTween = new RelativeRectTween(
                begin: to.shift(new Offset(forwardDirection * topNavBarBox.size.width, 0.0)),
                end: to
            );
            return (Widget?)
                new PositionedTransition(
                    ...
                    child: Nav_barLibrary._wrapWithBackground(
                        ...
                        border: topBorder,
                        child: new SizedBox(
                            height: topNavBarBox.size.height,
                            width: double.PositiveInfinity
                        )
                    )
                );
    ...
    public virtual Widget? topBackChevron
    {
        get
        {
            ...
            if (bottomBackChevron is null)
            {
                ...
                fromLocal = to.shift(
                    new Offset(forwardDirection * topBackChevronBox.size.width * 2.0, 0.0)
                );
                childLocal = DartRuntimePrimitives.ConvertValue<Widget>(
                    new ScaleTransition(
                        scale: routeAnimation.drive(new CurveTween(curve: effectiveScaleCurve)),
                        child: childLocal
                    )
                );
            }
            ...
            return (Widget?)
                new PositionedTransition(
                    rect: routeAnimation
                        .drive(new CurveTween(curve: effectivePositionCurve))
                        .drive(positionTween),
                    child: new FadeTransition(
                        opacity: routeAnimation.drive(
                            new CurveTween(
                                curve: new Interval(
                                    (
                                        (bottomBackChevron is null)
                                        && (!Equals(animation.status, AnimationStatus.forward))
                                    )
                                        ? 0.9
                                        : 0.4,
                                    1.0
        ...
        get
        {
            ...
            if ((topBackLabelOpacity is not null) && (topBackLabelOpacity.opacity.value < 1.0))
            {
                midClickOpacity = animation.drive(
                    new Tween<double>(begin: 0.0, end: topBackLabelOpacity.opacity.value)
                );
            }
    ...
    public virtual Widget? topMiddle
    {
        get
        {
            ...
            var anchorMovementInTransitionBox = new Tween<Offset>(
                begin: new Offset(topNavBarBox.size.width - (toBox.size.width / 2L), to.top),
                end: toAnchorInTransitionBox
            );
            return (Widget?)
                new _FixedSizeSlidingTransition__nav_bar(
                    isLTR: isLTRLocal,
    ...
    public virtual Widget? topLargeTitle
    {
        get
        {
            ...
            Curve animationCurve = Equals(animation.status, AnimationStatus.forward)
                ? Nav_barLibrary._kTopNavBarHeaderTransitionCurve
                : Nav_barLibrary._kTopNavBarHeaderTransitionCurve.flipped;
            return (Widget?)
                new PositionedTransition(
                    rect: userGestureInProgress
                        ? routeAnimation
...
public static partial class Nav_barLibrary
{
    internal static Widget _navBarHeroLaunchPadBuilder(
        BuildContext context,
        Size heroSize,
        Widget child
    )
...
public static partial class Nav_barLibrary
{
    internal static Widget _navBarHeroFlightShuttleBuilder(
    ...
    )
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            fromHeroWidget.child is _TransitionableNavigationBar__nav_bar
        );
        DartRuntimePrimitives.Assert(() =>
            toHeroWidget.child is _TransitionableNavigationBar__nav_bar
        );
        ...
        DartRuntimePrimitives.Assert(
            () => fromNavBar.componentsKeys.navBarBoxKey.currentContext!.owner is not null,
            () => (object?)"The from nav bar to Hero must have been mounted in the previous frame"
        );
        DartRuntimePrimitives.Assert(
            () => toNavBar.componentsKeys.navBarBoxKey.currentContext!.owner is not null,
            () => (object?)"The to nav bar to Hero must have been mounted in the previous frame"
        );
        switch (flightDirection)
        {
            case HeroFlightDirection.push:
            {
                return new _NavigationBarTransition__nav_bar(
                    animation: animation,
