...
public static partial class PickerLibrary
{
    internal static Duration _kCupertinoPickerTapToScrollDuration = Duration.Create(
        milliseconds: 300L
    );
}
...
public class CupertinoPicker : StatefulWidget
{
    ...
    public CupertinoPicker(
        ...
        Action<long>? onSelectedItemChanged = default!,
        List<Widget> children = default!,
        Widget? selectionOverlay = default!,
        bool looping = false
    )
        : base(key: key)
    {
        ...
        childDelegate = looping
            ? new global::Doroti.Framework.Widgets.ListWheelChildLoopingListDelegate(
                children: children
            )
            : new global::Doroti.Framework.Widgets.ListWheelChildListDelegate(children: children);
    ...
    public static CupertinoPicker CreateBuilder(
        Key? key = null,
        double? diameterRatio = null,
        Color? backgroundColor = null,
        double offAxisFraction = 0.0,
    ...
    {
        var __instance = new CupertinoPicker(
            key: key,
        ...
        __instance.childDelegate = new ListWheelChildBuilderDelegate(
            builder: itemBuilder,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _CupertinoPickerState__picker());
}
...
internal class _CupertinoPickerState__picker : State<CupertinoPicker>
{
    ...
    internal virtual FixedExtentScrollController _effectiveController =>
        DartRuntimePrimitives.ConvertValue<FixedExtentScrollController>(
    ...
    internal virtual async Future _handleChildTap(long index)
    {
        _enableHapticFeedback = false;
        await _effectiveController.animateToItem(
            index,
            duration: PickerLibrary._kCupertinoPickerTapToScrollDuration,
            curve: PickerLibrary._kCupertinoPickerTapToScrollCurve
        );
        ...
        return new IgnorePointer(
            child: new Center(
                child: new ConstrainedBox(
                    constraints: BoxConstraints.CreateExpand(height: heightLocal),
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Color? resolvedBackgroundColor = CupertinoDynamicColor.maybeResolve(
            widget.backgroundColor,
            context
        );
        DartRuntimePrimitives.Assert(() =>
            RenderListWheelViewport.defaultPerspective == PickerLibrary._kDefaultPerspective
        );
            ...
            child: new Stack(
                children: (
                    (Func<List<Widget>>)(
                        () =>
                        {
                            var __collection13325 = new List<Widget>();
                            __collection13325.Add(
                                DartRuntimePrimitives.ConvertValue<Widget>(
                                    Positioned.CreateFill(
                                        child: new _CupertinoPickerSemantics__picker(
                                            scrollController: _effectiveController,
                                            child: ListWheelScrollView.CreateUseDelegate(
                                                ...
                                                overAndUnderCenterOpacity: PickerLibrary._kOverAndUnderCenterOpacity,
                                                ...
                                                childDelegate: new _CupertinoPickerListWheelChildDelegateWrapper__picker(
                                                    widget.childDelegate,
                                                    onTappedChild: (__arg0) =>
                                                    {
                                                        _ = _handleChildTap(__arg0);
                                                    }
                                                )
                                            )
                                        )
                            ...
                            if (widget.selectionOverlay is not null)
                            {
                                __collection13325.Add(
                                    DartRuntimePrimitives.ConvertValue<Widget>(
        ...
        return new Container(
            ...
            decoration: new ShapeDecoration(
                shape: new RoundedSuperellipseBorder(
                    borderRadius: BorderRadiusDirectional.CreateHorizontal(
...
internal class _CupertinoPickerSemantics__picker : SingleChildRenderObjectWidget
{
    ...
    internal _CupertinoPickerSemantics__picker(
        Widget? child = null,
        FixedExtentScrollController scrollController = default!
    )
        : base(child: child)
    {
        this.scrollController = scrollController;
    ...
    public override RenderObject createRenderObject(BuildContext context)
    {
        ...
        return new _RenderCupertinoPickerSemantics__picker(
            scrollController,
    ...
    public override void updateRenderObject(BuildContext context, RenderObject renderObject)
    {
        ...
        DartRuntimePrimitives.Ignore(
            (
                (Func<_RenderCupertinoPickerSemantics__picker>)(
                    () =>
                    {
...
public class _RenderCupertinoPickerSemantics__picker : RenderProxyBox
{
    ...
    internal _RenderCupertinoPickerSemantics__picker(
    ...
    public override void assembleSemanticsNode(
        Semantics.SemanticsNode node,
        Semantics.SemanticsConfiguration config,
        IEnumerable<Semantics.SemanticsNode> children
    )
    {
        ...
        Semantics.SemanticsNode? previousChild = indexedChildren.GetValueOrDefault(
            _currentIndex - 1L
        );
...
internal class _CupertinoPickerListWheelChildDelegateWrapper__picker : ListWheelChildDelegate
{
    ...
    internal _CupertinoPickerListWheelChildDelegateWrapper__picker(
        ListWheelChildDelegate _wrapped,
        Action<long> onTappedChild
    )
    {
    ...
    public override bool shouldRebuild(ListWheelChildDelegate oldDelegate) =>
        _wrapped.shouldRebuild(
            ((_CupertinoPickerListWheelChildDelegateWrapper__picker)oldDelegate)._wrapped
        );
