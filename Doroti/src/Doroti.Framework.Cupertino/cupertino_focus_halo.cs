...
public class CupertinoFocusHalo : StatefulWidget
{
    ...
    internal virtual Func<BorderRadiusGeometry, BorderSide, ShapeBorder> _shapeBuilder
    {
        get;
        private set;
    } = default!;
    ...
    public CupertinoFocusHalo(Widget child, Key? key = null)
        : base(key: key)
    {
        this.child = child;
        _borderRadius = BorderRadius.zero;
        _shapeBuilder =
            (Func<BorderRadiusGeometry, BorderSide, RoundedRectangleBorder>)(
                (borderRadius, side) =>
                    new RoundedRectangleBorder(side: side, borderRadius: borderRadius)
            );
    }

    public static CupertinoFocusHalo CreateWithRRect(
        Widget child,
    ...
    public static CupertinoFocusHalo CreateWithRoundedSuperellipse(
        Widget child,
        BorderRadiusGeometry borderRadius,
        Key? key = null
    )
    {
        ...
        __instance._borderRadius = borderRadius;
        __instance._shapeBuilder =
            (Func<BorderRadiusGeometry?, BorderSide, RoundedSuperellipseBorder>)(
                (borderRadius, side) =>
                    new RoundedSuperellipseBorder(side: side, borderRadius: borderRadius)
            );
        return __instance;
    }
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _CupertinoFocusHaloState__cupertino_focus_halo()
        );
}
...
internal class _CupertinoFocusHaloState__cupertino_focus_halo : State<CupertinoFocusHalo>
{
    ...
    internal virtual Ui.Color _effectiveFocusOutlineColor =>
        DartRuntimePrimitives.ConvertValue<Ui.Color>(
            HSLColor
                .CreateFromColor(
            ...
            child: new DecoratedBox(
                ...
                decoration: new ShapeDecoration(
                    shape: widget._shapeBuilder(
                        ...
                        _childHasFocus
                            ? new BorderSide(color: _effectiveFocusOutlineColor, width: 3.5)
                            : BorderSide.none
                    )
                ),
                child: widget.child
