...
public static partial class Text_selection_toolbarLibrary
{
    internal static CupertinoDynamicColor _kToolbarBackgroundColor = new CupertinoDynamicColor(
        color: new Color(4294375158L),
        darkColor: new Color(4280427042L)
    );
}

public static partial class Text_selection_toolbarLibrary
{
    internal static CupertinoDynamicColor _kToolbarDividerColor = new CupertinoDynamicColor(
        color: new Color(4292269782L),
        darkColor: new Color(4282532418L)
    );
}
...
public class CupertinoTextSelectionToolbar : StatelessWidget
{
    ...
    public virtual Func<BuildContext, Offset, Offset, Widget, Widget> toolbarBuilder
    {
        get;
        private set;
    } = default!;
    ...
    public CupertinoTextSelectionToolbar(
        Key? key = null,
        Offset anchorAbove = default!,
        Offset anchorBelow = default!,
        List<Widget> children = default!,
        Func<BuildContext, Offset, Offset, Widget, Widget> toolbarBuilder = default!
    )
        : base(key: key)
    {
        Func<BuildContext, Offset, Offset, Widget, Widget> __toolbarBuilder =
    ...
    internal static Widget _defaultToolbarBuilder(
        BuildContext context,
        Offset anchorAbove,
        Offset anchorBelow,
        Widget child
    )
    {
        return new _CupertinoTextSelectionToolbarShape__text_selection_toolbar(
            ...
            shadowColor: Equals(CupertinoTheme.brightnessOf(context), Brightness.light)
                ? CupertinoColors.black.withOpacity(0.2)
                : null,
            child: new ColoredBox(
                color: Text_selection_toolbarLibrary._kToolbarBackgroundColor.resolveFrom(context),
                child: child
            )
        );
    ...
    public override Widget build(BuildContext context)
    {
        ...
        double leftMargin =
            Text_selection_toolbarLibrary._kArrowScreenPadding + mediaQueryPadding.left;
        double rightMargin =
        ...
        return new Padding(
            ...
            child: new CustomSingleChildLayout(
                @delegate: new TextSelectionToolbarLayoutDelegate(
                    anchorAbove: anchorAboveAdjusted,
                    anchorBelow: anchorBelowAdjusted
                ),
                child: new _CupertinoTextSelectionToolbarContent__text_selection_toolbar(
                    anchorAbove: anchorAboveAdjusted,
                    anchorBelow: anchorBelowAdjusted,
...
internal class _CupertinoTextSelectionToolbarShape__text_selection_toolbar
    : SingleChildRenderObjectWidget
{
    ...
    internal _CupertinoTextSelectionToolbarShape__text_selection_toolbar(
        Offset anchorAbove,
        Offset anchorBelow,
    ...
    public override RenderObject createRenderObject(BuildContext context) =>
        DartRuntimePrimitives.ConvertValue<RenderObject>(
            new _RenderCupertinoTextSelectionToolbarShape__text_selection_toolbar(
                _anchorAbove,
                _anchorBelow,
                _shadowColor,
                null
    ...
    {
        var __renderObject =
            (_RenderCupertinoTextSelectionToolbarShape__text_selection_toolbar)renderObject;
        DartRuntimePrimitives.Ignore(
            (
                (Func<_RenderCupertinoTextSelectionToolbarShape__text_selection_toolbar>)(
                    () =>
                    {
...
public class _RenderCupertinoTextSelectionToolbarShape__text_selection_toolbar : RenderShiftedBox
{
    ...
    internal virtual LayerHandle<ClipPathLayer> _clipPathLayer { get; private set; } =
        new LayerHandle<ClipPathLayer>();
    internal virtual Paint? _debugPaint { get; set; } = default;

    internal _RenderCupertinoTextSelectionToolbarShape__text_selection_toolbar(
        Offset _anchorAbove,
        Offset _anchorBelow,
        Color? _shadowColor,
        RenderBox? child
    ...
    internal virtual bool _isAbove(double childHeight) =>
        DartRuntimePrimitives.ConvertValue<bool>(
            anchorAbove.dy
                >= (childHeight - Text_selection_toolbarLibrary._kToolbarArrowSize.height)
        );
    ...
    public override void performLayout()
    {
        ...
        size = new Size(
            childLocal.size.width,
            childLocal.size.height - Text_selection_toolbarLibrary._kToolbarArrowSize.height
        );
    }
    ...
    {
        Rect rect =
            new Offset(0.0, Text_selection_toolbarLibrary._kToolbarArrowSize.height)
            & new Size(
                child.size.width,
                child.size.height - (Text_selection_toolbarLibrary._kToolbarArrowSize.height * 2L)
            );
        return RRect
    ...
    internal static Path _addRRectToPath(Path path, RRect rrect, double startAngle)
    {
        ...
        for (
            var i = startQuadrantIndex;
            i < (checked(rrectCorners.Count) + startQuadrantIndex);
            i += 1L
        )
        {
            ...
            var otherVertex = new Offset(
                vertex.dx + (2L * rectCenterOffset.x),
                vertex.dy + (2L * rectCenterOffset.y)
            );
    ...
    internal virtual Path _clipPath(RenderBox child, RRect rrect)
    {
        ...
        if (
            (
                (Text_selection_toolbarLibrary._kToolbarBorderRadius.x * 2L)
                + Text_selection_toolbarLibrary._kToolbarArrowSize.width
            ) > size.width
        )
        {
            return (
        ...
        {
            double arrowBaseY =
                child.size.height - Text_selection_toolbarLibrary._kToolbarArrowSize.height;
    ...
    public override void paint(PaintingContext context, Offset offset)
    {
        ...
        if (_shadowColor is not null)
        {
            ...
            RRect shadowRRect = RRect
                .fromLTRBR(
                    ...
                    rrect.top,
                    rrect.right,
                    rrect.bottom + Text_selection_toolbarLibrary._kToolbarArrowSize.height,
                    Text_selection_toolbarLibrary._kToolbarBorderRadius
                )
        ...
        _clipPathLayer.layer = context.pushClipPath(
            ...
            Offset.zero & childLocal.size,
            clipPath,
            (innerContext, innerOffset) =>
            {
                innerContext.paintChild(childLocal, innerOffset);
            },
    ...
    public override bool hitTestChildren(BoxHitTestResult result, Offset position)
    {
        ...
        var childParentData = ((BoxParentData?)childLocal.parentData!)!;
        var hitBox = Rect.fromLTWH(
            childParentData.offset.dx,
            childParentData.offset.dy + Text_selection_toolbarLibrary._kToolbarArrowSize.height,
            childLocal.size.width,
            childLocal.size.height - (Text_selection_toolbarLibrary._kToolbarArrowSize.height * 2L)
        );
...
public class _CupertinoTextSelectionToolbarContent__text_selection_toolbar : StatefulWidget
{
    ...
    internal _CupertinoTextSelectionToolbarContent__text_selection_toolbar(
        Offset anchorAbove,
        Offset anchorBelow,
        Func<BuildContext, Offset, Offset, Widget, Widget> toolbarBuilder,
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _CupertinoTextSelectionToolbarContentState__text_selection_toolbar()
        );
}

public class _CupertinoTextSelectionToolbarContentState__text_selection_toolbar
    : State<_CupertinoTextSelectionToolbarContent__text_selection_toolbar>,
        TickerProviderStateMixin<_CupertinoTextSelectionToolbarContent__text_selection_toolbar>
{
    ...
    internal virtual GlobalKey<IState> _toolbarItemsKey { get; private set; } =
    ...
    internal virtual void _handleNextPage()
    {
        ...
        if (
            (renderToolbar is _RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar)
            && (
                (_RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar)renderToolbar
            ).hasNextPage
        )
        {
            _RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar renderToolbar__19544__as19636 =
                (_RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar)renderToolbar;
            _controller.reverse();
    ...
    internal virtual void _handlePreviousPage()
    {
        ...
        {
            _RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar renderToolbar__19891__as19983 =
                (_RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar)renderToolbar;
            _controller.reverse();
            _controller.addStatusListener(_statusListener);
            _nextPage = _page - 1L;
    ...
    public override void initState()
    {
        ...
        _controller = new AnimationController(
            value: 1.0,
            vsync: this,
            duration: Text_selection_toolbarLibrary._kToolbarTransitionDuration
        );
    }

    public override void didUpdateWidget(
        _CupertinoTextSelectionToolbarContent__text_selection_toolbar oldWidget
    )
    {
    ...
    public override Widget build(BuildContext context)
    {
        ...
        Widget backButtonLocal = new Center(
            widthFactor: 1.0,
            heightFactor: 1.0,
            child: new CupertinoTextSelectionToolbarButton(
                ...
                child: new IgnorePointer(
                    child: new CustomPaint(
                        painter: new _LeftCupertinoChevronPainter__text_selection_toolbar(
                            color: chevronColor
                        ),
                        size: new Size(Text_selection_toolbarLibrary._kToolbarChevronSize)
                    )
                )
            )
        );
        Widget nextButtonLocal = new Center(
            widthFactor: 1.0,
            heightFactor: 1.0,
            child: new CupertinoTextSelectionToolbarButton(
                ...
                child: new IgnorePointer(
                    child: new CustomPaint(
                        painter: new _RightCupertinoChevronPainter__text_selection_toolbar(
                            color: chevronColor
                        ),
                        size: new Size(Text_selection_toolbarLibrary._kToolbarChevronSize)
                    )
        ...
        List<Widget> childrenLocal = widget
            .children.map(
                (child) =>
                {
            ...
            new FadeTransition(
                ...
                child: new AnimatedSize(
                    ...
                    child: new GestureDetector(
                        ...
                        child: new _CupertinoTextSelectionToolbarItems__text_selection_toolbar(
                            key: _toolbarItemsKey,
                            page: _page,
                            backButton: backButtonLocal,
                            dividerColor: Text_selection_toolbarLibrary._kToolbarDividerColor.resolveFrom(
                                context
                            ),
                            dividerWidth: 1.0 / MediaQuery.devicePixelRatioOf(context),
                            nextButton: nextButtonLocal,
...
internal class _LeftCupertinoChevronPainter__text_selection_toolbar
    : _CupertinoChevronPainter__text_selection_toolbar
{
    internal _LeftCupertinoChevronPainter__text_selection_toolbar(Color color)
        : base(color: color, isLeft: true) { }
}

internal class _RightCupertinoChevronPainter__text_selection_toolbar
    : _CupertinoChevronPainter__text_selection_toolbar
{
    internal _RightCupertinoChevronPainter__text_selection_toolbar(Color color)
        : base(color: color, isLeft: false) { }
}
...
internal abstract class _CupertinoChevronPainter__text_selection_toolbar : CustomPainter
{
    ...
    public override void paint(Canvas canvas, Size size)
    {
        DartRuntimePrimitives.Assert(
            ...
            () => (object?)$"size must have the same height and width: {size}"
        );
    ...
    public override bool shouldRepaint(CustomPainter oldDelegate) =>
        DartRuntimePrimitives.ConvertValue<bool>(
            (!Equals(((_CupertinoChevronPainter__text_selection_toolbar)oldDelegate).color, color))
                || (
                    ((_CupertinoChevronPainter__text_selection_toolbar)oldDelegate).isLeft != isLeft
                )
        );
}
...
public class _CupertinoTextSelectionToolbarItems__text_selection_toolbar : RenderObjectWidget
{
    ...
    internal _CupertinoTextSelectionToolbarItems__text_selection_toolbar(
        Key? key = null,
        long page = default!,
        List<Widget> children = default!,
        Widget backButton = default!,
        Color dividerColor = default!,
        double dividerWidth = default!,
        Widget nextButton = default!
    )
        : base(key: key)
    {
        this.page = page;
    ...
    public override RenderObject createRenderObject(BuildContext context)
    {
        return new _RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar(
    ...
    {
        var __renderObject =
            (_RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar)renderObject;
        DartRuntimePrimitives.Ignore(
            (
                (Func<_RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar>)(
                    () =>
                    {
                        var __cascade = __renderObject;
                        __cascade.page = page;
    ...
    public override _CupertinoTextSelectionToolbarItemsElement__text_selection_toolbar createElement() =>
        new _CupertinoTextSelectionToolbarItemsElement__text_selection_toolbar(this);
}

public class _CupertinoTextSelectionToolbarItemsElement__text_selection_toolbar
    : RenderObjectElement
{
    internal virtual List<Element> _children { get; set; } = default!;
    public virtual DartMap<
        _CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar,
        Element
    > slotToChild { get; private set; } =
        new DartMap<_CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar, Element>();
    internal virtual HashSet<Element> _forgottenChildren { get; private set; } =
        new HashSet<Element>();

    internal _CupertinoTextSelectionToolbarItemsElement__text_selection_toolbar(
        _CupertinoTextSelectionToolbarItems__text_selection_toolbar widget
    )
        : base(widget) { }

    public override _RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar renderObject =>
        DartRuntimePrimitives.ConvertValue<_RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar>(
            ((_RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar?)base.renderObject)!
        );

    internal virtual void _updateRenderObject(
        RenderBox? child,
    ...
    public override void insertRenderObjectChild(RenderObject child, object? slot)
    {
        ...
        if (slot is IndexedSlot<Element?>)
        {
            ...
            renderObject.insert(
                ((RenderBox?)child)!,
                after: ((RenderBox?)slot__as28229.value?.renderObject)!
            );
            return;
        }
        DartRuntimePrimitives.Assert(
            () => false,
            () => (object?)"slot must be _CupertinoTextSelectionToolbarItemsSlot or IndexedSlot"
        );
    }
    ...
    public override void moveRenderObjectChild(RenderObject child, object? oldSlot, object? newSlot)
    {
        var targetSlot =
            ...
            ?? throw new ArgumentException(
                "Toolbar children require an indexed slot.",
                nameof(newSlot)
            );
        renderObject.move((RenderBox)child, after: (RenderBox?)targetSlot.value?.renderObject);
    }
    ...
    public override void removeRenderObjectChild(RenderObject child, object? slot)
    {
        if (slot is _CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar)
        {
            _CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar slot__as29126 =
                (_CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar)slot;
            DartRuntimePrimitives.Assert(() => child is RenderBox);
            DartRuntimePrimitives.Assert(() =>
    ...
    {
        DartRuntimePrimitives.Assert(() =>
            slotToChild.containsValue(child) || _children.Contains(child)
        );
        DartRuntimePrimitives.Assert(() => !_forgottenChildren.Contains(child));
        if (
            child.slot is _CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar slotLocal
    ...
    internal virtual void _mountChild(
        Widget widget,
        _CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar slot
    )
    {
    ...
    public override void mount(Element? parent, object? newSlot)
    {
        ...
        _children = new List<Element>(
            Enumerable.Select(
                Enumerable.Range(0, checked((int)checked((long)toolbarItems.children.Count))),
                (i) =>
                {
                    Element result = inflateWidget(
    ...
    public override void debugVisitOnstageChildren(Action<Element> visitor)
    {
        ...
        _children
            .where((child) => !_forgottenChildren.Contains(child) && _shouldPaint(child))
...
public class _RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar
    : RenderBox,
        ...
        RenderBoxContainerDefaultsMixin<RenderBox, ToolbarItemsParentData>
{
    public virtual DartMap<
        _CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar,
        RenderBox
    > slottedChildren { get; private set; } =
        new DartMap<_CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar, RenderBox>();
    ...
    internal _RenderCupertinoTextSelectionToolbarItems__text_selection_toolbar(
        Color dividerColor,
        double dividerWidth,
        long page
    )
    ...
    internal virtual RenderBox? _updateChild(
        RenderBox? oldChild,
        RenderBox? newChild,
        _CupertinoTextSelectionToolbarItemsSlot__text_selection_toolbar slot
    )
    ...
    public override void performLayout()
    {
        ...
        visitChildren(
            (renderObjectChild) =>
            {
                ...
                if (
                    Equals(childLocal, _backButton)
                    || Equals(childLocal, _nextButton)
                    || (currentPage > _page)
                )
                {
                    return;
                ...
                double paginationButtonsWidth =
                    (currentPage == 0L)
                        ? ((i == (childCount + 1L)) ? 0.0 : _nextButton!.size.width)
                ...
                double currentWidth =
                    currentButtonPosition + paginationButtonsWidth + childLocal.size.width;
                ...
                if (childParentData.shouldPaint)
                {
                    ...
                    if ((childParentData.nextSibling is not null) || Equals(child, backButton))
                    {
                        context.canvas.drawLine(
                            new Offset(child.size.width, 0) + childOffset,
                            new Offset(child.size.width, child.size.height) + childOffset,
                            (
                                (Func<Paint>)(
                                    () =>
                                    {
        ...
        else
        {
            ...
            else
            {
                ...
                var childPreviousSiblingParentData = (
                    (ToolbarItemsParentData?)childParentData.previousSibling!.parentData!
                )!;
                var childNextSiblingParentData = (
                    (ToolbarItemsParentData?)childParentData.nextSibling!.parentData!
                )!;
    ...
    public virtual void insert(RenderBox child, RenderBox? after = null)
    {
        ...
        adoptChild(child);
        DartRuntimePrimitives.Assert(
            () => child.parentData is ToolbarItemsParentData,
            () =>
                (object?)
                    $"A child of {GetType()} has parentData of type {DartRuntimePrimitives.RuntimeType(child.parentData)}, "
                + $"which does not conform to {typeof(ToolbarItemsParentData)}. Class using ContainerRenderObjectMixin "
