...
public static partial class RouteLibrary
{
    internal static Duration _kDroppedSwipePageAnimationDuration = Duration.Create(
        milliseconds: 350L
    );
}
...
public static partial class RouteLibrary
{
    public static Color kCupertinoModalBarrierColor = new CupertinoDynamicColor(
        color: new Color(855638016L),
        darkColor: new Color(2046820352L)
    );
}
...
public static partial class RouteLibrary
{
    internal static Animatable<Offset> _kRightMiddleTween = new Tween<Offset>(
...
public static partial class RouteLibrary
{
    internal static Animatable<Offset> _kMiddleLeftTween = new Tween<Offset>(
        begin: Offset.zero,
        end: new Offset(-1.0 / 3.0, 0.0)
    );
}
...
public interface CupertinoRouteTransitionMixin<T> : ICupertinoRouteTitle
{
    ...
    public static _CupertinoBackGestureController__route<TRouteResult> _startPopGesture<TRouteResult>(
        PageRoute<TRouteResult> route
    )
    {
        DartRuntimePrimitives.Assert(() => route.popGestureEnabled);
        return new _CupertinoBackGestureController__route<TRouteResult>(
    ...
    )
    {
        ...
        else
        {
            return new CupertinoPageTransition(
                ...
                secondaryRouteAnimation: secondaryAnimation,
                linearTransition: linearTransitionLocal,
                child: new _CupertinoBackGestureDetector__route<TRouteResult>(
                    enabledCallback: () => route.popGestureEnabled,
                    onStartPopGesture: () =>
                        CupertinoRouteTransitionMixin<TRouteResult>._startPopGesture(route),
                    child: child
                )
            );
        }
...
public class CupertinoPageRoute<T> : PageRoute<T>, CupertinoRouteTransitionMixin<T>
{
    ...
    {
        string? previousTitleString =
            (previousRoute is ICupertinoRouteTitle)
                ? ((ICupertinoRouteTitle)(object)previousRoute).title
                : null;
    ...
    public override Color? barrierColor =>
        fullscreenDialog ? null : RouteLibrary._kCupertinoPageTransitionBarrierColor;
    ...
    {
        bool nextRouteIsNotFullscreen =
            nextRoute is not IPageRoute || !((IPageRoute)(object)nextRoute).fullscreenDialog;
        bool nextRouteHasDelegatedTransition =
...
internal class _PageBasedCupertinoPageRoute__route<T>
    : PageRoute<T>,
        CupertinoRouteTransitionMixin<T>
{
    public virtual ValueNotifier<string?>? _previousTitle { get; set; } = default;

    internal _PageBasedCupertinoPageRoute__route(
        CupertinoPage<T> page,
        bool allowSnapshotting = true
    )
        : base(allowSnapshotting: allowSnapshotting, settings: page)
    {
        DartRuntimePrimitives.Assert(() => opaque);
    }
    ...
    public override Func<
        ...
        Widget?,
        Widget?
    >? delegatedTransition => fullscreenDialog ? null : CupertinoPageTransition.delegatedTransition;
...
public class CupertinoPage<T> : Page<T>
{
    ...
    {
        return new _PageBasedCupertinoPageRoute__route<T>(
            page: this,
            allowSnapshotting: allowSnapshotting
        );
        throw new InvalidOperationException("Dart control flow completed without a value.");
...
public class CupertinoPageTransition : StatefulWidget
{
    ...
    )
    {
        ...
        Animation<Offset> delegatedPositionAnimation = animationLocal.drive(
            RouteLibrary._kMiddleLeftTween
        );
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _CupertinoPageTransitionState__route());
}
...
public class CupertinoFullscreenDialogTransition : StatefulWidget
{
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _CupertinoFullscreenDialogTransitionState__route()
        );
}

internal class _CupertinoFullscreenDialogTransitionState__route
    : State<CupertinoFullscreenDialogTransition>
{
    internal virtual Animation<Offset> _primaryPositionAnimation { get; set; } = default!;
    internal virtual Animation<Offset> _secondaryPositionAnimation { get; set; } = default!;
    internal virtual CurvedAnimation? _primaryPositionCurve { get; set; } = default;
    ...
    internal virtual void _setupAnimation()
    {
        ...
        ).drive(RouteLibrary._kBottomUpTween);
        _secondaryPositionAnimation = (
...
internal class _CupertinoBackGestureDetector__route<T> : StatefulWidget
{
    ...
    public virtual Func<_CupertinoBackGestureController__route<T>> onStartPopGesture
    {
        get;
        private set;
    } = default!;

    internal _CupertinoBackGestureDetector__route(
        Key? key = null,
        Func<bool> enabledCallback = default!,
        Func<_CupertinoBackGestureController__route<T>> onStartPopGesture = default!,
        Widget child = default!
    )
        : base(key: key)
    {
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(
            new _CupertinoBackGestureDetectorState__route<T>()
        );
}

internal class _CupertinoBackGestureDetectorState__route<T>
    : State<_CupertinoBackGestureDetector__route<T>>
{
    internal virtual _CupertinoBackGestureController__route<T>? _backGestureController { get; set; } =
        default;
    ...
    public override Widget build(BuildContext context)
    {
        ...
        double dragAreaWidth = Directionality.of(context) switch
        {
        ...
        return new Stack(
            ...
            {
                DartRuntimePrimitives.ConvertValue<Widget>(widget.child),
                DartRuntimePrimitives.ConvertValue<Widget>(
                    new PositionedDirectional(
                        start: 0.0,
                        width: Math.Max(dragAreaWidth, RouteLibrary._kBackGestureWidth),
                        top: 0.0,
                        bottom: 0.0,
                        child: new Listener(
...
public class _CupertinoBackGestureController__route<T>
{
    ...
    internal _CupertinoBackGestureController__route(
    ...
    public virtual void dragEnd(double velocity)
    {
        ...
        if (animateForward)
        {
            controller.animateTo(
                1.0,
                duration: RouteLibrary._kDroppedSwipePageAnimationDuration,
...
{
    public static DecorationTween kTween = new DecorationTween(
        begin: new _CupertinoEdgeShadowDecoration__route(),
        end: new _CupertinoEdgeShadowDecoration__route(
            new List<Color> { new Color(67108864L), CupertinoColors.transparent }
        )
    );
    ...
    public static _CupertinoEdgeShadowDecoration__route? lerp(
        _CupertinoEdgeShadowDecoration__route? a,
        _CupertinoEdgeShadowDecoration__route? b,
        double t
    )
    {
        ...
        DartRuntimePrimitives.Assert(() =>
            (b._colors is null)
            || (a._colors is null)
            || (checked(a._colors.Count) == checked((long)b._colors.Count))
        );
    ...
    public override _CupertinoEdgeShadowDecoration__route lerpFrom(Decoration? a, double t)
    {
        ...
        {
            _CupertinoEdgeShadowDecoration__route a__as34106 =
                (_CupertinoEdgeShadowDecoration__route)a;
    ...
    public override _CupertinoEdgeShadowDecoration__route lerpTo(Decoration? b, double t)
    {
        ...
        {
            _CupertinoEdgeShadowDecoration__route b__as34370 =
                (_CupertinoEdgeShadowDecoration__route)b;
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is _CupertinoEdgeShadowDecoration__route)
            && Equals(__other._colors, _colors);
    }

    public override int GetHashCode() =>
        DartRuntimePrimitives.ConvertValue<int>(_colors?.GetHashCode() ?? 0);
...
{
    internal virtual _CupertinoEdgeShadowDecoration__route _decoration { get; private set; } =
        default!;

    internal _CupertinoEdgeShadowPainter__route(
        _CupertinoEdgeShadowDecoration__route _decoration,
        Action? onChanged
    )
        : base(onChanged)
    {
        ...
        System.Diagnostics.Debug.Assert(
            (_decoration._colors is null) || (checked(_decoration._colors.Count) > 1L)
        );
    }
...
public static partial class RouteLibrary
{
    internal static Physics.SpringDescription _kStandardSpring = new Physics.SpringDescription(
        mass: 1,
...
public class CupertinoModalPopupRoute<T> : PopupRoute<T>
{
    ...
    internal static Tween<Offset> _offsetTween = new Tween<Offset>(
        begin: new Offset(0.0, 1.0),
        end: Offset.zero
    );
    ...
    public CupertinoModalPopupRoute(
        ...
        : base(filter: filter, settings: settings, requestFocus: requestFocus)
    {
...
public static partial class RouteLibrary
{
    ...
    )
    {
        return Navigator
            ...
            .push(
                new CupertinoModalPopupRoute<T>(
                    builder: builder,
                    filter: filter,
...
public static partial class RouteLibrary
{
    internal static Widget _buildCupertinoDialogTransitions(
        BuildContext context,
        Animation<double> animation,
        Animation<double> secondaryAnimation,
        Widget child
...
public class CupertinoDialogRoute<T> : RawDialogRoute<T>
{
    public virtual Func<
        ...
        Widget,
        Widget
    >? transitionBuilder { get; set; } = default;
    ...
    public CupertinoDialogRoute(
        ...
        : base(
            barrierDismissible: barrierDismissible,
            transitionDuration: transitionDuration ?? Duration.Create(milliseconds: 250),
            settings: settings,
            requestFocus: requestFocus,
            anchorPoint: anchorPoint,
            ...
            barrierColor: barrierColor
                ?? CupertinoDynamicColor.resolve(RouteLibrary.kCupertinoModalBarrierColor, context)
        )
    {
