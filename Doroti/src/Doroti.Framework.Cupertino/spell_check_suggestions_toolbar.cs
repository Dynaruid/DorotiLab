...
public class CupertinoSpellCheckSuggestionsToolbar : StatelessWidget
{
    ...
    public CupertinoSpellCheckSuggestionsToolbar(Key? key = null, TextSelectionToolbarAnchors anchors = default!, List<ContextMenuButtonItem> buttonItems = default!) : base(key: key)
    {
    ...
    public static CupertinoSpellCheckSuggestionsToolbar CreateEditableText(Key? key = null, EditableTextState editableTextState = default!)
    {
    ...
    public static List<ContextMenuButtonItem>? buildButtonItems(EditableTextState editableTextState)
    {
        ...
        if (!Enumerable.Any(spanAtCursorIndex.suggestions))
        {
            ...
            return new List<ContextMenuButtonItem> { new ContextMenuButtonItem(onPressed: null, label: localizations.noSpellCheckReplacementsLabel) };
        }
    ...
    internal static void _replaceText(EditableTextState editableTextState, string text, TextRange replacementRange)
    {
        ...
        TextEditingValue newValue = editableTextState.textEditingValue.replaced(replacementRange, text).copyWith(selection: TextSelection.CreateCollapsed(offset: replacementRange.start + text.Length));
