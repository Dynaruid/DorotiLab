...
public static partial class Context_menuLibrary
{
    internal static List<global::Doroti.Generated.Framework.Painting.BoxShadow> _endBoxShadow = new List<global::Doroti.Generated.Framework.Painting.BoxShadow> { new global::Doroti.Generated.Framework.Painting.BoxShadow(color: new global::Doroti.Ui.Color(1073741824L), blurRadius: 10.0, spreadRadius: 0.5) };
}
...
public static partial class Context_menuLibrary
{
    internal static Rect _getRect(global::Doroti.Generated.Framework.Widgets.GlobalKey<IState> globalKey)
    {
        ...
        return global::Doroti.Ui.Rect.fromPoints(((Offset)((dynamic)renderBoxContainer__2936).localToGlobal(((global::Doroti.Generated.Framework.Rendering.RenderBox)renderBoxContainer__2936).paintBounds.topLeft)), ((Offset)((dynamic)renderBoxContainer__2936).localToGlobal(((global::Doroti.Generated.Framework.Rendering.RenderBox)renderBoxContainer__2936).paintBounds.bottomRight)));
...
_childHidden = true;
        ...
        _route = new _ContextMenuRoute__context_menu<object?>(actions: ((CupertinoContextMenu)(object)this.widget).actions, barrierLabel: CupertinoLocalizations.of(this.context).menuDismissLabel, filter: new global::Doroti.Ui.ImageFilter(sigmaX: 5.0, sigmaY: 5.0), contextMenuLocation: this._contextMenuLocation, previousChildRect: DartRuntimePrimitives.RequireValue(this._decoyChildEndRect), scaleFactor: this._scaleFactor, builder: ((global::System.Func<global::Doroti.Generated.Framework.Widgets.BuildContext, global::Doroti.Generated.Framework.Animation.Animation<double>, global::Doroti.Generated.Framework.Widgets.Widget>?)((context, animation) => {
...
internal class _DecoyChildState__context_menu : global::Doroti.Generated.Framework.Widgets.State<_DecoyChild__context_menu>, global::Doroti.Generated.Framework.Widgets.TickerProviderStateMixin<_DecoyChild__context_menu>
{
    ...
    public override void initState()
    {
        ...
        _rect = new global::Doroti.Generated.Framework.Animation.TweenSequence<global::Doroti.Ui.Rect?>(new List<global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Ui.Rect?>> { new global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Ui.Rect?>(tween: new global::Doroti.Generated.Framework.Animation.RectTween(begin: ((_DecoyChild__context_menu)(object)this.widget).beginRect, end: ((_DecoyChild__context_menu)(object)this.widget).beginRect).chain(new global::Doroti.Generated.Framework.Animation.CurveTween(curve: global::Doroti.Generated.Framework.Animation.Curves.linear)), weight: beginPause__24596), new global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Ui.Rect?>(tween: new global::Doroti.Generated.Framework.Animation.RectTween(begin: ((_DecoyChild__context_menu)(object)this.widget).beginRect, end: ((_DecoyChild__context_menu)(object)this.widget).endRect).chain(new global::Doroti.Generated.Framework.Animation.CurveTween(curve: global::Doroti.Generated.Framework.Animation.Curves.easeOutSine)), weight: openAnimationLength__24624), new global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Ui.Rect?>(tween: new global::Doroti.Generated.Framework.Animation.RectTween(begin: ((_DecoyChild__context_menu)(object)this.widget).endRect, end: ((_DecoyChild__context_menu)(object)this.widget).endRect).chain(new global::Doroti.Generated.Framework.Animation.CurveTween(curve: global::Doroti.Generated.Framework.Animation.Curves.linear)), weight: endPause__24746) }.Cast<global::Doroti.Generated.Framework.Animation.TweenSequenceItem<global::Doroti.Ui.Rect?>>().ToList()).animate(((_DecoyChild__context_menu)(object)this.widget).controller);
...
internal class _ContextMenuRoute__context_menu<T> : global::Doroti.Generated.Framework.Widgets.PopupRoute<T>
{
    ...
    internal static global::Doroti.Ui.Rect _getScaledRect(global::Doroti.Generated.Framework.Widgets.GlobalKey<IState> globalKey, double scale)
    {
    ...
    internal static global::Doroti.Ui.Rect _getSheetRectBegin(global::Doroti.Generated.Framework.Widgets.Orientation? orientation, _ContextMenuLocation__context_menu contextMenuLocation, Rect childRect, Rect sheetRect)
    {
        switch (contextMenuLocation)
        {
            case _ContextMenuLocation__context_menu.center:
                {
                    global::Doroti.Ui.Offset target__31527 = ((global::Doroti.Ui.Offset)(object?)((object.Equals(orientation, global::Doroti.Generated.Framework.Widgets.Orientation.portrait)) ? childRect.bottomCenter : childRect.topCenter));
            ...
            case _ContextMenuLocation__context_menu.right:
                {
                    global::Doroti.Ui.Offset target__31821 = ((global::Doroti.Ui.Offset)(object?)((object.Equals(orientation, global::Doroti.Generated.Framework.Widgets.Orientation.portrait)) ? childRect.bottomRight : childRect.topRight));
            ...
            case _ContextMenuLocation__context_menu.left:
                {
                    global::Doroti.Ui.Offset target__32068 = ((global::Doroti.Ui.Offset)(object?)((object.Equals(orientation, global::Doroti.Generated.Framework.Widgets.Orientation.portrait)) ? childRect.bottomLeft : childRect.topLeft));
...
internal class _ContextMenuRouteStaticState__context_menu : global::Doroti.Generated.Framework.Widgets.State<_ContextMenuRouteStatic__context_menu>, global::Doroti.Generated.Framework.Widgets.TickerProviderStateMixin<_ContextMenuRouteStatic__context_menu>
{
    ...
    internal virtual void _onPanEnd(global::Doroti.Generated.Framework.Gestures.DragEndDetails details)
    {
        if ((((global::Doroti.Generated.Framework.Gestures.DragEndDetails)details).velocity.pixelsPerSecond.dy.abs() >= global::Doroti.Generated.Framework.Gestures.ConstantsLibrary.kMinFlingVelocity))
        {
            ...
            _moveAnimation = new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Ui.Offset>(begin: new global::Doroti.Ui.Offset(0.0, ((global::Doroti.Generated.Framework.Animation.Animation<Offset>)this._moveAnimation).value.dy), end: new global::Doroti.Ui.Offset(0.0, finalPosition__40679)).animate(this._moveController);
...
_moveAnimation = new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Ui.Offset>(begin: Offset.zero, end: new global::Doroti.Ui.Offset(Dart_uiLibrary.clampDouble(endX__42643, -SliderLibrary._kPadding, SliderLibrary._kPadding), endY__42706)).animate(this._moveCurvedAnimation);
...
else
{
    ...
    internal virtual global::Doroti.Generated.Framework.Widgets.Widget _getChild(global::Doroti.Generated.Framework.Widgets.Orientation orientation, _ContextMenuLocation__context_menu contextMenuLocation)
    {
        ...
        var screenBounds__43909 = global::Doroti.Ui.Rect.fromLTWH(0, 0, ((screenSize__43796.width - ((global::Doroti.Generated.Framework.Painting.EdgeInsets)padding__43858).left) - ((global::Doroti.Generated.Framework.Painting.EdgeInsets)padding__43858).right), ((screenSize__43796.height - ((global::Doroti.Generated.Framework.Painting.EdgeInsets)padding__43858).top) - ((global::Doroti.Generated.Framework.Painting.EdgeInsets)padding__43858).bottom));
