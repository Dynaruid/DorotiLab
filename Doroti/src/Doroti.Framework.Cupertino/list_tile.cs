...
public static partial class List_tileLibrary
{
    internal static global::Doroti.Framework.Painting.EdgeInsetsDirectional _kPadding = global::Doroti.Framework.Painting.EdgeInsetsDirectional.CreateOnly(start: 20.0, end: 14.0);
}

public static partial class List_tileLibrary
{
    internal static global::Doroti.Framework.Painting.EdgeInsetsDirectional _kPaddingWithSubtitle = global::Doroti.Framework.Painting.EdgeInsetsDirectional.CreateOnly(start: 20.0, end: 14.0);
}

public static partial class List_tileLibrary
{
    internal static global::Doroti.Framework.Painting.EdgeInsets _kNotchedPadding = global::Doroti.Framework.Painting.EdgeInsets.CreateSymmetric(horizontal: 14.0);
}
...
internal class _CupertinoListTileState__list_tile : global::Doroti.Framework.Widgets.State<CupertinoListTile>
{
    ...
    {
        global::Doroti.Framework.Painting.TextStyle textStyle__12145 = CupertinoTheme.of(context).textTheme.textStyle;
        global::Doroti.Framework.Painting.TextStyle coloredStyle__12225 = ((global::Doroti.Framework.Painting.TextStyle)(object?)textStyle__12145.copyWith(color: CupertinoColors.secondaryLabel.resolveFrom(context)));
        ...
        global::Doroti.Framework.Widgets.Widget title__12498 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.DefaultTextStyle(style: ((baseType__12349 || (((CupertinoListTile)this.widget).subtitle is null)) ? textStyle__12145 : textStyle__12145.copyWith(fontWeight: FontWeight.w600, fontSize: ((((CupertinoListTile)this.widget).leading is null) ? List_tileLibrary._kNotchedTitleWithSubtitleFontSize : null))), maxLines: 1L, overflow: global::Doroti.Framework.Painting.TextOverflow.ellipsis, child: ((CupertinoListTile)this.widget).title));
        global::Doroti.Framework.Painting.EdgeInsetsGeometry padding__12899 = (((CupertinoListTile)this.widget).padding ?? (((CupertinoListTile)this.widget)._type switch { _CupertinoListTileType__list_tile.@base when ((((CupertinoListTile)this.widget).subtitle is not null)) => DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Painting.EdgeInsetsGeometry>(List_tileLibrary._kPaddingWithSubtitle), _CupertinoListTileType__list_tile.notched when ((((CupertinoListTile)this.widget).leading is not null)) => DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Painting.EdgeInsetsGeometry>(List_tileLibrary._kNotchedPadding), _CupertinoListTileType__list_tile.@base => DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Painting.EdgeInsetsGeometry>(List_tileLibrary._kPadding), _CupertinoListTileType__list_tile.notched => DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Painting.EdgeInsetsGeometry>(List_tileLibrary._kNotchedPaddingWithoutLeading), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") }));
        ...
        global::Doroti.Framework.Widgets.Widget child__14186 = ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.ConstrainedBox(constraints: new global::Doroti.Framework.Rendering.BoxConstraints(minWidth: double.PositiveInfinity, minHeight: minHeight__13822), child: new global::Doroti.Framework.Widgets.ColoredBox(color: backgroundColor__13587, child: new global::Doroti.Framework.Widgets.Padding(padding: padding__12899, child: new global::Doroti.Framework.Widgets.Row(children: ((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection14447 = new List<global::Doroti.Framework.Widgets.Widget>(); if (((CupertinoListTile)this.widget).leading is global::Doroti.Framework.Widgets.Widget leading__14508) { __collection14447.AddRange(new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(global::Doroti.Framework.Widgets.SizedBox.CreateSquare(dimension: ((CupertinoListTile)this.widget).leadingSize, child: new global::Doroti.Framework.Widgets.Center(child: leading__14508))), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: ((CupertinoListTile)this.widget).leadingToTitle)) }); } else { __collection14447.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(height: ((CupertinoListTile)this.widget).leadingSize))); } __collection14447.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.Expanded(child: new global::Doroti.Framework.Widgets.Column(mainAxisAlignment: global::Doroti.Framework.Rendering.MainAxisAlignment.spaceBetween, crossAxisAlignment: global::Doroti.Framework.Rendering.CrossAxisAlignment.start, children: ((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection15027 = new List<global::Doroti.Framework.Widgets.Widget>(); __collection15027.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(title__12498)); if (((CupertinoListTile)this.widget).subtitle is global::Doroti.Framework.Widgets.Widget subtitle__15122) { __collection15027.AddRange(new List<global::Doroti.Framework.Widgets.Widget> { DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(height: List_tileLibrary._kNotchedTitleToSubtitle)), DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.DefaultTextStyle(style: coloredStyle__12225.copyWith(fontSize: (baseType__12349 ? List_tileLibrary._kSubtitleFontSize : List_tileLibrary._kNotchedSubtitleFontSize)), maxLines: 1L, overflow: global::Doroti.Framework.Painting.TextOverflow.ellipsis, child: subtitle__15122)) }); } return __collection15027; }))())))); if (((CupertinoListTile)this.widget).additionalInfo is global::Doroti.Framework.Widgets.Widget additionalInfo__15731) { __collection14447.AddRange(((Func<List<global::Doroti.Framework.Widgets.Widget>>)(() => { var __collection15750 = new List<global::Doroti.Framework.Widgets.Widget>(); __collection15750.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.DefaultTextStyle(style: coloredStyle__12225, maxLines: 1L, child: additionalInfo__15731))); if ((((CupertinoListTile)this.widget).trailing is not null)) { __collection15750.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(new global::Doroti.Framework.Widgets.SizedBox(width: List_tileLibrary._kAdditionalInfoToTrailing))); } return __collection15750; }))()); } var __collectionElement15978 = ((CupertinoListTile)this.widget).trailing; if (__collectionElement15978 is { } __nonNullCollectionElement15978) { __collection14447.Add(DartRuntimePrimitives.ConvertValue<global::Doroti.Framework.Widgets.Widget>(__nonNullCollectionElement15978)); } return __collection14447; }))())))));
...
public class CupertinoListTileChevron : global::Doroti.Framework.Widgets.StatelessWidget
{
    ...
    public override global::Doroti.Framework.Widgets.Widget build(global::Doroti.Framework.Widgets.BuildContext context)
    {
        return ((global::Doroti.Framework.Widgets.Widget)(object?)new global::Doroti.Framework.Widgets.Icon(CupertinoIcons.right_chevron, size: CupertinoTheme.of(context).textTheme.textStyle.fontSize, color: CupertinoColors.systemGrey2.resolveFrom(context)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
