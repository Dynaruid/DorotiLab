...
{
    internal static global::Doroti.Framework.Animation.Curve _kAnimationCurve = ((global::Doroti.Framework.Animation.Curve)(object?)global::Doroti.Framework.Animation.Curves.easeInOut);
}
...
{
    internal virtual global::Doroti.Framework.Widgets.GlobalKey<IState> _headerKey { get; private set; } = global::Doroti.Framework.Widgets.GlobalKey<IState>.Create();
    ...
    internal static global::Doroti.Framework.Animation.Animatable<double> _quarterTween = ((global::Doroti.Framework.Animation.Animatable<double>)(object?)new global::Doroti.Framework.Animation.Tween<double>(begin: 0.0, end: 0.25));
    ...
    internal virtual global::Doroti.Framework.Widgets.Widget? _buildIcon(global::Doroti.Framework.Widgets.BuildContext context, global::Doroti.Framework.Animation.Animation<double> animation)
    {
        ...
        return ((global::Doroti.Framework.Widgets.Widget?)(object?)new global::Doroti.Framework.Widgets.RotationTransition(turns: this._iconTurns, child: global::Doroti.Framework.Widgets.SizedBox.CreateSquare(dimension: CupertinoTheme.of(context).textTheme.textStyle.fontSize, child: new global::Doroti.Framework.Widgets.Center(child: new global::Doroti.Framework.Widgets.Icon(CupertinoIcons.right_chevron, color: CupertinoColors.activeBlue, size: Expansion_tileLibrary._kIconFontSize, fontWeight: FontWeight.w900)))));
