...
public static partial class DebugLibrary
{
    public static bool debugCheckHasCupertinoLocalizations(BuildContext context)
    {
        ...
        {
            if (
                Localizations.of<CupertinoLocalizations>(context, typeof(CupertinoLocalizations))
                is null
            )
            {
                    ...
                    new FlutterError(
                        (
                            (Func<List<DiagnosticsNode>>)(
                                () =>
                                {
                                    var __collection1052 = new List<DiagnosticsNode>();
                                    __collection1052.Add(
                                        new ErrorSummary("No CupertinoLocalizations found.")
                                    );
                                    __collection1052.Add(
                                        new ErrorDescription(
                                            $"{DartRuntimePrimitives.RuntimeType(context.widget)} widgets require CupertinoLocalizations "
                                    ...
                                    __collection1052.AddRange(
                                        context.describeMissingAncestor(
                                            expectedAncestorType: typeof(CupertinoLocalizations)
                                        )
                                    );
                                    return __collection1052;
                                }
                            )
                        )()
                    )
