...
public class CupertinoApp : StatefulWidget
{
    ...
    public static CupertinoApp CreateRouter(
        Key? key = null,
    ...
    {
        var __instance = new CupertinoApp(
            key: key,
            theme: theme,
            routes: new DartMap<string, Func<BuildContext, Widget>>(),
    ...
    public override IState createState() =>
        DartRuntimePrimitives.ConvertValue<IState>(new _CupertinoAppState__app());
...
public class CupertinoScrollBehavior : ScrollBehavior
{
    ...
    public override Gestures.MultitouchDragStrategy getMultitouchDragStrategy(
        BuildContext context
    ) => Gestures.MultitouchDragStrategy.averageBoundaryPointers;
}
...
internal class _CupertinoAppState__app : State<CupertinoApp>
{
        ...
        get
        {
            return (
                (Func<List<object>>)(
                    () =>
                    {
                        var __collection18903 = new List<object>();
                        var __collectionSpread18943 = widget.localizationsDelegates;
                        if (__collectionSpread18943 is not null)
                        {
                            __collection18903.AddRange(__collectionSpread18943);
                        }
                        __collection18903.Add(DefaultCupertinoLocalizations.@delegate);
                        return __collection18903;
                    }
                )
            )();
        }
    ...
    {
        return new _CupertinoInspectorButton__app(
            onPressed: () => onPressed(),
    ...
    {
        return _CupertinoInspectorButton__app.CreateIconOnly(
            onPressed: onPressed,
            semanticsLabel: semanticsLabel,
    ...
    {
        return _CupertinoInspectorButton__app.CreateToggle(
            onPressed: () => onPressed(),
            semanticsLabel: semanticsLabel,
    ...
    internal virtual WidgetsApp _buildWidgetApp(BuildContext context)
    {
        ...
        Color colorLocal = CupertinoDynamicColor.resolve(
    ...
    {
        CupertinoThemeData effectiveThemeData = (
            widget.theme ?? new CupertinoThemeData()
        ).resolveFrom(context);
        Brightness brightnessLocal =
            effectiveThemeData.brightness ?? MediaQuery.platformBrightnessOf(context);
        SystemChrome.setSystemUIOverlayStyle(
            Equals(brightnessLocal, Brightness.dark)
                ? SystemUiOverlayStyle.light
                : SystemUiOverlayStyle.dark
        );
        return new ScrollConfiguration(
            behavior: widget.scrollBehavior ?? new CupertinoScrollBehavior(),
                ...
                child: new CupertinoTheme(
                    ...
                    child: new DefaultSelectionStyle(
                        ...
                        child: new HeroControllerScope(
                            ...
                            child: new Builder(
                                builder: (Func<BuildContext, WidgetsApp>)_buildWidgetApp
                            )
                        )
                    )
                )
...
{
    internal _CupertinoInspectorButton__app(
        Action onPressed,
        string semanticsLabel,
        IconData icon,
    ...
    internal static _CupertinoInspectorButton__app CreateToggle(
        Action onPressed,
        string semanticsLabel,
        IconData icon,
        bool toggledOn = true
    ...
    {
        var __instance = new _CupertinoInspectorButton__app(
            onPressed: onPressed,
            semanticsLabel: semanticsLabel,
            icon: icon
        );
    ...
    internal static _CupertinoInspectorButton__app CreateIconOnly(
        Action onPressed,
        string semanticsLabel,
        IconData icon
    )
    ...
    public override Widget build(BuildContext context)
    {
        ...
        return new Padding(
            ...
            padding: EdgeInsets.CreateAll(
                (ConstantsLibrary.kMinInteractiveDimensionCupertino - buttonSize) / 2L
            ),
            child: (
