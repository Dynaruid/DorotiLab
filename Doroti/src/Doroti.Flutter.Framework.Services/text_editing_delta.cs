...
public abstract class TextEditingDelta : Diagnosticable
{
    ...
    public static TextEditingDelta CreateFromJSON(DartMap<string, object> encoded)
    {
        ...
        var newComposing = new global::Doroti.Flutter.Ui.TextRange(start: (((long?)encoded.GetValueOrDefault("composingBase")) ?? -1L), end: (((long?)encoded.GetValueOrDefault("composingExtent")) ?? -1L));
        ...
        DartRuntimePrimitives.Assert(() => Text_editing_deltaLibrary._debugTextRangeIsValid(new global::Doroti.Flutter.Ui.TextRange(start: replacementDestinationStart, end: replacementDestinationEnd), oldText));
        string newText = Text_editing_deltaLibrary._replace(oldText, replacementSource, new global::Doroti.Flutter.Ui.TextRange(start: replacementDestinationStart, end: replacementDestinationEnd));
        ...
        else
        {
            if ((((isDeletingByReplacingWithEmpty || isDeletingInsideComposingRegion)) && !isOriginalComposingRegionTextChanged))
            {
                ...
                return new TextEditingDeltaDeletion(oldText: oldText, deletedRange: new global::Doroti.Flutter.Ui.TextRange(start: actualStart__9997, end: replacementDestinationEnd), selection: newSelection, composing: newComposing);
            }
            else
            {
                ...
                else
                {
                    if (isReplaced)
                    {
                        return new TextEditingDeltaReplacement(oldText: oldText, replacementText: replacementSource, replacedRange: new global::Doroti.Flutter.Ui.TextRange(start: replacementDestinationStart, end: replacementDestinationEnd), selection: newSelection, composing: newComposing);
                    }
                }
            }
        }
...
public class TextEditingDeltaInsertion : TextEditingDelta
{
    ...
    public override TextEditingValue apply(TextEditingValue value)
    {
        ...
        DartRuntimePrimitives.Assert(() => Text_editing_deltaLibrary._debugTextRangeIsValid(new global::Doroti.Flutter.Ui.TextRange(insertionOffset), newText));
        newText = Text_editing_deltaLibrary._replace(newText, textInserted, new global::Doroti.Flutter.Ui.TextRange(insertionOffset));
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.TextRange>("composing", composing));
    }
...
public class TextEditingDeltaDeletion : TextEditingDelta
{
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.TextRange>("deletedRange", deletedRange));
        properties.Add(new DiagnosticsProperty<TextSelection>("selection", selection));
        properties.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.TextRange>("composing", composing));
    }
...
public class TextEditingDeltaReplacement : TextEditingDelta
{
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.TextRange>("replacedRange", replacedRange));
        properties.Add(new DiagnosticsProperty<TextSelection>("selection", selection));
        properties.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.TextRange>("composing", composing));
    }
