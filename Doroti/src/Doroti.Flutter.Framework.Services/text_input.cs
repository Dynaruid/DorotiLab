...
public class TextEditingValue
{
    ...
    public static TextEditingValue CreateFromJSON(DartMap<string, object> encoded)
    {
        ...
        var composing = new global::Doroti.Flutter.Ui.TextRange(start: (((long?)encoded.GetValueOrDefault("composingBase")) ?? -1L), end: (((long?)encoded.GetValueOrDefault("composingExtent")) ?? -1L));
    ...
    public virtual TextEditingValue replaced(TextRange replacementRange, string replacementString)
    {
        ...
        var adjustedComposing = new global::Doroti.Flutter.Ui.TextRange(start: adjustIndex(composing.start), end: adjustIndex(composing.end));
...
public class TextInputStyle : Diagnosticable
{
    ...
    public virtual void debugFillProperties(DiagnosticPropertiesBuilder properties)
    {
        ...
        properties.Add(new DiagnosticsProperty<global::Doroti.Flutter.Ui.FontWeight>("fontWeight", fontWeight, defaultValue: null));
        properties.Add(new EnumProperty<global::Doroti.Flutter.Ui.TextDirection>("textDirection", textDirection));
        properties.Add(new EnumProperty<global::Doroti.Flutter.Ui.TextAlign>("textAlign", textAlign));
...
public class TextInputConnection
{
    ...
    public virtual void setComposingRect(Rect rect)
    {
        ...
        _cachedRect = rect;
        global::Doroti.Flutter.Ui.Rect validRect = (rect.isFinite ? rect : (Offset.zero & new global::Doroti.Flutter.Ui.Size(-1, -1)));
...
public static partial class Text_inputLibrary
{
    internal static RawFloatingCursorPoint _toTextPoint(FloatingCursorDragState state, DartMap<string, object> encoded)
    {
        ...
        global::Doroti.Flutter.Ui.Offset offset = ((object.Equals(state, FloatingCursorDragState.Update)) ? new global::Doroti.Flutter.Ui.Offset((((double)encoded.GetValueOrDefault("X"))).toDouble(), (((double)encoded.GetValueOrDefault("Y"))).toDouble()) : Offset.zero);
    ...
    internal async virtual Future<object> _handleTextInputInvocation(MethodCall methodCall)
    {
            ...
            case var __case81975 when object.Equals(__case81975, "TextInputClient.focusElement"):
                {
                    ...
                    _scribbleClients.GetValueOrDefault(args__82021[(int)(0L)])?.onScribbleFocus(new global::Doroti.Flutter.Ui.Offset((((double)args__82021[(int)(1L)])).toDouble(), (((double)args__82021[(int)(2L)])).toDouble()));
                    return default!;
                }
            case var __case82233 when object.Equals(__case82233, "TextInputClient.requestElementsInRect"):
                {
                    ...
                    {
                        var rect__82559 = new global::Doroti.Flutter.Ui.Rect(args__82301[(int)(0L)], args__82301[(int)(1L)], args__82301[(int)(2L)], args__82301[(int)(3L)]);
                        if (!((_scribbleClients.GetValueOrDefault(elementIdentifier)?.isInScribbleRect(rect__82559) ?? false)))
                        {
                            return false;
                        }
                        global::Doroti.Flutter.Ui.Rect bounds__82781 = (_scribbleClients.GetValueOrDefault(elementIdentifier)?.bounds ?? Rect.zero);
                        return !((((object.Equals(bounds__82781, Rect.zero)) || bounds__82781.hasNaN) || bounds__82781.isInfinite));
                    })).map(((elementIdentifier) =>
                    {
                        global::Doroti.Flutter.Ui.Rect bounds__82781 = _scribbleClients.GetValueOrDefault(elementIdentifier)!.bounds;
        ...
        switch (method)
        {
            ...
            case var __case88204 when object.Equals(__case88204, "TextInputClient.insertTextPlaceholder"):
                {
                    _currentConnection!._client.insertTextPlaceholder(new global::Doroti.Flutter.Ui.Size((((double)args[(int)(1L)])).toDouble(), (((double)args[(int)(2L)])).toDouble()));
                    break;
                }
...
internal sealed class _HostTextInputControl : TextInputControl
{
    ...
    private ITextInputHostCapability RequireCapability(string elementId) =>
        _capability ?? throw new FlutterCapabilityException(
            FlutterCapabilityIds.TextInput,
            null,
            DartUiInvocation.Managed($"package:flutter/services.dart#{elementId}"),
            "no text input client is attached");

    private void OnEditingStateChanged(FlutterTextEditingState state)
    {
    ...
    private void OnActionPerformed(FlutterTextInputAction action)
    {
        if (_client is null || _view is null)
        {
            return;
        ...
        {
            FlutterTextInputAction.done => TextInputAction.done,
            FlutterTextInputAction.next => TextInputAction.next,
            FlutterTextInputAction.previous => TextInputAction.previous,
            FlutterTextInputAction.newline => TextInputAction.newline,
    ...
    private static FlutterTextEditingState ToHost(TextEditingValue value)
    {
        var selection = value.selection ?? new TextSelection(baseOffset: -1, extentOffset: -1);
        FlutterTextSelection? composing = value.composing is { isValid: true } range
            ? new FlutterTextSelection(checked((int)range.start), checked((int)range.end))
            : null;
        return new FlutterTextEditingState(
            value.text,
            new FlutterTextSelection(
