...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/grid_paper.dart
#nullable enable
...
{            var __cascade = new global::Doroti.Flutter.Ui.Paint();
        ...
        for (var x__688 = 0.0; (x__688 <= size.width); x__688 += (this.interval / allDivisions__621))
        {
            ...
            canvas.drawLine(new global::Doroti.Flutter.Ui.Offset(x__688, 0.0), new global::Doroti.Flutter.Ui.Offset(x__688, size.height), linePaint__568);
        }
        for (var y__992 = 0.0; (y__992 <= size.height); y__992 += (this.interval / allDivisions__621))
        {
            ...
            canvas.drawLine(new global::Doroti.Flutter.Ui.Offset(0.0, y__992), new global::Doroti.Flutter.Ui.Offset(size.width, y__992), linePaint__568);
        }
    }
