...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/desktop_text_selection_toolbar_layout_delegate.dart
#nullable enable
...
public class DesktopTextSelectionToolbarLayoutDelegate : global::Doroti.Generated.Framework.Rendering.SingleChildLayoutDelegate
{
    ...
    {
        var overhang__1366 = new global::Doroti.Flutter.Ui.Offset(((this.anchor.dx + childSize.width) - size.width), ((this.anchor.dy + childSize.height) - size.height));
        return new global::Doroti.Flutter.Ui.Offset(((overhang__1366.dx > 0.0) ? (this.anchor.dx - overhang__1366.dx) : this.anchor.dx), ((overhang__1366.dy > 0.0) ? (this.anchor.dy - overhang__1366.dy) : this.anchor.dy));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
