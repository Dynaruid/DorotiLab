...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/heroes.dart
#nullable enable
...
public class _HeroFlightManifest__heroes
{
    ...
    private global::Doroti.Flutter.Ui.Rect __late_fromHeroLocation = default!;
    public virtual global::Doroti.Flutter.Ui.Rect fromHeroLocation
    {
        get
        {
            if (!__late_fromHeroLocation_initialized)
            {
                __late_fromHeroLocation = ((global::Doroti.Flutter.Ui.Rect)(object?)_HeroFlightManifest__heroes._boundingBoxFor(this.fromHero.context, ((BuildContext?)((dynamic)this.fromRoute).subtreeContext)));
    ...
    private global::Doroti.Flutter.Ui.Rect __late_toHeroLocation = default!;
    public virtual global::Doroti.Flutter.Ui.Rect toHeroLocation
    {
        get
        {
            if (!__late_toHeroLocation_initialized)
            {
                __late_toHeroLocation = ((global::Doroti.Flutter.Ui.Rect)(object?)_HeroFlightManifest__heroes._boundingBoxFor(this.toHero.context, ((BuildContext?)((dynamic)this.toRoute).subtreeContext)));
    ...
    public virtual global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Rect?> createHeroRectTween(Rect? begin, Rect? end)
    {
        ...
        return ((global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Rect?>)(object?)((createRectTween__19711 is null ? new global::Doroti.Generated.Framework.Animation.RectTween(begin: begin, end: end) : createRectTween__19711.Invoke(begin, end))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    internal static global::Doroti.Flutter.Ui.Rect _boundingBoxFor(BuildContext context, BuildContext? ancestorContext)
    {
        ...
        return ((global::Doroti.Flutter.Ui.Rect)(object?)MatrixUtils.transformRect(box__20120.getTransformTo(ancestorContext?.findRenderObject()), (Offset.zero & ((global::Doroti.Generated.Framework.Rendering.RenderBox)box__20120).size)));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
global::Doroti.Flutter.Ui.Rect rect__22996 = ((global::Doroti.Flutter.Ui.Rect)(object?)DartRuntimePrimitives.RequireValue(this.heroRectTween.evaluate(this._proxyAnimation)));
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public virtual void onTick()
    {
        ...
        if (((toHeroOrigin__26130 is not null) && DartRuntimePrimitives.RequireValue(toHeroOrigin__26130).isFinite))
        {
            ...
            {
                global::Doroti.Flutter.Ui.Rect heroRectEnd__26632 = ((global::Doroti.Flutter.Ui.Rect)(object?)(DartRuntimePrimitives.RequireValue(toHeroOrigin__26130__value26392) & DartRuntimePrimitives.RequireValue(((global::Doroti.Generated.Framework.Animation.Tween<Rect?>)this.heroRectTween).end).size));
    ...
    public virtual void divert(_HeroFlightManifest__heroes newManifest)
    {
        ...
        if (((object.Equals(((_HeroFlightManifest__heroes)this.manifest).type, HeroFlightDirection.push)) && (object.Equals(((_HeroFlightManifest__heroes)newManifest).type, HeroFlightDirection.pop))))
        {
            ...
            heroRectTween = DartRuntimePrimitives.ConvertValue<global::Doroti.Generated.Framework.Animation.Tween<Rect?>>(new global::Doroti.Generated.Framework.Animation.ReverseTween<global::Doroti.Flutter.Ui.Rect?>(this.heroRectTween));
        }
        else
        {
