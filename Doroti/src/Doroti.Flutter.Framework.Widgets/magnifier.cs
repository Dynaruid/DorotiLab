...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/magnifier.dart
#nullable enable
...
public class MagnifierController
{
    ...
    public static global::Doroti.Flutter.Ui.Rect shiftWithinBounds(Rect rect, Rect bounds)
    {
        ...
        global::Doroti.Flutter.Ui.Offset rectShift__12514 = ((global::Doroti.Flutter.Ui.Offset)(object?)Offset.zero);
        if ((rect.left < bounds.left))
        {
            rectShift__12514 += new global::Doroti.Flutter.Ui.Offset((bounds.left - rect.left), 0);
        }
        else
        {
            if ((rect.right > bounds.right))
            {
                rectShift__12514 += new global::Doroti.Flutter.Ui.Offset((bounds.right - rect.right), 0);
            }
        }
        if ((rect.top < bounds.top))
        {
            rectShift__12514 += new global::Doroti.Flutter.Ui.Offset(0, (bounds.top - rect.top));
        }
        else
        {
            if ((rect.bottom > bounds.bottom))
            {
                rectShift__12514 += new global::Doroti.Flutter.Ui.Offset(0, (bounds.bottom - rect.bottom));
            }
        }
...
public class _RenderMagnification__magnifier : global::Doroti.Generated.Framework.Rendering.RenderProxyBox
{
    ...
    public virtual global::Doroti.Flutter.Ui.Offset focalPointOffset
    {
    ...
    {
        global::Doroti.Flutter.Ui.Offset thisCenter__22916 = ((global::Doroti.Flutter.Ui.Offset)(object?)(global::Doroti.Generated.Framework.Painting.Alignment.center.alongSize(this.size) + offset));
...
{            var __cascade = Matrix4.identity();
            ...
            return __cascade;        }))();
        var filter__23345 = new global::Doroti.Flutter.Ui.ImageFilter(matrix__22982.storage, filterQuality: FilterQuality.high);
