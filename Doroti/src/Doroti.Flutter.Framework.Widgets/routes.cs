...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public abstract global::Doroti.Flutter.Ui.Color? barrierColor { get; }
...
notification__82227.dispatch(this.subtreeContext);
    ...
    public virtual Widget buildModalBarrier()
    {
        ...
        if ((((this.barrierColor is not null) && (this.barrierColor!.alpha != 0L)) && !this.offstage))
        {
            ...
            global::Doroti.Generated.Framework.Animation.Animation<global::Doroti.Flutter.Ui.Color?> color__88400 = ((global::Doroti.Generated.Framework.Animation.Animation<global::Doroti.Flutter.Ui.Color?>)(object?)this.animation!.drive(new global::Doroti.Generated.Framework.Animation.ColorTween(begin: this.barrierColor!.withOpacity(0.0), end: this.barrierColor).chain(new global::Doroti.Generated.Framework.Animation.CurveTween(curve: this.barrierCurve))));
