...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/view.dart
#nullable enable
...
public class View : StatefulWidget
{
    ...
    public View(global::Doroti.Generated.Framework.Foundation.Key? key = null, FlutterView view = default!, global::Doroti.Generated.Framework.Rendering.PipelineOwner? deprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner = null, global::Doroti.Generated.Framework.Rendering.RenderView? deprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView = null, Widget child = default!) : base(key: key)
    {
        this.view = view;
        this.child = child;
    ...
    public static global::Doroti.Flutter.Ui.FlutterView? maybeOf(BuildContext context)
    {
        return ((global::Doroti.Flutter.Ui.FlutterView?)(object?)LookupBoundary.dependOnInheritedWidgetOfExactType<_ViewScope__view>(context)?.view);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public static global::Doroti.Flutter.Ui.FlutterView of(BuildContext context)
    {
        global::Doroti.Flutter.Ui.FlutterView? result__7300 = ((global::Doroti.Flutter.Ui.FlutterView?)(object?)View.maybeOf(context));
        ...
        return ((global::Doroti.Flutter.Ui.FlutterView)(object?)result__7300!);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _ViewState__view : State<View>, WidgetsBindingObserver
{
    ...
    internal virtual void _scopeFocusChangeListener()
    {
        ...
        WidgetsBinding.instance.platformDispatcher.requestViewFocusChange(direction: global::Doroti.Flutter.Ui.ViewFocusDirection.forward, state: global::Doroti.Flutter.Ui.ViewFocusState.focused, viewId: checked((long)((View)(object)this.widget).view.viewId));
    }

    public virtual void didChangeViewFocus(ViewFocusEvent @event)
    {
        _viewHasFocus = (@event.state switch { var __constant10380 when (object.Equals(__constant10380, global::Doroti.Flutter.Ui.ViewFocusState.focused)) => (checked((long)@event.viewId) == checked((long)((View)(object)this.widget).view.viewId)), var __constant10448 when (object.Equals(__constant10448, global::Doroti.Flutter.Ui.ViewFocusState.unfocused)) => false, _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        ...
        switch (@event.state)
        {
            case var __constant10619 when (object.Equals(__constant10619, global::Doroti.Flutter.Ui.ViewFocusState.focused)):
                {
                    switch (@event.direction)
                    {
                        case var __constant10693 when (object.Equals(__constant10693, global::Doroti.Flutter.Ui.ViewFocusDirection.forward)):
                            {
                                nextFocus__10570 = (this._policy.findFirstFocus(this._scopeNode, ignoreCurrentFocus: true) ?? this._scopeNode);
                                break;
                            }
                        case var __constant10836 when (object.Equals(__constant10836, global::Doroti.Flutter.Ui.ViewFocusDirection.backward)):
                            {
                                nextFocus__10570 = this._policy.findLastFocus(this._scopeNode, ignoreCurrentFocus: true);
                                break;
                            }
                        case var __constant10965 when (object.Equals(__constant10965, global::Doroti.Flutter.Ui.ViewFocusDirection.undefined)):
                            {
            ...
            case var __constant11086 when (object.Equals(__constant11086, global::Doroti.Flutter.Ui.ViewFocusState.unfocused)):
                {
...
public class RawView : StatelessWidget
{
    ...
    public RawView(global::Doroti.Generated.Framework.Foundation.Key? key = null, FlutterView view = default!, global::Doroti.Generated.Framework.Rendering.PipelineOwner? deprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner = null, global::Doroti.Generated.Framework.Rendering.RenderView? deprecatedDoNotUseWillBeRemovedWithoutNoticeRenderView = null, Widget child = default!) : base(key: key)
    {
        this.view = view;
        this.child = child;
        this._deprecatedPipelineOwner = deprecatedDoNotUseWillBeRemovedWithoutNoticePipelineOwner;
...
internal class _ViewScope__view : InheritedWidget
{
    ...
    internal _ViewScope__view(FlutterView view, Widget child) : base(child: child)
    {
        this.view = view;
    }
...
internal class _DeprecatedRawViewKey__view<T> : GlobalKey<T> where T : IState
{
    ...
    internal _DeprecatedRawViewKey__view(FlutterView view, global::Doroti.Generated.Framework.Rendering.PipelineOwner? owner, global::Doroti.Generated.Framework.Rendering.RenderView? renderView)
    {
        this.view = view;
        this.owner = owner;
