...
internal class _DragBoundaryDelegateForRect__drag_boundary : DragBoundaryDelegate<Rect>
{
    ...
    public virtual Rect nearestPositionWithinBoundary(Rect draggedObject)
    {
        ...
        return global::Doroti.Flutter.Ui.Rect.fromLTWH(left__1867, top__2004, draggedObject.width, draggedObject.height);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
public class DragBoundary : InheritedWidget
{
    ...
    public static DragBoundaryDelegate<global::Doroti.Flutter.Ui.Rect> forRectOf(BuildContext context, bool useGlobalPosition = true)
    {
        return ((DragBoundaryDelegate<global::Doroti.Flutter.Ui.Rect>)(object?)(DragBoundary.forRectMaybeOf(context, useGlobalPosition: useGlobalPosition) ?? new _DragBoundaryDelegateForRect__drag_boundary(((Rect)(object)null))));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public static DragBoundaryDelegate<global::Doroti.Flutter.Ui.Rect>? forRectMaybeOf(BuildContext context, bool useGlobalPosition = true)
    {
        ...
        {
            return ((DragBoundaryDelegate<global::Doroti.Flutter.Ui.Rect>)(object)null);
        }
        ...
        global::Doroti.Flutter.Ui.Rect boundary__4123 = ((global::Doroti.Flutter.Ui.Rect)(object?)(useGlobalPosition ? global::Doroti.Flutter.Ui.Rect.fromPoints(((Offset)((dynamic)rb__3990!).localToGlobal(Offset.zero)), ((Offset)((dynamic)rb__3990).localToGlobal(((global::Doroti.Generated.Framework.Rendering.RenderBox)rb__3990).size.bottomRight(Offset.zero)))) : (Offset.zero & rb__3990!.size)));
        return ((DragBoundaryDelegate<global::Doroti.Flutter.Ui.Rect>?)(object?)new _DragBoundaryDelegateForRect__drag_boundary(boundary__4123));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
