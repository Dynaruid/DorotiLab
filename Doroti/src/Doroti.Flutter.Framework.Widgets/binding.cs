...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/binding.dart
#nullable enable
...
public interface WidgetsBindingObserver
{
    ...
    public async Future<global::Doroti.Flutter.Ui.AppExitResponse> didRequestAppExit()
    {
...
public interface WidgetsBinding
{
    ...
    public Future<global::Doroti.Flutter.Ui.AppExitResponse> handleRequestAppExit();
    ...
    public global::Doroti.Flutter.Ui.Locale? computePlatformResolvedLocale(List<Locale> supportedLocales);
    ...
    FlutterView window => platformDispatcher.implicitView ?? throw new InvalidOperationException("WidgetsBinding.window requires exactly one Flutter view.");
...
(((RenderView?)(object?)((PipelineOwner)this.pipelineOwner).rootNode)!)?.clearSemantics();
    ...
    public virtual Future<global::Doroti.Flutter.Ui.Codec> instantiateImageCodecFromBuffer(ImmutableBuffer buffer, long? cacheWidth = null, long? cacheHeight = null, bool allowUpscaling = false)
    {
        ...
        return ((Future<global::Doroti.Flutter.Ui.Codec>)(object?)Dart_uiLibrary.instantiateImageCodecFromBuffer(buffer, targetWidth: cacheWidth, targetHeight: cacheHeight, allowUpscaling: allowUpscaling));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public virtual Future<global::Doroti.Flutter.Ui.Codec> instantiateImageCodecWithSize(ImmutableBuffer buffer, global::System.Func<long, long, TargetImageSize>? getTargetSize = null)
    {
        return ((Future<global::Doroti.Flutter.Ui.Codec>)(object?)Dart_uiLibrary.instantiateImageCodecWithSize(buffer, getTargetSize: getTargetSize));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual global::Doroti.Flutter.Ui.Rect? getRectOfSemanticsNodeInViewCoordinates(long viewId, long nodeId) => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Rect>(null);
    ...
    public virtual void _handleSemanticsActionEvent(SemanticsActionEvent action)
    {
        ...
        global::Doroti.Flutter.Ui.SemanticsActionEvent decodedAction__6706 = ((global::Doroti.Flutter.Ui.SemanticsActionEvent)(object?)((arguments__6642 is ByteData) ? action.copyWith(arguments: new global::Doroti.Generated.Framework.Services.StandardMessageCodec().decodeMessage(((ByteData)arguments__6642))) : action));
        List<global::System.Action<global::Doroti.Flutter.Ui.SemanticsActionEvent>> localListeners__7088 = ((List<global::System.Action<global::Doroti.Flutter.Ui.SemanticsActionEvent>>)(object?)this._semanticsActionListeners.toList());
    ...
    public virtual global::Doroti.Flutter.Ui.AccessibilityFeatures accessibilityFeatures => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.AccessibilityFeatures>(this._accessibilityFeatures);
    public virtual void handleAccessibilityFeaturesChanged()
    {
        this._accessibilityFeatures = this.platformDispatcher.accessibilityFeatures;
    }

    public virtual global::Doroti.Flutter.Ui.SemanticsUpdateBuilder createSemanticsUpdateBuilder()
    {
        return ((global::Doroti.Flutter.Ui.SemanticsUpdateBuilder)(object?)new global::Doroti.Flutter.Ui.SemanticsUpdateBuilder());
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
if ((global::Doroti.Generated.Framework.Painting.DebugLibrary.debugInvertOversizedImages != value))
{
    ...
    global::Doroti.Flutter.Runtime.DartAsyncRuntime.unawaited(_forceRepaint());
}
throw new InvalidOperationException("Dart closure completed without a value.");
})));
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public virtual global::Doroti.Flutter.Ui.PictureRecorder createPictureRecorder() => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.PictureRecorder>(new global::Doroti.Flutter.Ui.PictureRecorder());
    public virtual global::Doroti.Flutter.Ui.Canvas createCanvas(PictureRecorder recorder) => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Canvas>(new global::Doroti.Flutter.Ui.Canvas(recorder));
...
((dynamic)child).visitChildren((global::System.Action<RenderObject>)visitor__28613);
    ...
    {
        return new DartMap<string, List<DartMap<string, string>>> { ["result"] = violations.map<ViolationIo, DartMap<string, string>>(((violation) => {
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    public async virtual Future<global::Doroti.Flutter.Ui.AppExitResponse> handleRequestAppExit()
    {
        ...
        return ((global::Doroti.Flutter.Ui.AppExitResponse)(object?)(didCancel__34096 ? AppExitResponse.cancel : AppExitResponse.exit));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
FlutterError.reportError(new global::Doroti.Generated.Framework.Foundation.FlutterErrorDetails(exception: exception, stack: stack, library: "widgets library", context: new global::Doroti.Generated.Framework.Foundation.ErrorDescription("while popping route")));
    ...
    {
        global::Doroti.Flutter.Runtime.Timer.run((() => {
attachRootWidget(rootWidget);
    ...
    public virtual global::Doroti.Flutter.Ui.Locale? computePlatformResolvedLocale(List<Locale> supportedLocales)
    {
