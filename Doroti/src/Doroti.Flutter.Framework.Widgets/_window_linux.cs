...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/_window_linux.dart
#nullable enable
...
public static partial class _window_linuxLibrary
{
    ...
    {
        Uint8List units__35618 = global::Doroti.Flutter.Runtime.Dart_convertLibrary.utf8.encode(value);
...
public static partial class _window_linuxLibrary
{
    internal static string _nativeToString(Pointer<Uint8> value)
    {
        ...
        return global::Doroti.Flutter.Runtime.Dart_convertLibrary.utf8.decode(value.asTypedList(length__35952));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
}
...
public class _GtkWindow___window_linux : _GtkContainer___window_linux
{
    ...
    public virtual global::Doroti.Flutter.Ui.Size getSize()
    {
        ...
        var result__45886 = new global::Doroti.Flutter.Ui.Size(size__45744[0L].toDouble(), size__45744[1L].toDouble());
        _gFree(size__45744);
