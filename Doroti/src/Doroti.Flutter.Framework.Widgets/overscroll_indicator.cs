...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/overscroll_indicator.dart
#nullable enable
            ...
            if (DartRuntimePrimitives.RequireValue(DartCollectionRuntime.NullableMapValue<bool>(this._accepted, isLeading__9697)))
            {
                ...
                else
                {
                    ...
                    if ((((OverscrollNotification)((OverscrollNotification)notification__as9386)).dragDetails is not null))
                    {
                        ...
                        global::Doroti.Flutter.Ui.Size size__10640 = ((global::Doroti.Flutter.Ui.Size)(object?)((global::Doroti.Generated.Framework.Rendering.RenderBox)renderer__10512).size);
                        global::Doroti.Flutter.Ui.Offset position__10687 = ((global::Doroti.Flutter.Ui.Offset)(object?)((Offset)((dynamic)renderer__10512).globalToLocal(((OverscrollNotification)((OverscrollNotification)notification__as9386)).dragDetails!.globalPosition)));
...
public class _GlowController__overscroll_indicator : global::Doroti.Generated.Framework.Foundation.ChangeNotifier
{
    ...
    public virtual void pull(double overscroll, double extent, double crossAxisOffset, double crossExtent)
    {
        ...
        this._glowSizeTween.begin = ((global::Doroti.Generated.Framework.Animation.Animation<double>)this._glowSize).value;
        this._glowSizeTween.end = Math.Max((1.0 - (1.0 / ((0.7 * global::Doroti.Flutter.Runtime.Dart_mathLibrary.sqrt((this._pullDistance * height__17649)))))), ((global::Doroti.Generated.Framework.Animation.Animation<double>)this._glowSize).value);
    ...
    internal virtual void _tickDisplacement(Duration elapsed)
    {
        if ((this._displacementTickerLastElapsed is not null))
        {
            ...
            _displacement = (this._displacementTarget - (((this._displacementTarget - this._displacement)) * global::Doroti.Flutter.Runtime.Dart_mathLibrary.pow(2.0, (-t__19631 / _crossAxisHalfTime.inMicroseconds))));
            notifyListeners();
        }
    ...
    public virtual void paint(Canvas canvas, Size size)
    {
        ...
        var rect__20574 = global::Doroti.Flutter.Ui.Rect.fromLTWH(0.0, 0.0, size.width, height__20438);
        var center__20636 = new global::Doroti.Flutter.Ui.Offset((((size.width / 2.0)) * ((0.5 + this._displacement))), (height__20438 - radius__20388));
            ...
            case global::Doroti.Generated.Framework.Painting.AxisDirection.left:
                {
                    ...
                    canvas.scale(1.0, -1.0);
                    controller.paint(canvas, new global::Doroti.Flutter.Ui.Size(size.height, size.width));
                    canvas.restore();
                    break;
                }
...
internal class _StretchController__overscroll_indicator : global::Doroti.Generated.Framework.Foundation.Listenable
{
    ...
    internal static double _exponentialScalar = (global::Doroti.Flutter.Runtime.Dart_mathLibrary.e / 0.33);
...
return default!;
    ...
    public virtual void pull(double normalizedOverscroll)
    {
        ...
        double exponentialIntensity__38972 = (_stretchIntensity * ((1L - global::Doroti.Flutter.Runtime.Dart_mathLibrary.exp((-absDistance__38853 * _exponentialScalar)))));
