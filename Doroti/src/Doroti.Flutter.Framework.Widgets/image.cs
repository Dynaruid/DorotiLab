...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/image.dart
#nullable enable
...
_wasSynchronouslyLoaded = false;
    ...
    {
        return ((Widget)(object?)new Stack(alignment: global::Doroti.Generated.Framework.Painting.Alignment.center, children: new List<Widget> { Positioned.CreateFill(child: new Placeholder(color: new global::Doroti.Flutter.Ui.Color(3482124831L))), new Padding(padding: global::Doroti.Generated.Framework.Painting.EdgeInsets.CreateAll(4.0), child: new FittedBox(child: new Text($"{error}", textAlign: global::Doroti.Flutter.Ui.TextAlign.center, textDirection: TextDirection.ltr, style: new global::Doroti.Generated.Framework.Painting.TextStyle(shadows: new List<global::Doroti.Flutter.Ui.Shadow> { new global::Doroti.Flutter.Ui.Shadow(blurRadius: 1.0) })))) }));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
