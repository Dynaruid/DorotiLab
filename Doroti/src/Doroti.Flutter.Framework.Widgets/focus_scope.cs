...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/focus_scope.dart
#nullable enable
...
internal class _DebugFocusBorder__focus_scope : StatelessWidget
{
    ...
    internal virtual global::Doroti.Flutter.Ui.Color _borderColor
    {
        get
        {
            if (((FocusNode)this.node).hasPrimaryFocus)
            {
                return new global::Doroti.Flutter.Ui.Color(4026597120L);
            }
            else
            {
                if (((FocusNode)this.node).hasFocus)
                {
                    return new global::Doroti.Flutter.Ui.Color(4026532095L);
                }
                else
                {
                    if (!((FocusNode)this.node).canRequestFocus)
                    {
                        return new global::Doroti.Flutter.Ui.Color(4043243520L);
                    }
                    else
                    {
                        if (((FocusNode)this.node).skipTraversal)
                        {
                            return new global::Doroti.Flutter.Ui.Color(4043308800L);
                        }
                        else
                        {
                            return new global::Doroti.Flutter.Ui.Color(4026597375L);
                        }
                    }
                }
            }
