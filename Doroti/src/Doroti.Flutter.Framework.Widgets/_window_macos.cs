...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/_window_macos.dart
#nullable enable
...
public class WindowingOwnerMacOSIo : WindowingOwnerIo
{
    ...
    public virtual WindowControllerIo createWindowController(WindowControllerDelegateIo @delegate, Size? size = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null, bool resizable = default!, string? title = null)
    {
        ...
        return ((WindowControllerIo)(object?)controller__2488);
    ...
    public virtual DialogWindowControllerIo createDialogWindowController(DialogWindowControllerDelegateIo @delegate, Size? size = null, global::Doroti.Generated.Framework.Rendering.BoxConstraints? constraints = null, bool resizable = default!, BaseWindowControllerIo? parent = null, string? title = null)
    {
        ...
        return ((DialogWindowControllerIo)(object?)controller__2952);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual TooltipWindowControllerIo createTooltipWindowController(TooltipWindowControllerDelegateIo @delegate, global::Doroti.Generated.Framework.Rendering.BoxConstraints constraints, Rect anchorRect, WindowPositionerIo positioner, BaseWindowControllerIo parent)
    {
        ...
        return ((TooltipWindowControllerIo)(object?)controller__3483);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public virtual PopupWindowControllerIo createPopupWindowController(PopupWindowControllerDelegateIo @delegate, global::Doroti.Generated.Framework.Rendering.BoxConstraints constraints, Rect anchorRect, WindowPositionerIo positioner, BaseWindowControllerIo parent)
    {
        ...
        return ((PopupWindowControllerIo)(object?)controller__4074);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }

    public static Pointer<Void> getWindowHandle(FlutterView view)
    {
...
public interface _WindowControllerMixin___window_macos : BaseWindowControllerMacOSIo
{
    ...
    public global::Doroti.Flutter.Ui.FlutterView rootView { get; }
    public Pointer<Void> windowHandle { get; }
    public global::Doroti.Flutter.Ui.Size contentSize { get; }
    public void destroy();
    public bool isDestroyed { get; }
}
...
public class TooltipWindowControllerMacOSIo : TooltipWindowControllerIo, _WindowControllerMixin___window_macos
{
    ...
    {
        Pointer<_Rect___window_macos> result__10652 = _window_macosLibrary._allocator();
        global::Doroti.Flutter.Ui.Rect targetRect__10697 = ((global::Doroti.Flutter.Ui.Rect)(object?)this._positioner.placeWindow(childSize: childSize.@ref.toSize(), anchorRect: this._anchorRect.translate(parentRect.@ref.left, parentRect.@ref.top), parentRect: parentRect.@ref.toRect(), displayRect: outputRect.@ref.toRect()));
        result__10652.@ref.left = targetRect__10697.left;
        result__10652.@ref.top = targetRect__10697.top;
        result__10652.@ref.width = childSize.@ref.width;
        result__10652.@ref.height = childSize.@ref.height;
    ...
    public override void destroy()
    {
        ...
        Pointer<Void> handle__7953 = this.windowHandle;
        _MacOSPlatformInterface___window_macos.destroyWindow(handle__7953);
    }
...
public class PopupWindowControllerMacOSIo : PopupWindowControllerIo, _WindowControllerMixin___window_macos
{
    ...
    public virtual Pointer<_Rect___window_macos> _handleOnGetWindowPosition(Pointer<_Size___window_macos> childSize, Pointer<_Rect___window_macos> parentRect, Pointer<_Rect___window_macos> outputRect)
    {
        Pointer<_Rect___window_macos> result__13752 = _window_macosLibrary._allocator();
        global::Doroti.Flutter.Ui.Rect targetRect__13797 = ((global::Doroti.Flutter.Ui.Rect)(object?)this._positioner.placeWindow(childSize: childSize.@ref.toSize(), anchorRect: this._anchorRect.translate(parentRect.@ref.left, parentRect.@ref.top), parentRect: parentRect.@ref.toRect(), displayRect: outputRect.@ref.toRect()));
        result__13752.@ref.left = targetRect__13797.left;
        result__13752.@ref.top = targetRect__13797.top;
        result__13752.@ref.width = childSize.@ref.width;
        result__13752.@ref.height = childSize.@ref.height;
        return result__13752;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _Size___window_macos : Struct
{
    ...
    public virtual global::Doroti.Flutter.Ui.Size toSize() => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Size>(new global::Doroti.Flutter.Ui.Size(this.width, this.height));
}
...
internal class _Offset___window_macos : Struct
{
    ...
    public virtual global::Doroti.Flutter.Ui.Offset toOffset() => DartRuntimePrimitives.ConvertValue<global::Doroti.Flutter.Ui.Offset>(new global::Doroti.Flutter.Ui.Offset(this.x, this.y));
}
...
internal class _Rect___window_macos : Struct
{
    ...
    {
        return global::Doroti.Flutter.Ui.Rect.fromLTWH(this.left, this.top, this.width, this.height);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _MacOSPlatformInterface___window_macos
{
    ...
    {
        Pointer<_Size___window_macos> ffiSize__23282 = _window_macosLibrary._allocator();
        DartRuntimePrimitives.Ignore(((Func<_Size___window_macos>)(() =>
{            var __cascade = ffiSize__23282.@ref;
            ...
            return __cascade;        }))());
        _MacOSPlatformInterface___window_macos._setWindowContentSize(windowHandle, ffiSize__23282);
        _window_macosLibrary._allocator.free(ffiSize__23282);
    }
...
{            var __cascade = request__24820.@ref;
        ...
        _window_macosLibrary._allocator.free(request__24820);
        return viewId__25480;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
{            var __cascade = request__26328.@ref;
        ...
        try
        {
            long viewId__27045 = _MacOSPlatformInterface___window_macos._createDialogWindow(DartRuntimePrimitives.RequireValue(WidgetsBinding.instance.platformDispatcher.engineId), request__26328);
            return viewId__27045;
        }
        finally
        {
            _window_macosLibrary._allocator.free(request__26328);
        }
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
{            var __cascade = request__29753.@ref;
    ...
    public static global::Doroti.Flutter.Ui.Size getWindowContentSize(Pointer<Void> windowHandle)
    {
        _Size___window_macos size__30994 = ((_Size___window_macos)(object?)_MacOSPlatformInterface___window_macos._getWindowContentSize(windowHandle));
        return new global::Doroti.Flutter.Ui.Size(((_Size___window_macos)size__30994).width, ((_Size___window_macos)size__30994).height);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    {
        Pointer<_Utf8___window_macos> titlePointer__31373 = title.toNativeUtf8();
        _MacOSPlatformInterface___window_macos._setWindowTitle(windowHandle, titlePointer__31373);
        _window_macosLibrary._allocator.free(titlePointer__31373);
    }
    ...
    {
        Pointer<_Utf8___window_macos> title__32992 = ((Pointer<_Utf8___window_macos>)(object?)_MacOSPlatformInterface___window_macos._getTitle(windowHandle));
        string result__33042 = title__32992.toDartString();
        _window_macosLibrary._allocator.free(title__32992);
        return result__33042;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
...
internal class _CallocAllocator___window_macos : Allocator
{
    ...
    {
        Pointer<T> result__34468 = _posixCalloc(byteCount, 1L).cast<T>();
        if ((result__34468.address == 0L))
        {
            throw DartRuntimePrimitives.AsException(new DartArgumentError($"Could not allocate {byteCount} bytes."));
        }
        return result__34468;
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
