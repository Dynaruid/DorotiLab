            ...
            case global::Doroti.Generated.Framework.Painting.Axis.horizontal:
                {
                    ...
                    if ((offset__10635 < 0L))
                    {
                        return global::Doroti.Flutter.Ui.Rect.fromLTRB((size.width + offset__10635), 0.0, size.width, size.height);
                    }
                    return global::Doroti.Flutter.Ui.Rect.fromLTRB(0.0, 0.0, offset__10635, size.height);
                }
            case global::Doroti.Generated.Framework.Painting.Axis.vertical:
                {
                    ...
                    if ((offset__10908 < 0L))
                    {
                        return global::Doroti.Flutter.Ui.Rect.fromLTRB(0.0, (size.height + offset__10908), size.width, size.height);
                    }
                    return global::Doroti.Flutter.Ui.Rect.fromLTRB(0.0, 0.0, size.width, offset__10908);
                }
            default:
...
{            var __cascade = this._moveController;
    ...
    internal virtual double _overallDragAxisExtent
    {
        get
        {
            global::Doroti.Flutter.Ui.Size size__13441 = ((global::Doroti.Flutter.Ui.Size)(object?)DartRuntimePrimitives.RequireValue(((BuildContext)this.context).size));
...
_updateMoveAnimation();
    ...
    internal virtual void _updateMoveAnimation()
    {
        ...
        _moveAnimation = this._moveController.drive(new global::Doroti.Generated.Framework.Animation.Tween<global::Doroti.Flutter.Ui.Offset>(begin: Offset.zero, end: (this._directionIsXAxis ? new global::Doroti.Flutter.Ui.Offset(end__16097, ((Dismissible)this.widget).crossAxisEndOffset) : new global::Doroti.Flutter.Ui.Offset(((Dismissible)this.widget).crossAxisEndOffset, end__16097))));
    }
