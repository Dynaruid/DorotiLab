...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/drag_target.dart
#nullable enable
...
internal class _DraggableState__drag_target<T> : State<Draggable<T>>
{
    ...
    internal virtual _DragAvatar__drag_target<T>? _startDrag(Offset position)
    {
        ...
        global::Doroti.Flutter.Ui.Offset dragStartPoint__19661 = default!;
...
public class _DragAvatar__drag_target<T> : global::Doroti.Generated.Framework.Gestures.Drag
{
    ...
    {
        global::Doroti.Flutter.Ui.Offset oldPosition__32743 = ((global::Doroti.Flutter.Ui.Offset)(object?)this._position);
    ...
    public virtual void updateDrag(Offset globalPosition)
    {
        ...
        if (this.overlayState.mounted)
        {
            ...
            global::Doroti.Flutter.Ui.Offset overlaySpaceOffset__33368 = ((global::Doroti.Flutter.Ui.Offset)(object?)((Offset)((dynamic)box__33288).globalToLocal(globalPosition)));
...
throw new InvalidOperationException("Dart closure completed without a value.");
    ...
    internal virtual global::Doroti.Flutter.Ui.Offset _restrictAxis(Offset offset)
    {
        return (this.axis switch { global::Doroti.Generated.Framework.Painting.Axis.horizontal => new global::Doroti.Flutter.Ui.Offset(offset.dx, 0.0), global::Doroti.Generated.Framework.Painting.Axis.vertical => new global::Doroti.Flutter.Ui.Offset(0.0, offset.dy), null => offset, _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
