...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/text_selection_toolbar_layout_delegate.dart
#nullable enable
...
public class TextSelectionToolbarLayoutDelegate : global::Doroti.Generated.Framework.Rendering.SingleChildLayoutDelegate
{
    ...
    public override Offset getPositionForChild(Size size, Size childSize)
    {
        ...
        global::Doroti.Flutter.Ui.Offset anchor__2663 = ((global::Doroti.Flutter.Ui.Offset)(object?)(DartRuntimePrimitives.RequireValue(fitsAbove__2580) ? this.anchorAbove : this.anchorBelow));
        return new global::Doroti.Flutter.Ui.Offset(TextSelectionToolbarLayoutDelegate.centerOn(anchor__2663.dx, childSize.width, size.width), (DartRuntimePrimitives.RequireValue(fitsAbove__2580) ? Math.Max(0.0, (anchor__2663.dy - childSize.height)) : anchor__2663.dy));
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
