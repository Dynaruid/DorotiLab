...
// Flutter 56b8e1a8: ../../../flutter-master/packages/flutter/lib/src/widgets/sliver_floating_header.dart
#nullable enable
...
if ((this.effectiveScrollOffset != ((global::Doroti.Generated.Framework.Animation.Animation<double>)this.snapAnimation).value))
{
    ...
    public override void paint(global::Doroti.Generated.Framework.Rendering.PaintingContext context, Offset offset)
    {
        ...
        {
            offset += (global::Doroti.Generated.Framework.Rendering.SliverLibrary.applyGrowthDirectionToAxisDirection(((global::Doroti.Generated.Framework.Rendering.SliverConstraints)this.constraints).axisDirection, ((global::Doroti.Generated.Framework.Rendering.SliverConstraints)this.constraints).growthDirection) switch { global::Doroti.Generated.Framework.Painting.AxisDirection.up => new global::Doroti.Flutter.Ui.Offset(0.0, ((this.geometry!.paintExtent - childMainAxisPosition(this.child!)) - this.childExtent)), global::Doroti.Generated.Framework.Painting.AxisDirection.left => new global::Doroti.Flutter.Ui.Offset(((this.geometry!.paintExtent - childMainAxisPosition(this.child!)) - this.childExtent), 0.0), global::Doroti.Generated.Framework.Painting.AxisDirection.right => new global::Doroti.Flutter.Ui.Offset(childMainAxisPosition(this.child!), 0.0), global::Doroti.Generated.Framework.Painting.AxisDirection.down => new global::Doroti.Flutter.Ui.Offset(0.0, childMainAxisPosition(this.child!)), _ => throw new InvalidOperationException("Non-exhaustive Dart switch value.") });
