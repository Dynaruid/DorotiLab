...
{
    public static InlineSpanSemanticsInformation placeholder = new InlineSpanSemanticsInformation(
        "￼",
        isPlaceholder: true
    );
    ...
    public InlineSpanSemanticsInformation(
        ...
        List<StringAttribute> stringAttributes = default!,
    ...
    )
    {
        ...
        requiresOwnNode =
            isPlaceholder || (recognizer is not null) || (semanticsIdentifier is not null);
        System.Diagnostics.Debug.Assert(
            !isPlaceholder || ((text == "￼") && (semanticsLabel is null) && (recognizer is null))
        );
    }
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is InlineSpanSemanticsInformation)
            ...
            && (__other.isPlaceholder == isPlaceholder)
            && CollectionsLibrary.listEquals(__other.stringAttributes, stringAttributes);
    }
    ...
    public override string ToString() =>
        $"{objectRuntimeTypeFunctions.objectRuntimeType(this, "InlineSpanSemanticsInformation")}{{text: {text}, semanticsLabel: {semanticsLabel}, semanticsIdentifier: {semanticsIdentifier}, recognizer: {recognizer}}}";
}
