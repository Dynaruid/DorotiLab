...
}))())) : (((TextStyle)b).background ?? (((Func<Paint>)(() =>
{
    ...
    public virtual global::Doroti.Ui.TextStyle getTextStyle(double textScaleFactor = 1.0, TextScaler textScaler = default!)
    {
        ...
        double? fontSizeLocal = (this.fontSize switch { null => null, double size when (object.Equals(textScaler, TextScaler.noScaling)) => (size * textScaleFactor), double sizeLocal => textScaler.scale(sizeLocal) });
            ...
            (_, global::Doroti.Ui.Color colorLocal) => ((Func<Paint>)(() =>
{
    ...
    public virtual global::Doroti.Ui.ParagraphStyle getParagraphStyle(TextAlign? textAlign = null, TextDirection? textDirection = null, TextScaler textScaler = default!, string? ellipsis = null, long? maxLines = null, TextHeightBehavior? textHeightBehavior = null, Locale? locale = null, string? fontFamily = null, double? fontSize = null, FontWeight? fontWeight = null, FontStyle? fontStyle = null, double? height = null, StrutStyle? strutStyle = null)
    {
        ...
        return new global::Doroti.Ui.ParagraphStyle(textAlign: textAlign, textDirection: textDirection, fontWeight: (fontWeight ?? this.fontWeight), fontStyle: (fontStyle ?? this.fontStyle), fontFamily: (fontFamily ?? this.fontFamily), fontSize: textScaler.scale(((fontSize ?? this.fontSize) ?? global::Doroti.Framework.Painting.Text_painterLibrary.kDefaultFontSize)), height: (height ?? this.height), textHeightBehavior: effectiveTextHeightBehavior, strutStyle: ((strutStyle is null) ? null : new global::Doroti.Ui.StrutStyle(fontFamily: ((StrutStyle)strutStyle).fontFamily, fontFamilyFallback: ((StrutStyle)strutStyle).fontFamilyFallback, fontSize: (((StrutStyle)strutStyle).fontSize switch { null => null, double unscaled => textScaler.scale(unscaled) }), height: ((StrutStyle)strutStyle).height, leading: ((StrutStyle)strutStyle).leading, leadingDistribution: ((StrutStyle)strutStyle).leadingDistribution, fontWeight: ((StrutStyle)strutStyle).fontWeight, fontStyle: ((StrutStyle)strutStyle).fontStyle, forceStrutHeight: ((StrutStyle)strutStyle).forceStrutHeight)), maxLines: maxLines, ellipsis: ellipsis, locale: locale);
        throw new InvalidOperationException("Dart control flow completed without a value.");
    }
    ...
    public override bool Equals(object? other)
    {
        ...
        return ((((((((((((((((((((((((((__other is TextStyle) && (((TextStyle)((TextStyle)__other)).inherit == this.inherit)) && (object.Equals(((TextStyle)((TextStyle)__other)).color, this.color))) && (object.Equals(((TextStyle)((TextStyle)__other)).backgroundColor, this.backgroundColor))) && (((TextStyle)((TextStyle)__other)).fontSize == this.fontSize)) && (object.Equals(((TextStyle)((TextStyle)__other)).fontWeight, this.fontWeight))) && (object.Equals(((TextStyle)((TextStyle)__other)).fontStyle, this.fontStyle))) && (((TextStyle)((TextStyle)__other)).letterSpacing == this.letterSpacing)) && (((TextStyle)((TextStyle)__other)).wordSpacing == this.wordSpacing)) && (object.Equals(((TextStyle)((TextStyle)__other)).textBaseline, this.textBaseline))) && (((TextStyle)((TextStyle)__other)).height == this.height)) && (object.Equals(((TextStyle)((TextStyle)__other)).leadingDistribution, this.leadingDistribution))) && (object.Equals(((TextStyle)((TextStyle)__other)).locale, this.locale))) && (object.Equals(((TextStyle)((TextStyle)__other)).foreground, this.foreground))) && (object.Equals(((TextStyle)((TextStyle)__other)).background, this.background))) && global::Doroti.Framework.Foundation.CollectionsLibrary.listEquals(((TextStyle)((TextStyle)__other)).shadows, this.shadows)) && global::Doroti.Framework.Foundation.CollectionsLibrary.listEquals(((TextStyle)((TextStyle)__other)).fontFeatures, this.fontFeatures)) && global::Doroti.Framework.Foundation.CollectionsLibrary.listEquals(((TextStyle)((TextStyle)__other)).fontVariations, this.fontVariations)) && (object.Equals(((TextStyle)((TextStyle)__other)).decoration, this.decoration))) && (object.Equals(((TextStyle)((TextStyle)__other)).decorationColor, this.decorationColor))) && (object.Equals(((TextStyle)((TextStyle)__other)).decorationStyle, this.decorationStyle))) && (((TextStyle)((TextStyle)__other)).decorationThickness == this.decorationThickness)) && (((TextStyle)((TextStyle)__other)).fontFamily == this.fontFamily)) && global::Doroti.Framework.Foundation.CollectionsLibrary.listEquals(((TextStyle)((TextStyle)__other)).fontFamilyFallback, this.fontFamilyFallback)) && (((TextStyle)((TextStyle)__other))._package == this._package)) && (object.Equals(((TextStyle)((TextStyle)__other)).overflow, this.overflow)));
    }
