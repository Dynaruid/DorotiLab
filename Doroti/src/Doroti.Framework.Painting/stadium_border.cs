...
{
    public StadiumBorder(BorderSide side = default!)
    ...
    public override ShapeBorder? lerpFrom(ShapeBorder? a, double t)
    {
        ...
        if (a is CircleBorder)
        {
            ...
            return new _StadiumToCircleBorder__stadium_border(
                side: BorderSide.lerp(a__as1274.side, side, t),
                circularity: 1.0 - t,
                eccentricity: a__as1274.eccentricity
            );
        }
        if (a is RoundedRectangleBorder)
        {
            ...
            return new _StadiumToRoundedRectangleBorder__stadium_border(
                side: BorderSide.lerp(a__as1471.side, side, t),
                borderRadius: a__as1471.borderRadius,
    ...
    public override ShapeBorder? lerpTo(ShapeBorder? b, double t)
    {
        ...
        if (b is CircleBorder)
        {
            ...
            return new _StadiumToCircleBorder__stadium_border(
                side: BorderSide.lerp(side, b__as1895.side, t),
                circularity: t,
                eccentricity: b__as1895.eccentricity
            );
        }
        if (b is RoundedRectangleBorder)
        {
            ...
            return new _StadiumToRoundedRectangleBorder__stadium_border(
                side: BorderSide.lerp(side, b__as2086.side, t),
                borderRadius: b__as2086.borderRadius,
                rectilinearity: t
            );
        }
    ...
    public override StadiumBorder copyWith(
...
internal class _StadiumToCircleBorder__stadium_border : OutlinedBorder
{
    ...
    internal _StadiumToCircleBorder__stadium_border(
    ...
    public override ShapeBorder? lerpFrom(ShapeBorder? a, double t)
    {
        if (a is StadiumBorder)
        {
            ...
            return new _StadiumToCircleBorder__stadium_border(
                side: BorderSide.lerp(a__as4725.side, side, t),
        ...
        if (a is CircleBorder)
        {
            ...
            return new _StadiumToCircleBorder__stadium_border(
                side: BorderSide.lerp(a__as4929.side, side, t),
                circularity: circularity + ((1.0 - circularity) * (1.0 - t)),
                eccentricity: a__as4929.eccentricity
            );
        }
        if (a is _StadiumToCircleBorder__stadium_border)
        {
            _StadiumToCircleBorder__stadium_border a__as5164 =
    ...
    public override ShapeBorder? lerpTo(ShapeBorder? b, double t)
    {
        if (b is StadiumBorder)
        {
            ...
            return new _StadiumToCircleBorder__stadium_border(
                side: BorderSide.lerp(side, b__as5542.side, t),
        ...
        if (b is CircleBorder)
        {
            ...
            return new _StadiumToCircleBorder__stadium_border(
                side: BorderSide.lerp(side, b__as5754.side, t),
                circularity: circularity + ((1.0 - circularity) * t),
                eccentricity: b__as5754.eccentricity
            );
        }
        if (b is _StadiumToCircleBorder__stadium_border)
        {
            _StadiumToCircleBorder__stadium_border b__as5981 =
    ...
    public override _StadiumToCircleBorder__stadium_border copyWith(
        BorderSide? side = null,
        BorderRadiusGeometry? borderRadius = null,
        double? eccentricity = null,
        LinearBorderEdge? start = null,
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is _StadiumToCircleBorder__stadium_border)
...
internal class _StadiumToRoundedRectangleBorder__stadium_border : OutlinedBorder
{
    ...
    internal _StadiumToRoundedRectangleBorder__stadium_border(
        BorderSide side = default!,
    ...
    public override ShapeBorder? lerpFrom(ShapeBorder? a, double t)
    {
        if (a is StadiumBorder)
        {
            ...
            return new _StadiumToRoundedRectangleBorder__stadium_border(
                side: BorderSide.lerp(a__as10360.side, side, t),
        ...
        if (a is RoundedRectangleBorder)
        {
            ...
            return new _StadiumToRoundedRectangleBorder__stadium_border(
                side: BorderSide.lerp(a__as10580.side, side, t),
                borderRadius: borderRadius,
        ...
        {
            _StadiumToRoundedRectangleBorder__stadium_border a__as10842 =
                (_StadiumToRoundedRectangleBorder__stadium_border)a;
            return new _StadiumToRoundedRectangleBorder__stadium_border(
    ...
    public override ShapeBorder? lerpTo(ShapeBorder? b, double t)
    {
        if (b is StadiumBorder)
        {
            ...
            return new _StadiumToRoundedRectangleBorder__stadium_border(
                side: BorderSide.lerp(side, b__as11261.side, t),
                borderRadius: borderRadius,
        ...
        if (b is RoundedRectangleBorder)
        {
            ...
            return new _StadiumToRoundedRectangleBorder__stadium_border(
                side: BorderSide.lerp(side, b__as11489.side, t),
                borderRadius: borderRadius,
        ...
        {
            _StadiumToRoundedRectangleBorder__stadium_border b__as11743 =
                (_StadiumToRoundedRectangleBorder__stadium_border)b;
            return new _StadiumToRoundedRectangleBorder__stadium_border(
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is _StadiumToRoundedRectangleBorder__stadium_border)
            ...
            && (__other.rectilinearity == rectilinearity);
    }

    public override int GetHashCode() =>
        FoundationRuntimePorts.ObjectHash(side, borderRadius, rectilinearity);

    public override string ToString()
    {
        return $"StadiumBorder({side}, {borderRadius}, "
            + $"{(rectilinearity * 100L).toStringAsFixed(1L)}% of the way to being a "
