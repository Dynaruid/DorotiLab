...
public abstract class BorderRadiusGeometry
{
    ...
    public static BorderRadiusGeometry CreateAll(Radius radius) => BorderRadius.CreateAll(radius);

    public static BorderRadiusGeometry CreateCircular(double radius) =>
        BorderRadius.CreateCircular(radius);

    public static BorderRadiusGeometry CreateHorizontal(
        Radius? left = null,
        Radius? right = null,
        Radius? start = null,
        Radius? end = null
    )
    {
        DartRuntimePrimitives.Assert(() =>
            ((left is null) && (right is null)) || ((start is null) && (end is null))
        );
        if ((start is not null) || (end is not null))
        {
            return BorderRadiusDirectional.CreateHorizontal(
    ...
    public static BorderRadiusGeometry CreateOnly(
    ...
    public static BorderRadiusGeometry CreateDirectional(
        Radius topStart = default!,
        Radius topEnd = default!,
        Radius bottomStart = default!,
        Radius bottomEnd = default!
    ) => new BorderRadiusDirectional(topStart, topEnd, bottomStart, bottomEnd);

    public static BorderRadiusGeometry CreateVertical(
        Radius top = default!,
    ...
    {
        return new _MixedBorderRadius__border_radius(
    ...
    public override string ToString()
    {
        ...
        if (
            Equals(_topLeft, _topRight)
            && Equals(_topRight, _bottomLeft)
            && Equals(_bottomLeft, _bottomRight)
        )
        {
        ...
        if (
            Equals(_topStart, _topEnd)
            && Equals(_topEnd, _bottomEnd)
            && Equals(_bottomEnd, _bottomStart)
        )
        {
            if (!Equals(_topStart, Radius.zero))
            {
                ...
                {
                    logical =
                        $"BorderRadiusDirectional.circular({_topStart.x.toStringAsFixed(1L)})";
                }
                else
                {
    ...
    public override bool Equals(object? other)
    {
        ...
        return (__other is BorderRadiusGeometry)
            && Equals(__other._topLeft, _topLeft)
            && Equals(__other._topRight, _topRight)
            && Equals(__other._bottomLeft, _bottomLeft)
            && Equals(__other._bottomRight, _bottomRight)
            && Equals(__other._topStart, _topStart)
            && Equals(__other._topEnd, _topEnd)
            && Equals(__other._bottomStart, _bottomStart)
            && Equals(__other._bottomEnd, _bottomEnd);
    }
...
{
    public static new BorderRadius zero = CreateAll(Radius.zero);
    ...
    public static new BorderRadius CreateAll(Radius radius)
    {
    ...
    public static new BorderRadius CreateCircular(double radius)
    {
        return CreateAll(Radius.circular(radius));
    }

    public static new BorderRadius CreateVertical(Radius top = default, Radius bottom = default)
    {
        return new BorderRadius(
            topLeft: top,
            topRight: top,
    ...
    public virtual BorderRadius copyWith(
        Radius? topLeft = null,
    ...
    {
        return new BorderRadius(
            topLeft: topLeft.___(other),
            topRight: topRight.___(other),
...
{
    public static new BorderRadiusDirectional zero = CreateAll(Radius.zero);
    ...
    public static new BorderRadiusDirectional CreateAll(Radius radius)
    {
    ...
    public static new BorderRadiusDirectional CreateCircular(double radius)
    {
        return CreateAll(Radius.circular(radius));
    }

    public static new BorderRadiusDirectional CreateVertical(
        Radius top = default,
        Radius bottom = default
    )
    {
    ...
    public static BorderRadiusDirectional CreateHorizontal(
        Radius start = default,
        Radius end = default
    )
    {
        return new BorderRadiusDirectional(
    ...
    {
        return new BorderRadiusDirectional(
            topStart: topStart.___(other),
            topEnd: topEnd.___(other),
...
internal class _MixedBorderRadius__border_radius : BorderRadiusGeometry
{
    ...
    internal override Radius _topLeft
    {
        get => __field__topLeft;
    }
    private Radius __field__topRight = default!;
    internal override Radius _topRight
    {
        get => __field__topRight;
    }
    private Radius __field__bottomLeft = default!;
    internal override Radius _bottomLeft
    {
        get => __field__bottomLeft;
    }
    private Radius __field__bottomRight = default!;
    internal override Radius _bottomRight
    {
        get => __field__bottomRight;
    }
    private Radius __field__topStart = default!;
    internal override Radius _topStart
    {
        get => __field__topStart;
    }
    private Radius __field__topEnd = default!;
    internal override Radius _topEnd
    {
        get => __field__topEnd;
    }
    private Radius __field__bottomStart = default!;
    internal override Radius _bottomStart
    {
        get => __field__bottomStart;
    }
    private Radius __field__bottomEnd = default!;
    internal override Radius _bottomEnd
    {
        get => __field__bottomEnd;
    }

    internal _MixedBorderRadius__border_radius(
        Radius _topLeft,
        Radius _topRight,
        Radius _bottomLeft,
        Radius _bottomRight,
    ...
    public override _MixedBorderRadius__border_radius ___(double other)
    {
        return new _MixedBorderRadius__border_radius(
            _topLeft.___(other),
            _topRight.___(other),
            _bottomLeft.___(other),
            _bottomRight.___(other),
            _topStart.___(other),
            _topEnd.___(other),
