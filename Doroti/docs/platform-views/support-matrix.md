...
| Qt Quick / Widgets | shared planner/session and explicit capabilities; host build passed | not run | WebEngine effect integration, resize/retirement qualification, real Linux GPU |
