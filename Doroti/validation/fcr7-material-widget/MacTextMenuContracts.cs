...
internal static partial class MountedPickerContracts
{
    ...
    private static void VerifyMacTextMenu(Brightness brightness)
    {
        ...
        try
        {
            ...
            Console.WriteLine($"macOS {brightness}: right-click menu pixels, Copy/Cut/Paste and dismissal PASS");
            ...
            void PressMenuItem(ContextMenuButtonType type)
            {
                ...
                Click(buttonBox.localToGlobal(buttonBox.size.center(Offset.zero)), 1);
                Pump();
