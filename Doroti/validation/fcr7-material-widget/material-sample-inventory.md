...
| component_screen.dart: First/SecondComponentList, BuildSlivers, _CacheHeight | 1/2 lists, independent scroll positions; intentional departure from the reference's growing extent: measure all 29 finite sections before scroll | CustomScrollView, separate SliverToBoxAdapter/RepaintBoundary per section; geometry/style changes use normal layout |
