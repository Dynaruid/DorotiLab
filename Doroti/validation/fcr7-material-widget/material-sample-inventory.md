...
| component_screen.dart: First/SecondComponentList, BuildSlivers, _CacheHeight | 1/2 lists, independent scroll positions, estimated item height; update cache on geometry/style change | CustomScrollView, SliverChildBuilderDelegate, SingleChildRenderObjectWidget, RenderProxyBox; investigate shared layout defects separately |
