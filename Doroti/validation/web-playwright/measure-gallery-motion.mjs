...
try {
 ...
 await page.goto((process.env.DOROTI_WEB_BASE_URL??'http://127.0.0.1:5090')+`/?dorotiTestbedMode=sample&dorotiResizeDiagnostics=${detailed?1:0}&dorotiInputMarkers=1`+(process.env.DOROTI_PERF_QUERY??''));
