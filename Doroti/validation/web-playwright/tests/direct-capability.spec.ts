...
test("selected direct presenter proves hardware Skia ownership without bitmap transfers", async ({ page, runtimeErrors }) => {
  ...
  expect(capability[webgpu ? "hardwareWebGpu" : "hardwareWebGl2"]).toBe(true);
