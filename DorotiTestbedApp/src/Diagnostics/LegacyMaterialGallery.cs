...
internal static class DemoTheme
{
    ...
    internal static Material.ThemeData Create(
        ...
        bool revealSystemBackdrop = false
    )
    {
        ...
        var palette = Material.ColorScheme.CreateFromSeed(
            seedColor: Seed,
            brightness: brightness,
            surface: new UiColor((surfaceAlpha << 24) | (isDark ? 0x00141218L : 0x00fffbfeL)),
...
internal sealed class MaterialGallery(
    ...
    Action<Material.Scaffold> scaffoldBuilt
) : StatefulWidget
{
...
internal sealed class MaterialGalleryState : State<MaterialGallery>
{
    ...
    private readonly FragmentShader _galleryShader = FragmentProgram
        .fromSource(GalleryShaderSource, "doroti-demo-gallery")
        .fragmentShader();
    private readonly FragmentShader _galleryFilterShader = FragmentProgram
        .fromSource(GalleryFilterShaderSource, "doroti-demo-image-filter")
        .fragmentShader();
    ...
    internal string EffectStateSignature =>
        $"backdropBlur={_blurEnabled};effectInteractions={EffectInteractionCount}";
    ...
    {
        var context =
            _blurToggleKey.currentContext
            ?? throw new InvalidOperationException("Backdrop blur toggle is not mounted.");
        var box =
            context.findRenderObject() as Doroti.Framework.Rendering.RenderBox
            ?? throw new InvalidOperationException(
                "Backdrop blur toggle does not own a RenderBox."
            );
    ...
    {
        var context =
            _backdropPanelKey.currentContext
            ?? throw new InvalidOperationException("Backdrop panel is not mounted.");
        var box =
            context.findRenderObject() as Doroti.Framework.Rendering.RenderBox
    ...
    private async void OpenSample()
    {
        ...
        catch (Exception exception)
        {
            ...
            if (mounted)
            {
                ...
                {
                    _openingSample = false;
                    _sampleLoadFailed = true;
                });
            }
        }
    }

    private Widget ActionSemantics(string label, Widget child, Action action, string value) =>
        new Semantics(
            container: true,
    ...
    public override Widget build(BuildContext context)
    {
        ...
        var button = ActionSemantics(
            ...
            () => _buttonCount++,
            _buttonCount.ToString()
        );
        var checkbox = ActionSemantics(
            InteractiveLabels[1],
            new Material.Checkbox(
                ...
                onChanged: value => Mutate(() => _checked = value == true)
            ),
            () => _checked = !_checked,
            _checked.ToString()
        );
        var radio = ActionSemantics(
            InteractiveLabels[2],
            new Material.Radio<long>(
                value: 1,
                groupValue: _radio,
                activeColor: palette.primary,
                fillColor: new WidgetStatePropertyAll<UiColor?>(palette.primary),
                ...
                materialTapTargetSize: Material.MaterialTapTargetSize.padded,
                visualDensity: Material.VisualDensity.standard,
                onChanged: value => Mutate(() => _radio = value)
            ),
            () => _radio = _radio == 1 ? 0 : 1,
            _radio.ToString()
        );
        var toggle = ActionSemantics(
            InteractiveLabels[3],
            new Material.Switch(
                value: _switched,
                ...
                thumbColor: new WidgetStatePropertyAll<UiColor?>(
                    _switched ? palette.primary : palette.onSurfaceVariant
                ),
                trackColor: new WidgetStatePropertyAll<UiColor?>(
                    _switched ? palette.primaryContainer : palette.surfaceContainerHighest
                ),
                ...
                hoverColor: interactionOverlay,
                splashRadius: 20,
                onChanged: value => Mutate(() => _switched = value)
            ),
            () => _switched = !_switched,
            _switched.ToString()
        );
        var slider = ActionSemantics(
            InteractiveLabels[4],
            new Material.Slider(
                value: _slider,
                min: 0,
                ...
                onChanged: value => Mutate(() => _slider = value)
            ),
            () => _slider = _slider < 0.7 ? 0.8 : 0.2,
        ...
        var textField = new Material.TextField(
            autofocus: Environment.GetEnvironmentVariable("DOROTI_TESTBED_MODE")
                == "boot-autofocus",
        ...
        var blurToggle = new Semantics(
            ...
            child: new Material.ElevatedButton(
                ...
                child: new Row(
                    ...
                    [
                        new IgnorePointer(
                            child: new Material.Checkbox(value: _blurEnabled, onChanged: _ => { })
                        ),
                                            ...
                                            child: new Container(
                                                ...
                                                child: new Column(
                                                    ...
                                                    [
                                                        ...
                                                        new Text(
                                                            "ListView rows continue behind this overlay"
                                                        ),
                                                    ]
                                                )
                                            )
        ...
        var scaffold = new Material.Scaffold(
                                    ...
                                    child: new Column(
                                        ...
                                        [
                                            ...
                                            .. _sampleLoadFailed
                                                ...
                                                {
                                                    new Text(
                                                        "Could not open the sample. Please try again.",
                                                        style: new Doroti.Framework.Painting.TextStyle(
                                                            color: palette.error
                                                        )
                                                    ),
                                            ...
                                            new Stack(
                                                ...
                                                [
                                                    new Text(
                                                        "Custom SkSL · shared GPU runtime effect · all targets",
                                                        style: new Doroti.Framework.Painting.TextStyle(
                                            ...
                                            new ImageFiltered(
                                                ...
                                                child: new Container(
                                                    ...
                                                    child: new Text(
                                                        "ImageFilter.shader · implicit child texture · GPU 2-pass",
                                                        style: new Doroti.Framework.Painting.TextStyle(
                                            ...
                                            new Text(
                                                "Reviewed Material · promoted product · strict Skia GPU"
                                            ),
                                            new Material.Card(
                                            ...
                                            new Row(
                                                spacing: 12,
                                                children: [toggle, new Text("Switch")]
                                            ),
                                            slider,
                                            new SizedBox(
                                                height: 64,
                                            ...
                                            new Row(
                                                ...
                                                [
                                                    blurToggle,
                                                    new Text("Backdrop blur (native effect gate)"),
                                                ]
                                            ),
                                            new Text(
                                                "Nested scroll regression · outer/inner controllers · transient Android scrollbar"
                                            ),
                                            new Text(
                                                "Lazy ListView.builder + clipped backdrop panel"
                                            ),
                                            effectPanel,
                                        ]
                                    )
            ...
            floatingActionButton: ActionSemantics(
                InteractiveLabels[5],
                new Material.FloatingActionButton(
