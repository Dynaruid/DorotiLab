...
internal static class WindowsWebViewEvidence
{
    ...
    {
        var lines = new List<string> { "WindowsAppSDK product WebViewController / CompositionController", "physical=notVerified; nativeAot=notVerified" };
        ...
        try
        {
            ...
            await ContentJs("chrome.webview.postMessage({version:1,documentGeneration:" + state.DocumentGeneration + ",requestId:1,name:'forged',payload:'bad'})");
