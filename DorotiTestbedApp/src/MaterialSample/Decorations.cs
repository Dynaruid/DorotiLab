...
internal sealed class ComponentSectionState : State<ComponentSection>
{
    ...
    public override Widget build(BuildContext context) =>
        new RepaintBoundary(
            child: new Padding(
                padding: EdgeInsets.CreateSymmetric(vertical: 10),
                child: new Column(
                    children:
                    [
                        new Row(
                            ...
                            [
                                ...
                                new M.Tooltip(
                                    ...
                                    child: new Padding(
                                        padding: EdgeInsets.CreateSymmetric(horizontal: 5),
                                        child: new Icon(M.Icons.info_outline, size: 16)
                                    )
                                ),
                            ]
                        ),
                        new ConstrainedBox(
                            constraints: BoxConstraints.CreateTightFor(width: 450),
                            child: new Focus(
                                focusNode: _focus,
...
internal sealed class GalleryDrawer : StatefulWidget
{
    ...
    internal static readonly IconData[] Icons =
    [
        M.Icons.inbox_outlined,
        M.Icons.send_outlined,
        M.Icons.favorite_outline,
        M.Icons.delete_outline,
        M.Icons.bookmark_border,
        M.Icons.bookmark_border,
        M.Icons.bookmark_border,
    ];
    internal static readonly IconData[] SelectedIcons =
    [
        M.Icons.inbox,
        M.Icons.send,
        M.Icons.favorite,
...
internal sealed class GalleryDrawerState : State<GalleryDrawer>
{
    ...
    public override Widget build(BuildContext context)
    {
        Widget Heading(string text) =>
            new Padding(
                padding: EdgeInsetsGeometry.CreateFromLTRB(28, 16, 16, 10),
                child: new Text(text, style: M.Theme.of(context).textTheme.titleSmall)
            );
        Widget Destination(int i) =>
            new M.NavigationDrawerDestination(
        ...
        return new M.NavigationDrawer(
            selectedIndex: _selected,
            onDestinationSelected: value => setState(() => _selected = value),
            children:
            [
                Heading("Mail"),
                .. Enumerable.Range(0, 4).Select(Destination),
                new M.Divider(indent: 28, endIndent: 28),
                Heading("Labels"),
                .. Enumerable.Range(4, 3).Select(Destination),
            ]
        );
    }
}
