...
internal sealed record CoreLiteral(SourceOrigin Origin, CoreType Type, object? Value)
    : CoreExpression(Origin, Type);

internal sealed record CoreLocal(SourceOrigin Origin, CoreType Type, LocalId Local)
    : CoreExpression(Origin, Type);
